...
#define __NR_NOPH_GameCanvas_flushGraphics 195 /* javax.microedition */
static inline _syscall1(void,NOPH_GameCanvas_flushGraphics, NOPH_GameCanvas_t, canvas) 
#define __NR_NOPH_GameCanvas_flushGraphics_rect 196 /* javax.microedition */
