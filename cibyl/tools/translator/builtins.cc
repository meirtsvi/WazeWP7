      ...
      if (mt->getBytecodeSize() < 20000)
        {
          if (cmp(name, "__negsf2"))
            return new Arithmetic1(name, "neg");
          else if (cmp(name, "__addsf3"))
            return new Arithmetic2(name, "add");
          else if (cmp(name, "__subsf3"))
            return new Arithmetic2(name, "sub");
          else if (cmp(name, "__divsf3"))
            return new Arithmetic2(name, "div");
          else if (cmp(name, "__mulsf3"))
            return new Arithmetic2(name, "mul");
          /* Comparisons */
