...
public:
  Addu(uint32_t address, int opcode,
       MIPS_register_t rs, MIPS_register_t rt, MIPS_register_t rd) : Rfmt("add", address, opcode, rs, rt, rd)
  {
  }
...
public:
  Subu(uint32_t address, int opcode,
       MIPS_register_t rs, MIPS_register_t rt, MIPS_register_t rd) : Rfmt("sub", address, opcode, rs, rt, rd)
  {
  }
