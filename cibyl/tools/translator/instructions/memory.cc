...
public:
  ...
  bool pass2()
  {
    ...
    if ( config->optimizePartialMemoryOps &&
      ...
      emit->bc_invokestatic("int32 [WazeWP7]%sCRunTime::memoryRead%s(int32)",
...
public:
  ...
  bool pass2()
  {
    ...
    emit->bc_invokestatic("void [WazeWP7]%sCRunTime::memoryWrite%s(int32, int32)",
        controller->getJasminPackagePath(), this->bc);
    return true;
  }
...
protected:
  ...
  void traceStore()
  {
    ...
    emit->bc_invokestatic("void [WazeWP7]%sCRunTime::memoryWrite%sPc(int32, int32, int32)",
        controller->getJasminPackagePath(), this->bc);
  }
...
protected:
  ...
  bool pass2()
  {
    ...
    if ( 1 )//config->optimizePartialMemoryOps ||
