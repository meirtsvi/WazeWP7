...
//    case OP_XORI: return new Ifmt("ixor", address, opcode,
    case OP_XORI: return new Ifmt("xor", address, opcode,
				  rs, rt, rd, extra);
//    case OP_ANDI: return new Ifmt("iand", address, opcode,
    case OP_ANDI: return new Ifmt("and", address, opcode,
				  rs, rt, rd, extra);
//    case OP_ORI: return new Ifmt("ior", address, opcode,
    case OP_ORI: return new Ifmt("or", address, opcode,
				 rs, rt, rd, extra);
    ...
    case OP_BEQ: if(rt==R_ZERO)
		   ...
		   return new OneRegisterConditionalJump("brfalse", address, opcode, rs, extra, false);
		 else
	           //return new TwoRegisterConditionalJump("if_icmpeq", address, opcode, rs, rt, extra);
			   return new TwoRegisterConditionalJump("beq ", address, opcode, rs, rt, extra);//tocheck
    case OP_BNE: if(rt==R_ZERO)
		   //return new OneRegisterConditionalJump("ifne", address, opcode, rs, extra);
		   return new OneRegisterConditionalJump("brtrue", address, opcode, rs, extra, false);
		 else
                   //return new TwoRegisterConditionalJump("if_icmpne", address, opcode, rs, rt, extra);
				   return new TwoRegisterConditionalJump("bne.un", address, opcode, rs, rt, extra);

    //case OP_BGEZ: return new OneRegisterConditionalJump("ifge", address, opcode, rs, extra);
	case OP_BGEZ: return new OneRegisterConditionalJump("bge", address, opcode, rs, extra, true);
    //case OP_BGTZ: return new OneRegisterConditionalJump("ifgt", address, opcode, rs, extra);
	case OP_BGTZ: return new OneRegisterConditionalJump("bgt", address, opcode, rs, extra, true);
    //case OP_BLEZ: return new OneRegisterConditionalJump("ifle", address, opcode, rs, extra);
	case OP_BLEZ: return new OneRegisterConditionalJump("ble", address, opcode, rs, extra, true);
    //case OP_BLTZ: return new OneRegisterConditionalJump("iflt", address, opcode, rs, extra);
	case OP_BLTZ: return new OneRegisterConditionalJump("blt", address, opcode, rs, extra, true);
