                                     ...
                                     int start, int end)
{
  ...
  emit->generic("  public static %s %s(int address, int sp, int a0, int a1, int a2, int a3) {\n"
                "    %s ret = 0;\n"
                "    switch(address) {\n",
...
void CallTableMethod::generateHierarchy(unsigned int n)
{
  ...
  emit->generic("  public static int fcall(int address, int sp, int a0, int a1, int a2, int a3) {\n");
  for (i = 0; i < n-1; i++)
    {
...
bool CallTableMethod::pass2()
{
  ...
  if (this->exp_syms)
    {
      emit->generic(" public static int getAddressByName(String name) {\n");
      ...
      if ( config->callTableClasses > 1 )
        {
          ...
          emit->generic("  public static int call(int address, int sp, int a0, int a1, int a2, int a3) {\n");
