...
#define __NR_NOPH_delete 22 /* java */
...
*/
#define __NR_NOPH_String_toCharPtr 23 /* java */
...
#define __NR___NOPH_System_currentTimeMillis 24 /* java */
