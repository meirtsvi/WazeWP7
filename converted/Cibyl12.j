...
// 0x010109b4: 0x10109b4: lui   s1, 0xe0000
	ldc.i4 917504
	stloc 9
// 0x010109b8: 0x10109b8: lw    v0, 29744(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010109d0: 0x10109d0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010109d4: 0x10109d4: jal   0x1000910 sw    v1, -30408(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010109fc: 0x10109fc: addiu a1, zero, 545
	ldc.i4 545
	stloc.2
// 0x01010a00: 0x1010a00: jal   0x1004a38 sw    s0, 29744(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01010a14: 0x1010a14: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01010a18: 0x1010a18: addiu a0, a0, 12676
	ldloc.1
	ldc.i4 12676
	add
	stloc.1
...
// 0x01010a24: 0x1010a24: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x01010a28: 0x1010a28: addiu v0, v0, 9300
	ldloc 5
	ldc.i4 9300
	add
	stloc 5
...
// 0x01010aa4: 0x1010aa4: beq   s1, v0, 0x1010d34 lui   s1, 0x30000
	...
	beq  L_1010d34
// --- basic block ---
// 0x01010aac: 0x1010aac: lw    v0, -30408(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01010abc: 0x1010abc: jal   0x1007a5c addiu s3, zero, 192
	...
	stloc 6
// --- basic block ---
// 0x01010ac4: 0x1010ac4: lw    s2, -30408(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1010aec:
// 0x01010aec: 0x1010aec: lw    s0, 29744(s8)
	ldloc 5
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x01010af8: 0x1010af8: addu  s4, s0, zero
	...
	stloc 12
L_1010afc:
// 0x01010afc: 0x1010afc: lw    v0, 29744(s8)
	ldloc 5
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x01010b18: 0x1010b18: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 7
// 0x01010b1c: 0x1010b1c: addiu v1, v1, 29620
	ldloc 7
	ldc.i4 29620
	add
	stloc 7
// 0x01010b20: 0x1010b20: lw    a0, 120(v1)
	...
	ldelem.i4
	stloc.1
// 0x01010b24: 0x1010b24: lw    a1, 29620(s7)
	ldloc 5
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01010c28: 0x1010c28: sw    v1, 28(sp)
	...
	ldloc 7
	stelem.i4
// 0x01010c2c: 0x1010c2c: jal   0x104e4e8 sw    s0, 24(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01010c34: 0x1010c34: lw    v1, 28(sp)
	...
	ldelem.i4
	stloc 7
// 0x01010c38: 0x1010c38: jal   0x104deb0 addu  a0, v1, zero
	ldloc 7
	stloc.1
	ldloc.1
...
// 0x01010ccc: 0x1010ccc: sw    a3, 24(sp)
	...
	ldloc 4
	stelem.i4
// 0x01010cd0: 0x1010cd0: jal   0x104e4e8 sw    v1, 28(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01010cd8: 0x1010cd8: lw    v1, 28(sp)
	...
	ldelem.i4
	stloc 7
// 0x01010cdc: 0x1010cdc: jal   0x104deb0 addu  a0, v1, zero
	ldloc 7
	stloc.1
	ldloc.1
	call int32 Cibyl57::roadmap_canvas_set_thickness_104deb0(int32)
...
// 0x01010da4: 0x1010da4: lui   v0, 0x10000
	ldc.i4 65536
	stloc.0
// 0x01010da8: 0x1010da8: jr    ra addiu v0, v0, 18616
	ldloc.0
	ldc.i4 18616
	add
	stloc.0
...
// 0x01010e3c: 0x1010e3c: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x01010e40: 0x1010e40: lw    v0, 24668(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010e74: 0x1010e74: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01010e78: 0x1010e78: lw    v1, -30400(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010e80: 0x1010e80: bne   v1, s0, 0x1010e8c sll   zero, zero, 0
	...
	bne.un L_1010e8c
// --- basic block ---
// 0x01010e88: 0x1010e88: sw    zero, -30400(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010ebc: 0x1010ebc: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x01010ec0: 0x1010ec0: lw    v0, 24668(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010ef8: 0x1010ef8: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x01010efc: 0x1010efc: jal   0x1006ba0 addiu a0, a0, 2828
	ldloc.1
	ldc.i4 2828
	add
	stloc.1
...
// 0x01010f18: 0x1010f18: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x01010f1c: 0x1010f1c: jal   0x1006ba0 addiu a0, a0, 13644
	ldloc.1
	ldc.i4 13644
	add
	stloc.1
...
// 0x01010f58: 0x1010f58: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01010f5c: 0x1010f5c: jal   0x1006ba0 addiu a0, a0, -11360
	ldloc.1
	ldc.i4 -11360
	add
	stloc.1
...
// 0x01011014: 0x1011014: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01011018: 0x1011018: sw    s0, -30400(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01011060: 0x1011060: lui   v1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x01011064: 0x1011064: lw    v1, 24668(v1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010111dc: 0x10111dc: lui   v0, 0x10000
	ldc.i4 65536
	stloc 5
// 0x010111e0: 0x10111e0: j	 0x101120c addiu v0, v0, 18616
	ldloc 5
	ldc.i4 18616
	add
	stloc 5
...
// 0x010111e8: 0x10111e8: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x010111ec: 0x10111ec: lw    a0, -30400(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101122c: 0x101122c: lui   v0, 0x10000
	ldc.i4 65536
	stloc 5
// 0x01011230: 0x1011230: j	 0x101125c addiu v0, v0, 18616
	ldloc 5
	ldc.i4 18616
	add
	stloc 5
...
// 0x01011238: 0x1011238: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101123c: 0x101123c: lw    a0, -30400(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101126c: 0x101126c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01011270: 0x1011270: lw    v1, -30400(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101128c: 0x101128c: bne   a1, v0, 0x101129c lui   v0, 0x10000
	...
	bne.un L_101129c
// --- basic block ---
// 0x01011294: 0x1011294: j	 0x10112a8 addiu v0, v0, 18616
	ldloc 5
	ldc.i4 18616
	add
	stloc 5
...
// 0x01011370: 0x1011370: jal   0x1040fa4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl48::roadmap_city_search_1040fa4(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 8
	stloc 7
// --- basic block ---
...
// 0x01011404: 0x1011404: addu  s0, s0, s2
	...
	add
	stloc 8
// 0x01011408: 0x1011408: addiu a1, a1, -116
	ldloc.2
	ldc.i4.s -116
	add
	stloc.2
...
// 0x01011460: 0x1011460: lui   s3, 0x30000
	ldc.i4 196608
	stloc 11
// 0x01011464: 0x1011464: lw    v1, -30400(s3)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0101148c: 0x101148c: jal   0x1011388 addu  a1, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x01011494: 0x1011494: lw    v0, -30400(s3)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010114b0: 0x10114b0: jal   0x1011388 addu  a1, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x010114b8: 0x10114b8: lw    v0, -30400(s3)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010114d4: 0x10114d4: jal   0x1011388 addu  a1, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x010114dc: 0x10114dc: lw    v0, -30400(s3)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01011844: 0x1011844: lui   s0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01011848: 0x1011848: addiu a1, s0, -30396
	ldloc 5
	ldc.i4 -30396
	add
	stloc.2
...
// 0x0101185c: 0x101185c: addiu v0, s0, -30396
	ldloc 5
	ldc.i4 -30396
	add
	stloc 8
...
// 0x01011894: 0x1011894: lui   v0, 0x10000
	ldc.i4 65536
	stloc 5
// 0x01011898: 0x1011898: j	 0x1011930 addiu v0, v0, 18616
	ldloc 5
	ldc.i4 18616
	add
	stloc 5
...
// 0x01011920: 0x1011920: addiu a1, a1, 27824
	...
	add
	stloc.2
// 0x01011924: 0x1011924: jal   0x1000f64 addiu a0, s0, -28860
	ldloc 8
	ldc.i4 -28860
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x0101192c: 0x101192c: addiu v0, s0, -28860
	ldloc 8
	ldc.i4 -28860
	add
	stloc 5
...
// 0x01011964: 0x1011964: lui   v0, 0x10000
	ldc.i4 65536
	stloc 6
// 0x01011968: 0x1011968: j	 0x1011a18 addiu v0, v0, 18616
	ldloc 6
	ldc.i4 18616
	add
	stloc 6
...
// 0x01011984: 0x1011984: bne   v1, v0, 0x1011994 lui   s0, 0x10000
	...
	bne.un L_1011994
// --- basic block ---
// 0x0101198c: 0x101198c: j	 0x10119a0 addiu s0, s0, 18616
	ldloc 10
	ldc.i4 18616
	add
	stloc 10
...
// 0x010119a8: 0x10119a8: bne   v0, zero, 0x10119b8 lui   s2, 0x10000
	...
	brtrue L_10119b8
// --- basic block ---
// 0x010119b0: 0x10119b0: j	 0x10119c0 addiu s2, s2, 18616
	ldloc 9
	ldc.i4 18616
	add
	stloc 9
...
// 0x010119b8: 0x10119b8: lui   s2, 0x20000
	ldc.i4 131072
	stloc 9
// 0x010119bc: 0x10119bc: addiu s2, s2, -116
	ldloc 9
	ldc.i4.s -116
	add
	stloc 9
...
// 0x010119d0: 0x10119d0: bne   v1, zero, 0x10119e0 lui   v1, 0x10000
	...
	brtrue L_10119e0
// --- basic block ---
// 0x010119d8: 0x10119d8: j	 0x10119e8 addiu v1, v1, 18616
	ldloc 7
	ldc.i4 18616
	add
	stloc 7
...
// 0x010119f4: 0x10119f4: addu  a3, s3, zero
	ldloc 11
	stloc 4
// 0x010119f8: 0x10119f8: addiu a0, s1, -29372
	ldloc 8
	ldc.i4 -29372
	add
	stloc.1
...
// 0x01011a0c: 0x1011a0c: jal   0x1000f9c sw    s0, 28(sp)
	...
	stloc 6
// --- basic block ---
// 0x01011a14: 0x1011a14: addiu v0, s1, -29372
	ldloc 8
	ldc.i4 -29372
	add
	stloc 6
...
// 0x01011a34: 0x1011a34: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01011a38: 0x1011a38: lw    v0, -30400(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01011a98: 0x1011a98: jal   0x100177c addu  s2, v0, zero
	...
	stloc 7
// --- basic block ---
// 0x01011aa0: 0x1011aa0: lw    v0, -30400(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01011ab0: 0x1011ab0: addu  a1, s0, zero
	ldloc 8
	stloc.2
// 0x01011ab4: 0x1011ab4: jal   0x10419c0 addu  a0, s2, zero
	ldloc 10
	stloc.1
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl48::roadmap_range_get_address_10419c0(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 5
	stloc 7
// --- basic block ---
// 0x01011abc: 0x1011abc: jal   0x10418e8 addu  a0, s2, zero
	ldloc 10
	stloc.1
	ldloc.1
...
// 0x01011ac8: 0x1011ac8: beq   v0, a0, 0x1011b20 addiu v1, zero, -1
	...
	beq  L_1011b20
// --- basic block ---
// 0x01011ad0: 0x1011ad0: lw    a0, -30400(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01011d50: 0x1011d50: addiu sp, sp, -80
	...
	add
	stloc.0
// 0x01011d54: 0x1011d54: lw    v0, 31376(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01011d68: 0x1011d68: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01011d6c: 0x1011d6c: lw    a0, 31452(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01011df4: 0x1011df4: beq   s4, v0, 0x1011f0c lui   v0, 0x20000
	...
	beq  L_1011f0c
// --- basic block ---
// 0x01011dfc: 0x1011dfc: lw    a2, 31464(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01011e60: 0x1011e60: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01011e64: 0x1011e64: lw    a0, 31464(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1011f98:
// 0x01011f98: 0x1011f98: lw    v0, 31376(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01011fa4: 0x1011fa4: lhu   v0, 2(s1)
	...
	call int32 [WazeWP7]CRunTime::memoryReadShortUnsigned(int32)
	stloc 6
// 0x01011fa8: 0x1011fa8: lw    v1, 31452(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
