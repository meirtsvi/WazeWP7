...
// 0x010105ec: 0x10105ec: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x010105f0: 0x10105f0: lw    v0, -28400(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010610: 0x1010610: addu  s1, v0, zero
	ldloc 5
	stloc 12
// 0x01010614: 0x1010614: lw    v0, -31232(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01010648: 0x1010648: sw    s3, 0(s0)
	...
	ldloc 13
	stelem.i4
// 0x0101064c: 0x101064c: addiu a2, a2, 18096
	ldloc.3
	ldc.i4 18096
	add
	stloc.3
...
// 0x010106e8: 0x10106e8: lui   v1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x010106ec: 0x10106ec: lw    v0, -31232(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010708: 0x1010708: addiu a0, a0, 26712
	...
	add
	stloc.1
// 0x0101070c: 0x101070c: addiu a2, a2, -832
	ldloc.3
	ldc.i4 -832
	add
	stloc.3
...
// 0x01010728: 0x1010728: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101072c: 0x101072c: lw    v1, -31232(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101077c: 0x101077c: sw    v0, 16(s0)
	...
	ldloc 5
	stelem.i4
// 0x01010780: 0x1010780: addiu a2, a2, 9144
	ldloc.3
	ldc.i4 9144
	add
	stloc.3
...
// 0x010107c0: 0x10107c0: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x010107c4: 0x10107c4: lw    v0, -31232(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 5
// 0x010107c8: 0x10107c8: addiu a0, a0, 11204
	ldloc.1
	ldc.i4 11204
	add
	stloc.1
...
// 0x0101080c: 0x101080c: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x01010810: 0x1010810: addiu a2, s2, 18096
	ldloc 8
	ldc.i4 18096
	add
	stloc.3
...
// 0x01010834: 0x1010834: jal   0x100e5a4 addu  a0, s7, zero
	...
	stloc 5
// --- basic block ---
// 0x0101083c: 0x101083c: jal   0x10bf2b4 sw    v0, 64(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01010898: 0x1010898: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0101089c: 0x101089c: lw    v1, -31232(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010108b8: 0x10108b8: addu  a1, s7, zero
	ldloc 11
	stloc.2
// 0x010108bc: 0x10108bc: addiu a2, a2, -564
	ldloc.3
	ldc.i4 -564
	add
	stloc.3
...
// 0x010108d8: 0x10108d8: bne   s2, v0, 0x10108f0 sll   zero, zero, 0
	...
	bne.un L_10108f0
// --- basic block ---
// 0x010108e0: 0x10108e0: jal   0x10bf2b4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01010938: 0x1010938: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0101093c: 0x101093c: lw    v1, -31232(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01010958: 0x1010958: addu  a1, s7, zero
	ldloc 11
	stloc.2
// 0x0101095c: 0x101095c: addiu a2, a2, 18096
	ldloc.3
	ldc.i4 18096
	add
	stloc.3
...
// 0x01010a18: 0x1010a18: lw    a1, 1792(v0)
	...
	ldelem.i4
	stloc.2
// 0x01010a1c: 0x1010a1c: jal   0x1050448 addu  a0, s1, zero
	ldloc 12
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01010a28: 0x1010a28: sw    v0, 48(s6)
	...
	ldloc 5
	stelem.i4
// 0x01010a2c: 0x1010a2c: jal   0x104f26c addiu s2, s2, 1
	ldloc 8
	ldc.i4.1
	add
	stloc 8
...
// 0x01010a48: 0x1010a48: bne   v0, zero, 0x1010a5c sll   zero, zero, 0
	...
	brtrue L_1010a5c
// --- basic block ---
// 0x01010a50: 0x1010a50: jal   0x10502f8 addu  a0, s7, zero
	ldloc 11
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01010a7c: 0x1010a7c: lw    a1, 1792(v0)
	...
	ldelem.i4
	stloc.2
// 0x01010a80: 0x1010a80: jal   0x1050448 addu  a0, s1, zero
	ldloc 12
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01010ab4: 0x1010ab4: lw    a0, 0(v0)
	...
	ldelem.i4
	stloc.1
// 0x01010ab8: 0x1010ab8: jal   0x10502f8 addiu s7, s7, 4
	ldloc 11
	ldc.i4.4
	add
	stloc 11
...
// 0x01010ac8: 0x1010ac8: blez  v1, 0x1010ad8 addu  a0, v1, zero
	...
	ble L_1010ad8
// --- basic block ---
// 0x01010ad0: 0x1010ad0: jal   0x104f26c sll   zero, zero, 0
	ldloc.1
	call int32 Cibyl60::roadmap_canvas_set_thickness_104f26c(int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
...
// 0x01010b5c: 0x1010b5c: lw    a1, 1792(v0)
	...
	ldelem.i4
	stloc.2
// 0x01010b60: 0x1010b60: jal   0x1050448 addu  a0, s1, zero
	ldloc 12
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01010b80: 0x1010b80: lw    a0, 68(sp)
	...
	stloc.1
L_1010b84:
// 0x01010b84: 0x1010b84: jal   0x10502f8 addiu s5, s5, 1
	ldloc 15
	ldc.i4.1
	add
	stloc 15
...
// 0x01010b98: 0x1010b98: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01010b9c: 0x1010b9c: lw    v0, -31236(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010bb4: 0x1010bb4: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x01010bb8: 0x1010bb8: sw    v0, -31232(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01010bf0: 0x1010bf0: lui   s1, 0xe0000
	ldc.i4 917504
	stloc 9
// 0x01010bf4: 0x1010bf4: lw    v0, -28400(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01010c0c: 0x1010c0c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01010c10: 0x1010c10: jal   0x1000910 sw    v1, -31236(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010c38: 0x1010c38: addiu a1, zero, 545
	ldc.i4 545
	stloc.2
// 0x01010c3c: 0x1010c3c: jal   0x1004a50 sw    s0, -28400(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01010c50: 0x1010c50: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01010c54: 0x1010c54: addiu a0, a0, 12164
	ldloc.1
	ldc.i4 12164
	add
	stloc.1
...
// 0x01010c60: 0x1010c60: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x01010c64: 0x1010c64: addiu v0, v0, 8464
	ldloc 5
	ldc.i4 8464
	add
	stloc 5
...
// 0x01010ce0: 0x1010ce0: beq   s1, v0, 0x1010f70 lui   s1, 0x30000
	...
	beq  L_1010f70
// --- basic block ---
// 0x01010ce8: 0x1010ce8: lw    v0, -31236(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01010cf8: 0x1010cf8: jal   0x1007b1c addiu s3, zero, 192
	...
	stloc 6
// --- basic block ---
// 0x01010d00: 0x1010d00: lw    s2, -31236(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1010d28:
// 0x01010d28: 0x1010d28: lw    s0, -28400(s8)
	ldloc 5
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x01010d34: 0x1010d34: addu  s4, s0, zero
	...
	stloc 12
L_1010d38:
// 0x01010d38: 0x1010d38: lw    v0, -28400(s8)
	ldloc 5
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x01010d54: 0x1010d54: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 7
// 0x01010d58: 0x1010d58: addiu v1, v1, -28524
	ldloc 7
	ldc.i4 -28524
	add
	stloc 7
// 0x01010d5c: 0x1010d5c: lw    a0, 120(v1)
	...
	ldelem.i4
	stloc.1
// 0x01010d60: 0x1010d60: lw    a1, -28524(s7)
	ldloc 5
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01010e64: 0x1010e64: sw    v1, 28(sp)
	...
	ldloc 7
	stelem.i4
// 0x01010e68: 0x1010e68: jal   0x104f8a4 sw    s0, 24(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01010e70: 0x1010e70: lw    v1, 28(sp)
	...
	ldelem.i4
	stloc 7
// 0x01010e74: 0x1010e74: jal   0x104f26c addu  a0, v1, zero
	ldloc 7
	stloc.1
	ldloc.1
	call int32 Cibyl60::roadmap_canvas_set_thickness_104f26c(int32)
...
// 0x01010f08: 0x1010f08: sw    a3, 24(sp)
	...
	ldloc 4
	stelem.i4
// 0x01010f0c: 0x1010f0c: jal   0x104f8a4 sw    v1, 28(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01010f14: 0x1010f14: lw    v1, 28(sp)
	...
	ldelem.i4
	stloc 7
// 0x01010f18: 0x1010f18: jal   0x104f26c addu  a0, v1, zero
	ldloc 7
	stloc.1
	ldloc.1
	call int32 Cibyl60::roadmap_canvas_set_thickness_104f26c(int32)
...
// 0x01010fe0: 0x1010fe0: lui   v0, 0x10000
	ldc.i4 65536
	stloc.0
// 0x01010fe4: 0x1010fe4: jr    ra addiu v0, v0, 18096
	ldloc.0
	ldc.i4 18096
	add
	stloc.0
...
// 0x01011078: 0x1011078: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x0101107c: 0x101107c: lw    v0, 23820(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010110b0: 0x10110b0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010110b4: 0x10110b4: lw    v1, -31228(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010110bc: 0x10110bc: bne   v1, s0, 0x10110c8 sll   zero, zero, 0
	...
	bne.un L_10110c8
// --- basic block ---
// 0x010110c4: 0x10110c4: sw    zero, -31228(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010110f8: 0x10110f8: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x010110fc: 0x10110fc: lw    v0, 23820(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01011134: 0x1011134: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x01011138: 0x1011138: jal   0x1006c70 addiu a0, a0, 2468
	ldloc.1
	ldc.i4 2468
	add
	stloc.1
...
// 0x01011154: 0x1011154: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x01011158: 0x1011158: jal   0x1006c70 addiu a0, a0, 13200
	ldloc.1
	ldc.i4 13200
	add
	stloc.1
...
// 0x01011194: 0x1011194: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01011198: 0x1011198: jal   0x1006c70 addiu a0, a0, -11920
	ldloc.1
	ldc.i4 -11920
	add
	stloc.1
...
// 0x01011250: 0x1011250: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01011254: 0x1011254: sw    s0, -31228(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101129c: 0x101129c: lui   v1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x010112a0: 0x10112a0: lw    v1, 23820(v1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01011418: 0x1011418: lui   v0, 0x10000
	ldc.i4 65536
	stloc 5
// 0x0101141c: 0x101141c: j	 0x1011448 addiu v0, v0, 18096
	ldloc 5
	ldc.i4 18096
	add
	stloc 5
...
// 0x01011424: 0x1011424: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x01011428: 0x1011428: lw    a0, -31228(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01011468: 0x1011468: lui   v0, 0x10000
	ldc.i4 65536
	stloc 5
// 0x0101146c: 0x101146c: j	 0x1011498 addiu v0, v0, 18096
	ldloc 5
	ldc.i4 18096
	add
	stloc 5
...
// 0x01011474: 0x1011474: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x01011478: 0x1011478: lw    a0, -31228(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010114a8: 0x10114a8: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010114ac: 0x10114ac: lw    v1, -31228(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010114c8: 0x10114c8: bne   a1, v0, 0x10114d8 lui   v0, 0x10000
	...
	bne.un L_10114d8
// --- basic block ---
// 0x010114d0: 0x10114d0: j	 0x10114e4 addiu v0, v0, 18096
	ldloc 5
	ldc.i4 18096
	add
	stloc 5
...
// 0x010115ac: 0x10115ac: jal   0x1041c4c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl50::roadmap_city_search_1041c4c(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 8
	stloc 7
// --- basic block ---
...
// 0x01011640: 0x1011640: addu  s0, s0, s2
	...
	add
	stloc 8
// 0x01011644: 0x1011644: addiu a1, a1, -324
	ldloc.2
	ldc.i4 -324
	add
	stloc.2
...
// 0x0101169c: 0x101169c: lui   s3, 0x30000
	ldc.i4 196608
	stloc 11
// 0x010116a0: 0x10116a0: lw    v1, -31228(s3)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010116c8: 0x10116c8: jal   0x10115c4 addu  a1, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x010116d0: 0x10116d0: lw    v0, -31228(s3)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010116ec: 0x10116ec: jal   0x10115c4 addu  a1, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x010116f4: 0x10116f4: lw    v0, -31228(s3)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01011710: 0x1011710: jal   0x10115c4 addu  a1, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x01011718: 0x1011718: lw    v0, -31228(s3)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01011a80: 0x1011a80: lui   s0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01011a84: 0x1011a84: addiu a1, s0, -31224
	ldloc 5
	ldc.i4 -31224
	add
	stloc.2
...
// 0x01011a98: 0x1011a98: addiu v0, s0, -31224
	ldloc 5
	ldc.i4 -31224
	add
	stloc 8
...
// 0x01011ad0: 0x1011ad0: lui   v0, 0x10000
	ldc.i4 65536
	stloc 5
// 0x01011ad4: 0x1011ad4: j	 0x1011b6c addiu v0, v0, 18096
	ldloc 5
	ldc.i4 18096
	add
	stloc 5
...
// 0x01011b5c: 0x1011b5c: addiu a1, a1, 28276
	...
	add
	stloc.2
// 0x01011b60: 0x1011b60: jal   0x1000f64 addiu a0, s0, -29688
	ldloc 8
	ldc.i4 -29688
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x01011b68: 0x1011b68: addiu v0, s0, -29688
	ldloc 8
	ldc.i4 -29688
	add
	stloc 5
