...
// 0x010109d0: 0x10109d0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010109d4: 0x10109d4: jal   0x1000910 sw    v1, -30472(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010aa4: 0x1010aa4: beq   s1, v0, 0x1010d34 lui   s1, 0x30000
	...
	beq  L_1010d34
// --- basic block ---
// 0x01010aac: 0x1010aac: lw    v0, -30472(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01010abc: 0x1010abc: jal   0x1007a5c addiu s3, zero, 192
	...
	stloc 6
// --- basic block ---
// 0x01010ac4: 0x1010ac4: lw    s2, -30472(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01010e3c: 0x1010e3c: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x01010e40: 0x1010e40: lw    v0, 24940(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010e74: 0x1010e74: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01010e78: 0x1010e78: lw    v1, -30464(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010e80: 0x1010e80: bne   v1, s0, 0x1010e8c sll   zero, zero, 0
	...
	bne.un L_1010e8c
// --- basic block ---
// 0x01010e88: 0x1010e88: sw    zero, -30464(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010ebc: 0x1010ebc: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x01010ec0: 0x1010ec0: lw    v0, 24940(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01011014: 0x1011014: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01011018: 0x1011018: sw    s0, -30464(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01011060: 0x1011060: lui   v1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x01011064: 0x1011064: lw    v1, 24940(v1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010111e8: 0x10111e8: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x010111ec: 0x10111ec: lw    a0, -30464(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01011238: 0x1011238: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101123c: 0x101123c: lw    a0, -30464(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101126c: 0x101126c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01011270: 0x1011270: lw    v1, -30464(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01011460: 0x1011460: lui   s3, 0x30000
	ldc.i4 196608
	stloc 11
// 0x01011464: 0x1011464: lw    v1, -30464(s3)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0101148c: 0x101148c: jal   0x1011388 addu  a1, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x01011494: 0x1011494: lw    v0, -30464(s3)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010114b0: 0x10114b0: jal   0x1011388 addu  a1, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x010114b8: 0x10114b8: lw    v0, -30464(s3)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010114d4: 0x10114d4: jal   0x1011388 addu  a1, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x010114dc: 0x10114dc: lw    v0, -30464(s3)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01011844: 0x1011844: lui   s0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01011848: 0x1011848: addiu a1, s0, -30460
	ldloc 5
	ldc.i4 -30460
	add
	stloc.2
...
// 0x0101185c: 0x101185c: addiu v0, s0, -30460
	ldloc 5
	ldc.i4 -30460
	add
	stloc 8
...
// 0x01011920: 0x1011920: addiu a1, a1, 27824
	...
	add
	stloc.2
// 0x01011924: 0x1011924: jal   0x1000f64 addiu a0, s0, -28924
	ldloc 8
	ldc.i4 -28924
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x0101192c: 0x101192c: addiu v0, s0, -28924
	ldloc 8
	ldc.i4 -28924
	add
	stloc 5
...
// 0x010119f4: 0x10119f4: addu  a3, s3, zero
	ldloc 11
	stloc 4
// 0x010119f8: 0x10119f8: addiu a0, s1, -29436
	ldloc 8
	ldc.i4 -29436
	add
	stloc.1
...
// 0x01011a0c: 0x1011a0c: jal   0x1000f9c sw    s0, 28(sp)
	...
	stloc 6
// --- basic block ---
// 0x01011a14: 0x1011a14: addiu v0, s1, -29436
	ldloc 8
	ldc.i4 -29436
	add
	stloc 6
...
// 0x01011a34: 0x1011a34: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01011a38: 0x1011a38: lw    v0, -30464(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01011a98: 0x1011a98: jal   0x100177c addu  s2, v0, zero
	...
	stloc 7
// --- basic block ---
// 0x01011aa0: 0x1011aa0: lw    v0, -30464(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01011ac8: 0x1011ac8: beq   v0, a0, 0x1011b20 addiu v1, zero, -1
	...
	beq  L_1011b20
// --- basic block ---
// 0x01011ad0: 0x1011ad0: lw    a0, -30464(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01011d50: 0x1011d50: addiu sp, sp, -80
	...
	add
	stloc.0
// 0x01011d54: 0x1011d54: lw    v0, 31312(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01011d68: 0x1011d68: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01011d6c: 0x1011d6c: lw    a0, 31388(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01011df4: 0x1011df4: beq   s4, v0, 0x1011f0c lui   v0, 0x20000
	...
	beq  L_1011f0c
// --- basic block ---
// 0x01011dfc: 0x1011dfc: lw    a2, 31400(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01011e60: 0x1011e60: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01011e64: 0x1011e64: lw    a0, 31400(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1011f98:
// 0x01011f98: 0x1011f98: lw    v0, 31312(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01011fa4: 0x1011fa4: lhu   v0, 2(s1)
	...
	call int32 [WazeWP7]CRunTime::memoryReadShortUnsigned(int32)
	stloc 6
// 0x01011fa8: 0x1011fa8: lw    v1, 31388(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
