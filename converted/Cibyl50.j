...
// 0x01043c98: 0x1043c98: sw    s0, 80(v1)
	...
	ldloc 12
	stelem.i4
// 0x01043c9c: 0x1043c9c: jal   0x10a1aa4 sw    s0, 80(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01043cd4: 0x1043cd4: addiu a1, zero, 3
	ldc.i4.3
	stloc.2
// 0x01043cd8: 0x1043cd8: jal   0x10a1aa4 sw    v0, 4(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010447dc: 0x10447dc: sw    zero, 28(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x010447e0: 0x10447e0: jal   0x10a2de4 addiu s1, s1, 1
	ldloc 10
	ldc.i4.1
	add
	stloc 10
...
// 0x01044898: 0x1044898: sw    v0, 24(sp)
	...
	ldloc 5
	stelem.i4
// 0x0104489c: 0x104489c: jal   0x10a2de4 sw    zero, 28(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
