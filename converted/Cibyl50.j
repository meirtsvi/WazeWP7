...
// 0x01043c38: 0x1043c38: addiu sp, sp, -56
	...
	add
	stloc.0
// 0x01043c3c: 0x1043c3c: addiu v1, v1, 12868
	ldloc 6
	ldc.i4 12868
	add
	stloc 6
...
// 0x01043c5c: 0x1043c5c: sw    zero, 84(v1)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01043c60: 0x1043c60: addiu v0, v0, 12956
	ldloc 5
	ldc.i4 12956
	add
	stloc 5
...
// 0x01043d14: 0x1043d14: addu  a0, s3, zero
	ldloc 10
	stloc.1
// 0x01043d18: 0x1043d18: jal   0x10426a8 sw    v0, 12852(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01043d24: 0x1043d24: lui   v1, 0x60000
	ldc.i4 393216
	stloc 6
// 0x01043d28: 0x1043d28: jal   0x104ecec sw    v0, 12856(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01043e38: 0x1043e38: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01043e3c: 0x1043e3c: sw    s0, 12860(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01043e60: 0x1043e60: lui   v0, 0x60000
	ldc.i4 393216
	stloc.0
// 0x01043e64: 0x1043e64: lw    v0, 13052(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01043e70: 0x1043e70: lui   v0, 0x60000
	ldc.i4 393216
	stloc.0
// 0x01043e74: 0x1043e74: jr    ra addiu v0, v0, 13380
	ldloc.0
	ldc.i4 13380
	add
	stloc.0
...
// 0x01043e7c: 0x1043e7c: lui   v0, 0x60000
	ldc.i4 393216
	stloc.0
// 0x01043e80: 0x1043e80: jr    ra addiu v0, v0, 13260
	ldloc.0
	ldc.i4 13260
	add
	stloc.0
...
// 0x01043f1c: 0x1043f1c: lw    s0, 20(sp)
	...
	ldelem.i4
	stloc 5
// 0x01043f20: 0x1043f20: sw    v1, 13048(v0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01043f68: 0x1043f68: sw    s3, 1080(sp)
	...
	ldloc 13
	stelem.i4
// 0x01043f6c: 0x1043f6c: jal   0x1001b68 sw    zero, 13052(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01044010: 0x1044010: sb    zero, 0(v0)
	...
	ldc.i4.s 0
	call void [WazeWP7]CRunTime::memoryWriteByte(int32, int32)
// 0x01044014: 0x1044014: lw    s7, 13052(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0104402c: 0x104402c: sw    v0, 0(s7)
	...
	ldloc 5
	stelem.i4
// 0x01044030: 0x1044030: lw    s5, 13052(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01044034: 0x1044034: jal   0x1001ba8 sll   s5, s5, 2
	...
	stloc 5
// --- basic block ---
// 0x0104403c: 0x104403c: lw    v1, 13052(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01044048: 0x1044048: sw    v0, 0(s5)
	...
	ldloc 5
	stelem.i4
// 0x0104404c: 0x104404c: j	 0x1044068 sw    v1, 13052(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01044058: 0x1044058: lui   s3, 0x60000
	ldc.i4 393216
	stloc 13
// 0x0104405c: 0x104405c: addiu s4, s4, 13260
	ldloc 14
	ldc.i4 13260
	add
	stloc 14
// 0x01044060: 0x1044060: addiu s3, s3, 13380
	ldloc 13
	ldc.i4 13380
	add
	stloc 13
...
// 0x01044090: 0x1044090: lui   v1, 0x60000
	ldc.i4 393216
	stloc 7
// 0x01044094: 0x1044094: lw    a1, 13052(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01044098: 0x1044098: addiu a0, a0, 13380
	ldloc.1
	ldc.i4 13380
	add
	stloc.1
// 0x0104409c: 0x104409c: addiu v1, v1, 13260
	ldloc 7
	ldc.i4 13260
	add
	stloc 7
...
// 0x010440e4: 0x10440e4: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010440e8: 0x10440e8: lw    v0, 13048(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0104411c: 0x104411c: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01044120: 0x1044120: lw    v0, 13048(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01044154: 0x1044154: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01044158: 0x1044158: lw    v0, 13048(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01044194: 0x1044194: lui   s0, 0x60000
	ldc.i4 393216
	stloc 8
// 0x01044198: 0x1044198: lw    v0, 13056(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010441d0: 0x10441d0: lui   v1, 0x60000
	ldc.i4 393216
	stloc 7
// 0x010441d4: 0x10441d4: lw    a0, 13500(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010441dc: 0x10441dc: mult  a0, v1
	...
	mul
	stloc 10
// 0x010441e0: 0x10441e0: lw    v1, 13056(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010442fc: 0x10442fc: lui   s2, 0x60000
	ldc.i4 393216
	stloc 8
// 0x01044300: 0x1044300: addiu s2, s2, 13260
	ldloc 8
	ldc.i4 13260
	add
	stloc 8
...
// 0x01044334: 0x1044334: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01044338: 0x1044338: addiu v0, v0, 13380
	ldloc 5
	ldc.i4 13380
	add
	stloc 5
...
// 0x01044350: 0x1044350: addiu s0, s0, 1
	...
	stloc 6
L_1044354:
// 0x01044354: 0x1044354: lw    v0, 13052(s3)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010443b0: 0x10443b0: lui   s3, 0x60000
	ldc.i4 393216
	stloc 6
// 0x010443b4: 0x10443b4: addiu s3, s3, 13380
	ldloc 6
	ldc.i4 13380
	add
	stloc 6
...
// 0x010443ec: 0x10443ec: addiu s3, s3, 4
	...
	stloc 6
L_10443f0:
// 0x010443f0: 0x10443f0: lw    v0, 13052(s4)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01044428: 0x1044428: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0104442c: 0x104442c: lw    v0, 13048(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01044468: 0x1044468: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0104446c: 0x104446c: lw    v0, 13048(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010444a8: 0x10444a8: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010444ac: 0x10444ac: lw    v0, 13048(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010444e8: 0x10444e8: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010444ec: 0x10444ec: lw    v0, 13048(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010445b4: 0x10445b4: lw    s0, 16(sp)
	...
	ldelem.i4
	stloc 8
// 0x010445b8: 0x10445b8: sw    v0, 13044(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010445e0: 0x10445e0: jal   0x104c584 sw    s0, 1064(sp)
	...
	stloc 5
// --- basic block ---
// 0x010445e8: 0x10445e8: lw    v1, 13056(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0104468c: 0x104468c: addu  a0, s4, zero
	ldloc 8
	stloc.1
// 0x01044690: 0x1044690: lw    s4, 13056(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01044694: 0x1044694: jal   0x1001ba8 sll   s4, s4, 2
	...
	stloc 5
// --- basic block ---
// 0x0104469c: 0x104469c: lw    v1, 13056(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010446a8: 0x10446a8: sw    v0, 0(s4)
	...
	ldloc 5
	stelem.i4
// 0x010446ac: 0x10446ac: j	 0x10446c0 sw    v1, 13056(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010446b4: 0x10446b4: lui   s3, 0x60000
	ldc.i4 393216
	stloc 11
// 0x010446b8: 0x10446b8: addiu s3, s3, 13060
	ldloc 11
	ldc.i4 13060
	add
	stloc 11
...
// 0x0104478c: 0x104478c: addiu a1, a1, 19076
	...
	add
	stloc.2
// 0x01044790: 0x1044790: jal   0x104ffc4 sw    zero, 13500(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010447b0: 0x10447b0: jal   0x1044428 lui   s4, 0x1040000
	...
	stloc 5
// --- basic block ---
// 0x010447b8: 0x10447b8: addiu s2, s2, 13060
	ldloc 8
	ldc.i4 13060
	add
	stloc 8
...
// 0x010447e8: 0x10447e8: addiu s2, s2, 4
	...
	stloc 8
L_10447ec:
// 0x010447ec: 0x10447ec: lw    v0, 13056(s3)
	ldloc 6
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x01044824: 0x1044824: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01044828: 0x1044828: lw    v0, 13048(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01044900: 0x1044900: lui   s0, 0x60000
	ldc.i4 393216
	stloc 8
// 0x01044904: 0x1044904: lw    v0, 13044(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01044914: 0x1044914: jalr  v0 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x0104491c: 0x104491c: sw    zero, 13044(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01044994: 0x1044994: lui   s2, 0x60000
	ldc.i4 393216
	stloc 9
// 0x01044998: 0x1044998: addiu s2, s2, 13380
	ldloc 9
	ldc.i4 13380
	add
	stloc 9
...
// 0x010449c8: 0x10449c8: addiu s2, s2, 4
	...
	stloc 9
L_10449cc:
// 0x010449cc: 0x10449cc: lw    v0, 13052(s3)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01044a54: 0x1044a54: lui   s0, 0x60000
	ldc.i4 393216
	stloc 7
// 0x01044a58: 0x1044a58: lw    v0, 13044(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01044a68: 0x1044a68: jalr  v0 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x01044a70: 0x1044a70: sw    zero, 13044(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01044aa0: 0x1044aa0: lui   v1, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01044aa4: 0x1044aa4: lw    t0, 13500(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01044aa8: 0x1044aa8: lui   v1, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01044aac: 0x1044aac: lw    v1, 13056(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01044b58: 0x1044b58: lui   v1, 0x60000
	ldc.i4 393216
	stloc 7
// 0x01044b5c: 0x1044b5c: lw    v0, 13500(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01044b60: 0x1044b60: lui   a0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x01044b64: 0x1044b64: lw    a0, 13056(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01044b68: 0x1044b68: addiu v0, v0, 1
	...
	add
	stloc 5
// 0x01044b6c: 0x1044b6c: bne   v0, a0, 0x1044bc0 sw    v0, 13500(v1)
	ldloc 5
	ldloc.1
	ldloc 6
	ldloc 7
...
// 0x01044c10: 0x1044c10: sw    s2, 24(sp)
	...
	ldloc 9
	stelem.i4
// 0x01044c14: 0x1044c14: addiu s0, s0, 13508
	ldloc 5
	ldc.i4 13508
	add
	stloc 5
// 0x01044c18: 0x1044c18: addiu s1, s1, 13772
	ldloc 7
	ldc.i4 13772
	add
	stloc 7
...
// 0x01044c3c: 0x1044c3c: lui   s0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01044c40: 0x1044c40: addiu s0, s0, 13772
	ldloc 5
	ldc.i4 13772
	add
	stloc 5
...
// 0x01044c8c: 0x1044c8c: lui   v0, 0x60000
	ldc.i4 393216
	stloc 7
// 0x01044c90: 0x1044c90: lw    v1, 13504(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01044ca0: 0x1044ca0: lw    s7, 140(sp)
	...
	ldelem.i4
	stloc 16
// 0x01044ca4: 0x1044ca4: sw    v1, 13504(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01044cd8: 0x1044cd8: addu  s4, a2, zero
	ldloc.3
	stloc 12
// 0x01044cdc: 0x1044cdc: lw    v0, -30068(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01044d18: 0x1044d18: lui   v1, 0x60000
	ldc.i4 393216
	stloc 6
// 0x01044d1c: 0x1044d1c: sw    a0, 13504(v1)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01044d24: 0x1044d24: lui   a0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x01044d28: 0x1044d28: lw    a2, 14332(v1)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.3
// 0x01044d2c: 0x1044d2c: addiu a0, a0, 13796
	ldloc.1
	ldc.i4 13796
	add
	stloc.1
...
// 0x01044d54: 0x1044d54: lui   v1, 0x60000
	ldc.i4 393216
	stloc 6
// 0x01044d58: 0x1044d58: addiu v1, v1, 13772
	ldloc 6
	ldc.i4 13772
	add
	stloc 6
...
// 0x01044dc4: 0x1044dc4: lui   v0, 0x60000
	ldc.i4 393216
	stloc 7
// 0x01044dc8: 0x1044dc8: lw    v0, 13504(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01044e10: 0x1044e10: addiu a0, zero, 20
	ldc.i4.s 20
	stloc.1
// 0x01044e14: 0x1044e14: bne   s5, a0, 0x1044ea4 addiu t0, t0, 13772
	ldloc 17
	ldloc.1
	ldloc 18
	ldc.i4 13772
...
// 0x01044e24: 0x1044e24: lui   a0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x01044e28: 0x1044e28: lw    t1, 13504(a0)
	ldloc 5
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01044eb4: 0x1044eb4: lui   v1, 0x60000
	ldc.i4 393216
	stloc 6
// 0x01044eb8: 0x1044eb8: addiu v1, v1, 13772
	ldloc 6
	ldc.i4 13772
	add
	stloc 6
...
// 0x01044f04: 0x1044f04: lw    v1, 0(s6)
	...
	ldelem.i4
	stloc 6
// 0x01044f08: 0x1044f08: addiu s2, s2, 13508
	ldloc 11
	ldc.i4 13508
	add
	stloc 11
...
// 0x01045140: 0x1045140: subu  s6, s6, v0
	...
	sub
	stloc 9
// 0x01045144: 0x1045144: addiu s3, s3, 13508
	ldloc 14
	ldc.i4 13508
	add
	stloc 14
...
// 0x010452b0: 0x10452b0: lui   v1, 0x60000
	ldc.i4 393216
	stloc 6
// 0x010452b4: 0x10452b4: addiu v1, v1, 13508
	ldloc 6
	ldc.i4 13508
	add
	stloc 6
// 0x010452b8: 0x10452b8: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 7
// 0x010452bc: 0x10452bc: lw    v0, -30072(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01045308: 0x1045308: lui   s6, 0x60000
	ldc.i4 393216
	stloc 9
// 0x0104530c: 0x104530c: addiu s6, s6, 13508
	ldloc 9
	ldc.i4 13508
	add
	stloc 9
...
// 0x01045398: 0x1045398: lui   v0, 0x60000
	ldc.i4 393216
	stloc 7
// 0x0104539c: 0x104539c: lw    v0, 13504(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x010453a0: 0x10453a0: addiu v1, v1, 13772
	ldloc 6
	ldc.i4 13772
	add
	stloc 6
