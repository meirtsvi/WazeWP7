...
// 0x01000064: 0x1000064: addiu s0, s0, 30328
	ldloc 5
	ldc.i4 30328
	add
	stloc 5
// 0x01000068: 0x1000068: j	 0x1000080 addiu s1, s1, 30352
	ldloc 8
	ldc.i4 30352
	add
	stloc 8
...
// 0x010000d0: 0x10000d0: addiu s0, s0, 30352
	ldloc 5
	ldc.i4 30352
	add
	stloc 5
// 0x010000d4: 0x10000d4: j	 0x10000ec addiu s1, s1, 30352
	ldloc 7
	ldc.i4 30352
	add
	stloc 7
...
// 0x01000148: 0x1000148: sw    s1, 24(sp)
	...
	ldloc 8
	stelem.i4
// 0x0100014c: 0x100014c: lw    s1, 30352(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01000154: 0x1000154: sw    s0, 20(sp)
	...
	ldloc 7
	stelem.i4
// 0x01000158: 0x1000158: lw    s0, 30356(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010001d0: 0x10001d0: jal   0x10c0be0 sw    v0, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01000224: 0x1000224: addiu a1, zero, 255
	ldc.i4 255
	stloc.2
// 0x01000228: 0x1000228: jal   0x10c0be0 sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100030c: 0x100030c: jal   0x10c0be0 sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01000524: 0x1000524: lui   v0, 0x20000
	ldc.i4 131072
	stloc 4
// 0x01000528: 0x1000528: lw    a2, 30364(v0)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x0100052c: 0x100052c: j	 0x1000540 addiu a3, v0, 30364
	ldloc 4
	ldc.i4 30364
	add
	stloc.3
...
// 0x01000534: 0x1000534: lui   a3, 0x20000
	ldc.i4 131072
	stloc.3
// 0x01000538: 0x1000538: lw    a2, 30368(a3)
	ldloc 5
	ldloc.3
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x0100053c: 0x100053c: addiu a3, a3, 30368
	ldloc.3
	ldc.i4 30368
	add
	stloc.3
...
// 0x010005b8: 0x10005b8: lui   a0, 0x20000
	ldc.i4 131072
	stloc.0
// 0x010005bc: 0x10005bc: lw    a0, 30368(a0)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010005e4: 0x10005e4: lui   a2, 0x20000
	ldc.i4 131072
	stloc.2
// 0x010005e8: 0x10005e8: lw    a3, 30380(a2)
	ldloc 5
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x010005f0: 0x10005f0: addiu a3, a3, -1
	...
	add
	stloc.3
// 0x010005f4: 0x10005f4: sw    a3, 30380(a2)
	ldloc 5
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x010005fc: 0x10005fc: bne   a0, a1, 0x100060c lui   a0, 0x20000
	...
	bne.un L_100060c
// --- basic block ---
// 0x01000604: 0x1000604: j	 0x1000610 sw    a2, 30368(a0)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100062c: 0x100062c: bne   a0, t0, 0x1000648 lui   t0, 0x20000
	...
	bne.un L_1000648
// --- basic block ---
// 0x01000634: 0x1000634: lw    t1, 30376(t0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100063c: 0x100063c: addiu t1, t1, 1
	...
	add
	stloc 8
// 0x01000640: 0x1000640: j	 0x100065c sw    t1, 30376(t0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01000648: 0x1000648: lui   t0, 0x20000
	...
	stloc 7
L_100064c:
// 0x0100064c: 0x100064c: lw    t1, 30380(t0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01000654: 0x1000654: addiu t1, t1, 1
	...
	add
	stloc 8
// 0x01000658: 0x1000658: sw    t1, 30380(t0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100068c: 0x100068c: bne   v1, v0, 0x1000700 lui   v0, 0x20000
	...
	bne.un L_1000700
// --- basic block ---
// 0x01000694: 0x1000694: lw    v0, 30368(v0)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x010006bc: 0x10006bc: lui   a2, 0x20000
	ldc.i4 131072
	stloc.2
// 0x010006c0: 0x10006c0: lw    a3, 30380(a2)
	ldloc 5
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x010006c8: 0x10006c8: addiu a3, a3, -1
	...
	add
	stloc.3
// 0x010006cc: 0x10006cc: sw    a3, 30380(a2)
	ldloc 5
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x010006d4: 0x10006d4: bne   v0, a0, 0x10006e4 lui   v0, 0x20000
	...
	bne.un L_10006e4
// --- basic block ---
// 0x010006dc: 0x10006dc: j	 0x10006e8 sw    a2, 30368(v0)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0100071c: 0x100071c: addiu v1, zero, 1
	ldc.i4.1
	stloc 4
// 0x01000720: 0x1000720: sw    a0, 30368(v0)
	ldloc 3
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01000724: 0x1000724: lui   v0, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01000728: 0x1000728: sw    v1, 30380(v0)
	ldloc 3
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0100072c: 0x100072c: lui   v0, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01000730: 0x1000730: sw    zero, 30364(v0)
	ldloc 3
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01000734: 0x1000734: lui   v0, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01000738: 0x1000738: sw    zero, 30372(v0)
	ldloc 3
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0100073c: 0x100073c: lui   v0, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01000740: 0x1000740: jr    ra sw    zero, 30376(v0)
	ldloc 3
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01000760: 0x1000760: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01000764: 0x1000764: lw    v0, 30360(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01000788: 0x1000788: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100078c: 0x100078c: lw    v0, 30368(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010007ec: 0x10007ec: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010007f0: 0x10007f0: lw    v0, 30360(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01000804: 0x1000804: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01000808: 0x1000808: lw    a3, 30372(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01000840: 0x1000840: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01000844: 0x1000844: lw    a1, 30380(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0100084c: 0x100084c: addiu a1, a1, -1
	...
	add
	stloc.2
// 0x01000850: 0x1000850: sw    a1, 30380(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01000858: 0x1000858: bne   v0, v1, 0x1000868 lui   v0, 0x20000
	...
	bne.un L_1000868
// --- basic block ---
// 0x01000860: 0x1000860: j	 0x100086c sw    a0, 30368(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010008bc: 0x10008bc: lui   v0, 0x20000
	...
	stloc 5
L_10008c0:
// 0x010008c0: 0x10008c0: lw    v0, 30360(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10008ec:
// 0x010008ec: 0x10008ec: lw    a0, 30372(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010008f4: 0x10008f4: addu  s0, s0, a0
	...
	add
	stloc 9
// 0x010008f8: 0x10008f8: sw    s0, 30372(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01000944: 0x1000944: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01000948: 0x1000948: lw    v0, 30360(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01000970: 0x1000970: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01000974: 0x1000974: lw    v0, 30364(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010009a4: 0x10009a4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010009a8: 0x10009a8: lw    v0, 30360(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010009ec: 0x10009ec: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x010009f0: 0x10009f0: lw    a1, 30376(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010009f8: 0x10009f8: addiu a1, a1, -1
	...
	add
	stloc.2
// 0x010009fc: 0x10009fc: sw    a1, 30376(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01000a04: 0x1000a04: bne   v0, v1, 0x1000a14 lui   v0, 0x20000
	...
	bne.un L_1000a14
// --- basic block ---
// 0x01000a0c: 0x1000a0c: j	 0x1000a18 sw    a0, 30364(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01000a28: 0x1000a28: lw    v1, 4(s0)
	...
	ldelem.i4
	stloc 7
// 0x01000a2c: 0x1000a2c: lw    a0, 30372(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01000a34: 0x1000a34: subu  v1, a0, v1
	...
	sub
	stloc 7
// 0x01000a38: 0x1000a38: j	 0x1000a50 sw    v1, 30372(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01000b0c: 0x1000b0c: addiu a2, a2, 20548
	...
	add
	stloc.3
// 0x01000b10: 0x1000b10: addiu a3, a3, 24308
	ldloc 4
	ldc.i4 24308
	add
	stloc 4
...
// 0x01000dd8: 0x1000dd8: jal   0x10c0be0 addiu a1, zero, 256
	ldc.i4 256
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01000e30: 0x1000e30: jal   0x10c0be0 addiu a1, zero, 256
	ldc.i4 256
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01000eac: 0x1000eac: jal   0x10c0be0 sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01000f2c: 0x1000f2c: jal   0x10c0be0 sw    v0, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01000f84: 0x1000f84: jal   0x10c0be0 sw    v0, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01000fb0: 0x1000fb0: jal   0x10c0be0 sw    v0, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
