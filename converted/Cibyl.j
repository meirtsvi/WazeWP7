...
// 0x01000024: 0x1000024: jal   0x100004c sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x0100002c: 0x100002c: jal   0x1050914 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl59::main_1050914(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x010001d0: 0x10001d0: jal   0x10c0c00 sw    v0, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01000224: 0x1000224: addiu a1, zero, 255
	ldc.i4 255
	stloc.2
// 0x01000228: 0x1000228: jal   0x10c0c00 sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100030c: 0x100030c: jal   0x10c0c00 sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01000b0c: 0x1000b0c: addiu a2, a2, 20548
	...
	add
	stloc.3
// 0x01000b10: 0x1000b10: addiu a3, a3, 24036
	ldloc 4
	ldc.i4 24036
	add
	stloc 4
...
// 0x01000dd8: 0x1000dd8: jal   0x10c0c00 addiu a1, zero, 256
	ldc.i4 256
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01000e30: 0x1000e30: jal   0x10c0c00 addiu a1, zero, 256
	ldc.i4 256
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01000eac: 0x1000eac: jal   0x10c0c00 sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01000f2c: 0x1000f2c: jal   0x10c0c00 sw    v0, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01000f84: 0x1000f84: jal   0x10c0c00 sw    v0, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01000fb0: 0x1000fb0: jal   0x10c0c00 sw    v0, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
