...
// 0x01083d38: 0x1083d38: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01083d3c: 0x1083d3c: addiu a0, a0, 17024
	ldloc.1
	ldc.i4 17024
	add
	stloc.1
...
// 0x01083d64: 0x1083d64: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01083d68: 0x1083d68: addiu a0, a0, 17024
	ldloc.1
	ldc.i4 17024
	add
	stloc.1
...
// 0x01083d98: 0x1083d98: lui   s0, 0x0
	ldc.i4.s 0
	stloc 6
// 0x01083d9c: 0x1083d9c: addiu a0, s0, 17024
	ldloc 6
	ldc.i4 17024
	add
	stloc.1
...
// 0x01083dac: 0x1083dac: beq   v0, zero, 0x1083dc8 lui   a1, 0x20000
	...
	brfalse L_1083dc8
// --- basic block ---
// 0x01083db4: 0x1083db4: addiu a0, s0, 17024
	ldloc 6
	ldc.i4 17024
	add
	stloc.1
...
// --- basic block ---
L_1083dc8:
// 0x01083dc8: 0x1083dc8: addiu a0, s0, 17024
	ldloc 6
	ldc.i4 17024
	add
	stloc.1
...
// 0x01083e80: 0x1083e80: addiu a0, s0, 26260
	...
	add
	stloc.1
// 0x01083e84: 0x1083e84: addiu a1, s5, 17040
	ldloc 9
	ldc.i4 17040
	add
	stloc.2
...
// 0x01083eb8: 0x1083eb8: addiu a2, a2, -22368
	...
	add
	stloc.3
// 0x01083ebc: 0x1083ebc: addiu a1, s4, 17056
	ldloc 15
	ldc.i4 17056
	add
	stloc.2
...
// 0x01083ed4: 0x1083ed4: addiu a2, a2, -31180
	...
	add
	stloc.3
// 0x01083ed8: 0x1083ed8: addiu a1, s3, 17072
	ldloc 14
	ldc.i4 17072
	add
	stloc.2
...
// 0x01083ef0: 0x1083ef0: addiu a2, a2, -22360
	...
	add
	stloc.3
// 0x01083ef4: 0x1083ef4: addiu a1, s2, 17088
	ldloc 13
	ldc.i4 17088
	add
	stloc.2
...
// 0x01083f18: 0x1083f18: addiu a0, a0, 12676
	...
	add
	stloc.1
// 0x01083f1c: 0x1083f1c: addiu a1, s1, 17024
	ldloc 12
	ldc.i4 17024
	add
	stloc.2
...
// 0x01083f40: 0x1083f40: lui   s6, 0x80000
	ldc.i4 524288
	stloc 10
// 0x01083f44: 0x1083f44: addiu a0, s5, 17040
	ldloc 9
	ldc.i4 17040
	add
	stloc.1
...
// 0x01083f78: 0x1083f78: jal   0x104f08c addiu a0, a0, -22324
	...
	stloc 5
// --- basic block ---
// 0x01083f80: 0x1083f80: addiu a0, s4, 17056
	ldloc 15
	ldc.i4 17056
	add
	stloc.1
...
// 0x01083fb4: 0x1083fb4: jal   0x104f08c addiu a0, a0, -22296
	...
	stloc 5
// --- basic block ---
// 0x01083fbc: 0x1083fbc: addiu a0, s3, 17072
	ldloc 14
	ldc.i4 17072
	add
	stloc.1
...
// 0x01083ff0: 0x1083ff0: jal   0x104f08c addiu a0, a0, -22268
	...
	stloc 5
// --- basic block ---
// 0x01083ff8: 0x1083ff8: addiu a0, s2, 17088
	ldloc 13
	ldc.i4 17088
	add
	stloc.1
...
// 0x01084040: 0x1084040: jal   0x104ef3c sw    v0, -1916(v1)
	...
	stloc 5
// --- basic block ---
// 0x01084048: 0x1084048: addiu a0, s1, 17024
	ldloc 12
	ldc.i4 17024
	add
	stloc.1
...
// 0x01084054: 0x1084054: beq   v0, zero, 0x1084074 lui   a0, 0x0
	...
	brfalse L_1084074
// --- basic block ---
// 0x0108405c: 0x108405c: jal   0x10146cc addiu a0, a0, 17104
	ldloc.1
	ldc.i4 17104
	add
	stloc.1
...
// 0x010848b0: 0x10848b0: sw    s4, -1908(v1)
	...
	ldloc 8
	stelem.i4
// 0x010848b4: 0x10848b4: jal   0x100844c sw    s4, 17168(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
