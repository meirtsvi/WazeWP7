...
// 0x010345a8: 0x10345a8: lui   a1, 0x10000
	ldc.i4 65536
	stloc.2
// 0x010345ac: 0x10345ac: jal   0x109b44c addiu a1, a1, -25508
	ldloc.2
	ldc.i4 -25508
	add
	stloc.2
...
// 0x010345b8: 0x10345b8: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x010345bc: 0x10345bc: jal   0x1097fa4 addiu a1, a1, 204
	ldloc.2
	ldc.i4 204
	add
	stloc.2
...
// 0x0103474c: 0x103474c: jal   0x106b1b0 addu  s0, a0, zero
	ldloc.1
	stloc 7
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl79::Realtime_IsNewbie_106b1b0(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x01034adc: 0x1034adc: jal   0x106c2dc sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01034b58: 0x1034b58: lui   v1, 0x0
	ldc.i4.s 0
	stloc 5
// 0x01034b5c: 0x1034b5c: jal   0x106e1a8 sw    v0, 12516(v1)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl82::OnMoodChanged_106e1a8(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 5
	stloc 7
// --- basic block ---
...
// 0x01034b98: 0x1034b98: addiu a0, a0, -13724
	...
	add
	stloc.1
// 0x01034b9c: 0x1034b9c: jal   0x10949b8 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01034c0c: 0x1034c0c: beq   v0, zero, 0x1034c2c sll   zero, zero, 0
	...
	brfalse L_1034c2c
// --- basic block ---
// 0x01034c14: 0x1034c14: jal   0x10962c4 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
	...
	stloc 6
// --- basic block ---
// 0x01034c1c: 0x1034c1c: jal   0x1094970 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01034c38: 0x1034c38: addiu a0, a0, -13724
	...
	add
	stloc.1
// 0x01034c3c: 0x1034c3c: jal   0x10949b8 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01034d84: 0x1034d84: beq   v0, zero, 0x1034d98 addiu v1, zero, 1
	...
	brfalse L_1034d98
// --- basic block ---
// 0x01034d8c: 0x1034d8c: jal   0x106b0e4 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01034e20: 0x1034e20: beq   v0, zero, 0x1034e58 sll   zero, zero, 0
	...
	brfalse L_1034e58
// --- basic block ---
// 0x01034e28: 0x1034e28: jal   0x10c0b00 sll   zero, zero, 0
	ldloc.0
	ldloc.1
...
// 0x01034e3c: 0x1034e3c: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x01034e40: 0x1034e40: jal   0x10c08d8 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01034e48: 0x1034e48: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01034e4c: 0x1034e4c: jal   0x10c0a10 addu  a1, v1, zero
	ldloc 6
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01034e90: 0x1034e90: sw    s1, 204(sp)
	...
	ldloc 15
	stelem.i4
// 0x01034e94: 0x1034e94: jal   0x106b1b0 sw    s0, 200(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01034eb8: 0x1034eb8: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x01034ebc: 0x1034ebc: jal   0x1095b3c addiu a3, zero, 8192
	ldc.i4 8192
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x01034ee0: 0x1034ee0: sw    zero, 16(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01034ee4: 0x1034ee4: jal   0x1092884 sw    zero, 20(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01034ef0: 0x1034ef0: addiu a1, zero, 40
	ldc.i4.s 40
	stloc.2
// 0x01034ef4: 0x1034ef4: jal   0x109187c addu  s1, v0, zero
	ldloc 5
	stloc 15
	ldloc.0
	ldloc.1
...
// 0x01034f10: 0x1034f10: sw    zero, 16(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01034f14: 0x1034f14: jal   0x1092884 sw    zero, 20(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01034f24: 0x1034f24: lui   s5, 0x10000
	ldc.i4 65536
	stloc 8
// 0x01034f28: 0x1034f28: jal   0x109187c addu  s2, v0, zero
	ldloc 5
	stloc 10
	ldloc.0
	ldloc.1
...
// 0x01034fe0: 0x1034fe0: sw    zero, 28(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01034fe4: 0x1034fe4: jal   0x10925fc sw    zero, 32(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01035040: 0x1035040: sw    zero, 28(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01035044: 0x1035044: jal   0x10925fc sw    zero, 32(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01035050: 0x1035050: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x01035054: 0x1035054: jal   0x1094480 addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01035074: 0x1035074: addiu a0, a0, -13644
	...
	add
	stloc.1
// 0x01035078: 0x1035078: jal   0x1098e58 addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01035080: 0x1035080: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01035084: 0x1035084: jal   0x109900c addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x01035090: 0x1035090: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x01035094: 0x1035094: jal   0x1094480 addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010350e8: 0x10350e8: addiu a2, zero, 12
	ldc.i4.s 12
	stloc.3
// 0x010350ec: 0x10350ec: jal   0x1098e58 ori   a3, zero, 32776
	ldc.i4.s 0
	ldc.i4 32776
	or
	stloc 4
...
// 0x010350f4: 0x10350f4: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x010350f8: 0x10350f8: jal   0x109900c addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x01035100: 0x1035100: addu  a0, s0, zero
	ldloc 9
	stloc.1
// 0x01035104: 0x1035104: jal   0x109900c addu  a1, s2, zero
	ldloc 10
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x01035110: 0x1035110: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x01035114: 0x1035114: jal   0x1094480 addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01035134: 0x1035134: addiu a0, s2, -13584
	...
	add
	stloc.1
// 0x01035138: 0x1035138: jal   0x1098e58 addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01035140: 0x1035140: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01035144: 0x1035144: jal   0x109900c addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x01035150: 0x1035150: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x01035154: 0x1035154: jal   0x1094480 addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01035170: 0x1035170: addiu a2, zero, 12
	ldc.i4.s 12
	stloc.3
// 0x01035174: 0x1035174: jal   0x1098e58 ori   a3, zero, 32776
	ldc.i4.s 0
	ldc.i4 32776
	or
	stloc 4
...
// 0x0103517c: 0x103517c: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01035180: 0x1035180: jal   0x109900c addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x01035190: 0x1035190: addu  a1, s1, zero
	ldloc 15
	stloc.2
// 0x01035194: 0x1035194: jal   0x109900c lui   s7, 0x10000
	ldc.i4 65536
	stloc 11
	ldloc.1
	ldloc.2
...
// --- basic block ---
L_10351b4:
// 0x010351b4: 0x10351b4: jal   0x1091660 sll   zero, zero, 0
	ldloc.1
	ldloc.2
	call int32 Cibyl108::ssd_list_get_row_1091660(int32,int32)
	stloc 5
// --- basic block ---
...
// 0x010351c0: 0x10351c0: beq   v0, zero, 0x10351e4 addu  a1, s8, zero
	...
	brfalse L_10351e4
// --- basic block ---
// 0x010351c8: 0x10351c8: jal   0x109b44c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010351d4: 0x10351d4: beq   v0, zero, 0x10351e4 addu  a1, s7, zero
	...
	brfalse L_10351e4
// --- basic block ---
// 0x010351dc: 0x10351dc: jal   0x1097c40 sll   zero, zero, 0
	ldloc.1
	ldloc.2
...
// 0x01035214: 0x1035214: sw    zero, 16(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01035218: 0x1035218: jal   0x1092884 sw    zero, 20(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103522c: 0x103522c: sw    zero, 216(s1)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01035230: 0x1035230: jal   0x1094480 addu  s2, v0, zero
	ldloc 5
	stloc 10
	ldloc.0
	ldloc.1
...
// 0x01035250: 0x1035250: addiu a0, s5, -13584
	...
	add
	stloc.1
// 0x01035254: 0x1035254: jal   0x1098e58 addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0103525c: 0x103525c: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01035260: 0x1035260: jal   0x109900c addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x0103526c: 0x103526c: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x01035270: 0x1035270: jal   0x1094480 addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103528c: 0x103528c: ori   a3, zero, 32776
	...
	or
	stloc 4
// 0x01035290: 0x1035290: jal   0x1098e58 addiu a0, s5, -13584
	ldloc 8
	ldc.i4 -13584
	add
	stloc.1
...
// 0x01035298: 0x1035298: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x0103529c: 0x103529c: jal   0x109900c addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x010352a4: 0x10352a4: addu  a0, s0, zero
	ldloc 9
	stloc.1
// 0x010352a8: 0x10352a8: jal   0x109900c addu  a1, s2, zero
	ldloc 10
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x010352b0: 0x10352b0: addu  a0, s2, zero
	ldloc 10
	stloc.1
// 0x010352b4: 0x10352b4: jal   0x109187c addiu a1, zero, 40
	ldc.i4.s 40
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01035378: 0x1035378: sw    zero, 28(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x0103537c: 0x103537c: jal   0x10925fc sw    zero, 32(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010353a0: 0x10353a0: addu  a1, s0, zero
	...
	stloc.2
L_10353a4:
// 0x010353a4: 0x10353a4: jal   0x1091660 addu  a0, s2, zero
	ldloc 10
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x010353b4: 0x10353b4: beq   v0, zero, 0x10353d8 addiu s0, s0, 1
	...
	brfalse L_10353d8
// --- basic block ---
// 0x010353bc: 0x10353bc: jal   0x109b44c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010353c8: 0x10353c8: beq   v0, zero, 0x10353d8 addu  a1, s4, zero
	...
	brfalse L_10353d8
// --- basic block ---
// 0x010353d0: 0x10353d0: jal   0x1097c40 sll   zero, zero, 0
	ldloc.1
	ldloc.2
	call void Cibyl113::ssd_text_set_color_1097c40(int32,int32)
// --- basic block ---
...
// 0x010353e8: 0x10353e8: addiu a0, a0, -13724
	...
	add
	stloc.1
// 0x010353ec: 0x10353ec: jal   0x1096034 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x010353f4: 0x10353f4: jal   0x1094970 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
