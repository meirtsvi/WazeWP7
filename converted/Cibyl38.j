...
// 0x010342f0: 0x10342f0: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x010342f4: 0x10342f4: addiu a1, a1, 12456
	ldloc.2
	ldc.i4 12456
	add
	stloc.2
...
// 0x01034324: 0x1034324: addiu a3, s2, 20820
	...
	add
	stloc 4
// 0x01034328: 0x1034328: addiu a1, a1, 12472
	ldloc.2
	ldc.i4 12472
	add
	stloc.2
...
// 0x01034340: 0x1034340: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x01034344: 0x1034344: addiu a1, a1, 12488
	ldloc.2
	ldc.i4 12488
	add
	stloc.2
...
// 0x01034390: 0x1034390: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x01034394: 0x1034394: addiu a1, a1, 12360
	ldloc.2
	ldc.i4 12360
	add
	stloc.2
...
// 0x010343e0: 0x10343e0: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x010343e4: 0x10343e4: addiu a0, a0, 12472
	ldloc.1
	ldc.i4 12472
	add
	stloc.1
...
// 0x010345a8: 0x10345a8: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x010345ac: 0x10345ac: addiu a0, a0, 12488
	ldloc.1
	ldc.i4 12488
	add
	stloc.1
...
// 0x01034654: 0x1034654: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x01034658: 0x1034658: addiu a1, s0, 12516
	ldloc 5
	ldc.i4 12516
	add
	stloc.2
...
// 0x01034668: 0x1034668: jal   0x100edd0 addu  a3, zero, zero
	...
	stloc 8
// --- basic block ---
// 0x01034670: 0x1034670: jal   0x100e368 addiu a0, s0, 12516
	ldloc 5
	ldc.i4 12516
	add
	stloc.1
...
// 0x01034a3c: 0x1034a3c: lui   s0, 0x0
	ldc.i4.s 0
	stloc 7
// 0x01034a40: 0x1034a40: lw    v1, 12512(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01034a58: 0x1034a58: jal   0x10346e8 addu  a0, v0, zero
	...
	stloc 5
// --- basic block ---
// 0x01034a60: 0x1034a60: sw    v0, 12512(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01034a68: 0x1034a68: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x01034a6c: 0x1034a6c: lw    v0, 12512(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01034ad0: 0x1034ad0: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x01034ad4: 0x1034ad4: addiu a1, s1, 12516
	ldloc 9
	ldc.i4 12516
	add
	stloc.2
...
// 0x01034ae4: 0x1034ae4: addu  a1, s0, zero
	ldloc 8
	stloc.2
// 0x01034ae8: 0x1034ae8: jal   0x100e5e0 addiu a0, s1, 12516
	ldloc 9
	ldc.i4 12516
	add
	stloc.1
...
// 0x01034b00: 0x1034b00: lui   v1, 0x0
	ldc.i4.s 0
	stloc 5
// 0x01034b04: 0x1034b04: jal   0x106e2dc sw    v0, 12512(v1)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01034ce4: 0x1034ce4: addiu a0, a0, 12676
	...
	add
	stloc.1
// 0x01034ce8: 0x1034ce8: addiu a1, a1, 12532
	ldloc.2
	ldc.i4 12532
	add
	stloc.2
...
// 0x01034d00: 0x1034d00: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01034d04: 0x1034d04: addiu a1, s1, 12516
	ldloc 9
	ldc.i4 12516
	add
	stloc.2
...
// 0x01034d10: 0x1034d10: jal   0x100edd0 addu  a3, zero, zero
	...
	stloc 5
// --- basic block ---
// 0x01034d18: 0x1034d18: jal   0x100e368 addiu a0, s1, 12516
	ldloc 9
	ldc.i4 12516
	add
	stloc.1
...
// 0x01034d78: 0x1034d78: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01034d7c: 0x1034d7c: jal   0x100e368 addiu a0, a0, 12516
	ldloc.1
	ldc.i4 12516
	add
	stloc.1
...
// 0x01034db0: 0x1034db0: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01034db4: 0x1034db4: jal   0x100e7a8 addiu a0, a0, 12532
	ldloc.1
	ldc.i4 12532
	add
	stloc.1
...
// 0x0103526c: 0x103526c: addiu s5, s5, -17388
	...
	add
	stloc 8
// 0x01035270: 0x1035270: sw    s4, 12508(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
