...
// 0x01098d10: 0x1098d10: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01098d14: 0x1098d14: addiu a1, a1, 21796
	ldloc.2
	ldc.i4 21796
	add
	stloc.2
...
// 0x01098ea8: 0x1098ea8: jal   0x1097ec8 addu  s2, v0, zero
	...
	stloc 5
// --- basic block ---
// 0x01098eb0: 0x1098eb0: lw    v0, 10012(s4)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01098edc: 0x1098edc: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01098ee0: 0x1098ee0: lw    a0, 29828(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01098ee4: 0x1098ee4: lui   v1, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01098ee8: 0x1098ee8: jal   0x104ee2c sw    v0, 10016(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01098f14: 0x1098f14: addu  a0, s6, zero
	ldloc 14
	stloc.1
// 0x01098f18: 0x1098f18: jal   0x104e050 sw    v0, 10004(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01098f20: 0x1098f20: lui   v1, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01098f24: 0x1098f24: sw    v0, 10008(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldloc 5
	stelem.i4
// 0x01098f28: 0x1098f28: sw    s5, 10012(s4)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01099344: 0x1099344: lui   v0, 0x80000
	ldc.i4 524288
	stloc.1
// 0x01099348: 0x1099348: jr    ra sw    a0, 10020(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0109951c: 0x109951c: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x01099520: 0x1099520: lw    v0, -30068(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01099524: 0x1099524: lui   v1, 0xf0000
	ldc.i4 983040
	stloc 7
// 0x01099528: 0x1099528: lw    s3, -30072(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0109952c: 0x109952c: lui   s2, 0x80000
	ldc.i4 524288
	stloc 10
// 0x01099530: 0x1099530: jal   0x1042450 sw    v0, 10024(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01099538: 0x1099538: subu  v0, s3, v0
	...
	sub
	stloc 5
// 0x0109953c: 0x109953c: addiu a2, s2, 10024
	ldloc 10
	ldc.i4 10024
	add
	stloc.3
...
// 0x01099590: 0x1099590: bne   v0, v1, 0x10995f8 lui   v0, 0xf0000
	...
	bne.un L_10995f8
// --- basic block ---
// 0x01099598: 0x1099598: lw    v1, -30068(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010995a8: 0x10995a8: beq   a0, zero, 0x10995c4 lui   a0, 0xf0000
	...
	brfalse L_10995c4
// --- basic block ---
// 0x010995b0: 0x10995b0: lw    a0, -30072(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010995c4: 0x10995c4: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x010995c8: 0x10995c8: lw    v0, -30072(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010996a8: 0x10996a8: lui   s4, 0xf0000
	ldc.i4 983040
	stloc 11
// 0x010996ac: 0x10996ac: lw    v1, -30072(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x010996b0: 0x10996b0: lw    v0, -30068(s4)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010996e8: 0x10996e8: jal   0x109914c addu  a0, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x010996f0: 0x10996f0: lw    v1, -30068(s4)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
