...
// 0x010b6a7c: 0x10b6a7c: beq   v1, zero, 0x10b6a98 lui   v0, 0xe0000
	...
	brfalse L_10b6a98
// --- basic block ---
// 0x010b6a84: 0x10b6a84: lw    a0, -17860(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10b6a98:
// 0x010b6a98: 0x10b6a98: lw    a0, -17860(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b6b7c: 0x10b6b7c: beq   v1, zero, 0x10b6b98 lui   v0, 0xe0000
	...
	brfalse L_10b6b98
// --- basic block ---
// 0x010b6b84: 0x10b6b84: lw    a0, -17860(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10b6b98:
// 0x010b6b98: 0x10b6b98: lw    a0, -17860(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010b6cb0: 0x10b6cb0: lui   a1, 0x20000000
	ldc.i4 536870912
	stloc.2
// 0x010b6cb4: 0x10b6cb4: lw    a0, -17856(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010b6cd4: 0x10b6cd4: bltz  v0, 0x10b6cf0 addiu a1, sp, 16
	...
	blt L_10b6cf0
// --- basic block ---
// 0x010b6cdc: 0x10b6cdc: lw    a0, -17856(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010b6cf4: 0x10b6cf4: lui   a3, 0x20000
	ldc.i4 131072
	stloc 4
// 0x010b6cf8: 0x10b6cf8: addiu a1, a1, 19536
	ldloc.2
	ldc.i4 19536
	add
	stloc.2
// 0x010b6cfc: 0x10b6cfc: addiu a3, a3, 19568
	ldloc 4
	ldc.i4 19568
	add
	stloc 4
...
// 0x010b6d6c: 0x10b6d6c: lui   s2, 0xe0000
	ldc.i4 917504
	stloc 10
// 0x010b6d70: 0x10b6d70: lw    a0, -17856(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010b6d90: 0x10b6d90: beq   v1, v0, 0x10b6dac addiu a1, sp, 48
	...
	beq  L_10b6dac
// --- basic block ---
// 0x010b6d98: 0x10b6d98: lw    a0, -17856(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010b6db8: 0x10b6db8: bne   v0, zero, 0x10b6dd8 lui   v0, 0xe0000
	...
	brtrue L_10b6dd8
// --- basic block ---
// 0x010b6dc0: 0x10b6dc0: lw    a0, -17856(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b6de0: 0x10b6de0: beq   v0, zero, 0x10b6e00 lui   v0, 0xe0000
	...
	brfalse L_10b6e00
// --- basic block ---
// 0x010b6de8: 0x10b6de8: lw    a0, -17856(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b6e10: 0x10b6e10: lw    a1, 16(s0)
	...
	ldelem.i4
	stloc.2
// 0x010b6e14: 0x10b6e14: lw    a0, -17856(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010b6e60: 0x10b6e60: jal   0x100177c addu  a2, s0, zero
	...
	stloc 5
// --- basic block ---
// 0x010b6e68: 0x10b6e68: lw    a0, -17856(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10b6e80:
// 0x010b6e80: 0x10b6e80: lw    a0, -17852(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010b6e88: 0x10b6e88: addiu a0, a0, 1
	...
	add
	stloc.1
// 0x010b6e8c: 0x10b6e8c: sw    a0, -17852(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010b6e90: 0x10b6e90: bne   a0, a1, 0x10b6ea4 addu  v0, zero, zero
	...
	bne.un L_10b6ea4
// --- basic block ---
// 0x010b6e98: 0x10b6e98: j	 0x10b6ea4 sw    zero, -17852(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010b6fc4: 0x10b6fc4: lui   a3, 0x20000
	ldc.i4 131072
	stloc 4
// 0x010b6fc8: 0x10b6fc8: addiu a1, a1, 19536
	ldloc.2
	ldc.i4 19536
	add
	stloc.2
// 0x010b6fcc: 0x10b6fcc: addiu a3, a3, 19632
	ldloc 4
	ldc.i4 19632
	add
	stloc 4
...
// 0x010b7358: 0x10b7358: sll   v0, v0, 2
	...
	shl
	stloc 6
// 0x010b735c: 0x10b735c: addiu v1, v1, -17768
	ldloc 7
	ldc.i4 -17768
	add
	stloc 7
// 0x010b7360: 0x10b7360: addiu a0, a0, -17848
	ldloc.1
	ldc.i4 -17848
	add
	stloc.1
...
// 0x010b7534: 0x10b7534: addu  a0, s0, zero
	ldloc 8
	stloc.1
// 0x010b7538: 0x10b7538: jal   0x1000f9c addiu a2, a2, 19684
	ldloc.3
	ldc.i4 19684
	add
	stloc.3
...
// 0x010b7560: 0x10b7560: addu  a2, v0, zero
	ldloc 5
	stloc.3
// 0x010b7564: 0x10b7564: addiu a3, a3, -19944
	ldloc 4
	ldc.i4 -19944
	add
	stloc 4
...
// 0x010b7578: 0x10b7578: addu  a0, s0, zero
	ldloc 8
	stloc.1
// 0x010b757c: 0x10b757c: jal   0x104c5f4 addiu a1, a1, 19364
	ldloc.2
	ldc.i4 19364
	add
	stloc.2
...
// 0x010b760c: 0x10b760c: sw    s0, 20(sp)
	...
	ldloc 7
	stelem.i4
// 0x010b7610: 0x10b7610: addiu s1, s1, -17768
	ldloc 8
	ldc.i4 -17768
	add
	stloc 8
// 0x010b7614: 0x10b7614: addiu s5, s5, -17688
	ldloc 11
	ldc.i4 -17688
	add
	stloc 11
...
// 0x010b76c4: 0x10b76c4: lui   s1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x010b76c8: 0x10b76c8: lw    v0, 19284(s1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010b76e0: 0x10b76e0: jal   0x10b75e8 lui   s0, 0xe0000
	...
	stloc 9
// --- basic block ---
// 0x010b76e8: 0x10b76e8: lw    a0, -17856(s0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010b76ec: 0x10b76ec: jal   0x104d5dc sll   zero, zero, 0
	...
	stloc 9
// --- basic block ---
// 0x010b76f4: 0x10b76f4: sw    s2, 19284(s1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldloc 8
	stelem.i4
// 0x010b76f8: 0x10b76f8: sw    zero, -17856(s0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010b7720: 0x10b7720: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x010b7724: 0x10b7724: addiu a0, a0, 3272
	ldloc.1
	ldc.i4 3272
	add
	stloc.1
...
// 0x010b775c: 0x10b775c: lui   a3, 0x20000
	ldc.i4 131072
	stloc 4
// 0x010b7760: 0x10b7760: addiu a1, a1, 19536
	ldloc.2
	ldc.i4 19536
	add
	stloc.2
// 0x010b7764: 0x10b7764: addiu a3, a3, 19696
	ldloc 4
	ldc.i4 19696
	add
	stloc 4
...
// 0x010b7784: 0x10b7784: addu  a0, s2, zero
	ldloc 10
	stloc.1
// 0x010b7788: 0x10b7788: addiu a2, a2, 19684
	ldloc.3
	ldc.i4 19684
	add
	stloc.3
...
// 0x010b77cc: 0x10b77cc: jal   0x104deb0 addiu a1, a1, 20776
	...
	stloc 5
// --- basic block ---
// 0x010b77d4: 0x10b77d4: sw    v0, -17856(s2)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010b77ec: 0x10b77ec: addu  a0, s1, zero
	ldloc 9
	stloc.1
// 0x010b77f0: 0x10b77f0: jal   0x104deb0 addiu a1, a1, 15592
	ldloc.2
	ldc.i4 15592
	add
	stloc.2
...
// 0x010b77fc: 0x10b77fc: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x010b7800: 0x10b7800: addiu a1, a1, 30224
	ldloc.2
	ldc.i4 30224
	add
	stloc.2
// 0x010b7804: 0x10b7804: addiu a2, zero, 4
	ldc.i4.4
	stloc.3
// 0x010b7808: 0x10b7808: jal   0x104d5fc sw    v0, -17856(s2)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010b7814: 0x10b7814: lui   s8, 0xe0000
	ldc.i4 917504
	stloc 16
// 0x010b7818: 0x10b7818: lw    a0, -17856(s8)
	ldloc 7
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x010b782c: 0x10b782c: addiu v0, sp, 28
	...
	add
	stloc 5
// 0x010b7830: 0x10b7830: addiu a1, a1, 19536
	ldloc.2
	ldc.i4 19536
	add
	stloc.2
// 0x010b7834: 0x10b7834: addiu a3, a3, 19720
	ldloc 4
	ldc.i4 19720
	add
	stloc 4
...
// 0x010b7888: 0x10b7888: addiu v0, zero, 1024
	...
	stloc 5
L_10b788c:
// 0x010b788c: 0x10b788c: lw    a0, -17856(s8)
	ldloc 7
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x010b7a50: 0x10b7a50: lui   a3, 0x20000
	ldc.i4 131072
	stloc 4
// 0x010b7a54: 0x10b7a54: addiu a1, a1, 19536
	ldloc.2
	ldc.i4 19536
	add
	stloc.2
// 0x010b7a58: 0x10b7a58: addiu a3, a3, 19760
	ldloc 4
	ldc.i4 19760
	add
	stloc 4
...
// 0x010b7a68: 0x10b7a68: lui   a2, 0xe0000
	ldc.i4 917504
	stloc.3
// 0x010b7a6c: 0x10b7a6c: addiu a2, a2, -17768
	ldloc.3
	ldc.i4 -17768
	add
	stloc.3
...
// 0x010b7a84: 0x10b7a84: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x010b7a88: 0x10b7a88: addiu a1, a1, 19536
	ldloc.2
	ldc.i4 19536
	add
	stloc.2
// 0x010b7a8c: 0x10b7a8c: addiu a3, a3, 19800
	ldloc 4
	ldc.i4 19800
	add
	stloc 4
...
// 0x010b7b0c: 0x10b7b0c: addiu a2, zero, 479
	ldc.i4 479
	stloc.3
// 0x010b7b10: 0x10b7b10: addiu a3, a3, 19852
	ldloc 4
	ldc.i4 19852
	add
	stloc 4
// 0x010b7b14: 0x10b7b14: addiu a1, a1, 19536
	ldloc.2
	ldc.i4 19536
	add
	stloc.2
// 0x010b7b18: 0x10b7b18: jal   0x100449c addiu a0, zero, 4
	...
	stloc 5
// --- basic block ---
// 0x010b7b20: 0x10b7b20: lw    a0, -17856(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010b7b3c: 0x10b7b3c: addu  a0, s1, zero
	ldloc 9
	stloc.1
// 0x010b7b40: 0x10b7b40: jal   0x104deb0 addiu a1, a1, 15592
	ldloc.2
	ldc.i4 15592
	add
	stloc.2
...
// 0x010b7b4c: 0x10b7b4c: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x010b7b50: 0x10b7b50: addiu a1, a1, 30224
	ldloc.2
	ldc.i4 30224
	add
	stloc.2
// 0x010b7b54: 0x10b7b54: addiu a2, zero, 4
	ldc.i4.4
	stloc.3
// 0x010b7b58: 0x10b7b58: jal   0x104d5fc sw    v0, -17856(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010b7b60: 0x10b7b60: lui   v0, 0x0
	...
	stloc 5
L_10b7b64:
// 0x010b7b64: 0x10b7b64: sw    s6, 19284(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b7b9c: 0x10b7b9c: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b7ba0: 0x10b7ba0: lw    v1, 19284(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b7bcc: 0x10b7bcc: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 6
// 0x010b7bd0: 0x10b7bd0: addiu v0, v0, -17768
	ldloc 5
	ldc.i4 -17768
	add
	stloc 5
// 0x010b7bd4: 0x10b7bd4: addiu v1, v1, -17688
	ldloc 6
	ldc.i4 -17688
	add
	stloc 6
...
// 0x010b7be0: 0x10b7be0: bne   v0, v1, 0x10b7bd8 lui   a0, 0x0
	...
	bne.un L_10b7bd8
// --- basic block ---
// 0x010b7be8: 0x10b7be8: jal   0x10b72b0 addiu a0, a0, 19172
	ldloc.1
	ldc.i4 19172
	add
	stloc.1
...
// 0x010b7bf0: 0x10b7bf0: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010b7bf4: 0x10b7bf4: jal   0x10b72b0 addiu a0, a0, 19156
	ldloc.1
	ldc.i4 19156
	add
	stloc.1
...
// 0x010b7bfc: 0x10b7bfc: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010b7c00: 0x10b7c00: jal   0x10b72b0 addiu a0, a0, 19188
	ldloc.1
	ldc.i4 19188
	add
	stloc.1
...
// 0x010b7c08: 0x10b7c08: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010b7c0c: 0x10b7c0c: jal   0x10b72b0 addiu a0, a0, 19204
	ldloc.1
	ldc.i4 19204
	add
	stloc.1
...
// 0x010b7c14: 0x10b7c14: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010b7c18: 0x10b7c18: jal   0x10b72b0 addiu a0, a0, 19252
	ldloc.1
	ldc.i4 19252
	add
	stloc.1
...
// 0x010b7c20: 0x10b7c20: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010b7c24: 0x10b7c24: jal   0x10b72b0 addiu a0, a0, 19236
	ldloc.1
	ldc.i4 19236
	add
	stloc.1
...
// 0x010b7c2c: 0x10b7c2c: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010b7c30: 0x10b7c30: jal   0x10b72b0 addiu a0, a0, 19268
	ldloc.1
	ldc.i4 19268
	add
	stloc.1
...
// 0x010b7c38: 0x10b7c38: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010b7c3c: 0x10b7c3c: jal   0x10b72b0 addiu a0, a0, 19220
	ldloc.1
	ldc.i4 19220
	add
	stloc.1
