...
// 0x01048d98: 0x1048d98: lui   v1, 0x60000
	ldc.i4 393216
	stloc 7
// 0x01048d9c: 0x1048d9c: sw    v0, 20512(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0104920c: 0x104920c: lui   a1, 0x60000
	ldc.i4 393216
	stloc.2
// 0x01049210: 0x1049210: addiu a1, a1, 20624
	ldloc.2
	ldc.i4 20624
	add
	stloc.2
...
// 0x01049370: 0x1049370: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01049374: 0x1049374: lw    a3, 23948(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01049378: 0x1049378: lw    a2, 23944(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010494d4: 0x10494d4: lui   a1, 0x60000
	ldc.i4 393216
	stloc.2
// 0x010494d8: 0x10494d8: addiu a1, a1, 20624
	ldloc.2
	ldc.i4 20624
	add
	stloc.2
...
// 0x01049638: 0x1049638: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0104963c: 0x104963c: lw    a3, 23948(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01049640: 0x1049640: lw    a2, 23944(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01049728: 0x1049728: beq   s0, zero, 0x10498a4 lui   s1, 0x60000
	...
	brfalse L_10498a4
// --- basic block ---
// 0x01049730: 0x1049730: addiu s1, s1, 20624
	ldloc 11
	ldc.i4 20624
	add
	stloc 11
...
// 0x01049888: 0x1049888: lui   v1, 0x10000
	ldc.i4 65536
	stloc 6
// 0x0104988c: 0x104988c: addiu v0, v0, 20624
	ldloc 7
	ldc.i4 20624
	add
	stloc 7
...
// 0x01049980: 0x1049980: jal   0x1094bd4 addu  s0, v0, zero
	...
	stloc 5
// --- basic block ---
// 0x01049988: 0x1049988: lw    a0, 20588(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0104998c: 0x104998c: jal   0x1001ba8 addiu s2, s2, 20588
	ldloc 10
	ldc.i4 20588
	add
	stloc 10
...
// 0x01049b90: 0x1049b90: sw    s5, 44(sp)
	...
	ldloc 13
	stelem.i4
// 0x01049b94: 0x1049b94: addiu s4, s4, 20624
	ldloc 12
	ldc.i4 20624
	add
	stloc 12
...
// 0x01049b9c: 0x1049b9c: sw    v0, 16(sp)
	...
	ldloc 6
	stelem.i4
// 0x01049ba0: 0x1049ba0: addiu s0, s0, 21000
	ldloc 8
	ldc.i4 21000
	add
	stloc 8
...
// 0x01049c04: 0x1049c04: bne   v0, zero, 0x1049c60 sll   zero, zero, 0
	...
	brtrue L_1049c60
// --- basic block ---
// 0x01049c0c: 0x1049c0c: lw    v0, 20584(s2)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01049c28: 0x1049c28: addu  a1, s3, zero
	ldloc 10
	stloc.2
// 0x01049c2c: 0x1049c2c: jal   0x1051a4c sw    v0, 20584(s2)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1049c44:
// 0x01049c44: 0x1049c44: lw    a0, 20584(s2)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01049c68: 0x1049c68: lui   v1, 0x70000
	ldc.i4 458752
	stloc 7
// 0x01049c6c: 0x1049c6c: addiu v1, v1, 20624
	ldloc 7
	ldc.i4 20624
	add
	stloc 7
...
// 0x01049e28: 0x1049e28: addu  s6, a3, zero
	ldloc 4
	stloc 15
// 0x01049e2c: 0x1049e2c: beq   s1, zero, 0x1049e48 addiu a0, v0, 20588
	ldloc 8
	ldloc 5
	ldc.i4 20588
	add
...
// 0x01049e50: 0x1049e50: sw    v1, 12(a0)
	...
	ldloc 6
	stelem.i4
// 0x01049e54: 0x1049e54: sw    v1, 20588(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01049e60: 0x1049e60: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01049e64: 0x1049e64: addiu v0, v0, 20588
	ldloc 5
	ldc.i4 20588
	add
	stloc 5
...
// 0x01049e88: 0x1049e88: lui   s0, 0x60000
	ldc.i4 393216
	stloc 10
// 0x01049e8c: 0x1049e8c: jal   0x101cd80 sw    v0, 20528(s0)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x01049e94: 0x1049e94: addiu s0, s0, 20528
	ldloc 10
	ldc.i4 20528
	add
	stloc 10
...
// 0x01049ea4: 0x1049ea4: lui   a1, 0x60000
	ldc.i4 393216
	stloc.2
// 0x01049ea8: 0x1049ea8: addiu a0, a2, 20536
	ldloc.3
	ldc.i4 20536
	add
	stloc.1
// 0x01049eac: 0x1049eac: beq   v0, zero, 0x1049f44 addiu v1, a1, 20560
	ldloc 5
	ldloc.2
	ldc.i4 20560
	add
...
// 0x01049eb8: 0x1049eb8: addiu v0, v0, 1968
	...
	add
	stloc 5
// 0x01049ebc: 0x1049ebc: sw    v0, 20536(a2)
	ldloc 7
	ldloc.3
	ldc.i4.2
	shr.un
...
// 0x01049ed0: 0x1049ed0: addiu v0, v0, 2008
	...
	add
	stloc 5
// 0x01049ed4: 0x1049ed4: sw    v0, 20560(a1)
	ldloc 7
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01049f48: 0x1049f48: addiu v0, v0, -15264
	...
	add
	stloc 5
// 0x01049f4c: 0x1049f4c: sw    v0, 20536(a2)
	ldloc 7
	ldloc.3
	ldc.i4.2
	shr.un
...
// 0x01049f60: 0x1049f60: addiu v0, v0, 2092
	...
	add
	stloc 5
// 0x01049f64: 0x1049f64: sw    v0, 20560(a1)
	ldloc 7
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0104a358: 0x104a358: addiu s5, zero, 2
	ldc.i4.2
	stloc 12
// 0x0104a35c: 0x104a35c: lw    a2, -30068(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0104a3fc: 0x104a3fc: lui   t2, 0x60000
	ldc.i4 393216
	stloc 19
// 0x0104a400: 0x104a400: addiu t2, t2, 20536
	ldloc 19
	ldc.i4 20536
	add
	stloc 19
// 0x0104a404: 0x104a404: addiu a3, a3, 20560
	ldloc 4
	ldc.i4 20560
	add
	stloc 4
...
// 0x0104a4b8: 0x104a4b8: lw    t1, 40(sp)
	...
	ldelem.i4
	stloc 17
// 0x0104a4bc: 0x104a4bc: lw    a2, -30068(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0104a554: 0x104a554: addiu v1, v1, 13620
	...
	add
	stloc 6
// 0x0104a558: 0x104a558: addiu a3, a3, 20528
	ldloc 4
	ldc.i4 20528
	add
	stloc 4
