...
// 0x010697a4: 0x10697a4: lw    a0, 32(sp)
	...
	ldelem.i4
	stloc.1
// 0x010697a8: 0x10697a8: jal   0x10ac754 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0106989c: 0x106989c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010698a0: 0x10698a0: addiu v0, v0, 16552
	ldloc 5
	ldc.i4 16552
	add
	stloc 5
...
// 0x01069a5c: 0x1069a5c: bne   a0, zero, 0x1069a94 sll   zero, zero, 0
	...
	brtrue L_1069a94
// --- basic block ---
// 0x01069a64: 0x1069a64: jal   0x10ac754 addu  a0, a2, zero
	ldloc.3
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01069f48: 0x1069f48: lui   a2, 0x20000
	ldc.i4 131072
	stloc.3
// 0x01069f4c: 0x1069f4c: addiu a2, a2, 20060
	ldloc.3
	ldc.i4 20060
	add
	stloc.3
