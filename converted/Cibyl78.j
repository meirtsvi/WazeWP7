...
// 0x0106946c: 0x106946c: addiu a1, a1, 5588
	...
	add
	stloc.2
// 0x01069470: 0x1069470: addiu a2, a2, 212
	ldloc.3
	ldc.i4 212
	add
	stloc.3
...
// 0x010697a4: 0x10697a4: lw    a0, 32(sp)
	...
	ldelem.i4
	stloc.1
// 0x010697a8: 0x10697a8: jal   0x10ac74c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0106989c: 0x106989c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010698a0: 0x10698a0: addiu v0, v0, 16560
	ldloc 5
	ldc.i4 16560
	add
	stloc 5
...
// 0x01069a5c: 0x1069a5c: bne   a0, zero, 0x1069a94 sll   zero, zero, 0
	...
	brtrue L_1069a94
// --- basic block ---
// 0x01069a64: 0x1069a64: jal   0x10ac74c addu  a0, a2, zero
	ldloc.3
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01069f48: 0x1069f48: lui   a2, 0x20000
	ldc.i4 131072
	stloc.3
// 0x01069f4c: 0x1069f4c: addiu a2, a2, 20068
	ldloc.3
	ldc.i4 20068
	add
	stloc.3
...
// 0x0106a154: 0x106a154: addu  a2, s1, zero
	ldloc 8
	stloc.3
// 0x0106a158: 0x106a158: jal   0x10c0e50 sw    v0, 32(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
