...
// 0x0101e684: 0x101e684: addiu a1, v0, 27588
	ldloc 6
	ldc.i4 27588
	add
	stloc.2
// 0x0101e688: 0x101e688: addiu s1, s1, -28540
	ldloc 9
	ldc.i4 -28540
	add
	stloc 9
// 0x0101e68c: 0x101e68c: lw    s0, 27588(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e69c: 0x101e69c: lui   s8, 0x0
	ldc.i4.s 0
	stloc 16
// 0x0101e6a0: 0x101e6a0: addiu s7, s2, 27596
	ldloc 10
	ldc.i4 27596
	add
	stloc 15
...
// 0x0101e6b8: 0x101e6b8: bne   v0, zero, 0x101e790 sll   zero, zero, 0
	...
	brtrue L_101e790
// --- basic block ---
// 0x0101e6c0: 0x101e6c0: lw    v0, 27560(s4)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x0101e6d0: 0x101e6d0: lw    v0, 24(s0)
	...
	ldelem.i4
	stloc 6
// 0x0101e6d4: 0x101e6d4: sw    zero, 27560(s4)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
	...
	ldc.i4.s 0
	stelem.i4
// 0x0101e6d8: 0x101e6d8: sw    v0, 27596(s2)
	ldloc 5
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0101e6dc: 0x101e6dc: lw    v0, 28(s0)
	...
	ldelem.i4
	stloc 6
// 0x0101e6e0: 0x101e6e0: sw    zero, 27572(s6)
	ldloc 5
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x0101e6e4: 0x101e6e4: sw    v0, 4(s7)
	...
	ldloc 6
	stelem.i4
// 0x0101e6e8: 0x101e6e8: sw    zero, 27564(s5)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x0101e77c: 0x101e77c: lw    a1, 20(sp)
	...
	ldelem.i4
	stloc.2
// 0x0101e780: 0x101e780: sw    s3, 27576(v1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101e79c: 0x101e79c: bne   s0, a1, 0x101e6b0 lui   v0, 0x30000
	...
	bne.un L_101e6b0
// --- basic block ---
// 0x0101e7a4: 0x101e7a4: lw    v0, 27576(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e804: 0x101e804: lw    s0, 32(sp)
	...
	ldelem.i4
	stloc 7
// 0x0101e808: 0x101e808: sw    v1, 27576(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e840: 0x101e840: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101e844: 0x101e844: lw    v0, 27560(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e874: 0x101e874: sw    s0, 56(sp)
	...
	ldloc 9
	stelem.i4
// 0x0101e878: 0x101e878: lw    s4, 27556(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101e888: 0x101e888: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101e88c: 0x101e88c: lw    v0, 27588(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e89c: 0x101e89c: lui   s8, 0x0
	ldc.i4.s 0
	stloc 16
// 0x0101e8a0: 0x101e8a0: addiu s0, s0, -28540
	ldloc 9
	ldc.i4 -28540
	add
	stloc 9
// 0x0101e8a4: 0x101e8a4: addiu s5, s5, 6336
	ldloc 11
	ldc.i4 6336
	add
	stloc 11
...
// 0x0101e9f0: 0x101e9f0: beq   v0, zero, 0x101eac4 sll   zero, zero, 0
	...
	brfalse L_101eac4
// --- basic block ---
// 0x0101e9f8: 0x101e9f8: jal   0x10bf298 sw    a1, 48(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl143::editor_screen_overide_car_10bf298(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 6
// --- basic block ---
...
// 0x0101ea04: 0x101ea04: bne   v0, zero, 0x101ea44 addu  a2, v0, zero
	...
	brtrue L_101ea44
// --- basic block ---
// 0x0101ea0c: 0x101ea0c: jal   0x104dfe8 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101ea1c: 0x101ea1c: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0101ea20: 0x101ea20: jal   0x10a4610 sw    v0, 44(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ea2c: 0x101ea2c: sw    v0, 48(sp)
	...
	ldloc 6
	stelem.i4
// 0x0101ea30: 0x101ea30: jal   0x104db28 addu  a0, v1, zero
	ldloc 7
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101ea44: 0x101ea44: addiu a1, zero, 1
	ldc.i4.1
	stloc.2
// 0x0101ea48: 0x101ea48: jal   0x10a4610 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101ea64: 0x101ea64: sw    a1, 48(sp)
	...
	ldloc.2
	stelem.i4
// 0x0101ea68: 0x101ea68: jal   0x104f4b0 sw    a2, 44(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ea8c: 0x101ea8c: subu  a2, a2, v0
	...
	sub
	stloc.3
// 0x0101ea90: 0x101ea90: jal   0x104f4d4 sw    a2, 24(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101eb38: 0x101eb38: addu  a0, zero, zero
	...
	stloc.1
L_101eb3c:
// 0x0101eb3c: 0x101eb3c: jal   0x10a4610 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101eb54: 0x101eb54: sw    a2, 44(sp)
	...
	ldloc.3
	stelem.i4
// 0x0101eb58: 0x101eb58: jal   0x104f4b0 sw    v0, 48(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101eb7c: 0x101eb7c: subu  a2, a2, v0
	...
	sub
	stloc.3
// 0x0101eb80: 0x101eb80: jal   0x104f4d4 sw    a2, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ebac: 0x101ebac: sw    v1, 20(sp)
	...
	stelem.i4
L_101ebb0:
// 0x0101ebb0: 0x101ebb0: jal   0x1050a58 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101ec24: 0x101ec24: lw    v0, 32(sp)
	...
	ldelem.i4
	stloc 6
// 0x0101ec28: 0x101ec28: addiu v1, v1, 27588
	ldloc 7
	ldc.i4 27588
	add
	stloc 7
...
// 0x0101ec34: 0x101ec34: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101ec38: 0x101ec38: lw    a1, 27568(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101ec50: 0x101ec50: lui   a0, 0xe0000
	ldc.i4 917504
	stloc.1
// 0x0101ec54: 0x101ec54: addiu a0, a0, -28540
	ldloc.1
	ldc.i4 -28540
	add
	stloc.1
...
// 0x0101ed5c: 0x101ed5c: jal   0x1021a4c sw    zero, 27564(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101ee00: 0x101ee00: lui   s1, 0x30000
	ldc.i4 196608
	stloc 9
// 0x0101ee04: 0x101ee04: lw    v0, 27560(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101ee30: 0x101ee30: lui   v1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x0101ee34: 0x101ee34: sw    s0, 27560(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101ee40: 0x101ee40: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101ee44: 0x101ee44: lw    v0, 27556(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101ee4c: 0x101ee4c: beq   s0, v0, 0x101ee6c lui   v0, 0x30000
	...
	beq  L_101ee6c
// --- basic block ---
// 0x0101ee54: 0x101ee54: lw    v0, 27564(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101eee0: 0x101eee0: sw    s0, 32(sp)
	...
	ldloc 8
	stelem.i4
// 0x0101eee4: 0x101eee4: lw    s0, 27564(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101ef18: 0x101ef18: lui   s3, 0x10000
	ldc.i4 65536
	stloc 9
// 0x0101ef1c: 0x101ef1c: addiu s5, v0, 27588
	ldloc 6
	ldc.i4 27588
	add
	stloc 14
...
// 0x0101ef24: 0x101ef24: addiu s3, s3, -29572
	...
	add
	stloc 9
// 0x0101ef28: 0x101ef28: lw    s8, 27588(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101efe4: 0x101efe4: jal   0x101dfec lui   s0, 0x30000
	...
	stloc 5
// --- basic block ---
// 0x0101efec: 0x101efec: beq   v0, zero, 0x101f020 sw    v0, 27564(s0)
	ldloc 5
	ldloc 6
	ldloc 8
	ldc.i4.2
...
// 0x0101f000: 0x101f000: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101f004: 0x101f004: beq   v0, zero, 0x101f01c sw    v0, 27572(v1)
	ldloc 5
	ldloc 6
	ldloc 7
	ldc.i4.2
...
// --- basic block ---
L_101f01c:
// 0x0101f01c: 0x101f01c: sw    zero, 27564(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101f044: 0x101f044: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101f048: 0x101f048: beq   v0, zero, 0x101f070 sw    v0, 27572(v1)
	ldloc 5
	ldloc 7
	ldloc 6
	ldc.i4.2
...
// 0x0101f05c: 0x101f05c: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101f060: 0x101f060: beq   v0, zero, 0x101f070 sw    v0, 27564(v1)
	ldloc 5
	ldloc 7
	ldloc 6
	ldc.i4.2
...
// 0x0101f0b8: 0x101f0b8: addiu s1, s1, 4892
	...
	add
	stloc 9
// 0x0101f0bc: 0x101f0bc: addiu s6, s6, 27588
	ldloc 13
	ldc.i4 27588
	add
	stloc 13
...
// 0x0101f17c: 0x101f17c: lui   s0, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101f180: 0x101f180: jal   0x100e5a4 sw    v0, 27556(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101f190: 0x101f190: bne   v0, zero, 0x101f19c sll   zero, zero, 0
	...
	brtrue L_101f19c
// --- basic block ---
// 0x0101f198: 0x101f198: lw    v0, 27556(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101f23c:
// 0x0101f23c: 0x101f23c: lw    v0, 27560(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101f244: 0x101f244: beq   v0, s1, 0x101f274 lui   v1, 0x30000
	...
	beq  L_101f274
// --- basic block ---
// 0x0101f24c: 0x101f24c: lw    v1, 27572(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101f254: 0x101f254: beq   v1, s1, 0x101f26c lui   v1, 0x30000
	...
	beq  L_101f26c
// --- basic block ---
// 0x0101f25c: 0x101f25c: lw    v1, 27564(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101f278: 0x101f278: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101f27c: 0x101f27c: sw    a0, 27596(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101f280: 0x101f280: lw    v0, 28(v0)
	...
	ldelem.i4
	stloc 5
// 0x0101f284: 0x101f284: addiu v1, v1, 27596
	ldloc 6
	ldc.i4 27596
	add
	stloc 6
...
// 0x0101f28c: 0x101f28c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101f290: 0x101f290: sw    zero, 27560(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101f294: 0x101f294: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101f298: 0x101f298: sw    zero, 27572(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101f29c: 0x101f29c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101f2a0: 0x101f2a0: sw    zero, 27564(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101f2a4: 0x101f2a4: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0101f2a8: 0x101f2a8: addiu v0, v0, -28540
	ldloc 5
	ldc.i4 -28540
	add
	stloc 5
...
// 0x0101f330: 0x101f330: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101f334: 0x101f334: jal   0x10215b8 sw    v1, 27576(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101f380: 0x101f380: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101f384: 0x101f384: lw    a1, 27560(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101f54c: 0x101f54c: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0101f550: 0x101f550: addiu v0, v0, -28540
	ldloc 5
	ldc.i4 -28540
	add
	stloc 5
...
// 0x0101f5ac: 0x101f5ac: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101f5b0: 0x101f5b0: lw    a1, 27592(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101f5c0: 0x101f5c0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101f5c4: 0x101f5c4: j	 0x101f65c sw    v1, 27576(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101f638: 0x101f638: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101f63c: 0x101f63c: lw    v1, 27560(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101f644: 0x101f644: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x0101f648: 0x101f648: bne   s4, v1, 0x101f658 sw    v0, 27576(a0)
	ldloc 8
	ldloc 7
	ldloc 6
	ldloc.1
