...
// 0x010453f8: 0x10453f8: sw    s4, 152(sp)
	...
	ldloc 9
	stelem.i4
// 0x010453fc: 0x10453fc: lw    s4, -30052(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0104542c: 0x104542c: addu  s1, a2, zero
	ldloc.3
	stloc 14
// 0x01045430: 0x1045430: lw    s8, -30056(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010454a0: 0x10454a0: lw    v1, 72(sp)
	...
	ldelem.i4
	stloc 7
// 0x010454a4: 0x10454a4: beq   s5, a0, 0x1045540 addiu s6, s6, 13524
	ldloc 11
	ldloc.1
	ldloc 13
	ldc.i4 13524
...
// 0x01045600: 0x1045600: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01045604: 0x1045604: addiu v0, v0, 13524
	ldloc 5
	ldc.i4 13524
	add
	stloc 5
...
// 0x01045724: 0x1045724: lui   s4, 0x60000
	ldc.i4 393216
	stloc 9
// 0x01045728: 0x1045728: addiu s4, s4, 13524
	ldloc 9
	ldc.i4 13524
	add
	stloc 9
...
// 0x010458d0: 0x10458d0: lui   v1, 0x60000
	ldc.i4 393216
	stloc 7
// 0x010458d4: 0x10458d4: addiu v1, v1, 13524
	ldloc 7
	ldc.i4 13524
	add
	stloc 7
...
// 0x01045948: 0x1045948: lw    a0, 200(sp)
	...
	ldelem.i4
	stloc.1
// 0x0104594c: 0x104594c: addiu a2, a2, 29620
	ldloc.3
	ldc.i4 29620
	add
	stloc.3
...
// --- basic block ---
L_10459b0:
// 0x010459b0: 0x10459b0: addiu s4, s4, 13524
	ldloc 9
	ldc.i4 13524
	add
	stloc 9
...
// 0x01045a70: 0x1045a70: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01045a74: 0x1045a74: addiu v0, v0, 13524
	ldloc 5
	ldc.i4 13524
	add
	stloc 5
...
// 0x01045aac: 0x1045aac: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01045ab0: 0x1045ab0: addiu v0, v0, 13524
	ldloc 5
	ldc.i4 13524
	add
	stloc 5
...
// 0x01045b64: 0x1045b64: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01045b68: 0x1045b68: addiu v0, v0, 13524
	ldloc 5
	ldc.i4 13524
	add
	stloc 5
...
// 0x01045ba8: 0x1045ba8: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01045bac: 0x1045bac: addiu v0, v0, 13524
	ldloc 5
	ldc.i4 13524
	add
	stloc 5
...
// 0x01045cf8: 0x1045cf8: sw    s0, 28(sp)
	...
	ldloc 10
	stelem.i4
// 0x01045cfc: 0x1045cfc: addiu s2, s2, 27800
	ldloc 8
	ldc.i4 27800
	add
	stloc 8
// 0x01045d00: 0x1045d00: addiu s1, s1, 13524
	ldloc 7
	ldc.i4 13524
	add
	stloc 7
// 0x01045d04: 0x1045d04: addiu s3, s3, 27888
	ldloc 9
	ldc.i4 27888
	add
	stloc 9
...
// 0x01045d10: 0x1045d10: addiu a1, zero, 3
	ldc.i4.3
	stloc.2
// 0x01045d14: 0x1045d14: jal   0x10a1a64 addu  a2, s0, zero
	ldloc 10
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01045d74: 0x1045d74: lui   v0, 0x60000
	ldc.i4 393216
	stloc 6
// 0x01045d78: 0x1045d78: sw    zero, 14348(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01046484: 0x1046484: jal   0x10940f8 sll   zero, zero, 0
...
// 0x0104665c: 0x104665c: lui   v0, 0x60000
	...
	stloc 5
L_1046660:
// 0x01046660: 0x1046660: lw    v0, 20528(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01046680: 0x1046680: lui   a0, 0x20000
	...
	stloc.1
L_1046684:
// 0x01046684: 0x1046684: jal   0x101df70 addiu a0, a0, 6956
	ldloc.1
	ldc.i4 6956
	add
	stloc.1
