...
// 0x0104fa60: 0x104fa60: addu  v1, v0, zero
	ldloc 5
	stloc 8
// 0x0104fa64: 0x104fa64: jal   0x10a4a3c sw    a3, 24(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010504c0: 0x10504c0: addu  s2, a2, zero
	ldloc.3
	stloc 10
// 0x010504c4: 0x10504c4: jal   0x10940c4 addu  s3, a3, zero
	ldloc 4
	stloc 12
...
// 0x01050a5c: 0x1050a5c: bne   a0, v0, 0x1050a6c sw    ra, 20(sp)
	...
	bne.un L_1050a6c
// --- basic block ---
// 0x01050a64: 0x1050a64: jal   0x10ac8ec sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl129::editor_main_check_map_10ac8ec(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 8
	stloc 5
// --- basic block ---
