...
// 0x01050470: 0x1050470: lui   s1, 0x0
	ldc.i4.s 0
	stloc 8
// 0x01050474: 0x1050474: lw    v0, 13844(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010504a0: 0x10504a0: jal   0x100449c sw    s0, 16(sp)
	...
	stloc 5
// --- basic block ---
// 0x010504a8: 0x10504a8: sw    s0, 13844(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01050ba4: 0x1050ba4: lui   s0, 0x0
	ldc.i4.s 0
	stloc 8
// 0x01050ba8: 0x1050ba8: lw    v0, 13824(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01050bc0: 0x1050bc0: addiu a2, a2, -16908
	...
	add
	stloc.3
// 0x01050bc4: 0x1050bc4: addiu a1, s1, 13808
	ldloc 9
	ldc.i4 13808
	add
	stloc.2
...
// 0x01050bcc: 0x1050bcc: jal   0x100edd0 addiu a0, a0, 12676
	...
	stloc 6
// --- basic block ---
// 0x01050bd4: 0x1050bd4: jal   0x100e7a8 addiu a0, s1, 13808
	ldloc 9
	ldc.i4 13808
	add
	stloc.1
...
// 0x01050bf0: 0x1050bf0: addu  v1, v0, zero
	ldloc 6
	stloc 7
// 0x01050bf4: 0x1050bf4: sw    zero, 13824(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01050c20: 0x1050c20: addiu a2, a2, 4656
	...
	add
	stloc.3
// 0x01050c24: 0x1050c24: addiu a1, s0, 13828
	ldloc 6
	ldc.i4 13828
	add
	stloc.2
...
// 0x01050c30: 0x1050c30: jal   0x100edd0 addiu a0, a0, -26772
	...
	stloc 7
// --- basic block ---
// 0x01050c38: 0x1050c38: jal   0x100e7a8 addiu a0, s0, 13828
	ldloc 6
	ldc.i4 13828
	add
	stloc.1
