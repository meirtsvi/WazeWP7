...
// 0x0101a200: 0x101a200: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x0101a204: 0x101a204: lw    s2, -30036(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a4d4: 0x101a4d4: bne   s0, a0, 0x101a4f0 lui   v0, 0xf0000
	...
	bne.un L_101a4f0
// --- basic block ---
// 0x0101a4dc: 0x101a4dc: lw    v0, -30036(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101a4f0:
// 0x0101a4f0: 0x101a4f0: lw    v0, -30036(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a590: 0x101a590: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101a594: 0x101a594: lw    a0, 26788(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a5b4: 0x101a5b4: bne   s0, v0, 0x101a5c8 lui   v0, 0x30000
	...
	bne.un L_101a5c8
// --- basic block ---
// 0x0101a5bc: 0x101a5bc: lw    a0, 26780(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a5c8: 0x101a5c8: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101a5cc: 0x101a5cc: lw    a0, 26772(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a5f4: 0x101a5f4: bne   s0, v0, 0x101a610 lui   v0, 0x30000
	...
	bne.un L_101a610
// --- basic block ---
// 0x0101a5fc: 0x101a5fc: lw    a0, 26792(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a614: 0x101a614: bne   s0, v0, 0x101a628 lui   v0, 0x30000
	...
	bne.un L_101a628
// --- basic block ---
// 0x0101a61c: 0x101a61c: lw    a0, 26784(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a628: 0x101a628: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101a62c: 0x101a62c: lw    a0, 26776(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a74c: 0x101a74c: addiu s0, s0, 2480
	...
	add
	stloc 8
// 0x0101a750: 0x101a750: addiu s2, s2, 29636
	ldloc 12
	ldc.i4 29636
	add
	stloc 12
...
// 0x0101a770: 0x101a770: beq   a0, zero, 0x101a798 lui   a3, 0x30000
	...
	brfalse L_101a798
// --- basic block ---
// 0x0101a778: 0x101a778: lw    a1, 26764(a3)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0101a81c: 0x101a81c: lw    a1, 24(sp)
	...
	ldelem.i4
	stloc.2
// 0x0101a820: 0x101a820: lw    v0, -30036(s8)
	ldloc 5
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x0101a834: 0x101a834: sw    a1, 24(sp)
	...
	ldloc.2
	stelem.i4
// 0x0101a838: 0x101a838: lw    v1, -30040(a3)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0101acb4: 0x101acb4: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101acb8: 0x101acb8: lw    a0, 26768(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101ae2c: 0x101ae2c: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101ae30: 0x101ae30: addiu v1, v1, 26796
	ldloc 6
	ldc.i4 26796
	add
	stloc 6
...
// 0x0101aea8: 0x101aea8: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x0101aeac: 0x101aeac: addiu v1, v1, 26796
	ldloc 6
	ldc.i4 26796
	add
	stloc 6
...
// 0x0101af50: 0x101af50: sll   v0, s0, 2
	...
	shl
	stloc 5
// 0x0101af54: 0x101af54: addiu s1, s1, 26796
	ldloc 8
	ldc.i4 26796
	add
	stloc 8
...
// 0x0101af80: 0x101af80: lui   v0, 0x30000
	...
	stloc 5
L_101af84:
// 0x0101af84: 0x101af84: addiu v0, v0, 26796
	ldloc 5
	ldc.i4 26796
	add
	stloc 5
...
// 0x0101affc: 0x101affc: addu  s1, s0, a1
	...
	add
	stloc 10
// 0x0101b000: 0x101b000: addiu s5, s5, 26796
	ldloc 9
	ldc.i4 26796
	add
	stloc 9
...
// 0x0101b534: 0x101b534: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x0101b538: 0x101b538: addiu v1, v1, 24724
	ldloc 7
	ldc.i4 24724
	add
	stloc 7
...
// 0x0101b71c: 0x101b71c: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0101b720: 0x101b720: lw    v1, 27320(s7)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x0101b724: 0x101b724: lw    v0, 27324(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0101b738: 0x101b738: sw    v0, 8(s0)
	...
	ldloc 5
	stelem.i4
// 0x0101b73c: 0x101b73c: sw    s0, 27320(s7)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
