...
// 0x0101a1dc: 0x101a1dc: sw    s7, 112(sp)
	...
	ldloc 7
	stelem.i4
// 0x0101a1e0: 0x101a1e0: jal   0x109a634 sw    s6, 108(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a200: 0x101a200: sw    v0, 16(sp)
	...
	ldloc 5
	stelem.i4
// 0x0101a204: 0x101a204: jal   0x104ea5c sw    zero, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a2c0: 0x101a2c0: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0101a2c4: 0x101a2c4: jal   0x10a1b28 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101a2cc: 0x101a2cc: beq   v0, zero, 0x101a330 addu  s6, v0, zero
	...
	brfalse L_101a330
// --- basic block ---
// 0x0101a2d4: 0x101a2d4: jal   0x109a634 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101a2f0: 0x101a2f0: addiu s7, s7, -12
	...
	add
	stloc 7
// 0x0101a2f4: 0x101a2f4: jal   0x104e0a4 addu  s7, s7, s2
	ldloc 7
	ldloc 10
	add
	stloc 7
...
// 0x0101a304: 0x101a304: lw    s7, 64(sp)
	...
	ldelem.i4
	stloc 7
// 0x0101a308: 0x101a308: jal   0x104e0c8 addu  a0, s6, zero
	ldloc 12
	stloc.1
	ldloc.1
...
// 0x0101a324: 0x101a324: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0101a328: 0x101a328: jal   0x104f64c sw    v0, 72(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a338: 0x101a338: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0101a33c: 0x101a33c: jal   0x10a1b28 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101a354: 0x101a354: addiu v0, v0, 4
	...
	add
	stloc 5
// 0x0101a358: 0x101a358: jal   0x109a634 sw    v0, 72(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a378: 0x101a378: addiu s7, s7, -12
	...
	add
	stloc 7
// 0x0101a37c: 0x101a37c: jal   0x104e0a4 addu  a0, s6, zero
	ldloc 12
	stloc.1
	ldloc.1
	call int32 Cibyl57::roadmap_canvas_image_width_104e0a4(int32)
...
// 0x0101a398: 0x101a398: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x0101a39c: 0x101a39c: jal   0x104f64c addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x0101a3a4: 0x101a3a4: lw    a0, 64(s0)
	...
	ldelem.i4
	stloc.1
// 0x0101a3a8: 0x101a3a8: jal   0x104e450 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	...
	stloc 5
// --- basic block ---
// 0x0101a3b0: 0x101a3b0: jal   0x109a634 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101a4c4: 0x101a4c4: sw    v0, 16(sp)
	...
	ldloc 5
	stelem.i4
// 0x0101a4c8: 0x101a4c8: jal   0x104ea5c sw    zero, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a544: 0x101a544: addu  s2, v0, zero
	ldloc 5
	stloc 8
// 0x0101a548: 0x101a548: jal   0x1053928 addu  s2, s3, s2
	ldloc 11
	ldloc 8
	add
	stloc 8
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl62::roadmap_message_ticker_height_1053928(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x0101a59c: 0x101a59c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101a5a0: 0x101a5a0: lw    a0, 26916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0101a5a4: 0x101a5a4: jal   0x104e450 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	...
	stloc 5
// --- basic block ---
// 0x0101a5ac: 0x101a5ac: jal   0x104e504 addiu a0, zero, 181
	ldc.i4 181
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101a5c0: 0x101a5c0: bne   s0, v0, 0x101a5d4 lui   v0, 0x30000
	...
	bne.un L_101a5d4
// --- basic block ---
// 0x0101a5c8: 0x101a5c8: lw    a0, 26908(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a5d4: 0x101a5d4: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101a5d8: 0x101a5d8: lw    a0, 26900(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	stloc.1
L_101a5dc:
// 0x0101a5dc: 0x101a5dc: jal   0x104e450 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101a5f0: 0x101a5f0: addiu a3, zero, 1
	ldc.i4.1
	stloc 4
// 0x0101a5f4: 0x101a5f4: jal   0x104f074 sw    zero, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a600: 0x101a600: bne   s0, v0, 0x101a61c lui   v0, 0x30000
	...
	bne.un L_101a61c
// --- basic block ---
// 0x0101a608: 0x101a608: lw    a0, 26920(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0101a60c: 0x101a60c: jal   0x104e450 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101a620: 0x101a620: bne   s0, v0, 0x101a634 lui   v0, 0x30000
	...
	bne.un L_101a634
// --- basic block ---
// 0x0101a628: 0x101a628: lw    a0, 26912(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a634: 0x101a634: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101a638: 0x101a638: lw    a0, 26904(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	stloc.1
L_101a63c:
// 0x0101a63c: 0x101a63c: jal   0x104e450 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101a650: 0x101a650: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0101a654: 0x101a654: jal   0x104f074 sw    zero, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a6a8: 0x101a6a8: addiu a2, zero, 12
	...
	stloc.3
L_101a6ac:
// 0x0101a6ac: 0x101a6ac: jal   0x104eb54 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// --- basic block ---
L_101a6bc:
// 0x0101a6bc: 0x101a6bc: jal   0x104ecf0 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101a77c: 0x101a77c: beq   a0, zero, 0x101a7a4 lui   a3, 0x30000
	...
	brfalse L_101a7a4
// --- basic block ---
// 0x0101a784: 0x101a784: lw    a1, 26892(a3)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0101a81c: 0x101a81c: sw    v0, 16(sp)
	...
	ldloc 6
	stelem.i4
// 0x0101a820: 0x101a820: jal   0x104ea5c sw    zero, 20(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101aa60: 0x101aa60: jal   0x10163f0 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101aa68: 0x101aa68: jal   0x1053928 sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101aab0: 0x101aab0: jal   0x10163f0 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101aab8: 0x101aab8: jal   0x1053928 sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101aae0: 0x101aae0: jal   0x10163f0 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101aae8: 0x101aae8: jal   0x1053928 sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101abe4: 0x101abe4: jal   0x10163f0 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101abec: 0x101abec: jal   0x1053928 sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ac18: 0x101ac18: jal   0x10163f0 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101ac20: 0x101ac20: jal   0x1053928 sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ac94: 0x101ac94: lw    a0, 60(s0)
	...
	ldelem.i4
	stloc.1
// 0x0101ac98: 0x101ac98: jal   0x104e450 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	...
	stloc 6
// --- basic block ---
// 0x0101aca0: 0x101aca0: jal   0x104e504 addiu a0, zero, 181
	ldc.i4 181
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101acb4: 0x101acb4: addiu a0, zero, 1
	ldc.i4.1
	stloc.1
// 0x0101acb8: 0x101acb8: jal   0x104f074 sw    zero, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101acc0: 0x101acc0: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101acc4: 0x101acc4: lw    a0, 26896(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0101acc8: 0x101acc8: jal   0x104e450 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101acdc: 0x101acdc: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0101ace0: 0x101ace0: jal   0x104f074 sw    zero, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101acf0: 0x101acf0: beq   a2, zero, 0x101ad54 addiu a1, zero, 1
	...
	brfalse L_101ad54
// --- basic block ---
// 0x0101acf8: 0x101acf8: jal   0x10a1b28 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101ad20: 0x101ad20: mflo  lo
	ldloc 9
	stloc 11
// 0x0101ad24: 0x101ad24: jal   0x104e0a4 addu  s3, s3, v0
	ldloc 11
	ldloc 6
	add
	stloc 11
...
// 0x0101ad48: 0x101ad48: subu  s3, s3, v0
	...
	sub
	stloc 11
// 0x0101ad4c: 0x101ad4c: jal   0x104f64c sw    s3, 52(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ad54: 0x101ad54: lw    a0, 64(s0)
	...
	ldelem.i4
	stloc.1
// 0x0101ad58: 0x101ad58: jal   0x104e450 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101ae38: 0x101ae38: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101ae3c: 0x101ae3c: addiu v1, v1, 26924
	ldloc 6
	ldc.i4 26924
	add
	stloc 6
...
// 0x0101aeb4: 0x101aeb4: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x0101aeb8: 0x101aeb8: addiu v1, v1, 26924
	ldloc 6
	ldc.i4 26924
	add
	stloc 6
...
// 0x0101af5c: 0x101af5c: sll   v0, s0, 2
	...
	shl
	stloc 5
// 0x0101af60: 0x101af60: addiu s1, s1, 26924
	ldloc 8
	ldc.i4 26924
	add
	stloc 8
...
// 0x0101af8c: 0x101af8c: lui   v0, 0x30000
	...
	stloc 5
L_101af90:
// 0x0101af90: 0x101af90: addiu v0, v0, 26924
	ldloc 5
	ldc.i4 26924
	add
	stloc 5
...
// 0x0101afac: 0x101afac: addiu a1, zero, 100
	ldc.i4.s 100
	stloc.2
// 0x0101afb0: 0x101afb0: jal   0x10c0f10 sw    v0, 24(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101b008: 0x101b008: addu  s1, s0, a1
	...
	add
	stloc 10
// 0x0101b00c: 0x101b00c: addiu s5, s5, 26924
	ldloc 9
	ldc.i4 26924
	add
	stloc 9
...
// 0x0101b540: 0x101b540: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x0101b544: 0x101b544: addiu v1, v1, 25188
	ldloc 7
	ldc.i4 25188
	add
	stloc 7
...
// 0x0101b640: 0x101b640: addu  a0, s2, zero
	ldloc 12
	stloc.1
// 0x0101b644: 0x101b644: jal   0x104eff4 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101b64c: 0x101b64c: sw    v0, 4(s5)
	...
	ldloc 5
	stelem.i4
// 0x0101b650: 0x101b650: jal   0x104eea4 addu  a0, s6, zero
	ldloc 11
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101b658: 0x101b658: lw    a0, 2584(sp)
	...
	ldelem.i4
	stloc.1
// 0x0101b65c: 0x101b65c: jal   0x104de04 sll   zero, zero, 0
	ldloc.1
...
// 0x0101b728: 0x101b728: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0101b72c: 0x101b72c: lw    v1, 27448(s7)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x0101b730: 0x101b730: lw    v0, 27452(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0101b744: 0x101b744: sw    v0, 8(s0)
	...
	ldloc 5
	stelem.i4
// 0x0101b748: 0x101b748: sw    s0, 27448(s7)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
