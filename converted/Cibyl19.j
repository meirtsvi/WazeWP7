...
// 0x0101a1d0: 0x101a1d0: sw    s7, 112(sp)
	...
	ldloc 7
	stelem.i4
// 0x0101a1d4: 0x101a1d4: jal   0x109a378 sw    s6, 108(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a1f4: 0x101a1f4: sw    v0, 16(sp)
	...
	ldloc 5
	stelem.i4
// 0x0101a1f8: 0x101a1f8: jal   0x104eb40 sw    zero, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a200: 0x101a200: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x0101a204: 0x101a204: lw    s2, -30004(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a248: 0x101a248: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x0101a24c: 0x101a24c: jal   0x1042410 sw    v0, 52(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a298: 0x101a298: addiu t0, t0, -31112
	...
	add
	stloc 13
// 0x0101a29c: 0x101a29c: jal   0x1045568 sw    t0, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a2b4: 0x101a2b4: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0101a2b8: 0x101a2b8: jal   0x10a186c addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101a2c0: 0x101a2c0: beq   v0, zero, 0x101a324 addu  s6, v0, zero
	...
	brfalse L_101a324
// --- basic block ---
// 0x0101a2c8: 0x101a2c8: jal   0x109a378 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101a2e4: 0x101a2e4: addiu s7, s7, -12
	...
	add
	stloc 7
// 0x0101a2e8: 0x101a2e8: jal   0x104e188 addu  s7, s7, s2
	ldloc 7
	ldloc 10
	add
	stloc 7
...
// 0x0101a2f8: 0x101a2f8: lw    s7, 64(sp)
	...
	ldelem.i4
	stloc 7
// 0x0101a2fc: 0x101a2fc: jal   0x104e1ac addu  a0, s6, zero
	ldloc 12
	stloc.1
	ldloc.1
...
// 0x0101a318: 0x101a318: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0101a31c: 0x101a31c: jal   0x104f730 sw    v0, 72(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a32c: 0x101a32c: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0101a330: 0x101a330: jal   0x10a186c addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101a348: 0x101a348: addiu v0, v0, 4
	...
	add
	stloc 5
// 0x0101a34c: 0x101a34c: jal   0x109a378 sw    v0, 72(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a36c: 0x101a36c: addiu s7, s7, -12
	...
	add
	stloc 7
// 0x0101a370: 0x101a370: jal   0x104e188 addu  a0, s6, zero
	ldloc 12
	stloc.1
	ldloc.1
	call int32 Cibyl57::roadmap_canvas_image_width_104e188(int32)
...
// 0x0101a38c: 0x101a38c: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x0101a390: 0x101a390: jal   0x104f730 addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x0101a398: 0x101a398: lw    a0, 64(s0)
	...
	ldelem.i4
	stloc.1
// 0x0101a39c: 0x101a39c: jal   0x104e534 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	...
	stloc 5
// --- basic block ---
// 0x0101a3a4: 0x101a3a4: jal   0x109a378 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101a3c0: 0x101a3c0: sw    v0, 44(sp)
	...
	stelem.i4
L_101a3c4:
// 0x0101a3c4: 0x101a3c4: jal   0x1042410 addu  s4, s5, s4
	ldloc 16
	ldloc 15
	add
	stloc 15
...
// 0x0101a4b8: 0x101a4b8: sw    v0, 16(sp)
	...
	ldloc 5
	stelem.i4
// 0x0101a4bc: 0x101a4bc: jal   0x104eb40 sw    zero, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a4d4: 0x101a4d4: bne   s0, a0, 0x101a4f0 lui   v0, 0xf0000
	...
	bne.un L_101a4f0
// --- basic block ---
// 0x0101a4dc: 0x101a4dc: lw    v0, -30004(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101a4f0:
// 0x0101a4f0: 0x101a4f0: lw    v0, -30004(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a520: 0x101a520: beq   v0, zero, 0x101a554 sw    v1, 64(sp)
	...
	brfalse L_101a554
// --- basic block ---
// 0x0101a528: 0x101a528: jal   0x1042410 sll   zero, zero, 0
	call int32 Cibyl48::roadmap_bar_top_height_1042410()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
...
// 0x0101a538: 0x101a538: addu  s2, v0, zero
	ldloc 5
	stloc 8
// 0x0101a53c: 0x101a53c: jal   0x1053a0c addu  s2, s3, s2
	ldloc 11
	ldloc 8
	add
	stloc 8
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl62::roadmap_message_ticker_height_1053a0c(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x0101a590: 0x101a590: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101a594: 0x101a594: lw    a0, 26820(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0101a598: 0x101a598: jal   0x104e534 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	...
	stloc 5
// --- basic block ---
// 0x0101a5a0: 0x101a5a0: jal   0x104e5e8 addiu a0, zero, 181
	ldc.i4 181
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101a5b4: 0x101a5b4: bne   s0, v0, 0x101a5c8 lui   v0, 0x30000
	...
	bne.un L_101a5c8
// --- basic block ---
// 0x0101a5bc: 0x101a5bc: lw    a0, 26812(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a5c8: 0x101a5c8: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101a5cc: 0x101a5cc: lw    a0, 26804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	stloc.1
L_101a5d0:
// 0x0101a5d0: 0x101a5d0: jal   0x104e534 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101a5e4: 0x101a5e4: addiu a3, zero, 1
	ldc.i4.1
	stloc 4
// 0x0101a5e8: 0x101a5e8: jal   0x104f158 sw    zero, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a5f4: 0x101a5f4: bne   s0, v0, 0x101a610 lui   v0, 0x30000
	...
	bne.un L_101a610
// --- basic block ---
// 0x0101a5fc: 0x101a5fc: lw    a0, 26824(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0101a600: 0x101a600: jal   0x104e534 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101a614: 0x101a614: bne   s0, v0, 0x101a628 lui   v0, 0x30000
	...
	bne.un L_101a628
// --- basic block ---
// 0x0101a61c: 0x101a61c: lw    a0, 26816(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a628: 0x101a628: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101a62c: 0x101a62c: lw    a0, 26808(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	stloc.1
L_101a630:
// 0x0101a630: 0x101a630: jal   0x104e534 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101a644: 0x101a644: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0101a648: 0x101a648: jal   0x104f158 sw    zero, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a69c: 0x101a69c: addiu a2, zero, 12
	...
	stloc.3
L_101a6a0:
// 0x0101a6a0: 0x101a6a0: jal   0x104ec38 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// --- basic block ---
L_101a6b0:
// 0x0101a6b0: 0x101a6b0: jal   0x104edd4 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101a74c: 0x101a74c: addiu s0, s0, 2480
	...
	add
	stloc 8
// 0x0101a750: 0x101a750: addiu s2, s2, 29668
	ldloc 12
	ldc.i4 29668
	add
	stloc 12
...
// 0x0101a770: 0x101a770: beq   a0, zero, 0x101a798 lui   a3, 0x30000
	...
	brfalse L_101a798
// --- basic block ---
// 0x0101a778: 0x101a778: lw    a1, 26796(a3)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0101a810: 0x101a810: sw    v0, 16(sp)
	...
	ldloc 6
	stelem.i4
// 0x0101a814: 0x101a814: jal   0x104eb40 sw    zero, 20(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a81c: 0x101a81c: lw    a1, 24(sp)
	...
	ldelem.i4
	stloc.2
// 0x0101a820: 0x101a820: lw    v0, -30004(s8)
	ldloc 5
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x0101a834: 0x101a834: sw    a1, 24(sp)
	...
	ldloc.2
	stelem.i4
// 0x0101a838: 0x101a838: lw    v1, -30008(a3)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101aa4c:
// 0x0101aa4c: 0x101aa4c: jal   0x1042410 sll   zero, zero, 0
	call int32 Cibyl48::roadmap_bar_top_height_1042410()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 6
...
// 0x0101aa54: 0x101aa54: jal   0x10163e4 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101aa5c: 0x101aa5c: jal   0x1053a0c sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101aa98: 0x101aa98: sw    v0, 56(sp)
	...
	stelem.i4
L_101aa9c:
// 0x0101aa9c: 0x101aa9c: jal   0x1042410 sll   zero, zero, 0
	call int32 Cibyl48::roadmap_bar_top_height_1042410()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 6
...
// 0x0101aaa4: 0x101aaa4: jal   0x10163e4 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101aaac: 0x101aaac: jal   0x1053a0c sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101aac8: 0x101aac8: addu  v1, v1, v0
	...
	add
	stloc 7
// 0x0101aacc: 0x101aacc: jal   0x1042410 sw    v1, 84(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101aad4: 0x101aad4: jal   0x10163e4 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101aadc: 0x101aadc: jal   0x1053a0c sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101ab04:
// 0x0101ab04: 0x101ab04: jal   0x1042444 sw    v1, 112(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ab18: 0x101ab18: subu  v0, v1, v0
	...
	sub
	stloc 6
// 0x0101ab1c: 0x101ab1c: jal   0x1042444 sw    v0, 68(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101abb4:
// 0x0101abb4: 0x101abb4: jal   0x1042444 sw    v1, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101abd0:
// 0x0101abd0: 0x101abd0: jal   0x1042410 sll   zero, zero, 0
	call int32 Cibyl48::roadmap_bar_top_height_1042410()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 6
...
// 0x0101abd8: 0x101abd8: jal   0x10163e4 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101abe0: 0x101abe0: jal   0x1053a0c sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101ac04:
// 0x0101ac04: 0x101ac04: jal   0x1042410 sw    a1, 124(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ac0c: 0x101ac0c: jal   0x10163e4 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101ac14: 0x101ac14: jal   0x1053a0c sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ac88: 0x101ac88: lw    a0, 60(s0)
	...
	ldelem.i4
	stloc.1
// 0x0101ac8c: 0x101ac8c: jal   0x104e534 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	...
	stloc 6
// --- basic block ---
// 0x0101ac94: 0x101ac94: jal   0x104e5e8 addiu a0, zero, 181
	ldc.i4 181
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101aca8: 0x101aca8: addiu a0, zero, 1
	ldc.i4.1
	stloc.1
// 0x0101acac: 0x101acac: jal   0x104f158 sw    zero, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101acb4: 0x101acb4: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101acb8: 0x101acb8: lw    a0, 26800(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0101acbc: 0x101acbc: jal   0x104e534 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101acd0: 0x101acd0: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0101acd4: 0x101acd4: jal   0x104f158 sw    zero, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ace4: 0x101ace4: beq   a2, zero, 0x101ad48 addiu a1, zero, 1
	...
	brfalse L_101ad48
// --- basic block ---
// 0x0101acec: 0x101acec: jal   0x10a186c addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101ad14: 0x101ad14: mflo  lo
	ldloc 9
	stloc 11
// 0x0101ad18: 0x101ad18: jal   0x104e188 addu  s3, s3, v0
	ldloc 11
	ldloc 6
	add
	stloc 11
...
// 0x0101ad3c: 0x101ad3c: subu  s3, s3, v0
	...
	sub
	stloc 11
// 0x0101ad40: 0x101ad40: jal   0x104f730 sw    s3, 52(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ad48: 0x101ad48: lw    a0, 64(s0)
	...
	ldelem.i4
	stloc.1
// 0x0101ad4c: 0x101ad4c: jal   0x104e534 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101ae2c: 0x101ae2c: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101ae30: 0x101ae30: addiu v1, v1, 26828
	ldloc 6
	ldc.i4 26828
	add
	stloc 6
...
// 0x0101aea8: 0x101aea8: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x0101aeac: 0x101aeac: addiu v1, v1, 26828
	ldloc 6
	ldc.i4 26828
	add
	stloc 6
...
// 0x0101af50: 0x101af50: sll   v0, s0, 2
	...
	shl
	stloc 5
// 0x0101af54: 0x101af54: addiu s1, s1, 26828
	ldloc 8
	ldc.i4 26828
	add
	stloc 8
...
// 0x0101af80: 0x101af80: lui   v0, 0x30000
	...
	stloc 5
L_101af84:
// 0x0101af84: 0x101af84: addiu v0, v0, 26828
	ldloc 5
	ldc.i4 26828
	add
	stloc 5
...
// 0x0101afa0: 0x101afa0: addiu a1, zero, 100
	ldc.i4.s 100
	stloc.2
// 0x0101afa4: 0x101afa4: jal   0x10c0c50 sw    v0, 24(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101affc: 0x101affc: addu  s1, s0, a1
	...
	add
	stloc 10
// 0x0101b000: 0x101b000: addiu s5, s5, 26828
	ldloc 9
	ldc.i4 26828
	add
	stloc 9
...
// 0x0101b534: 0x101b534: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x0101b538: 0x101b538: addiu v1, v1, 24756
	ldloc 7
	ldc.i4 24756
	add
	stloc 7
...
// 0x0101b634: 0x101b634: addu  a0, s2, zero
	ldloc 12
	stloc.1
// 0x0101b638: 0x101b638: jal   0x104f0d8 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101b640: 0x101b640: sw    v0, 4(s5)
	...
	ldloc 5
	stelem.i4
// 0x0101b644: 0x101b644: jal   0x104ef88 addu  a0, s6, zero
	ldloc 11
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101b64c: 0x101b64c: lw    a0, 2584(sp)
	...
	ldelem.i4
	stloc.1
// 0x0101b650: 0x101b650: jal   0x104defc sll   zero, zero, 0
	ldloc.1
...
// 0x0101b71c: 0x101b71c: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0101b720: 0x101b720: lw    v1, 27352(s7)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x0101b724: 0x101b724: lw    v0, 27356(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0101b738: 0x101b738: sw    v0, 8(s0)
	...
	ldloc 5
	stelem.i4
// 0x0101b73c: 0x101b73c: sw    s0, 27352(s7)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
