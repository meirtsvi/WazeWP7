...
// 0x0101a1dc: 0x101a1dc: sw    s7, 112(sp)
	...
	ldloc 7
	stelem.i4
// 0x0101a1e0: 0x101a1e0: jal   0x109a59c sw    s6, 108(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a2c0: 0x101a2c0: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0101a2c4: 0x101a2c4: jal   0x10a1a90 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101a2cc: 0x101a2cc: beq   v0, zero, 0x101a330 addu  s6, v0, zero
	...
	brfalse L_101a330
// --- basic block ---
// 0x0101a2d4: 0x101a2d4: jal   0x109a59c addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101a338: 0x101a338: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0101a33c: 0x101a33c: jal   0x10a1a90 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101a354: 0x101a354: addiu v0, v0, 4
	...
	add
	stloc 5
// 0x0101a358: 0x101a358: jal   0x109a59c sw    v0, 72(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a3a8: 0x101a3a8: jal   0x104e3d8 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x0101a3b0: 0x101a3b0: jal   0x109a59c addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101acf0: 0x101acf0: beq   a2, zero, 0x101ad54 addiu a1, zero, 1
	...
	brfalse L_101ad54
// --- basic block ---
// 0x0101acf8: 0x101acf8: jal   0x10a1a90 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101afac: 0x101afac: addiu a1, zero, 100
	ldc.i4.s 100
	stloc.2
// 0x0101afb0: 0x101afb0: jal   0x10c0be0 sw    v0, 24(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
