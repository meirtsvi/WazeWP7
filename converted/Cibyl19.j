...
// 0x0101a1dc: 0x101a1dc: sw    s7, 112(sp)
	...
	ldloc 7
	stelem.i4
// 0x0101a1e0: 0x101a1e0: jal   0x109a570 sw    s6, 108(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a20c: 0x101a20c: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x0101a210: 0x101a210: lw    s2, -30052(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a2c0: 0x101a2c0: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0101a2c4: 0x101a2c4: jal   0x10a1a64 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101a2cc: 0x101a2cc: beq   v0, zero, 0x101a330 addu  s6, v0, zero
	...
	brfalse L_101a330
// --- basic block ---
// 0x0101a2d4: 0x101a2d4: jal   0x109a570 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101a338: 0x101a338: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0101a33c: 0x101a33c: jal   0x10a1a64 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101a354: 0x101a354: addiu v0, v0, 4
	...
	add
	stloc 5
// 0x0101a358: 0x101a358: jal   0x109a570 sw    v0, 72(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a3a8: 0x101a3a8: jal   0x104e3d8 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x0101a3b0: 0x101a3b0: jal   0x109a570 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101a4e0: 0x101a4e0: bne   s0, a0, 0x101a4fc lui   v0, 0xf0000
	...
	bne.un L_101a4fc
// --- basic block ---
// 0x0101a4e8: 0x101a4e8: lw    v0, -30052(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101a4fc:
// 0x0101a4fc: 0x101a4fc: lw    v0, -30052(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a59c: 0x101a59c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101a5a0: 0x101a5a0: lw    a0, 26772(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a5c0: 0x101a5c0: bne   s0, v0, 0x101a5d4 lui   v0, 0x30000
	...
	bne.un L_101a5d4
// --- basic block ---
// 0x0101a5c8: 0x101a5c8: lw    a0, 26764(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a5d4: 0x101a5d4: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101a5d8: 0x101a5d8: lw    a0, 26756(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a600: 0x101a600: bne   s0, v0, 0x101a61c lui   v0, 0x30000
	...
	bne.un L_101a61c
// --- basic block ---
// 0x0101a608: 0x101a608: lw    a0, 26776(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a620: 0x101a620: bne   s0, v0, 0x101a634 lui   v0, 0x30000
	...
	bne.un L_101a634
// --- basic block ---
// 0x0101a628: 0x101a628: lw    a0, 26768(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a634: 0x101a634: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101a638: 0x101a638: lw    a0, 26760(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101a758: 0x101a758: addiu s0, s0, 2480
	...
	add
	stloc 8
// 0x0101a75c: 0x101a75c: addiu s2, s2, 29620
	ldloc 12
	ldc.i4 29620
	add
	stloc 12
...
// 0x0101a77c: 0x101a77c: beq   a0, zero, 0x101a7a4 lui   a3, 0x30000
	...
	brfalse L_101a7a4
// --- basic block ---
// 0x0101a784: 0x101a784: lw    a1, 26748(a3)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0101a828: 0x101a828: lw    a1, 24(sp)
	...
	ldelem.i4
	stloc.2
// 0x0101a82c: 0x101a82c: lw    v0, -30052(s8)
	ldloc 5
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x0101a840: 0x101a840: sw    a1, 24(sp)
	...
	ldloc.2
	stelem.i4
// 0x0101a844: 0x101a844: lw    v1, -30056(a3)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0101acc0: 0x101acc0: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101acc4: 0x101acc4: lw    a0, 26752(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101acf0: 0x101acf0: beq   a2, zero, 0x101ad54 addiu a1, zero, 1
	...
	brfalse L_101ad54
// --- basic block ---
// 0x0101acf8: 0x101acf8: jal   0x10a1a64 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101ae38: 0x101ae38: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101ae3c: 0x101ae3c: addiu v1, v1, 26780
	ldloc 6
	ldc.i4 26780
	add
	stloc 6
...
// 0x0101aeb4: 0x101aeb4: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x0101aeb8: 0x101aeb8: addiu v1, v1, 26780
	ldloc 6
	ldc.i4 26780
	add
	stloc 6
...
// 0x0101af5c: 0x101af5c: sll   v0, s0, 2
	...
	shl
	stloc 5
// 0x0101af60: 0x101af60: addiu s1, s1, 26780
	ldloc 8
	ldc.i4 26780
	add
	stloc 8
...
// 0x0101af8c: 0x101af8c: lui   v0, 0x30000
	...
	stloc 5
L_101af90:
// 0x0101af90: 0x101af90: addiu v0, v0, 26780
	ldloc 5
	ldc.i4 26780
	add
	stloc 5
...
// 0x0101afac: 0x101afac: addiu a1, zero, 100
	ldc.i4.s 100
	stloc.2
// 0x0101afb0: 0x101afb0: jal   0x10c0e50 sw    v0, 24(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101b008: 0x101b008: addu  s1, s0, a1
	...
	add
	stloc 10
// 0x0101b00c: 0x101b00c: addiu s5, s5, 26780
	ldloc 9
	ldc.i4 26780
	add
	stloc 9
...
// 0x0101b540: 0x101b540: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x0101b544: 0x101b544: addiu v1, v1, 25044
	ldloc 7
	ldc.i4 25044
	add
	stloc 7
...
// 0x0101b728: 0x101b728: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0101b72c: 0x101b72c: lw    v1, 27304(s7)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x0101b730: 0x101b730: lw    v0, 27308(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0101b744: 0x101b744: sw    v0, 8(s0)
	...
	ldloc 5
	stelem.i4
// 0x0101b748: 0x101b748: sw    s0, 27304(s7)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
