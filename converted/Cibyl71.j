...
// 0x0105fb80: 0x105fb80: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0105fb84: 0x105fb84: addiu a0, a0, 14540
	ldloc.1
	ldc.i4 14540
	add
	stloc.1
...
// 0x0105fb94: 0x105fb94: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0105fb98: 0x105fb98: addiu a0, a0, 14556
	ldloc.1
	ldc.i4 14556
	add
	stloc.1
...
// 0x0105febc: 0x105febc: lui   v0, 0x0
	...
	stloc 5
L_105fec0:
// 0x0105fec0: 0x105fec0: lw    v1, 14484(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0105fed0: 0x105fed0: bne   v1, v0, 0x105fefc lui   s1, 0x0
	...
	bne.un L_105fefc
// --- basic block ---
// 0x0105fed8: 0x105fed8: lw    a0, 14492(s3)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0105fedc: 0x105fedc: jal   0x105f7cc sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x0105fee4: 0x105fee4: lw    a0, 14504(s2)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0105fee8: 0x105fee8: jal   0x105e7f0 addu  a1, zero, zero
	...
	stloc 5
// --- basic block ---
// 0x0105fef0: 0x105fef0: lw    a0, 14500(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0105ff18: 0x105ff18: jal   0x104e160 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x0105ff20: 0x105ff20: lw    a0, 14492(s3)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0105ff24: 0x105ff24: jal   0x105f7cc subu  s0, s0, v0
	...
	stloc 5
// --- basic block ---
// 0x0105ff2c: 0x105ff2c: lw    a0, 14504(s2)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0105ff30: 0x105ff30: jal   0x105e7f0 addu  a1, zero, zero
	...
	stloc 5
// --- basic block ---
// 0x0105ff38: 0x105ff38: lw    a0, 14500(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0105fff8: 0x105fff8: lui   v0, 0x0
	...
	stloc 5
L_105fffc:
// 0x0105fffc: 0x105fffc: lw    a0, 14484(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01060008: 0x1060008: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0106000c: 0x106000c: lw    a0, 14496(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01060190: 0x1060190: jal   0x10146cc addiu a0, a0, 14636
	ldloc.1
	ldc.i4 14636
	add
	stloc.1
...
// 0x010605ec: 0x10605ec: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010605f0: 0x10605f0: addiu a0, a0, 14696
	ldloc.1
	ldc.i4 14696
	add
	stloc.1
...
// 0x010606a8: 0x10606a8: addiu a0, a0, 26260
	...
	add
	stloc.1
// 0x010606ac: 0x10606ac: addiu a1, a1, 14696
	ldloc.2
	ldc.i4 14696
	add
	stloc.2
...
// 0x010606d0: 0x10606d0: addiu a0, s3, 12676
	...
	add
	stloc.1
// 0x010606d4: 0x10606d4: addiu a1, s1, 14712
	ldloc 10
	ldc.i4 14712
	add
	stloc.2
...
// 0x010606f4: 0x10606f4: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x010606f8: 0x10606f8: addiu a1, a1, 14728
	ldloc.2
	ldc.i4 14728
	add
	stloc.2
...
// 0x0106071c: 0x106071c: jal   0x1014084 addiu a0, a0, 1876
	...
	stloc 7
// --- basic block ---
// 0x01060724: 0x1060724: addiu a0, s1, 14712
	ldloc 10
	ldc.i4 14712
	add
	stloc.1
...
// 0x01060b5c: 0x1060b5c: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01060b60: 0x1060b60: jal   0x100e5e0 addiu a0, a0, 14728
	ldloc.1
	ldc.i4 14728
	add
	stloc.1
...
// 0x01060b78: 0x1060b78: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01060b7c: 0x1060b7c: jal   0x100e5e0 addiu a0, s0, 14712
	ldloc 7
	ldc.i4 14712
	add
	stloc.1
...
// 0x01060b88: 0x1060b88: addiu a1, a1, 20820
	...
	add
	stloc.2
// 0x01060b8c: 0x1060b8c: jal   0x100e814 addiu a0, s0, 14712
	ldloc 7
	ldc.i4 14712
	add
	stloc.1
