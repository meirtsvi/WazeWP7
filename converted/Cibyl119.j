...
// 0x0109fc84: 0x109fc84: jal   0x1038ae8 andi  a0, a0, 1
	...
	stloc 5
// --- basic block ---
// 0x0109fc8c: 0x109fc8c: lw    a0, 17660(s0)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0109fca0: 0x109fca0: lui   t0, 0x100000
	ldc.i4 1048576
	stloc 17
// 0x0109fca4: 0x109fca4: lw    a0, 17660(s0)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0109fcc0: 0x109fcc0: lui   v1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x0109fcc4: 0x109fcc4: lw    a0, 17664(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0109fd20: 0x109fd20: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0109fd24: 0x109fd24: lw    a0, 17672(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109fd58: 0x109fd58: lui   s8, 0x10000
	ldc.i4 65536
	stloc 16
// 0x0109fd5c: 0x109fd5c: lw    a0, 17668(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109fda8: 0x109fda8: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0109fdac: 0x109fdac: lw    a0, 17684(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109fdd0: 0x109fdd0: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0109fdd4: 0x109fdd4: lw    a0, 17688(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109fe38: 0x109fe38: lw    t1, 48(sp)
	...
	ldelem.i4
	stloc 18
// 0x0109fe3c: 0x109fe3c: lw    a0, 17692(s4)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0109fe78: 0x109fe78: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0109fe7c: 0x109fe7c: lw    a0, 17696(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109feb0: 0x109feb0: jal   0x109424c addiu a2, zero, 8
	...
	stloc 5
// --- basic block ---
// 0x0109feb8: 0x109feb8: lw    a0, 17692(s4)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0109feec: 0x109feec: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0109fef0: 0x109fef0: lw    s5, 17676(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109ff6c: 0x109ff6c: lw    a0, 10244(s5)
	...
	ldelem.i4
	stloc.1
// 0x0109ff70: 0x109ff70: lw    a1, 17672(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109ff84: 0x109ff84: lw    a0, 10244(s5)
	...
	ldelem.i4
	stloc.1
// 0x0109ff88: 0x109ff88: lw    a1, 17668(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109ff9c: 0x109ff9c: lw    a0, 10244(s5)
	...
	ldelem.i4
	stloc.1
// 0x0109ffa0: 0x109ffa0: lw    a1, 17664(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a0014: 0x10a0014: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010a0018: 0x10a0018: lw    a1, 17676(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a0034: 0x10a0034: beq   v0, zero, 0x10a006c lui   v1, 0x0
	...
	brfalse L_10a006c
// --- basic block ---
// 0x010a003c: 0x10a003c: lw    v0, 17700(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 5
// 0x010a0040: 0x10a0040: lw    a0, 17660(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10a006c:
// 0x010a006c: 0x10a006c: lw    a0, 17660(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x010a0070: 0x10a0070: jal   0x10942b4 addiu a1, a1, 17700
	ldloc.2
	ldc.i4 17700
	add
	stloc.2
...
// 0x010a0084: 0x10a0084: lui   s5, 0x80000
	ldc.i4 524288
	stloc 8
// 0x010a0088: 0x10a0088: lw    a1, 17672(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a009c: 0x10a009c: bne   s6, zero, 0x10a00d4 lui   v0, 0x0
	...
	brtrue L_10a00d4
// --- basic block ---
// 0x010a00a4: 0x10a00a4: lw    a1, 17684(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a00e8: 0x10a00e8: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010a00ec: 0x10a00ec: lw    a1, 17688(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a0140: 0x10a0140: lw    a0, 10244(s2)
	...
	ldelem.i4
	stloc.1
// 0x010a0144: 0x10a0144: lw    a1, 17692(s5)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010a0164: 0x10a0164: lw    a0, 10244(s2)
	...
	ldelem.i4
	stloc.1
// 0x010a0168: 0x10a0168: lw    a1, 17692(s5)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10a0184:
// 0x010a0184: 0x10a0184: lw    a1, 17696(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a01c0: 0x10a01c0: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010a01c4: 0x10a01c4: lw    a0, 17660(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a0274: 0x10a0274: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010a0278: 0x10a0278: lw    a1, 17668(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a02b8: 0x10a02b8: beq   v0, zero, 0x10a02cc lui   v0, 0x0
	...
	brfalse L_10a02cc
// --- basic block ---
// 0x010a02c0: 0x10a02c0: lw    a0, 17660(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
