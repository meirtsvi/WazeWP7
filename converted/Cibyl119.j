...
// 0x0109fd0c: 0x109fd0c: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x0109fd10: 0x109fd10: addiu v1, v1, 29856
	ldloc 7
	ldc.i4 29856
	add
	stloc 7
...
// 0x0109fdd0: 0x109fdd0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109fdd4: 0x109fdd4: lw    a1, 10216(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0109fdd8: 0x109fdd8: lui   v1, 0x80000
	ldc.i4 524288
	stloc 7
// 0x0109fddc: 0x109fddc: lw    v0, 10220(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 5
// 0x0109fde0: 0x109fde0: lw    a2, 10224(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0109fdec: 0x109fdec: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109fdf0: 0x109fdf0: sw    zero, 10220(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109fdf8: 0x109fdf8: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109fdfc: 0x109fdfc: sw    zero, 10216(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109fe00: 0x109fe00: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109fe04: 0x109fe04: sw    zero, 10224(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109fe60: 0x109fe60: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109fe64: 0x109fe64: sw    v1, 10220(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109fe6c: 0x109fe6c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109fe70: 0x109fe70: sw    v1, 10224(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109fe74: 0x109fe74: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109fe78: 0x109fe78: sw    s3, 10216(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109ff14: 0x109ff14: lui   v1, 0x80000
	ldc.i4 524288
	stloc 7
// 0x0109ff18: 0x109ff18: sw    v0, 10228(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010a01a4: 0x10a01a4: lw    a0, 10228(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010a01b4: 0x10a01b4: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010a01b8: 0x10a01b8: lw    a0, 10228(s5)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010a01cc: 0x10a01cc: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010a01d0: 0x10a01d0: lw    a0, 10228(s5)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010a01e4: 0x10a01e4: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010a01e8: 0x10a01e8: lw    a0, 10228(s5)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010a0258: 0x10a0258: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010a025c: 0x10a025c: lw    a0, 10228(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a02d4: 0x10a02d4: lw    a1, 17684(v0)
	...
	ldelem.i4
	stloc.2
// 0x010a02d8: 0x10a02d8: lw    a0, 10228(s5)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010a02f0: 0x10a02f0: lw    a1, 17696(v0)
	...
	ldelem.i4
	stloc.2
// 0x010a02f4: 0x10a02f4: lw    a0, 10228(s5)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010a0320: 0x10a0320: lw    a1, 17696(v0)
	...
	ldelem.i4
	stloc.2
// 0x010a0324: 0x10a0324: lw    a0, 10228(s5)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010a0338: 0x10a0338: lw    a1, 17700(v0)
	...
	ldelem.i4
	stloc.2
// 0x010a033c: 0x10a033c: lw    a0, 10228(s5)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010a0388: 0x10a0388: lui   s5, 0x0
	ldc.i4.s 0
	stloc 8
// 0x010a038c: 0x10a038c: lw    a0, 10228(s2)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x010a03a8: 0x10a03a8: bne   v0, zero, 0x10a03d0 lui   v0, 0x0
	...
	brtrue L_10a03d0
// --- basic block ---
// 0x010a03b0: 0x10a03b0: lw    a0, 10228(s2)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x010a03d0: 0x10a03d0: lw    a1, 17708(v0)
	...
	ldelem.i4
	stloc.2
// 0x010a03d4: 0x10a03d4: lw    a0, 10228(s2)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x010a04c8: 0x10a04c8: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010a04cc: 0x10a04cc: lw    a0, 10228(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a04ec: 0x10a04ec: lui   v1, 0x80000
	ldc.i4 524288
	stloc 6
// 0x010a04f0: 0x10a04f0: lw    a2, 10224(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.3
// 0x010a04f4: 0x10a04f4: lw    v1, 10220(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a0528: 0x10a0528: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010a052c: 0x10a052c: lw    a0, 10224(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a0638: 0x10a0638: lui   v0, 0x80000
	ldc.i4 524288
	stloc 4
// 0x010a063c: 0x10a063c: lw    v0, 10232(v0)
	ldloc 8
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x010a0644: 0x10a0644: bne   v0, zero, 0x10a06ec lui   v1, 0x80000
	...
	brtrue L_10a06ec
// --- basic block ---
// 0x010a064c: 0x10a064c: lw    v0, 10244(v1)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a0670: 0x10a0670: lui   a0, 0x80000
	ldc.i4 524288
	stloc.0
// 0x010a0674: 0x10a0674: addiu t1, t1, 15260
	ldloc 7
	ldc.i4 15260
	add
	stloc 7
// 0x010a0678: 0x10a0678: addiu t0, t0, 14260
	ldloc 6
	ldc.i4 14260
	add
	stloc 6
// 0x010a067c: 0x10a067c: addiu a3, a3, 13260
	ldloc.3
	ldc.i4 13260
	add
	stloc.3
// 0x010a0680: 0x10a0680: addiu a2, a2, 12260
	ldloc.2
	ldc.i4 12260
	add
	stloc.2
// 0x010a0684: 0x10a0684: addiu a1, a1, 11260
	ldloc.1
	ldc.i4 11260
	add
	stloc.1
// 0x010a0688: 0x10a0688: addiu a0, a0, 10260
	ldloc.0
	ldc.i4 10260
	add
	stloc.0
...
// 0x010a06ac: 0x10a06ac: addiu v0, zero, 1
	ldc.i4.1
	stloc 4
// 0x010a06b0: 0x10a06b0: sw    v0, 10244(v1)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a06e4: 0x10a06e4: lui   v0, 0x80000
	ldc.i4 524288
	stloc 4
// 0x010a06e8: 0x10a06e8: sw    v1, 10232(v0)
	ldloc 8
	ldloc 4
	ldc.i4.2
	shr.un
