...
// 0x0108d110: 0x108d110: addiu a0, a0, -26772
	...
	add
	stloc.1
// 0x0108d114: 0x108d114: addiu a1, a1, 17332
	ldloc.2
	ldc.i4 17332
	add
	stloc.2
...
// 0x0108d148: 0x108d148: jal   0x100e630 addiu a0, a0, 17332
	ldloc.1
	ldc.i4 17332
	add
	stloc.1
...
// 0x0108d174: 0x108d174: jal   0x100e7a8 addiu a0, a0, 17332
	ldloc.1
	ldc.i4 17332
	add
	stloc.1
...
// 0x0108d1ac: 0x108d1ac: addiu a0, s0, 16
	...
	add
	stloc.1
// 0x0108d1b0: 0x108d1b0: addiu a1, a1, 17316
	ldloc.2
	ldc.i4 17316
	add
	stloc.2
...
// 0x0108d1c0: 0x108d1c0: addiu a0, s0, 40
	...
	add
	stloc.1
// 0x0108d1c4: 0x108d1c4: addiu a1, a1, 17324
	ldloc.2
	ldc.i4 17324
	add
	stloc.2
...
// 0x0108d284: 0x108d284: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0108d288: 0x108d288: lw    s0, 17348(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0108d2f8: 0x108d2f8: addiu v0, zero, -1
	ldc.i4.m1
	stloc 5
// 0x0108d2fc: 0x108d2fc: sw    v0, 17348(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_108d308:
// 0x0108d308: 0x108d308: lw    v0, 17348(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0108d320: 0x108d320: sw    a1, -1876(a0)
	...
	ldloc.2
	stelem.i4
// 0x0108d324: 0x108d324: sw    v0, 17348(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0108d52c: 0x108d52c: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x0108d530: 0x108d530: addiu a1, a1, 17316
	ldloc.2
	ldc.i4 17316
	add
	stloc.2
...
// 0x0108d584: 0x108d584: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x0108d588: 0x108d588: addiu a1, a1, 17324
	ldloc.2
	ldc.i4 17324
	add
	stloc.2
...
// 0x0108d8ec: 0x108d8ec: beq   v1, a0, 0x108d95c lui   a1, 0x0
	...
	beq  L_108d95c
// --- basic block ---
// 0x0108d8f4: 0x108d8f4: lw    s1, 17348(a1)
	ldloc 7
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0108d908: 0x108d908: sw    v1, -1876(v0)
	...
	ldloc 8
	stelem.i4
// 0x0108d90c: 0x108d90c: sw    zero, 17348(a1)
	ldloc 7
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0108d9d8: 0x108d9d8: jal   0x100e368 addiu a0, a0, 14916
	ldloc.1
	ldc.i4 14916
	add
	stloc.1
...
// 0x0108d9ec: 0x108d9ec: lui   v1, 0x0
	ldc.i4.s 0
	stloc 6
// 0x0108d9f0: 0x108d9f0: sw    v0, 17352(v1)
	ldloc 8
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0108db00: 0x108db00: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0108db04: 0x108db04: lw    v1, 17352(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0108db34: 0x108db34: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0108db38: 0x108db38: lw    a0, 17352(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0108db7c: 0x108db7c: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0108db80: 0x108db80: lw    a0, 17352(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0108ddcc: 0x108ddcc: lui   v1, 0x1090000
	ldc.i4 17367040
	stloc 6
// 0x0108ddd0: 0x108ddd0: lw    a1, 17352(t0)
	ldloc 7
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x0108df00: 0x108df00: lw    v1, 44(sp)
	...
	ldelem.i4
	stloc 6
// 0x0108df04: 0x108df04: lw    a1, 17352(t0)
	ldloc 7
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x0108e134: 0x108e134: lw    a1, 16(v1)
	...
	ldelem.i4
	stloc.2
// 0x0108e138: 0x108e138: addiu a0, a0, 14916
	ldloc.1
	ldc.i4 14916
	add
	stloc.1
// 0x0108e13c: 0x108e13c: lui   v1, 0x0
	ldc.i4.s 0
	stloc 6
// 0x0108e140: 0x108e140: jal   0x100e5e0 sw    v0, 17352(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
