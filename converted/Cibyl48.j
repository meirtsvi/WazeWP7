...
// 0x01040d08: 0x1040d08: lui   s3, 0x60000
	ldc.i4 393216
	stloc 9
// 0x01040d0c: 0x1040d0c: lw    v0, 12080(s3)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1040d28:
// 0x01040d28: 0x1040d28: lw    a0, 12084(s2)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01040d54: 0x1040d54: lui   s2, 0x60000
	...
	stloc 11
L_1040d58:
// 0x01040d58: 0x1040d58: lw    v0, 12080(s3)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01040d6c: 0x1040d6c: lui   v0, 0x60000
	...
	stloc 5
L_1040d70:
// 0x01040d70: 0x1040d70: lw    v0, 12080(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01040d84: 0x1040d84: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01040d88: 0x1040d88: lw    a0, 12084(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01040dd0: 0x1040dd0: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01040dd4: 0x1040dd4: lw    v1, 12076(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01040e34: 0x1040e34: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01040e38: 0x1040e38: addiu a1, a1, 15592
	ldloc.2
	ldc.i4 15592
	add
	stloc.2
...
// 0x01040e5c: 0x1040e5c: lui   s1, 0x60000
	ldc.i4 393216
	stloc 8
// 0x01040e60: 0x1040e60: addiu a1, s1, 12080
	ldloc 8
	ldc.i4 12080
	add
	stloc.2
...
// --- basic block ---
L_1040e8c:
// 0x01040e8c: 0x1040e8c: lw    a0, 12084(s7)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x01040f94: 0x1040f94: addiu s1, s1, 1
	...
	stloc 8
L_1040f98:
// 0x01040f98: 0x1040f98: lw    v0, 12080(s8)
	ldloc 6
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x01040fb4: 0x1040fb4: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01040fb8: 0x1040fb8: sw    zero, 12076(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1041038:
// 0x01041038: 0x1041038: lw    a0, 12084(s5)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x01041094: 0x1041094: addiu s0, s0, 1
	...
	stloc 7
L_1041098:
// 0x01041098: 0x1041098: lw    v0, 12080(s6)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_104111c:
// 0x0104111c: 0x104111c: lw    a0, 12084(s2)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01041160: 0x1041160: jal   0x1000930 addu  a0, s5, zero
	...
	stloc 6
// --- basic block ---
// 0x01041168: 0x1041168: lw    v0, 12076(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01041170: 0x1041170: addiu v0, v0, 1
	...
	add
	stloc 6
// 0x01041174: 0x1041174: sw    v0, 12076(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01041188: 0x1041188: addiu s0, s0, 1
	...
	stloc 8
L_104118c:
// 0x0104118c: 0x104118c: lw    v0, 12080(s3)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x0104131c: 0x104131c: lui   s2, 0x60000
	ldc.i4 393216
	stloc 9
// 0x01041320: 0x1041320: lw    a0, 12084(s2)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1041334:
// 0x01041334: 0x1041334: lw    a0, 12084(s2)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0104134c: 0x104134c: beq   v0, zero, 0x1041378 addu  a1, s0, zero
	...
	brfalse L_1041378
// --- basic block ---
// 0x01041354: 0x1041354: lw    a0, 12084(s2)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01041474: 0x1041474: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01041478: 0x1041478: lw    a1, 12080(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01041494: 0x1041494: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01041498: 0x1041498: lw    a0, 12084(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010414a4: 0x10414a4: lui   v0, 0x60000
	...
	stloc 5
L_10414a8:
// 0x010414a8: 0x10414a8: lw    s0, 12080(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010414b0: 0x10414b0: addiu v1, s0, 1
	...
	add
	stloc 7
// 0x010414b4: 0x10414b4: jal   0x1000910 sw    v1, 12080(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010414d4: 0x10414d4: sw    s1, 0(s1)
	...
	ldloc 9
	stelem.i4
// 0x010414d8: 0x10414d8: lw    a0, 12084(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01041508: 0x1041508: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0104150c: 0x104150c: lw    a0, 12084(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0104151c: 0x104151c: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01041520: 0x1041520: lw    v1, 12076(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01041528: 0x1041528: addiu v1, v1, 1
	...
	add
	stloc 7
// 0x0104152c: 0x104152c: j	 0x1041590 sw    v1, 12076(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1041534:
// 0x01041534: 0x1041534: lw    a0, 12084(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01041568: 0x1041568: beq   v0, s3, 0x10415c4 lui   v0, 0x60000
	...
	beq  L_10415c4
// --- basic block ---
// 0x01041570: 0x1041570: lw    a0, 12076(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010415b0: 0x10415b0: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010415b4: 0x10415b4: lw    v1, 12076(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010415bc: 0x10415bc: addiu v1, v1, 1
	...
	stloc 7
L_10415c0:
// 0x010415c0: 0x10415c0: sw    v1, 12076(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010415f4: 0x10415f4: lui   s2, 0x60000
	ldc.i4 393216
	stloc 10
// 0x010415f8: 0x10415f8: lw    v0, 12084(s2)
	ldloc 5
	ldloc 10
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1041624:
// 0x01041624: 0x1041624: lw    a0, 12084(s2)
	ldloc 5
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0104167c: 0x104167c: addiu s0, s0, 1
	...
	stloc 8
L_1041680:
// 0x01041680: 0x1041680: lw    v0, 12080(s1)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0104168c: 0x104168c: bne   v0, zero, 0x1041624 lui   s3, 0x60000
	...
	brtrue L_1041624
// --- basic block ---
// 0x01041694: 0x1041694: lw    a0, 12084(s3)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01041698: 0x1041698: jal   0x1015aa4 sll   zero, zero, 0
	...
	stloc 6
// --- basic block ---
// 0x010416a0: 0x10416a0: sw    zero, 12084(s3)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010416c0: 0x10416c0: lw    s0, 20(sp)
	...
	ldelem.i4
	stloc 8
// 0x010416c4: 0x10416c4: sw    zero, 12080(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010416e4: 0x10416e4: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010416e8: 0x10416e8: addiu a0, a0, -3520
	ldloc.1
	ldc.i4 -3520
	add
	stloc.1
// 0x010416ec: 0x10416ec: addiu a1, zero, 4096
	ldc.i4 4096
	stloc.2
// 0x010416f0: 0x10416f0: jal   0x10158d0 sw    zero, 12080(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01041700: 0x1041700: sw    v0, 12084(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01041708: 0x1041708: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0104170c: 0x104170c: sw    v1, 12076(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01041958: 0x1041958: lui   v0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x0104195c: 0x104195c: lw    v1, 12088(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010419c8: 0x10419c8: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x010419cc: 0x10419cc: lw    v0, 27376(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010419dc: 0x10419dc: lui   a3, 0x0
	ldc.i4.s 0
	stloc 4
// 0x010419e0: 0x10419e0: addiu a1, a1, -3444
	ldloc.2
	ldc.i4 -3444
	add
	stloc.2
...
// 0x010419f8: 0x10419f8: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010419fc: 0x10419fc: sw    s0, 12088(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01041a0c: 0x1041a0c: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01041a10: 0x1041a10: lw    v0, 12088(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01041cb8: 0x1041cb8: addiu a1, a1, -3444
	...
	add
	stloc.2
// 0x01041cbc: 0x1041cbc: addiu a3, a3, -3416
	ldloc 4
	ldc.i4 -3416
	add
	stloc 4
...
// 0x01041ce0: 0x1041ce0: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x01041ce4: 0x1041ce4: lw    v0, 27376(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01041d00: 0x1041d00: lui   a3, 0x0
	ldc.i4.s 0
	stloc 4
// 0x01041d04: 0x1041d04: addiu a1, a1, -3444
	ldloc.2
	ldc.i4 -3444
	add
	stloc.2
...
// 0x01041d18: 0x1041d18: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01041d1c: 0x1041d1c: lw    v1, 12088(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01041d24: 0x1041d24: bne   v1, s0, 0x1041d30 sll   zero, zero, 0
	...
	bne.un L_1041d30
// --- basic block ---
// 0x01041d2c: 0x1041d2c: sw    zero, 12088(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01041d6c: 0x1041d6c: addu  a2, v0, zero
	ldloc 6
	stloc.3
// 0x01041d70: 0x1041d70: addiu a0, s1, -3444
	ldloc 9
	ldc.i4 -3444
	add
	stloc.1
...
// 0x01041d80: 0x1041d80: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01041d84: 0x1041d84: lw    v1, 27376(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01041dac: 0x1041dac: bne   v0, zero, 0x1041dc8 lui   a3, 0x10000
	...
	brtrue L_1041dc8
// --- basic block ---
// 0x01041db4: 0x1041db4: addiu a1, s1, -3444
	ldloc 9
	ldc.i4 -3444
	add
	stloc.2
// 0x01041db8: 0x1041db8: addiu a3, a3, -3384
	ldloc 4
	ldc.i4 -3384
	add
	stloc 4
...
// 0x01042280: 0x1042280: bgez  a2, 0x1042294 sll   zero, zero, 0
	...
	bge L_1042294
// --- basic block ---
// 0x01042288: 0x1042288: lw    a3, -30036(s5)
	ldloc 5
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x01042294: 0x1042294: bgez  v1, 0x10422a8 sll   zero, zero, 0
	...
	bge L_10422a8
// --- basic block ---
// 0x0104229c: 0x104229c: lw    a3, -30040(s4)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x010423e0: 0x10423e0: lui   v0, 0x60000
	ldc.i4 393216
	stloc.0
// 0x010423e4: 0x10423e4: lw    v0, 12896(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010423f0: 0x10423f0: lui   v0, 0x60000
	ldc.i4 393216
	stloc.0
// 0x010423f4: 0x10423f4: lw    v0, 12896(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01042400: 0x1042400: lui   v0, 0x60000
	ldc.i4 393216
	stloc.0
// 0x01042404: 0x1042404: lw    v0, 12896(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01042410: 0x1042410: lui   v0, 0x60000
	ldc.i4 393216
	stloc.0
// 0x01042414: 0x1042414: lw    v1, 12880(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01042424: 0x1042424: lui   v0, 0x0
	ldc.i4.s 0
	stloc.0
// 0x01042428: 0x1042428: lw    v0, 13344(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01042444: 0x1042444: lui   v0, 0x0
	ldc.i4.s 0
	stloc.0
// 0x01042448: 0x1042448: lw    v1, 13328(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01042458: 0x1042458: lui   v0, 0x0
	ldc.i4.s 0
	stloc.0
// 0x0104245c: 0x104245c: lw    v0, 13336(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01042484: 0x1042484: lui   v0, 0x0
	ldc.i4.s 0
	stloc.0
// 0x01042488: 0x1042488: jr    ra sw    v1, 13328(v0)
	ldloc 3
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010424b8: 0x10424b8: lui   v0, 0x60000
	ldc.i4 393216
	stloc.0
// 0x010424bc: 0x10424bc: jr    ra sw    zero, 12880(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010424ec: 0x10424ec: bne   v0, zero, 0x10424fc lui   v0, 0x10000
	...
	brtrue L_10424fc
// --- basic block ---
// 0x010424f4: 0x10424f4: j	 0x1042524 addiu v0, v0, 18616
	ldloc 5
	ldc.i4 18616
	add
	stloc 5
...
// 0x0104250c: 0x104250c: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01042510: 0x1042510: addiu a1, a1, -14064
	ldloc.2
	ldc.i4 -14064
	add
	stloc.2
// 0x01042514: 0x1042514: addu  a2, v0, zero
	ldloc 5
	stloc.3
// 0x01042518: 0x1042518: jal   0x1000f64 addiu a0, s0, 12092
	ldloc 6
	ldc.i4 12092
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x01042520: 0x1042520: addiu v0, s0, 12092
	ldloc 6
	ldc.i4 12092
	add
	stloc 5
