...
// 0x01018ca4: 0x1018ca4: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x01018ca8: 0x1018ca8: jal   0x101842c sw    v0, -28192(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01018cc0: 0x1018cc0: lui   a1, 0x1010000
	ldc.i4 16842752
	stloc.2
// 0x01018cc4: 0x1018cc4: sw    a2, -28188(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01018cd0: 0x1018cd0: addiu a0, zero, 15000
	ldc.i4 15000
	stloc.1
// 0x01018cd4: 0x1018cd4: sw    zero, -28192(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
	...
	ldc.i4.s 0
	stelem.i4
// 0x01018cd8: 0x1018cd8: jal   0x10500d4 sw    zero, -28184(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01018ce4: 0x1018ce4: addiu a1, a1, 28100
	...
	add
	stloc.2
// 0x01018ce8: 0x1018ce8: jal   0x10500d4 addiu a0, zero, 100
	ldc.i4.s 100
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01018cf4: 0x1018cf4: jal   0x101df64 addiu a0, a0, 6628
	...
	stloc 5
// --- basic block ---
// 0x01018cfc: 0x1018cfc: jal   0x106cf38 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl81::Realtime_FoursquareSearch_106cf38(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x01018d68: 0x1018d68: sw    s5, 180(sp)
	...
	ldloc 14
	stelem.i4
// 0x01018d6c: 0x1018d6c: jal   0x104ff3c sw    s0, 160(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x01018d74: 0x1018d74: jal   0x104c534 lui   s3, 0x30000
	ldc.i4 196608
	stloc 10
...
// 0x01018d80: 0x1018d80: beq   s2, v0, 0x1018e58 addiu v1, zero, 1
	...
	beq  L_1018e58
// --- basic block ---
// 0x01018d88: 0x1018d88: lw    v0, -28188(s3)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01018e1c: 0x1018e1c: addiu a0, a0, 30116
	...
	add
	stloc.1
// 0x01018e20: 0x1018e20: jal   0x104c28c addiu a1, a1, 30124
	ldloc.2
	ldc.i4 30124
	add
	stloc.2
...
// 0x01018e4c: 0x1018e4c: lui   v0, 0x30000
	...
	stloc 5
L_1018e50:
// 0x01018e50: 0x1018e50: j	 0x1019090 sw    zero, -28188(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1018e58:
// 0x01018e58: 0x1018e58: lw    v0, -28188(s3)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01018ea4: 0x1018ea4: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01018ea8: 0x1018ea8: lw    v0, -28192(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01018eb0: 0x1018eb0: beq   v0, zero, 0x1019090 sw    zero, -28188(s3)
	ldloc 5
	ldloc 6
	ldloc 10
	ldc.i4.2
...
// 0x01018eec: 0x1018eec: addu  a1, s4, zero
	ldloc 8
	stloc.2
// 0x01018ef0: 0x1018ef0: jal   0x1016eec sw    zero, -28188(s3)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01018f0c: 0x1018f0c: jal   0x100449c addiu a2, zero, 1026
	...
	stloc 5
// --- basic block ---
// 0x01018f14: 0x1018f14: beq   s4, zero, 0x1019090 sw    zero, -28188(s3)
	ldloc 8
	ldloc 6
	ldloc 10
	ldc.i4.2
...
// 0x01018f48: 0x1018f48: sw    v0, 24(sp)
	...
	ldloc 5
	stelem.i4
// 0x01018f4c: 0x1018f4c: jal   0x10684f0 sw    s2, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01018f90: 0x1018f90: addu  a0, s6, zero
	ldloc 11
	stloc.1
// 0x01018f94: 0x1018f94: addiu a1, a1, 26028
	ldloc.2
	ldc.i4 26028
	add
	stloc.2
...
// 0x01018fa0: 0x1018fa0: sw    v0, 24(sp)
	...
	ldloc 5
	stelem.i4
// 0x01018fa4: 0x1018fa4: jal   0x10684f0 sw    s2, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01018fcc: 0x1018fcc: lui   a3, 0x10000
	ldc.i4 65536
	stloc 4
// 0x01018fd0: 0x1018fd0: addiu v0, v0, 26028
	ldloc 5
	ldc.i4 26028
	add
	stloc 5
...
// 0x01019004: 0x1019004: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01019008: 0x1019008: addiu a1, a1, 26429
	ldloc.2
	ldc.i4 26429
	add
	stloc.2
...
// 0x01019018: 0x1019018: sw    v0, 24(sp)
	...
	ldloc 5
	stelem.i4
// 0x0101901c: 0x101901c: jal   0x10684f0 sw    s2, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01019034: 0x1019034: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01019038: 0x1019038: addiu v0, v0, 26429
	ldloc 5
	ldc.i4 26429
	add
	stloc 5
...
// 0x01019064: 0x1019064: addiu a1, a1, 32692
	...
	add
	stloc.2
// 0x01019068: 0x1019068: jal   0x10500d4 addiu a0, zero, 100
	ldc.i4.s 100
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01019330: 0x1019330: addu  a0, s2, zero
	ldloc 8
	stloc.1
// 0x01019334: 0x1019334: jal   0x104f08c addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101933c: 0x101933c: addu  a0, s1, zero
	ldloc 12
	stloc.1
// 0x01019340: 0x1019340: jal   0x104ef3c sw    v0, 280(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1019354:
// 0x01019354: 0x1019354: lw    v0, 26752(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01019378: 0x1019378: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101937c: 0x101937c: lw    v1, 26744(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101939c: 0x101939c: addiu a0, a0, -31260
	...
	add
	stloc.1
// 0x010193a0: 0x10193a0: jal   0x104f08c sw    v1, 26744(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010193b0: 0x10193b0: addiu a0, a0, 32004
	...
	add
	stloc.1
// 0x010193b4: 0x10193b4: jal   0x104ef3c sw    v0, 26752(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010193d0: 0x10193d0: addiu a0, a0, 4720
	...
	add
	stloc.1
// 0x010193d4: 0x10193d4: jal   0x1019274 sw    v0, 26756(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010193e4: 0x10193e4: addiu a0, a0, 4768
	...
	add
	stloc.1
// 0x010193e8: 0x10193e8: jal   0x1019274 sw    v0, 26760(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010193f8: 0x10193f8: addiu a0, a0, 4784
	...
	add
	stloc.1
// 0x010193fc: 0x10193fc: jal   0x1019274 sw    v0, 26764(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101940c: 0x101940c: addiu a0, a0, 4736
	...
	add
	stloc.1
// 0x01019410: 0x1019410: jal   0x1019274 sw    v0, 26768(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01019420: 0x1019420: addiu a0, a0, 4752
	...
	add
	stloc.1
// 0x01019424: 0x1019424: sw    v0, 26772(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01019430: 0x1019430: lui   v1, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01019434: 0x1019434: sw    v0, 26776(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01019448: 0x1019448: addiu a0, zero, 230
	ldc.i4 230
	stloc.1
// 0x0101944c: 0x101944c: jal   0x104e59c sw    v0, 60(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01019684: 0x1019684: sw    a0, 24(sp)
	...
	ldloc.1
	stelem.i4
// 0x01019688: 0x1019688: jal   0x10423c4 sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010196a4: 0x10196a4: beq   a2, zero, 0x10196c8 addiu a1, zero, 1
	...
	brfalse L_10196c8
// --- basic block ---
// 0x010196ac: 0x10196ac: jal   0x10a1820 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010196bc: 0x10196bc: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x010196c0: 0x10196c0: jal   0x104f6e4 addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x010196d8: 0x10196d8: lui   a1, 0xe0000
	ldc.i4 917504
	stloc.2
// 0x010196dc: 0x10196dc: addiu a1, a1, 29620
	ldloc.2
	ldc.i4 29620
	add
	stloc.2
...
// 0x01019858: 0x1019858: bne   v0, zero, 0x1019874 addu  a0, s8, zero
	...
	brtrue L_1019874
// --- basic block ---
// 0x01019860: 0x1019860: jal   0x104ef3c addu  a0, s3, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010198a0: 0x10198a0: addu  a0, s4, zero
	...
	stloc.1
L_10198a4:
// 0x010198a4: 0x10198a4: jal   0x104ef3c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010198c0: 0x10198c0: bne   v0, zero, 0x10198d8 sll   zero, zero, 0
	...
	brtrue L_10198d8
// --- basic block ---
// 0x010198c8: 0x10198c8: jal   0x104ef3c addu  a0, s3, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_10198d8:
// 0x010198d8: 0x10198d8: jal   0x104ef3c addu  a0, s3, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010198f4: 0x10198f4: addu  a1, s2, zero
	ldloc 13
	stloc.2
// 0x010198f8: 0x10198f8: jal   0x104ebec sw    v0, 300(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01019918: 0x1019918: sw    v0, 16(sp)
	...
	ldloc 5
	stelem.i4
// 0x0101991c: 0x101991c: jal   0x104eaf4 sw    zero, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01019a7c: 0x1019a7c: addu  a0, s0, zero
	ldloc 11
	stloc.1
// 0x01019a80: 0x1019a80: jal   0x104ed88 addu  a1, s2, zero
	ldloc 13
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01019aac: 0x1019aac: addiu a2, zero, 12
	...
	stloc.3
L_1019ab0:
// 0x01019ab0: 0x1019ab0: jal   0x104ebec sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01019ae8: 0x1019ae8: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01019aec: 0x1019aec: lw    v0, 26748(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01019b1c: 0x1019b1c: bne   s1, zero, 0x1019b4c lui   s2, 0x30000
	...
	brtrue L_1019b4c
// --- basic block ---
// 0x01019b24: 0x1019b24: j	 0x1019b34 sw    zero, 26748(s2)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01019b4c: 0x1019b4c: jal   0x1001ba8 addu  a0, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x01019b54: 0x1019b54: sw    v0, 26748(s2)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01019bf8: 0x1019bf8: addiu a1, zero, 1024
	ldc.i4 1024
	stloc.2
// 0x01019bfc: 0x1019bfc: jal   0x10c0c00 sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a098: 0x101a098: lw    a0, 4(s2)
	...
	ldelem.i4
	stloc.1
// 0x0101a09c: 0x101a09c: jal   0x10ac6d8 sll   zero, zero, 0
	call void Cibyl129::roadmap_voice_announce_10ac6d8()
// --- basic block ---
L_101a0a4:
