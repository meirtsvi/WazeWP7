...
// 0x01018cb0: 0x1018cb0: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x01018cb4: 0x1018cb4: jal   0x1018438 sw    v0, -28208(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01018ccc: 0x1018ccc: lui   a1, 0x1010000
	ldc.i4 16842752
	stloc.2
// 0x01018cd0: 0x1018cd0: sw    a2, -28204(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01018cdc: 0x1018cdc: addiu a0, zero, 15000
	ldc.i4 15000
	stloc.1
// 0x01018ce0: 0x1018ce0: sw    zero, -28208(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
	...
	ldc.i4.s 0
	stelem.i4
// 0x01018ce4: 0x1018ce4: jal   0x104ffc4 sw    zero, -28200(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01018d8c: 0x1018d8c: beq   s2, v0, 0x1018e64 addiu v1, zero, 1
	...
	beq  L_1018e64
// --- basic block ---
// 0x01018d94: 0x1018d94: lw    v0, -28204(s3)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01018e58: 0x1018e58: lui   v0, 0x30000
	...
	stloc 5
L_1018e5c:
// 0x01018e5c: 0x1018e5c: j	 0x101909c sw    zero, -28204(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1018e64:
// 0x01018e64: 0x1018e64: lw    v0, -28204(s3)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01018eb0: 0x1018eb0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01018eb4: 0x1018eb4: lw    v0, -28208(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01018ebc: 0x1018ebc: beq   v0, zero, 0x101909c sw    zero, -28204(s3)
	ldloc 5
	ldloc 6
	ldloc 10
	ldc.i4.2
...
// 0x01018ef8: 0x1018ef8: addu  a1, s4, zero
	ldloc 8
	stloc.2
// 0x01018efc: 0x1018efc: jal   0x1016ef8 sw    zero, -28204(s3)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01018f18: 0x1018f18: jal   0x100449c addiu a2, zero, 1026
	...
	stloc 5
// --- basic block ---
// 0x01018f20: 0x1018f20: beq   s4, zero, 0x101909c sw    zero, -28204(s3)
	ldloc 8
	ldloc 6
	ldloc 10
	ldc.i4.2
...
// 0x01018f9c: 0x1018f9c: addu  a0, s6, zero
	ldloc 11
	stloc.1
// 0x01018fa0: 0x1018fa0: addiu a1, a1, 26012
	ldloc.2
	ldc.i4 26012
	add
	stloc.2
...
// 0x01018fd8: 0x1018fd8: lui   a3, 0x10000
	ldc.i4 65536
	stloc 4
// 0x01018fdc: 0x1018fdc: addiu v0, v0, 26012
	ldloc 5
	ldc.i4 26012
	add
	stloc 5
...
// 0x01019010: 0x1019010: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01019014: 0x1019014: addiu a1, a1, 26413
	ldloc.2
	ldc.i4 26413
	add
	stloc.2
...
// 0x01019040: 0x1019040: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01019044: 0x1019044: addiu v0, v0, 26413
	ldloc 5
	ldc.i4 26413
	add
	stloc 5
...
// --- basic block ---
L_1019360:
// 0x01019360: 0x1019360: lw    v0, 26736(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01019384: 0x1019384: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x01019388: 0x1019388: lw    v1, 26728(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010193a8: 0x10193a8: addiu a0, a0, -31260
	...
	add
	stloc.1
// 0x010193ac: 0x10193ac: jal   0x104ef7c sw    v1, 26728(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010193bc: 0x10193bc: addiu a0, a0, 32004
	...
	add
	stloc.1
// 0x010193c0: 0x10193c0: jal   0x104ee2c sw    v0, 26736(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010193dc: 0x10193dc: addiu a0, a0, 4720
	...
	add
	stloc.1
// 0x010193e0: 0x10193e0: jal   0x1019280 sw    v0, 26740(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010193f0: 0x10193f0: addiu a0, a0, 4768
	...
	add
	stloc.1
// 0x010193f4: 0x10193f4: jal   0x1019280 sw    v0, 26744(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01019404: 0x1019404: addiu a0, a0, 4784
	...
	add
	stloc.1
// 0x01019408: 0x1019408: jal   0x1019280 sw    v0, 26748(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01019418: 0x1019418: addiu a0, a0, 4736
	...
	add
	stloc.1
// 0x0101941c: 0x101941c: jal   0x1019280 sw    v0, 26752(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101942c: 0x101942c: addiu a0, a0, 4752
	...
	add
	stloc.1
// 0x01019430: 0x1019430: sw    v0, 26756(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101943c: 0x101943c: lui   v1, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01019440: 0x1019440: sw    v0, 26760(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010196e4: 0x10196e4: lui   a1, 0xe0000
	ldc.i4 917504
	stloc.2
// 0x010196e8: 0x10196e8: addiu a1, a1, 29604
	ldloc.2
	ldc.i4 29604
	add
	stloc.2
...
// 0x01019af4: 0x1019af4: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01019af8: 0x1019af8: lw    v0, 26732(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01019b28: 0x1019b28: bne   s1, zero, 0x1019b58 lui   s2, 0x30000
	...
	brtrue L_1019b58
// --- basic block ---
// 0x01019b30: 0x1019b30: j	 0x1019b40 sw    zero, 26732(s2)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01019b58: 0x1019b58: jal   0x1001ba8 addu  a0, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x01019b60: 0x1019b60: sw    v0, 26732(s2)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101a0a4: 0x101a0a4: lw    a0, 4(s2)
	...
	ldelem.i4
	stloc.1
// 0x0101a0a8: 0x101a0a8: jal   0x10ac924 sll   zero, zero, 0
	call void Cibyl129::roadmap_voice_announce_10ac924()
// --- basic block ---
L_101a0b0:
