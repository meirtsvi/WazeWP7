...
// 0x01018cb0: 0x1018cb0: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x01018cb4: 0x1018cb4: jal   0x1018438 sw    v0, -28048(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01018ccc: 0x1018ccc: lui   a1, 0x1010000
	ldc.i4 16842752
	stloc.2
// 0x01018cd0: 0x1018cd0: sw    a2, -28044(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01018cdc: 0x1018cdc: addiu a0, zero, 15000
	ldc.i4 15000
	stloc.1
// 0x01018ce0: 0x1018ce0: sw    zero, -28048(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
	...
	ldc.i4.s 0
	stelem.i4
// 0x01018ce4: 0x1018ce4: jal   0x105003c sw    zero, -28040(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01018cf0: 0x1018cf0: addiu a1, a1, 28112
	...
	add
	stloc.2
// 0x01018cf4: 0x1018cf4: jal   0x105003c addiu a0, zero, 100
	ldc.i4.s 100
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01018cfc: 0x1018cfc: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01018d00: 0x1018d00: jal   0x101df70 addiu a0, a0, 7100
	ldloc.1
	ldc.i4 7100
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x01018d08: 0x1018d08: jal   0x106ce88 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl81::Realtime_FoursquareSearch_106ce88(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x01018d74: 0x1018d74: sw    s5, 180(sp)
	...
	ldloc 14
	stelem.i4
// 0x01018d78: 0x1018d78: jal   0x104fea4 sw    s0, 160(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x01018d80: 0x1018d80: jal   0x104c488 lui   s3, 0x30000
	ldc.i4 196608
	stloc 10
...
// 0x01018d8c: 0x1018d8c: beq   s2, v0, 0x1018e64 addiu v1, zero, 1
	...
	beq  L_1018e64
// --- basic block ---
// 0x01018d94: 0x1018d94: lw    v0, -28044(s3)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01018e28: 0x1018e28: addiu a0, a0, 30116
	...
	add
	stloc.1
// 0x01018e2c: 0x1018e2c: jal   0x104c1e0 addiu a1, a1, 30124
	ldloc.2
	ldc.i4 30124
	add
	stloc.2
...
// 0x01018e58: 0x1018e58: lui   v0, 0x30000
	...
	stloc 5
L_1018e5c:
// 0x01018e5c: 0x1018e5c: j	 0x101909c sw    zero, -28044(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1018e64:
// 0x01018e64: 0x1018e64: lw    v0, -28044(s3)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01018eb0: 0x1018eb0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01018eb4: 0x1018eb4: lw    v0, -28048(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01018ebc: 0x1018ebc: beq   v0, zero, 0x101909c sw    zero, -28044(s3)
	ldloc 5
	ldloc 6
	ldloc 10
	ldc.i4.2
...
// 0x01018ef8: 0x1018ef8: addu  a1, s4, zero
	ldloc 8
	stloc.2
// 0x01018efc: 0x1018efc: jal   0x1016ef8 sw    zero, -28044(s3)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01018f18: 0x1018f18: jal   0x100449c addiu a2, zero, 1026
	...
	stloc 5
// --- basic block ---
// 0x01018f20: 0x1018f20: beq   s4, zero, 0x101909c sw    zero, -28044(s3)
	ldloc 8
	ldloc 6
	ldloc 10
	ldc.i4.2
...
// 0x01018f54: 0x1018f54: sw    v0, 24(sp)
	...
	ldloc 5
	stelem.i4
// 0x01018f58: 0x1018f58: jal   0x1068440 sw    s2, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01018f9c: 0x1018f9c: addu  a0, s6, zero
	ldloc 11
	stloc.1
// 0x01018fa0: 0x1018fa0: addiu a1, a1, 26172
	ldloc.2
	ldc.i4 26172
	add
	stloc.2
...
// 0x01018fac: 0x1018fac: sw    v0, 24(sp)
	...
	ldloc 5
	stelem.i4
// 0x01018fb0: 0x1018fb0: jal   0x1068440 sw    s2, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01018fd8: 0x1018fd8: lui   a3, 0x10000
	ldc.i4 65536
	stloc 4
// 0x01018fdc: 0x1018fdc: addiu v0, v0, 26172
	ldloc 5
	ldc.i4 26172
	add
	stloc 5
...
// 0x01019010: 0x1019010: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01019014: 0x1019014: addiu a1, a1, 26573
	ldloc.2
	ldc.i4 26573
	add
	stloc.2
...
// 0x01019024: 0x1019024: sw    v0, 24(sp)
	...
	ldloc 5
	stelem.i4
// 0x01019028: 0x1019028: jal   0x1068440 sw    s2, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01019040: 0x1019040: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01019044: 0x1019044: addiu v0, v0, 26573
	ldloc 5
	ldc.i4 26573
	add
	stloc 5
...
// 0x01019070: 0x1019070: addiu a1, a1, 32704
	...
	add
	stloc.2
// 0x01019074: 0x1019074: jal   0x105003c addiu a0, zero, 100
	ldc.i4.s 100
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010190d8: 0x10190d8: lui   a2, 0x20000
	ldc.i4 131072
	stloc.3
// 0x010190dc: 0x10190dc: addiu a0, s1, 12796
	ldloc 8
	ldc.i4 12796
	add
	stloc.1
// 0x010190e0: 0x10190e0: addiu a1, a1, 4640
	...
	add
	stloc.2
// 0x010190e4: 0x10190e4: addiu a2, a2, -6668
	ldloc.3
	ldc.i4 -6668
	add
	stloc.3
...
// 0x01019100: 0x1019100: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x01019104: 0x1019104: addiu a0, s1, 12796
	ldloc 8
	ldc.i4 12796
	add
	stloc.1
...
// 0x0101911c: 0x101911c: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x01019120: 0x1019120: addiu a0, s1, 12796
	ldloc 8
	ldc.i4 12796
	add
	stloc.1
...
// 0x01019138: 0x1019138: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x0101913c: 0x101913c: addiu a0, s1, 12796
	ldloc 8
	ldc.i4 12796
	add
	stloc.1
...
// 0x010191f8: 0x10191f8: addiu s0, s0, 2480
	...
	add
	stloc 5
// 0x010191fc: 0x10191fc: j	 0x1019248 addiu s1, s1, 12796
	ldloc 8
	ldc.i4 12796
	add
	stloc 8
...
// 0x0101933c: 0x101933c: addu  a0, s2, zero
	ldloc 8
	stloc.1
// 0x01019340: 0x1019340: jal   0x104eff4 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01019348: 0x1019348: addu  a0, s1, zero
	ldloc 12
	stloc.1
// 0x0101934c: 0x101934c: jal   0x104eea4 sw    v0, 280(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1019360:
// 0x01019360: 0x1019360: lw    v0, 26896(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01019384: 0x1019384: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x01019388: 0x1019388: lw    v1, 26888(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010193a8: 0x10193a8: addiu a0, a0, -31260
	...
	add
	stloc.1
// 0x010193ac: 0x10193ac: jal   0x104eff4 sw    v1, 26888(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010193bc: 0x10193bc: addiu a0, a0, 32004
	...
	add
	stloc.1
// 0x010193c0: 0x10193c0: jal   0x104eea4 sw    v0, 26896(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010193dc: 0x10193dc: addiu a0, a0, 4720
	...
	add
	stloc.1
// 0x010193e0: 0x10193e0: jal   0x1019280 sw    v0, 26900(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010193f0: 0x10193f0: addiu a0, a0, 4768
	...
	add
	stloc.1
// 0x010193f4: 0x10193f4: jal   0x1019280 sw    v0, 26904(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01019404: 0x1019404: addiu a0, a0, 4784
	...
	add
	stloc.1
// 0x01019408: 0x1019408: jal   0x1019280 sw    v0, 26908(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01019418: 0x1019418: addiu a0, a0, 4736
	...
	add
	stloc.1
// 0x0101941c: 0x101941c: jal   0x1019280 sw    v0, 26912(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101942c: 0x101942c: addiu a0, a0, 4752
	...
	add
	stloc.1
// 0x01019430: 0x1019430: sw    v0, 26916(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101943c: 0x101943c: lui   v1, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01019440: 0x1019440: sw    v0, 26920(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01019454: 0x1019454: addiu a0, zero, 230
	ldc.i4 230
	stloc.1
// 0x01019458: 0x1019458: jal   0x104e504 sw    v0, 60(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010196b0: 0x10196b0: beq   a2, zero, 0x10196d4 addiu a1, zero, 1
	...
	brfalse L_10196d4
// --- basic block ---
// 0x010196b8: 0x10196b8: jal   0x10a1b28 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010196c8: 0x10196c8: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x010196cc: 0x10196cc: jal   0x104f64c addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x010196e4: 0x10196e4: lui   a1, 0xe0000
	ldc.i4 917504
	stloc.2
// 0x010196e8: 0x10196e8: addiu a1, a1, 29764
	ldloc.2
	ldc.i4 29764
	add
	stloc.2
...
// 0x01019864: 0x1019864: bne   v0, zero, 0x1019880 addu  a0, s8, zero
	...
	brtrue L_1019880
// --- basic block ---
// 0x0101986c: 0x101986c: jal   0x104eea4 addu  a0, s3, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010198ac: 0x10198ac: addu  a0, s4, zero
	...
	stloc.1
L_10198b0:
// 0x010198b0: 0x10198b0: jal   0x104eea4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010198cc: 0x10198cc: bne   v0, zero, 0x10198e4 sll   zero, zero, 0
	...
	brtrue L_10198e4
// --- basic block ---
// 0x010198d4: 0x10198d4: jal   0x104eea4 addu  a0, s3, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_10198e4:
// 0x010198e4: 0x10198e4: jal   0x104eea4 addu  a0, s3, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01019900: 0x1019900: addu  a1, s2, zero
	ldloc 13
	stloc.2
// 0x01019904: 0x1019904: jal   0x104eb54 sw    v0, 300(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01019924: 0x1019924: sw    v0, 16(sp)
	...
	ldloc 5
	stelem.i4
// 0x01019928: 0x1019928: jal   0x104ea5c sw    zero, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01019a88: 0x1019a88: addu  a0, s0, zero
	ldloc 11
	stloc.1
// 0x01019a8c: 0x1019a8c: jal   0x104ecf0 addu  a1, s2, zero
	ldloc 13
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01019ab8: 0x1019ab8: addiu a2, zero, 12
	...
	stloc.3
L_1019abc:
// 0x01019abc: 0x1019abc: jal   0x104eb54 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01019af4: 0x1019af4: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01019af8: 0x1019af8: lw    v0, 26892(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01019b28: 0x1019b28: bne   s1, zero, 0x1019b58 lui   s2, 0x30000
	...
	brtrue L_1019b58
// --- basic block ---
// 0x01019b30: 0x1019b30: j	 0x1019b40 sw    zero, 26892(s2)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01019b58: 0x1019b58: jal   0x1001ba8 addu  a0, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x01019b60: 0x1019b60: sw    v0, 26892(s2)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01019c04: 0x1019c04: addiu a1, zero, 1024
	ldc.i4 1024
	stloc.2
// 0x01019c08: 0x1019c08: jal   0x10c0f10 sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101a0a4: 0x101a0a4: lw    a0, 4(s2)
	...
	ldelem.i4
	stloc.1
// 0x0101a0a8: 0x101a0a8: jal   0x10ac9e0 sll   zero, zero, 0
	call void Cibyl129::roadmap_voice_announce_10ac9e0()
// --- basic block ---
L_101a0b0:
