...
// 0x0102bd04: 0x102bd04: lui   v0, 0x60000
	ldc.i4 393216
	stloc.2
// 0x0102bd08: 0x102bd08: sw    a0, -24128(v0)
	ldloc 3
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0102bd0c: 0x102bd0c: lui   v0, 0x60000
	ldc.i4 393216
	stloc.2
// 0x0102bd10: 0x102bd10: jr    ra sw    a1, -24124(v0)
	ldloc 3
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0102bd18: 0x102bd18: lui   v0, 0x60000
	ldc.i4 393216
	stloc.0
// 0x0102bd1c: 0x102bd1c: lw    v0, -24128(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0102bdb4: 0x102bdb4: lui   v0, 0x60000
	ldc.i4 393216
	stloc.3
// 0x0102bdb8: 0x102bdb8: lw    v1, -24128(v0)
	ldloc 6
	ldloc.3
	ldc.i4.2
	shr.un
...
// 0x0102be54: 0x102be54: lui   v0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x0102be58: 0x102be58: lw    v0, -24124(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0102be8c: 0x102be8c: lui   v0, 0x60000
	ldc.i4 393216
	stloc.0
// 0x0102be90: 0x102be90: lw    v0, -24124(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0102beac: 0x102beac: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x0102beb0: 0x102beb0: addiu a0, s0, 12716
	ldloc 5
	ldc.i4 12716
	add
	stloc.1
...
// 0x0102becc: 0x102becc: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x0102bed0: 0x102bed0: addiu a0, s0, 12716
	ldloc 5
	ldc.i4 12716
	add
	stloc.1
...
// 0x0102c0c4: 0x102c0c4: addiu a0, a0, 6788
	...
	add
	stloc.1
// 0x0102c0c8: 0x102c0c8: jal   0x100e7a8 sw    v0, -24128(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102c0d4: 0x102c0d4: lui   v1, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0102c0d8: 0x102c0d8: sw    v0, -24124(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102c158: 0x102c158: lui   s0, 0x60000
	ldc.i4 393216
	stloc 6
// 0x0102c15c: 0x102c15c: lw    v0, -23740(s0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0102c16c: 0x102c16c: jalr  v0 sll   zero, zero, 0
	...
	stloc 7
// --- basic block ---
// 0x0102c174: 0x102c174: sw    zero, -23740(s0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0102c194: 0x102c194: lui   v1, 0x60000
	ldc.i4 393216
	stloc.1
// 0x0102c198: 0x102c198: lw    v0, -23752(v1)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.3
// 0x0102c19c: 0x102c19c: jr    ra sw    a0, -23752(v1)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0102c258: 0x102c258: lui   s0, 0x60000
	ldc.i4 393216
	stloc 7
// 0x0102c25c: 0x102c25c: lw    v0, -24120(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0102c27c: 0x102c27c: jal   0x1029be0 addiu a1, a1, 6836
	...
	stloc 6
// --- basic block ---
// 0x0102c284: 0x102c284: beq   v0, zero, 0x102c324 sw    v0, -24120(s0)
	ldloc 6
	ldloc 5
	ldloc 7
	ldc.i4.2
...
// 0x0102c294: 0x102c294: jal   0x109a378 addu  a0, zero, zero
	...
	stloc 6
// --- basic block ---
// 0x0102c29c: 0x102c29c: lw    a0, -24120(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0102c2bc: 0x102c2bc: jal   0x109c9a0 addiu a3, zero, 1
	...
	stloc 6
// --- basic block ---
// 0x0102c2c4: 0x102c2c4: lw    a0, -24120(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0102c2e0: 0x102c2e0: jal   0x109c9a0 addiu a1, s2, -25448
	...
	stloc 6
// --- basic block ---
// 0x0102c2e8: 0x102c2e8: lw    a0, -24120(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0102c2f8: 0x102c2f8: lui   a3, 0x1030000
	ldc.i4 16973824
	stloc 4
// 0x0102c2fc: 0x102c2fc: lw    a2, -24120(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0102c384: 0x102c384: addiu sp, sp, -32
	...
	add
	stloc.0
// 0x0102c388: 0x102c388: addiu a0, a0, 18656
	ldloc.1
	ldc.i4 18656
	add
	stloc.1
...
// 0x0102c40c: 0x102c40c: lui   s0, 0x60000
	ldc.i4 393216
	stloc 7
// 0x0102c410: 0x102c410: lw    v0, -24072(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0102c42c: 0x102c42c: sw    v0, 16(sp)
	...
	ldloc 5
	stelem.i4
// 0x0102c430: 0x102c430: addiu a0, a0, -24068
	ldloc.1
	ldc.i4 -24068
	add
	stloc.1
...
// 0x0102c44c: 0x102c44c: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x0102c450: 0x102c450: sw    v0, -24072(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0102c458: 0x102c458: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0102c45c: 0x102c45c: addiu v0, v0, -24068
	ldloc 5
	ldc.i4 -24068
	add
	stloc 5
...
// 0x0102c4d8: 0x102c4d8: addiu a0, s0, -25312
	...
	add
	stloc.1
// 0x0102c4dc: 0x102c4dc: addiu a1, a1, 18656
	ldloc.2
	ldc.i4 18656
	add
	stloc.2
...
// 0x0102c538: 0x102c538: addu  a1, s1, zero
	ldloc 9
	stloc.2
// 0x0102c53c: 0x102c53c: jal   0x1098c64 addiu a0, a0, -2808
	ldloc.1
	ldc.i4 -2808
	add
	stloc.1
...
// 0x0102c5ac: 0x102c5ac: addiu a3, s1, -13684
	...
	add
	stloc 4
// 0x0102c5b0: 0x102c5b0: addiu a0, a0, -24068
	ldloc.1
	ldc.i4 -24068
	add
	stloc.1
...
// 0x0102ca9c: 0x102ca9c: jal   0x1001b14 addiu a1, a1, -24068
	ldloc.2
	ldc.i4 -24068
	add
	stloc.2
...
// 0x0102cc58: 0x102cc58: lw    a0, 52(sp)
	...
	ldelem.i4
	stloc.1
// 0x0102cc5c: 0x102cc5c: sw    v0, -24112(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
	...
	ldloc 5
	stelem.i4
// 0x0102cc60: 0x102cc60: jal   0x1001ba8 addiu s1, s1, -24112
	ldloc 8
	ldc.i4 -24112
	add
	stloc 8
...
// 0x0102cc74: 0x102cc74: lui   v1, 0x10000
	ldc.i4 65536
	stloc 7
// 0x0102cc78: 0x102cc78: addiu v1, v1, 18656
	ldloc 7
	ldc.i4 18656
	add
	stloc 7
...
// 0x0102cc8c: 0x102cc8c: sw    v1, 12(s1)
	...
	ldloc 7
	stelem.i4
// 0x0102cc90: 0x102cc90: addiu a1, s3, -14024
	ldloc 11
	ldc.i4 -14024
	add
	stloc.2
...
// 0x0102cca8: 0x102cca8: lw    a2, 0(s0)
	...
	ldelem.i4
	stloc.3
// 0x0102ccac: 0x102ccac: addiu a1, s3, -14024
	ldloc 11
	ldc.i4 -14024
	add
	stloc.2
...
// --- basic block ---
L_102ce6c:
// 0x0102ce6c: 0x102ce6c: lw    v0, -24080(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0102ce8c: 0x102ce8c: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x0102ce90: 0x102ce90: sw    v0, -24080(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0102cf04: 0x102cf04: addiu a0, zero, 4
	ldc.i4.4
	stloc.1
// 0x0102cf08: 0x102cf08: jal   0x100449c addiu a2, zero, 3310
	ldc.i4 3310
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0102cfb8: 0x102cfb8: addiu a3, a3, -25180
	...
	add
	stloc 4
// 0x0102cfbc: 0x102cfbc: addiu a2, zero, 560
	ldc.i4 560
	stloc.3
...
// 0x0102d088: 0x102d088: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0102d08c: 0x102d08c: lw    v1, -24076(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102d094: 0x102d094: beq   v1, zero, 0x102d0ac sll   zero, zero, 0
	...
	brfalse L_102d0ac
// --- basic block ---
// 0x0102d09c: 0x102d09c: jal   0x1021480 sw    zero, -24076(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
