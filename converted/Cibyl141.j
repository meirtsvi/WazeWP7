...
// 0x010bd1d4: 0x10bd1d4: addiu a0, a0, -11788
	...
	add
	stloc.1
// 0x010bd1d8: 0x10bd1d8: jal   0x106c65c sw    v0, 19500(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010bd208: 0x10bd208: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010bd20c: 0x10bd20c: lw    a0, 19500(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010bd26c: 0x10bd26c: addiu a0, a0, -11636
	...
	add
	stloc.1
// 0x010bd270: 0x10bd270: jal   0x106c898 sw    v0, 19504(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010bd2a0: 0x10bd2a0: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010bd2a4: 0x10bd2a4: lw    a0, 19504(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010bd380: 0x10bd380: addiu sp, sp, -48
	...
	add
	stloc.0
// 0x010bd384: 0x10bd384: addiu a0, a0, 19508
	ldloc.1
	ldc.i4 19508
	add
	stloc.1
...
// 0x010bd620: 0x10bd620: addiu a0, a0, 12676
	...
	add
	stloc.1
// 0x010bd624: 0x10bd624: addiu a1, a1, 19508
	ldloc.2
	ldc.i4 19508
	add
	stloc.2
...
// 0x010bd860: 0x10bd860: jal   0x100e368 addiu a0, a0, 19532
	ldloc.1
	ldc.i4 19532
	add
	stloc.1
...
// 0x010bd880: 0x10bd880: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x010bd884: 0x10bd884: addiu a0, a0, 19548
	ldloc.1
	ldc.i4 19548
	add
	stloc.1
...
// 0x010bd8e8: 0x10bd8e8: beq   v0, zero, 0x10bd934 lui   v0, 0x0
	...
	brfalse L_10bd934
// --- basic block ---
// 0x010bd8f0: 0x10bd8f0: lw    v1, 19524(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010bd908: 0x10bd908: addiu v1, v1, 1
	...
	stloc 6
L_10bd90c:
// 0x010bd90c: 0x10bd90c: sw    v1, 19524(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010bd914: 0x10bd914: lui   s0, 0xe0000
	ldc.i4 917504
	stloc 9
// 0x010bd918: 0x10bd918: lw    a2, 19524(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010bd93c: 0x10bd93c: bne   v0, zero, 0x10bd990 lui   v0, 0x0
	...
	brtrue L_10bd990
// --- basic block ---
// 0x010bd944: 0x10bd944: lw    v1, 19528(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010bd974: 0x10bd974: lui   v1, 0x0
	ldc.i4.s 0
	stloc 6
// 0x010bd978: 0x10bd978: beq   v0, zero, 0x10bda3c sw    a0, 19528(v1)
	ldloc 5
	ldloc 7
	ldloc 6
	ldc.i4.2
...
// --- basic block ---
L_10bd990:
// 0x010bd990: 0x10bd990: lw    a0, 19528(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010bd998: 0x10bd998: bne   a0, v1, 0x10bd9a4 addiu v1, zero, 3
	...
	bne.un L_10bd9a4
// --- basic block ---
// 0x010bd9a0: 0x10bd9a0: sw    v1, 19528(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010bd9fc: 0x10bd9fc: lui   v1, 0x0
	ldc.i4.s 0
	stloc 6
// 0x010bda00: 0x10bda00: lw    a3, 19528(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010bda18: 0x10bda18: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010bda1c: 0x10bda1c: lw    v1, 19528(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010bda34: 0x10bda34: addiu v1, v1, 1
	...
	stloc 6
L_10bda38:
// 0x010bda38: 0x10bda38: sw    v1, 19528(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010bda5c: 0x10bda5c: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x010bda60: 0x10bda60: addiu a0, a0, 19564
	ldloc.1
	ldc.i4 19564
	add
	stloc.1
...
// 0x010bdaa0: 0x10bdaa0: addiu s1, s1, 20820
	...
	add
	stloc 9
// 0x010bdaa4: 0x10bdaa4: addiu a1, a1, 19564
	ldloc.2
	ldc.i4 19564
	add
	stloc.2
...
// 0x010bdadc: 0x10bdadc: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x010bdae0: 0x10bdae0: addiu a1, a1, 19548
	ldloc.2
	ldc.i4 19548
	add
	stloc.2
...
// 0x010bdb04: 0x10bdb04: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x010bdb08: 0x10bdb08: addiu a1, a1, 19532
	ldloc.2
	ldc.i4 19532
	add
	stloc.2
...
// --- basic block ---
L_10bde08:
// 0x010bde08: 0x10bde08: lw    v1, 18808(s4)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x010be02c: 0x10be02c: addiu a0, a0, 23144
	...
	add
	stloc.1
// 0x010be030: 0x10be030: addiu a1, a1, 19580
	ldloc.2
	ldc.i4 19580
	add
	stloc.2
...
// 0x010be2dc: 0x10be2dc: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x010be2e0: 0x10be2e0: lw    a0, 18808(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
