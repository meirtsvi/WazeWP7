...
// 0x0106c450: 0x106c450: sw    s3, 28(sp)
	...
	ldloc 11
	stelem.i4
// 0x0106c454: 0x106c454: jal   0x10b5e5c sw    s2, 24(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_106c4ac:
// 0x0106c4ac: 0x106c4ac: jal   0x10b5908 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0106c604: 0x106c604: jal   0x10b4054 sw    s1, 120(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0106c624: 0x106c624: sw    s1, 16(sp)
	...
	ldloc 8
	stelem.i4
// 0x0106c628: 0x106c628: jal   0x10b3f10 sw    v0, 20(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl134::editor_marker_export_10b3f10(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 10
	stloc 6
// --- basic block ---
// 0x0106c630: 0x106c630: jal   0x10b400c addu  a0, s0, zero
	ldloc 7
	stloc.1
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl134::editor_marker_type_10b400c(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 10
	stloc 6
// --- basic block ---
...
// 0x0106c6b0: 0x106c6b0: sw    s1, 20(sp)
	...
	ldloc 7
	stelem.i4
// 0x0106c6b4: 0x106c6b4: jal   0x10b4348 sw    s0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_106c6e8:
// 0x0106c6e8: 0x106c6e8: jal   0x10b3e14 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl134::editor_marker_committed_10b3e14(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 8
	stloc 5
// --- basic block ---
