...
// 0x01035460: 0x1035460: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01035464: 0x1035464: addiu v0, v0, 25900
	ldloc 5
	ldc.i4 25900
	add
	stloc 5
...
// 0x01035674: 0x1035674: sw    a0, 12556(v0)
	...
	ldloc.1
	stelem.i4
// 0x01035678: 0x1035678: addiu v1, v1, 26164
	ldloc 6
	ldc.i4 26164
	add
	stloc 6
// 0x0103567c: 0x103567c: addiu s8, s8, 21804
	ldloc 14
	ldc.i4 21804
	add
	stloc 14
// 0x01035680: 0x1035680: addiu s7, s7, 3100
	...
	add
	stloc 13
// 0x01035684: 0x1035684: addiu s2, s2, -16980
	ldloc 9
	ldc.i4 -16980
	add
	stloc 9
// 0x01035688: 0x1035688: addiu s3, s3, -17060
	ldloc 10
	ldc.i4 -17060
	add
	stloc 10
// 0x0103568c: 0x103568c: addiu s4, s4, -17140
	ldloc 11
	ldc.i4 -17140
	add
	stloc 11
...
// 0x010357e4: 0x10357e4: addu  a0, s0, zero
	ldloc 8
	stloc.1
// 0x010357e8: 0x10357e8: addiu a1, a1, 26220
	ldloc.2
	ldc.i4 26220
	add
	stloc.2
...
// 0x0103591c: 0x103591c: addu  s3, a3, zero
	ldloc 4
	stloc 9
// 0x01035920: 0x1035920: addiu s5, s5, 26236
	ldloc 8
	ldc.i4 26236
	add
	stloc 8
...
// 0x01035a58: 0x1035a58: lw    a0, 4(a1)
	...
	ldelem.i4
	stloc.1
// 0x01035a5c: 0x1035a5c: jal   0x101cb7c addiu a1, s0, -16592
	ldloc 8
	ldc.i4 -16592
	add
	stloc.2
...
// 0x01035a64: 0x1035a64: lui   s2, 0x60000
	ldc.i4 393216
	stloc 7
// 0x01035a68: 0x1035a68: sw    v0, -16864(s2)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01035a6c: 0x1035a6c: lw    a0, 8(s1)
	...
	ldelem.i4
	stloc.1
// 0x01035a70: 0x1035a70: jal   0x101cb7c addiu a1, s0, -16592
	ldloc 8
	ldc.i4 -16592
	add
	stloc.2
	...
	stloc 6
// --- basic block ---
// 0x01035a78: 0x1035a78: addiu s2, s2, -16864
	ldloc 7
	ldc.i4 -16864
	add
	stloc 7
...
// 0x01035a80: 0x1035a80: lw    a0, 12(s1)
	...
	ldelem.i4
	stloc.1
// 0x01035a84: 0x1035a84: jal   0x101cb7c addiu a1, s0, -16592
	ldloc 8
	ldc.i4 -16592
	add
	stloc.2
...
// 0x01035ae0: 0x1035ae0: addu  s3, a1, zero
	ldloc.2
	stloc 10
// 0x01035ae4: 0x1035ae4: addiu s2, s2, -16860
	ldloc 6
	ldc.i4 -16860
	add
	stloc 6
// 0x01035ae8: 0x1035ae8: addiu s4, s4, -16592
	ldloc 11
	ldc.i4 -16592
	add
	stloc 11
...
// 0x01035b18: 0x1035b18: addiu s0, s0, -1
	...
	add
	stloc 7
// 0x01035b1c: 0x1035b1c: sw    s0, -16864(v0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01035b5c: 0x1035b5c: lui   a1, 0x60000
	ldc.i4 393216
	stloc.2
// 0x01035b60: 0x1035b60: jal   0x101cb7c addiu a1, a1, -16592
	ldloc.2
	ldc.i4 -16592
	add
	stloc.2
...
// 0x01035b68: 0x1035b68: lui   v1, 0x60000
	ldc.i4 393216
	stloc 7
// 0x01035b6c: 0x1035b6c: sw    v0, -16864(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01035bac: 0x1035bac: lw    a0, 4(a1)
	...
	ldelem.i4
	stloc.1
// 0x01035bb0: 0x1035bb0: jal   0x101cb7c addiu a1, s0, -16592
	ldloc 8
	ldc.i4 -16592
	add
	stloc.2
...
// 0x01035bb8: 0x1035bb8: lui   s2, 0x60000
	ldc.i4 393216
	stloc 7
// 0x01035bbc: 0x1035bbc: sw    v0, -16864(s2)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01035bc0: 0x1035bc0: lw    a0, 8(s1)
	...
	ldelem.i4
	stloc.1
// 0x01035bc4: 0x1035bc4: jal   0x101cb7c addiu a1, s0, -16592
	ldloc 8
	ldc.i4 -16592
	add
	stloc.2
	...
	stloc 6
// --- basic block ---
// 0x01035bcc: 0x1035bcc: addiu s2, s2, -16864
	ldloc 7
	ldc.i4 -16864
	add
	stloc 7
...
// 0x01035bd4: 0x1035bd4: lw    a0, 12(s1)
	...
	ldelem.i4
	stloc.1
// 0x01035bd8: 0x1035bd8: jal   0x101cb7c addiu a1, s0, -16592
	ldloc 8
	ldc.i4 -16592
	add
	stloc.2
...
// 0x01035e50: 0x1035e50: lui   s2, 0x60000
	ldc.i4 393216
	stloc 10
// 0x01035e54: 0x1035e54: beq   v0, zero, 0x1035e9c addiu s1, s2, -16864
	ldloc 6
	ldloc 10
	ldc.i4 -16864
	add
...
// 0x01035e88: 0x1035e88: addiu v1, zero, 65
	ldc.i4.s 65
	stloc 7
// 0x01035e8c: 0x1035e8c: sb    v1, -16864(s2)
	ldloc 10
	ldc.i4 -16864
	add
	ldloc 7
...
// 0x01035e9c: 0x1035e9c: addiu v0, zero, 86
	ldc.i4.s 86
	stloc 6
// 0x01035ea0: 0x1035ea0: sb    v0, -16864(s2)
	ldloc 10
	ldc.i4 -16864
	add
	ldloc 6
...
// 0x01035ef0: 0x1035ef0: lui   a1, 0x60000
	ldc.i4 393216
	stloc.2
// 0x01035ef4: 0x1035ef4: jal   0x101cb7c addiu a1, a1, -16592
	ldloc.2
	ldc.i4 -16592
	add
	stloc.2
...
// 0x01035efc: 0x1035efc: lui   s1, 0x60000
	ldc.i4 393216
	stloc 7
// 0x01035f00: 0x1035f00: sw    v0, -16864(s1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01035f10: 0x1035f10: jal   0x1035c7c addiu a3, zero, 83
	...
	stloc 6
// --- basic block ---
// 0x01035f18: 0x1035f18: addiu s1, s1, -16864
	ldloc 7
	ldc.i4 -16864
	add
	stloc 7
...
// 0x01035fc4: 0x1035fc4: lui   s1, 0x60000
	ldc.i4 393216
	stloc 7
// 0x01035fc8: 0x1035fc8: sw    v0, -16864(s1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01035fd0: 0x1035fd0: jal   0x1035c00 addiu a1, zero, 1
	...
	stloc 5
// --- basic block ---
// 0x01035fd8: 0x1035fd8: addiu s1, s1, -16864
	ldloc 7
	ldc.i4 -16864
	add
	stloc 7
...
// 0x01036034: 0x1036034: jal   0x1000d8c lui   s1, 0x60000
	...
	stloc 5
// --- basic block ---
// 0x0103603c: 0x103603c: sb    v0, -16864(s1)
	ldloc 7
	ldc.i4 -16864
	add
	ldloc 5
...
// 0x01036040: 0x1036040: lw    a0, 8(s0)
	...
	ldelem.i4
	stloc.1
// 0x01036044: 0x1036044: jal   0x1000d8c addiu s1, s1, -16864
	ldloc 7
	ldc.i4 -16864
	add
	stloc 7
...
// 0x010360c8: 0x10360c8: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010360cc: 0x10360cc: addiu v0, v0, -16864
	ldloc 5
	ldc.i4 -16864
	add
	stloc 5
...
// 0x01036104: 0x1036104: beq   s2, zero, 0x10361c0 lui   s4, 0x60000
	...
	brfalse L_10361c0
// --- basic block ---
// 0x0103610c: 0x103610c: addiu s4, s4, -16864
	ldloc 12
	ldc.i4 -16864
	add
	stloc 12
...
// 0x01036174: 0x1036174: lui   v1, 0x60000
	ldc.i4 393216
	stloc 8
// 0x01036178: 0x1036178: addiu v1, v1, -16864
	ldloc 8
	ldc.i4 -16864
	add
	stloc 8
...
// 0x01036224: 0x1036224: addiu s5, a0, -4
	...
	add
	stloc 13
// 0x01036228: 0x1036228: sb    v0, -16864(s0)
	ldloc 8
	ldc.i4 -16864
	add
	ldloc 7
...
// 0x0103622c: 0x103622c: lw    a0, 8(a1)
	...
	ldelem.i4
	stloc.1
// 0x01036230: 0x1036230: addiu s4, s0, -16864
	ldloc 8
	ldc.i4 -16864
	add
	stloc 11
...
// 0x01036270: 0x1036270: lui   v1, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01036274: 0x1036274: addiu v1, v1, -16864
	ldloc 5
	ldc.i4 -16864
	add
	stloc 5
...
// 0x01036284: 0x1036284: bne   s0, s3, 0x103624c lui   v1, 0x60000
	...
	bne.un L_103624c
// --- basic block ---
// 0x0103628c: 0x103628c: j	 0x1036278 addiu v1, v1, -16864
	ldloc 5
	ldc.i4 -16864
	add
	stloc 5
...
// 0x010362c0: 0x10362c0: addiu v1, s0, 2
	...
	add
	stloc 5
// 0x010362c4: 0x10362c4: addiu s2, s2, -16864
	ldloc 9
	ldc.i4 -16864
	add
	stloc 9
...
// 0x01036340: 0x1036340: lw    a1, 4(a1)
	...
	ldelem.i4
	stloc.2
// 0x01036344: 0x1036344: addiu a0, s0, -16864
	ldloc 5
	ldc.i4 -16864
	add
	stloc.1
// 0x01036348: 0x1036348: addiu a2, zero, 256
	ldc.i4 256
	stloc.3
// 0x0103634c: 0x103634c: jal   0x1001af8 addiu s0, s0, -16864
	ldloc 5
	ldc.i4 -16864
	add
	stloc 5
...
// 0x0103640c: 0x103640c: lui   s1, 0x60000
	ldc.i4 393216
	stloc 9
// 0x01036410: 0x1036410: sw    v0, -16864(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01036414: 0x1036414: lw    a0, 8(s0)
	...
	ldelem.i4
	stloc.1
// 0x01036418: 0x1036418: jal   0x103636c addiu s1, s1, -16864
	ldloc 9
	ldc.i4 -16864
	add
	stloc 9
...
// 0x01036420: 0x1036420: lui   a0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x01036424: 0x1036424: addiu a0, a0, -16860
	ldloc.1
	ldc.i4 -16860
	add
	stloc.1
...
// 0x0103644c: 0x103644c: lui   a0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x01036450: 0x1036450: addiu a0, a0, -16852
	ldloc.1
	ldc.i4 -16852
	add
	stloc.1
...
// 0x01036478: 0x1036478: lui   a0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x0103647c: 0x103647c: addiu a0, a0, -16844
	ldloc.1
	ldc.i4 -16844
	add
	stloc.1
...
// 0x010364e0: 0x10364e0: lui   v1, 0x60000
	ldc.i4 393216
	stloc 7
// 0x010364e4: 0x10364e4: addiu s3, v1, -16900
	ldloc 7
	ldc.i4 -16900
	add
	stloc 12
...
// 0x0103652c: 0x103652c: addu  a1, a1, a2
	...
	add
	stloc.2
// 0x01036530: 0x1036530: beq   a0, zero, 0x103666c sw    a1, -16900(v1)
	ldloc.1
	ldloc 6
	ldloc 7
	ldc.i4.2
...
// 0x010365ec: 0x10365ec: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010365f0: 0x10365f0: sw    s1, -16880(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010365f4: 0x10365f4: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010365f8: 0x10365f8: addiu v0, v0, -16900
	ldloc 5
	ldc.i4 -16900
	add
	stloc 5
...
// 0x01036610: 0x1036610: lui   s0, 0x60000
	ldc.i4 393216
	stloc 9
// 0x01036614: 0x1036614: addiu s0, s0, -16900
	ldloc 9
	ldc.i4 -16900
	add
	stloc 9
...
// 0x01036658: 0x1036658: lui   a0, 0x60000
	...
	stloc.1
L_103665c:
// 0x0103665c: 0x103665c: jal   0x10c395c addiu a0, a0, -16900
	ldloc.1
	ldc.i4 -16900
	add
	stloc.1
