...
// 0x01035c20: 0x1035c20: beq   v0, zero, 0x1035c58 sll   zero, zero, 0
	...
	brfalse L_1035c58
// --- basic block ---
// 0x01035c28: 0x1035c28: jal   0x10c1de0 addu  a0, s1, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01035c30: 0x1035c30: addu  a0, s0, zero
	ldloc 9
	stloc.1
// 0x01035c34: 0x1035c34: jal   0x10c0b2c addu  s1, v0, zero
	ldloc 5
	stloc 6
	ldloc.1
	conv.r4
...
// 0x01035c3c: 0x1035c3c: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01035c40: 0x1035c40: jal   0x10c0900 addu  a0, s1, zero
	ldloc 6
	stloc.1
	ldloc.1
	ldloc.2
	...
	stloc 5
// --- basic block ---
// 0x01035c48: 0x1035c48: jal   0x10c0a3c addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
...
// 0x010362b4: 0x10362b4: lw    a0, 0(v0)
	...
	ldelem.i4
	stloc.1
// 0x010362b8: 0x10362b8: jal   0x10c1de0 lui   s2, 0x60000
	ldc.i4 393216
	stloc 9
	ldloc.0
	ldloc.1
...
// 0x010362d4: 0x10362d4: lw    a0, 0(v1)
	...
	ldelem.i4
	stloc.1
// 0x010362d8: 0x10362d8: jal   0x10c1de0 addiu s0, s0, 3
	ldloc 8
	ldc.i4.3
	add
	stloc 8
...
// 0x010362ec: 0x10362ec: lw    a0, 0(s0)
	...
	ldelem.i4
	stloc.1
// 0x010362f0: 0x10362f0: jal   0x10c1de0 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01036630: 0x1036630: cibyl_sysc 0x58a
	...
	stloc 5
// 0x01036634: 0x1036634: jal   0x10c364c addu  v1, v0, zero
	ldloc 5
	stloc 7
	ldloc.0
	ldloc.1
...
// 0x01036658: 0x1036658: lui   a0, 0x60000
	...
	stloc.1
L_103665c:
// 0x0103665c: 0x103665c: jal   0x10c36fc addiu a0, a0, -16964
	ldloc.1
	ldc.i4 -16964
	add
	stloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl145::timegm_10c36fc(int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
