...
// 0x0107316c: 0x107316c: addiu v0, v0, -32496
	...
	add
	stloc 5
// 0x01073170: 0x1073170: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x0107360c: 0x107360c: lw    a3, 168(sp)
	...
	ldelem.i4
	stloc 4
// 0x01073610: 0x1073610: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073770: 0x1073770: addiu t0, t0, -32140
	...
	add
	stloc 9
// 0x01073774: 0x1073774: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x010737e4: 0x10737e4: addiu v1, v1, -32056
	...
	add
	stloc 5
// 0x010737e8: 0x10737e8: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x0107382c: 0x107382c: addiu v0, v0, 32228
	...
	add
	stloc 5
// 0x01073830: 0x1073830: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073874: 0x1073874: addiu v0, v0, 32228
	...
	add
	stloc 5
// 0x01073878: 0x1073878: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073920: 0x1073920: addiu t1, t1, -31848
	...
	add
	stloc 8
// 0x01073924: 0x1073924: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x010739a0: 0x10739a0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010739a4: 0x10739a4: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x010739f4: 0x10739f4: addiu v0, v0, -31748
	...
	add
	stloc 5
// 0x010739f8: 0x10739f8: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073a30: 0x1073a30: addiu v0, v0, -31716
	...
	add
	stloc 5
// 0x01073a34: 0x1073a34: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073b34: 0x1073b34: addiu t2, t2, -31680
	...
	add
	stloc 8
// 0x01073b38: 0x1073b38: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073b88: 0x1073b88: addiu v0, v0, -31548
	...
	add
	stloc 5
// 0x01073b8c: 0x1073b8c: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073c38: 0x1073c38: addiu t0, sp, 40
	...
	add
	stloc 8
// 0x01073c3c: 0x1073c3c: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073cf4: 0x1073cf4: addiu t0, sp, 40
	...
	add
	stloc 8
// 0x01073cf8: 0x1073cf8: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073d3c: 0x1073d3c: sw    a1, 16(sp)
	...
	ldloc.2
	stelem.i4
// 0x01073d40: 0x1073d40: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073de4: 0x1073de4: addiu v1, v1, -31392
	...
	add
	stloc 7
// 0x01073de8: 0x1073de8: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073e48: 0x1073e48: addiu v0, v0, -31292
	...
	add
	stloc 5
// 0x01073e4c: 0x1073e4c: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073ee8: 0x1073ee8: addiu v1, v1, -31232
	...
	add
	stloc 5
// 0x01073eec: 0x1073eec: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073f64: 0x1073f64: addiu v0, v0, -31216
	...
	add
	stloc 6
// 0x01073f68: 0x1073f68: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01073fd0: 0x1073fd0: addiu v1, v1, -31188
	...
	add
	stloc 5
// 0x01073fd4: 0x1073fd4: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x0107412c: 0x107412c: addiu t5, t5, -31148
	...
	add
	stloc 10
// 0x01074130: 0x1074130: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
