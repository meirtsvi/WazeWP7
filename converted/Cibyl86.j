...
// 0x01072efc: 0x1072efc: addu  a2, s1, zero
	ldloc 8
	stloc.3
// 0x01072f00: 0x1072f00: jal   0x10c0e50 sw    v0, 32(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01072fb0: 0x1072fb0: lui   v1, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01072fb4: 0x1072fb4: lw    a0, -18256(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010732b0: 0x10732b0: bne   v0, zero, 0x10732c0 lui   v1, 0x20000
	...
	brtrue L_10732c0
// --- basic block ---
// 0x010732b8: 0x10732b8: j	 0x10732c8 addiu v1, v1, 18840
	ldloc 7
	ldc.i4 18840
	add
	stloc 7
...
// 0x010732e0: 0x10732e0: bne   v0, zero, 0x10732f0 lui   v0, 0x20000
	...
	brtrue L_10732f0
// --- basic block ---
// 0x010732e8: 0x10732e8: j	 0x10732f8 addiu v0, v0, 18840
	ldloc 6
	ldc.i4 18840
	add
	stloc 6
...
// 0x010733d8: 0x10733d8: addiu v1, v1, 4
	...
	add
	stloc 7
// 0x010733dc: 0x10733dc: beq   t0, zero, 0x10733ec addiu v0, v0, 18840
	ldloc 13
	ldloc 6
	ldc.i4 18840
	add
...
// 0x01073420: 0x1073420: addiu a0, sp, 96
	...
	add
	stloc.1
// 0x01073424: 0x1073424: jal   0x10c3938 sw    v1, 96(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01073450: 0x1073450: bne   v1, zero, 0x1073460 lui   v1, 0x20000
	...
	brtrue L_1073460
// --- basic block ---
// 0x01073458: 0x1073458: j	 0x1073468 addiu v1, v1, 18840
	ldloc 7
	ldc.i4 18840
	add
	stloc 7
...
// 0x01073958: 0x1073958: lui   v1, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0107395c: 0x107395c: addiu v1, v1, 28960
	ldloc 5
	ldc.i4 28960
	add
	stloc 5
...
// 0x010739c4: 0x10739c4: sll   a3, a3, 2
	...
	shl
	stloc 4
// 0x010739c8: 0x10739c8: addiu a1, a1, 28972
	ldloc.2
	ldc.i4 28972
	add
	stloc.2
...
// 0x010739ec: 0x10739ec: sll   a0, a0, 2
	...
	shl
	stloc.1
// 0x010739f0: 0x10739f0: addiu a1, a1, 28984
	ldloc.2
	ldc.i4 28984
	add
	stloc.2
...
// 0x01073ac8: 0x1073ac8: bne   a2, zero, 0x1073ad8 lui   v1, 0x20000
	...
	brtrue L_1073ad8
// --- basic block ---
// 0x01073ad0: 0x1073ad0: j	 0x1073ae0 addiu v1, v1, 18840
	ldloc 7
	ldc.i4 18840
	add
	stloc 7
...
// 0x01073ae0: 0x1073ae0: bne   a3, zero, 0x1073af0 lui   v0, 0x20000
	...
	brtrue L_1073af0
// --- basic block ---
// 0x01073ae8: 0x1073ae8: j	 0x1073af8 addiu v0, v0, 18840
	ldloc 6
	ldc.i4 18840
	add
	stloc 6
...
// 0x01073b7c: 0x1073b7c: bne   a3, zero, 0x1073b8c lui   v1, 0x20000
	...
	brtrue L_1073b8c
// --- basic block ---
// 0x01073b84: 0x1073b84: j	 0x1073b94 addiu v1, v1, 18840
	ldloc 7
	ldc.i4 18840
	add
	stloc 7
...
// 0x01073b9c: 0x1073b9c: bne   v0, zero, 0x1073bac lui   v0, 0x20000
	...
	brtrue L_1073bac
// --- basic block ---
// 0x01073ba4: 0x1073ba4: j	 0x1073bb4 addiu v0, v0, 18840
	ldloc 6
	ldc.i4 18840
	add
	stloc 6
...
// 0x01073f08: 0x1073f08: bne   a3, zero, 0x1073f18 lui   t2, 0x20000
	...
	brtrue L_1073f18
// --- basic block ---
// 0x01073f10: 0x1073f10: j	 0x1073f20 addiu t2, t2, 18840
	ldloc 9
	ldc.i4 18840
	add
	stloc 9
...
// 0x01073f20: 0x1073f20: bne   a1, zero, 0x1073f30 lui   t1, 0x20000
	...
	brtrue L_1073f30
// --- basic block ---
// 0x01073f28: 0x1073f28: j	 0x1073f38 addiu t1, t1, 18840
	ldloc 8
	ldc.i4 18840
	add
	stloc 8
...
// 0x01073f38: 0x1073f38: bne   a0, zero, 0x1073f48 lui   t0, 0x20000
	...
	brtrue L_1073f48
// --- basic block ---
// 0x01073f40: 0x1073f40: j	 0x1073f50 addiu t0, t0, 18840
	ldloc 7
	ldc.i4 18840
	add
	stloc 7
...
// 0x01073f9c: 0x1073f9c: bne   a3, zero, 0x1073fac lui   t2, 0x20000
	...
	brtrue L_1073fac
// --- basic block ---
// 0x01073fa4: 0x1073fa4: j	 0x1073fb4 addiu t2, t2, 18840
	ldloc 9
	ldc.i4 18840
	add
	stloc 9
...
// 0x01073fb4: 0x1073fb4: bne   a1, zero, 0x1073fc4 lui   t1, 0x20000
	...
	brtrue L_1073fc4
// --- basic block ---
// 0x01073fbc: 0x1073fbc: j	 0x1073fcc addiu t1, t1, 18840
	ldloc 8
	ldc.i4 18840
	add
	stloc 8
...
// 0x01073fcc: 0x1073fcc: bne   a0, zero, 0x1073fdc lui   t0, 0x20000
	...
	brtrue L_1073fdc
// --- basic block ---
// 0x01073fd4: 0x1073fd4: j	 0x1073fe4 addiu t0, t0, 18840
	ldloc 7
	ldc.i4 18840
	add
	stloc 7
