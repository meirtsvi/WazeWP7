...
// 0x01066330: 0x1066330: lui   v0, 0x70000
	...
	stloc 5
L_1066334:
// 0x01066334: 0x1066334: lw    v0, 15964(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01066420: 0x1066420: lui   a0, 0x70000
	ldc.i4 458752
	stloc.1
// 0x01066424: 0x1066424: addiu a0, a0, 15968
	ldloc.1
	ldc.i4 15968
	add
	stloc.1
...
// 0x01066440: 0x1066440: lui   a0, 0x70000
	ldc.i4 458752
	stloc.1
// 0x01066444: 0x1066444: addiu a0, a0, 15968
	ldloc.1
	ldc.i4 15968
	add
	stloc.1
...
// --- basic block ---
L_1066454:
// 0x01066454: 0x1066454: addiu a0, a0, 15968
	ldloc.1
	ldc.i4 15968
	add
	stloc.1
...
// 0x01066490: 0x1066490: lui   s3, 0x70000
	ldc.i4 458752
	stloc 9
// 0x01066494: 0x1066494: addiu s3, s3, 15968
	ldloc 9
	ldc.i4 15968
	add
	stloc 9
...
// 0x010664a8: 0x10664a8: addu  a0, v0, zero
	ldloc 6
	stloc.1
// 0x010664ac: 0x10664ac: addiu s0, s0, 16004
	ldloc 8
	ldc.i4 16004
	add
	stloc 8
...
// 0x01066784: 0x1066784: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01066788: 0x1066788: j	 0x1066798 addiu v1, v1, 18792
	ldloc 7
	ldc.i4 18792
	add
	stloc 7
...
// 0x0106706c: 0x106706c: lui   a0, 0x70000
	ldc.i4 458752
	stloc.1
// 0x01067070: 0x1067070: lw    a1, 16496(a0)
	ldloc 5
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0106708c: 0x106708c: sw    a1, 12(v1)
	...
	stelem.i4
L_1067090:
// 0x01067090: 0x1067090: sw    v1, 16496(a0)
	ldloc 5
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0106728c: 0x106728c: lui   v1, 0x70000
	ldc.i4 458752
	stloc 7
// 0x01067290: 0x1067290: lw    v0, 16496(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010672c0: 0x10672c0: sw    a0, 16496(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01067480: 0x1067480: lw    v0, 12(v0)
	...
	ldelem.i4
	stloc 7
// 0x01067484: 0x1067484: jal   0x1000930 sw    v0, 16496(s0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_106748c:
// 0x0106748c: 0x106748c: lw    v0, 16496(s0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010676f4: 0x10676f4: beq   v0, zero, 0x1067714 lui   v1, 0x70000
	...
	brfalse L_1067714
// --- basic block ---
// 0x010676fc: 0x10676fc: lw    a0, 16500(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01067704: 0x1067704: addiu a0, a0, 1
	...
	add
	stloc.1
// 0x01067708: 0x1067708: sw    a0, 16500(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01067714: 0x1067714: lui   v0, 0x70000
	ldc.i4 458752
	stloc 6
// 0x01067718: 0x1067718: lw    v1, 16504(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01067720: 0x1067720: addiu v1, v1, 1
	...
	add
	stloc 7
// 0x01067724: 0x1067724: jal   0x1000910 sw    v1, 16504(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
