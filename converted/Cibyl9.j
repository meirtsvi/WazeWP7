...
// 0x0100c8a4: 0x100c8a4: lui   v1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100c8a8: 0x100c8a8: lw    v1, 31480(v1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100ca30: 0x100ca30: lui   v1, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0100ca34: 0x100ca34: lw    v0, 31496(v1)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.3
// 0x0100ca38: 0x100ca38: jr    ra sw    a0, 31496(v1)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0100ca90: 0x100ca90: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0100ca94: 0x100ca94: jal   0x101cd74 addiu a0, a0, 25068
	ldloc.1
	ldc.i4 25068
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x0100ca9c: 0x100ca9c: jal   0x104c514 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x0100caa4: 0x100caa4: jal   0x1021434 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100caac: 0x100caac: bne   v0, zero, 0x100cac0 lui   a1, 0x1010000
	...
	brtrue L_100cac0
// --- basic block ---
// 0x0100cab4: 0x100cab4: jal   0x10218c8 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100cac0: 0x100cac0: addiu a1, a1, -13604
	...
	add
	stloc.2
// 0x0100cac4: 0x100cac4: jal   0x10500d4 addiu a0, zero, 100
	ldc.i4.s 100
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0100caf8: 0x100caf8: jal   0x104ff3c sw    s1, 32(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x0100cb00: 0x100cb00: jal   0x10596fc sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100cb08: 0x100cb08: jal   0x1013754 addu  a0, s0, zero
	...
	stloc 5
// --- basic block ---
// 0x0100cb10: 0x100cb10: jal   0x1052d5c addu  a0, s0, zero
	ldloc 8
	stloc.1
	call void Cibyl61::roadmap_tile_remove_all_1052d5c()
// --- basic block ---
// 0x0100cb18: 0x100cb18: jal   0x104c534 sll   zero, zero, 0
	call int32 Cibyl56::ssd_progress_msg_dialog_hide_104c534()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
// 0x0100cb20: 0x100cb20: jal   0x1021434 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100cb68: 0x100cb68: addiu a0, a0, -13372
	...
	add
	stloc.1
// 0x0100cb6c: 0x100cb6c: sw    zero, 31484(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100cbe4: 0x100cbe4: lui   v1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100cbe8: 0x100cbe8: lw    s0, 31484(v1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100cc08: 0x100cc08: mflo  lo
	ldloc 10
	stloc 7
// 0x0100cc0c: 0x100cc0c: jal   0x101cd74 addiu a0, a0, 25160
	ldloc.1
	ldc.i4 25160
	add
	stloc.1
...
// 0x0100cc64: 0x100cc64: sw    s2, 24(sp)
	...
	ldloc 7
	stelem.i4
// 0x0100cc68: 0x100cc68: lw    s2, 31492(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100cc84: 0x100cc84: addiu s1, zero, 1
	ldc.i4.1
	stloc 11
// 0x0100cc88: 0x100cc88: sw    s1, 31492(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100cca0: 0x100cca0: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x0100cca4: 0x100cca4: addiu a0, a0, 18364
	ldloc.1
	ldc.i4 18364
	add
	stloc.1
// 0x0100cca8: 0x100cca8: addiu a2, a2, -64
	ldloc.3
	ldc.i4.s -64
	add
	stloc.3
...
// 0x0100cccc: 0x100cccc: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0100ccd0: 0x100ccd0: jal   0x100edd0 addiu a0, a0, 12676
	ldloc.1
	ldc.i4 12676
	add
	stloc.1
...
// 0x0100cd00: 0x100cd00: addu  a1, s2, zero
	ldloc 7
	stloc.2
// 0x0100cd04: 0x100cd04: jal   0x100e630 sw    s1, 31488(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100cdb4: 0x100cdb4: lui   s6, 0x20000
	ldc.i4 131072
	stloc 17
// 0x0100cdb8: 0x100cdb8: lw    s3, 31508(s6)
	ldloc 5
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x0100cdc4: 0x100cdc4: div   s3, a0
	...
	rem
	stloc 10
// 0x0100cdc8: 0x100cdc8: lw    v0, 31512(v1)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100cdcc: 0x100cdcc: mfhi  hi
	ldloc 10
	stloc 8
// 0x0100cdd0: 0x100cdd0: bne   v0, a0, 0x100ceb0 sw    s3, 31508(s6)
	ldloc 7
	ldloc.1
	ldloc 5
	ldloc 17
...
// 0x0100cde0: 0x100cde0: lui   s4, 0x20000
	ldc.i4 131072
	stloc 11
// 0x0100cde4: 0x100cde4: addiu s4, s4, 31524
	ldloc 11
	ldc.i4 31524
	add
	stloc 11
...
// 0x0100ce60: 0x100ce60: sw    v1, 0(v0)
	...
	ldloc 6
	stelem.i4
// 0x0100ce64: 0x100ce64: lw    v0, 31508(s6)
	ldloc 5
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x0100ce9c: 0x100ce9c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 7
// 0x0100cea0: 0x100cea0: lw    v1, 31512(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100cea8: 0x100cea8: addiu v1, v1, -1
	...
	add
	stloc 6
// 0x0100ceac: 0x100ceac: sw    v1, 31512(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100ceb0: 0x100ceb0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 7
// 0x0100ceb4: 0x100ceb4: lw    t0, 31508(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100cebc: 0x100cebc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 7
// 0x0100cec0: 0x100cec0: lw    a1, 31512(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x0100cec4: 0x100cec4: addiu t1, t1, 31524
	ldloc 18
	ldc.i4 31524
	add
	stloc 18
...
// 0x0100cf58: 0x100cf58: lui   v1, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100cf5c: 0x100cf5c: j	 0x100cfbc sw    a1, 31512(v1)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100cf64:
// 0x0100cf64: 0x100cf64: lw    a0, 31512(v1)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100cfa0:
// 0x0100cfa0: 0x100cfa0: lw    v0, 31508(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100cfb0: 0x100cfb0: addiu a0, a0, 1
	...
	add
	stloc.1
// 0x0100cfb4: 0x100cfb4: sw    a0, 31512(v1)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100cfbc: 0x100cfbc: lui   v1, 0x20000
	...
	stloc 6
L_100cfc0:
// 0x0100cfc0: 0x100cfc0: lw    v1, 31508(v1)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100cfd4: 0x100cfd4: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0100cfd8: 0x100cfd8: lw    t0, 31500(a0)
	ldloc 5
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0100d014: 0x100d014: mult  v0, t0
	...
	mul
	stloc 9
// 0x0100d018: 0x100d018: addiu v1, v1, 31524
	ldloc 6
	ldc.i4 31524
	add
	stloc 6
...
// 0x0100d150: 0x100d150: lui   s0, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100d154: 0x100d154: lw    v0, 31500(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100d19c: 0x100d19c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100d1a0: 0x100d1a0: lw    v0, 31520(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100d1a8: 0x100d1a8: bgtz  v0, 0x100d374 addiu v0, zero, 2
	...
	bgt L_100d374
// --- basic block ---
// 0x0100d1b0: 0x100d1b0: lw    v1, 31500(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100d1cc: 0x100d1cc: addiu s7, zero, -65
	...
	stloc 16
L_100d1d0:
// 0x0100d1d0: 0x100d1d0: lw    v0, 31512(s6)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0100d1d8: 0x100d1d8: blez  v0, 0x100d374 addiu a0, v0, -1
	...
	ble L_100d374
// --- basic block ---
// 0x0100d1e0: 0x100d1e0: lw    v1, 31508(s5)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x0100d1e4: 0x100d1e4: sw    a0, 31512(s6)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0100d1f4: 0x100d1f4: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0100d1f8: 0x100d1f8: addiu a0, a0, 31524
	ldloc.1
	ldc.i4 31524
	add
	stloc.1
...
// 0x0100d218: 0x100d218: mfhi  hi
	ldloc 18
	stloc 6
// 0x0100d21c: 0x100d21c: beq   s0, s8, 0x100d374 sw    v0, 31508(s5)
	ldloc 8
	ldloc 17
	ldloc 5
	ldloc 13
...
// 0x0100d28c: 0x100d28c: jal   0x100449c sw    s0, 16(sp)
	...
	stloc 6
// --- basic block ---
// 0x0100d294: 0x100d294: lw    s6, 31516(s5)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x0100d338: 0x100d338: sw    v1, 0(s1)
	...
	ldloc 7
	stelem.i4
// 0x0100d33c: 0x100d33c: lw    v1, 31520(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100d344: 0x100d344: addiu v1, v1, 1
	...
	add
	stloc 7
// 0x0100d348: 0x100d348: jal   0x100b52c sw    v1, 31520(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
	...
	stloc 6
// --- basic block ---
// 0x0100d350: 0x100d350: lw    s0, 31516(s5)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x0100d364: 0x100d364: addu  a1, s0, zero
	ldloc 8
	stloc.2
// 0x0100d368: 0x100d368: jal   0x1045f14 addiu a2, s0, 12
	ldloc 8
	ldc.i4.s 12
	add
	stloc.3
...
// 0x0100d420: 0x100d420: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100d424: 0x100d424: lw    v0, 31488(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100d49c: 0x100d49c: ori   s0, s0, 64
	...
	or
	stloc 9
// 0x0100d4a0: 0x100d4a0: lw    v0, 31516(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100d4b0: 0x100d4b0: jal   0x1000910 addiu a0, zero, 540
	...
	stloc 5
// --- basic block ---
// 0x0100d4b8: 0x100d4b8: sw    v0, 31516(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100d4c0: 0x100d4c0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100d4c4: 0x100d4c4: lw    v1, 31500(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100d4d8: 0x100d4d8: addiu a0, a0, -9936
	...
	add
	stloc.1
// 0x0100d4dc: 0x100d4dc: jal   0x106bf9c sw    v1, 31500(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100d4e4: 0x100d4e4: lui   v1, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100d4e8: 0x100d4e8: sw    v0, 31504(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100d4ec: 0x100d4ec: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100d4f0: 0x100d4f0: lw    v1, 31500(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100d564: 0x100d564: lw    a3, 532(s1)
	...
	ldelem.i4
	stloc 4
// 0x0100d568: 0x100d568: jal   0x1052d1c addu  a1, s0, zero
	ldloc 9
	stloc.2
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl61::roadmap_tile_store_1052d1c(int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x0100d584: 0x100d584: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100d588: 0x100d588: lw    v1, 31520(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100d594: 0x100d594: sw    zero, 8(s1)
	...
	ldc.i4.s 0
	stelem.i4
// 0x0100d598: 0x100d598: jal   0x10bfc50 sw    v1, 31520(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x0100d5a0: 0x100d5a0: jal   0x1060c38 addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0100d5e8: 0x100d5e8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100d5ec: 0x100d5ec: lw    a0, 31484(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100d5f8: 0x100d5f8: slt   a1, a0, a1
	...
	clt
	stloc.2
// 0x0100d5fc: 0x100d5fc: bne   a1, zero, 0x100d618 sw    a0, 31484(v0)
	ldloc.2
	ldloc 6
	ldloc 5
	ldc.i4.2
...
// 0x0100d608: 0x100d608: sw    a0, 776(v1)
	...
	ldloc.1
	stelem.i4
// 0x0100d60c: 0x100d60c: jal   0x1021434 sw    zero, 31484(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100d614: 0x100d614: lui   v0, 0x20000
	...
	stloc 5
L_100d618:
// 0x0100d618: 0x100d618: lw    v1, 31484(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100d688: 0x100d688: jal   0x100449c sw    s0, 16(sp)
	...
	stloc 5
// --- basic block ---
// 0x0100d690: 0x100d690: lw    v0, 31496(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100d6c4: 0x100d6c4: jal   0x100449c sw    s0, 16(sp)
	...
	stloc 5
// --- basic block ---
// 0x0100d6cc: 0x100d6cc: lw    v0, 31496(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100d6dc:
// 0x0100d6dc: 0x100d6dc: jal   0x101f818 addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.1
	ldloc.2
	ldloc.3
	call int32 Cibyl23::roadmap_screen_in_view_101f818(int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
// 0x0100d6e4: 0x100d6e4: beq   v0, zero, 0x100d6f4 sll   zero, zero, 0
	...
	brfalse L_100d6f4
// --- basic block ---
// 0x0100d6ec: 0x100d6ec: jal   0x10218c8 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100d744: 0x100d744: jal   0x10c0c00 sw    v0, 24(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100d7b8: 0x100d7b8: bltz  a1, 0x100d81c lui   v0, 0x20000
	...
	blt L_100d81c
// --- basic block ---
// 0x0100d7c0: 0x100d7c0: lw    a0, 31484(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100d7cc: 0x100d7cc: slt   a1, a0, a1
	...
	clt
	stloc.2
// 0x0100d7d0: 0x100d7d0: bne   a1, zero, 0x100d7ec sw    a0, 31484(v0)
	ldloc.2
	ldloc 5
	ldloc 6
	ldc.i4.2
...
// 0x0100d7dc: 0x100d7dc: sw    a0, 776(v1)
	...
	ldloc.1
	stelem.i4
// 0x0100d7e0: 0x100d7e0: jal   0x1021434 sw    zero, 31484(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100d7e8: 0x100d7e8: lui   v0, 0x20000
	...
	stloc 6
L_100d7ec:
// 0x0100d7ec: 0x100d7ec: lw    v1, 31484(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100d854: 0x100d854: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x0100d858: 0x100d858: lw    a1, 31520(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100d860: 0x100d860: addiu a1, a1, -1
	...
	add
	stloc.2
// 0x0100d864: 0x100d864: lw    a0, 31500(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0100d868: 0x100d868: sw    a1, 31520(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100d884: 0x100d884: addiu a0, zero, 20000
	ldc.i4 20000
	stloc.1
// 0x0100d888: 0x100d888: jal   0x10500d4 sw    v1, 31500(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100d8b8: 0x100d8b8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100d8bc: 0x100d8bc: lw    v1, 31520(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100d8c4: 0x100d8c4: addiu v1, v1, -1
	...
	add
	stloc 7
// 0x0100d8c8: 0x100d8c8: jal   0x100d148 sw    v1, 31520(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100d8f4: 0x100d8f4: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x0100d8f8: 0x100d8f8: addiu a0, a0, 12676
	ldloc.1
	ldc.i4 12676
	add
	stloc.1
// 0x0100d8fc: 0x100d8fc: addiu a1, a1, 828
	...
	add
	stloc.2
// 0x0100d900: 0x100d900: addiu a2, a2, 18616
	ldloc.3
	ldc.i4 18616
	add
	stloc.3
...
// 0x0100d914: 0x100d914: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100d918: 0x100d918: jal   0x100d148 sw    v1, 31500(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100d948: 0x100d948: addiu a0, zero, 20000
	ldc.i4 20000
	stloc.1
// 0x0100d94c: 0x100d94c: jal   0x10500d4 lui   s0, 0x20000
	ldc.i4 131072
	stloc 7
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x0100d954: 0x100d954: lw    v0, 31504(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100d964: 0x100d964: jalr  v0 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x0100d96c: 0x100d96c: sw    zero, 31504(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100d99c: 0x100d99c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100d9a0: 0x100d9a0: lw    s0, 31516(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100d9f0: 0x100d9f0: lw    a0, 536(s0)
	...
	ldelem.i4
	stloc.1
// 0x0100d9f4: 0x100d9f4: jal   0x1045ec0 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl51::roadmap_http_async_copy_abort_1045ec0(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x0100da24: 0x100da24: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100da28: 0x100da28: lw    v1, 31520(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100da30: 0x100da30: addiu v1, v1, -1
	...
	add
	stloc 7
// 0x0100da34: 0x100da34: sw    v1, 31520(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100da54: 0x100da54: sw    s1, 20(sp)
	...
	ldloc 8
	stelem.i4
// 0x0100da58: 0x100da58: lw    s1, -30940(s2)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0100daa8: 0x100daa8: div   s1, v1
	...
	rem
	stloc 12
// 0x0100daac: 0x100daac: lw    a1, -30940(s2)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0100dab0: 0x100dab0: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0100dab4: 0x100dab4: addiu a0, a0, -30932
	ldloc.1
	ldc.i4 -30932
	add
	stloc.1
...
// --- basic block ---
L_100db10:
// 0x0100db10: 0x100db10: lw    a0, -30936(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100db20: 0x100db20: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0100db24: 0x100db24: jal   0x10158d0 addiu a0, a0, 25896
	ldloc.1
	ldc.i4 25896
	add
	stloc.1
	...
	stloc 6
// --- basic block ---
// 0x0100db2c: 0x100db2c: j	 0x100db3c sw    v0, -30936(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100db34:
// 0x0100db34: 0x100db34: jal   0x1015b2c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100db3c: 0x100db3c: lui   s1, 0x30000
	ldc.i4 196608
	stloc 8
// 0x0100db40: 0x100db40: lw    a2, -30940(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100db4c: 0x100db4c: lui   a3, 0x30000
	ldc.i4 196608
	stloc 4
// 0x0100db50: 0x100db50: addiu a3, a3, -30932
	ldloc 4
	ldc.i4 -30932
	add
	stloc 4
// 0x0100db54: 0x100db54: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0100db58: 0x100db58: lw    a0, -30936(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0100db7c: 0x100db7c: sw    zero, 4(s2)
	...
	ldc.i4.s 0
	stelem.i4
// 0x0100db80: 0x100db80: jal   0x10157e0 sw    s0, 0(s2)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
	...
	stloc 6
// --- basic block ---
// 0x0100db88: 0x100db88: lw    v1, -30940(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100db90: 0x100db90: addiu v1, v1, 1
	...
	add
	stloc 5
// 0x0100db94: 0x100db94: sw    v1, -30940(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
