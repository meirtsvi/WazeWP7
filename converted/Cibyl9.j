...
// 0x0100d4d8: 0x100d4d8: addiu a0, a0, -9936
	...
	add
	stloc.1
// 0x0100d4dc: 0x100d4dc: jal   0x106be74 sw    v1, 31500(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100d594: 0x100d594: sw    zero, 8(s1)
	...
	ldc.i4.s 0
	stelem.i4
// 0x0100d598: 0x100d598: jal   0x10bfe94 sw    v1, 31520(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100d608: 0x100d608: sw    a0, 776(v1)
	...
	ldloc.1
	stelem.i4
// 0x0100d60c: 0x100d60c: jal   0x102148c sw    zero, 31484(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100d744: 0x100d744: jal   0x10c0e50 sw    v0, 24(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100d7dc: 0x100d7dc: sw    a0, 776(v1)
	...
	ldloc.1
	stelem.i4
// 0x0100d7e0: 0x100d7e0: jal   0x102148c sw    zero, 31484(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100d884: 0x100d884: addiu a0, zero, 20000
	ldc.i4 20000
	stloc.1
// 0x0100d888: 0x100d888: jal   0x104ffc4 sw    v1, 31500(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
