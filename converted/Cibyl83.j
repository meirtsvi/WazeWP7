...
// 0x0106f65c: 0x106f65c: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0106f660: 0x106f660: lw    v0, 17836(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106f6d0: 0x106f6d0: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0106f6d4: 0x106f6d4: lw    v0, 17840(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106f740: 0x106f740: jal   0x100449c addiu a0, zero, 4
	...
	stloc 5
// --- basic block ---
// 0x0106f748: 0x106f748: jal   0x10b34b0 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0106f814: 0x106f814: jal   0x100449c addiu a0, zero, 4
	...
	stloc 5
// --- basic block ---
// 0x0106f81c: 0x106f81c: jal   0x10b34b0 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0106fed8: 0x106fed8: jal   0x106eee8 addu  s0, a1, zero
	...
	stloc 8
// --- basic block ---
// 0x0106fee0: 0x106fee0: jal   0x10a9374 addu  a0, s0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl126::roadmap_login_update_details_on_response_10a9374(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 9
	stloc 8
// --- basic block ---
...
// 0x0106ffec: 0x106ffec: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0106fff0: 0x106fff0: lw    v0, -18836(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010700e4: 0x10700e4: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010700e8: 0x10700e8: lw    v0, -18836(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010701e0: 0x10701e0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010701e4: 0x10701e4: lw    v0, -18836(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01070298: 0x1070298: lui   v0, 0x70000
	ldc.i4 458752
	stloc 6
// 0x0107029c: 0x107029c: addiu v0, v0, 17952
	ldloc 6
	ldc.i4 17952
	add
	stloc 6
...
// 0x01070328: 0x1070328: lui   a0, 0x70000
	...
	stloc.1
L_107032c:
// 0x0107032c: 0x107032c: jal   0x108b4c4 addiu a0, a0, 18232
	ldloc.1
	ldc.i4 18232
	add
	stloc.1
...
// 0x0107034c: 0x107034c: addiu a3, a3, 384
	...
	add
	stloc 4
// 0x01070350: 0x1070350: addiu a0, s1, 17952
	ldloc 9
	ldc.i4 17952
	add
	stloc.1
...
// 0x01070360: 0x1070360: beq   v0, zero, 0x1070380 addu  v1, zero, zero
	...
	brfalse L_1070380
// --- basic block ---
// 0x01070368: 0x1070368: addiu a0, s1, 17952
	ldloc 9
	ldc.i4 17952
	add
	stloc.1
...
// 0x01070460: 0x1070460: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01070464: 0x1070464: lw    v0, 17844(v0)
	ldloc 9
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0107056c: 0x107056c: lui   v0, 0x80000
	...
	stloc 5
L_1070570:
// 0x01070570: 0x1070570: lw    v0, -18836(v0)
	ldloc 9
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010705bc: 0x10705bc: lui   v0, 0x80000
	...
	stloc 5
L_10705c0:
// 0x010705c0: 0x10705c0: lw    v0, -18836(v0)
	ldloc 9
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01070610: 0x1070610: lui   v0, 0x80000
	...
	stloc 5
L_1070614:
// 0x01070614: 0x1070614: lw    v0, -18836(v0)
	ldloc 9
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0107065c: 0x107065c: addu  s1, s0, v0
	...
	stloc 8
L_1070660:
// 0x01070660: 0x1070660: jal   0x109093c sll   zero, zero, 0
...
// 0x010706ac: 0x10706ac: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010706b0: 0x10706b0: sw    v1, -18888(v0)
	ldloc 9
	ldloc 5
	ldc.i4.2
	shr.un
