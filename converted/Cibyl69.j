...
// 0x0105cb00: 0x105cb00: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0105cb04: 0x105cb04: sb    zero, 9364(v0)
	ldloc 5
	ldc.i4 9364
	add
	ldc.i4.s 0
...
// 0x0105cb08: 0x105cb08: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0105cb0c: 0x105cb0c: sb    zero, 9620(v0)
	ldloc 5
	ldc.i4 9620
	add
	ldc.i4.s 0
...
// 0x0105cb14: 0x105cb14: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x0105cb18: 0x105cb18: sb    zero, 9644(v0)
	ldloc 5
	ldc.i4 9644
	add
	ldc.i4.s 0
...
// 0x0105cb24: 0x105cb24: jal   0x105c4e8 sb    zero, 9900(v0)
	ldloc 5
	ldc.i4 9900
	add
	ldc.i4.s 0
...
// 0x0105cb7c: 0x105cb7c: addiu v1, zero, 1
	ldc.i4.1
	stloc 7
// 0x0105cb80: 0x105cb80: sw    v1, 10532(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0105cb90: 0x105cb90: lui   s0, 0x70000
	...
	stloc 8
L_105cb94:
// 0x0105cb94: 0x105cb94: lw    v0, 10528(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0105cba4: 0x105cba4: jalr  v0 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x0105cbac: 0x105cbac: sw    zero, 10528(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0105cbc0: 0x105cbc0: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0105cbc4: 0x105cbc4: lw    v0, 9320(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0105cc2c: 0x105cc2c: lw    a1, 12(s0)
	...
	ldelem.i4
	stloc.2
// 0x0105cc30: 0x105cc30: addiu a0, s2, 9364
	ldloc 5
	ldc.i4 9364
	add
	stloc.1
// 0x0105cc34: 0x105cc34: addiu a2, zero, 256
	ldc.i4 256
	stloc.3
// 0x0105cc38: 0x105cc38: jal   0x1001af8 addiu s2, s2, 9364
	ldloc 5
	ldc.i4 9364
	add
	stloc 5
...
// 0x0105cc48: 0x105cc48: lui   s2, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0105cc4c: 0x105cc4c: addiu a0, s2, 9620
	ldloc 5
	ldc.i4 9620
	add
	stloc.1
// 0x0105cc50: 0x105cc50: addiu a2, zero, 24
	ldc.i4.s 24
	stloc.3
// 0x0105cc54: 0x105cc54: jal   0x1001af8 addiu s2, s2, 9620
	ldloc 5
	ldc.i4 9620
	add
	stloc 5
...
// 0x0105cc64: 0x105cc64: lui   s2, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0105cc68: 0x105cc68: addiu a0, s2, 9644
	ldloc 5
	ldc.i4 9644
	add
	stloc.1
// 0x0105cc6c: 0x105cc6c: addiu a2, zero, 256
	ldc.i4 256
	stloc.3
// 0x0105cc70: 0x105cc70: jal   0x1001af8 addiu s2, s2, 9644
	ldloc 5
	ldc.i4 9644
	add
	stloc 5
...
// 0x0105cc80: 0x105cc80: lui   s2, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0105cc84: 0x105cc84: addiu a0, s2, 9900
	ldloc 5
	ldc.i4 9900
	add
	stloc.1
// 0x0105cc88: 0x105cc88: addiu a2, zero, 256
	ldc.i4 256
	stloc.3
// 0x0105cc8c: 0x105cc8c: jal   0x1001af8 addiu s2, s2, 9900
	ldloc 5
	ldc.i4 9900
	add
	stloc 5
...
// 0x0105cee8: 0x105cee8: sw    v0, 552(s4)
	...
	stelem.i4
L_105ceec:
// 0x0105ceec: 0x105ceec: lw    v1, 31400(s7)
	ldloc 5
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x0105cfdc: 0x105cfdc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 7
// 0x0105cfe0: 0x105cfe0: lw    v0, 31312(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0105cffc: 0x105cffc: lui   v1, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0105d000: 0x105d000: lw    a0, 31400(v1)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0105d024: 0x105d024: lui   v0, 0x20000
	ldc.i4 131072
	stloc 7
// 0x0105d028: 0x105d028: lw    a1, 31388(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_105d504:
// 0x0105d504: 0x105d504: jal   0x10c0b40 sll   zero, zero, 0
	ldloc.0
	ldloc.1
...
// 0x0105d518: 0x105d518: sw    a2, 24(sp)
	...
	ldloc.3
	stelem.i4
// 0x0105d51c: 0x105d51c: jal   0x10c0b40 sw    v1, 28(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0105d534: 0x105d534: addu  a2, v0, zero
	ldloc 6
	stloc.3
// 0x0105d538: 0x105d538: jal   0x10c0918 addu  a3, v1, zero
	ldloc 8
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x0105d548: 0x105d548: jal   0x100405c addu  s8, v0, zero
	...
	stloc 6
// --- basic block ---
// 0x0105d550: 0x105d550: jal   0x10c0b40 addiu a0, v0, 1
	ldloc 6
	ldc.i4.1
	add
	stloc.1
...
// 0x0105d560: 0x105d560: addu  a1, s7, zero
	ldloc 15
	stloc.2
// 0x0105d564: 0x105d564: jal   0x10c0970 addu  a2, v0, zero
	ldloc 6
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0105d56c: 0x105d56c: addu  a1, v1, zero
	ldloc 8
	stloc.2
// 0x0105d570: 0x105d570: jal   0x10c0a50 addu  a0, v0, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0105d7d8: 0x105d7d8: sw    v0, 552(a2)
	...
	stelem.i4
L_105d7dc:
// 0x0105d7dc: 0x105d7dc: lw    t6, 31400(t3)
	ldloc 5
	ldloc 22
	ldc.i4.2
	shr.un
...
// 0x0105da44: 0x105da44: lh    v0, 36(s2)
	...
	call int32 [WazeWP7]CRunTime::memoryReadShort(int32)
	stloc 5
// 0x0105da48: 0x105da48: lw    v1, 31312(s5)
	ldloc 6
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x0105da58: 0x105da58: ori   a3, zero, 65535
	...
	or
	stloc 4
// 0x0105da5c: 0x105da5c: lw    a2, 31388(s7)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x0105da6c: 0x105da6c: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x0105da70: 0x105da70: lw    a3, 31400(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
