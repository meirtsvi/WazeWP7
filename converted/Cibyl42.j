...
// 0x01038d78: 0x1038d78: sll   v0, v0, 2
	...
	shl
	stloc.2
// 0x01038d7c: 0x1038d7c: addiu v1, v1, 27320
	ldloc.3
	ldc.i4 27320
	add
	stloc.3
...
// 0x01038da0: 0x1038da0: lui   v0, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01038da4: 0x1038da4: addiu v0, v0, 27064
	ldloc.2
	ldc.i4 27064
	add
	stloc.2
...
// 0x01038dc8: 0x1038dc8: lui   v0, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01038dcc: 0x1038dcc: addiu v0, v0, 26552
	ldloc.2
	ldc.i4 26552
	add
	stloc.2
...
// 0x01038fbc: 0x1038fbc: addu  s3, a0, zero
	ldloc.1
	stloc 10
// 0x01038fc0: 0x1038fc0: addiu s2, s2, 27508
	ldloc 6
	ldc.i4 27508
	add
	stloc 6
...
// 0x0103903c: 0x103903c: jal   0x1038f3c addiu a0, s0, -14844
	ldloc 7
	ldc.i4 -14844
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x01039044: 0x1039044: jal   0x1038f9c addiu a0, s0, -14844
	ldloc 7
	ldc.i4 -14844
	add
	stloc.1
...
// 0x01039410: 0x1039410: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01039414: 0x1039414: lw    a2, -24184(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039474: 0x1039474: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01039478: 0x1039478: lw    a0, 27592(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
// 0x01039494: 0x1039494: lw    v0, -14732(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010394b0: 0x10394b0: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x010394b4: 0x10394b4: sw    v0, -14732(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010394cc: 0x10394cc: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x010394d0: 0x10394d0: sw    zero, -14732(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039540: 0x1039540: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01039544: 0x1039544: lw    a0, 27596(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0103957c: 0x103957c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01039580: 0x1039580: lw    a0, 27596(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010395d4: 0x10395d4: sw    s6, 1224(sp)
	...
	ldloc 18
	stelem.i4
// 0x010395d8: 0x10395d8: sb    s0, -13528(s1)
	ldloc 9
	ldc.i4 -13528
	add
	ldloc 14
...
// 0x01039600: 0x1039600: lui   v1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x01039604: 0x1039604: addiu s1, s1, -13528
	ldloc 9
	ldc.i4 -13528
	add
	stloc 9
...
// 0x01039660: 0x1039660: addiu s7, s7, 12620
	...
	add
	stloc 19
// 0x01039664: 0x1039664: addiu s1, s1, -14728
	ldloc 9
	ldc.i4 -14728
	add
	stloc 9
...
// 0x01039b50: 0x1039b50: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x01039b54: 0x1039b54: addiu v1, v1, -13928
	ldloc 7
	ldc.i4 -13928
	add
	stloc 7
...
// 0x01039b9c: 0x1039b9c: sll   a0, a3, 2
	...
	shl
	stloc.1
// 0x01039ba0: 0x1039ba0: addiu a2, a2, -14328
	ldloc.3
	ldc.i4 -14328
	add
	stloc.3
...
// 0x01039bac: 0x1039bac: sll   a1, a1, 2
	...
	shl
	stloc.2
// 0x01039bb0: 0x1039bb0: addiu a0, a0, -13928
	ldloc.1
	ldc.i4 -13928
	add
	stloc.1
...
// 0x01039c1c: 0x1039c1c: sll   a1, s4, 2
	...
	shl
	stloc.2
// 0x01039c20: 0x1039c20: addiu t0, v1, -13928
	ldloc 7
	ldc.i4 -13928
	add
	stloc 11
// 0x01039c24: 0x1039c24: addiu a3, a0, -14328
	ldloc.1
	ldc.i4 -14328
	add
	stloc 4
// 0x01039c28: 0x1039c28: addiu a2, v0, -14728
	ldloc 5
	ldc.i4 -14728
	add
	stloc.3
...
// 0x01039c40: 0x1039c40: lw    t0, 0(a2)
	...
	ldelem.i4
	stloc 11
// 0x01039c44: 0x1039c44: lw    t5, -14328(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 23
// 0x01039c48: 0x1039c48: lw    t4, -13928(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 21
// 0x01039c4c: 0x1039c4c: lw    t3, -14728(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039c58: 0x1039c58: sw    t3, 0(a2)
	...
	ldloc 20
	stelem.i4
// 0x01039c5c: 0x1039c5c: sw    t2, -14328(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldloc 13
	stelem.i4
// 0x01039c60: 0x1039c60: sw    t1, -13928(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldloc 12
	stelem.i4
// 0x01039c64: 0x1039c64: sw    t0, -14728(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039c98: 0x1039c98: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x01039c9c: 0x1039c9c: addiu a3, a3, -13928
	ldloc 4
	ldc.i4 -13928
	add
	stloc 4
// 0x01039ca0: 0x1039ca0: addiu a2, a2, -14328
	ldloc.3
	ldc.i4 -14328
	add
	stloc.3
// 0x01039ca4: 0x1039ca4: addiu a1, a1, -14728
	ldloc.2
	ldc.i4 -14728
	add
	stloc.2
...
// 0x01039d30: 0x1039d30: lui   a0, 0x1040000
	ldc.i4 17039360
	stloc.1
// 0x01039d34: 0x1039d34: addiu t2, t2, -13528
	ldloc 13
	ldc.i4 -13528
	add
	stloc 13
...
// 0x01039d3c: 0x1039d3c: addiu t0, zero, 6
	ldc.i4.6
	stloc 11
// 0x01039d40: 0x1039d40: addiu a3, a3, -14728
	ldloc 4
	ldc.i4 -14728
	add
	stloc 4
// 0x01039d44: 0x1039d44: addiu a2, a2, -14328
	ldloc.3
	ldc.i4 -14328
	add
	stloc.3
// 0x01039d48: 0x1039d48: addiu a1, a1, -13928
	ldloc.2
	ldc.i4 -13928
	add
	stloc.2
...
// 0x01039dd8: 0x1039dd8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01039ddc: 0x1039ddc: lw    a0, 27600(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039e14: 0x1039e14: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01039e18: 0x1039e18: lw    a0, 27604(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039e50: 0x1039e50: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01039e54: 0x1039e54: lw    a0, 27608(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_103a258:
// 0x0103a258: 0x103a258: beq   s2, zero, 0x103a30c sb    zero, -13508(a0)
	ldloc 10
	ldloc.1
	ldc.i4 -13508
	add
...
// 0x0103a298: 0x103a298: beq   v0, zero, 0x103a2c4 lui   a2, 0x10000
	...
	brfalse L_103a2c4
// --- basic block ---
// 0x0103a2a0: 0x103a2a0: addiu a0, a0, -13508
	ldloc.1
	ldc.i4 -13508
	add
	stloc.1
...
// 0x0103a2e4: 0x103a2e4: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x0103a2e8: 0x103a2e8: addiu a0, a0, -13508
	ldloc.1
	ldc.i4 -13508
	add
	stloc.1
...
// 0x0103a324: 0x103a324: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x0103a328: 0x103a328: addiu a0, a0, -13508
	ldloc.1
	ldc.i4 -13508
	add
	stloc.1
...
// 0x0103a354: 0x103a354: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x0103a358: 0x103a358: addiu a0, a0, -13508
	ldloc.1
	ldc.i4 -13508
	add
	stloc.1
...
// 0x0103a36c: 0x103a36c: lui   a0, 0x60000
	...
	stloc.1
L_103a370:
// 0x0103a370: 0x103a370: jal   0x103d46c addiu a0, a0, -13508
	ldloc.1
	ldc.i4 -13508
	add
	stloc.1
