...
// --- basic block ---
L_1039940:
// 0x01039940: 0x1039940: jal   0x109a5b0 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01039eac: 0x1039eac: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x01039eb0: 0x1039eb0: jal   0x1096f24 addiu a0, a0, -18704
	ldloc.1
	ldc.i4 -18704
	add
	stloc.1
...
// 0x0103a02c: 0x103a02c: addiu a1, sp, 24
	...
	add
	stloc.2
// 0x0103a030: 0x103a030: jal   0x10aa078 addiu a2, zero, 1
	ldc.i4.1
	stloc.3
	ldloc.0
	ldloc.1
