...
// 0x01039008: 0x1039008: addiu a0, a0, -26772
	...
	add
	stloc.1
// 0x0103900c: 0x103900c: addiu a1, a1, 18236
	ldloc.2
	ldc.i4 18236
	add
	stloc.2
...
// 0x010395ac: 0x10395ac: addiu s1, s1, -13512
	...
	add
	stloc 9
// 0x010395b0: 0x10395b0: lw    v1, 12664(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010395ec: 0x10395ec: addu  a0, s0, zero
	ldloc 14
	stloc.1
// 0x010395f0: 0x10395f0: sw    zero, 12664(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039604: 0x1039604: addu  s5, v0, zero
	ldloc 5
	stloc 16
// 0x01039608: 0x1039608: addiu s7, s7, 12616
	ldloc 19
	ldc.i4 12616
	add
	stloc 19
// 0x0103960c: 0x103960c: addiu s1, s1, -14712
	...
	add
	stloc 9
// 0x01039610: 0x1039610: addiu s8, s8, 12640
	ldloc 17
	ldc.i4 12640
	add
	stloc 17
...
// 0x010397b0: 0x10397b0: lui   v0, 0x0
	...
	stloc 5
L_10397b4:
// 0x010397b4: 0x10397b4: lw    v0, 12664(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0103982c: 0x103982c: lui   v0, 0x0
	...
	stloc 5
L_1039830:
// 0x01039830: 0x1039830: lw    v0, 12664(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039960: 0x1039960: jal   0x1000f9c sw    v1, 16(sp)
	...
	stloc 5
// --- basic block ---
// 0x01039968: 0x1039968: lw    s2, 12664(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0103997c: 0x103997c: lui   s2, 0x0
	ldc.i4.s 0
	stloc 8
// 0x01039980: 0x1039980: j	 0x1039aec addiu s2, s2, 12616
	ldloc 8
	ldc.i4 12616
	add
	stloc 8
...
// 0x01039994: 0x1039994: jal   0x1000f9c addiu a1, zero, 350
	...
	stloc 5
// --- basic block ---
// 0x0103999c: 0x103999c: lw    v0, 12664(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010399a8: 0x10399a8: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x010399ac: 0x10399ac: addiu s2, s2, 12616
	ldloc 8
	ldc.i4 12616
	add
	stloc 8
...
// --- basic block ---
L_1039a28:
// 0x01039a28: 0x1039a28: lw    s4, 12664(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039aac: 0x1039aac: lui   v0, 0x0
	...
	stloc 5
L_1039ab0:
// 0x01039ab0: 0x1039ab0: lw    s3, 12664(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039acc: 0x1039acc: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x01039ad0: 0x1039ad0: lw    v0, 12664(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039aec: 0x1039aec: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x01039af0: 0x1039af0: lw    v0, 12664(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039b1c: 0x1039b1c: lui   v1, 0x0
	...
	stloc 7
L_1039b20:
// 0x01039b20: 0x1039b20: lw    a1, 12664(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01039b38: 0x1039b38: lui   a2, 0x60000
	ldc.i4 393216
	stloc.3
// 0x01039b3c: 0x1039b3c: lw    a3, 12664(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01039b70: 0x1039b70: sw    s5, 0(a2)
	...
	ldloc 16
	stelem.i4
// 0x01039b74: 0x1039b74: jal   0x1037750 sw    a3, 12664(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01039b88: 0x1039b88: beq   s5, zero, 0x1039ba4 lui   v0, 0x0
	...
	brfalse L_1039ba4
// --- basic block ---
// 0x01039b90: 0x1039b90: lw    v0, 12664(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039c98: 0x1039c98: lui   v0, 0x0
	...
	stloc 5
L_1039c9c:
// 0x01039c9c: 0x1039c9c: lw    v1, 12664(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01039cdc: 0x1039cdc: addiu t2, t2, -13512
	...
	add
	stloc 13
// 0x01039ce0: 0x1039ce0: addiu t1, t1, 12592
	ldloc 12
	ldc.i4 12592
	add
	stloc 12
