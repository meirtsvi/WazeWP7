...
// 0x0109cd5c: 0x109cd5c: bne   a0, v0, 0x109cd74 lui   v0, 0x80000
	...
	bne.un L_109cd74
// --- basic block ---
// 0x0109cd64: 0x109cd64: lw    v1, 10196(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0109cd6c: 0x109cd6c: addiu v1, v1, 1
	...
	add
	stloc.2
// 0x0109cd70: 0x109cd70: sw    v1, 10196(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0109cd88: 0x109cd88: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109cd8c: 0x109cd8c: lw    v1, 10188(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109cd98: 0x109cd98: bne   v1, zero, 0x109ce04 sw    s0, 16(sp)
	...
	brtrue L_109ce04
// --- basic block ---
// 0x0109cda0: 0x109cda0: addiu v0, v0, 10188
	ldloc 5
	ldc.i4 10188
	add
	stloc 5
...
// 0x0109cdac: 0x109cdac: bne   v0, zero, 0x109ce04 lui   v0, 0x80000
	...
	brtrue L_109ce04
// --- basic block ---
// 0x0109cdb4: 0x109cdb4: lw    v0, 10184(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109cdf0: 0x109cdf0: lui   s0, 0x80000
	ldc.i4 524288
	stloc 6
// 0x0109cdf4: 0x109cdf4: jal   0x104e050 sw    v0, 10188(s0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x0109cdfc: 0x109cdfc: addiu s0, s0, 10188
	ldloc 6
	ldc.i4 10188
	add
	stloc 6
...
// 0x0109ce08: 0x109ce08: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109ce0c: 0x109ce0c: addiu v0, v0, 10188
	ldloc 5
	ldc.i4 10188
	add
	stloc 5
...
// 0x0109d128: 0x109d128: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109d12c: 0x109d12c: lw    v0, 10196(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109d150: 0x109d150: bne   v0, zero, 0x109d2e8 lui   s2, 0x80000
	...
	brtrue L_109d2e8
// --- basic block ---
// 0x0109d158: 0x109d158: lw    v0, 10208(s2)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0109d17c: 0x109d17c: lui   v1, 0x80000
	ldc.i4 524288
	stloc 7
// 0x0109d180: 0x109d180: sw    a0, 10204(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldloc.1
	stelem.i4
// 0x0109d184: 0x109d184: sw    v0, 10208(s2)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0109d188: 0x109d188: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109d18c: 0x109d18c: lw    v0, 10204(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109d198: 0x109d198: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109d19c: 0x109d19c: lw    v0, 10208(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109d738: 0x109d738: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109d73c: 0x109d73c: lw    v1, 10184(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109d7dc: 0x109d7dc: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109d7e0: 0x109d7e0: lw    v1, 10184(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109db80: 0x109db80: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109db84: 0x109db84: lw    v0, 10196(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109dc18: 0x109dc18: lui   v1, 0x80000
	ldc.i4 524288
	stloc 7
// 0x0109dc1c: 0x109dc1c: sw    v0, 10184(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0109de74: 0x109de74: jal   0x109d9a8 lui   s1, 0x80000
	...
	stloc 5
// --- basic block ---
// 0x0109de7c: 0x109de7c: lw    v0, 10200(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109de9c: 0x109de9c: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x0109dea0: 0x109dea0: sw    v0, 10200(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
