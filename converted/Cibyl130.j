...
// 0x010ae91c: 0x10ae91c: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x010ae920: 0x10ae920: jal   0x10b093c sw    s0, 18888(s5)
	ldloc 6
	ldloc 12
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10ae94c:
// 0x010ae94c: 0x10ae94c: lw    s4, 18888(s5)
	ldloc 6
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x010ae9a0: 0x10ae9a0: addu  a0, s4, zero
	ldloc 8
	stloc.1
// 0x010ae9a4: 0x10ae9a4: jal   0x10b093c sw    s0, 18888(s5)
	ldloc 6
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x010aea40: 0x10aea40: jal   0x1009844 lui   s4, 0x0
	...
	stloc 5
// --- basic block ---
// 0x010aea48: 0x10aea48: lw    a0, 18888(s4)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010aea54: 0x10aea54: bne   a0, v0, 0x10aea68 lui   s3, 0x90000
	...
	bne.un L_10aea68
// --- basic block ---
// 0x010aea5c: 0x10aea5c: sw    s0, 18888(s4)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010aea80: 0x10aea80: bne   v0, zero, 0x10aea94 sll   zero, zero, 0
	...
	brtrue L_10aea94
// --- basic block ---
// 0x010aea88: 0x10aea88: sw    s0, 18888(s4)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010aea9c: 0x10aea9c: subu  s0, s0, v1
	...
	sub
	stloc 9
// 0x010aeaa0: 0x10aeaa0: sw    s0, 18888(s4)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010aee14: 0x10aee14: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010aee18: 0x10aee18: lw    v1, 18800(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10af414:
// 0x010af414: 0x10af414: lw    a2, 18800(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010af4c8: 0x10af4c8: ori   s1, s1, 128
	...
	stloc 9
L_10af4cc:
// 0x010af4cc: 0x10af4cc: lw    a2, 18800(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
