...
// 0x01032eb4: 0x1032eb4: jal   0x10ba4d0 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl139::request_speed_cam_delete_10ba4d0(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x010331c0: 0x10331c0: jal   0x1094108 sw    s0, 16(sp)
	ldloc 8
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010331c8: 0x10331c8: beq   v0, zero, 0x10331f4 sll   zero, zero, 0
	...
	brfalse L_10331f4
// --- basic block ---
// 0x010331d0: 0x10331d0: jal   0x1094138 lui   s0, 0x10000
	ldc.i4 65536
	stloc 6
...
// 0x010331e4: 0x10331e4: bne   v0, zero, 0x10331f4 addiu a0, s0, -14428
	...
	brtrue L_10331f4
// --- basic block ---
// 0x010331ec: 0x10331ec: jal   0x10949fc addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01033254: 0x1033254: lui   s1, 0x10000
	ldc.i4 65536
	stloc 9
// 0x01033258: 0x1033258: jal   0x109b47c addiu a1, s1, -14416
	ldloc 9
	ldc.i4 -14416
	add
	stloc.2
...
// 0x010332b8: 0x10332b8: lw    a0, 4(v0)
	...
	ldelem.i4
	stloc.1
// 0x010332bc: 0x10332bc: jal   0x109b684 addiu a1, sp, 16
	ldloc.0
	ldc.i4.s 16
	add
	stloc.2
	...
	stloc 5
// --- basic block ---
// 0x010332c4: 0x10332c4: jal   0x1095198 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0103338c: 0x103338c: addiu a1, a1, -14400
	...
	add
	stloc.2
// 0x01033390: 0x1033390: jal   0x109b47c lui   s0, 0x60000
	ldc.i4 393216
	stloc 9
	ldloc.0
	ldloc.1
...
// 0x010333ec: 0x10333ec: addu  a0, s5, zero
	ldloc 13
	stloc.1
// 0x010333f0: 0x10333f0: jal   0x1097fd4 addu  a1, s1, zero
	ldloc 10
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x010333fc: 0x10333fc: lui   a1, 0x10000
	ldc.i4 65536
	stloc.2
// 0x01033400: 0x1033400: jal   0x109b47c addiu a1, a1, -25508
	ldloc.2
	ldc.i4 -25508
	add
	stloc.2
...
// 0x0103344c: 0x103344c: addu  a1, s1, zero
	ldloc 10
	stloc.2
// 0x01033450: 0x1033450: jal   0x1097fd4 addu  a0, s5, zero
	ldloc 13
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103345c: 0x103345c: lui   a1, 0x10000
	ldc.i4 65536
	stloc.2
// 0x01033460: 0x1033460: jal   0x109b47c addiu a1, a1, -14372
	ldloc.2
	ldc.i4 -14372
	add
	stloc.2
...
// 0x010334c8: 0x10334c8: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x010334cc: 0x10334cc: jal   0x109e088 addu  a0, s1, zero
	ldloc 10
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010335b4: 0x10335b4: sw    v0, 24(sp)
	...
	ldloc 5
	stelem.i4
// 0x010335b8: 0x10335b8: jal   0x109e668 sw    zero, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010335d8: 0x10335d8: addiu v0, zero, 128
	ldc.i4 128
	stloc 5
// 0x010335dc: 0x10335dc: jal   0x1093b9c sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010335ec: 0x10335ec: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x010335f0: 0x10335f0: jal   0x1099158 addu  s0, v0, zero
	ldloc 5
	stloc 9
	ldloc.1
	ldloc.2
...
// 0x0103360c: 0x103360c: addiu v0, zero, 136
	ldc.i4 136
	stloc 5
// 0x01033610: 0x1033610: jal   0x1093b9c sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01033620: 0x1033620: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x01033624: 0x1033624: jal   0x1099158 sw    v0, 232(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01033630: 0x1033630: addu  a0, s0, zero
	ldloc 9
	stloc.1
// 0x01033634: 0x1033634: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x01033688: 0x1033688: addiu a0, a0, -25508
	...
	add
	stloc.1
// 0x0103368c: 0x103368c: jal   0x1098e88 addiu a2, zero, 14
	ldc.i4.s 14
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x010336a0: 0x10336a0: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x010336a4: 0x10336a4: jal   0x1099158 sw    v0, 232(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010336b0: 0x10336b0: addu  a0, s0, zero
	ldloc 9
	stloc.1
// 0x010336b4: 0x10336b4: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x010336bc: 0x10336bc: lw    a0, -17916(s5)
	...
	ldelem.i4
	stloc.1
// 0x010336c0: 0x10336c0: jal   0x109903c addu  a1, s0, zero
	ldloc 9
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0103372c: 0x103372c: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01033730: 0x1033730: jal   0x109e2b4 addiu a2, zero, 2
	ldc.i4.2
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01033738: 0x1033738: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x0103373c: 0x103373c: jal   0x109903c addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x01033784: 0x1033784: lw    a0, 4(v0)
	...
	ldelem.i4
	stloc.1
// 0x01033788: 0x1033788: jal   0x10992ec addiu a1, a1, 14360
	ldloc.2
	ldc.i4 14360
	add
	stloc.2
...
// 0x010337a4: 0x10337a4: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x010337a8: 0x10337a8: jal   0x109b5ac addu  a0, s1, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010337c4: 0x10337c4: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x010337c8: 0x10337c8: jal   0x109b684 addu  a0, s1, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010337d8: 0x10337d8: lw    a0, 4(v0)
	...
	ldelem.i4
	stloc.1
// 0x010337dc: 0x10337dc: jal   0x10992f4 addiu a1, a1, 12804
	ldloc.2
	ldc.i4 12804
	add
	stloc.2
...
// 0x010337e8: 0x10337e8: addiu a0, a0, -14428
	...
	add
	stloc.1
// 0x010337ec: 0x10337ec: jal   0x1096064 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x010339b4: 0x10339b4: addiu a0, a0, -14428
	...
	add
	stloc.1
// 0x010339b8: 0x10339b8: jal   0x10949fc addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
