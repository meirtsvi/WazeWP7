...
// 0x01075424: 0x1075424: addiu v0, v0, -29576
	...
	add
	stloc 6
// 0x01075428: 0x1075428: addiu a0, a0, 15240
	ldloc.1
	ldc.i4 15240
	add
	stloc.1
...
// 0x010754b0: 0x10754b0: addiu v0, v0, 18616
	...
	add
	stloc 6
// 0x010754b4: 0x10754b4: addiu a0, a0, 15240
	ldloc.1
	ldc.i4 15240
	add
	stloc.1
...
// 0x010754fc: 0x10754fc: addiu v0, v0, -29528
	...
	add
	stloc 5
// 0x01075500: 0x1075500: addiu a0, a0, 15240
	ldloc.1
	ldc.i4 15240
	add
	stloc.1
...
// 0x010755d0: 0x10755d0: sw    v1, 16(sp)
	...
	ldloc 7
	stelem.i4
// 0x010755d4: 0x10755d4: addiu a0, a0, 15240
	ldloc.1
	ldc.i4 15240
	add
	stloc.1
...
// 0x0107562c: 0x107562c: addiu v0, v0, -29500
	...
	add
	stloc 5
// 0x01075630: 0x1075630: addiu a0, a0, 15528
	ldloc.1
	ldc.i4 15528
	add
	stloc.1
...
// 0x010757d0: 0x10757d0: addiu t0, zero, 70
	ldc.i4.s 70
	stloc 9
// 0x010757d4: 0x10757d4: addiu a2, a2, 15536
	ldloc.3
	ldc.i4 15536
	add
	stloc.3
...
// 0x01075ecc: 0x1075ecc: addiu v1, zero, 1
	ldc.i4.1
	stloc 6
// 0x01075ed0: 0x1075ed0: addiu a0, a0, 15600
	ldloc.1
	ldc.i4 15600
	add
	stloc.1
...
// 0x01075f08: 0x1075f08: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x01075f0c: 0x1075f0c: addiu a1, a1, 15680
	ldloc.2
	ldc.i4 15680
	add
	stloc.2
...
// 0x01075f28: 0x1075f28: addiu a0, a0, -26772
	...
	add
	stloc.1
// 0x01075f2c: 0x1075f2c: addiu a1, a1, 15696
	ldloc.2
	ldc.i4 15696
	add
	stloc.2
...
// 0x01075f4c: 0x1075f4c: addiu v0, v0, 9300
	...
	add
	stloc 5
// 0x01075f50: 0x1075f50: addiu a1, a1, 15712
	ldloc.2
	ldc.i4 15712
	add
	stloc.2
...
// 0x010766f8: 0x10766f8: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010766fc: 0x10766fc: lw    v1, 15728(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01076724: 0x1076724: jal   0x100e630 addiu a0, a0, 15696
	ldloc.1
	ldc.i4 15696
	add
	stloc.1
...
// 0x01076790: 0x1076790: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01076794: 0x1076794: jal   0x100e7a8 addiu a0, a0, 15696
	ldloc.1
	ldc.i4 15696
	add
	stloc.1
...
// 0x0107679c: 0x107679c: lui   v1, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010767a0: 0x10767a0: lw    a0, 15728(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
