...
// 0x01075ea4: 0x1075ea4: blez  s0, 0x1075eb8 addu  a0, s3, zero
	...
	ble L_1075eb8
// --- basic block ---
// 0x01075eac: 0x1075eac: jal   0x10acc24 addu  a0, s0, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_1076014:
// 0x01076014: 0x1076014: jal   0x10acc24 addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01076020: 0x1076020: addiu a1, zero, 6
	ldc.i4.6
	stloc.2
// 0x01076024: 0x1076024: jal   0x10ac9c8 addiu a2, zero, 6
	ldc.i4.6
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01076300: 0x1076300: lw    a0, 16(s0)
	...
	ldelem.i4
	stloc.1
// 0x01076304: 0x1076304: jal   0x10acc24 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
