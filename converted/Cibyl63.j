...
// 0x01054d80: 0x1054d80: addiu a1, zero, 1
	ldc.i4.1
	stloc.2
// 0x01054d84: 0x1054d84: jal   0x10a1a90 addu  a2, s0, zero
	ldloc 9
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01054db0: 0x1054db0: sw    zero, 24(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01054db4: 0x1054db4: jal   0x10a2dd0 sw    zero, 28(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01054e90: 0x1054e90: addiu a1, zero, 1
	ldc.i4.1
	stloc.2
// 0x01054e94: 0x1054e94: jal   0x10a1a90 addu  a2, s0, zero
	ldloc 7
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01054ebc: 0x1054ebc: sw    zero, 24(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01054ec0: 0x1054ec0: jal   0x10a2dd0 sw    zero, 28(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01054ed0: 0x1054ed0: addiu a1, zero, 1
	ldc.i4.1
	stloc.2
// 0x01054ed4: 0x1054ed4: jal   0x10a1a90 addiu a2, s0, 7516
	ldloc 7
	ldc.i4 7516
	add
	stloc.3
...
// 0x01054efc: 0x1054efc: sw    zero, 24(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01054f00: 0x1054f00: jal   0x10a2dd0 sw    zero, 28(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010551d0: 0x10551d0: addiu a0, a0, 7140
	...
	add
	stloc.1
// 0x010551d4: 0x10551d4: jal   0x1094390 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01055200: 0x1055200: sll   a3, a3, 13
	...
	shl
	stloc 4
// 0x01055204: 0x1055204: jal   0x1095b80 lui   s3, 0x10000
	ldc.i4 65536
	stloc 13
	ldloc.0
	ldloc.1
...
// 0x01055220: 0x1055220: sw    v0, 9228(s0)
	...
	ldloc 5
	stelem.i4
// 0x01055224: 0x1055224: jal   0x1093b9c sw    zero, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0105522c: 0x105522c: lw    a0, 9228(s0)
	...
	ldelem.i4
	stloc.1
// 0x01055230: 0x1055230: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x01055238: 0x1055238: addiu a0, s1, 7140
	...
	add
	stloc.1
// 0x0105523c: 0x105523c: jal   0x1096064 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01055254: 0x1055254: addiu s5, s5, 9236
	...
	add
	stloc 11
// 0x01055258: 0x1055258: jal   0x109b47c sw    v0, 9228(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0105527c: 0x105527c: addiu a1, a1, 352
	...
	add
	stloc.2
// 0x01055280: 0x1055280: jal   0x109b47c addu  a0, s6, zero
	ldloc 12
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01055294: 0x1055294: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01055298: 0x1055298: jal   0x1097fd4 addu  a0, s6, zero
	ldloc 12
	stloc.1
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x010552a0: 0x10552a0: jal   0x1095950 addiu a0, s1, 7140
	ldloc 9
	ldc.i4 7140
	add
	stloc.1
...
// 0x010552a8: 0x10552a8: lw    a0, 9228(s0)
	...
	ldelem.i4
	stloc.1
// 0x010552ac: 0x10552ac: jal   0x109b47c addiu a1, s3, 7156
	ldloc 13
	ldc.i4 7156
	add
	stloc.2
...
// 0x010552bc: 0x10552bc: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x010552c0: 0x10552c0: jal   0x10994c8 sw    v0, 2248(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010552d0: 0x10552d0: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x010552d4: 0x10552d4: jal   0x10994c8 addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x010552dc: 0x10552dc: jal   0x10949b4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0105533c: 0x105533c: jal   0x1001af8 sw    zero, 108(sp)
	...
	stloc 5
// --- basic block ---
// 0x01055344: 0x1055344: jal   0x10949b4 sb    zero, 2171(sp)
	ldloc.0
	ldc.i4 2171
	add
	ldc.i4.s 0
...
// 0x010557a0: 0x10557a0: jal   0x1001b68 sw    s1, 544(sp)
	...
	stloc 5
// --- basic block ---
// 0x010557a8: 0x10557a8: jal   0x109431c addiu a0, s0, -20308
	ldloc 8
	ldc.i4 -20308
	add
	stloc.1
...
// 0x010557c4: 0x10557c4: addiu a1, a1, 18656
	...
	add
	stloc.2
// 0x010557c8: 0x10557c8: jal   0x1095b80 addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x010557e8: 0x10557e8: addu  s0, v0, zero
	ldloc 5
	stloc 8
// 0x010557ec: 0x10557ec: jal   0x1099158 addiu s1, zero, 8
	ldc.i4.8
	stloc 9
	ldloc.1
	ldloc.2
...
// 0x01055800: 0x1055800: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x01055804: 0x1055804: jal   0x1093b9c sw    s1, 16(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0105580c: 0x105580c: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01055810: 0x1055810: jal   0x109903c addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x01055824: 0x1055824: addiu a0, a0, 7536
	...
	add
	stloc.1
// 0x01055828: 0x1055828: jal   0x109e2b4 addiu a1, a1, 7548
	ldloc.2
	ldc.i4 7548
	add
	stloc.2
...
// 0x01055830: 0x1055830: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01055834: 0x1055834: jal   0x109903c addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x01055848: 0x1055848: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x0105584c: 0x105584c: jal   0x1093b9c sw    s1, 16(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01055854: 0x1055854: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01055858: 0x1055858: jal   0x109903c addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x0105586c: 0x105586c: addu  a1, s2, zero
	ldloc 10
	stloc.2
// 0x01055870: 0x1055870: jal   0x1098e88 addiu a0, a0, -2528
	ldloc.1
	ldc.i4 -2528
	add
	stloc.1
...
// 0x01055880: 0x1055880: addiu a1, a1, 23008
	...
	add
	stloc.2
// 0x01055884: 0x1055884: jal   0x1097c70 sw    v0, 528(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01055890: 0x1055890: addu  a0, s0, zero
	ldloc 8
	stloc.1
// 0x01055894: 0x1055894: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x010558ac: 0x10558ac: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x010558b0: 0x10558b0: jal   0x1093b9c sw    s1, 16(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010558b8: 0x10558b8: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x010558bc: 0x10558bc: jal   0x109903c addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x010558f0: 0x10558f0: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x010558f4: 0x10558f4: jal   0x109903c addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x01055900: 0x1055900: addiu a0, a0, -20308
	...
	add
	stloc.1
// 0x01055904: 0x1055904: jal   0x1096064 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01055940: 0x1055940: jal   0x10949fc addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01055c08: 0x1055c08: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01055c0c: 0x1055c0c: jal   0x10ac76c addu  a1, s2, zero
	ldloc 8
	stloc.2
...
// 0x01055fc4: 0x1055fc4: jal   0x105a3dc sw    v0, 16(sp)
	...
	stloc 5
// --- basic block ---
// 0x01055fcc: 0x1055fcc: jal   0x10c0b30 addu  a0, s6, zero
	ldloc 10
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01055fe0: 0x1055fe0: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x01055fe4: 0x1055fe4: jal   0x10c0908 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01055fec: 0x1055fec: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x01055ff0: 0x1055ff0: jal   0x10c0a40 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01056014: 0x1056014: addu  a0, s1, zero
	ldloc 9
	stloc.1
// 0x01056018: 0x1056018: jal   0x109b47c addiu a1, a1, 8148
	ldloc.2
	ldc.i4 8148
	add
	stloc.2
...
// 0x01056020: 0x1056020: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01056024: 0x1056024: jal   0x1097fd4 addu  a1, s0, zero
	ldloc 8
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01056064: 0x1056064: addu  a0, s1, zero
	ldloc 9
	stloc.1
// 0x01056068: 0x1056068: jal   0x109b47c addiu a1, a1, 8172
	ldloc.2
	ldc.i4 8172
	add
	stloc.2
...
// 0x01056070: 0x1056070: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01056074: 0x1056074: jal   0x1097fd4 addu  a1, s0, zero
	ldloc 8
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x010560ac: 0x10560ac: addu  a0, s1, zero
	ldloc 9
	stloc.1
// 0x010560b0: 0x10560b0: jal   0x109b47c addiu a1, a1, 8192
	ldloc.2
	ldc.i4 8192
	add
	stloc.2
...
// 0x010560b8: 0x10560b8: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x010560bc: 0x10560bc: jal   0x1097fd4 addu  a1, s0, zero
	ldloc 8
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x010560d8: 0x10560d8: addiu a1, a1, 8212
	...
	add
	stloc.2
// 0x010560dc: 0x10560dc: jal   0x109b47c addu  a0, s1, zero
	ldloc 9
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010560e4: 0x10560e4: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x010560e8: 0x10560e8: jal   0x1097fd4 addu  a1, s4, zero
	ldloc 13
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x010560f4: 0x10560f4: addu  a0, s1, zero
	ldloc 9
	stloc.1
// 0x010560f8: 0x10560f8: jal   0x109b47c addiu a1, a1, 8232
	ldloc.2
	ldc.i4 8232
	add
	stloc.2
...
// 0x01056100: 0x1056100: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01056104: 0x1056104: jal   0x1097fd4 addu  a1, s3, zero
	ldloc 12
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01056160: 0x1056160: addu  a0, s1, zero
	ldloc 9
	stloc.1
// 0x01056164: 0x1056164: jal   0x109b47c addiu a1, a1, 8260
	ldloc.2
	ldc.i4 8260
	add
	stloc.2
...
// 0x0105616c: 0x105616c: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01056170: 0x1056170: jal   0x1097fd4 addu  a1, s0, zero
	ldloc 8
	stloc.2
	ldloc.0
	ldloc.1
