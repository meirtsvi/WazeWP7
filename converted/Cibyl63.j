...
// 0x01055740: 0x1055740: lui   v1, 0x0
	ldc.i4.s 0
	stloc.3
// 0x01055744: 0x1055744: lw    v0, 14040(v1)
	ldloc 4
	ldloc.3
	ldc.i4.2
	shr.un
...
// 0x01055748: 0x1055748: lui   a2, 0x70000
	ldc.i4 458752
	stloc.2
// 0x0105574c: 0x105574c: addiu v1, v1, 14040
	ldloc.3
	ldc.i4 14040
	add
	stloc.3
...
// 0x01055788: 0x1055788: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x0105578c: 0x105578c: addiu a1, a1, 13944
	ldloc.2
	ldc.i4 13944
	add
	stloc.2
...
// 0x010557b0: 0x10557b0: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x010557b4: 0x10557b4: addiu a1, a1, 13960
	ldloc.2
	ldc.i4 13960
	add
	stloc.2
...
// 0x010557d0: 0x10557d0: addiu a2, s1, 7304
	...
	add
	stloc.3
// 0x010557d4: 0x10557d4: addiu a1, a1, 13976
	ldloc.2
	ldc.i4 13976
	add
	stloc.2
...
// 0x010557e8: 0x10557e8: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x010557ec: 0x10557ec: addiu a1, a1, 13992
	ldloc.2
	ldc.i4 13992
	add
	stloc.2
...
// 0x0105580c: 0x105580c: addiu a3, s2, 9300
	...
	add
	stloc 4
// 0x01055810: 0x1055810: addiu a1, a1, 14008
	ldloc.2
	ldc.i4 14008
	add
	stloc.2
...
// 0x0105582c: 0x105582c: addiu a3, s2, 9300
	...
	add
	stloc 4
// 0x01055830: 0x1055830: addiu a1, a1, 14024
	ldloc.2
	ldc.i4 14024
	add
	stloc.2
...
// 0x01055868: 0x1055868: jal   0x100e368 addiu a0, a0, 13944
	ldloc.1
	ldc.i4 13944
	add
	stloc.1
...
// 0x01055af8: 0x1055af8: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01055afc: 0x1055afc: addiu a0, a0, 13944
	ldloc.1
	ldc.i4 13944
	add
	stloc.1
...
// 0x01055d0c: 0x1055d0c: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01055d10: 0x1055d10: jal   0x100e368 addiu a0, a0, 13960
	ldloc.1
	ldc.i4 13960
	add
	stloc.1
