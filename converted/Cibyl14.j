...
// 0x010144e0: 0x10144e0: addiu s1, zero, 1
	ldc.i4.1
	stloc 9
// 0x010144e4: 0x10144e4: jal   0x10bfbfc sw    s1, -28440(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010144ec: 0x10144ec: addiu a0, sp, 20
	...
	add
	stloc.1
// 0x010144f0: 0x10144f0: jal   0x10c36d8 sw    v0, 20(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010144f8: 0x10144f8: addu  a0, s2, zero
	ldloc 10
	stloc.1
// 0x010144fc: 0x10144fc: jal   0x10bfbc0 addu  a1, s0, zero
	ldloc 8
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01014504: 0x1014504: addiu a0, sp, 16
	...
	add
	stloc.1
// 0x01014508: 0x1014508: jal   0x10c36d8 sw    v0, 16(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
