...
// 0x010133ec: 0x10133ec: lui   v0, 0x30000
	...
	stloc 5
L_10133f0:
// 0x010133f0: 0x10133f0: lw    v0, -30416(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013400: 0x1013400: beq   v0, zero, 0x10134d0 lui   v0, 0x20000
	...
	brfalse L_10134d0
// --- basic block ---
// 0x01013408: 0x1013408: lw    v1, 31360(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101341c: 0x101341c: beq   a3, v0, 0x1013464 lui   v0, 0x20000
	...
	beq  L_1013464
// --- basic block ---
// 0x01013424: 0x1013424: lw    v1, 31448(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013754: 0x1013754: lui   v0, 0x30000
	ldc.i4 196608
	stloc.2
// 0x01013758: 0x1013758: lw    v1, -28416(v0)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0101375c: 0x101375c: lui   v0, 0x30000
	ldc.i4 196608
	stloc.2
// 0x01013760: 0x1013760: lw    a1, -28420(v0)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01013834: 0x1013834: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x01013838: 0x1013838: lw    a2, -28404(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01013880: 0x1013880: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x01013884: 0x1013884: lw    a2, -28404(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010139a4: 0x10139a4: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010139a8: 0x10139a8: lw    v0, -28420(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010139b8: 0x10139b8: lui   s1, 0x30000
	ldc.i4 196608
	stloc 9
// 0x010139bc: 0x10139bc: lw    a0, -28408(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010139e4: 0x10139e4: jal   0x10034b8 sw    zero, 24(sp)
	...
	stloc 5
// --- basic block ---
// 0x010139ec: 0x10139ec: lw    a0, -28404(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010139f8: 0x10139f8: addiu a1, sp, 24
	...
	add
	stloc.2
// 0x010139fc: 0x10139fc: jal   0x10034b8 sw    v0, -28408(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x01013a04: 0x1013a04: jal   0x1015e08 sw    v0, -28404(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01013a10: 0x1013a10: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x01013a14: 0x1013a14: beq   a0, zero, 0x1013a24 sw    v0, -28416(v1)
	ldloc.1
	ldloc 6
	ldloc 7
	ldc.i4.2
...
// 0x01013a1c: 0x1013a1c: addiu v0, zero, 8
	ldc.i4.8
	stloc 5
// 0x01013a20: 0x1013a20: sw    v0, -28416(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01013a24: 0x1013a24: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01013a28: 0x1013a28: lw    a0, -28416(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013a44: 0x1013a44: addiu a1, zero, 134
	ldc.i4 134
	stloc.2
// 0x01013a48: 0x1013a48: jal   0x1004a38 sw    v0, -28420(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01013aac: 0x1013aac: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01013ab0: 0x1013ab0: lw    a2, -28416(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013ab4: 0x1013ab4: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01013ab8: 0x1013ab8: lw    v0, -28420(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013b58: 0x1013b58: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x01013b5c: 0x1013b5c: lw    v1, -28412(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01013b64: 0x1013b64: addiu v1, v1, 1
	...
	add
	stloc 7
// 0x01013b68: 0x1013b68: bne   v1, zero, 0x1013bc0 sw    v1, -28412(a0)
	ldloc 7
	ldloc 6
	ldloc.1
	ldc.i4.2
...
// 0x01013bb0: 0x1013bb0: addiu v1, zero, 1
	ldc.i4.1
	stloc 7
// 0x01013bb4: 0x1013bb4: sw    v1, -28412(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013bc4: 0x1013bc4: lui   s5, 0x10000
	ldc.i4 65536
	stloc 10
// 0x01013bc8: 0x1013bc8: lw    s2, -28412(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1013bf4:
// 0x01013bf4: 0x1013bf4: lw    a2, -28408(s4)
	ldloc 6
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x01013c10: 0x1013c10: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01013c14: 0x1013c14: lw    v0, -28420(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013da8: 0x1013da8: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x01013dac: 0x1013dac: lw    v0, 24992(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013de0: 0x1013de0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01013de4: 0x1013de4: lw    v1, -28400(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013dec: 0x1013dec: bne   v1, s0, 0x1013df8 sll   zero, zero, 0
	...
	bne.un L_1013df8
// --- basic block ---
// 0x01013df4: 0x1013df4: sw    zero, -28400(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013e28: 0x1013e28: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x01013e2c: 0x1013e2c: lw    v0, 24992(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013ea0: 0x1013ea0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01013ea4: 0x1013ea4: sw    s0, -28400(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013efc: 0x1013efc: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01013f00: 0x1013f00: lw    v1, 24992(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01014084: 0x1014084: lui   v1, 0x30000
	ldc.i4 196608
	stloc.3
// 0x01014088: 0x1014088: addiu v1, v1, -28388
	ldloc.3
	ldc.i4 -28388
	add
	stloc.3
...
// 0x010140a8: 0x10140a8: sll   v0, v0, 2
	...
	shl
	stloc 4
// 0x010140ac: 0x10140ac: addiu v1, v1, -28388
	ldloc.3
	ldc.i4 -28388
	add
	stloc.3
...
// 0x010142a4: 0x10142a4: lui   v1, 0x20000
	ldc.i4 131072
	stloc 6
// 0x010142a8: 0x10142a8: lw    a1, 24996(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01014414: 0x1014414: jal   0x100f20c lui   s1, 0x30000
	...
	stloc 5
// --- basic block ---
// 0x0101441c: 0x101441c: addiu s0, s0, -28388
	ldloc 9
	ldc.i4 -28388
	add
	stloc 9
// 0x01014420: 0x1014420: addiu s1, s1, -28324
	ldloc 11
	ldc.i4 -28324
	add
	stloc 11
...
// 0x01014478: 0x1014478: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101447c: 0x101447c: lw    v1, -28396(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010144a0: 0x10144a0: addiu v1, v1, 1
	...
	add
	stloc 6
// 0x010144a4: 0x10144a4: j	 0x1014594 sw    v1, -28396(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010144c8: 0x10144c8: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010144cc: 0x10144cc: lw    v1, -28392(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010144e0: 0x10144e0: addiu s1, zero, 1
	ldc.i4.1
	stloc 9
// 0x010144e4: 0x10144e4: jal   0x10bfe58 sw    s1, -28392(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010144ec: 0x10144ec: addiu a0, sp, 20
	...
	add
	stloc.1
// 0x010144f0: 0x10144f0: jal   0x10c3938 sw    v0, 20(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010144f8: 0x10144f8: addu  a0, s2, zero
	ldloc 10
	stloc.1
// 0x010144fc: 0x10144fc: jal   0x10bfe1c addu  a1, s0, zero
	ldloc 8
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01014504: 0x1014504: addiu a0, sp, 16
	...
	add
	stloc.1
// 0x01014508: 0x1014508: jal   0x10c3938 sw    v0, 16(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010146d8: 0x10146d8: lui   v1, 0x30000
	ldc.i4 196608
	stloc 4
// 0x010146dc: 0x10146dc: addiu v1, v1, -28316
	ldloc 4
	ldc.i4 -28316
	add
	stloc 4
...
// 0x010146f8: 0x10146f8: lui   v1, 0x30000
	ldc.i4 196608
	stloc 4
// 0x010146fc: 0x10146fc: lw    a1, -28324(v1)
	ldloc 6
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x01014704: 0x1014704: sll   a3, v0, 2
	...
	shl
	stloc.3
// 0x01014708: 0x1014708: addiu a2, a2, -28320
	ldloc.2
	ldc.i4 -28320
	add
	stloc.2
...
// 0x01014714: 0x1014714: sw    a0, 0(a2)
	...
	ldloc.0
	stelem.i4
// 0x01014718: 0x1014718: jr    ra sw    a1, -28324(v1)
	ldloc 6
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x01014734: 0x1014734: lui   v1, 0x30000
	ldc.i4 196608
	stloc.2
// 0x01014738: 0x1014738: addiu v1, v1, -28320
	ldloc.2
	ldc.i4 -28320
	add
	stloc.2
...
// 0x01014774: 0x1014774: lui   v0, 0x30000
	ldc.i4 196608
	stloc.3
// 0x01014778: 0x1014778: lw    v1, -28324(v0)
	ldloc 4
	ldloc.3
	ldc.i4.2
	shr.un
...
// 0x01014780: 0x1014780: addiu v1, v1, -1
	...
	add
	stloc.2
// 0x01014784: 0x1014784: jr    ra sw    v1, -28324(v0)
	ldloc 4
	ldloc.3
	ldc.i4.2
	shr.un
...
// 0x010147b8: 0x10147b8: addu  s3, a0, zero
	ldloc.1
	stloc 10
// 0x010147bc: 0x10147bc: addiu s1, s1, -28316
	ldloc 7
	ldc.i4 -28316
	add
	stloc 7
...
// 0x010147f4: 0x10147f4: addiu s1, s1, 4
	...
	stloc 7
L_10147f8:
// 0x010147f8: 0x10147f8: lw    v0, -28324(s2)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101485c: 0x101485c: addu  s5, a2, zero
	ldloc.3
	stloc 12
// 0x01014860: 0x1014860: addiu s2, s2, -28316
	ldloc 8
	ldc.i4 -28316
	add
	stloc 8
...
// 0x010148a8: 0x10148a8: addiu s2, s2, 4
	...
	stloc 8
L_10148ac:
// 0x010148ac: 0x10148ac: lw    v0, -28324(s4)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
