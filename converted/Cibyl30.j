...
// 0x01028b44: 0x1028b44: beq   v0, zero, 0x1028b58 lui   v1, 0x60000
	...
	brfalse L_1028b58
// --- basic block ---
// 0x01028b4c: 0x1028b4c: lw    a1, -26276(v1)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1028b58:
// 0x01028b58: 0x1028b58: addiu v1, v1, -26276
	ldloc 5
	ldc.i4 -26276
	add
	stloc 5
...
// 0x01028b74: 0x1028b74: beq   v0, zero, 0x1028b88 lui   v1, 0x60000
	...
	brfalse L_1028b88
// --- basic block ---
// 0x01028b7c: 0x1028b7c: lw    a1, -26276(v1)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1028b88:
// 0x01028b88: 0x1028b88: addiu v1, v1, -26276
	ldloc 5
	ldc.i4 -26276
	add
	stloc 5
...
// 0x01028c58: 0x1028c58: beq   v0, zero, 0x1028c6c lui   v1, 0x60000
	...
	brfalse L_1028c6c
// --- basic block ---
// 0x01028c60: 0x1028c60: lw    a1, -26276(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1028c6c:
// 0x01028c6c: 0x1028c6c: addiu v1, v1, -26276
	ldloc 5
	ldc.i4 -26276
	add
	stloc 5
...
// 0x01028c88: 0x1028c88: beq   v0, zero, 0x1028c9c lui   v1, 0x60000
	...
	brfalse L_1028c9c
// --- basic block ---
// 0x01028c90: 0x1028c90: lw    a1, -26276(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1028c9c:
// 0x01028c9c: 0x1028c9c: addiu v1, v1, -26276
	ldloc 5
	ldc.i4 -26276
	add
	stloc 5
...
// 0x01028d74: 0x1028d74: sw    s0, 20(sp)
	...
	ldloc 6
	stelem.i4
// 0x01028d78: 0x1028d78: lw    s0, -26236(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01028e48: 0x1028e48: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01028e4c: 0x1028e4c: lw    s1, -26236(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01028e64: 0x1028e64: beq   v0, zero, 0x1028e80 addiu s1, s1, 8
	...
	brfalse L_1028e80
// --- basic block ---
// 0x01028e6c: 0x1028e6c: lw    a1, -26232(s3)
	ldloc 6
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x01028f4c: 0x1028f4c: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01028f50: 0x1028f50: lw    v0, -26236(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01028fec: 0x1028fec: lui   s6, 0x10000
	ldc.i4 65536
	stloc 12
// 0x01028ff0: 0x1028ff0: sw    v0, -26236(s5)
	ldloc 6
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x01029094: 0x1029094: jal   0x1001b48 addu  a0, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x0102909c: 0x102909c: lw    v1, -26232(s4)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x010290a8: 0x10290a8: beq   v1, zero, 0x10290b4 sll   zero, zero, 0
	...
	brfalse L_10290b4
// --- basic block ---
// 0x010290b0: 0x10290b0: sw    v0, -26232(s4)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
	...
	stelem.i4
L_10290b4:
// 0x010290b4: 0x10290b4: lw    v1, -26236(s5)
	ldloc 6
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x010290e4: 0x10290e4: bne   a0, zero, 0x102900c lui   v0, 0x60000
	...
	brtrue L_102900c
// --- basic block ---
// 0x010290ec: 0x10290ec: lw    a0, -26236(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102918c: 0x102918c: lui   s8, 0x10000
	ldc.i4 65536
	stloc 13
// 0x01029190: 0x1029190: addiu s4, s4, -26228
	ldloc 12
	ldc.i4 -26228
	add
	stloc 12
...
// 0x01029274: 0x1029274: addu  v0, v0, s4
	...
	add
	stloc 5
// 0x01029278: 0x1029278: j	 0x10292c0 addiu v1, v1, 24824
	ldloc 7
	ldc.i4 24824
	add
	stloc 7
...
// 0x010292e0: 0x10292e0: beq   s0, zero, 0x10292fc lui   v0, 0x60000
	...
	brfalse L_10292fc
// --- basic block ---
// 0x010292e8: 0x10292e8: addiu v0, v0, -26228
	ldloc 5
	ldc.i4 -26228
	add
	stloc 5
...
// 0x0102937c: 0x102937c: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01029380: 0x1029380: jal   0x104d1dc addiu a0, a0, -26772
	ldloc.1
	ldc.i4 -26772
	add
	stloc.1
...
// --- basic block ---
L_1029564:
// 0x01029564: 0x1029564: addiu v0, v0, 24824
	ldloc 5
	ldc.i4 24824
	add
	stloc 5
...
// --- basic block ---
L_1029580:
// 0x01029580: 0x1029580: addiu v1, v1, 24840
	ldloc 7
	ldc.i4 24840
	add
	stloc 7
...
// 0x010296a8: 0x10296a8: addu  s0, v0, zero
	ldloc 5
	stloc 8
// 0x010296ac: 0x10296ac: j	 0x1029720 addiu s2, s2, 24824
	ldloc 9
	ldc.i4 24824
	add
	stloc 9
...
// 0x01029ca4: 0x1029ca4: lui   v0, 0x60000
	ldc.i4 393216
	stloc.2
// 0x01029ca8: 0x1029ca8: lw    v1, -24180(v0)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01029cb0: 0x1029cb0: beq   v1, zero, 0x1029d00 addu  a1, zero, zero
	...
	brfalse L_1029d00
// --- basic block ---
// 0x01029cb8: 0x1029cb8: addiu v0, v0, -24180
	ldloc.2
	ldc.i4 -24180
	add
	stloc.2
...
// 0x01029d00: 0x1029d00: sll   a1, a1, 2
	...
	shl
	stloc.1
// 0x01029d04: 0x1029d04: addiu v0, v0, -24180
	ldloc.2
	ldc.i4 -24180
	add
	stloc.2
