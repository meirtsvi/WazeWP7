...
// 0x01028adc: 0x1028adc: jal   0x1096064 sw    s1, 24(sp)
	ldloc 8
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01028af4: 0x1028af4: addiu a0, s0, -28724
	...
	add
	stloc.1
// 0x01028af8: 0x1028af8: jal   0x1096064 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028bd0: 0x1028bd0: jal   0x1096064 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028be8: 0x1028be8: addiu a0, s0, -27832
	...
	add
	stloc.1
// 0x01028bec: 0x1028bec: jal   0x1096064 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01029b88: 0x1029b88: bne   v0, zero, 0x1029ba0 addu  a0, s0, zero
	...
	brtrue L_1029ba0
// --- basic block ---
// 0x01029b90: 0x1029b90: jal   0x109ca5c addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
