...
// 0x01028adc: 0x1028adc: jal   0x1096034 sw    s1, 24(sp)
	ldloc 8
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01028af4: 0x1028af4: addiu a0, s0, -28724
	...
	add
	stloc.1
// 0x01028af8: 0x1028af8: jal   0x1096034 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028b2c: 0x1028b2c: addiu a0, a0, -28612
	...
	add
	stloc.1
// 0x01028b30: 0x1028b30: jal   0x1094868 addu  s0, s1, s0
	ldloc 9
	ldloc 7
	add
	stloc 7
...
// 0x01028b3c: 0x1028b3c: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x01028b40: 0x1028b40: jal   0x1094868 addiu a0, a0, -28592
	ldloc.1
	ldc.i4 -28592
	add
	stloc.1
...
// 0x01028b6c: 0x1028b6c: lui   a0, 0x10000
	...
	stloc.1
L_1028b70:
// 0x01028b70: 0x1028b70: jal   0x1094868 addiu a0, a0, -28576
	ldloc.1
	ldc.i4 -28576
	add
	stloc.1
...
// 0x01028b9c: 0x1028b9c: lui   a0, 0x10000
	...
	stloc.1
L_1028ba0:
// 0x01028ba0: 0x1028ba0: jal   0x1094868 addiu a0, a0, -28556
	ldloc.1
	ldc.i4 -28556
	add
	stloc.1
...
// 0x01028bd0: 0x1028bd0: jal   0x1096034 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028be8: 0x1028be8: addiu a0, s0, -27832
	...
	add
	stloc.1
// 0x01028bec: 0x1028bec: jal   0x1096034 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028c20: 0x1028c20: addu  a1, v0, zero
	ldloc 6
	stloc.2
// 0x01028c24: 0x1028c24: jal   0x10948a4 addiu a0, s0, 32672
	ldloc 8
	ldc.i4 32672
	add
	stloc.1
...
// 0x01028c38: 0x1028c38: addiu a0, a0, -28644
	...
	add
	stloc.1
// 0x01028c3c: 0x1028c3c: jal   0x10948a4 addu  a1, v0, zero
	ldloc 6
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028c50: 0x1028c50: addiu a0, a0, -28628
	...
	add
	stloc.1
// 0x01028c54: 0x1028c54: jal   0x10948a4 addu  a1, v0, zero
	ldloc 6
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028c80: 0x1028c80: lui   a0, 0x10000
	...
	stloc.1
L_1028c84:
// 0x01028c84: 0x1028c84: jal   0x1094868 addiu a0, a0, -28576
	ldloc.1
	ldc.i4 -28576
	add
	stloc.1
...
// 0x01028cb0: 0x1028cb0: lui   a0, 0x10000
	...
	stloc.1
L_1028cb4:
// 0x01028cb4: 0x1028cb4: jal   0x1094868 addiu a0, a0, -28556
	ldloc.1
	ldc.i4 -28556
	add
	stloc.1
...
// 0x01029b88: 0x1029b88: bne   v0, zero, 0x1029ba0 addu  a0, s0, zero
	...
	brtrue L_1029ba0
// --- basic block ---
// 0x01029b90: 0x1029b90: jal   0x109ca2c addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
