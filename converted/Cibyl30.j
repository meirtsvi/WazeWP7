...
// 0x01028adc: 0x1028adc: jal   0x1096038 sw    s1, 24(sp)
	ldloc 8
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01028af4: 0x1028af4: addiu a0, s0, -28724
	...
	add
	stloc.1
// 0x01028af8: 0x1028af8: jal   0x1096038 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028b2c: 0x1028b2c: addiu a0, a0, -28612
	...
	add
	stloc.1
// 0x01028b30: 0x1028b30: jal   0x109486c addu  s0, s1, s0
	ldloc 9
	ldloc 7
	add
	stloc 7
...
// 0x01028b3c: 0x1028b3c: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x01028b40: 0x1028b40: jal   0x109486c addiu a0, a0, -28592
	ldloc.1
	ldc.i4 -28592
	add
	stloc.1
...
// 0x01028b50: 0x1028b50: beq   v0, zero, 0x1028b64 lui   v1, 0x60000
	...
	brfalse L_1028b64
// --- basic block ---
// 0x01028b58: 0x1028b58: lw    a1, -26292(v1)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1028b64:
// 0x01028b64: 0x1028b64: addiu v1, v1, -26292
	ldloc 5
	ldc.i4 -26292
	add
	stloc 5
...
// 0x01028b6c: 0x1028b6c: lui   a0, 0x10000
	...
	stloc.1
L_1028b70:
// 0x01028b70: 0x1028b70: jal   0x109486c addiu a0, a0, -28576
	ldloc.1
	ldc.i4 -28576
	add
	stloc.1
...
// 0x01028b80: 0x1028b80: beq   v0, zero, 0x1028b94 lui   v1, 0x60000
	...
	brfalse L_1028b94
// --- basic block ---
// 0x01028b88: 0x1028b88: lw    a1, -26292(v1)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1028b94:
// 0x01028b94: 0x1028b94: addiu v1, v1, -26292
	ldloc 5
	ldc.i4 -26292
	add
	stloc 5
...
// 0x01028b9c: 0x1028b9c: lui   a0, 0x10000
	...
	stloc.1
L_1028ba0:
// 0x01028ba0: 0x1028ba0: jal   0x109486c addiu a0, a0, -28556
	ldloc.1
	ldc.i4 -28556
	add
	stloc.1
...
// 0x01028bd0: 0x1028bd0: jal   0x1096038 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028be8: 0x1028be8: addiu a0, s0, -27832
	...
	add
	stloc.1
// 0x01028bec: 0x1028bec: jal   0x1096038 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028c20: 0x1028c20: addu  a1, v0, zero
	ldloc 6
	stloc.2
// 0x01028c24: 0x1028c24: jal   0x10948a8 addiu a0, s0, 32672
	ldloc 8
	ldc.i4 32672
	add
	stloc.1
...
// 0x01028c38: 0x1028c38: addiu a0, a0, -28644
	...
	add
	stloc.1
// 0x01028c3c: 0x1028c3c: jal   0x10948a8 addu  a1, v0, zero
	ldloc 6
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028c50: 0x1028c50: addiu a0, a0, -28628
	...
	add
	stloc.1
// 0x01028c54: 0x1028c54: jal   0x10948a8 addu  a1, v0, zero
	ldloc 6
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028c64: 0x1028c64: beq   v0, zero, 0x1028c78 lui   v1, 0x60000
	...
	brfalse L_1028c78
// --- basic block ---
// 0x01028c6c: 0x1028c6c: lw    a1, -26292(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1028c78:
// 0x01028c78: 0x1028c78: addiu v1, v1, -26292
	ldloc 5
	ldc.i4 -26292
	add
	stloc 5
...
// 0x01028c80: 0x1028c80: lui   a0, 0x10000
	...
	stloc.1
L_1028c84:
// 0x01028c84: 0x1028c84: jal   0x109486c addiu a0, a0, -28576
	ldloc.1
	ldc.i4 -28576
	add
	stloc.1
...
// 0x01028c94: 0x1028c94: beq   v0, zero, 0x1028ca8 lui   v1, 0x60000
	...
	brfalse L_1028ca8
// --- basic block ---
// 0x01028c9c: 0x1028c9c: lw    a1, -26292(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1028ca8:
// 0x01028ca8: 0x1028ca8: addiu v1, v1, -26292
	ldloc 5
	ldc.i4 -26292
	add
	stloc 5
...
// 0x01028cb0: 0x1028cb0: lui   a0, 0x10000
	...
	stloc.1
L_1028cb4:
// 0x01028cb4: 0x1028cb4: jal   0x109486c addiu a0, a0, -28556
	ldloc.1
	ldc.i4 -28556
	add
	stloc.1
...
// 0x01028d80: 0x1028d80: sw    s0, 20(sp)
	...
	ldloc 6
	stelem.i4
// 0x01028d84: 0x1028d84: lw    s0, -26252(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01028e54: 0x1028e54: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01028e58: 0x1028e58: lw    s1, -26252(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01028e70: 0x1028e70: beq   v0, zero, 0x1028e8c addiu s1, s1, 8
	...
	brfalse L_1028e8c
// --- basic block ---
// 0x01028e78: 0x1028e78: lw    a1, -26248(s3)
	ldloc 6
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x01028f58: 0x1028f58: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01028f5c: 0x1028f5c: lw    v0, -26252(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01028ff8: 0x1028ff8: lui   s6, 0x10000
	ldc.i4 65536
	stloc 12
// 0x01028ffc: 0x1028ffc: sw    v0, -26252(s5)
	ldloc 6
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x010290a0: 0x10290a0: jal   0x1001b48 addu  a0, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x010290a8: 0x10290a8: lw    v1, -26248(s4)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x010290b4: 0x10290b4: beq   v1, zero, 0x10290c0 sll   zero, zero, 0
	...
	brfalse L_10290c0
// --- basic block ---
// 0x010290bc: 0x10290bc: sw    v0, -26248(s4)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
	...
	stelem.i4
L_10290c0:
// 0x010290c0: 0x10290c0: lw    v1, -26252(s5)
	ldloc 6
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x010290f0: 0x10290f0: bne   a0, zero, 0x1029018 lui   v0, 0x60000
	...
	brtrue L_1029018
// --- basic block ---
// 0x010290f8: 0x10290f8: lw    a0, -26252(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01029198: 0x1029198: lui   s8, 0x10000
	ldc.i4 65536
	stloc 13
// 0x0102919c: 0x102919c: addiu s4, s4, -26244
	ldloc 12
	ldc.i4 -26244
	add
	stloc 12
...
// 0x01029280: 0x1029280: addu  v0, v0, s4
	...
	add
	stloc 5
// 0x01029284: 0x1029284: j	 0x10292cc addiu v1, v1, 25144
	ldloc 7
	ldc.i4 25144
	add
	stloc 7
...
// 0x010292ec: 0x10292ec: beq   s0, zero, 0x1029308 lui   v0, 0x60000
	...
	brfalse L_1029308
// --- basic block ---
// 0x010292f4: 0x10292f4: addiu v0, v0, -26244
	ldloc 5
	ldc.i4 -26244
	add
	stloc 5
...
// --- basic block ---
L_1029570:
// 0x01029570: 0x1029570: addiu v0, v0, 25144
	ldloc 5
	ldc.i4 25144
	add
	stloc 5
...
// --- basic block ---
L_102958c:
// 0x0102958c: 0x102958c: addiu v1, v1, 25160
	ldloc 7
	ldc.i4 25160
	add
	stloc 7
...
// 0x010296b4: 0x10296b4: addu  s0, v0, zero
	ldloc 5
	stloc 8
// 0x010296b8: 0x10296b8: j	 0x102972c addiu s2, s2, 25144
	ldloc 9
	ldc.i4 25144
	add
	stloc 9
...
// 0x01029b88: 0x1029b88: bne   v0, zero, 0x1029ba0 addu  a0, s0, zero
	...
	brtrue L_1029ba0
// --- basic block ---
// 0x01029b90: 0x1029b90: jal   0x109ca30 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01029cb0: 0x1029cb0: lui   v0, 0x60000
	ldc.i4 393216
	stloc.2
// 0x01029cb4: 0x1029cb4: lw    v1, -24196(v0)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01029cbc: 0x1029cbc: beq   v1, zero, 0x1029d0c addu  a1, zero, zero
	...
	brfalse L_1029d0c
// --- basic block ---
// 0x01029cc4: 0x1029cc4: addiu v0, v0, -24196
	ldloc.2
	ldc.i4 -24196
	add
	stloc.2
...
// 0x01029d0c: 0x1029d0c: sll   a1, a1, 2
	...
	shl
	stloc.1
// 0x01029d10: 0x1029d10: addiu v0, v0, -24196
	ldloc.2
	ldc.i4 -24196
	add
	stloc.2
