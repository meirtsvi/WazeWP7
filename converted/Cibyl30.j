...
// 0x01028adc: 0x1028adc: jal   0x10960b0 sw    s1, 24(sp)
	ldloc 8
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01028af4: 0x1028af4: addiu a0, s0, -28724
	...
	add
	stloc.1
// 0x01028af8: 0x1028af8: jal   0x10960b0 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028b2c: 0x1028b2c: addiu a0, a0, -28612
	...
	add
	stloc.1
// 0x01028b30: 0x1028b30: jal   0x10948e4 addu  s0, s1, s0
	ldloc 9
	ldloc 7
	add
	stloc 7
...
// 0x01028b3c: 0x1028b3c: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x01028b40: 0x1028b40: jal   0x10948e4 addiu a0, a0, -28592
	ldloc.1
	ldc.i4 -28592
	add
	stloc.1
...
// 0x01028b50: 0x1028b50: beq   v0, zero, 0x1028b64 lui   v1, 0x60000
	...
	brfalse L_1028b64
// --- basic block ---
// 0x01028b58: 0x1028b58: lw    a1, -26148(v1)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1028b64:
// 0x01028b64: 0x1028b64: addiu v1, v1, -26148
	ldloc 5
	ldc.i4 -26148
	add
	stloc 5
...
// 0x01028b6c: 0x1028b6c: lui   a0, 0x10000
	...
	stloc.1
L_1028b70:
// 0x01028b70: 0x1028b70: jal   0x10948e4 addiu a0, a0, -28576
	ldloc.1
	ldc.i4 -28576
	add
	stloc.1
...
// 0x01028b80: 0x1028b80: beq   v0, zero, 0x1028b94 lui   v1, 0x60000
	...
	brfalse L_1028b94
// --- basic block ---
// 0x01028b88: 0x1028b88: lw    a1, -26148(v1)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1028b94:
// 0x01028b94: 0x1028b94: addiu v1, v1, -26148
	ldloc 5
	ldc.i4 -26148
	add
	stloc 5
...
// 0x01028b9c: 0x1028b9c: lui   a0, 0x10000
	...
	stloc.1
L_1028ba0:
// 0x01028ba0: 0x1028ba0: jal   0x10948e4 addiu a0, a0, -28556
	ldloc.1
	ldc.i4 -28556
	add
	stloc.1
...
// 0x01028bd0: 0x1028bd0: jal   0x10960b0 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028be8: 0x1028be8: addiu a0, s0, -27832
	...
	add
	stloc.1
// 0x01028bec: 0x1028bec: jal   0x10960b0 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028c20: 0x1028c20: addu  a1, v0, zero
	ldloc 6
	stloc.2
// 0x01028c24: 0x1028c24: jal   0x1094920 addiu a0, s0, 32672
	ldloc 8
	ldc.i4 32672
	add
	stloc.1
...
// 0x01028c38: 0x1028c38: addiu a0, a0, -28644
	...
	add
	stloc.1
// 0x01028c3c: 0x1028c3c: jal   0x1094920 addu  a1, v0, zero
	ldloc 6
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028c50: 0x1028c50: addiu a0, a0, -28628
	...
	add
	stloc.1
// 0x01028c54: 0x1028c54: jal   0x1094920 addu  a1, v0, zero
	ldloc 6
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01028c64: 0x1028c64: beq   v0, zero, 0x1028c78 lui   v1, 0x60000
	...
	brfalse L_1028c78
// --- basic block ---
// 0x01028c6c: 0x1028c6c: lw    a1, -26148(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1028c78:
// 0x01028c78: 0x1028c78: addiu v1, v1, -26148
	ldloc 5
	ldc.i4 -26148
	add
	stloc 5
...
// 0x01028c80: 0x1028c80: lui   a0, 0x10000
	...
	stloc.1
L_1028c84:
// 0x01028c84: 0x1028c84: jal   0x10948e4 addiu a0, a0, -28576
	ldloc.1
	ldc.i4 -28576
	add
	stloc.1
...
// 0x01028c94: 0x1028c94: beq   v0, zero, 0x1028ca8 lui   v1, 0x60000
	...
	brfalse L_1028ca8
// --- basic block ---
// 0x01028c9c: 0x1028c9c: lw    a1, -26148(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1028ca8:
// 0x01028ca8: 0x1028ca8: addiu v1, v1, -26148
	ldloc 5
	ldc.i4 -26148
	add
	stloc 5
...
// 0x01028cb0: 0x1028cb0: lui   a0, 0x10000
	...
	stloc.1
L_1028cb4:
// 0x01028cb4: 0x1028cb4: jal   0x10948e4 addiu a0, a0, -28556
	ldloc.1
	ldc.i4 -28556
	add
	stloc.1
...
// 0x01028cd8: 0x1028cd8: jal   0x104fea4 addiu a0, a0, -29492
	ldloc.1
	ldc.i4 -29492
	add
	stloc.1
...
// 0x01028cf0: 0x1028cf0: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01028cf4: 0x1028cf4: jal   0x104c1e0 addiu a0, a0, 30116
	ldloc.1
	ldc.i4 30116
	add
	stloc.1
...
// 0x01028d80: 0x1028d80: sw    s0, 20(sp)
	...
	ldloc 6
	stelem.i4
// 0x01028d84: 0x1028d84: lw    s0, -26108(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01028e54: 0x1028e54: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01028e58: 0x1028e58: lw    s1, -26108(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01028e70: 0x1028e70: beq   v0, zero, 0x1028e8c addiu s1, s1, 8
	...
	brfalse L_1028e8c
// --- basic block ---
// 0x01028e78: 0x1028e78: lw    a1, -26104(s3)
	ldloc 6
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x01028f58: 0x1028f58: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01028f5c: 0x1028f5c: lw    v0, -26108(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01028ff8: 0x1028ff8: lui   s6, 0x10000
	ldc.i4 65536
	stloc 12
// 0x01028ffc: 0x1028ffc: sw    v0, -26108(s5)
	ldloc 6
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x010290a0: 0x10290a0: jal   0x1001b48 addu  a0, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x010290a8: 0x10290a8: lw    v1, -26104(s4)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x010290b4: 0x10290b4: beq   v1, zero, 0x10290c0 sll   zero, zero, 0
	...
	brfalse L_10290c0
// --- basic block ---
// 0x010290bc: 0x10290bc: sw    v0, -26104(s4)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
	...
	stelem.i4
L_10290c0:
// 0x010290c0: 0x10290c0: lw    v1, -26108(s5)
	ldloc 6
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x010290f0: 0x10290f0: bne   a0, zero, 0x1029018 lui   v0, 0x60000
	...
	brtrue L_1029018
// --- basic block ---
// 0x010290f8: 0x10290f8: lw    a0, -26108(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01029108: 0x1029108: sw    zero, 0(s2)
	...
	ldc.i4.s 0
	stelem.i4
// 0x0102910c: 0x102910c: jal   0x104fc0c addiu a1, a1, -29320
	ldloc.2
	ldc.i4 -29320
	add
	stloc.2
	call void Cibyl59::roadmap_main_set_keyboard_104fc0c()
// --- basic block ---
L_1029114:
...
// 0x01029180: 0x1029180: sw    s2, 288(sp)
	...
	ldloc 10
	stelem.i4
// 0x01029184: 0x1029184: jal   0x104db60 sw    s0, 280(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01029198: 0x1029198: lui   s8, 0x10000
	ldc.i4 65536
	stloc 13
// 0x0102919c: 0x102919c: addiu s4, s4, -26100
	ldloc 12
	ldc.i4 -26100
	add
	stloc 12
...
// 0x01029280: 0x1029280: addu  v0, v0, s4
	...
	add
	stloc 5
// 0x01029284: 0x1029284: j	 0x10292cc addiu v1, v1, 25288
	ldloc 7
	ldc.i4 25288
	add
	stloc 7
...
// 0x010292ec: 0x10292ec: beq   s0, zero, 0x1029308 lui   v0, 0x60000
	...
	brfalse L_1029308
// --- basic block ---
// 0x010292f4: 0x10292f4: addiu v0, v0, -26100
	ldloc 5
	ldc.i4 -26100
	add
	stloc 5
...
// 0x01029388: 0x1029388: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0102938c: 0x102938c: jal   0x104d0e4 addiu a0, a0, -26652
	ldloc.1
	ldc.i4 -26652
	add
	stloc.1
...
// 0x010293b0: 0x10293b0: addiu a0, s4, 26252
	...
	add
	stloc.1
// 0x010293b4: 0x10293b4: jal   0x104d29c addu  s4, a0, zero
	ldloc.1
	stloc 10
	ldloc.0
	ldloc.1
...
// 0x010293d4: 0x10293d4: bne   v0, zero, 0x10293f8 addu  a0, s4, zero
	...
	brtrue L_10293f8
// --- basic block ---
// 0x010293dc: 0x10293dc: jal   0x104d224 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// --- basic block ---
L_1029570:
// 0x01029570: 0x1029570: addiu v0, v0, 25288
	ldloc 5
	ldc.i4 25288
	add
	stloc 5
// 0x01029574: 0x1029574: bne   a1, v0, 0x102958c lui   v1, 0x20000
	...
	bne.un L_102958c
// --- basic block ---
// 0x0102957c: 0x102957c: jal   0x104fd54 addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.1
	call int32 Cibyl59::roadmap_main_add_separator_104fd54(int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// --- basic block ---
L_102958c:
// 0x0102958c: 0x102958c: addiu v1, v1, 25304
	ldloc 7
	ldc.i4 25304
	add
	stloc 7
...
// 0x01029598: 0x1029598: addu  a0, s3, zero
	ldloc 11
	stloc.1
// 0x0102959c: 0x102959c: jal   0x10556a8 addu  a1, s4, zero
	ldloc 12
	stloc.2
	ldloc.1
	ldloc.2
	ldloc.3
	call int32 Cibyl63::roadmap_help_first_topic_10556a8(int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x010295cc: 0x10295cc: addu  a0, s0, zero
	ldloc 8
	stloc.1
// 0x010295d0: 0x10295d0: jal   0x104fcec addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl59::roadmap_main_add_menu_item_104fcec(int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
// 0x010295d8: 0x10295d8: addu  a0, s3, zero
	ldloc 11
	stloc.1
// 0x010295dc: 0x10295dc: jal   0x10559d0 addu  a1, s4, zero
	ldloc 12
	stloc.2
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl63::roadmap_help_next_topic_10559d0(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x010295fc: 0x10295fc: bne   v0, v1, 0x1029630 sll   zero, zero, 0
	...
	bne.un L_1029630
// --- basic block ---
// 0x01029604: 0x1029604: jal   0x104fc14 sw    a1, 28(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
	...
	ldloc.2
	stelem.i4
	call int32 Cibyl59::roadmap_main_new_menu_104fc14()
	stloc 5
// --- basic block ---
...
// 0x0102961c: 0x102961c: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01029620: 0x1029620: jal   0x104fc24 addu  a0, s0, zero
	ldloc 8
	stloc.1
	call void Cibyl59::roadmap_main_add_menu_104fc24()
// --- basic block ---
...
// 0x0102966c: 0x102966c: addu  a0, s0, zero
	ldloc 8
	stloc.1
// 0x01029670: 0x1029670: jal   0x104fcec addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.1
	ldloc.2
...
// 0x010296b4: 0x10296b4: addu  s0, v0, zero
	ldloc 5
	stloc 8
// 0x010296b8: 0x10296b8: j	 0x102972c addiu s2, s2, 25288
	ldloc 9
	ldc.i4 25288
	add
	stloc 9
...
// 0x010296c0: 0x10296c0: bne   a1, s2, 0x10296d8 sll   zero, zero, 0
	...
	bne.un L_10296d8
// --- basic block ---
// 0x010296c8: 0x10296c8: jal   0x104fd7c addiu s0, s0, 4
	ldloc 8
	ldc.i4.4
	add
	stloc 8
	call void Cibyl59::roadmap_main_add_tool_space_104fd7c()
// --- basic block ---
...
// 0x0102971c: 0x102971c: lw    a2, 16(v0)
	...
	ldelem.i4
	stloc.3
// 0x01029720: 0x1029720: jal   0x104fd74 sll   zero, zero, 0
	call void Cibyl59::roadmap_main_add_tool_104fd74()
// --- basic block ---
L_1029728:
...
// 0x01029a48: 0x1029a48: sw    s3, 292(sp)
	...
	ldloc 11
	stelem.i4
// 0x01029a4c: 0x1029a4c: jal   0x104db60 sw    s2, 288(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01029b88: 0x1029b88: bne   v0, zero, 0x1029ba0 addu  a0, s0, zero
	...
	brtrue L_1029ba0
// --- basic block ---
// 0x01029b90: 0x1029b90: jal   0x109caf4 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01029c14: 0x1029c14: sw    s5, 40(sp)
	...
	ldloc 9
	stelem.i4
// 0x01029c18: 0x1029c18: jal   0x104d29c sw    s4, 36(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
	...
	stloc 6
// --- basic block ---
// 0x01029c20: 0x1029c20: jal   0x104c5fc sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01029c40: 0x1029c40: addiu a0, s0, 26252
	...
	add
	stloc.1
// 0x01029c44: 0x1029c44: jal   0x104d29c addu  s4, a0, zero
	ldloc.1
	stloc 13
	ldloc.0
	ldloc.1
...
// 0x01029c60: 0x1029c60: addu  a0, s4, zero
	ldloc 13
	stloc.1
// 0x01029c64: 0x1029c64: jal   0x104d224 addu  s5, v0, zero
	ldloc 6
	stloc 9
	ldloc.0
	ldloc.1
...
// 0x01029cb0: 0x1029cb0: lui   v0, 0x60000
	ldc.i4 393216
	stloc.2
// 0x01029cb4: 0x1029cb4: lw    v1, -24052(v0)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01029cbc: 0x1029cbc: beq   v1, zero, 0x1029d0c addu  a1, zero, zero
	...
	brfalse L_1029d0c
// --- basic block ---
// 0x01029cc4: 0x1029cc4: addiu v0, v0, -24052
	ldloc.2
	ldc.i4 -24052
	add
	stloc.2
...
// 0x01029d0c: 0x1029d0c: sll   a1, a1, 2
	...
	shl
	stloc.1
// 0x01029d10: 0x1029d10: addiu v0, v0, -24052
	ldloc.2
	ldc.i4 -24052
	add
	stloc.2
