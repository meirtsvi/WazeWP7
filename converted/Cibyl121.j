...
// 0x010a1894: 0x10a1894: sll   v1, a0, 2
	...
	shl
	stloc 7
// 0x010a1898: 0x10a1898: addiu v0, v0, 17736
	ldloc 5
	ldc.i4 17736
	add
	stloc 5
...
// 0x010a1edc: 0x10a1edc: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010a1ee0: 0x10a1ee0: lw    s0, 17928(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a1fac: 0x10a1fac: addiu v0, zero, -1
	ldc.i4.m1
	stloc 5
// 0x010a1fb0: 0x10a1fb0: sw    v0, 17928(v1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10a1fbc:
// 0x010a1fbc: 0x10a1fbc: lw    v0, 17928(v1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010a1fd4: 0x10a1fd4: sw    a1, 27680(a0)
	...
	ldloc.2
	stelem.i4
// 0x010a1fd8: 0x10a1fd8: sw    v0, 17928(v1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010a2048: 0x10a2048: beq   a0, v0, 0x10a20c8 lui   a2, 0x0
	...
	beq  L_10a20c8
// --- basic block ---
// 0x010a2050: 0x10a2050: lw    v0, 17928(a2)
	ldloc 6
	ldloc.3
	ldc.i4.2
	shr.un
...
// 0x010a2064: 0x10a2064: sw    v0, 27680(v1)
	...
	ldloc 5
	stelem.i4
// 0x010a2068: 0x10a2068: sw    zero, 17928(a2)
	ldloc 6
	ldloc.3
	ldc.i4.2
	shr.un
...
// 0x010a2438: 0x10a2438: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010a243c: 0x10a243c: jal   0x100e368 addiu a0, a0, 17768
	ldloc.1
	ldc.i4 17768
	add
	stloc.1
...
// 0x010a2448: 0x10a2448: addu  s6, v0, zero
	ldloc 5
	stloc 11
// 0x010a244c: 0x10a244c: j	 0x10a24bc addiu a0, a0, 17784
	ldloc.1
	ldc.i4 17784
	add
	stloc.1
...
// --- basic block ---
L_10a2454:
// 0x010a2454: 0x10a2454: jal   0x100e368 addiu a0, a0, 17800
	ldloc.1
	ldc.i4 17800
	add
	stloc.1
...
// 0x010a2460: 0x10a2460: addu  s6, v0, zero
	ldloc 5
	stloc 11
// 0x010a2464: 0x10a2464: j	 0x10a24bc addiu a0, a0, 17816
	ldloc.1
	ldc.i4 17816
	add
	stloc.1
...
// 0x010a246c: 0x10a246c: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010a2470: 0x10a2470: jal   0x100e368 addiu a0, a0, 17832
	ldloc.1
	ldc.i4 17832
	add
	stloc.1
...
// 0x010a247c: 0x10a247c: addu  s6, v0, zero
	ldloc 5
	stloc 11
// 0x010a2480: 0x10a2480: j	 0x10a24bc addiu a0, a0, 17848
	ldloc.1
	ldc.i4 17848
	add
	stloc.1
...
// 0x010a2488: 0x10a2488: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010a248c: 0x10a248c: jal   0x100e368 addiu a0, a0, 17864
	ldloc.1
	ldc.i4 17864
	add
	stloc.1
...
// 0x010a2498: 0x10a2498: addu  s6, v0, zero
	ldloc 5
	stloc 11
// 0x010a249c: 0x10a249c: j	 0x10a24bc addiu a0, a0, 17880
	ldloc.1
	ldc.i4 17880
	add
	stloc.1
...
// 0x010a24a4: 0x10a24a4: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010a24a8: 0x10a24a8: jal   0x100e368 addiu a0, a0, 17896
	ldloc.1
	ldc.i4 17896
	add
	stloc.1
...
// 0x010a24b4: 0x10a24b4: addu  s6, v0, zero
	ldloc 5
	stloc 11
// 0x010a24b8: 0x10a24b8: addiu a0, a0, 17912
	ldloc.1
	ldc.i4 17912
	add
	stloc.1
...
// 0x010a2758: 0x10a2758: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x010a275c: 0x10a275c: addiu a0, a0, 17752
	ldloc.1
	ldc.i4 17752
	add
	stloc.1
...
// 0x010a2a3c: 0x10a2a3c: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x010a2a40: 0x10a2a40: addiu a1, a1, 17768
	ldloc.2
	ldc.i4 17768
	add
	stloc.2
...
// 0x010a2a60: 0x10a2a60: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x010a2a64: 0x10a2a64: addiu a1, a1, 17832
	ldloc.2
	ldc.i4 17832
	add
	stloc.2
...
// 0x010a2a7c: 0x10a2a7c: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x010a2a80: 0x10a2a80: addiu a1, a1, 17896
	ldloc.2
	ldc.i4 17896
	add
	stloc.2
...
// 0x010a2a98: 0x10a2a98: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x010a2a9c: 0x10a2a9c: addiu a1, a1, 17864
	ldloc.2
	ldc.i4 17864
	add
	stloc.2
...
// 0x010a2ab8: 0x10a2ab8: addiu a2, s1, 18616
	...
	add
	stloc.3
// 0x010a2abc: 0x10a2abc: addiu a1, a1, 17800
	ldloc.2
	ldc.i4 17800
	add
	stloc.2
...
// 0x010a2ad0: 0x10a2ad0: addiu a2, s1, 18616
	...
	add
	stloc.3
// 0x010a2ad4: 0x10a2ad4: addiu a1, a1, 17784
	ldloc.2
	ldc.i4 17784
	add
	stloc.2
...
// 0x010a2ae8: 0x10a2ae8: addiu a2, s1, 18616
	...
	add
	stloc.3
// 0x010a2aec: 0x10a2aec: addiu a1, a1, 17816
	ldloc.2
	ldc.i4 17816
	add
	stloc.2
...
// 0x010a2b00: 0x10a2b00: addiu a2, s1, 18616
	...
	add
	stloc.3
// 0x010a2b04: 0x10a2b04: addiu a1, a1, 17848
	ldloc.2
	ldc.i4 17848
	add
	stloc.2
...
// 0x010a2b18: 0x10a2b18: addiu a2, s1, 18616
	...
	add
	stloc.3
// 0x010a2b1c: 0x10a2b1c: addiu a1, a1, 17912
	ldloc.2
	ldc.i4 17912
	add
	stloc.2
...
// 0x010a2b30: 0x10a2b30: addiu a2, s1, 18616
	...
	add
	stloc.3
// 0x010a2b34: 0x10a2b34: addiu a1, a1, 17880
	ldloc.2
	ldc.i4 17880
	add
	stloc.2
