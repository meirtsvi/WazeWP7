...
// 0x010379b0: 0x10379b0: sll   s0, s0, 2
	...
	shl
	stloc 6
// 0x010379b4: 0x10379b4: addiu v0, v0, -15496
	ldloc 5
	ldc.i4 -15496
	add
	stloc 5
...
// 0x010379f8: 0x10379f8: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010379fc: 0x10379fc: lw    v0, -16540(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01037a28: 0x1037a28: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01037a2c: 0x1037a2c: sw    v1, -16540(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01037a4c: 0x1037a4c: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01037a50: 0x1037a50: lw    v0, -16532(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01037a7c: 0x1037a7c: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01037a80: 0x1037a80: sw    v1, -16532(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01037a84: 0x1037a84: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01037a88: 0x1037a88: lw    v1, -16528(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01037a90: 0x1037a90: addiu v1, v1, -1
	...
	add
	stloc 7
// 0x01037a94: 0x1037a94: sw    v1, -16528(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01037aa0: 0x1037aa0: lw    s0, 16(sp)
	...
	ldelem.i4
	stloc 8
// 0x01037aa4: 0x1037aa4: sw    v1, -16536(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1037b08:
// 0x01037b08: 0x1037b08: lw    s0, -16532(s3)
	ldloc 5
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01037b14: 0x1037b14: jal   0x1000930 addu  a0, s0, zero
	...
	stloc 6
// --- basic block ---
// 0x01037b1c: 0x1037b1c: sw    s1, -16536(s2)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
	...
	stelem.i4
L_1037b20:
// 0x01037b20: 0x1037b20: lw    v0, -16528(s4)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01037b88: 0x1037b88: addiu a2, zero, 1024
	ldc.i4 1024
	stloc.3
// 0x01037b8c: 0x1037b8c: addiu a0, s2, -16524
	ldloc 5
	ldc.i4 -16524
	add
	stloc.1
// 0x01037b90: 0x1037b90: jal   0x1001af8 addiu s2, s2, -16524
	ldloc 5
	ldc.i4 -16524
	add
	stloc 5
...
// 0x01037be4: 0x1037be4: lui   v0, 0x10000
	ldc.i4 65536
	stloc 7
// 0x01037be8: 0x1037be8: j	 0x1037c08 addiu v0, v0, 18656
	ldloc 7
	ldc.i4 18656
	add
	stloc 7
...
// 0x01037c3c: 0x1037c3c: sll   a0, v0, 2
	...
	shl
	stloc.1
// 0x01037c40: 0x1037c40: addiu v1, v1, -15496
	ldloc 6
	ldc.i4 -15496
	add
	stloc 6
...
// 0x01037d3c: 0x1037d3c: sll   a0, v0, 2
	...
	shl
	stloc.1
// 0x01037d40: 0x1037d40: addiu v1, v1, -15496
	ldloc 7
	ldc.i4 -15496
	add
	stloc 7
...
// 0x01037e14: 0x1037e14: lui   v0, 0x60000
	ldc.i4 393216
	stloc 6
// 0x01037e18: 0x1037e18: sw    v1, -16536(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01037e54: 0x1037e54: sw    s0, 88(sp)
	...
	ldloc 8
	stelem.i4
// 0x01037e58: 0x1037e58: lw    s0, -16540(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01037f94: 0x1037f94: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01037f98: 0x1037f98: lw    s1, -16540(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01038184: 0x1038184: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01038188: 0x1038188: lw    v0, -16540(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010381a0: 0x10381a0: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010381a4: 0x10381a4: sw    s0, -16532(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010381a8: 0x10381a8: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010381ac: 0x10381ac: lw    s2, -16528(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010381bc: 0x10381bc: addiu a0, a0, 12560
	...
	add
	stloc.1
// 0x010381c0: 0x10381c0: sw    s0, -16540(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
	...
	ldloc 8
	stelem.i4
// 0x010381c4: 0x10381c4: jal   0x100e7a8 sw    s2, -16528(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010381d0: 0x10381d0: beq   v0, zero, 0x10381f8 lui   v0, 0x60000
	...
	brfalse L_10381f8
// --- basic block ---
// 0x010381d8: 0x10381d8: lw    s0, -16532(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01038214: 0x1038214: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01038218: 0x1038218: sw    v1, -16536(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01038260: 0x1038260: sll   v1, s1, 2
	...
	shl
	stloc 7
// 0x01038264: 0x1038264: addiu v0, v0, -15496
	ldloc 6
	ldc.i4 -15496
	add
	stloc 6
...
// 0x01038388: 0x1038388: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0103838c: 0x103838c: lw    v0, -15500(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010383a0: 0x10383a0: bne   v0, zero, 0x1038480 sw    s0, 1040(sp)
	...
	brtrue L_1038480
// --- basic block ---
// 0x010383a8: 0x10383a8: jal   0x104c584 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010383bc: 0x10383bc: addiu a1, a1, -12164
	...
	add
	stloc.2
// 0x010383c0: 0x10383c0: jal   0x104dae8 addiu a2, a2, 26152
	ldloc.3
	ldc.i4 26152
	add
	stloc.3
...
// 0x01038470: 0x1038470: addiu v1, zero, 1
	ldc.i4.1
	stloc 6
// 0x01038474: 0x1038474: sw    v1, -15500(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01038478: 0x1038478: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0103847c: 0x103847c: sw    zero, -16536(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010384a4: 0x10384a4: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x010384a8: 0x10384a8: addiu a0, a0, 12716
	ldloc.1
	ldc.i4 12716
	add
	stloc.1
...
// 0x010388f8: 0x10388f8: addu  s3, a1, zero
	ldloc.2
	stloc 10
// 0x010388fc: 0x10388fc: addiu s1, s1, -14972
	ldloc 7
	ldc.i4 -14972
	add
	stloc 7
...
// --- basic block ---
L_103892c:
// 0x0103892c: 0x103892c: lw    v0, -14976(s2)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01038a9c: 0x1038a9c: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01038aa0: 0x1038aa0: addiu a0, a0, -14972
	ldloc.1
	ldc.i4 -14972
	add
	stloc.1
// 0x01038aa4: 0x1038aa4: sw    ra, 20(sp)
// 0x01038aa8: 0x1038aa8: jal   0x1038960 addiu a1, a1, -14976
	ldloc.2
	ldc.i4 -14976
	add
	stloc.2
...
// 0x01038acc: 0x1038acc: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01038ad0: 0x1038ad0: addiu a0, a0, -14972
	ldloc.1
	ldc.i4 -14972
	add
	stloc.1
// 0x01038ad4: 0x1038ad4: sw    ra, 20(sp)
// 0x01038ad8: 0x1038ad8: jal   0x10389e0 addiu a1, a1, -14976
	ldloc.2
	ldc.i4 -14976
	add
	stloc.2
...
// 0x01038b2c: 0x1038b2c: bne   a0, v0, 0x1038b38 lui   v0, 0x60000
	...
	bne.un L_1038b38
// --- basic block ---
// 0x01038b34: 0x1038b34: sw    zero, -14984(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01038b40: 0x1038b40: lui   v0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x01038b44: 0x1038b44: jr    ra sw    a0, -14984(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01038b5c: 0x1038b5c: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01038b60: 0x1038b60: lw    v1, -14984(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01038b84: 0x1038b84: lui   s0, 0x60000
	ldc.i4 393216
	stloc 8
// 0x01038b88: 0x1038b88: lw    v0, -14980(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01038b9c: 0x1038b9c: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x01038ba0: 0x1038ba0: addiu a0, a0, 12716
	ldloc.1
	ldc.i4 12716
	add
	stloc.1
...
// 0x01038bc4: 0x1038bc4: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x01038bc8: 0x1038bc8: sw    v0, -14980(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01038c48: 0x1038c48: sw    v0, 24(sp)
	...
	ldloc 5
	stelem.i4
// 0x01038c4c: 0x1038c4c: addiu a0, a0, 18656
	ldloc.1
	ldc.i4 18656
	add
	stloc.1
...
// 0x01038c64: 0x1038c64: sw    s0, 20(sp)
	...
	ldloc 8
	stelem.i4
// 0x01038c68: 0x1038c68: jal   0x104c1d8 sw    zero, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
