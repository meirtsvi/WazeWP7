...
// 0x010a8964: 0x10a8964: lui   s1, 0x90000
	ldc.i4 589824
	stloc 9
// 0x010a8968: 0x10a8968: jal   0x1001800 sw    zero, -32684(s1)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010a89a0: 0x10a89a0: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x010a89a4: 0x10a89a4: sw    v0, -32684(s1)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010a89a8: 0x10a89a8: lui   v0, 0x90000
	...
	stloc 5
L_10a89ac:
// 0x010a89ac: 0x10a89ac: lw    v0, -32684(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a8a0c: 0x10a8a0c: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x010a8a10: 0x10a8a10: jal   0x100ea70 sw    zero, -32684(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a8be8: 0x10a8be8: lui   v0, 0x90000
	ldc.i4 589824
	stloc 7
// 0x010a8bec: 0x10a8bec: sw    v1, -32688(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010a8c38: 0x10a8c38: addiu a0, s1, 32144
	...
	add
	stloc.1
// 0x010a8c3c: 0x10a8c3c: jal   0x101cd80 sw    v0, -32680(s2)
	ldloc 5
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010a8c4c: 0x10a8c4c: addiu s2, s2, -32680
	ldloc 10
	ldc.i4 -32680
	add
	stloc 10
...
// 0x010a8c54: 0x10a8c54: addiu s1, s1, 32144
	...
	add
	stloc 6
// 0x010a8c58: 0x10a8c58: addiu a0, v1, -32672
	ldloc 8
	ldc.i4 -32672
	add
	stloc.1
...
// 0x010a8c60: 0x10a8c60: sw    s1, 4(a0)
	...
	ldloc 6
	stelem.i4
// 0x010a8c64: 0x10a8c64: sw    s0, -32672(v1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010a8cc4: 0x10a8cc4: lui   v0, 0x90000
	ldc.i4 589824
	stloc 5
// 0x010a8cc8: 0x10a8cc8: lw    v0, -32688(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a8ce0: 0x10a8ce0: lui   v0, 0x20000
	...
	stloc 5
L_10a8ce4:
// 0x010a8ce4: 0x10a8ce4: lw    s2, 29984(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a8e10: 0x10a8e10: jal   0x1099134 lui   s7, 0xf0000
	...
	call void Cibyl114::ssd_widget_set_color_1099134(int32,int32,int32)
// --- basic block ---
// 0x010a8e18: 0x10a8e18: lw    a2, -30068(s7)
	ldloc 7
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x010a8f50: 0x10a8f50: jal   0x1099134 addiu a2, s8, 23008
	...
	call void Cibyl114::ssd_widget_set_color_1099134(int32,int32,int32)
// --- basic block ---
// 0x010a8f58: 0x10a8f58: lw    a2, -30068(s7)
	ldloc 7
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x010a90f4: 0x10a90f4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010a90f8: 0x10a90f8: lw    a0, 29988(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a9178: 0x10a9178: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010a917c: 0x10a917c: lw    a0, 29992(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a924c: 0x10a924c: lui   v0, 0x90000
	ldc.i4 589824
	stloc.1
// 0x010a9250: 0x10a9250: jr    ra sw    a0, -32664(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10a9bb0:
// 0x010a9bb0: 0x10a9bb0: lw    v0, -32664(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
