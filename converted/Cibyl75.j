...
// 0x01064900: 0x1064900: lui   a3, 0x70000
	ldc.i4 458752
	stloc 4
// 0x01064904: 0x1064904: addiu a3, a3, 15976
	ldloc 4
	ldc.i4 15976
	add
	stloc 4
...
// 0x01064944: 0x1064944: addiu a1, s3, 28100
	...
	add
	stloc.2
// 0x01064948: 0x1064948: addiu a3, a3, 15972
	ldloc 4
	ldc.i4 15972
	add
	stloc 4
...
// 0x010649c8: 0x10649c8: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x010649cc: 0x10649cc: addiu s4, v0, 15968
	ldloc 5
	ldc.i4 15968
	add
	stloc 11
// 0x010649d0: 0x10649d0: lw    v1, 15968(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01064a14: 0x1064a14: bne   v0, zero, 0x1064a28 addiu s0, s0, 15968
	ldloc 5
	ldloc 8
	ldc.i4 15968
	add
...
// 0x01064a20: 0x1064a20: lui   s0, 0x70000
	...
	stloc 8
L_1064a24:
// 0x01064a24: 0x1064a24: addiu s0, s0, 15968
	ldloc 8
	ldc.i4 15968
	add
	stloc 8
...
// 0x01064bc8: 0x1064bc8: lui   s0, 0x70000
	ldc.i4 458752
	stloc 8
// 0x01064bcc: 0x1064bcc: addiu s0, s0, 15968
	ldloc 8
	ldc.i4 15968
	add
	stloc 8
...
// 0x01064c2c: 0x1064c2c: lui   s0, 0x70000
	ldc.i4 458752
	stloc 8
// 0x01064c30: 0x1064c30: addiu s0, s0, 15968
	ldloc 8
	ldc.i4 15968
	add
	stloc 8
...
// 0x01064de8: 0x1064de8: lui   v1, 0x70000
	ldc.i4 458752
	stloc 7
// 0x01064dec: 0x1064dec: addiu v1, v1, 15968
	ldloc 7
	ldc.i4 15968
	add
	stloc 7
...
// 0x01064e3c: 0x1064e3c: lw    a0, 32(v1)
	...
	ldelem.i4
	stloc.1
// 0x01064e40: 0x1064e40: jalr  v0 addiu a2, a2, 16004
	ldloc 5
	ldloc.3
	ldc.i4 16004
	add
...
// 0x01064e7c: 0x1064e7c: lui   s1, 0x70000
	ldc.i4 458752
	stloc 9
// 0x01064e80: 0x1064e80: lw    v0, 15960(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01064ea8: 0x1064ea8: lui   v1, 0x70000
	ldc.i4 458752
	stloc 6
// 0x01064eac: 0x1064eac: sw    v0, 15964(v1)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01064eb0: 0x1064eb0: addiu v0, zero, 1
	ldc.i4.1
	stloc 7
// 0x01064eb4: 0x1064eb4: sw    v0, 15960(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01064f2c: 0x1064f2c: lui   s1, 0x70000
	ldc.i4 458752
	stloc 9
// 0x01064f30: 0x1064f30: addiu s1, s1, 15968
	ldloc 9
	ldc.i4 15968
	add
	stloc 9
...
// 0x01065020: 0x1065020: lui   v0, 0x70000
	...
	stloc 5
L_1065024:
// 0x01065024: 0x1065024: addiu v0, v0, 15968
	ldloc 5
	ldc.i4 15968
	add
	stloc 5
...
// 0x01065068: 0x1065068: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0106506c: 0x106506c: addiu v0, v0, 15968
	ldloc 5
	ldc.i4 15968
	add
	stloc 5
...
// 0x010650c4: 0x10650c4: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x010650c8: 0x10650c8: sw    s0, 16468(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010650cc: 0x10650cc: lui   s2, 0x70000
	ldc.i4 458752
	stloc 10
// 0x010650d0: 0x10650d0: addiu s2, s2, 15968
	ldloc 10
	ldc.i4 15968
	add
	stloc 10
...
// 0x010653c4: 0x10653c4: lh    v0, 36(v1)
	...
	call int32 [WazeWP7]CRunTime::memoryReadShort(int32)
	stloc 5
// 0x010653c8: 0x10653c8: lw    a1, 31312(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010653e4: 0x10653e4: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x010653e8: 0x10653e8: lw    a2, 31400(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01065418: 0x1065418: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x0106541c: 0x106541c: lw    a3, 31388(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x010655f4: 0x10655f4: bne   a0, v0, 0x106560c lui   a0, 0x70000
	...
	bne.un L_106560c
// --- basic block ---
// 0x010655fc: 0x10655fc: addiu a0, a0, 16476
	ldloc.1
	ldc.i4 16476
	add
	stloc.1
...
// --- basic block ---
L_106560c:
// 0x0106560c: 0x106560c: addiu a0, a0, 16476
	ldloc.1
	ldc.i4 16476
	add
	stloc.1
...
// 0x01065660: 0x1065660: bne   a0, v0, 0x1065678 lui   a0, 0x70000
	...
	bne.un L_1065678
// --- basic block ---
// 0x01065668: 0x1065668: addiu a0, a0, 16484
	ldloc.1
	ldc.i4 16484
	add
	stloc.1
...
// --- basic block ---
L_1065678:
// 0x01065678: 0x1065678: addiu a0, a0, 16484
	ldloc.1
	ldc.i4 16484
	add
	stloc.1
...
// 0x01065768: 0x1065768: beq   a0, zero, 0x1065790 lui   v0, 0x70000
	...
	brfalse L_1065790
// --- basic block ---
// 0x01065770: 0x1065770: lw    v0, 16492(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010658f8: 0x10658f8: lui   s1, 0x70000
	ldc.i4 458752
	stloc 10
// 0x010658fc: 0x10658fc: addiu s1, s1, 15968
	ldloc 10
	ldc.i4 15968
	add
	stloc 10
...
// 0x010660bc: 0x10660bc: lui   s0, 0x70000
	ldc.i4 458752
	stloc 9
// 0x010660c0: 0x10660c0: addiu s0, s0, 15968
	ldloc 9
	ldc.i4 15968
	add
	stloc 9
...
// 0x01066198: 0x1066198: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0106619c: 0x106619c: addiu v0, v0, 15968
	ldloc 5
	ldc.i4 15968
	add
	stloc 5
...
// 0x010661c4: 0x10661c4: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x010661c8: 0x10661c8: addiu v0, v0, 15968
	ldloc 5
	ldc.i4 15968
	add
	stloc 5
...
// 0x01066268: 0x1066268: addiu a0, zero, 1
	ldc.i4.1
	stloc.1
// 0x0106626c: 0x106626c: jal   0x1064f24 addiu s0, s0, 15968
	ldloc 9
	ldc.i4 15968
	add
	stloc 9
...
// 0x01066290: 0x1066290: lui   a2, 0x70000
	ldc.i4 458752
	stloc.3
// 0x01066294: 0x1066294: addiu a1, a1, 16004
	ldloc.2
	ldc.i4 16004
	add
	stloc.2
// 0x01066298: 0x1066298: jalr  v0 addiu a2, a2, 16444
	ldloc 5
	ldloc.3
	ldc.i4 16444
	add
