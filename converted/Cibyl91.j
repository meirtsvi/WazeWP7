...
// 0x010794b0: 0x10794b0: sw    s0, 16(sp)
	...
	ldloc 7
	stelem.i4
// 0x010794b4: 0x10794b4: jal   0x1096fd8 sw    v0, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010794e0: 0x10794e0: addu  a0, s0, zero
	ldloc 5
	stloc.1
// 0x010794e4: 0x10794e4: addiu a1, a1, 29048
	ldloc.2
	ldc.i4 29048
	add
	stloc.2
...
// 0x01079524: 0x1079524: addu  a0, s0, zero
	ldloc 5
	stloc.1
// 0x01079528: 0x1079528: addiu a1, a1, 29096
	ldloc.2
	ldc.i4 29096
	add
	stloc.2
...
// 0x01079568: 0x1079568: addu  a0, s0, zero
	ldloc 5
	stloc.1
// 0x0107956c: 0x107956c: addiu a1, a1, 29144
	ldloc.2
	ldc.i4 29144
	add
	stloc.2
...
// 0x010795ac: 0x10795ac: addu  a0, s0, zero
	ldloc 5
	stloc.1
// 0x010795b0: 0x10795b0: addiu a1, a1, 29192
	ldloc.2
	ldc.i4 29192
	add
	stloc.2
...
// 0x010795f0: 0x10795f0: addu  a0, s0, zero
	ldloc 5
	stloc.1
// 0x010795f4: 0x10795f4: addiu a1, a1, 29240
	ldloc.2
	ldc.i4 29240
	add
	stloc.2
...
// 0x01079634: 0x1079634: addu  a0, s0, zero
	ldloc 5
	stloc.1
// 0x01079638: 0x1079638: addiu a1, a1, 29288
	ldloc.2
	ldc.i4 29288
	add
	stloc.2
...
// 0x01079678: 0x1079678: addu  a0, s0, zero
	ldloc 5
	stloc.1
// 0x0107967c: 0x107967c: addiu a1, a1, 29336
	ldloc.2
	ldc.i4 29336
	add
	stloc.2
...
// 0x010796e0: 0x10796e0: lw    v0, 144(s3)
	...
	ldelem.i4
	stloc 5
// 0x010796e4: 0x10796e4: jal   0x10c0b40 subu  a0, a0, v0
	ldloc.1
	ldloc 5
	sub
	stloc.1
...
// 0x010796ec: 0x10796ec: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x010796f0: 0x10796f0: jal   0x10c0a50 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01079814: 0x1079814: jal   0x10949fc addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0107983c: 0x107983c: jal   0x10949fc addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0107985c: 0x107985c: lui   s1, 0x80000
	ldc.i4 524288
	stloc 9
// 0x01079860: 0x1079860: addiu s1, s1, -15868
	ldloc 9
	ldc.i4 -15868
	add
	stloc 9
...
// 0x0107992c: 0x107992c: bne   v0, zero, 0x1079954 lui   s0, 0x80000
	...
	brtrue L_1079954
// --- basic block ---
// 0x01079934: 0x1079934: lw    v0, -13832(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01079948: 0x1079948: jal   0x104fe2c addiu a0, a0, -864
	...
	stloc 6
// --- basic block ---
// 0x01079950: 0x1079950: sw    zero, -13832(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0107995c: 0x107995c: addiu v0, v0, -15868
	ldloc 6
	ldc.i4 -15868
	add
	stloc 6
...
// 0x010799c4: 0x10799c4: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010799c8: 0x10799c8: sw    zero, -15932(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1079a28:
// 0x01079a28: 0x1079a28: jal   0x10086dc addiu a0, s1, -13820
	ldloc 9
	ldc.i4 -13820
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x01079a30: 0x1079a30: addiu v0, s1, -13820
	ldloc 9
	ldc.i4 -13820
	add
	stloc 5
...
// 0x01079a38: 0x1079a38: sw    s0, 4(v0)
	...
	ldloc 7
	stelem.i4
// 0x01079a3c: 0x1079a3c: sw    s0, -13820(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01079a40: 0x1079a40: lui   v0, 0x80000
	...
	stloc 5
L_1079a44:
// 0x01079a44: 0x1079a44: lw    a0, -16068(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01079a5c: 0x1079a5c: lui   v0, 0x80000
	...
	stloc 5
L_1079a60:
// 0x01079a60: 0x1079a60: bne   s3, zero, 0x1079abc sw    zero, -16068(v0)
	ldloc 11
	ldloc 6
	ldloc 5
	ldc.i4.2
...
// 0x01079a68: 0x1079a68: lui   s0, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01079a6c: 0x1079a6c: lw    v0, -13848(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01079a88: 0x1079a88: addiu a0, zero, 1
	ldc.i4.1
	stloc.1
// 0x01079a8c: 0x1079a8c: jal   0x106ac60 sw    zero, -13832(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x01079a94: 0x1079a94: sw    zero, -13848(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01079a98: 0x1079a98: lui   s0, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01079a9c: 0x1079a9c: lw    v0, -13828(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01079ab0: 0x1079ab0: jal   0x104fe2c addiu a0, a0, -1684
	...
	stloc 5
// --- basic block ---
// 0x01079ab8: 0x1079ab8: sw    zero, -13828(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01079abc: 0x1079abc: lui   s0, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01079ac0: 0x1079ac0: lw    v0, -13828(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01079ad4: 0x1079ad4: jal   0x104fe2c addiu a0, a0, -1684
	...
	stloc 5
// --- basic block ---
// 0x01079adc: 0x1079adc: sw    zero, -13828(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01079b40: 0x1079b40: sw    s1, 24(sp)
	...
	ldloc 9
	stelem.i4
// 0x01079b44: 0x1079b44: jal   0x1094108 sw    s0, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01079b4c: 0x1079b4c: beq   v0, zero, 0x1079bdc lui   s0, 0x80000
	...
	brfalse L_1079bdc
// --- basic block ---
// 0x01079b54: 0x1079b54: jal   0x1094138 sll   zero, zero, 0
...
// 0x01079ba0: 0x1079ba0: lui   s1, 0x80000
	ldc.i4 524288
	stloc 9
// 0x01079ba4: 0x1079ba4: jal   0x10086dc addiu a0, s1, -13820
	ldloc 9
	ldc.i4 -13820
	add
	stloc.1
...
// 0x01079bac: 0x1079bac: jal   0x101ed08 addiu a0, s3, -31028
	...
	stloc 5
// --- basic block ---
// 0x01079bb4: 0x1079bb4: addiu v0, s1, -13820
	ldloc 9
	ldc.i4 -13820
	add
	stloc 5
...
// 0x01079bbc: 0x1079bbc: sw    s0, 4(v0)
	...
	ldloc 7
	stelem.i4
// 0x01079bc0: 0x1079bc0: sw    s0, -13820(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
	...
	stelem.i4
L_1079bc4:
// 0x01079bc4: 0x1079bc4: jal   0x1094cdc addiu a0, zero, 2
	ldc.i4.2
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_1079bdc:
// 0x01079bdc: 0x1079bdc: lw    v0, -13828(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01079bf0: 0x1079bf0: jal   0x104fe2c addiu a0, a0, -1684
	...
	stloc 5
// --- basic block ---
// 0x01079bf8: 0x1079bf8: sw    zero, -13828(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01079c10: 0x1079c10: lw    s0, 20(sp)
	...
	ldelem.i4
	stloc 7
// 0x01079c14: 0x1079c14: sw    zero, -13856(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01079cb8: 0x1079cb8: lui   s0, 0x0
	ldc.i4.s 0
	stloc 8
// 0x01079cbc: 0x1079cbc: jal   0x1094c0c sw    v0, 16(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01079d24: 0x1079d24: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01079d28: 0x1079d28: lw    v0, -13832(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01079d48: 0x1079d48: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01079d4c: 0x1079d4c: sw    zero, -13832(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01079da0: 0x1079da0: lui   v1, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01079da4: 0x1079da4: addiu v1, v1, -15868
	ldloc 5
	ldc.i4 -15868
	add
	stloc 5
...
// 0x01079e0c: 0x1079e0c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01079e10: 0x1079e10: lw    a0, -13844(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01079e88: 0x1079e88: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01079e8c: 0x1079e8c: addiu v0, v0, -15868
	ldloc 5
	ldc.i4 -15868
	add
	stloc 5
...
// 0x01079ed8: 0x1079ed8: addiu a0, s3, -26280
	...
	add
	stloc.1
// 0x01079edc: 0x1079edc: jal   0x1096078 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01079ef0: 0x1079ef0: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01079ef4: 0x1079ef4: addiu a1, a1, 29384
	ldloc.2
	ldc.i4 29384
	add
	stloc.2
...
// 0x01079f14: 0x1079f14: addiu a1, s6, 18656
	...
	add
	stloc.2
// 0x01079f18: 0x1079f18: jal   0x1095b80 addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01079f60: 0x1079f60: addiu v0, zero, 10
	ldc.i4.s 10
	stloc 5
// 0x01079f64: 0x1079f64: jal   0x1093b9c sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01079f74: 0x1079f74: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x01079f78: 0x1079f78: jal   0x109916c addu  s2, v0, zero
	ldloc 5
	stloc 8
	ldloc.1
	ldloc.2
...
// 0x01079fc8: 0x1079fc8: addu  a0, s2, zero
	ldloc 8
	stloc.1
// 0x01079fcc: 0x1079fcc: jal   0x1099050 sw    v0, 56(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01079fd8: 0x1079fd8: addu  a1, s4, zero
	ldloc 11
	stloc.2
// 0x01079fdc: 0x1079fdc: jal   0x1099338 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01079fe4: 0x1079fe4: addu  a0, s2, zero
	ldloc 8
	stloc.1
// 0x01079fe8: 0x1079fe8: jal   0x1099338 addu  a1, s4, zero
	ldloc 11
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01079ff0: 0x1079ff0: addu  a1, s2, zero
	ldloc 8
	stloc.2
// 0x01079ff4: 0x1079ff4: jal   0x1099050 addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x0107a024: 0x107a024: addiu v0, zero, 4233
	ldc.i4 4233
	stloc 5
// 0x0107a028: 0x107a028: jal   0x1093b9c sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0107a03c: 0x107a03c: addiu a2, zero, 17
	ldc.i4.s 17
	stloc.3
// 0x0107a040: 0x107a040: jal   0x109e11c addu  s2, v0, zero
	ldloc 5
	stloc 8
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl118::ssd_bitmap_image_new_109e11c(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x0107a054: 0x107a054: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x0107a058: 0x107a058: jal   0x1099110 sw    v0, -16064(s4)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x0107a060: 0x107a060: lw    a1, -16064(s4)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x0107a064: 0x107a064: jal   0x1099050 addu  a0, s2, zero
	ldloc 8
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x0107a06c: 0x107a06c: addu  a0, s0, zero
	ldloc 9
	stloc.1
// 0x0107a070: 0x107a070: jal   0x1099050 addu  a1, s2, zero
	ldloc 8
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0107a078: 0x107a078: addiu a0, s3, -26280
	...
	add
	stloc.1
// 0x0107a07c: 0x107a07c: jal   0x1096078 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0107a084: 0x107a084: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0107a088: 0x107a088: lw    a0, -16064(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0107a08c: 0x107a08c: jal   0x109e0c8 addu  a1, s1, zero
	ldloc 10
	stloc.2
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl118::ssd_bitmap_image_update_109e0c8(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
// 0x0107a094: 0x107a094: jal   0x10949b4 sw    s1, 164(s0)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0107a13c: 0x107a13c: jal   0x1094178 sll   zero, zero, 0
	call int32 Cibyl110::ssd_dialog_get_current_data_1094178()
	stloc 5
// --- basic block ---
...
// 0x0107a150: 0x107a150: addiu a0, a0, -26280
	...
	add
	stloc.1
// 0x0107a154: 0x107a154: jal   0x10949fc addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0107a528: 0x107a528: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0107a52c: 0x107a52c: addiu v0, v0, -15868
	ldloc 5
	ldc.i4 -15868
	add
	stloc 5
...
// 0x0107a5b8: 0x107a5b8: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x0107a5bc: 0x107a5bc: addiu v0, v0, -15868
	ldloc 5
	ldc.i4 -15868
	add
	stloc 5
...
// 0x0107a604: 0x107a604: sll   v1, v1, 2
	...
	shl
	stloc 6
// 0x0107a608: 0x107a608: addiu a0, a0, 28988
	ldloc.1
	ldc.i4 28988
	add
	stloc.1
...
// 0x0107a650: 0x107a650: addiu a1, a1, -25900
	...
	stloc.2
L_107a654:
// 0x0107a654: 0x107a654: jal   0x1001b68 addiu a0, s0, -16060
	ldloc 7
	ldc.i4 -16060
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x0107a65c: 0x107a65c: j	 0x107a6d8 addiu v0, s0, -16060
	ldloc 7
	ldc.i4 -16060
	add
	stloc 5
