...
// 0x01079578: 0x1079578: addu  a0, s1, zero
	ldloc 8
	stloc.1
// 0x0107957c: 0x107957c: addiu a2, a2, 15912
	ldloc.3
	ldc.i4 15912
	add
	stloc.3
...
// 0x01079b1c: 0x1079b1c: lui   s0, 0x0
	ldc.i4.s 0
	stloc 11
// 0x01079b20: 0x1079b20: addiu a0, s0, 15932
	ldloc 11
	ldc.i4 15932
	add
	stloc.1
...
// 0x01079b30: 0x1079b30: addu  a2, s3, zero
	ldloc 13
	stloc.3
// 0x01079b34: 0x1079b34: addiu a0, s0, 15932
	ldloc 11
	ldc.i4 15932
	add
	stloc.1
...
// 0x01079b44: 0x1079b44: xori  a2, s1, 1
	...
	xor
	stloc.3
// 0x01079b48: 0x1079b48: addiu a0, s0, 15932
	ldloc 11
	ldc.i4 15932
	add
	stloc.1
...
// 0x01079b60: 0x1079b60: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x01079b64: 0x1079b64: jal   0x109c40c addiu a0, s0, 15932
	ldloc 11
	ldc.i4 15932
	add
	stloc.1
...
// 0x01079b84: 0x1079b84: sw    v0, 20(sp)
	...
	ldloc 5
	stelem.i4
// 0x01079b88: 0x1079b88: addiu a2, s0, 15932
	ldloc 11
	ldc.i4 15932
	add
	stloc.3
...
// 0x01079dd0: 0x1079dd0: lui   s2, 0x0
	ldc.i4.s 0
	stloc 10
// 0x01079dd4: 0x1079dd4: lw    a1, 15948(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01079e24: 0x1079e24: addiu v0, s1, -13756
	...
	add
	stloc 5
// 0x01079e28: 0x1079e28: sw    s0, 15948(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01079f68: 0x1079f68: lui   s2, 0x0
	ldc.i4.s 0
	stloc 10
// 0x01079f6c: 0x1079f6c: lw    a1, 15948(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01079fa8: 0x1079fa8: addiu v0, s1, -13756
	...
	add
	stloc 5
// 0x01079fac: 0x1079fac: sw    s0, 15948(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0107a0b0: 0x107a0b0: jal   0x1094994 sw    v0, 16(sp)
	...
	stloc 5
// --- basic block ---
// 0x0107a0b8: 0x107a0b8: lw    a0, 15868(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0107a0e8: 0x107a0e8: lw    v0, 16(sp)
	...
	ldelem.i4
	stloc 5
// 0x0107a0ec: 0x107a0ec: sw    v1, 15868(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
