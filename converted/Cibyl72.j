...
// 0x010615e8: 0x10615e8: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x010615ec: 0x10615ec: addiu a0, a0, 14872
	ldloc.1
	ldc.i4 14872
	add
	stloc.1
...
// 0x01061614: 0x1061614: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01061618: 0x1061618: addiu a0, a0, 14744
	ldloc.1
	ldc.i4 14744
	add
	stloc.1
...
// 0x01061684: 0x1061684: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01061688: 0x1061688: addiu a0, a0, 14840
	ldloc.1
	ldc.i4 14840
	add
	stloc.1
...
// 0x010616b0: 0x10616b0: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x010616b4: 0x10616b4: addiu a0, a0, 14856
	ldloc.1
	ldc.i4 14856
	add
	stloc.1
...
// 0x010616ec: 0x10616ec: jal   0x100e814 addiu a0, s0, 14824
	ldloc 7
	ldc.i4 14824
	add
	stloc.1
...
// 0x010616fc: 0x10616fc: lui   a1, 0x10000
	ldc.i4 65536
	stloc.2
// 0x01061700: 0x1061700: addiu a0, s0, 14824
	ldloc 7
	ldc.i4 14824
	add
	stloc.1
...
// 0x01061730: 0x1061730: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01061734: 0x1061734: addiu a0, a0, 14808
	ldloc.1
	ldc.i4 14808
	add
	stloc.1
...
// 0x0106175c: 0x106175c: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01061760: 0x1061760: addiu a0, a0, 14792
	ldloc.1
	ldc.i4 14792
	add
	stloc.1
...
// 0x01061788: 0x1061788: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x0106178c: 0x106178c: addiu a0, a0, 14776
	ldloc.1
	ldc.i4 14776
	add
	stloc.1
...
// 0x010617b4: 0x10617b4: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x010617b8: 0x10617b8: addiu a0, a0, 14760
	ldloc.1
	ldc.i4 14760
	add
	stloc.1
...
// 0x010617f0: 0x10617f0: addiu a0, s1, -26772
	...
	add
	stloc.1
// 0x010617f4: 0x10617f4: addiu a1, a1, 14744
	ldloc.2
	ldc.i4 14744
	add
	stloc.2
...
// 0x01061834: 0x1061834: addiu a3, s2, 9300
	...
	add
	stloc 4
// 0x01061838: 0x1061838: addiu a1, a1, 14776
	ldloc.2
	ldc.i4 14776
	add
	stloc.2
...
// 0x01061854: 0x1061854: addiu a3, s2, 9300
	...
	add
	stloc 4
// 0x01061858: 0x1061858: addiu a1, a1, 14792
	ldloc.2
	ldc.i4 14792
	add
	stloc.2
...
// 0x01061874: 0x1061874: addiu a3, s2, 9300
	...
	add
	stloc 4
// 0x01061878: 0x1061878: addiu a1, a1, 14808
	ldloc.2
	ldc.i4 14808
	add
	stloc.2
...
// 0x01061898: 0x1061898: addiu a3, s2, 9300
	...
	add
	stloc 4
// 0x0106189c: 0x106189c: addiu a1, a1, 14760
	ldloc.2
	ldc.i4 14760
	add
	stloc.2
...
// 0x010618c8: 0x10618c8: addiu a0, s1, -26772
	...
	add
	stloc.1
// 0x010618cc: 0x10618cc: addiu a1, a1, 14824
	ldloc.2
	ldc.i4 14824
	add
	stloc.2
...
// 0x010618f0: 0x10618f0: addiu a3, s2, 9300
	...
	add
	stloc 4
// 0x010618f4: 0x10618f4: addiu a1, a1, 14888
	ldloc.2
	ldc.i4 14888
	add
	stloc.2
...
// 0x01061910: 0x1061910: addiu a3, s2, 9300
	...
	add
	stloc 4
// 0x01061914: 0x1061914: addiu a1, a1, 14872
	ldloc.2
	ldc.i4 14872
	add
	stloc.2
...
// 0x01061934: 0x1061934: addu  a3, s0, zero
	ldloc 7
	stloc 4
// 0x01061938: 0x1061938: addiu a1, a1, 14840
	ldloc.2
	ldc.i4 14840
	add
	stloc.2
...
// 0x01061954: 0x1061954: addu  a3, s2, zero
	ldloc 8
	stloc 4
// 0x01061958: 0x1061958: addiu a1, a1, 14904
	ldloc.2
	ldc.i4 14904
	add
	stloc.2
...
// 0x01061974: 0x1061974: addu  a3, s0, zero
	ldloc 7
	stloc 4
// 0x01061978: 0x1061978: addiu a1, a1, 14856
	ldloc.2
	ldc.i4 14856
	add
	stloc.2
...
// 0x010619f0: 0x10619f0: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010619f4: 0x10619f4: addiu a0, a0, 14744
	ldloc.1
	ldc.i4 14744
	add
	stloc.1
...
// 0x01061a04: 0x1061a04: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x01061a08: 0x1061a08: addiu a0, a0, 14888
	ldloc.1
	ldc.i4 14888
	add
	stloc.1
...
// 0x01061a24: 0x1061a24: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01061a28: 0x1061a28: addiu a0, a0, 14792
	ldloc.1
	ldc.i4 14792
	add
	stloc.1
...
// 0x01061a38: 0x1061a38: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x01061a3c: 0x1061a3c: addiu a0, a0, 14904
	ldloc.1
	ldc.i4 14904
	add
	stloc.1
...
// 0x01061a58: 0x1061a58: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01061a5c: 0x1061a5c: addiu a0, a0, 14808
	ldloc.1
	ldc.i4 14808
	add
	stloc.1
...
// 0x01061a6c: 0x1061a6c: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x01061a70: 0x1061a70: addiu a0, a0, 14872
	ldloc.1
	ldc.i4 14872
	add
	stloc.1
...
// 0x01061a90: 0x1061a90: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01061a94: 0x1061a94: addiu a0, a0, 14856
	ldloc.1
	ldc.i4 14856
	add
	stloc.1
...
// 0x01061ab0: 0x1061ab0: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01061ab4: 0x1061ab4: jal   0x100e5e0 addiu a0, a0, 14776
	ldloc.1
	ldc.i4 14776
	add
	stloc.1
...
// 0x01061acc: 0x1061acc: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01061ad0: 0x1061ad0: jal   0x100e5e0 addiu a0, a0, 14760
	ldloc.1
	ldc.i4 14760
	add
	stloc.1
...
// 0x01061ae4: 0x1061ae4: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01061ae8: 0x1061ae8: addiu a0, a0, 14824
	ldloc.1
	ldc.i4 14824
	add
	stloc.1
