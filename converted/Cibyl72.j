...
// 0x01060ccc: 0x1060ccc: addiu sp, sp, -96
	...
	add
	stloc.0
// 0x01060cd0: 0x1060cd0: lw    v1, 12640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01060d44: 0x1060d44: sll   v1, s2, 2
	...
	shl
	stloc 7
// 0x01060d48: 0x1060d48: addiu v0, v0, 12676
	ldloc 5
	ldc.i4 12676
	add
	stloc 5
...
// 0x01060d68: 0x1060d68: sll   v1, s2, 2
	...
	shl
	stloc 7
// 0x01060d6c: 0x1060d6c: addiu v0, v0, 12676
	ldloc 5
	ldc.i4 12676
	add
	stloc 5
...
// 0x01060d8c: 0x1060d8c: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01060d90: 0x1060d90: lw    a0, 12640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01060d98: 0x1060d98: addiu a0, a0, 1
	...
	add
	stloc.1
// 0x01060d9c: 0x1060d9c: sw    a0, 12640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01060da8: 0x1060da8: sll   a0, a0, 2
	...
	shl
	stloc.1
// 0x01060dac: 0x1060dac: addiu v0, v0, 12676
	ldloc 5
	ldc.i4 12676
	add
	stloc 5
...
// 0x01060dd0: 0x1060dd0: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01060dd4: 0x1060dd4: bne   v1, zero, 0x1061100 sw    s0, 12676(v0)
	ldloc 7
	ldloc 6
	ldloc 5
	ldc.i4.2
...
// --- basic block ---
L_1060e1c:
// 0x01060e1c: 0x1060e1c: lw    v1, 31372(s5)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x01060e9c: 0x1060e9c: ori   s5, s5, 18929
	...
	or
	stloc 13
// 0x01060ea0: 0x1060ea0: addiu s3, s3, 12676
	ldloc 10
	ldc.i4 12676
	add
	stloc 10
...
// --- basic block ---
L_1060ec0:
// 0x01060ec0: 0x1060ec0: jal   0x1060a94 sw    v1, 12640(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x01060ec8: 0x1060ec8: lw    v0, 12640(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01060edc: 0x1060edc: jal   0x1000930 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x01060ee4: 0x1060ee4: lw    v0, 12640(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01060ef4: 0x1060ef4: sw    zero, 0(v0)
	...
	stelem.i4
L_1060ef8:
// 0x01060ef8: 0x1060ef8: lw    v0, 12976(s4)
	ldloc 6
	ldloc 20
	ldc.i4.2
	shr.un
...
// 0x01060f18: 0x1060f18: bne   v0, zero, 0x1060f38 sll   zero, zero, 0
	...
	brtrue L_1060f38
// --- basic block ---
// 0x01060f20: 0x1060f20: lw    v0, 12640(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01060f64: 0x1060f64: lw    a1, 20(s0)
	...
	ldelem.i4
	stloc.2
// 0x01060f68: 0x1060f68: lw    a0, 12976(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01060f70: 0x1060f70: addu  a0, a1, a0
	...
	add
	stloc.1
// 0x01060f74: 0x1060f74: sw    a0, 12976(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01060fa8: 0x1060fa8: lui   t5, 0x20000
	...
	stloc 11
L_1060fac:
// 0x01060fac: 0x1060fac: lw    v0, 31372(t5)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01061250: 0x1061250: lui   v1, 0x70000
	ldc.i4 458752
	stloc 7
// 0x01061254: 0x1061254: lw    v0, 12644(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0106125c: 0x106125c: bne   v0, zero, 0x1061284 sll   zero, zero, 0
	...
	brtrue L_1061284
// --- basic block ---
// 0x01061264: 0x1061264: addiu v1, v1, 12644
	ldloc 7
	ldc.i4 12644
	add
	stloc 7
...
// 0x010613f0: 0x10613f0: beq   v0, zero, 0x106141c lui   v1, 0x70000
	...
	brfalse L_106141c
// --- basic block ---
// 0x010613f8: 0x10613f8: addiu v1, v1, 12644
	ldloc 7
	ldc.i4 12644
	add
	stloc 7
...
// 0x010614ac: 0x10614ac: lui   v0, 0x70000
	ldc.i4 458752
	stloc.0
// 0x010614b0: 0x10614b0: jr    ra sw    v1, 12980(v0)
	ldloc 3
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01061568: 0x1061568: jal   0x100e814 addiu a1, a1, 9628
	ldloc.2
	ldc.i4 9628
	add
	stloc.2
...
// 0x01061708: 0x1061708: addiu a0, s1, -26732
	...
	add
	stloc.1
// 0x0106170c: 0x106170c: addiu a3, s2, 9628
	ldloc 8
	ldc.i4 9628
	add
	stloc 4
...
// 0x01061728: 0x1061728: addiu a0, s1, -26732
	...
	add
	stloc.1
// 0x0106172c: 0x106172c: addiu a3, s2, 9628
	ldloc 8
	ldc.i4 9628
	add
	stloc 4
...
// 0x01061748: 0x1061748: addiu a0, s1, -26732
	...
	add
	stloc.1
// 0x0106174c: 0x106174c: addiu a3, s2, 9628
	ldloc 8
	ldc.i4 9628
	add
	stloc 4
...
// 0x0106176c: 0x106176c: addiu a0, s3, 12716
	...
	add
	stloc.1
// 0x01061770: 0x1061770: addiu a3, s2, 9628
	ldloc 8
	ldc.i4 9628
	add
	stloc 4
...
// 0x010617c4: 0x10617c4: addiu a0, s3, 12716
	...
	add
	stloc.1
// 0x010617c8: 0x10617c8: addiu a3, s2, 9628
	ldloc 8
	ldc.i4 9628
	add
	stloc 4
...
// 0x010617e4: 0x10617e4: addiu a0, s3, 12716
	...
	add
	stloc.1
// 0x010617e8: 0x10617e8: addiu a3, s2, 9628
	ldloc 8
	ldc.i4 9628
	add
	stloc 4
...
// 0x01061800: 0x1061800: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x01061804: 0x1061804: addiu s2, s2, 9628
	ldloc 8
	ldc.i4 9628
	add
	stloc 8
...
// 0x010618c0: 0x10618c0: jal   0x10948e4 addiu a0, a0, -11024
	ldloc.1
	ldc.i4 -11024
	add
	stloc.1
...
// 0x010618ec: 0x10618ec: beq   v0, zero, 0x106190c lui   a0, 0x10000
	...
	brfalse L_106190c
// --- basic block ---
// 0x010618f4: 0x10618f4: jal   0x10948e4 addiu a0, a0, 13068
	ldloc.1
	ldc.i4 13068
	add
	stloc.1
...
// 0x01061920: 0x1061920: beq   v0, zero, 0x1061940 lui   a0, 0x10000
	...
	brfalse L_1061940
// --- basic block ---
// 0x01061928: 0x1061928: jal   0x10948e4 addiu a0, a0, 13080
	ldloc.1
	ldc.i4 13080
	add
	stloc.1
...
// 0x0106195c: 0x106195c: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x01061960: 0x1061960: jal   0x10948e4 addiu a0, a0, 13100
	ldloc.1
	ldc.i4 13100
	add
	stloc.1
...
// 0x01061978: 0x1061978: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x0106197c: 0x106197c: jal   0x10948e4 addiu a0, a0, 13124
	ldloc.1
	ldc.i4 13124
	add
	stloc.1
...
// 0x01061994: 0x1061994: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x01061998: 0x1061998: jal   0x10948e4 addiu a0, a0, 13136
	ldloc.1
	ldc.i4 13136
	add
	stloc.1
...
// 0x010619b0: 0x10619b0: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x010619b4: 0x10619b4: jal   0x10948e4 addiu a0, a0, 13148
	ldloc.1
	ldc.i4 13148
	add
	stloc.1
...
// 0x010619e4: 0x10619e4: jal   0x10618b4 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x010619ec: 0x10619ec: jal   0x1094bcc addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01061b84: 0x1061b84: addu  a1, s4, zero
	ldloc 12
	stloc.2
// 0x01061b88: 0x1061b88: jal   0x10830ec addu  a2, s1, zero
	ldloc 10
	stloc.3
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl98::RTTrafficInfo_Get_Avg_Cross_Time_10830ec(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x01061b9c: 0x1061b9c: beq   s1, zero, 0x1061bc0 sll   v1, s0, 3
	...
	brfalse L_1061bc0
// --- basic block ---
// 0x01061ba4: 0x1061ba4: lw    a1, 31376(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01061bac: 0x1061bac: addu  v1, a1, v1
	...
	add
	stloc 7
// 0x01061bb0: 0x1061bb0: lw    a0, 31452(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1061bc0:
// 0x01061bc0: 0x1061bc0: lw    a1, 31376(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01061bc4: 0x1061bc4: lw    a0, 31452(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01061c4c: 0x1061c4c: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01061c50: 0x1061c50: lw    v1, 31452(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01061cdc: 0x1061cdc: addu  a1, s2, zero
	...
	stloc.2
L_1061ce0:
// 0x01061ce0: 0x1061ce0: jal   0x1082c04 addu  a2, s5, zero
	ldloc 13
	stloc.3
	ldloc.1
	ldloc.2
...
// 0x01061d08: 0x1061d08: mflo  lo
	ldloc 18
	stloc.1
// 0x01061d0c: 0x1061d0c: jal   0x10c0da0 sll   zero, zero, 0
	ldloc.0
	ldloc.1
...
// 0x01061d18: 0x1061d18: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01061d1c: 0x1061d1c: addiu v0, v0, 23912
	ldloc 5
	ldc.i4 23912
	add
	stloc 5
...
// 0x01061d24: 0x1061d24: lw    a2, 0(v0)
	...
	ldelem.i4
	stloc.3
// 0x01061d28: 0x1061d28: jal   0x10c0b78 addu  a1, v1, zero
	ldloc 7
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01061d38: 0x1061d38: sw    a2, 96(sp)
	...
	ldloc.3
	stelem.i4
// 0x01061d3c: 0x1061d3c: jal   0x10c0da0 sw    v1, 100(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01061d54: 0x1061d54: addu  a2, v0, zero
	ldloc 5
	stloc.3
// 0x01061d58: 0x1061d58: jal   0x10c0bd0 addu  a3, v1, zero
	ldloc 7
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x01061d60: 0x1061d60: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x01061d64: 0x1061d64: jal   0x10c0cb0 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01061dc0: 0x1061dc0: bne   a1, zero, 0x1061df8 lui   v0, 0x70000
	...
	brtrue L_1061df8
// --- basic block ---
// 0x01061dc8: 0x1061dc8: lw    a2, 12980(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
