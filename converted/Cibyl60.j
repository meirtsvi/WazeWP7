...
// 0x01050c00: 0x1050c00: lui   s0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01050c04: 0x1050c04: addiu a1, s0, -1524
	ldloc 5
	ldc.i4 -1524
	add
	stloc.2
...
// 0x01050c0c: 0x1050c0c: jal   0x1000e78 addiu a0, a0, 4724
	...
	stloc 8
// --- basic block ---
// 0x01050c14: 0x1050c14: jal   0x1055440 addiu a0, s0, -1524
	ldloc 5
	ldc.i4 -1524
	add
	stloc.1
...
// 0x01050cc0: 0x1050cc0: lui   v0, 0x70000
	ldc.i4 458752
	stloc 6
// 0x01050cc4: 0x1050cc4: lw    v1, -1528(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01050d14: 0x1050d14: lui   v0, 0x70000
	ldc.i4 458752
	stloc 6
// 0x01050d18: 0x1050d18: sw    v1, -2740(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01050d28: 0x1050d28: lui   a0, 0x70000
	ldc.i4 458752
	stloc.1
// 0x01050d2c: 0x1050d2c: addiu v1, v1, -1816
	ldloc 5
	ldc.i4 -1816
	add
	stloc 5
// 0x01050d30: 0x1050d30: addiu a0, a0, -1528
	ldloc.1
	ldc.i4 -1528
	add
	stloc.1
...
// 0x01050dd8: 0x1050dd8: bne   a1, zero, 0x1050f90 addiu v0, zero, 1
	...
	brtrue L_1050f90
// --- basic block ---
// 0x01050de0: 0x1050de0: jal   0x1094108 sll   zero, zero, 0
...
// --- basic block ---
L_1050edc:
// 0x01050edc: 0x1050edc: jal   0x1094158 sll   zero, zero, 0
...
// 0x01050ef0: 0x1050ef0: addiu a1, a1, -2528
	...
	add
	stloc.2
// 0x01050ef4: 0x1050ef4: jal   0x109b7ac addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01050f38: 0x1050f38: lui   s0, 0xf0000
	ldc.i4 983040
	stloc 8
// 0x01050f3c: 0x1050f3c: lb    v1, -29904(s0)
	ldloc 8
	ldc.i4 -29904
	add
...
// 0x01050f44: 0x1050f44: beq   v1, zero, 0x1050f90 addu  v0, zero, zero
	...
	brfalse L_1050f90
// --- basic block ---
// 0x01050f4c: 0x1050f4c: addiu s0, s0, -29904
	ldloc 8
	ldc.i4 -29904
	add
	stloc 8
...
// 0x01051044: 0x1051044: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01051048: 0x1051048: lw    v1, -3752(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01051064: 0x1051064: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01051068: 0x1051068: j	 0x10510f4 sw    zero, -2712(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01051080: 0x1051080: lw    a0, 8(a0)
	...
	ldelem.i4
	stloc.1
// 0x01051084: 0x1051084: addiu v0, v0, -2640
	ldloc 5
	ldc.i4 -2640
	add
	stloc 5
...
// 0x010510b0: 0x10510b0: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x010510b4: 0x10510b4: addiu v0, v0, -2712
	ldloc 5
	ldc.i4 -2712
	add
	stloc 5
...
// 0x01051130: 0x1051130: lui   v1, 0x70000
	ldc.i4 458752
	stloc 6
// 0x01051134: 0x1051134: lw    v0, -3752(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01051150: 0x1051150: addiu a0, a0, 5004
	...
	add
	stloc.1
// 0x01051154: 0x1051154: jal   0x101cd80 sw    s0, -3752(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01051184: 0x1051184: lui   s0, 0x70000
	...
	stloc 8
L_1051188:
// 0x01051188: 0x1051188: addiu s3, s0, -2712
	ldloc 8
	ldc.i4 -2712
	add
	stloc 9
...
// 0x010511a4: 0x10511a4: sw    s2, 52(s3)
	...
	ldloc 11
	stelem.i4
// 0x010511a8: 0x10511a8: sw    v1, -2712(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
	...
	ldloc 6
	stelem.i4
// 0x010511ac: 0x10511ac: lw    a0, -3752(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010511d4: 0x10511d4: bne   v0, v1, 0x10512a0 lui   v0, 0x70000
	...
	bne.un L_10512a0
// --- basic block ---
// 0x010511dc: 0x10511dc: addiu v0, v0, -2648
	ldloc 5
	ldc.i4 -2648
	add
	stloc 5
...
// 0x01051200: 0x1051200: lui   s3, 0x70000
	ldc.i4 458752
	stloc 9
// 0x01051204: 0x1051204: addiu s3, s3, -2712
	ldloc 9
	ldc.i4 -2712
	add
	stloc 9
...
// 0x0105122c: 0x105122c: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01051230: 0x1051230: lw    a1, -2732(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01051238: 0x1051238: addiu a1, a1, 1
	...
	add
	stloc.2
// 0x0105123c: 0x105123c: sw    a1, -2732(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010512f8: 0x10512f8: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x010512fc: 0x10512fc: lw    v1, -2724(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01051304: 0x1051304: beq   v1, a0, 0x1051314 sw    ra, 20(sp)
	...
	beq  L_1051314
// --- basic block ---
// 0x0105130c: 0x105130c: jal   0x1021920 sw    a0, -2724(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0105136c: 0x105136c: bne   v0, zero, 0x1051430 lui   s1, 0x70000
	...
	brtrue L_1051430
// --- basic block ---
// 0x01051374: 0x1051374: lw    s5, -1528(s1)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010513b4: 0x10513b4: lw    a0, 4(s2)
	...
	ldelem.i4
	stloc.1
// 0x010513b8: 0x10513b8: lw    s1, -1528(s1)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010513f4: 0x10513f4: lui   v0, 0x70000
	...
	stloc 5
L_10513f8:
// 0x010513f8: 0x10513f8: addiu v0, v0, -524
	ldloc 5
	ldc.i4 -524
	add
	stloc 5
...
// --- basic block ---
L_1051430:
// 0x01051430: 0x1051430: lw    s0, -1528(s1)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01051450: 0x1051450: lw    a0, 4(s2)
	...
	ldelem.i4
	stloc.1
// 0x01051454: 0x1051454: lw    s0, -1528(s1)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01051484: 0x1051484: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01051488: 0x1051488: addiu v0, v0, -524
	ldloc 5
	ldc.i4 -524
	add
	stloc 5
...
// 0x0105149c: 0x105149c: beq   v0, zero, 0x10514e0 lui   v0, 0x70000
	...
	brfalse L_10514e0
// --- basic block ---
// 0x010514a4: 0x10514a4: lw    v0, -2728(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010514ac: 0x10514ac: beq   v0, zero, 0x10514e0 lui   v0, 0x70000
	...
	brfalse L_10514e0
// --- basic block ---
// 0x010514b4: 0x10514b4: lw    a0, -1528(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010514d4: 0x10514d4: lui   v1, 0x70000
	ldc.i4 458752
	stloc 6
// 0x010514d8: 0x10514d8: jalr  v0 sw    v0, -3748(v1)
	ldloc 5
	ldloc 7
	ldloc 6
	ldc.i4.2
...
// 0x01051534: 0x1051534: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01051538: 0x1051538: lw    v1, -1528(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01051578: 0x1051578: addu  s3, a0, zero
	ldloc.1
	stloc 10
// 0x0105157c: 0x105157c: addiu s1, s1, -520
	ldloc 6
	ldc.i4 -520
	add
	stloc 6
...
// 0x010515f4: 0x10515f4: lui   v0, 0x70000
	ldc.i4 458752
	stloc 7
// 0x010515f8: 0x10515f8: lw    v1, -1528(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01051618: 0x1051618: lui   s1, 0x70000
	ldc.i4 458752
	stloc 6
// 0x0105161c: 0x105161c: addiu s1, s1, -524
	ldloc 6
	ldc.i4 -524
	add
	stloc 6
...
// 0x0105168c: 0x105168c: addu  s2, a2, zero
	ldloc.3
	stloc 11
// 0x01051690: 0x1051690: addiu s4, s4, -180
	ldloc 8
	ldc.i4 -180
	add
	stloc 8
...
// 0x010516b4: 0x10516b4: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x010516b8: 0x10516b8: addiu v0, v0, -188
	ldloc 5
	ldc.i4 -188
	add
	stloc 5
...
// 0x010516f8: 0x10516f8: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x010516fc: 0x10516fc: addiu v0, v0, -188
	ldloc 5
	ldc.i4 -188
	add
	stloc 5
...
// 0x01051734: 0x1051734: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01051738: 0x1051738: j	 0x10517f0 sw    zero, -2728(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01051740: 0x1051740: lui   s4, 0x70000
	...
	stloc 8
L_1051744:
// 0x01051744: 0x1051744: addiu s4, s4, -524
	ldloc 8
	ldc.i4 -524
	add
	stloc 8
...
// 0x0105174c: 0x105174c: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01051750: 0x1051750: sw    v1, -2728(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01051848: 0x1051848: jal   0x10ac82c addiu a0, zero, 1
	ldc.i4.1
	stloc.1
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl129::editor_main_set_10ac82c(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 8
	stloc 7
// --- basic block ---
...
// 0x01051860: 0x1051860: lui   v1, 0x70000
	ldc.i4 458752
	stloc 6
// 0x01051864: 0x1051864: lw    v0, 52(v1)
	ldloc 8
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0105188c: 0x105188c: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x01051890: 0x1051890: beq   a0, v0, 0x10518bc sw    a0, 52(v1)
	ldloc.1
	ldloc 5
	ldloc 8
	ldloc 6
...
// 0x01051974: 0x1051974: bne   v0, zero, 0x1051984 lui   v1, 0x20000
	...
	brtrue L_1051984
// --- basic block ---
// 0x0105197c: 0x105197c: j	 0x10519dc addiu v1, v1, 22164
	ldloc 6
	ldc.i4 22164
	add
	stloc 6
...
// 0x010519d4: 0x10519d4: lui   v1, 0x20000
	...
	stloc 6
L_10519d8:
// 0x010519d8: 0x10519d8: addiu v1, v1, 20308
	ldloc 6
	ldc.i4 20308
	add
	stloc 6
...
// 0x01051a28: 0x1051a28: lui   v0, 0x70000
	ldc.i4 458752
	stloc.1
// 0x01051a2c: 0x1051a2c: lw    v1, 60(v0)
	ldloc 4
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01051a4c: 0x1051a4c: lui   v0, 0x70000
	ldc.i4 458752
	stloc.2
// 0x01051a50: 0x1051a50: lw    v1, 60(v0)
	ldloc 5
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01051ac0: 0x1051ac0: lui   v0, 0x70000
	ldc.i4 458752
	stloc.0
// 0x01051ac4: 0x1051ac4: jr    ra sw    v1, 60(v0)
	ldloc 3
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01051b28: 0x1051b28: lui   v0, 0x70000
	ldc.i4 458752
	stloc 6
// 0x01051b2c: 0x1051b2c: lw    v1, 60(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01051b60: 0x1051b60: lui   a1, 0x70000
	ldc.i4 458752
	stloc.2
// 0x01051b64: 0x1051b64: lw    v0, 56(a1)
	ldloc 7
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01051b74: 0x1051b74: lui   a0, 0x70000
	ldc.i4 458752
	stloc.1
// 0x01051b78: 0x1051b78: lw    v1, 60(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01051b8c: 0x1051b8c: addu  v1, v0, zero
	ldloc 5
	stloc 6
// 0x01051b90: 0x1051b90: sw    v1, 56(a1)
	ldloc 7
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01051b94: 0x1051b94: lui   a1, 0x10000
	ldc.i4 65536
	stloc.2
// 0x01051b98: 0x1051b98: lw    a0, 60(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01051bb4: 0x1051bb4: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01051bb8: 0x1051bb8: lw    a0, 56(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01051be4: 0x1051be4: lui   v0, 0x70000
	ldc.i4 458752
	stloc.1
// 0x01051be8: 0x1051be8: jr    ra sw    a0, 64(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
