...
// 0x01097ab8: 0x1097ab8: jal   0x10962d0 sw    a0, 9940(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01097b4c: 0x1097b4c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01097b50: 0x1097b50: lw    v0, 9940(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01097b80: 0x1097b80: lui   v0, 0x80000
	...
	stloc 5
L_1097b84:
// 0x01097b84: 0x1097b84: lw    v0, 9940(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01097bbc: 0x1097bbc: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01097bc0: 0x1097bc0: lw    v0, 9940(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01097bdc: 0x1097bdc: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01097be0: 0x1097be0: jal   0x1021920 sw    v1, 9940(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01098344: 0x1098344: addu  s6, v0, s6
	...
	add
	stloc 15
// 0x01098348: 0x1098348: jal   0x10c0afc sw    s6, 8(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01098350: 0x1098350: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01098354: 0x1098354: lw    a1, 23840(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01098358: 0x1098358: jal   0x10c0820 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x01098360: 0x1098360: addu  a0, s5, zero
	ldloc 10
	stloc.1
// 0x01098364: 0x1098364: jal   0x10c0afc addu  s0, v0, zero
	ldloc 5
	stloc 9
	ldloc.1
	conv.r4
...
// 0x0109836c: 0x109836c: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01098370: 0x1098370: lw    a1, 23844(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01098374: 0x1098374: jal   0x10c08d0 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x0109837c: 0x109837c: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01098380: 0x1098380: jal   0x10c0820 addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.1
	ldloc.2
	...
	stloc 5
// --- basic block ---
// 0x01098388: 0x1098388: jal   0x10c0a0c addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
...
// 0x010986f0: 0x10986f0: addu  a0, a0, v1
	...
	add
	stloc.1
// 0x010986f4: 0x10986f4: jal   0x10c0afc addu  a0, a0, v0
	ldloc.1
	ldloc 5
	add
	stloc.1
...
// 0x01098700: 0x1098700: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01098704: 0x1098704: addiu v0, v0, 23844
	ldloc 5
	ldc.i4 23844
	add
	stloc 5
// 0x01098708: 0x1098708: lw    a1, 0(v0)
	...
	ldelem.i4
	stloc.2
// 0x0109870c: 0x109870c: jal   0x10c08d0 sll   zero, zero, 0
	ldloc.1
	ldloc.2
	call int32 Cibyl143::__mulsf3_10c08d0(int32,int32)
	stloc 5
// --- basic block ---
// 0x01098714: 0x1098714: jal   0x10c0a0c addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	call float32 [WazeWP7]CRunTime::intBitsToFloat(int32)
...
// --- basic block ---
L_10989f0:
// 0x010989f0: 0x10989f0: jal   0x10c0b10 addu  a0, s2, zero
	ldloc 10
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010989f8: 0x10989f8: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x010989fc: 0x10989fc: lw    a3, 23924(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01098a00: 0x1098a00: lw    a2, 23920(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01098a04: 0x1098a04: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x01098a08: 0x1098a08: jal   0x10c0838 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01098a10: 0x1098a10: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01098a14: 0x1098a14: lw    a3, 23876(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01098a18: 0x1098a18: lw    a2, 23872(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01098a1c: 0x1098a1c: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x01098a20: 0x1098a20: jal   0x10c08e8 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01098a28: 0x1098a28: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x01098a2c: 0x1098a2c: jal   0x10c0a20 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01098a3c: 0x1098a3c: beq   v0, zero, 0x1098a74 sll   zero, zero, 0
	...
	brfalse L_1098a74
// --- basic block ---
// 0x01098a44: 0x1098a44: jal   0x10c0b10 addu  a0, s4, zero
	ldloc 12
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01098a4c: 0x1098a4c: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01098a50: 0x1098a50: lw    a3, 23964(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01098a54: 0x1098a54: lw    a2, 23960(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01098a58: 0x1098a58: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x01098a5c: 0x1098a5c: jal   0x10c08e8 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01098a64: 0x1098a64: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01098a68: 0x1098a68: jal   0x10c0a20 addu  a1, v1, zero
	ldloc 7
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01098a70: 0x1098a70: addu  s4, v0, zero
	...
	stloc 12
L_1098a74:
// 0x01098a74: 0x1098a74: jal   0x10c0b10 subu  a0, s2, s4
	ldloc 10
	ldloc 12
	sub
	stloc.1
...
// 0x01098a7c: 0x1098a7c: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01098a80: 0x1098a80: lw    a3, 23924(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01098a84: 0x1098a84: lw    a2, 23920(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01098a88: 0x1098a88: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x01098a8c: 0x1098a8c: jal   0x10c0838 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01098a94: 0x1098a94: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01098a98: 0x1098a98: lw    a3, 23876(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01098a9c: 0x1098a9c: lw    a2, 23872(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01098aa0: 0x1098aa0: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x01098aa4: 0x1098aa4: jal   0x10c08e8 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01098aac: 0x1098aac: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x01098ab0: 0x1098ab0: jal   0x10c0a20 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01098af4: 0x1098af4: bne   v0, zero, 0x1098b10 lui   v0, 0x80000
	...
	brtrue L_1098b10
// --- basic block ---
// 0x01098afc: 0x1098afc: lw    v0, 9956(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01098b5c: 0x1098b5c: addiu v0, v0, -2
	...
	add
	stloc 5
// 0x01098b60: 0x1098b60: lw    a0, 9968(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01098b7c: 0x1098b7c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01098b80: 0x1098b80: lw    v0, 29780(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01098c10: 0x1098c10: lw    a0, 28(v1)
	...
	ldelem.i4
	stloc.1
// 0x01098c14: 0x1098c14: lw    v0, 9960(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01098c34: 0x1098c34: beq   v0, zero, 0x1098c4c lui   v0, 0x80000
	...
	brfalse L_1098c4c
// --- basic block ---
// 0x01098c3c: 0x1098c3c: lw    v0, 9956(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
