...
// 0x010962d0: 0x10962d0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010962d4: 0x10962d4: lw    v1, 9804(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109630c: 0x109630c: sw    s0, 16(sp)
	...
	ldloc 7
	stelem.i4
// 0x01096310: 0x1096310: lw    s0, 9804(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010963c0: 0x10963c0: sw    s0, 16(sp)
	...
	ldloc 7
	stelem.i4
// 0x010963c4: 0x10963c4: lw    s0, 9804(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01096418: 0x1096418: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109641c: 0x109641c: lw    v1, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01096474: 0x1096474: addiu a0, a0, -1
	...
	add
	stloc.1
// 0x01096478: 0x1096478: lw    v0, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01096490: 0x1096490: sll   a0, a0, 2
	...
	shl
	stloc.1
// 0x01096494: 0x1096494: addiu a1, a1, 29752
	ldloc.2
	ldc.i4 29752
	add
	stloc.2
...
// 0x01096fec: 0x1096fec: addu  s1, v0, zero
	ldloc 6
	stloc 8
// 0x01096ff0: 0x1096ff0: addiu s3, s3, 25080
	ldloc 9
	ldc.i4 25080
	add
	stloc 9
...
// 0x010971d0: 0x10971d0: beq   a0, zero, 0x109728c lui   v0, 0xf0000
	...
	brfalse L_109728c
// --- basic block ---
// 0x010971d8: 0x10971d8: lw    v0, -29912(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 5
// 0x010971dc: 0x10971dc: lw    s2, -29908(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_109728c:
// 0x0109728c: 0x109728c: lw    v0, -29912(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 5
// 0x01097290: 0x1097290: lw    a2, -29908(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010973dc: 0x10973dc: addu  a0, s2, zero
	ldloc 9
	stloc.1
// 0x010973e0: 0x10973e0: jal   0x1001b14 addiu a1, a1, 25080
	ldloc.2
	ldc.i4 25080
	add
	stloc.2
