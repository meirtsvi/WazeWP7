...
// 0x0100dbb0: 0x100dbb0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0100dbb4: 0x100dbb4: lw    v0, -30940(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100dbd4: 0x100dbd4: lui   s1, 0x30000
	ldc.i4 196608
	stloc 10
// 0x0100dbd8: 0x100dbd8: lw    a0, -30936(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0100dbe0: 0x100dbe0: jal   0x101552c lui   s2, 0x30000
	...
	stloc 5
// --- basic block ---
// 0x0100dbe8: 0x100dbe8: j	 0x100dc18 addiu s2, s2, -30932
	ldloc 9
	ldc.i4 -30932
	add
	stloc 9
...
// 0x0100dc04: 0x100dc04: beq   v1, s0, 0x100dc40 addiu v0, v0, 4
	...
	beq  L_100dc40
// --- basic block ---
// 0x0100dc0c: 0x100dc0c: lw    a0, -30936(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0100dc58: 0x100dc58: lui   v1, 0x30000
	ldc.i4 196608
	stloc 4
// 0x0100dc5c: 0x100dc5c: addiu v1, v1, -30864
	ldloc 4
	ldc.i4 -30864
	add
	stloc 4
...
// 0x0100dc98: 0x100dc98: lui   v1, 0x30000
	ldc.i4 196608
	stloc 4
// 0x0100dc9c: 0x100dc9c: addiu v1, v1, -30864
	ldloc 4
	ldc.i4 -30864
	add
	stloc 4
...
// 0x0100dcd4: 0x100dcd4: jal   0x104ff3c addiu a0, a0, -8856
	ldloc.1
	ldc.i4 -8856
	add
	stloc.1
...
// 0x0100dcf8: 0x100dcf8: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x0100dcfc: 0x100dcfc: addiu a0, a0, 12676
	ldloc.1
	ldc.i4 12676
	add
	stloc.1
...
// 0x0100dd18: 0x100dd18: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0100dd1c: 0x100dd1c: addiu v0, v0, -30864
	ldloc 5
	ldc.i4 -30864
	add
	stloc 5
// 0x0100dd20: 0x100dd20: addiu v1, v1, -30644
	ldloc 6
	ldc.i4 -30644
	add
	stloc 6
...
// 0x0100dd4c: 0x100dd4c: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x0100dd50: 0x100dd50: jal   0x10500d4 addiu a1, a1, -8856
	ldloc.2
	ldc.i4 -8856
	add
	stloc.2
...
// 0x0100dda4: 0x100dda4: sw    s1, 148(sp)
	...
	ldloc 7
	stelem.i4
// 0x0100dda8: 0x100dda8: jal   0x100177c addiu s7, s7, -30864
	ldloc 11
	ldc.i4 -30864
	add
	stloc 11
...
// 0x0100ddc0: 0x100ddc0: addiu s6, zero, 44
	...
	stloc 15
L_100ddc4:
// 0x0100ddc4: 0x100ddc4: lw    s1, -30868(s8)
	ldloc 5
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x0100de40: 0x100de40: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0100de44: 0x100de44: j	 0x100de5c sw    s1, -30868(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100de5c: 0x100de5c: beq   s2, zero, 0x100de7c sll   zero, zero, 0
	...
	brfalse L_100de7c
// --- basic block ---
// 0x0100de64: 0x100de64: jal   0x1021434 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100de6c: 0x100de6c: bne   v0, zero, 0x100de7c sll   zero, zero, 0
	...
	brtrue L_100de7c
// --- basic block ---
// 0x0100de74: 0x100de74: jal   0x10218c8 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100deac: 0x100deac: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0100deb0: 0x100deb0: lw    v1, -30864(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100debc: 0x100debc: beq   v1, zero, 0x100df0c addu  a2, zero, zero
	...
	brfalse L_100df0c
// --- basic block ---
// 0x0100dec4: 0x100dec4: addiu v0, v0, -30864
	ldloc 6
	ldc.i4 -30864
	add
	stloc 6
...
// 0x0100df14: 0x100df14: lui   v1, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0100df18: 0x100df18: addiu v1, v1, -30864
	ldloc 5
	ldc.i4 -30864
	add
	stloc 5
...
// 0x0100e0e8: 0x100e0e8: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0100e0ec: 0x100e0ec: lw    v0, -30644(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100e0f8: 0x100e0f8: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0100e0fc: 0x100e0fc: lw    v0, -30644(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100e380: 0x100e380: lui   v0, 0x10000
	ldc.i4 65536
	stloc 5
// 0x0100e384: 0x100e384: j	 0x100e3a0 addiu v0, v0, 18616
	ldloc 5
	ldc.i4 18616
	add
	stloc 5
...
// 0x0100e538: 0x100e538: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x0100e53c: 0x100e53c: addiu a0, a0, 18364
	ldloc.1
	ldc.i4 18364
	add
	stloc.1
...
// 0x0100e59c: 0x100e59c: lui   a1, 0x10000
	ldc.i4 65536
	stloc.2
// 0x0100e5a0: 0x100e5a0: addiu a1, a1, 9992
	ldloc.2
	ldc.i4 9992
	add
	stloc.2
...
// 0x0100e644: 0x100e644: sw    s1, 40(sp)
	...
	ldloc 7
	stelem.i4
// 0x0100e648: 0x100e648: addiu a1, a1, -14064
	ldloc.2
	ldc.i4 -14064
	add
	stloc.2
...
// 0x0100e688: 0x100e688: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x0100e68c: 0x100e68c: addiu a0, a0, 18364
	ldloc.1
	ldc.i4 18364
	add
	stloc.1
...
// --- basic block ---
L_100e888:
// 0x0100e888: 0x100e888: jal   0x104c6d8 addiu s0, sp, 16
	ldloc.0
	ldc.i4.s 16
	add
	stloc 8
...
// 0x0100e8b0: 0x100e8b0: addu  a1, s0, zero
	ldloc 8
	stloc.2
// 0x0100e8b4: 0x100e8b4: jal   0x104dc0c addiu a2, a2, 15592
	ldloc.3
	ldc.i4 15592
	add
	stloc.3
...
// 0x0100ecc0: 0x100ecc0: lui   v0, 0x10000
	ldc.i4 65536
	stloc 6
// 0x0100ecc4: 0x100ecc4: addiu v0, v0, 18616
	ldloc 6
	ldc.i4 18616
	add
	stloc 6
