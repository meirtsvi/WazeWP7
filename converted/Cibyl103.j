...
// 0x01089b0c: 0x1089b0c: sw    s3, 52(sp)
	...
	ldloc 11
	stelem.i4
// 0x01089b10: 0x1089b10: sw    zero, -30056(s0)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01089b84: 0x1089b84: addu  a0, v0, zero
	ldloc 6
	stloc.1
// 0x01089b88: 0x1089b88: addiu a1, a1, -30052
	ldloc.2
	ldc.i4 -30052
	add
	stloc.2
...
// 0x01089b94: 0x1089b94: addu  a2, s3, zero
	ldloc 11
	stloc.3
// 0x01089b98: 0x1089b98: sw    v1, -30056(s0)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01089bc0: 0x1089bc0: lui   a0, 0xf0000
	...
	stloc.1
L_1089bc4:
// 0x01089bc4: 0x1089bc4: jal   0x108d254 addiu a0, a0, -30056
	ldloc.1
	ldc.i4 -30056
	add
	stloc.1
...
// 0x01089bfc: 0x1089bfc: addu  a0, v0, zero
	ldloc 6
	stloc.1
// 0x01089c00: 0x1089c00: addiu a1, a1, -30019
	ldloc.2
	ldc.i4 -30019
	add
	stloc.2
...
// 0x01089c1c: 0x1089c1c: bne   v0, zero, 0x1089c58 lui   s2, 0x20000
	...
	brtrue L_1089c58
// --- basic block ---
// 0x01089c24: 0x1089c24: addiu a0, s0, -30056
	ldloc 9
	ldc.i4 -30056
	add
	stloc.1
...
// --- basic block ---
L_1089c58:
// 0x01089c58: 0x1089c58: lw    v1, -30056(s0)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0108a3bc: 0x108a3bc: lw    a0, 28(sp)
	...
	ldelem.i4
	stloc.1
// 0x0108a3c0: 0x108a3c0: jal   0x10c0da0 sll   zero, zero, 0
	ldloc.0
	ldloc.1
...
// 0x0108a3c8: 0x108a3c8: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0108a3cc: 0x108a3cc: lw    a3, 23948(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x0108a3d0: 0x108a3d0: lw    a2, 23944(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0108a3d4: 0x108a3d4: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x0108a3d8: 0x108a3d8: jal   0x10c0b78 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
