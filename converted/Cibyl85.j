...
// 0x010723d4: 0x10723d4: jal   0x10b5908 addu  s0, a0, zero
	ldloc.1
	stloc 8
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl135::editor_line_committed_10b5908(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x010723f8: 0x10723f8: sw    v0, 20(sp)
	...
	ldloc 5
	stelem.i4
// 0x010723fc: 0x10723fc: jal   0x10b5e84 sw    zero, 16(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01072424: 0x1072424: addiu a3, sp, 36
	...
	add
	stloc 4
// 0x01072428: 0x1072428: jal   0x10b4a4c sw    zero, 16(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0107282c: 0x107282c: addu  s2, a1, zero
	ldloc.2
	stloc 11
// 0x01072830: 0x1072830: jal   0x10b5908 sw    v0, 72(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01072854: 0x1072854: addiu a3, sp, 32
	...
	add
	stloc 4
// 0x01072858: 0x1072858: jal   0x10b5e84 sw    v0, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01072888: 0x1072888: addiu a3, sp, 44
	...
	add
	stloc 4
// 0x0107288c: 0x107288c: jal   0x10b4a4c sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010728b8: 0x10728b8: addiu a1, sp, 64
	...
	add
	stloc.2
// 0x010728bc: 0x10728bc: jal   0x10b4afc addiu a2, sp, 68
	ldloc.0
	ldc.i4.s 68
	add
	stloc.3
...
// 0x010728c8: 0x10728c8: addiu a2, sp, 60
	...
	add
	stloc.3
// 0x010728cc: 0x10728cc: jal   0x10b5a78 addu  a0, s2, zero
	ldloc 11
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010728d4: 0x10728d4: lw    a0, 56(sp)
	...
	ldelem.i4
	stloc.1
// 0x010728d8: 0x10728d8: jal   0x10b47c4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl134::editor_point_db_id_10b47c4(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
// 0x010728e0: 0x10728e0: lw    a0, 60(sp)
	...
	ldelem.i4
	stloc.1
// 0x010728e4: 0x10728e4: jal   0x10b47c4 addu  s3, v0, zero
	ldloc 5
	stloc 10
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_10729b4:
// 0x010729b4: 0x10729b4: jal   0x10b4718 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010729bc: 0x10729bc: addu  a0, s1, zero
	ldloc 8
	stloc.1
// 0x010729c0: 0x10729c0: jal   0x10b469c addu  a1, s4, zero
	ldloc 12
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01072a0c: 0x1072a0c: bne   v0, zero, 0x1072abc addu  a0, s2, zero
	...
	brtrue L_1072abc
// --- basic block ---
// 0x01072a14: 0x1072a14: jal   0x10b5a1c addiu a1, sp, 72
	ldloc.0
	ldc.i4.s 72
	add
	stloc.2
...
// 0x01072a24: 0x1072a24: bltz  a0, 0x1072abc sll   zero, zero, 0
	...
	blt L_1072abc
// --- basic block ---
// 0x01072a2c: 0x1072a2c: jal   0x10b4d50 addiu s3, sp, 248
	ldloc.0
	ldc.i4 248
	add
	stloc 10
...
// 0x01072a44: 0x1072a44: lw    a0, 72(sp)
	...
	ldelem.i4
	stloc.1
// 0x01072a48: 0x1072a48: jal   0x10b4be8 addiu s2, sp, 764
	ldloc.0
	ldc.i4 764
	add
	stloc 11
...
// 0x01072a60: 0x1072a60: lw    a0, 72(sp)
	...
	ldelem.i4
	stloc.1
// 0x01072a64: 0x1072a64: jal   0x10b4c40 addiu s1, sp, 1280
	ldloc.0
	ldc.i4 1280
	add
	stloc 8
