...
// 0x01071da0: 0x1071da0: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x01071da4: 0x1071da4: jal   0x100edd0 addiu a1, a1, 18680
	ldloc.2
	ldc.i4 18680
	add
	stloc.2
...
// 0x01071db4: 0x1071db4: addiu a2, s2, 18616
	...
	add
	stloc.3
// 0x01071db8: 0x1071db8: jal   0x100ed90 addiu a1, a1, 18696
	ldloc.2
	ldc.i4 18696
	add
	stloc.2
...
// 0x01071dc8: 0x1071dc8: addiu a2, s2, 18616
	...
	add
	stloc.3
// 0x01071dcc: 0x1071dcc: addiu a1, a1, 18664
	ldloc.2
	ldc.i4 18664
	add
	stloc.2
...
// 0x01071df4: 0x1071df4: addiu a3, s5, 21112
	...
	add
	stloc 4
// 0x01071df8: 0x1071df8: addiu a1, a1, 15084
	ldloc.2
	ldc.i4 15084
	add
	stloc.2
...
// 0x01071e14: 0x1071e14: addiu a0, s1, 12676
	...
	add
	stloc.1
// 0x01071e18: 0x1071e18: addiu a1, a1, 15100
	ldloc.2
	ldc.i4 15100
	add
	stloc.2
...
// 0x01071e38: 0x1071e38: addiu a0, s1, 12676
	...
	add
	stloc.1
// 0x01071e3c: 0x1071e3c: addiu a1, a1, 15116
	ldloc.2
	ldc.i4 15116
	add
	stloc.2
...
// 0x01071e54: 0x1071e54: addiu a0, s1, 12676
	...
	add
	stloc.1
// 0x01071e58: 0x1071e58: addiu a1, a1, 15132
	ldloc.2
	ldc.i4 15132
	add
	stloc.2
...
// 0x01071e70: 0x1071e70: addiu a0, s1, 12676
	...
	add
	stloc.1
// 0x01071e74: 0x1071e74: addiu a1, a1, 15148
	ldloc.2
	ldc.i4 15148
	add
	stloc.2
...
// 0x01071e8c: 0x1071e8c: addiu a0, s1, 12676
	...
	add
	stloc.1
// 0x01071e90: 0x1071e90: addiu a1, a1, 15164
	ldloc.2
	ldc.i4 15164
	add
	stloc.2
...
// 0x01071ea8: 0x1071ea8: addiu a0, s1, 12676
	...
	add
	stloc.1
// 0x01071eac: 0x1071eac: addiu a1, a1, 15180
	ldloc.2
	ldc.i4 15180
	add
	stloc.2
...
// 0x01071ec4: 0x1071ec4: addiu a2, s2, 18616
	...
	add
	stloc.3
// 0x01071ec8: 0x1071ec8: addiu a1, a1, 15196
	ldloc.2
	ldc.i4 15196
	add
	stloc.2
...
// 0x01071ef4: 0x1071ef4: addiu a2, s1, -6856
	...
	add
	stloc.3
// 0x01071ef8: 0x1071ef8: addiu a1, a1, 14924
	ldloc.2
	ldc.i4 14924
	add
	stloc.2
...
// 0x01071f20: 0x1071f20: addiu a2, s1, -6856
	...
	add
	stloc.3
// 0x01071f24: 0x1071f24: addiu a1, a1, 14940
	ldloc.2
	ldc.i4 14940
	add
	stloc.2
...
// 0x01071f44: 0x1071f44: addiu a0, s0, -26772
	...
	add
	stloc.1
// 0x01071f48: 0x1071f48: addiu a1, a1, 15068
	ldloc.2
	ldc.i4 15068
	add
	stloc.2
...
// 0x01071f64: 0x1071f64: addiu a0, s5, 18364
	...
	add
	stloc.1
// 0x01071f68: 0x1071f68: addiu a1, a1, 15008
	ldloc.2
	ldc.i4 15008
	add
	stloc.2
...
// 0x01071f80: 0x1071f80: addiu a2, s2, 18616
	...
	add
	stloc.3
// 0x01071f84: 0x1071f84: addiu a1, a1, 15024
	ldloc.2
	ldc.i4 15024
	add
	stloc.2
...
// 0x01071f98: 0x1071f98: addiu a0, s0, -26772
	...
	add
	stloc.1
// 0x01071f9c: 0x1071f9c: addiu a1, a1, 14992
	ldloc.2
	ldc.i4 14992
	add
	stloc.2
...
// 0x01071fc4: 0x1071fc4: addiu a3, s5, 9300
	...
	add
	stloc 4
// 0x01071fc8: 0x1071fc8: addiu a1, a1, 14972
	ldloc.2
	ldc.i4 14972
	add
	stloc.2
...
// 0x01071fe0: 0x1071fe0: addiu a3, s5, 9300
	...
	add
	stloc 4
// 0x01071fe4: 0x1071fe4: addiu a1, a1, 14956
	ldloc.2
	ldc.i4 14956
	add
	stloc.2
...
// 0x01072150: 0x1072150: addiu a1, a1, 32236
	...
	add
	stloc.2
// 0x01072154: 0x1072154: addiu a2, a2, 15248
	ldloc.3
	ldc.i4 15248
	add
	stloc.3
...
// 0x010726d4: 0x10726d4: addiu v1, zero, 70
	ldc.i4.s 70
	stloc 6
// 0x010726d8: 0x10726d8: addiu a2, a2, 15600
	ldloc.3
	ldc.i4 15600
	add
	stloc.3
...
// 0x01072e0c: 0x1072e0c: addiu a1, a1, 808
	...
	add
	stloc.2
// 0x01072e10: 0x1072e10: addiu a2, a2, 15216
	ldloc.3
	ldc.i4 15216
	add
	stloc.3
