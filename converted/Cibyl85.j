...
// 0x010719f4: 0x10719f4: sw    s2, 36(sp)
	...
	ldloc 10
	stelem.i4
// 0x010719f8: 0x10719f8: lw    s0, 17796(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01071a50: 0x1071a50: lui   v0, 0x70000
	...
	stloc 5
L_1071a54:
// 0x01071a54: 0x1071a54: lw    v1, 17796(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01071a68: 0x1071a68: bne   s0, v0, 0x1071bb8 lui   v0, 0x70000
	...
	bne.un L_1071bb8
// --- basic block ---
// 0x01071a70: 0x1071a70: lw    v0, 17800(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1071aa0:
// 0x01071aa0: 0x1071aa0: sw    s0, 17796(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01071ac0: 0x1071ac0: jal   0x100449c addiu a2, zero, 3668
	...
	stloc 5
// --- basic block ---
// 0x01071ac8: 0x1071ac8: lw    v0, 17804(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01071aec: 0x1071aec: jal   0x106edf0 addu  a0, zero, zero
	...
	stloc 5
// --- basic block ---
// 0x01071af4: 0x1071af4: j	 0x1071bb8 sw    s3, 17804(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01071b0c: 0x1071b0c: jal   0x100449c addiu a2, zero, 3680
	...
	stloc 5
// --- basic block ---
// 0x01071b14: 0x1071b14: lw    v0, 17804(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01071b3c: 0x1071b3c: jal   0x1071924 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x01071b44: 0x1071b44: j	 0x1071bb8 sw    zero, 17804(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1071b4c:
// 0x01071b4c: 0x1071b4c: lw    v1, -18912(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01071b6c: 0x1071b6c: lui   a0, 0x70000
	ldc.i4 458752
	stloc.1
// 0x01071b70: 0x1071b70: lw    v0, -18864(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 5
// 0x01071b74: 0x1071b74: lw    a0, 17800(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01071be4: 0x1071be4: beq   v0, zero, 0x1071c0c lui   v1, 0x70000
	...
	brfalse L_1071c0c
// --- basic block ---
// 0x01071bec: 0x1071bec: lw    v0, 17772(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1071c0c:
// 0x01071c0c: 0x1071c0c: lw    v0, 17772(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01071c40: 0x1071c40: sw    s4, 48(sp)
	...
	ldloc 12
	stelem.i4
// 0x01071c44: 0x1071c44: lw    s4, 17764(s3)
	ldloc 7
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x01071ef0: 0x1071ef0: addiu a3, a3, -12116
	...
	add
	stloc 4
// 0x01071ef4: 0x1071ef4: jal   0x1085dd8 addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x01071efc: 0x1071efc: lui   a0, 0xf0000
	ldc.i4 983040
	stloc.1
// 0x01071f00: 0x1071f00: jal   0x108d254 addiu a0, a0, -30056
	ldloc.1
	ldc.i4 -30056
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x01071f08: 0x1071f08: jal   0x108d244 addiu a0, s0, -18864
	ldloc 8
	ldc.i4 -18864
	add
	stloc.1
...
// 0x01071f5c: 0x1071f5c: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x01071f60: 0x1071f60: jal   0x10400f8 sw    s4, -18864(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01071f68: 0x1071f68: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x01071f6c: 0x1071f6c: jal   0x1071bd4 sw    v0, 17764(s3)
	ldloc 7
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x01071fdc: 0x1071fdc: addu  t2, a0, zero
	ldloc.1
	stloc 7
// 0x01071fe0: 0x1071fe0: lw    a0, -18256(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01072060: 0x1072060: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01072064: 0x1072064: lw    a0, -18256(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01072088: 0x1072088: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x0107208c: 0x107208c: addiu v1, v1, 28948
	ldloc 6
	ldc.i4 28948
	add
	stloc 6
...
// --- basic block ---
L_10720e4:
// 0x010720e4: 0x10720e4: lw    a0, -18256(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0107210c: 0x107210c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01072110: 0x1072110: lw    a0, -18256(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01072138: 0x1072138: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0107213c: 0x107213c: lw    v1, -18256(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0107216c: 0x107216c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01072170: 0x1072170: lw    a0, -18256(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010723d4: 0x10723d4: jal   0x10b5b9c addu  s0, a0, zero
	ldloc.1
	stloc 8
	ldloc.0
	ldloc.1
...
// 0x010723f8: 0x10723f8: sw    v0, 20(sp)
	...
	ldloc 5
	stelem.i4
// 0x010723fc: 0x10723fc: jal   0x10b6118 sw    zero, 16(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01072424: 0x1072424: addiu a3, sp, 36
	...
	add
	stloc 4
// 0x01072428: 0x1072428: jal   0x10b4ce0 sw    zero, 16(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01072578: 0x1072578: lui   v0, 0x80000
	ldc.i4 524288
	stloc 7
// 0x0107257c: 0x107257c: lw    a0, -18256(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0107282c: 0x107282c: addu  s2, a1, zero
	ldloc.2
	stloc 11
// 0x01072830: 0x1072830: jal   0x10b5b9c sw    v0, 72(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01072854: 0x1072854: addiu a3, sp, 32
	...
	add
	stloc 4
// 0x01072858: 0x1072858: jal   0x10b6118 sw    v0, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01072888: 0x1072888: addiu a3, sp, 44
	...
	add
	stloc 4
// 0x0107288c: 0x107288c: jal   0x10b4ce0 sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010728b8: 0x10728b8: addiu a1, sp, 64
	...
	add
	stloc.2
// 0x010728bc: 0x10728bc: jal   0x10b4d90 addiu a2, sp, 68
	ldloc.0
	ldc.i4.s 68
	add
	stloc.3
...
// 0x010728c8: 0x10728c8: addiu a2, sp, 60
	...
	add
	stloc.3
// 0x010728cc: 0x10728cc: jal   0x10b5d0c addu  a0, s2, zero
	ldloc 11
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010728d4: 0x10728d4: lw    a0, 56(sp)
	...
	ldelem.i4
	stloc.1
// 0x010728d8: 0x10728d8: jal   0x10b4a58 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl134::editor_point_db_id_10b4a58(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
// 0x010728e0: 0x10728e0: lw    a0, 60(sp)
	...
	ldelem.i4
	stloc.1
// 0x010728e4: 0x10728e4: jal   0x10b4a58 addu  s3, v0, zero
	ldloc 5
	stloc 10
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_10729b4:
// 0x010729b4: 0x10729b4: jal   0x10b49ac sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010729bc: 0x10729bc: addu  a0, s1, zero
	ldloc 8
	stloc.1
// 0x010729c0: 0x10729c0: jal   0x10b4930 addu  a1, s4, zero
	ldloc 12
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01072a0c: 0x1072a0c: bne   v0, zero, 0x1072abc addu  a0, s2, zero
	...
	brtrue L_1072abc
// --- basic block ---
// 0x01072a14: 0x1072a14: jal   0x10b5cb0 addiu a1, sp, 72
	ldloc.0
	ldc.i4.s 72
	add
	stloc.2
...
// 0x01072a24: 0x1072a24: bltz  a0, 0x1072abc sll   zero, zero, 0
	...
	blt L_1072abc
// --- basic block ---
// 0x01072a2c: 0x1072a2c: jal   0x10b4fe4 addiu s3, sp, 248
	ldloc.0
	ldc.i4 248
	add
	stloc 10
...
// 0x01072a44: 0x1072a44: lw    a0, 72(sp)
	...
	ldelem.i4
	stloc.1
// 0x01072a48: 0x1072a48: jal   0x10b4e7c addiu s2, sp, 764
	ldloc.0
	ldc.i4 764
	add
	stloc 11
...
// 0x01072a60: 0x1072a60: lw    a0, 72(sp)
	...
	ldelem.i4
	stloc.1
// 0x01072a64: 0x1072a64: jal   0x10b4ed4 addiu s1, sp, 1280
	ldloc.0
	ldc.i4 1280
	add
	stloc 8
