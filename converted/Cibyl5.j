...
// 0x01007418: 0x1007418: lui   a2, 0x20000
	ldc.i4 131072
	stloc.3
// 0x0100741c: 0x100741c: addiu a1, a1, 31588
	ldloc.2
	ldc.i4 31588
	add
	stloc.2
// 0x01007420: 0x1007420: addiu a2, a2, 31584
	ldloc.3
	ldc.i4 31584
	add
	stloc.3
...
// 0x01007430: 0x1007430: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01007434: 0x1007434: lw    v1, 31584(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01007444: 0x1007444: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01007448: 0x1007448: lw    a1, 31588(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01007620: 0x1007620: lui   v1, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01007624: 0x1007624: lw    v0, 31580(v1)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.3
// 0x01007628: 0x1007628: jr    ra sw    a0, 31580(v1)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01007634: 0x1007634: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01007638: 0x1007638: lw    v0, 31580(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01007670: 0x1007670: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01007674: 0x1007674: lw    v0, 31580(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01007810: 0x1007810: beq   v0, zero, 0x1007824 lui   v0, 0x20000
	...
	brfalse L_1007824
// --- basic block ---
// 0x01007818: 0x1007818: lw    s0, 23968(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01007824: 0x1007824: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01007828: 0x1007828: lw    s0, 23972(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
	...
	stloc 8
L_100782c:
// 0x0100782c: 0x100782c: jal   0x10c0e4c addu  a0, s4, zero
	ldloc 10
	stloc.1
	ldloc.1
	conv.r4
...
// 0x01007838: 0x1007838: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100783c: 0x100783c: lw    a1, 23976(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01007840: 0x1007840: jal   0x10c0c20 addu  a0, s2, zero
	ldloc 11
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x01007848: 0x1007848: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x0100784c: 0x100784c: jal   0x10c0c20 addu  a1, s0, zero
	ldloc 8
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x01007854: 0x1007854: addu  a0, s1, zero
	ldloc 9
	stloc.1
// 0x01007858: 0x1007858: jal   0x10c0e4c addu  s0, v0, zero
	ldloc 5
	stloc 8
	ldloc.1
	conv.r4
...
// 0x01007860: 0x1007860: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01007864: 0x1007864: jal   0x10c0c78 addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x0100786c: 0x100786c: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01007870: 0x1007870: jal   0x10c0d14 addu  s0, v0, zero
	ldloc 5
	stloc 8
	ldloc.0
	ldloc.1
...
// 0x0100787c: 0x100787c: addu  s7, v1, zero
	ldloc 6
	stloc 14
// 0x01007880: 0x1007880: jal   0x10c0e60 addu  s6, v0, zero
	ldloc 5
	stloc 13
	ldloc.0
	ldloc.1
...
// 0x0100788c: 0x100788c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01007890: 0x1007890: lw    a1, 24100(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01007894: 0x1007894: lw    a0, 24096(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100789c: 0x100789c: addu  a2, s4, zero
	ldloc 10
	stloc.3
// 0x010078a0: 0x10078a0: jal   0x10c0c90 addu  s5, v1, zero
	ldloc 6
	stloc 15
	ldloc.0
	ldloc.1
...
// 0x010078b0: 0x10078b0: addu  a0, s6, zero
	ldloc 13
	stloc.1
// 0x010078b4: 0x10078b4: jal   0x10c1d2c addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x010078cc: 0x10078cc: addu  a3, s5, zero
	ldloc 15
	stloc 4
// 0x010078d0: 0x10078d0: jal   0x10c1d2c addu  a2, s4, zero
	ldloc 10
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x010078e0: 0x10078e0: addu  a1, s0, zero
	ldloc 8
	stloc.2
// 0x010078e4: 0x10078e4: jal   0x10c0bc8 addu  a0, s2, zero
	ldloc 11
	stloc.1
	ldloc.1
	ldloc.2
	call int32 Cibyl143::__subsf3_10c0bc8(int32,int32)
	stloc 5
// --- basic block ---
// 0x010078ec: 0x10078ec: jal   0x10c0d14 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01007908: 0x1007908: addiu a0, zero, 2000
	...
	stloc.1
L_100790c:
// 0x0100790c: 0x100790c: jal   0x10c0e60 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	call int32 Cibyl143::__floatsidf_10c0e60(int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
...
// 0x01007914: 0x1007914: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01007918: 0x1007918: lw    a3, 24108(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x0100791c: 0x100791c: lw    a2, 24104(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01007920: 0x1007920: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x01007924: 0x1007924: jal   0x10c0c38 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01007930: 0x1007930: addu  s7, v1, zero
	ldloc 6
	stloc 14
// 0x01007934: 0x1007934: jal   0x10c0e60 addu  s6, v0, zero
	ldloc 5
	stloc 13
	ldloc.0
	ldloc.1
...
// 0x01007944: 0x1007944: addu  a0, s6, zero
	ldloc 13
	stloc.1
// 0x01007948: 0x1007948: jal   0x10c0c90 addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01007958: 0x1007958: addu  a1, s5, zero
	ldloc 15
	stloc.2
// 0x0100795c: 0x100795c: jal   0x10c0c38 addu  a0, s4, zero
	ldloc 10
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01007964: 0x1007964: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x01007968: 0x1007968: jal   0x10c0d38 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01007970: 0x1007970: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01007974: 0x1007974: jal   0x10c0b70 addu  a1, s0, zero
	ldloc 8
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x01007980: 0x1007980: addu  a1, s2, zero
	ldloc 11
	stloc.2
// 0x01007984: 0x1007984: jal   0x10c1f70 addu  s0, v0, zero
	ldloc 5
	stloc 8
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl144::__lesf2_10c1f70(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x01007998: 0x1007998: bne   v0, zero, 0x10079b8 addiu a0, s3, -1
	...
	brtrue L_10079b8
// --- basic block ---
// 0x010079a0: 0x10079a0: jal   0x10c0e4c sll   a0, a0, 1
	ldloc.1
	ldc.i4.1
	shl
	stloc.1
...
// 0x010079a8: 0x10079a8: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x010079ac: 0x10079ac: jal   0x10c0bc8 addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x010079b8: 0x10079b8: beq   s8, zero, 0x10079d8 lui   v0, 0x20000
	...
	brfalse L_10079d8
// --- basic block ---
// 0x010079c0: 0x10079c0: lw    a1, 23980(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x010079c4: 0x10079c4: jal   0x10c1fc0 addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl144::__ltsf2_10c1fc0(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
// 0x010079cc: 0x10079cc: bgez  v0, 0x10079d8 lui   v0, 0x20000
	...
	bge L_10079d8
// --- basic block ---
// 0x010079d4: 0x10079d4: lw    s0, 23984(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
	...
	stloc 8
L_10079d8:
// 0x010079d8: 0x10079d8: jal   0x10c0d5c addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.1
...
// 0x01007dbc: 0x1007dbc: jal   0x10c0e4c sll   zero, zero, 0
	ldloc.1
	conv.r4
	call int32 [WazeWP7]CRunTime::floatToIntBits(float32)
	stloc 5
...
// 0x01007dd0: 0x1007dd0: lw    a1, 28(v1)
	...
	ldelem.i4
	stloc.2
// 0x01007dd4: 0x1007dd4: jal   0x10c0c78 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	ldloc.2
	...
	stloc 5
// --- basic block ---
// 0x01007ddc: 0x1007ddc: jal   0x10c0d5c addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	call float32 [WazeWP7]CRunTime::intBitsToFloat(int32)
...
// 0x01007e54: 0x1007e54: jal   0x10c0e4c sll   zero, zero, 0
	ldloc.1
	conv.r4
	call int32 [WazeWP7]CRunTime::floatToIntBits(float32)
	stloc 5
...
// 0x01007e68: 0x1007e68: lw    a1, 12(v1)
	...
	ldelem.i4
	stloc.2
// 0x01007e6c: 0x1007e6c: jal   0x10c0c20 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	ldloc.2
	...
	stloc 5
// --- basic block ---
// 0x01007e74: 0x1007e74: jal   0x10c0d5c addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	call float32 [WazeWP7]CRunTime::intBitsToFloat(int32)
...
// 0x01007ea0: 0x1007ea0: jal   0x10c0c20 sll   zero, zero, 0
	ldloc.1
	ldloc.2
	call int32 Cibyl143::__mulsf3_10c0c20(int32,int32)
	stloc 5
...
// 0x01007ec0: 0x1007ec0: lui   s0, 0x20000
	ldc.i4 131072
	stloc 8
// 0x01007ec4: 0x1007ec4: lw    v0, 31568(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01007ed0: 0x1007ed0: beq   a0, v0, 0x1007f0c addu  s1, a0, zero
	...
	beq  L_1007f0c
// --- basic block ---
// 0x01007ed8: 0x1007ed8: jal   0x10c0e4c sll   zero, zero, 0
	ldloc.1
	conv.r4
	call int32 [WazeWP7]CRunTime::floatToIntBits(float32)
	stloc 5
...
// 0x01007eec: 0x1007eec: lw    a1, 20(v1)
	...
	ldelem.i4
	stloc.2
// 0x01007ef0: 0x1007ef0: jal   0x10c0c78 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	ldloc.2
	...
	stloc 5
// --- basic block ---
// 0x01007ef8: 0x1007ef8: jal   0x10c0d5c addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	call float32 [WazeWP7]CRunTime::intBitsToFloat(int32)
...
// 0x01007f00: 0x1007f00: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01007f04: 0x1007f04: sw    v0, 31564(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldloc 5
	stelem.i4
// 0x01007f08: 0x1007f08: sw    s1, 31568(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01007f10: 0x1007f10: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01007f14: 0x1007f14: lw    v0, 31564(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01008550: 0x1008550: jal   0x1006c08 sw    v1, 16(s0)
	...
	stloc 5
// --- basic block ---
// 0x01008558: 0x1008558: lw    a1, 23988(s1)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01008560: 0x1008560: lw    s2, 20(sp)
	...
	ldelem.i4
	stloc 9
// 0x01008564: 0x1008564: jal   0x10c0c20 sll   zero, zero, 0
	ldloc.1
	ldloc.2
	call int32 Cibyl143::__mulsf3_10c0c20(int32,int32)
	stloc 5
...
// 0x0100856c: 0x100856c: addu  a0, s2, zero
	ldloc 9
	stloc.1
// 0x01008570: 0x1008570: jal   0x10c0e4c addu  s4, v0, zero
	ldloc 5
	stloc 13
	ldloc.1
	conv.r4
...
// 0x01008578: 0x1008578: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x0100857c: 0x100857c: jal   0x10c0c20 addu  a0, s4, zero
	ldloc 13
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x01008598: 0x1008598: addiu s2, s2, 432
	...
	add
	stloc 9
// 0x0100859c: 0x100859c: lw    a1, 23988(s1)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010085a4: 0x10085a4: lw    s1, 20(sp)
	...
	ldelem.i4
	stloc 11
// 0x010085a8: 0x10085a8: jal   0x10c0c20 sll   zero, zero, 0
	ldloc.1
	ldloc.2
	call int32 Cibyl143::__mulsf3_10c0c20(int32,int32)
	stloc 5
...
// 0x010085b0: 0x10085b0: addu  a0, s1, zero
	ldloc 11
	stloc.1
// 0x010085b4: 0x10085b4: jal   0x10c0e4c addu  s3, v0, zero
	ldloc 5
	stloc 12
	ldloc.1
	conv.r4
...
// 0x010085bc: 0x10085bc: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x010085c0: 0x10085c0: jal   0x10c0c20 addu  a0, s3, zero
	ldloc 12
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x010085d8: 0x10085d8: mflo  lo
	ldloc 10
	stloc.1
// 0x010085dc: 0x10085dc: jal   0x10c0e60 sw    v0, 8(s2)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010085e4: 0x10085e4: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x010085e8: 0x10085e8: lw    a3, 24076(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x010085ec: 0x10085ec: lw    a2, 24072(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010085f0: 0x10085f0: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x010085f4: 0x10085f4: jal   0x10c0b88 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010085fc: 0x10085fc: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x01008600: 0x1008600: jal   0x10c0d70 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
