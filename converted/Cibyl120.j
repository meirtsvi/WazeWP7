...
// 0x010a06f4: 0x10a06f4: beq   a0, zero, 0x10a0710 lui   v0, 0x80000
	...
	stloc.1
	brfalse L_10a0710
// 0x010a06fc: 0x10a06fc: sw    zero, 10232(v0)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010a0708: 0x10a0708: lui   v0, 0x80000
	ldc.i4 524288
	stloc.1
// 0x010a070c: 0x10a070c: sw    zero, 10240(v0)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010a072c: 0x10a072c: lui   v0, 0x80000
	ldc.i4 524288
	stloc.0
// 0x010a0730: 0x10a0730: jr    ra addiu v0, v0, 10260
	ldloc.0
	ldc.i4 10260
	add
	stloc.0
...
// 0x010a0738: 0x10a0738: lui   v0, 0x80000
	ldc.i4 524288
	stloc.0
// 0x010a073c: 0x10a073c: jr    ra addiu v0, v0, 11260
	ldloc.0
	ldc.i4 11260
	add
	stloc.0
...
// 0x010a0744: 0x10a0744: lui   v0, 0x80000
	ldc.i4 524288
	stloc.0
// 0x010a0748: 0x10a0748: jr    ra addiu v0, v0, 14260
	ldloc.0
	ldc.i4 14260
	add
	stloc.0
...
// 0x010a0784: 0x10a0784: lui   v0, 0x80000
	ldc.i4 524288
	stloc 6
// 0x010a0788: 0x10a0788: sw    zero, 10232(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a0794: 0x10a0794: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010a0798: 0x10a0798: lw    a0, 10236(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a08f4: 0x10a08f4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010a08f8: 0x10a08f8: lw    v0, 29896(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a0908: 0x10a0908: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x010a090c: 0x10a090c: lw    s0, -30068(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a0e68: 0x10a0e68: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x010a0e6c: 0x10a0e6c: lw    a2, -30068(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a1120: 0x10a1120: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010a1124: 0x10a1124: sw    s0, 10236(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a1128: 0x10a1128: lui   v0, 0x80000
	...
	stloc 5
L_10a112c:
// 0x010a112c: 0x10a112c: lw    v0, 10240(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a1144: 0x10a1144: addiu v0, v0, 32140
	...
	add
	stloc 5
// 0x010a1148: 0x10a1148: sw    v0, 10252(s0)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010a1158: 0x10a1158: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010a115c: 0x10a115c: addiu s2, s0, 10252
	ldloc 11
	ldc.i4 10252
	add
	stloc 15
// 0x010a1160: 0x10a1160: lw    s3, 10236(s1)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010a1184: 0x10a1184: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010a1188: 0x10a1188: lw    s3, 10236(s1)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010a11a8: 0x10a11a8: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010a11ac: 0x10a11ac: lw    s1, 10236(s1)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010a11d4: 0x10a11d4: beq   v0, zero, 0x10a11e8 lui   v0, 0x80000
	...
	brfalse L_10a11e8
// --- basic block ---
// 0x010a11dc: 0x10a11dc: lw    a2, 10252(s0)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010a11ec: 0x10a11ec: lui   a1, 0x20000
	...
	stloc.2
L_10a11f0:
// 0x010a11f0: 0x10a11f0: lw    a0, 10236(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a1200: 0x10a1200: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010a1204: 0x10a1204: jal   0x109497c sw    v1, 10240(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a13c8: 0x10a13c8: addiu a0, zero, 10
	ldc.i4.s 10
	stloc.1
// 0x010a13cc: 0x10a13cc: jal   0x104ffc4 sw    zero, 10240(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a14b0: 0x10a14b0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 6
// 0x010a14b4: 0x10a14b4: lw    v1, 10248(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a1524: 0x10a1524: lui   v0, 0x80000
	ldc.i4 524288
	stloc 6
// 0x010a1528: 0x10a1528: sw    v1, 10248(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a1548: 0x10a1548: jal   0x10a96c0 addiu a0, a0, 10260
	ldloc.1
	ldc.i4 10260
	add
	stloc.1
...
// 0x010a1558: 0x10a1558: lui   a1, 0x80000
	ldc.i4 524288
	stloc.2
// 0x010a155c: 0x10a155c: addiu a0, a0, 11260
	ldloc.1
	ldc.i4 11260
	add
	stloc.1
// 0x010a1560: 0x10a1560: jal   0x10a979c addiu a1, a1, 12260
	ldloc.2
	ldc.i4 12260
	add
	stloc.2
...
// 0x010a1568: 0x10a1568: beq   v0, zero, 0x10a1580 lui   a0, 0x80000
	...
	brfalse L_10a1580
// --- basic block ---
// 0x010a1570: 0x10a1570: jal   0x10a9740 addiu a0, a0, 13260
	ldloc.1
	ldc.i4 13260
	add
	stloc.1
...
// 0x010a159c: 0x10a159c: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x010a15a0: 0x10a15a0: addiu a0, a0, 15260
	ldloc.1
	ldc.i4 15260
	add
	stloc.1
...
// 0x010a15cc: 0x10a15cc: addiu a0, a0, 18684
	...
	add
	stloc.1
// 0x010a15d0: 0x10a15d0: jal   0x100e5e0 addiu a1, a1, 14260
	ldloc.2
	ldc.i4 14260
	add
	stloc.2
...
// 0x010a15e0: 0x10a15e0: lui   a2, 0x80000
	ldc.i4 524288
	stloc.3
// 0x010a15e4: 0x10a15e4: addiu a0, a0, 10260
	ldloc.1
	ldc.i4 10260
	add
	stloc.1
// 0x010a15e8: 0x10a15e8: addiu a1, a1, 11260
	ldloc.2
	ldc.i4 11260
	add
	stloc.2
// 0x010a15ec: 0x10a15ec: addiu a2, a2, 13260
	ldloc.3
	ldc.i4 13260
	add
	stloc.3
...
// 0x010a15f8: 0x10a15f8: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010a15fc: 0x10a15fc: sw    zero, 10248(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a1654: 0x10a1654: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x010a1658: 0x10a1658: addiu a0, a0, 15260
	ldloc.1
	ldc.i4 15260
	add
	stloc.1
...
// 0x010a1684: 0x10a1684: addiu a0, a0, 18684
	...
	add
	stloc.1
// 0x010a1688: 0x10a1688: jal   0x100e5e0 addiu a1, a1, 14260
	ldloc.2
	ldc.i4 14260
	add
	stloc.2
...
// 0x010a1698: 0x10a1698: lui   a2, 0x80000
	ldc.i4 524288
	stloc.3
// 0x010a169c: 0x10a169c: addiu a0, a0, 10260
	ldloc.1
	ldc.i4 10260
	add
	stloc.1
// 0x010a16a0: 0x10a16a0: addiu a1, a1, 11260
	ldloc.2
	ldc.i4 11260
	add
	stloc.2
// 0x010a16a4: 0x10a16a4: addiu a2, a2, 13260
	ldloc.3
	ldc.i4 13260
	add
	stloc.3
...
// 0x010a16b4: 0x10a16b4: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010a16b8: 0x10a16b8: sw    zero, 10248(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a1738: 0x10a1738: lui   s2, 0x80000
	ldc.i4 524288
	stloc 8
// 0x010a173c: 0x10a173c: addiu s2, s2, 16772
	ldloc 8
	ldc.i4 16772
	add
	stloc 8
...
// 0x010a1864: 0x10a1864: lui   s0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010a1868: 0x10a1868: addiu s0, s0, 16772
	ldloc 5
	ldc.i4 16772
	add
	stloc 5
...
// 0x010a1928: 0x10a1928: lw    v0, 17752(s4)
	...
	ldelem.i4
	stloc 5
// 0x010a192c: 0x10a192c: addiu s1, s1, 16260
	ldloc 6
	ldc.i4 16260
	add
	stloc 6
