...
// 0x0103f54c: 0x103f54c: lw    a0, 16(v0)
	...
	ldelem.i4
	stloc.1
// 0x0103f550: 0x103f550: jal   0x10c0908 addu  s0, v0, zero
	ldloc 5
	stloc 8
	ldloc.0
	ldloc.1
...
// 0x0103f558: 0x103f558: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x0103f55c: 0x103f55c: jal   0x10c0a40 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103f570: 0x103f570: lw    a0, 8(s0)
	...
	ldelem.i4
	stloc.1
// 0x0103f574: 0x103f574: jal   0x10c0908 sw    v0, 36(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103f57c: 0x103f57c: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x0103f580: 0x103f580: jal   0x10c0a40 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103f5e8: 0x103f5e8: lw    a0, 16(v0)
	...
	ldelem.i4
	stloc.1
// 0x0103f5ec: 0x103f5ec: jal   0x10c0908 addu  s0, v0, zero
	ldloc 5
	stloc 8
	ldloc.0
	ldloc.1
...
// 0x0103f5f4: 0x103f5f4: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x0103f5f8: 0x103f5f8: jal   0x10c0a40 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103f60c: 0x103f60c: lw    a0, 8(s0)
	...
	ldelem.i4
	stloc.1
// 0x0103f610: 0x103f610: jal   0x10c0908 sw    v0, 36(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103f618: 0x103f618: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x0103f61c: 0x103f61c: jal   0x10c0a40 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01040134: 0x1040134: jal   0x10402c4 addiu a0, a0, 11956
	...
	stloc 6
// --- basic block ---
// 0x0104013c: 0x104013c: jal   0x10ac69c sll   zero, zero, 0
	call void Cibyl129::roadmap_device_events_os_term_10ac69c()
// --- basic block ---
...
// 0x010401b0: 0x10401b0: jal   0x1040274 sw    v0, 32(sp)
	...
	stloc 5
// --- basic block ---
// 0x010401b8: 0x10401b8: jal   0x10ac694 sll   zero, zero, 0
	call int32 Cibyl129::roadmap_device_events_os_init_10ac694()
	stloc 5
// --- basic block ---
