...
// 0x0101a974: 0x101a974: addiu s0, s0, 2480
	...
	add
	stloc 8
// 0x0101a978: 0x101a978: addiu s2, s2, -28524
	ldloc 12
	ldc.i4 -28524
	add
	stloc 12
...
// 0x0101a998: 0x101a998: beq   a0, zero, 0x101a9c0 lui   a3, 0x30000
	...
	brfalse L_101a9c0
// --- basic block ---
// 0x0101a9a0: 0x101a9a0: lw    a1, 25920(a3)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0101aa38: 0x101aa38: sw    v0, 16(sp)
	...
	ldloc 6
	stelem.i4
// 0x0101aa3c: 0x101aa3c: jal   0x104feb0 sw    zero, 20(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101aa44: 0x101aa44: lw    a1, 24(sp)
	...
	ldelem.i4
	stloc.2
// 0x0101aa48: 0x101aa48: lw    v0, -22660(s8)
	ldloc 5
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x0101aa5c: 0x101aa5c: sw    a1, 24(sp)
	...
	ldloc.2
	stelem.i4
// 0x0101aa60: 0x101aa60: lw    v1, -22664(a3)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101ac74:
// 0x0101ac74: 0x101ac74: jal   0x104306c sll   zero, zero, 0
...
// 0x0101ac7c: 0x101ac7c: jal   0x1016620 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101ac84: 0x101ac84: jal   0x1054d30 sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101acc0: 0x101acc0: sw    v0, 56(sp)
	...
	stelem.i4
L_101acc4:
// 0x0101acc4: 0x101acc4: jal   0x104306c sll   zero, zero, 0
	call int32 Cibyl50::roadmap_bar_top_height_104306c()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 6
...
// 0x0101accc: 0x101accc: jal   0x1016620 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101acd4: 0x101acd4: jal   0x1054d30 sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101acf0: 0x101acf0: addu  v1, v1, v0
	...
	add
	stloc 7
// 0x0101acf4: 0x101acf4: jal   0x104306c sw    v1, 84(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101acfc: 0x101acfc: jal   0x1016620 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101ad04: 0x101ad04: jal   0x1054d30 sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101ad2c:
// 0x0101ad2c: 0x101ad2c: jal   0x10430a0 sw    v1, 112(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ad40: 0x101ad40: subu  v0, v1, v0
	...
	sub
	stloc 6
// 0x0101ad44: 0x101ad44: jal   0x10430a0 sw    v0, 68(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101addc:
// 0x0101addc: 0x101addc: jal   0x10430a0 sw    v1, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101adf8:
// 0x0101adf8: 0x101adf8: jal   0x104306c sll   zero, zero, 0
	call int32 Cibyl50::roadmap_bar_top_height_104306c()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 6
...
// 0x0101ae00: 0x101ae00: jal   0x1016620 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101ae08: 0x101ae08: jal   0x1054d30 sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101ae2c:
// 0x0101ae2c: 0x101ae2c: jal   0x104306c sw    a1, 124(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ae34: 0x101ae34: jal   0x1016620 sw    v0, 120(sp)
	...
	stloc 6
// --- basic block ---
// 0x0101ae3c: 0x101ae3c: jal   0x1054d30 sw    v0, 128(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101aeb0: 0x101aeb0: lw    a0, 60(s0)
	...
	ldelem.i4
	stloc.1
// 0x0101aeb4: 0x101aeb4: jal   0x104f8a4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	...
	stloc 6
// --- basic block ---
// 0x0101aebc: 0x101aebc: jal   0x104f958 addiu a0, zero, 181
	ldc.i4 181
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101aed0: 0x101aed0: addiu a0, zero, 1
	ldc.i4.1
	stloc.1
// 0x0101aed4: 0x101aed4: jal   0x10504c8 sw    zero, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101aedc: 0x101aedc: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101aee0: 0x101aee0: lw    a0, 25924(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0101aee4: 0x101aee4: jal   0x104f8a4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101aef8: 0x101aef8: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0101aefc: 0x101aefc: jal   0x10504c8 sw    zero, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101af0c: 0x101af0c: beq   a2, zero, 0x101af70 addiu a1, zero, 1
	...
	brfalse L_101af70
// --- basic block ---
// 0x0101af14: 0x101af14: jal   0x10a4658 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101af3c: 0x101af3c: mflo  lo
	ldloc 9
	stloc 11
// 0x0101af40: 0x101af40: jal   0x104f4f8 addu  s3, s3, v0
	ldloc 11
	ldloc 6
	add
	stloc 11
...
// 0x0101af64: 0x101af64: subu  s3, s3, v0
	...
	sub
	stloc 11
// 0x0101af68: 0x101af68: jal   0x1050aa0 sw    s3, 52(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101af70: 0x101af70: lw    a0, 64(s0)
	...
	ldelem.i4
	stloc.1
// 0x0101af74: 0x101af74: jal   0x104f8a4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101b054: 0x101b054: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101b058: 0x101b058: addiu v1, v1, 25952
	ldloc 6
	ldc.i4 25952
	add
	stloc 6
...
// 0x0101b0d0: 0x101b0d0: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x0101b0d4: 0x101b0d4: addiu v1, v1, 25952
	ldloc 6
	ldc.i4 25952
	add
	stloc 6
...
// 0x0101b178: 0x101b178: sll   v0, s0, 2
	...
	shl
	stloc 5
// 0x0101b17c: 0x101b17c: addiu s1, s1, 25952
	ldloc 8
	ldc.i4 25952
	add
	stloc 8
...
// 0x0101b1a8: 0x101b1a8: lui   v0, 0x30000
	...
	stloc 5
L_101b1ac:
// 0x0101b1ac: 0x101b1ac: addiu v0, v0, 25952
	ldloc 5
	ldc.i4 25952
	add
	stloc 5
...
// 0x0101b1c8: 0x101b1c8: addiu a1, zero, 100
	ldc.i4.s 100
	stloc.2
// 0x0101b1cc: 0x101b1cc: jal   0x10c34c0 sw    v0, 24(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101b224: 0x101b224: addu  s1, s0, a1
	...
	add
	stloc 10
// 0x0101b228: 0x101b228: addiu s5, s5, 25952
	ldloc 9
	ldc.i4 25952
	add
	stloc 9
...
// 0x0101b75c: 0x101b75c: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x0101b760: 0x101b760: addiu v1, v1, 23860
	ldloc 7
	ldc.i4 23860
	add
	stloc 7
...
// 0x0101b85c: 0x101b85c: addu  a0, s2, zero
	ldloc 12
	stloc.1
// 0x0101b860: 0x101b860: jal   0x1050448 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101b868: 0x101b868: sw    v0, 4(s5)
	...
	ldloc 5
	stelem.i4
// 0x0101b86c: 0x101b86c: jal   0x10502f8 addu  a0, s6, zero
	ldloc 11
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101b874: 0x101b874: lw    a0, 2584(sp)
	...
	ldelem.i4
	stloc.1
// 0x0101b878: 0x101b878: jal   0x104f26c sll   zero, zero, 0
	ldloc.1
...
// 0x0101b944: 0x101b944: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0101b948: 0x101b948: lw    v1, 26476(s7)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x0101b94c: 0x101b94c: lw    v0, 26480(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0101b960: 0x101b960: sw    v0, 8(s0)
	...
	ldloc 5
	stelem.i4
// 0x0101b964: 0x101b964: sw    s0, 26476(s7)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x0101b9f4: 0x101b9f4: sw    s4, 60(sp)
	...
	ldloc 13
	stelem.i4
// 0x0101b9f8: 0x101b9f8: jal   0x1050448 sw    s0, 44(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ba10: 0x101ba10: addiu a1, s2, -30240
	...
	add
	stloc.2
// 0x0101ba14: 0x101ba14: addiu a3, s1, 6796
	ldloc 9
	ldc.i4 6796
	add
	stloc 4
// 0x0101ba18: 0x101ba18: sw    v0, 26480(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldloc 5
	stelem.i4
// 0x0101ba1c: 0x101ba1c: jal   0x104ec70 sw    s0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ba2c: 0x101ba2c: addiu s5, s2, -30240
	...
	add
	stloc 14
// 0x0101ba30: 0x101ba30: j	 0x101ba80 addiu s4, s1, 6796
	ldloc 9
	ldc.i4 6796
	add
	stloc 13
...
// 0x0101ba38: 0x101ba38: lw    a0, 24(sp)
	...
	ldelem.i4
	stloc.1
// 0x0101ba3c: 0x101ba3c: jal   0x104e914 sw    a2, 32(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ba44: 0x101ba44: lw    a0, 24(sp)
	...
	ldelem.i4
	stloc.1
// 0x0101ba48: 0x101ba48: jal   0x104e928 addu  s1, v0, zero
	ldloc 5
	stloc 9
	ldloc.1
...
// 0x0101ba54: 0x101ba54: jal   0x101b538 addu  a0, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x0101ba5c: 0x101ba5c: jal   0x104eb28 addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101ba70: 0x101ba70: addu  a3, s4, zero
	ldloc 13
	stloc 4
// 0x0101ba74: 0x101ba74: jal   0x104ec70 sw    s0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ba8c: 0x101ba8c: lui   s3, 0x20000
	ldc.i4 131072
	stloc 10
// 0x0101ba90: 0x101ba90: addiu a0, s3, -772
	ldloc 10
	ldc.i4 -772
	add
	stloc.1
// 0x0101ba94: 0x101ba94: addiu a1, s2, -30240
	...
	add
	stloc.2
// 0x0101ba98: 0x101ba98: addiu a3, s1, 6796
	ldloc 9
	ldc.i4 6796
	add
	stloc 4
// 0x0101ba9c: 0x101ba9c: jal   0x104ec70 sw    s0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101baa4: 0x101baa4: addu  a2, v0, zero
	ldloc 5
	stloc.3
// 0x0101baa8: 0x101baa8: addiu s3, s3, -772
	ldloc 10
	ldc.i4 -772
	add
	stloc 10
// 0x0101baac: 0x101baac: addiu s2, s2, -30240
	...
	add
	stloc 11
// 0x0101bab0: 0x101bab0: addiu s1, s1, 6796
	ldloc 9
	ldc.i4 6796
	add
	stloc 9
...
// 0x0101babc: 0x101babc: lw    a0, 24(sp)
	...
	ldelem.i4
	stloc.1
// 0x0101bac0: 0x101bac0: jal   0x104e914 sw    a2, 32(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101bac8: 0x101bac8: lw    a0, 24(sp)
	...
	ldelem.i4
	stloc.1
// 0x0101bacc: 0x101bacc: jal   0x104e928 addu  s4, v0, zero
	ldloc 5
	stloc 13
	ldloc.1
	call int32 Cibyl59::roadmap_file_size_104e928(int32)
...
// 0x0101bad8: 0x101bad8: jal   0x101b538 addu  a0, s4, zero
	...
	stloc 5
// --- basic block ---
// 0x0101bae0: 0x101bae0: jal   0x104eb28 addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101baf4: 0x101baf4: addu  a3, s1, zero
	ldloc 9
	stloc 4
// 0x0101baf8: 0x101baf8: jal   0x104ec70 sw    s0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101bb0c: 0x101bb0c: lui   s1, 0x10000
	ldc.i4 65536
	stloc 9
// 0x0101bb10: 0x101bb10: lw    s0, 26476(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101bb40: 0x101bb40: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101bb44: 0x101bb44: lw    s0, 26472(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101bb48: 0x101bb48: lui   v0, 0x30000
	...
	stloc 5
L_101bb4c:
// 0x0101bb4c: 0x101bb4c: bne   s0, zero, 0x101bbac sw    s0, 26472(v0)
	ldloc 8
	ldloc 6
	ldloc 5
	ldc.i4.2
...
// 0x0101bb68: 0x101bb68: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101bb6c: 0x101bb6c: lw    s0, 26476(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101bb9c: 0x101bb9c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101bba0: 0x101bba0: lw    s0, 26472(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101bba4: 0x101bba4: lui   v0, 0x30000
	...
	stloc 5
L_101bba8:
// 0x0101bba8: 0x101bba8: sw    s0, 26472(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101bbac: 0x101bbac: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101bbb0: 0x101bbb0: lw    v1, 26472(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101bc2c: 0x101bc2c: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101bc30: 0x101bc30: lw    a0, 26476(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101bcd8: 0x101bcd8: addiu a1, zero, 8
	ldc.i4.8
	stloc.2
// 0x0101bcdc: 0x101bcdc: jal   0x101b4f0 sw    v0, 26464(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101bd00: 0x101bd00: lw    s0, 44(sp)
	...
	ldelem.i4
	stloc 8
// 0x0101bd04: 0x101bd04: sw    v0, 26468(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
