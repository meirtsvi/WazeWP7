...
// 0x0101ca88: 0x101ca88: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101ca8c: 0x101ca8c: addiu v0, v0, 27320
	ldloc 5
	ldc.i4 27320
	add
	stloc 5
...
// 0x0101cb50: 0x101cb50: sll   v0, s3, 2
	...
	shl
	stloc 5
// 0x0101cb54: 0x101cb54: addiu v1, v1, 27320
	ldloc 7
	ldc.i4 27320
	add
	stloc 7
...
// 0x0101cc24: 0x101cc24: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101cc28: 0x101cc28: lw    v0, 28336(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101cc34: 0x101cc34: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101cc38: 0x101cc38: lw    v0, 28332(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101cc44: 0x101cc44: lui   v0, 0xe0000
	ldc.i4 917504
	stloc.0
// 0x0101cc48: 0x101cc48: jr    ra addiu v0, v0, 29748
	ldloc.0
	ldc.i4 29748
	add
	stloc.0
...
// 0x0101cc50: 0x101cc50: lui   v0, 0xe0000
	ldc.i4 917504
	stloc.0
// 0x0101cc54: 0x101cc54: jr    ra addiu v0, v0, 30148
	ldloc.0
	ldc.i4 30148
	add
	stloc.0
...
// 0x0101cd14: 0x101cd14: addu  s2, a0, zero
	ldloc.1
	stloc 9
// 0x0101cd18: 0x101cd18: addiu s1, s1, 29748
	ldloc 7
	ldc.i4 29748
	add
	stloc 7
...
// --- basic block ---
L_101cd48:
// 0x0101cd48: 0x101cd48: lw    v0, 28332(s4)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0101cd80: 0x101cd80: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101cd84: 0x101cd84: lw    v0, 28340(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101cdd8: 0x101cdd8: jal   0x10155cc lui   s2, 0x30000
	...
	stloc 6
// --- basic block ---
// 0x0101cde0: 0x101cde0: lw    a0, 28368(s2)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101cdfc:
// 0x0101cdfc: 0x101cdfc: lw    s2, 28356(s3)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101ce28:
// 0x0101ce28: 0x101ce28: lw    a0, 28368(s4)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x0101ce70: 0x101ce70: lui   s0, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101ce74: 0x101ce74: lw    v0, 28360(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101ce98: 0x101ce98: addiu v0, zero, 50
	ldc.i4.s 50
	stloc 5
// 0x0101ce9c: 0x101ce9c: jal   0x1000910 sw    v0, 28360(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101ceb0: 0x101ceb0: jal   0x100177c addu  s3, v0, zero
	...
	stloc 5
// --- basic block ---
// 0x0101ceb8: 0x101ceb8: lw    a1, 28360(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101cec0: 0x101cec0: addiu a0, a0, -30340
	...
	add
	stloc.1
// 0x0101cec4: 0x101cec4: jal   0x10158dc sw    s3, 28356(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x0101cecc: 0x101cecc: j	 0x101cef8 sw    v0, 28368(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101ced4:
// 0x0101ced4: 0x101ced4: lw    a0, 28356(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101cedc: 0x101cedc: sll   v0, v0, 1
	...
	shl
	stloc 5
// 0x0101cee0: 0x101cee0: jal   0x1000a60 sw    v0, 28360(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x0101cee8: 0x101cee8: lw    a0, 28368(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0101ceec: 0x101ceec: lw    a1, 28360(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x0101cef0: 0x101cef0: jal   0x1015b38 sw    v0, 28356(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101cef8: 0x101cef8: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101cefc: 0x101cefc: lw    v0, 28356(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101cf98: 0x101cf98: lui   s2, 0x30000
	ldc.i4 196608
	stloc 12
// 0x0101cf9c: 0x101cf9c: jal   0x1001b68 sw    zero, 28332(s2)
	ldloc 6
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x0101d03c: 0x101d03c: sb    zero, 0(v0)
	...
	ldc.i4.s 0
	call void [WazeWP7]CRunTime::memoryWriteByte(int32, int32)
// 0x0101d040: 0x101d040: lw    s7, 28332(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101d058: 0x101d058: sw    v0, 0(s7)
	...
	ldloc 5
	stelem.i4
// 0x0101d05c: 0x101d05c: lw    s5, 28332(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101d060: 0x101d060: jal   0x1001ba8 sll   s5, s5, 2
	...
	stloc 5
// --- basic block ---
// 0x0101d068: 0x101d068: lw    v1, 28332(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101d074: 0x101d074: sw    v0, 0(s5)
	...
	ldloc 5
	stelem.i4
// 0x0101d078: 0x101d078: j	 0x101d098 sw    v1, 28332(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101d088: 0x101d088: addu  s1, s2, zero
	ldloc 12
	stloc 8
// 0x0101d08c: 0x101d08c: addiu s4, s4, 30148
	ldloc 14
	ldc.i4 30148
	add
	stloc 14
// 0x0101d090: 0x101d090: addiu s3, s3, 29748
	ldloc 10
	ldc.i4 29748
	add
	stloc 10
...
// 0x0101d0dc: 0x101d0dc: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 7
// 0x0101d0e0: 0x101d0e0: lw    a1, 28332(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x0101d0e4: 0x101d0e4: addiu a0, a0, 29748
	ldloc.1
	ldc.i4 29748
	add
	stloc.1
// 0x0101d0e8: 0x101d0e8: addiu v1, v1, 30148
	ldloc 7
	ldc.i4 30148
	add
	stloc 7
...
// 0x0101d1f8: 0x101d1f8: sw    v1, 16(sp)
	...
	ldloc 7
	stelem.i4
// 0x0101d1fc: 0x101d1fc: jal   0x10a2da4 sw    v0, 24(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101d290: 0x101d290: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101d294: 0x101d294: lw    v0, 28344(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d338: 0x101d338: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101d33c: 0x101d33c: lw    v0, 28344(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d388: 0x101d388: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101d38c: 0x101d38c: lw    v1, 28352(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d394: 0x101d394: bne   v1, zero, 0x101d3f0 addiu v1, zero, 1
	...
	brtrue L_101d3f0
// --- basic block ---
// 0x0101d39c: 0x101d39c: sw    v1, 28352(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d3e4: 0x101d3e4: sw    v0, 24(sp)
	...
	ldloc 5
	stelem.i4
// 0x0101d3e8: 0x101d3e8: jal   0x10a2da4 sw    s0, 28(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101d400: 0x101d400: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101d404: 0x101d404: lw    v0, 28344(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d454: 0x101d454: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101d458: 0x101d458: lw    v0, 28344(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d4c0: 0x101d4c0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101d4c4: 0x101d4c4: lw    v0, 28344(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d5b0: 0x101d5b0: lui   a1, 0x30000
	ldc.i4 196608
	stloc.2
// 0x0101d5b4: 0x101d5b4: lw    a0, 28364(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0101d5b8: 0x101d5b8: lw    v1, 28360(a1)
	ldloc 5
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0101d5d0: 0x101d5d0: lw    v0, 80(sp)
	...
	stloc 6
L_101d5d4:
// 0x0101d5d4: 0x101d5d4: lw    a2, 28364(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.3
// 0x0101d5d8: 0x101d5d8: lw    a0, 28356(s8)
	ldloc 5
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x0101d5ec: 0x101d5ec: lw    a1, 72(sp)
	...
	ldelem.i4
	stloc.2
// 0x0101d5f0: 0x101d5f0: lw    a0, 28368(s7)
	ldloc 5
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x0101d5f8: 0x101d5f8: jal   0x10157ec addu  a1, v0, zero
	...
	stloc 6
// --- basic block ---
// 0x0101d600: 0x101d600: lw    v0, 28364(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101d614: 0x101d614: addu  a3, s4, zero
	ldloc 12
	stloc 4
// 0x0101d618: 0x101d618: sw    v0, 28364(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101d744: 0x101d744: lui   s0, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101d748: 0x101d748: lw    v0, 28348(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101d758: 0x101d758: jalr  v0 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x0101d760: 0x101d760: sw    zero, 28348(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101d83c: 0x101d83c: sw    v1, 28344(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d860: 0x101d860: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0101d864: 0x101d864: sw    v1, 30148(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d870: 0x101d870: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0101d874: 0x101d874: jal   0x104c584 sw    v1, 29748(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d88c: 0x101d88c: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101d890: 0x101d890: jal   0x104c544 sw    v0, 28348(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101d8a8: 0x101d8a8: lui   s0, 0x30000
	ldc.i4 196608
	stloc 8
// 0x0101d8ac: 0x101d8ac: bne   v0, zero, 0x101d8c8 sw    v0, 28340(s0)
	ldloc 5
	ldloc 7
	ldloc 8
	ldc.i4.2
...
// 0x0101d8bc: 0x101d8bc: jal   0x101d514 addu  a0, v0, zero
	...
	stloc 5
// --- basic block ---
// 0x0101d8c4: 0x101d8c4: sw    v0, 28340(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101d8e8: 0x101d8e8: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101d8ec: 0x101d8ec: jal   0x101d4a4 sw    v0, 28336(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101da9c: 0x101da9c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101daa0: 0x101daa0: lw    v0, 28344(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101dba8: 0x101dba8: addiu sp, sp, -40
	...
	add
	stloc.0
// 0x0101dbac: 0x101dbac: addiu v1, v0, 28372
	ldloc 5
	ldc.i4 28372
	add
	stloc 7
...
// 0x0101dbd0: 0x101dbd0: bne   a0, v1, 0x101dbec addu  s0, a1, zero
	...
	bne.un L_101dbec
// --- basic block ---
// 0x0101dbd8: 0x101dbd8: lw    v0, 28372(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101dbfc: 0x101dbfc: lui   s2, 0x30000
	ldc.i4 196608
	stloc 8
// 0x0101dc00: 0x101dc00: sw    v0, 28392(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101dc04: 0x101dc04: lw    s3, 4(s1)
	...
	ldelem.i4
	stloc 11
// 0x0101dc08: 0x101dc08: jal   0x101db80 addiu s2, s2, 28392
	ldloc 8
	ldc.i4 28392
	add
	stloc 8
...
// 0x0101dc14: 0x101dc14: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0101dc18: 0x101dc18: addiu a0, a0, 28372
	ldloc.1
	ldc.i4 28372
	add
	stloc.1
...
// 0x0101dc2c: 0x101dc2c: lui   v0, 0x30000
	...
	stloc 5
L_101dc30:
// 0x0101dc30: 0x101dc30: lw    v1, 28392(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x0101dc34: 0x101dc34: addiu v0, v0, 28392
	ldloc 5
	ldc.i4 28392
	add
	stloc 5
...
// 0x0101dc60: 0x101dc60: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0101dc64: 0x101dc64: addiu v0, v0, 29620
	ldloc 5
	ldc.i4 29620
	add
	stloc 5
...
// 0x0101dd04: 0x101dd04: lui   v0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0101dd08: 0x101dd08: lw    v0, 28400(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0101dd18: 0x101dd18: beq   v1, zero, 0x101dd44 lui   v1, 0x30000
	...
	brfalse L_101dd44
// --- basic block ---
// 0x0101dd20: 0x101dd20: lw    a0, 28404(v1)
	ldloc 3
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0101de08: 0x101de08: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101de0c: 0x101de0c: lw    v0, 28404(v0)
	ldloc 1
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101de30: 0x101de30: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101de34: 0x101de34: lw    v1, 28404(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
