...
// 0x0101bd14: 0x101bd14: addu  t0, a0, zero
	ldloc.1
	stloc 6
// 0x0101bd18: 0x101bd18: lw    v1, 26468(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101bdac: 0x101bdac: addu  s2, a1, zero
	ldloc.2
	stloc 10
// 0x0101bdb0: 0x101bdb0: lw    s0, 26476(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101bde0: 0x101bde0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101bde4: 0x101bde4: lw    s0, 26472(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101be00: 0x101be00: lw    a0, 4(s0)
	...
	ldelem.i4
	stloc.1
// 0x0101be04: 0x101be04: jal   0x104f8a4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0101be2c: 0x101be2c: lw    a1, 60(s0)
	...
	ldelem.i4
	stloc.2
// 0x0101be30: 0x101be30: lw    a2, 26468(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101be34: 0x101be34: addiu a3, zero, 1
	ldc.i4.1
	stloc 4
// 0x0101be38: 0x101be38: jal   0x10504c8 sw    zero, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101be60: 0x101be60: lw    a2, 28(s0)
	...
	ldelem.i4
	stloc.3
// 0x0101be64: 0x101be64: lw    a1, 26468(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101be68: 0x101be68: addiu a3, zero, 1
	ldc.i4.1
	stloc 4
// 0x0101be6c: 0x101be6c: jal   0x10506cc sw    zero, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101be94: 0x101be94: lw    a1, 12(s0)
	...
	ldelem.i4
	stloc.2
// 0x0101be98: 0x101be98: lw    a2, 26468(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.3
// 0x0101be9c: 0x101be9c: jal   0x10507d8 addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x0101bec4: 0x101bec4: lw    a2, 44(s0)
	...
	ldelem.i4
	stloc.3
// 0x0101bec8: 0x101bec8: lw    a1, 26468(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101becc: 0x101becc: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0101bed0: 0x101bed0: jal   0x10506cc sw    zero, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101bf04: 0x101bf04: lui   v0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0101bf08: 0x101bf08: lw    v0, 26484(v0)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0101bf90: 0x101bf90: addu  s2, a0, zero
	ldloc.1
	stloc 10
// 0x0101bf94: 0x101bf94: lw    s0, 26484(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101c0b4: 0x101c0b4: lui   v0, 0x30000
	ldc.i4 196608
	stloc.3
// 0x0101c0b8: 0x101c0b8: lw    v0, 26484(v0)
	ldloc 5
	ldloc.3
	ldc.i4.2
	shr.un
...
// 0x0101c11c: 0x101c11c: sw    s0, 20(sp)
	...
	ldloc 8
	stelem.i4
// 0x0101c120: 0x101c120: lw    v0, 26484(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101c154: 0x101c154: beq   a1, zero, 0x101c190 lui   s0, 0x30000
	...
	brfalse L_101c190
// --- basic block ---
// 0x0101c15c: 0x101c15c: lw    v1, 26488(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101c170: 0x101c170: addiu a0, s1, -14456
	...
	add
	stloc.1
// 0x0101c174: 0x101c174: jal   0x104cfd8 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101c17c: 0x101c17c: addiu a0, s1, -14456
	...
	add
	stloc.1
// 0x0101c180: 0x101c180: jal   0x104cf60 addiu a1, zero, 2
	ldc.i4.2
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101c188: 0x101c188: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x0101c18c: 0x101c18c: sw    v0, 26488(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101c21c: 0x101c21c: sw    s0, 48(sp)
	...
	ldloc 7
	stelem.i4
// 0x0101c220: 0x101c220: lw    s0, 26484(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101c34c:
// 0x0101c34c: 0x101c34c: addiu s1, s1, -28524
	ldloc 9
	ldc.i4 -28524
	add
	stloc 9
...
// 0x0101c398: 0x101c398: lw    s0, 26484(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101c3f4: 0x101c3f4: lui   v1, 0x30000
	ldc.i4 196608
	stloc 8
// 0x0101c3f8: 0x101c3f8: sw    v0, 26484(v1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101c4f0: 0x101c4f0: addu  s2, a2, zero
	ldloc.3
	stloc 13
// 0x0101c4f4: 0x101c4f4: lw    v0, 26484(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101c5f8: 0x101c5f8: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101c5fc: 0x101c5fc: lw    v0, 26484(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101c680: 0x101c680: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101c684: 0x101c684: beq   s4, zero, 0x101c6ac sw    v0, 26484(v1)
	ldloc 10
	ldloc 5
	ldloc 7
	ldc.i4.2
...
// 0x0101c7c4: 0x101c7c4: lw    s4, 0(a0)
	...
	ldelem.i4
	stloc 13
// 0x0101c7c8: 0x101c7c8: lw    s1, 26484(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 8
// 0x0101c7cc: 0x101c7cc: addiu s2, s2, -28524
	ldloc 10
	ldc.i4 -28524
	add
	stloc 10
...
// 0x0101c860: 0x101c860: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0101c864: 0x101c864: jal   0x10a4658 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101c870: 0x101c870: beq   v0, zero, 0x101c90c addu  a0, v0, zero
	...
	brfalse L_101c90c
// --- basic block ---
// 0x0101c878: 0x101c878: jal   0x104f51c sll   zero, zero, 0
	ldloc.1
...
// 0x0101c880: 0x101c880: addu  a0, s7, zero
	ldloc 16
	stloc.1
// 0x0101c884: 0x101c884: jal   0x104f4f8 addu  s6, v0, zero
	ldloc 6
	stloc 14
	ldloc.1
...
// 0x0101cb74: 0x101cb74: sll   a1, a1, 2
	...
	shl
	stloc.2
// 0x0101cb78: 0x101cb78: addiu v1, v1, 26492
	ldloc 6
	ldc.i4 26492
	add
	stloc 6
...
// 0x0101cca4: 0x101cca4: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101cca8: 0x101cca8: addiu v0, v0, 26492
	ldloc 5
	ldc.i4 26492
	add
	stloc 5
...
// 0x0101cd6c: 0x101cd6c: sll   v0, s3, 2
	...
	shl
	stloc 5
// 0x0101cd70: 0x101cd70: addiu v1, v1, 26492
	ldloc 7
	ldc.i4 26492
	add
	stloc 7
...
// 0x0101ce40: 0x101ce40: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101ce44: 0x101ce44: lw    v0, 27508(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ce50: 0x101ce50: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101ce54: 0x101ce54: lw    v0, 27504(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101ce60: 0x101ce60: lui   v0, 0xe0000
	ldc.i4 917504
	stloc.0
// 0x0101ce64: 0x101ce64: jr    ra addiu v0, v0, -28396
	ldloc.0
	ldc.i4 -28396
	add
	stloc.0
...
// 0x0101ce6c: 0x101ce6c: lui   v0, 0xe0000
	ldc.i4 917504
	stloc.0
// 0x0101ce70: 0x101ce70: jr    ra addiu v0, v0, -27996
	ldloc.0
	ldc.i4 -27996
	add
	stloc.0
...
// 0x0101cf30: 0x101cf30: addu  s2, a0, zero
	ldloc.1
	stloc 9
// 0x0101cf34: 0x101cf34: addiu s1, s1, -28396
	ldloc 7
	ldc.i4 -28396
	add
	stloc 7
...
// --- basic block ---
L_101cf64:
// 0x0101cf64: 0x101cf64: lw    v0, 27504(s4)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0101cf9c: 0x101cf9c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101cfa0: 0x101cfa0: lw    v0, 27512(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101cfe4: 0x101cfe4: jal   0x100449c lui   s0, 0x10000
	...
	stloc 6
// --- basic block ---
// 0x0101cfec: 0x101cfec: j	 0x101d060 addiu s0, s0, 18096
	ldloc 8
	ldc.i4 18096
	add
	stloc 8
...
// 0x0101cff4: 0x101cff4: jal   0x10157fc lui   s2, 0x30000
	...
	stloc 6
// --- basic block ---
// 0x0101cffc: 0x101cffc: lw    a0, 27540(s2)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101d018:
// 0x0101d018: 0x101d018: lw    s2, 27528(s3)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101d044:
// 0x0101d044: 0x101d044: lw    a0, 27540(s4)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
