...
// 0x0101ca7c: 0x101ca7c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101ca80: 0x101ca80: addiu v0, v0, 27336
	ldloc 5
	ldc.i4 27336
	add
	stloc 5
...
// 0x0101cb44: 0x101cb44: sll   v0, s3, 2
	...
	shl
	stloc 5
// 0x0101cb48: 0x101cb48: addiu v1, v1, 27336
	ldloc 7
	ldc.i4 27336
	add
	stloc 7
...
// 0x0101cc18: 0x101cc18: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101cc1c: 0x101cc1c: lw    v0, 28352(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101cc28: 0x101cc28: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101cc2c: 0x101cc2c: lw    v0, 28348(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101cc38: 0x101cc38: lui   v0, 0xe0000
	ldc.i4 917504
	stloc.0
// 0x0101cc3c: 0x101cc3c: jr    ra addiu v0, v0, 29764
	ldloc.0
	ldc.i4 29764
	add
	stloc.0
...
// 0x0101cc44: 0x101cc44: lui   v0, 0xe0000
	ldc.i4 917504
	stloc.0
// 0x0101cc48: 0x101cc48: jr    ra addiu v0, v0, 30164
	ldloc.0
	ldc.i4 30164
	add
	stloc.0
...
// 0x0101cd08: 0x101cd08: addu  s2, a0, zero
	ldloc.1
	stloc 9
// 0x0101cd0c: 0x101cd0c: addiu s1, s1, 29764
	ldloc 7
	ldc.i4 29764
	add
	stloc 7
...
// --- basic block ---
L_101cd3c:
// 0x0101cd3c: 0x101cd3c: lw    v0, 28348(s4)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0101cd74: 0x101cd74: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101cd78: 0x101cd78: lw    v0, 28356(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101cdcc: 0x101cdcc: jal   0x10155c0 lui   s2, 0x30000
	...
	stloc 6
// --- basic block ---
// 0x0101cdd4: 0x101cdd4: lw    a0, 28384(s2)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101cdf0:
// 0x0101cdf0: 0x101cdf0: lw    s2, 28372(s3)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101ce1c:
// 0x0101ce1c: 0x101ce1c: lw    a0, 28384(s4)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x0101ce64: 0x101ce64: lui   s0, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101ce68: 0x101ce68: lw    v0, 28376(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101ce8c: 0x101ce8c: addiu v0, zero, 50
	ldc.i4.s 50
	stloc 5
// 0x0101ce90: 0x101ce90: jal   0x1000910 sw    v0, 28376(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101cea4: 0x101cea4: jal   0x100177c addu  s3, v0, zero
	...
	stloc 5
// --- basic block ---
// 0x0101ceac: 0x101ceac: lw    a1, 28376(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101ceb4: 0x101ceb4: addiu a0, a0, -30340
	...
	add
	stloc.1
// 0x0101ceb8: 0x101ceb8: jal   0x10158d0 sw    s3, 28372(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x0101cec0: 0x101cec0: j	 0x101ceec sw    v0, 28384(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101cec8:
// 0x0101cec8: 0x101cec8: lw    a0, 28372(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101ced0: 0x101ced0: sll   v0, v0, 1
	...
	shl
	stloc 5
// 0x0101ced4: 0x101ced4: jal   0x1000a60 sw    v0, 28376(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x0101cedc: 0x101cedc: lw    a0, 28384(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0101cee0: 0x101cee0: lw    a1, 28376(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x0101cee4: 0x101cee4: jal   0x1015b2c sw    v0, 28372(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101ceec: 0x101ceec: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101cef0: 0x101cef0: lw    v0, 28372(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101cf8c: 0x101cf8c: lui   s2, 0x30000
	ldc.i4 196608
	stloc 12
// 0x0101cf90: 0x101cf90: jal   0x1001b68 sw    zero, 28348(s2)
	ldloc 6
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x0101d030: 0x101d030: sb    zero, 0(v0)
	...
	ldc.i4.s 0
	call void [WazeWP7]CRunTime::memoryWriteByte(int32, int32)
// 0x0101d034: 0x101d034: lw    s7, 28348(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101d04c: 0x101d04c: sw    v0, 0(s7)
	...
	ldloc 5
	stelem.i4
// 0x0101d050: 0x101d050: lw    s5, 28348(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101d054: 0x101d054: jal   0x1001ba8 sll   s5, s5, 2
	...
	stloc 5
// --- basic block ---
// 0x0101d05c: 0x101d05c: lw    v1, 28348(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101d068: 0x101d068: sw    v0, 0(s5)
	...
	ldloc 5
	stelem.i4
// 0x0101d06c: 0x101d06c: j	 0x101d08c sw    v1, 28348(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101d07c: 0x101d07c: addu  s1, s2, zero
	ldloc 12
	stloc 8
// 0x0101d080: 0x101d080: addiu s4, s4, 30164
	ldloc 14
	ldc.i4 30164
	add
	stloc 14
// 0x0101d084: 0x101d084: addiu s3, s3, 29764
	ldloc 10
	ldc.i4 29764
	add
	stloc 10
...
// 0x0101d0d0: 0x101d0d0: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 7
// 0x0101d0d4: 0x101d0d4: lw    a1, 28348(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x0101d0d8: 0x101d0d8: addiu a0, a0, 29764
	ldloc.1
	ldc.i4 29764
	add
	stloc.1
// 0x0101d0dc: 0x101d0dc: addiu v1, v1, 30164
	ldloc 7
	ldc.i4 30164
	add
	stloc 7
...
// 0x0101d284: 0x101d284: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101d288: 0x101d288: lw    v0, 28360(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d32c: 0x101d32c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101d330: 0x101d330: lw    v0, 28360(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d37c: 0x101d37c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101d380: 0x101d380: lw    v1, 28368(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d388: 0x101d388: bne   v1, zero, 0x101d3e4 addiu v1, zero, 1
	...
	brtrue L_101d3e4
// --- basic block ---
// 0x0101d390: 0x101d390: sw    v1, 28368(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d3f4: 0x101d3f4: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101d3f8: 0x101d3f8: lw    v0, 28360(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d448: 0x101d448: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101d44c: 0x101d44c: lw    v0, 28360(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d4b4: 0x101d4b4: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101d4b8: 0x101d4b8: lw    v0, 28360(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d5a4: 0x101d5a4: lui   a1, 0x30000
	ldc.i4 196608
	stloc.2
// 0x0101d5a8: 0x101d5a8: lw    a0, 28380(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0101d5ac: 0x101d5ac: lw    v1, 28376(a1)
	ldloc 5
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0101d5c4: 0x101d5c4: lw    v0, 80(sp)
	...
	stloc 6
L_101d5c8:
// 0x0101d5c8: 0x101d5c8: lw    a2, 28380(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.3
// 0x0101d5cc: 0x101d5cc: lw    a0, 28372(s8)
	ldloc 5
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x0101d5e0: 0x101d5e0: lw    a1, 72(sp)
	...
	ldelem.i4
	stloc.2
// 0x0101d5e4: 0x101d5e4: lw    a0, 28384(s7)
	ldloc 5
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x0101d5ec: 0x101d5ec: jal   0x10157e0 addu  a1, v0, zero
	...
	stloc 6
// --- basic block ---
// 0x0101d5f4: 0x101d5f4: lw    v0, 28380(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101d608: 0x101d608: addu  a3, s4, zero
	ldloc 12
	stloc 4
// 0x0101d60c: 0x101d60c: sw    v0, 28380(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101d738: 0x101d738: lui   s0, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101d73c: 0x101d73c: lw    v0, 28364(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101d74c: 0x101d74c: jalr  v0 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x0101d754: 0x101d754: sw    zero, 28364(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101d830: 0x101d830: sw    v1, 28360(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d854: 0x101d854: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0101d858: 0x101d858: sw    v1, 30164(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d864: 0x101d864: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0101d868: 0x101d868: jal   0x104c6f4 sw    v1, 29764(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101d880: 0x101d880: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101d884: 0x101d884: jal   0x104c6b4 sw    v0, 28364(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101d89c: 0x101d89c: lui   s0, 0x30000
	ldc.i4 196608
	stloc 8
// 0x0101d8a0: 0x101d8a0: bne   v0, zero, 0x101d8bc sw    v0, 28356(s0)
	ldloc 5
	ldloc 7
	ldloc 8
	ldc.i4.2
...
// 0x0101d8b0: 0x101d8b0: jal   0x101d508 addu  a0, v0, zero
	...
	stloc 5
// --- basic block ---
// 0x0101d8b8: 0x101d8b8: sw    v0, 28356(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101d8dc: 0x101d8dc: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101d8e0: 0x101d8e0: jal   0x101d498 sw    v0, 28352(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101da90: 0x101da90: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101da94: 0x101da94: lw    v0, 28360(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101db9c: 0x101db9c: addiu sp, sp, -40
	...
	add
	stloc.0
// 0x0101dba0: 0x101dba0: addiu v1, v0, 28388
	ldloc 5
	ldc.i4 28388
	add
	stloc 7
...
// 0x0101dbc4: 0x101dbc4: bne   a0, v1, 0x101dbe0 addu  s0, a1, zero
	...
	bne.un L_101dbe0
// --- basic block ---
// 0x0101dbcc: 0x101dbcc: lw    v0, 28388(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101dbf0: 0x101dbf0: lui   s2, 0x30000
	ldc.i4 196608
	stloc 8
// 0x0101dbf4: 0x101dbf4: sw    v0, 28408(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101dbf8: 0x101dbf8: lw    s3, 4(s1)
	...
	ldelem.i4
	stloc 11
// 0x0101dbfc: 0x101dbfc: jal   0x101db74 addiu s2, s2, 28408
	ldloc 8
	ldc.i4 28408
	add
	stloc 8
...
// 0x0101dc08: 0x101dc08: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0101dc0c: 0x101dc0c: addiu a0, a0, 28388
	ldloc.1
	ldc.i4 28388
	add
	stloc.1
...
// 0x0101dc20: 0x101dc20: lui   v0, 0x30000
	...
	stloc 5
L_101dc24:
// 0x0101dc24: 0x101dc24: lw    v1, 28408(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x0101dc28: 0x101dc28: addiu v0, v0, 28408
	ldloc 5
	ldc.i4 28408
	add
	stloc 5
...
// 0x0101dc54: 0x101dc54: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0101dc58: 0x101dc58: addiu v0, v0, 29636
	ldloc 5
	ldc.i4 29636
	add
	stloc 5
...
// 0x0101dcf8: 0x101dcf8: lui   v0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0101dcfc: 0x101dcfc: lw    v0, 28416(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0101dd0c: 0x101dd0c: beq   v1, zero, 0x101dd38 lui   v1, 0x30000
	...
	brfalse L_101dd38
// --- basic block ---
// 0x0101dd14: 0x101dd14: lw    a0, 28420(v1)
	ldloc 3
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0101ddfc: 0x101ddfc: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101de00: 0x101de00: lw    v0, 28420(v0)
	ldloc 1
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101de24: 0x101de24: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101de28: 0x101de28: lw    v1, 28420(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
