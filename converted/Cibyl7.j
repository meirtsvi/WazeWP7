...
// 0x0100a108: 0x100a108: lui   v0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0100a10c: 0x100a10c: lw    v0, 30620(v0)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0100a144: 0x100a144: lui   v0, 0x20000
	ldc.i4 131072
	stloc.0
// 0x0100a148: 0x100a148: lw    v1, 30620(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100a164: 0x100a164: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a168: 0x100a168: lw    v1, 30620(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a170: 0x100a170: bne   a0, v1, 0x100a17c sw    ra, 20(sp)
	...
	bne.un L_100a17c
// --- basic block ---
// 0x0100a178: 0x100a178: sw    zero, 30620(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a1ac: 0x100a1ac: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x0100a1b0: 0x100a1b0: lw    v0, 23784(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a1d8: 0x100a1d8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a1dc: 0x100a1dc: beq   s0, zero, 0x100a1f0 sw    s0, 30620(v0)
	ldloc 7
	ldloc 6
	ldloc 5
	ldc.i4.2
...
// 0x0100a1e8: 0x100a1e8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a1ec: 0x100a1ec: sw    v1, 30624(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a238: 0x100a238: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x0100a23c: 0x100a23c: lw    v1, 23784(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100a2d8: 0x100a2d8: lui   v0, 0x20000
	ldc.i4 131072
	stloc.0
// 0x0100a2dc: 0x100a2dc: lw    v1, 30628(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100a2f8: 0x100a2f8: lui   v0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0100a2fc: 0x100a2fc: lw    v0, 30628(v0)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0100a31c: 0x100a31c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 4
// 0x0100a320: 0x100a320: lw    v1, 30628(v0)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0100a384: 0x100a384: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x0100a388: 0x100a388: lw    v0, 23788(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a3bc: 0x100a3bc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a3c0: 0x100a3c0: lw    v1, 30628(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a3c8: 0x100a3c8: bne   v1, s0, 0x100a3d4 sll   zero, zero, 0
	...
	bne.un L_100a3d4
// --- basic block ---
// 0x0100a3d0: 0x100a3d0: sw    zero, 30628(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a404: 0x100a404: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x0100a408: 0x100a408: lw    v0, 23788(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a448: 0x100a448: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a44c: 0x100a44c: sw    s0, 30628(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a4ac: 0x100a4ac: lui   v1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100a4b0: 0x100a4b0: lw    v1, 23788(v1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100a550: 0x100a550: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100a554: 0x100a554: lw    v0, 30628(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100a5fc: 0x100a5fc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a600: 0x100a600: lw    v0, 30628(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a650: 0x100a650: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x0100a654: 0x100a654: lw    v0, 23792(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a67c: 0x100a67c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a680: 0x100a680: beq   s0, zero, 0x100a694 sw    s0, 30632(v0)
	ldloc 7
	ldloc 6
	ldloc 5
	ldc.i4.2
...
// 0x0100a68c: 0x100a68c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a690: 0x100a690: sw    v1, 30636(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a6a8: 0x100a6a8: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x0100a6ac: 0x100a6ac: lw    v0, 23792(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a6e0: 0x100a6e0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a6e4: 0x100a6e4: lw    v1, 30632(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a6ec: 0x100a6ec: bne   v1, s0, 0x100a6f8 sll   zero, zero, 0
	...
	bne.un L_100a6f8
// --- basic block ---
// 0x0100a6f4: 0x100a6f4: sw    zero, 30632(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a748: 0x100a748: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x0100a74c: 0x100a74c: lw    v1, 23792(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100a800: 0x100a800: lui   v0, 0x20000
	ldc.i4 131072
	stloc.0
// 0x0100a804: 0x100a804: jr    ra sw    v1, 30648(v0)
	ldloc 3
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100a82c: 0x100a82c: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x0100a830: 0x100a830: lw    v0, 23796(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a860: 0x100a860: sw    s0, 30640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a914: 0x100a914: addiu a3, s1, 64
	...
	add
	stloc 4
// 0x0100a918: 0x100a918: jal   0x100cab8 sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100a930: 0x100a930: lui   v1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100a934: 0x100a934: lw    s3, 30640(v1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100a9b0: 0x100a9b0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a9b4: 0x100a9b4: lw    v1, 30640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a9e0: 0x100a9e0: lw    a0, 0(v0)
	...
	ldelem.i4
	stloc.1
// 0x0100a9e4: 0x100a9e4: jal   0x1013a1c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100a9f4: 0x100a9f4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a9f8: 0x100a9f8: lw    a0, 30640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100aa38: 0x100aa38: sw    s0, 744(v0)
	...
	ldloc 7
	stelem.i4
// 0x0100aa3c: 0x100aa3c: jal   0x1015a1c lui   s0, 0x0
	ldc.i4.s 0
	stloc 7
	ldloc.0
	ldloc.1
...
// 0x0100ab1c: 0x100ab1c: mult  s0, s2
	...
	mul
	stloc 9
// 0x0100ab20: 0x100ab20: lw    v0, 30640(s3)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x0100ab60: 0x100ab60: lw    a0, 0(v0)
	...
	ldelem.i4
	stloc.1
// 0x0100ab64: 0x100ab64: jal   0x1013a1c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100ab6c: 0x100ab6c: mult  s0, s2
	...
	stloc 9
L_100ab70:
// 0x0100ab70: 0x100ab70: lw    v0, 30640(s3)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x0100ab88: 0x100ab88: addiu v0, s0, 1
	...
	add
	stloc 6
// 0x0100ab8c: 0x100ab8c: lw    a1, 30640(s3)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x0100abe4: 0x100abe4: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 6
// 0x0100abe8: 0x100abe8: lw    v0, 23796(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100ac1c:
// 0x0100ac1c: 0x100ac1c: jal   0x1042248 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100ac2c: 0x100ac2c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100ac30: 0x100ac30: lw    v1, 30640(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100ac38: 0x100ac38: bne   v1, s0, 0x100ac44 sll   zero, zero, 0
	...
	bne.un L_100ac44
// --- basic block ---
// 0x0100ac40: 0x100ac40: sw    zero, 30640(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100ac44: 0x100ac44: lw    a0, 6168(s0)
	...
	ldelem.i4
	stloc.1
// 0x0100ac48: 0x100ac48: jal   0x1015ce0 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100ac84: 0x100ac84: addu  s2, a0, zero
	ldloc.1
	stloc 10
// 0x0100ac88: 0x100ac88: jal   0x104232c sw    s0, 24(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl50::roadmap_city_init_104232c(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x0100acb0: 0x100acb0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100acb4: 0x100acb4: sw    s0, 30640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100acb8: 0x100acb8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100acbc: 0x100acbc: lw    v0, 23796(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100ad70: 0x100ad70: addiu a0, a0, 25252
	...
	add
	stloc.1
// 0x0100ad74: 0x100ad74: jal   0x1015b0c addiu a1, zero, 512
	ldc.i4 512
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0100ad8c: 0x100ad8c: lui   v1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x0100ad90: 0x100ad90: sw    zero, 30640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100adfc: 0x100adfc: mult  s0, s4
	...
	stloc 18
L_100ae00:
// 0x0100ae00: 0x100ae00: lw    v0, 30640(s5)
	ldloc 5
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x0100ae40: 0x100ae40: lw    v0, 0(v0)
	...
	ldelem.i4
	stloc 6
// 0x0100ae44: 0x100ae44: jal   0x100ddec sw    zero, 8(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100ae68: 0x100ae68: addiu a2, zero, 1
	ldc.i4.1
	stloc.3
// 0x0100ae6c: 0x100ae6c: jal   0x100d5e0 addu  a3, s6, zero
	ldloc 15
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x0100aebc: 0x100aebc: jal   0x100ca5c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100aedc: 0x100aedc: jal   0x100ca5c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100aee4: 0x100aee4: lui   v1, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100aee8: 0x100aee8: lw    v1, 30644(v1)
	ldloc 8
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100af00: 0x100af00: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100af04: 0x100af04: lw    v1, 30640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100af3c: 0x100af3c: lw    a0, 4(v0)
	...
	ldelem.i4
	stloc.1
// 0x0100af40: 0x100af40: jal   0x100c754 sll   zero, zero, 0
	ldloc.1
	call int32 Cibyl8::roadmap_tile_get_scale_shift_100c754(int32)
	stloc 5
// --- basic block ---
L_100af48:
...
// 0x0100af58: 0x100af58: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100af5c: 0x100af5c: lw    v1, 30640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100af9c: 0x100af9c: lw    a0, 4(v0)
	...
	ldelem.i4
	stloc.1
// 0x0100afa0: 0x100afa0: jal   0x100c730 sll   zero, zero, 0
	ldloc.1
	call int32 Cibyl8::roadmap_tile_get_scale_factor_100c730(int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x0100afd8: 0x100afd8: lui   v1, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100afdc: 0x100afdc: lw    a1, 30640(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b118: 0x100b118: jal   0x100c98c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100b12c: 0x100b12c: beq   v0, zero, 0x100b140 sll   zero, zero, 0
	...
	brfalse L_100b140
// --- basic block ---
// 0x0100b134: 0x100b134: jal   0x100c98c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100b144: 0x100b144: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b148: 0x100b148: sw    a0, 30644(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b168: 0x100b168: jal   0x100c98c addu  s2, a0, zero
	ldloc.1
	stloc 9
	ldloc.0
	ldloc.1
...
// 0x0100b17c: 0x100b17c: bne   v0, zero, 0x100b19c addu  a0, s0, zero
	...
	brtrue L_100b19c
// --- basic block ---
// 0x0100b184: 0x100b184: jal   0x100c730 sll   zero, zero, 0
	ldloc.1
	call int32 Cibyl8::roadmap_tile_get_scale_factor_100c730(int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 10
...
// 0x0100b1c4: 0x100b1c4: lui   s0, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100b1c8: 0x100b1c8: lw    v0, 30640(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100b1e0: 0x100b1e0: lw    a0, 6168(v0)
	...
	ldelem.i4
	stloc.1
// 0x0100b1e4: 0x100b1e4: jal   0x1015768 addu  a1, s1, zero
	ldloc 9
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0100b1f4: 0x100b1f4: mult  v0, s2
	...
	mul
	stloc 12
// 0x0100b1f8: 0x100b1f8: lw    v1, 30640(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100b214: 0x100b214: lw    a0, 6168(v1)
	...
	ldelem.i4
	stloc.1
// 0x0100b218: 0x100b218: jal   0x1015994 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100b268: 0x100b268: bgez  v0, 0x100b320 lui   v1, 0x20000
	...
	bge L_100b320
// --- basic block ---
// 0x0100b270: 0x100b270: jal   0x100ddec addu  a0, s1, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0100b2a0: 0x100b2a0: sw    v0, 0(s0)
	...
	stelem.i4
L_100b2a4:
// 0x0100b2a4: 0x100b2a4: jal   0x1013aa4 addu  a0, s1, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl14::roadmap_locator_load_tile_1013aa4(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 5
	stloc 7
// --- basic block ---
...
// --- basic block ---
L_100b320:
// 0x0100b320: 0x100b320: lw    v1, 30640(v1)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b3c4: 0x100b3c4: addiu s2, zero, 11
	...
	stloc 13
L_100b3c8:
// 0x0100b3c8: 0x100b3c8: lw    v1, 30640(s3)
	ldloc 6
	ldloc 14
	ldc.i4.2
	shr.un
