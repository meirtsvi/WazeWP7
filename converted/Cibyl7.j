...
// 0x0100a048: 0x100a048: lui   v0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0100a04c: 0x100a04c: lw    v0, 31448(v0)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0100a084: 0x100a084: lui   v0, 0x20000
	ldc.i4 131072
	stloc.0
// 0x0100a088: 0x100a088: lw    v1, 31448(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100a0a4: 0x100a0a4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a0a8: 0x100a0a8: lw    v1, 31448(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a0b0: 0x100a0b0: bne   a0, v1, 0x100a0bc sw    ra, 20(sp)
	...
	bne.un L_100a0bc
// --- basic block ---
// 0x0100a0b8: 0x100a0b8: sw    zero, 31448(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a0ec: 0x100a0ec: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x0100a0f0: 0x100a0f0: lw    v0, 24968(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a118: 0x100a118: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a11c: 0x100a11c: beq   s0, zero, 0x100a130 sw    s0, 31448(v0)
	ldloc 7
	ldloc 6
	ldloc 5
	ldc.i4.2
...
// 0x0100a128: 0x100a128: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a12c: 0x100a12c: sw    v1, 31452(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a178: 0x100a178: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x0100a17c: 0x100a17c: lw    v1, 24968(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100a218: 0x100a218: lui   v0, 0x20000
	ldc.i4 131072
	stloc.0
// 0x0100a21c: 0x100a21c: lw    v1, 31456(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100a238: 0x100a238: lui   v0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0100a23c: 0x100a23c: lw    v0, 31456(v0)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0100a25c: 0x100a25c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 4
// 0x0100a260: 0x100a260: lw    v1, 31456(v0)
	ldloc 5
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0100a2c4: 0x100a2c4: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x0100a2c8: 0x100a2c8: lw    v0, 24972(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a2fc: 0x100a2fc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a300: 0x100a300: lw    v1, 31456(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a308: 0x100a308: bne   v1, s0, 0x100a314 sll   zero, zero, 0
	...
	bne.un L_100a314
// --- basic block ---
// 0x0100a310: 0x100a310: sw    zero, 31456(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a344: 0x100a344: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x0100a348: 0x100a348: lw    v0, 24972(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a388: 0x100a388: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a38c: 0x100a38c: sw    s0, 31456(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a3ec: 0x100a3ec: lui   v1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100a3f0: 0x100a3f0: lw    v1, 24972(v1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100a490: 0x100a490: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100a494: 0x100a494: lw    v0, 31456(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100a53c: 0x100a53c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a540: 0x100a540: lw    v0, 31456(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a590: 0x100a590: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x0100a594: 0x100a594: lw    v0, 24976(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a5bc: 0x100a5bc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a5c0: 0x100a5c0: beq   s0, zero, 0x100a5d4 sw    s0, 31460(v0)
	ldloc 7
	ldloc 6
	ldloc 5
	ldc.i4.2
...
// 0x0100a5cc: 0x100a5cc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a5d0: 0x100a5d0: sw    v1, 31464(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a5e8: 0x100a5e8: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x0100a5ec: 0x100a5ec: lw    v0, 24976(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a620: 0x100a620: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a624: 0x100a624: lw    v1, 31460(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a62c: 0x100a62c: bne   v1, s0, 0x100a638 sll   zero, zero, 0
	...
	bne.un L_100a638
// --- basic block ---
// 0x0100a634: 0x100a634: sw    zero, 31460(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a688: 0x100a688: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x0100a68c: 0x100a68c: lw    v1, 24976(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100a740: 0x100a740: lui   v0, 0x20000
	ldc.i4 131072
	stloc.0
// 0x0100a744: 0x100a744: jr    ra sw    v1, 31476(v0)
	ldloc 3
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100a76c: 0x100a76c: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x0100a770: 0x100a770: lw    v0, 24980(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a7a0: 0x100a7a0: sw    s0, 31468(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a870: 0x100a870: lui   v1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100a874: 0x100a874: lw    s3, 31468(v1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100a8f0: 0x100a8f0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a8f4: 0x100a8f4: lw    v1, 31468(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100a934: 0x100a934: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100a938: 0x100a938: lw    a0, 31468(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100aa5c: 0x100aa5c: mult  s0, s2
	...
	mul
	stloc 9
// 0x0100aa60: 0x100aa60: lw    v0, 31468(s3)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x0100aaac: 0x100aaac: mult  s0, s2
	...
	stloc 9
L_100aab0:
// 0x0100aab0: 0x100aab0: lw    v0, 31468(s3)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x0100aac8: 0x100aac8: addiu v0, s0, 1
	...
	add
	stloc 6
// 0x0100aacc: 0x100aacc: lw    a1, 31468(s3)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x0100ab24: 0x100ab24: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 6
// 0x0100ab28: 0x100ab28: lw    v0, 24980(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100ab6c: 0x100ab6c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100ab70: 0x100ab70: lw    v1, 31468(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100ab78: 0x100ab78: bne   v1, s0, 0x100ab84 sll   zero, zero, 0
	...
	bne.un L_100ab84
// --- basic block ---
// 0x0100ab80: 0x100ab80: sw    zero, 31468(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100abf0: 0x100abf0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100abf4: 0x100abf4: sw    s0, 31468(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100abf8: 0x100abf8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100abfc: 0x100abfc: lw    v0, 24980(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100accc: 0x100accc: lui   v1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x0100acd0: 0x100acd0: sw    zero, 31468(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100ad3c: 0x100ad3c: mult  s0, s4
	...
	stloc 18
L_100ad40:
// 0x0100ad40: 0x100ad40: lw    v0, 31468(s5)
	ldloc 5
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x0100ae24: 0x100ae24: lui   v1, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100ae28: 0x100ae28: lw    v1, 31472(v1)
	ldloc 8
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100ae40: 0x100ae40: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100ae44: 0x100ae44: lw    v1, 31468(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100ae98: 0x100ae98: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100ae9c: 0x100ae9c: lw    v1, 31468(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100af18: 0x100af18: lui   v1, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100af1c: 0x100af1c: lw    a1, 31468(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b084: 0x100b084: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b088: 0x100b088: sw    a0, 31472(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b104: 0x100b104: lui   s0, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100b108: 0x100b108: lw    v0, 31468(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100b134: 0x100b134: mult  v0, s2
	...
	mul
	stloc 12
// 0x0100b138: 0x100b138: lw    v1, 31468(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100b260:
// 0x0100b260: 0x100b260: lw    v1, 31468(v1)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b304: 0x100b304: addiu s2, zero, 11
	...
	stloc 13
L_100b308:
// 0x0100b308: 0x100b308: lw    v1, 31468(s3)
	ldloc 6
	ldloc 14
	ldc.i4.2
	shr.un
