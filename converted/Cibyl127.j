...
// 0x010a9cf8: 0x10a9cf8: addiu v0, v0, -23184
	ldloc 5
	ldc.i4 -23184
	add
	stloc 5
// 0x010a9cfc: 0x10a9cfc: addiu v1, v1, -22784
	ldloc 6
	ldc.i4 -22784
	add
	stloc 6
...
// 0x010a9d2c: 0x10a9d2c: addiu a0, a0, -24444
	...
	add
	stloc.1
// 0x010a9d30: 0x10a9d30: jal   0x106ab74 sw    v0, -32700(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a9d3c: 0x10a9d3c: lui   v1, 0x90000
	ldc.i4 589824
	stloc 6
// 0x010a9d40: 0x10a9d40: sw    v0, -32696(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a9d64: 0x10a9d64: lui   v0, 0x90000
	ldc.i4 589824
	stloc 5
// 0x010a9d68: 0x10a9d68: lw    v0, -32700(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a9d98: 0x10a9d98: sw    s0, 36(sp)
	...
	ldloc 7
	stelem.i4
// 0x010a9d9c: 0x10a9d9c: lw    s0, -32704(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a9dc4: 0x10a9dc4: addiu a0, zero, 1
	ldc.i4.1
	stloc.1
// 0x010a9dc8: 0x10a9dc8: j	 0x10a9e3c sw    a0, -32704(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a9ddc: 0x10a9ddc: addiu s0, s0, 1
	...
	add
	stloc 7
// 0x010a9de0: 0x10a9de0: sw    s0, -32704(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a9df4: 0x10a9df4: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 6
// 0x010a9df8: 0x10a9df8: addiu v0, v0, -23184
	ldloc 6
	ldc.i4 -23184
	add
	stloc 6
...
// 0x010a9e40: 0x10a9e40: sll   a0, s0, 2
	...
	shl
	stloc.1
// 0x010a9e44: 0x10a9e44: addiu t1, t1, -23184
	ldloc 8
	ldc.i4 -23184
	add
	stloc 8
...
// 0x010a9f64: 0x10a9f64: beq   v0, zero, 0x10a9fc8 addiu a0, zero, 1
	...
	brfalse L_10a9fc8
// --- basic block ---
// 0x010a9f6c: 0x10a9f6c: lw    v0, -32708(s1)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x010a9f78: 0x10a9f78: slti  v1, v0, 4
	...
	clt
	stloc 7
// 0x010a9f7c: 0x10a9f7c: beq   v1, zero, 0x10aa014 sw    v0, -32708(s1)
	ldloc 7
	ldloc 5
	ldloc 13
	ldc.i4.2
...
// --- basic block ---
L_10aa12c:
// 0x010aa12c: 0x10aa12c: lw    v0, -32696(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010aa278: 0x10aa278: addu  s0, v0, zero
	ldloc 5
	stloc 9
// 0x010aa27c: 0x10aa27c: addiu s4, s4, 29948
	ldloc 10
	ldc.i4 29948
	add
	stloc 10
...
// 0x010aa2a0: 0x10aa2a0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010aa2a4: 0x10aa2a4: addiu v0, v0, 29948
	ldloc 5
	ldc.i4 29948
	add
	stloc 5
...
// 0x010aa650: 0x10aa650: addu  a0, s2, zero
	ldloc 8
	stloc.1
// 0x010aa654: 0x10aa654: addiu a1, a1, 22852
	ldloc.2
	ldc.i4 22852
	add
	stloc.2
...
// 0x010aa754: 0x10aa754: sll   v1, v1, 2
	...
	shl
	stloc 5
// 0x010aa758: 0x10aa758: addiu s1, s1, -23184
	ldloc 8
	ldc.i4 -23184
	add
	stloc 8
...
// 0x010aab28: 0x10aab28: lui   v0, 0x90000
	ldc.i4 589824
	stloc 5
// 0x010aab2c: 0x10aab2c: lw    v1, -32688(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x010aab30: 0x10aab30: addiu v0, v0, -32468
	ldloc 5
	ldc.i4 -32468
	add
	stloc 5
...
// 0x010aabf4: 0x10aabf4: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x010aabf8: 0x10aabf8: sw    v0, -32688(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010aac0c: 0x10aac0c: addu  s0, v0, zero
	ldloc 5
	stloc 8
// 0x010aac10: 0x10aac10: lw    v0, -32692(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010aac28: 0x10aac28: jal   0x106a324 addu  a0, s0, zero
	...
	stloc 5
// --- basic block ---
// 0x010aac30: 0x10aac30: sw    v0, -32692(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010aac34: 0x10aac34: lui   v0, 0x90000
	...
	stloc 5
L_10aac38:
// 0x010aac38: 0x10aac38: lw    v0, -32692(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010aac54: 0x10aac54: addiu a0, zero, 1
	ldc.i4.1
	stloc.1
// 0x010aac58: 0x10aac58: addiu a2, zero, 990
	ldc.i4 990
	stloc.3
...
// 0x010aac78: 0x10aac78: addiu a0, zero, 4
	ldc.i4.4
	stloc.1
// 0x010aac7c: 0x10aac7c: jal   0x100449c addiu a2, zero, 996
	ldc.i4 996
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x010aacd4: 0x10aacd4: addiu a1, s0, 13632
	...
	add
	stloc.2
// 0x010aacd8: 0x10aacd8: addiu a2, zero, 1094
	ldc.i4 1094
	stloc.3
// 0x010aacdc: 0x10aacdc: addiu a3, a3, 13720
	...
	add
	stloc 4
// 0x010aace0: 0x10aace0: sw    s3, -32344(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010aacec: 0x10aacec: lui   v0, 0x90000
	ldc.i4 589824
	stloc 6
// 0x010aacf0: 0x10aacf0: lw    a2, -32692(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010aad0c: 0x10aad0c: addiu a3, a3, 13760
	...
	add
	stloc 4
// 0x010aad10: 0x10aad10: addiu a2, zero, 1096
	ldc.i4 1096
	stloc.3
...
// 0x010aad40: 0x10aad40: lui   a1, 0x10b0000
	ldc.i4 17498112
	stloc.2
// 0x010aad44: 0x10aad44: addiu a1, a1, -15372
	ldloc.2
	ldc.i4 -15372
	add
	stloc.2
