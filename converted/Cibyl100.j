...
// 0x0108585c: 0x108585c: lui   s0, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01085860: 0x1085860: jal   0x1096308 sw    v1, -1968(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x01085868: 0x1085868: lw    v0, -1976(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01085870: 0x1085870: beq   v0, zero, 0x1085884 sll   zero, zero, 0
	...
	brfalse L_1085884
// --- basic block ---
// 0x01085878: 0x1085878: jal   0x1094cdc addiu a0, zero, 2
	ldc.i4.2
	stloc.1
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x01085880: 0x1085880: sw    zero, -1976(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01085884: 0x1085884: lui   s0, 0x0
	ldc.i4.s 0
	stloc 7
// 0x01085888: 0x1085888: jal   0x109a5b0 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0108589c: 0x108589c: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x010858a0: 0x10858a0: jal   0x109c690 sltu  s1, zero, v0
	ldc.i4.s 0
	ldloc 5
	clt.un
	stloc 9
...
// 0x010858b0: 0x10858b0: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x010858b4: 0x10858b4: jal   0x109c690 addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x010858e4: 0x10858e4: sw    zero, 24(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x010858e8: 0x10858e8: jal   0x109c97c sw    s0, 28(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010858f0: 0x10858f0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010858f4: 0x10858f4: sw    s0, -1976(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01085920: 0x1085920: sw    s0, 44(sp)
	...
	ldloc 8
	stelem.i4
// 0x01085924: 0x1085924: beq   a0, zero, 0x10859e8 sw    zero, -1976(v0)
	ldloc.1
	ldloc 6
	ldloc 5
	ldc.i4.2
...
// --- basic block ---
L_1085954:
// 0x01085954: 0x1085954: jal   0x109bd98 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0108595c: 0x108595c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01085960: 0x1085960: lw    a0, -1972(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01085974: 0x1085974: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01085978: 0x1085978: lw    a0, -1972(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01085a0c: 0x1085a0c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01085a10: 0x1085a10: lw    a0, -1972(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01085a14: 0x1085a14: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01085a18: 0x1085a18: lw    a1, -1968(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01085a68: 0x1085a68: sw    s4, 48(sp)
	...
	ldloc 9
	stelem.i4
// 0x01085a6c: 0x1085a6c: jal   0x10a1aa4 sw    s2, 40(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01085a80: 0x1085a80: addiu a1, zero, 1
	ldc.i4.1
	stloc.2
// 0x01085a84: 0x1085a84: jal   0x10a1aa4 addu  s5, v0, zero
	ldloc 6
	stloc 13
	ldloc.0
	ldloc.1
...
// 0x01085a98: 0x1085a98: addiu a1, zero, 1
	ldc.i4.1
	stloc.2
// 0x01085a9c: 0x1085a9c: jal   0x10a1aa4 addu  s3, v0, zero
	ldloc 6
	stloc 12
	ldloc.0
	ldloc.1
...
// 0x01085bcc: 0x1085bcc: jal   0x1094c0c addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01085bd4: 0x1085bd4: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01085bd8: 0x1085bd8: lw    a0, -1972(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01085c00: 0x1085c00: sw    s2, 40(sp)
	...
	ldloc 10
	stelem.i4
// 0x01085c04: 0x1085c04: jal   0x10941cc sw    s1, 36(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01085c48: 0x1085c48: addiu s2, zero, 1
	ldc.i4.1
	stloc 10
// 0x01085c4c: 0x1085c4c: j	 0x1085c6c sw    v1, -1968(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01085c60: 0x1085c60: lui   v0, 0x80000
	...
	stloc 5
L_1085c64:
// 0x01085c64: 0x1085c64: sw    v1, -1968(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01085c6c: 0x1085c6c: lui   s0, 0x80000
	ldc.i4 524288
	stloc 8
// 0x01085c70: 0x1085c70: lw    v0, -1976(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01085c78: 0x1085c78: beq   v0, zero, 0x1085c8c sll   zero, zero, 0
	...
	brfalse L_1085c8c
// --- basic block ---
// 0x01085c80: 0x1085c80: jal   0x1094cdc addiu a0, zero, 2
	ldc.i4.2
	stloc.1
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x01085c88: 0x1085c88: sw    zero, -1976(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
	...
	stelem.i4
L_1085c8c:
// 0x01085c8c: 0x1085c8c: jal   0x109a5b0 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01085ca4: 0x1085ca4: addiu a1, zero, 3
	ldc.i4.3
	stloc.2
// 0x01085ca8: 0x1085ca8: jal   0x109c690 addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x01085cd8: 0x1085cd8: sw    zero, 16(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01085cdc: 0x1085cdc: jal   0x109c97c sw    zero, 24(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01085ce8: 0x1085ce8: lui   v1, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01085cec: 0x1085cec: sw    v0, -1976(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
