...
// 0x0107e73c: 0x107e73c: sw    s0, 16(sp)
	...
	ldloc 8
	stelem.i4
// 0x0107e740: 0x107e740: beq   v0, zero, 0x107e7ec sw    a0, 15936(v1)
	ldloc 5
	ldloc 7
	ldloc 6
	ldc.i4.2
...
// 0x0107e814: 0x107e814: sw    s0, 16(sp)
	...
	ldloc 8
	stelem.i4
// 0x0107e818: 0x107e818: beq   v0, zero, 0x107e8cc sw    a0, 15936(v1)
	ldloc 5
	ldloc 7
	ldloc 6
	ldc.i4.2
...
// 0x0107ea44: 0x107ea44: addiu a0, a0, -13756
	...
	add
	stloc.1
// 0x0107ea48: 0x107ea48: addiu a1, a1, 15956
	ldloc.2
	ldc.i4 15956
	add
	stloc.2
...
// 0x0107ea64: 0x107ea64: addiu a0, a0, -13756
	...
	add
	stloc.1
// 0x0107ea68: 0x107ea68: addiu a1, a1, 15956
	ldloc.2
	ldc.i4 15956
	add
	stloc.2
...
// 0x0107ea80: 0x107ea80: lui   a0, 0x80000
	ldc.i4 524288
	stloc.1
// 0x0107ea84: 0x107ea84: addiu a1, a1, 15956
	ldloc.2
	ldc.i4 15956
	add
	stloc.2
...
// 0x0107eac8: 0x107eac8: beq   v1, zero, 0x107eb00 lui   v1, 0x0
	...
	brfalse L_107eb00
// --- basic block ---
// 0x0107ead0: 0x107ead0: lw    a0, 15936(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0107eb94: 0x107eb94: addiu a0, a0, -13756
	...
	add
	stloc.1
// 0x0107eb98: 0x107eb98: jal   0x100844c addiu a1, a1, 15956
	ldloc.2
	ldc.i4 15956
	add
	stloc.2
...
// 0x0107ebac: 0x107ebac: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0107ebb0: 0x107ebb0: sw    v1, 15956(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0107ecb4: 0x107ecb4: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0107ecb8: 0x107ecb8: lw    a0, 15936(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0107ecd0: 0x107ecd0: bne   v1, zero, 0x107ecdc addiu v1, zero, 2
	...
	brtrue L_107ecdc
// --- basic block ---
// 0x0107ecd8: 0x107ecd8: sw    v1, 15936(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0107ecf8: 0x107ecf8: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0107ecfc: 0x107ecfc: sw    v1, 15936(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0107f524: 0x107f524: addiu a0, zero, 2
	ldc.i4.2
	stloc.1
// 0x0107f528: 0x107f528: sw    a0, 15820(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0107f898: 0x107f898: lw    s1, 1264(s0)
	...
	ldelem.i4
	stloc 9
// 0x0107f89c: 0x107f89c: jal   0x100e7a8 addiu a0, a0, 15960
	ldloc.1
	ldc.i4 15960
	add
	stloc.1
...
// 0x0107f8a8: 0x107f8a8: beq   v0, zero, 0x107f8c4 lui   v0, 0x0
	...
	brfalse L_107f8c4
// --- basic block ---
// 0x0107f8b0: 0x107f8b0: lw    v0, 15824(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_107f94c:
// 0x0107f94c: 0x107f94c: lw    v0, 15824(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0107f980: 0x107f980: lw    s3, 1264(s0)
	...
	ldelem.i4
	stloc 11
// 0x0107f984: 0x107f984: jal   0x100e7a8 addiu a0, s2, 15960
	ldloc 10
	ldc.i4 15960
	add
	stloc.1
...
// 0x0107f98c: 0x107f98c: slt   v0, v0, s3
	...
	clt
	stloc 5
// 0x0107f990: 0x107f990: beq   v0, zero, 0x107f9c4 addiu a0, s2, 15960
	ldloc 5
	ldloc 10
	ldc.i4 15960
	add
