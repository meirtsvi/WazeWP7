...
// 0x0103e40c: 0x103e40c: addiu a1, sp, 16
	...
	add
	stloc.2
// 0x0103e410: 0x103e410: jal   0x10aa078 addiu a2, zero, 1
	ldc.i4.1
	stloc.3
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl127::roadmap_trip_server_create_poi_10aa078(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 8
	stloc 5
// --- basic block ---
...
// 0x0103e620: 0x103e620: lw    a0, 8(s0)
	...
	ldelem.i4
	stloc.1
// 0x0103e624: 0x103e624: jal   0x10c0918 addiu s1, sp, 32
	ldloc.0
	ldc.i4.s 32
	add
	stloc 10
...
// 0x0103e62c: 0x103e62c: addu  a1, v1, zero
	ldloc 8
	stloc.2
// 0x0103e630: 0x103e630: jal   0x10c0a50 addu  a0, v0, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103e644: 0x103e644: lw    a0, 16(s0)
	...
	ldelem.i4
	stloc.1
// 0x0103e648: 0x103e648: jal   0x10c0918 sw    v0, 32(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103e650: 0x103e650: addu  a1, v1, zero
	ldloc 8
	stloc.2
// 0x0103e654: 0x103e654: jal   0x10c0a50 addu  a0, v0, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103efd8: 0x103efd8: bne   v0, zero, 0x103eff0 lui   a0, 0x10000
	...
	brtrue L_103eff0
// --- basic block ---
// 0x0103efe0: 0x103efe0: jal   0x10aaed4 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103effc: 0x103effc: bne   v0, zero, 0x103f014 lui   a0, 0x10000
	...
	brtrue L_103f014
// --- basic block ---
// 0x0103f004: 0x103f004: jal   0x10aae64 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103f020: 0x103f020: bne   v0, zero, 0x103f038 lui   a0, 0x10000
	...
	brtrue L_103f038
// --- basic block ---
// 0x0103f028: 0x103f028: jal   0x10aada4 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103f044: 0x103f044: bne   v0, zero, 0x103f05c lui   a0, 0x10000
	...
	brtrue L_103f05c
// --- basic block ---
// 0x0103f04c: 0x103f04c: jal   0x10aae04 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_103f150:
// 0x0103f150: 0x103f150: jal   0x10ac4f8 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103f2ec: 0x103f2ec: addu  s1, v0, zero
	...
	stloc 8
L_103f2f0:
// 0x0103f2f0: 0x103f2f0: jal   0x10ac4f8 addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.0
	ldloc.1
