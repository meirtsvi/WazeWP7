...
// 0x0103e40c: 0x103e40c: addiu a1, sp, 16
	...
	add
	stloc.2
// 0x0103e410: 0x103e410: jal   0x10aa034 addiu a2, zero, 1
	ldc.i4.1
	stloc.3
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x0103e418: 0x103e418: jal   0x1094bc8 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103e620: 0x103e620: lw    a0, 8(s0)
	...
	ldelem.i4
	stloc.1
// 0x0103e624: 0x103e624: jal   0x10c08d8 addiu s1, sp, 32
	ldloc.0
	ldc.i4.s 32
	add
	stloc 10
...
// 0x0103e62c: 0x103e62c: addu  a1, v1, zero
	ldloc 8
	stloc.2
// 0x0103e630: 0x103e630: jal   0x10c0a10 addu  a0, v0, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103e644: 0x103e644: lw    a0, 16(s0)
	...
	ldelem.i4
	stloc.1
// 0x0103e648: 0x103e648: jal   0x10c08d8 sw    v0, 32(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103e650: 0x103e650: addu  a1, v1, zero
	ldloc 8
	stloc.2
// 0x0103e654: 0x103e654: jal   0x10c0a10 addu  a0, v0, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103e6dc: 0x103e6dc: beq   s3, zero, 0x103e704 addu  a1, s1, zero
	...
	brfalse L_103e704
// --- basic block ---
// 0x0103e6e4: 0x103e6e4: jal   0x10595e0 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0103e6ec: 0x103e6ec: addu  a0, s1, zero
	ldloc 10
	stloc.1
// 0x0103e6f0: 0x103e6f0: jal   0x105cbf0 addiu a1, sp, 40
	ldloc.0
	ldc.i4.s 40
	add
	stloc.2
...
// --- basic block ---
L_103e83c:
// 0x0103e83c: 0x103e83c: jal   0x10690f8 sw    a2, 148(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103e860: 0x103e860: jal   0x100449c addiu a0, zero, 1
	...
	stloc 5
// --- basic block ---
// 0x0103e868: 0x103e868: jal   0x106a58c addu  a0, s0, zero
	ldloc 10
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103e888: 0x103e888: sw    a2, 148(sp)
	...
	ldloc.3
	stelem.i4
// 0x0103e88c: 0x103e88c: jal   0x106ac7c sw    s2, -11704(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0103e928: 0x103e928: addu  a0, a2, zero
	ldloc.3
	stloc.1
// 0x0103e92c: 0x103e92c: jal   0x10725d4 sw    a2, 148(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103e97c: 0x103e97c: sw    v0, 144(sp)
	...
	ldloc 5
	stelem.i4
// 0x0103e980: 0x103e980: jal   0x10725d4 sw    a2, 148(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103e994: 0x103e994: addu  a0, a3, zero
	ldloc 4
	stloc.1
// 0x0103e998: 0x103e998: jal   0x10725d4 sw    a3, 144(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103ea38: 0x103ea38: sw    s2, 20(sp)
	...
	ldloc 11
	stelem.i4
// 0x0103ea3c: 0x103ea3c: jal   0x106a034 sw    s3, 24(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103ebcc: 0x103ebcc: addiu a2, sp, 24
	...
	add
	stloc.3
// 0x0103ebd0: 0x103ebd0: jal   0x10683bc sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103ec9c: 0x103ec9c: lw    a0, 11248(s0)
	...
	ldelem.i4
	stloc.1
// 0x0103eca0: 0x103eca0: jal   0x106a600 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0103ed30: 0x103ed30: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x0103ed34: 0x103ed34: jal   0x106a318 addu  s0, v0, zero
	ldloc 5
	stloc 8
	ldloc.0
	ldloc.1
...
// 0x0103efd8: 0x103efd8: bne   v0, zero, 0x103eff0 lui   a0, 0x10000
	...
	brtrue L_103eff0
// --- basic block ---
// 0x0103efe0: 0x103efe0: jal   0x10aae90 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103effc: 0x103effc: bne   v0, zero, 0x103f014 lui   a0, 0x10000
	...
	brtrue L_103f014
// --- basic block ---
// 0x0103f004: 0x103f004: jal   0x10aae20 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103f020: 0x103f020: bne   v0, zero, 0x103f038 lui   a0, 0x10000
	...
	brtrue L_103f038
// --- basic block ---
// 0x0103f028: 0x103f028: jal   0x10aad60 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103f044: 0x103f044: bne   v0, zero, 0x103f05c lui   a0, 0x10000
	...
	brtrue L_103f05c
// --- basic block ---
// 0x0103f04c: 0x103f04c: jal   0x10aadc0 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_103f150:
// 0x0103f150: 0x103f150: jal   0x10ac4b4 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103f2ec: 0x103f2ec: addu  s1, v0, zero
	...
	stloc 8
L_103f2f0:
// 0x0103f2f0: 0x103f2f0: jal   0x10ac4b4 addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.0
	ldloc.1
