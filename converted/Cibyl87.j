...
// 0x010742bc: 0x10742bc: addiu t0, a1, -31008
	...
	add
	stloc 15
// 0x010742c0: 0x10742c0: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01074420: 0x1074420: addiu t0, a1, -30864
	...
	add
	stloc 15
// 0x01074424: 0x1074424: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01074480: 0x1074480: addiu v0, v0, -30776
	...
	add
	stloc 5
// 0x01074484: 0x1074484: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x010745a8: 0x10745a8: lw    v1, 996(sp)
	...
	ldelem.i4
	stloc 7
// 0x010745ac: 0x10745ac: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01074728: 0x1074728: lw    t0, 1020(sp)
	...
	ldelem.i4
	stloc 8
// 0x0107472c: 0x107472c: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01074934: 0x1074934: addiu t0, t0, -30508
	...
	add
	stloc 9
// 0x01074938: 0x1074938: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x010749e0: 0x10749e0: addiu v0, v0, -30476
	...
	add
	stloc 6
// 0x010749e4: 0x10749e4: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01074a60: 0x1074a60: addiu t0, t0, -30396
	...
	add
	stloc 6
// 0x01074a64: 0x1074a64: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01074adc: 0x1074adc: addiu v0, v0, -30340
	...
	add
	stloc 6
// 0x01074ae0: 0x1074ae0: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01074b54: 0x1074b54: addiu v1, v1, 12324
	...
	add
	stloc 7
// 0x01074b58: 0x1074b58: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01074bd4: 0x1074bd4: addiu v1, v1, 32228
	...
	add
	stloc 7
// 0x01074bd8: 0x1074bd8: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01074c18: 0x1074c18: addiu v0, v0, -30088
	...
	add
	stloc 5
// 0x01074c1c: 0x1074c1c: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01074d38: 0x1074d38: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01074d3c: 0x1074d3c: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01074fb0: 0x1074fb0: lw    a3, 2352(sp)
	...
	ldelem.i4
	stloc 4
// 0x01074fb4: 0x1074fb4: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x01075208: 0x1075208: lw    a2, 2336(sp)
	...
	ldelem.i4
	stloc.3
// 0x0107520c: 0x107520c: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
...
// 0x0107536c: 0x107536c: lw    a2, 2336(sp)
	...
	ldelem.i4
	stloc.3
// 0x01075370: 0x1075370: addiu a0, a0, 15248
	ldloc.1
	ldc.i4 15248
	add
	stloc.1
