...
// 0x01074444: 0x1074444: bne   v0, zero, 0x1074454 lui   v0, 0x20000
	...
	brtrue L_1074454
// --- basic block ---
// 0x0107444c: 0x107444c: j	 0x107445c addiu v0, v0, 18792
	ldloc 6
	ldc.i4 18792
	add
	stloc 6
...
// 0x010745a4: 0x10745a4: bne   v0, zero, 0x10745b4 lui   v1, 0x20000
	...
	brtrue L_10745b4
// --- basic block ---
// 0x010745ac: 0x10745ac: j	 0x10745bc addiu v1, v1, 18792
	ldloc 7
	ldc.i4 18792
	add
	stloc 7
...
// 0x010745c4: 0x10745c4: bne   v0, zero, 0x10745d4 lui   v0, 0x20000
	...
	brtrue L_10745d4
// --- basic block ---
// 0x010745cc: 0x10745cc: j	 0x10745dc addiu v0, v0, 18792
	ldloc 6
	ldc.i4 18792
	add
	stloc 6
...
// 0x010747c8: 0x10747c8: bne   a3, zero, 0x10747d8 lui   v1, 0x20000
	...
	brtrue L_10747d8
// --- basic block ---
// 0x010747d0: 0x10747d0: j	 0x10747e0 addiu v1, v1, 18792
	ldloc 7
	ldc.i4 18792
	add
	stloc 7
...
// 0x010747e8: 0x10747e8: bne   v0, zero, 0x10747f8 lui   v0, 0x20000
	...
	brtrue L_10747f8
// --- basic block ---
// 0x010747f0: 0x10747f0: j	 0x1074800 addiu v0, v0, 18792
	ldloc 6
	ldc.i4 18792
	add
	stloc 6
...
// 0x01074914: 0x1074914: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01074918: 0x1074918: j	 0x1074928 addiu v0, v0, 18792
	ldloc 5
	ldc.i4 18792
	add
	stloc 5
...
// 0x010749fc: 0x10749fc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01074a00: 0x1074a00: j	 0x1074a10 addiu v0, v0, 18792
	ldloc 5
	ldc.i4 18792
	add
	stloc 5
...
// 0x01074b48: 0x1074b48: sw    s2, 2308(sp)
	...
	ldloc 10
	stelem.i4
// 0x01074b4c: 0x1074b4c: jal   0x1090918 addiu s0, sp, 44
	ldloc.0
	ldc.i4.s 44
	add
	stloc 8
...
// --- basic block ---
L_1074bc0:
// 0x01074bc0: 0x1074bc0: jal   0x1090928 addiu s2, s2, 1
	ldloc 10
	ldc.i4.1
	add
	stloc 10
	ldloc.1
	call int32 Cibyl107::RealtimeExternalPoi_DisplayedList_get_ID_1090928(int32)
	stloc 5
// --- basic block ---
...
// --- basic block ---
L_1074c2c:
// 0x01074c2c: 0x1074c2c: jal   0x1090a6c sw    v0, 2288(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl107::RealtimeExternalPoiNotifier_DisplayedList_clear_1090a6c(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x0107519c: 0x107519c: mflo  lo
	ldloc 18
	stloc 8
// 0x010751a0: 0x10751a0: jal   0x10676d4 addiu s8, s8, 18792
	ldloc 14
	ldc.i4 18792
	add
	stloc 14
