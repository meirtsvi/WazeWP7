...
// 0x010b2238: 0x10b2238: lw    v1, 44(sp)
	...
	ldelem.i4
	stloc 7
// 0x010b223c: 0x10b223c: lw    v0, 19128(s3)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x010b225c: 0x10b225c: addiu a1, zero, 150
	ldc.i4 150
	stloc.2
// 0x010b2260: 0x10b2260: sw    t0, 19128(s3)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x010b2370: 0x10b2370: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b2374: 0x10b2374: lw    a0, 18980(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b2384: 0x10b2384: beq   a0, v0, 0x10b239c lui   s0, 0x0
	...
	beq  L_10b239c
// --- basic block ---
// 0x010b238c: 0x10b238c: bltz  a0, 0x10b23a0 addiu s0, s0, 18968
	ldloc.1
	ldloc 8
	ldc.i4 18968
	add
...
// --- basic block ---
L_10b239c:
// 0x010b239c: 0x10b239c: addiu s0, s0, 18968
	ldloc 8
	ldc.i4 18968
	add
	stloc 8
...
// 0x010b2494: 0x10b2494: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b2498: 0x10b2498: addiu v0, v0, 18968
	ldloc 5
	ldc.i4 18968
	add
	stloc 5
...
// 0x010b2584: 0x10b2584: lw    a0, -11560(s3)
	...
	ldelem.i4
	stloc.1
// 0x010b2588: 0x10b2588: addiu s1, s1, 18892
	ldloc 10
	ldc.i4 18892
	add
	stloc 10
...
// 0x010b25b8: 0x10b25b8: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b25bc: 0x10b25bc: addiu v0, v0, 18968
	ldloc 5
	ldc.i4 18968
	add
	stloc 5
...
// 0x010b26e8: 0x10b26e8: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b26ec: 0x10b26ec: lw    v0, 18892(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b3280: 0x10b3280: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b3284: 0x10b3284: lw    a0, 19136(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b32bc: 0x10b32bc: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b32c0: 0x10b32c0: lw    v1, 19140(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b32c4: 0x10b32c4: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b32c8: 0x10b32c8: sw    v1, 19144(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b3324: 0x10b3324: lui   v1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x010b3328: 0x10b3328: jal   0x10b494c sw    v0, 19136(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10b334c:
// 0x010b334c: 0x10b334c: lw    s5, 19144(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b3698: 0x10b3698: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b369c: 0x10b369c: lw    v1, 19144(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b36b4: 0x10b36b4: lui   s3, 0xe0000
	ldc.i4 917504
	stloc 10
// 0x010b36b8: 0x10b36b8: sw    v1, 19140(s2)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010b3988: 0x10b3988: bne   v0, zero, 0x10b3a0c lui   a1, 0x0
	...
	brtrue L_10b3a0c
// --- basic block ---
// 0x010b3990: 0x10b3990: lw    v0, 19140(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x010b3a98: 0x10b3a98: addiu s2, s2, 1
	...
	add
	stloc 9
// 0x010b3a9c: 0x10b3a9c: sw    v0, 19140(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
