...
// 0x01029d24: 0x1029d24: lui   v0, 0x60000
	ldc.i4 393216
	stloc.2
// 0x01029d28: 0x1029d28: lw    v1, -24212(v0)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01029d30: 0x1029d30: beq   v1, a0, 0x1029d80 addu  a1, zero, zero
	...
	beq  L_1029d80
// --- basic block ---
// 0x01029d38: 0x1029d38: addiu v0, v0, -24212
	ldloc.2
	ldc.i4 -24212
	add
	stloc.2
...
// 0x01029d80: 0x1029d80: sll   a1, a1, 2
	...
	shl
	stloc.1
// 0x01029d84: 0x1029d84: addiu v0, v0, -24212
	ldloc.2
	ldc.i4 -24212
	add
	stloc.2
...
// 0x01029d98: 0x1029d98: lui   v0, 0x60000
	ldc.i4 393216
	stloc.0
// 0x01029d9c: 0x1029d9c: jr    ra sw    zero, -25000(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01029da4: 0x1029da4: lui   v0, 0x60000
	ldc.i4 393216
	stloc.0
// 0x01029da8: 0x1029da8: addiu v0, v0, -25052
	ldloc.0
	ldc.i4 -25052
	add
	stloc.0
...
// 0x01029e60: 0x1029e60: lui   v0, 0x60000
	ldc.i4 393216
	stloc.0
// 0x01029e64: 0x1029e64: lw    v1, -25236(v0)
	ldloc 3
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01029e88: 0x1029e88: lui   v0, 0x60000
	ldc.i4 393216
	stloc 6
// 0x01029e8c: 0x1029e8c: lw    v1, -25232(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01029eec: 0x1029eec: lw    a1, 6576(s3)
	...
	ldelem.i4
	stloc.2
// 0x01029ef0: 0x1029ef0: addiu a0, v1, -25052
	ldloc 7
	ldc.i4 -25052
	add
	stloc.1
// 0x01029ef4: 0x1029ef4: addiu a3, zero, 1
	ldc.i4.1
	stloc 4
// 0x01029ef8: 0x1029ef8: sw    a3, -25232(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01029efc: 0x1029efc: sw    a2, 8(a0)
	...
	ldloc.3
	stelem.i4
// 0x01029f00: 0x1029f00: sw    s1, -25052(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01029f30: 0x1029f30: addu  a0, s0, zero
	ldloc 8
	stloc.1
// 0x01029f34: 0x1029f34: jalr  s2 addiu a2, a2, -25020
	ldloc 11
	ldloc.3
	ldc.i4 -25020
	add
...
// 0x01029f3c: 0x1029f3c: lui   a0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x01029f40: 0x1029f40: addiu a0, a0, -24992
	ldloc.1
	ldc.i4 -24992
	add
	stloc.1
...
// 0x01029f4c: 0x1029f4c: lui   v0, 0x60000
	ldc.i4 393216
	stloc 6
// 0x01029f50: 0x1029f50: addiu v0, v0, -25052
	ldloc 6
	ldc.i4 -25052
	add
	stloc 6
...
// 0x01029f5c: 0x1029f5c: sw    v1, 56(v0)
	...
	ldloc 7
	stelem.i4
// 0x01029f60: 0x1029f60: sw    zero, -25232(a0)
	ldloc 5
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0102a064: 0x102a064: lw    s0, 28(sp)
	...
	ldelem.i4
	stloc 9
// 0x0102a068: 0x102a068: sw    v0, -25228(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0102a2d0: 0x102a2d0: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0102a2d4: 0x102a2d4: lw    v1, -25060(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102a3c4: 0x102a3c4: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0102a3c8: 0x102a3c8: lw    v0, -25228(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102a610: 0x102a610: jal   0x100e5e0 sw    v1, -25224(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102a63c: 0x102a63c: jal   0x1019584 sw    zero, -25224(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102a710: 0x102a710: addiu sp, sp, -624
	...
	add
	stloc.0
// 0x0102a714: 0x102a714: addiu v1, v1, 29604
	ldloc 7
	ldc.i4 29604
	add
	stloc 7
...
// 0x0102ad00: 0x102ad00: lw    s8, 1816(v0)
	...
	ldelem.i4
	stloc 15
// 0x0102ad04: 0x102ad04: jal   0x1009844 addiu a0, s2, -24992
	ldloc 10
	ldc.i4 -24992
	add
	stloc.1
...
// 0x0102ad1c: 0x102ad1c: lw    s3, 16(s3)
	...
	ldelem.i4
	stloc 9
// 0x0102ad20: 0x102ad20: addiu a0, s2, -24992
	ldloc 10
	ldc.i4 -24992
	add
	stloc.1
...
// 0x0102adf4: 0x102adf4: lui   a0, 0x20000
	...
	stloc.1
L_102adf8:
// 0x0102adf8: 0x102adf8: lw    v0, 31356(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0102b1b4: 0x102b1b4: lw    s0, 40(sp)
	...
	ldelem.i4
	stloc 9
// 0x0102b1b8: 0x102b1b8: sw    v1, -24984(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102b1c4: 0x102b1c4: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0102b1c8: 0x102b1c8: lw    v0, -25236(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102b20c: 0x102b20c: addu  a0, a1, a0
	...
	add
	stloc.1
// 0x0102b210: 0x102b210: jal   0x10b9c9c addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl138::editor_cleanup_test_10b9c9c(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x0102b218: 0x102b218: lui   s3, 0x60000
	ldc.i4 393216
	stloc 9
// 0x0102b21c: 0x102b21c: lw    v0, -25056(s3)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0102b220: 0x102b220: lui   v1, 0x60000
	ldc.i4 393216
	stloc 6
// 0x0102b224: 0x102b224: sw    s1, -25236(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0102b268: 0x102b268: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x0102b26c: 0x102b26c: sw    v0, -25056(s3)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0102b270: 0x102b270: lui   v0, 0x60000
	...
	stloc 5
L_102b274:
// 0x0102b274: 0x102b274: lw    v0, -25056(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102b284: 0x102b284: lui   v1, 0x60000
	ldc.i4 393216
	stloc 6
// 0x0102b288: 0x102b288: lw    t0, -25060(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0102b2cc: 0x102b2cc: addiu a2, zero, 705
	ldc.i4 705
	stloc.3
// 0x0102b2d0: 0x102b2d0: j	 0x102b30c sw    t0, -25060(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0102b304: 0x102b304: addiu a2, zero, 708
	ldc.i4 708
	stloc.3
// 0x0102b308: 0x102b308: sw    zero, -25060(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0102b3a8: 0x102b3a8: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0102b3ac: 0x102b3ac: sw    v1, -25068(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102b3b0: 0x102b3b0: lw    v1, 4(s0)
	...
	ldelem.i4
	stloc 6
// 0x0102b3b4: 0x102b3b4: addiu v0, v0, -25068
	ldloc 5
	ldc.i4 -25068
	add
	stloc 5
...
// 0x0102b3cc: 0x102b3cc: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0102b3d0: 0x102b3d0: lw    v0, -24984(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102b4a4: 0x102b4a4: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0102b4a8: 0x102b4a8: sw    v1, -25068(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102b4ac: 0x102b4ac: lw    v1, 4(s0)
	...
	ldelem.i4
	stloc 6
// 0x0102b4b0: 0x102b4b0: addiu v0, v0, -25068
	ldloc 5
	ldc.i4 -25068
	add
	stloc 5
...
// 0x0102b4dc: 0x102b4dc: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0102b4e0: 0x102b4e0: sw    v1, -25068(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102b4e4: 0x102b4e4: lw    v1, 4(s0)
	...
	ldelem.i4
	stloc 6
// 0x0102b4e8: 0x102b4e8: addiu v0, v0, -25068
	ldloc 5
	ldc.i4 -25068
	add
	stloc 5
...
// 0x0102b50c: 0x102b50c: sw    v1, -25068(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102b510: 0x102b510: lw    v1, 4(s0)
	...
	ldelem.i4
	stloc 6
// 0x0102b514: 0x102b514: addiu v0, v0, -25068
	ldloc 5
	ldc.i4 -25068
	add
	stloc 5
...
// 0x0102b540: 0x102b540: lw    a0, 4(s3)
	...
	ldelem.i4
	stloc.1
// 0x0102b544: 0x102b544: addiu v1, s1, -25068
	ldloc 8
	ldc.i4 -25068
	add
	stloc 6
// 0x0102b548: 0x102b548: sw    a0, 4(v1)
	...
	ldloc.1
	stelem.i4
// 0x0102b54c: 0x102b54c: sw    v0, -25068(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_102b55c:
// 0x0102b55c: 0x102b55c: addiu a0, s1, -25068
	ldloc 8
	ldc.i4 -25068
	add
	stloc.1
...
// 0x0102b568: 0x102b568: slti  v0, v0, 21
	...
	clt
	stloc 5
// 0x0102b56c: 0x102b56c: bne   v0, zero, 0x102b598 addiu a0, s1, -25068
	ldloc 5
	ldloc 8
	ldc.i4 -25068
	add
...
// 0x0102b580: 0x102b580: lw    v1, 0(s0)
	...
	ldelem.i4
	stloc 6
// 0x0102b584: 0x102b584: addiu v0, s1, -25068
	ldloc 8
	ldc.i4 -25068
	add
	stloc 5
// 0x0102b588: 0x102b588: sw    v1, -25068(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0102b5ac: 0x102b5ac: lw    a1, 8(s0)
	...
	ldelem.i4
	stloc.2
// 0x0102b5b0: 0x102b5b0: lw    a0, -25224(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0102b5e8: 0x102b5e8: bne   v0, zero, 0x102b5f8 addiu v0, zero, 1
	...
	brtrue L_102b5f8
// --- basic block ---
// 0x0102b5f0: 0x102b5f0: j	 0x102b60c sw    v0, -25224(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0102b614: 0x102b614: addiu a0, a0, 6556
	...
	add
	stloc.1
// 0x0102b618: 0x102b618: jal   0x101dba4 addiu a1, s4, -24992
	ldloc 12
	ldc.i4 -24992
	add
	stloc.2
...
// 0x0102b648: 0x102b648: addiu v1, zero, -1
	ldc.i4.m1
	stloc 6
// 0x0102b64c: 0x102b64c: beq   v0, v1, 0x102bca4 addiu a0, s4, -24992
	ldloc 5
	ldloc 6
	ldloc 12
	ldc.i4 -24992
...
// 0x0102b734: 0x102b734: beq   v0, zero, 0x102b78c lui   v0, 0x60000
	...
	brfalse L_102b78c
// --- basic block ---
// 0x0102b73c: 0x102b73c: addiu v1, v0, -25052
	ldloc 5
	ldc.i4 -25052
	add
	stloc 6
...
// 0x0102b754: 0x102b754: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x0102b758: 0x102b758: lw    v0, -25052(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 5
// 0x0102b75c: 0x102b75c: addiu a0, a0, -24992
	ldloc.1
	ldc.i4 -24992
	add
	stloc.1
...
// 0x0102b79c: 0x102b79c: lui   a0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x0102b7a0: 0x102b7a0: addiu a0, a0, -24992
	ldloc.1
	ldc.i4 -24992
	add
	stloc.1
...
// 0x0102b7ac: 0x102b7ac: sw    v0, 20(sp)
	...
	ldloc 5
	stelem.i4
// 0x0102b7b0: 0x102b7b0: addiu s5, s5, -24980
	ldloc 13
	ldc.i4 -24980
	add
	stloc 13
...
// 0x0102b7d8: 0x102b7d8: addu  s1, v0, zero
	ldloc 5
	stloc 8
// 0x0102b7dc: 0x102b7dc: addiu s8, s8, -25144
	ldloc 16
	ldc.i4 -25144
	add
	stloc 16
...
// 0x0102b820: 0x102b820: lui   a0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x0102b824: 0x102b824: addiu a0, a0, -25052
	ldloc.1
	ldc.i4 -25052
	add
	stloc.1
...
// 0x0102b844: 0x102b844: lui   a1, 0x60000
	ldc.i4 393216
	stloc.2
// 0x0102b848: 0x102b848: addiu a1, a1, -25052
	ldloc.2
	ldc.i4 -25052
	add
	stloc.2
...
// 0x0102b854: 0x102b854: lw    v0, 8(a1)
	...
	ldelem.i4
	stloc 5
// 0x0102b858: 0x102b858: addiu a2, a2, -24980
	ldloc.3
	ldc.i4 -24980
	add
	stloc.3
...
// 0x0102b8ec: 0x102b8ec: lui   a0, 0x60000
	...
	stloc.1
L_102b8f0:
// 0x0102b8f0: 0x102b8f0: addiu a0, a0, -25220
	ldloc.1
	ldc.i4 -25220
	add
	stloc.1
...
// 0x0102b978: 0x102b978: lui   a1, 0x60000
	ldc.i4 393216
	stloc.2
// 0x0102b97c: 0x102b97c: addiu a1, a1, -24980
	ldloc.2
	ldc.i4 -24980
	add
	stloc.2
...
// 0x0102b9b4: 0x102b9b4: lui   a1, 0x60000
	ldc.i4 393216
	stloc.2
// 0x0102b9b8: 0x102b9b8: addiu a1, a1, -25220
	ldloc.2
	ldc.i4 -25220
	add
	stloc.2
...
// 0x0102ba8c: 0x102ba8c: lw    s5, 6596(v0)
	...
	ldelem.i4
	stloc 13
// 0x0102ba90: 0x102ba90: addiu s1, s1, -24212
	ldloc 8
	ldc.i4 -24212
	add
	stloc 8
// 0x0102ba94: 0x102ba94: addiu s3, s3, -24192
	ldloc 9
	ldc.i4 -24192
	add
	stloc 9
...
// 0x0102bac4: 0x102bac4: addiu a0, a0, -31024
	...
	add
	stloc.1
// 0x0102bac8: 0x102bac8: jal   0x1019584 addiu s1, s1, -25052
	ldloc 8
	ldc.i4 -25052
	add
	stloc 8
...
// 0x0102bb08: 0x102bb08: addu  a0, s2, zero
	ldloc 11
	stloc.1
// 0x0102bb0c: 0x102bb0c: jalr  v0 addiu a2, a2, -25020
	ldloc 5
	ldloc.3
	ldc.i4 -25020
	add
...
// 0x0102bb14: 0x102bb14: lui   v0, 0x60000
	...
	stloc 5
L_102bb18:
// 0x0102bb18: 0x102bb18: lw    v0, -25000(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102bb9c: 0x102bb9c: lui   a3, 0x60000
	ldc.i4 393216
	stloc 4
// 0x0102bba0: 0x102bba0: addiu a3, a3, -24980
	ldloc 4
	ldc.i4 -24980
	add
	stloc 4
...
// 0x0102bc70: 0x102bc70: lui   v0, 0x60000
	...
	stloc 5
L_102bc74:
// 0x0102bc74: 0x102bc74: addiu v1, v0, -25052
	ldloc 5
	ldc.i4 -25052
	add
	stloc 6
...
// 0x0102bc80: 0x102bc80: beq   v1, zero, 0x102bca8 lui   a0, 0x60000
	...
	brfalse L_102bca8
// --- basic block ---
// 0x0102bc88: 0x102bc88: lw    v0, -25052(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0102bc8c: 0x102bc8c: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x0102bc90: 0x102bc90: addiu a0, a0, -24992
	ldloc.1
	ldc.i4 -24992
	add
	stloc.1
