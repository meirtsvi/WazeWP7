...
// 0x0101491c: 0x101491c: addu  s3, a2, zero
	ldloc.3
	stloc 10
// 0x01014920: 0x1014920: addiu s1, s1, -28364
	ldloc 7
	ldc.i4 -28364
	add
	stloc 7
...
// 0x01014958: 0x1014958: addiu s1, s1, 4
	...
	stloc 7
L_101495c:
// 0x0101495c: 0x101495c: lw    v0, -28372(s2)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010149d4: 0x10149d4: addu  s5, a3, zero
	ldloc 4
	stloc 12
// 0x010149d8: 0x10149d8: addiu s1, s1, -28364
	ldloc 7
	ldc.i4 -28364
	add
	stloc 7
...
// 0x01014a24: 0x1014a24: addiu s1, s1, 4
	...
	stloc 7
L_1014a28:
// 0x01014a28: 0x1014a28: lw    v1, -28372(s2)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01014a8c: 0x1014a8c: addiu s1, s1, -28364
	ldloc 7
	ldc.i4 -28364
	add
	stloc 7
...
// 0x01014ac4: 0x1014ac4: addiu s1, s1, 4
	...
	stloc 7
L_1014ac8:
// 0x01014ac8: 0x1014ac8: lw    v0, -28372(s2)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01014c80: 0x1014c80: sll   a2, v0, 2
	...
	shl
	stloc.3
// 0x01014c84: 0x1014c84: addiu v1, v1, -28368
	ldloc 5
	ldc.i4 -28368
	add
	stloc 5
...
// 0x01014d38: 0x1014d38: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01014d3c: 0x1014d3c: lw    v1, 31312(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01014d4c: 0x1014d4c: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01014d50: 0x1014d50: lw    v1, 31388(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01014d7c: 0x1014d7c: sll   a2, v0, 2
	...
	shl
	stloc.3
// 0x01014d80: 0x1014d80: addiu v1, v1, -28368
	ldloc 7
	ldc.i4 -28368
	add
	stloc 7
...
// 0x01014e44: 0x1014e44: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01014e48: 0x1014e48: lw    v1, 31312(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01014e58: 0x1014e58: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01014e5c: 0x1014e5c: lw    v1, 31388(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01014e88: 0x1014e88: sll   a2, v0, 2
	...
	shl
	stloc.3
// 0x01014e8c: 0x1014e8c: addiu v1, v1, -28368
	ldloc 7
	ldc.i4 -28368
	add
	stloc 7
...
// 0x01014f58: 0x1014f58: lui   v1, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01014f5c: 0x1014f5c: lw    v1, 31312(v1)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1014f80:
// 0x01014f80: 0x1014f80: lw    a0, 31400(v1)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01014fa8: 0x1014fa8: sll   a0, v0, 2
	...
	shl
	stloc.1
// 0x01014fac: 0x1014fac: addiu v1, v1, -28368
	ldloc 5
	ldc.i4 -28368
	add
	stloc 5
...
// 0x0101510c: 0x101510c: sll   a2, v0, 2
	...
	shl
	stloc.3
// 0x01015110: 0x1015110: addiu v1, v1, -28368
	ldloc 7
	ldc.i4 -28368
	add
	stloc 7
...
// 0x01015258: 0x1015258: sll   a3, v0, 2
	...
	shl
	stloc 4
// 0x0101525c: 0x101525c: addiu v1, v1, -28368
	ldloc 7
	ldc.i4 -28368
	add
	stloc 7
...
// 0x01015340: 0x1015340: sll   a1, v0, 2
	...
	shl
	stloc.2
// 0x01015344: 0x1015344: addiu v1, v1, -28368
	ldloc 6
	ldc.i4 -28368
	add
	stloc 6
...
// 0x01015420: 0x1015420: sll   a3, v0, 2
	...
	shl
	stloc 4
// 0x01015424: 0x1015424: addiu v1, v1, -28368
	ldloc 7
	ldc.i4 -28368
	add
	stloc 7
...
// 0x010154c4: 0x10154c4: sll   a1, v0, 2
	...
	shl
	stloc.2
// 0x010154c8: 0x10154c8: addiu v1, v1, -28368
	ldloc 5
	ldc.i4 -28368
	add
	stloc 5
...
// 0x01015988: 0x1015988: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101598c: 0x101598c: lw    v0, -28328(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010159a8: 0x10159a8: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010159ac: 0x10159ac: sw    s0, -28328(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01015ab4: 0x1015ab4: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01015ab8: 0x1015ab8: lw    v1, -28328(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01015ad0: 0x1015ad0: bne   s0, v1, 0x1015adc sll   zero, zero, 0
	...
	bne.un L_1015adc
// --- basic block ---
// 0x01015ad8: 0x1015ad8: sw    a1, -28328(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
