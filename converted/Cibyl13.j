...
// 0x01012274: 0x1012274: addu  a0, s5, zero
	ldloc 11
	stloc.1
// 0x01012278: 0x1012278: beq   s5, zero, 0x10122e0 addiu a1, a1, -30380
	ldloc 11
	ldloc.2
	ldc.i4 -30380
	add
...
// 0x01012294: 0x1012294: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x01012298: 0x1012298: lw    v0, -30384(a0)
	ldloc 5
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010122e0: 0x10122e0: addiu s2, s2, 1
	...
	stloc 8
L_10122e4:
// 0x010122e4: 0x10122e4: lw    v0, -30384(s3)
	ldloc 5
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x010122f4: 0x10122f4: slt   v0, s2, v0
	...
	clt
	stloc 6
// 0x010122f8: 0x10122f8: addiu a1, a1, -30380
	ldloc.2
	ldc.i4 -30380
	add
	stloc.2
...
// 0x0101246c: 0x101246c: lw    a0, 24(sp)
	...
	ldelem.i4
	stloc.1
// 0x01012470: 0x1012470: lw    v0, -30384(s3)
	ldloc 5
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x0101253c: 0x101253c: beq   a2, zero, 0x101255c lui   v1, 0x20000
	...
	brfalse L_101255c
// --- basic block ---
// 0x01012544: 0x1012544: lw    a1, 31392(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01012548: 0x1012548: lw    v1, 31468(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_101255c:
// 0x0101255c: 0x101255c: lw    a1, 31392(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01012560: 0x1012560: lw    v1, 31468(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101261c: 0x101261c: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01012620: 0x1012620: lw    v1, 31392(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01012628: 0x1012628: addu  v0, v1, v0
	...
	add
	stloc 5
// 0x0101262c: 0x101262c: lw    a0, 31468(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0101263c: 0x101263c: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01012640: 0x1012640: lw    v1, 31392(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01012648: 0x1012648: addu  v0, v1, v0
	...
	add
	stloc 5
// 0x0101264c: 0x101264c: lw    a0, 31468(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01012ad8: 0x1012ad8: lw    v0, 36(sp)
	...
	ldelem.i4
	stloc 5
// 0x01012adc: 0x1012adc: lw    v1, 31392(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01012aec: 0x1012aec: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01012af0: 0x1012af0: lw    v1, 31468(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01012ca8: 0x1012ca8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01012cac: 0x1012cac: lw    v1, 31392(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01012ccc: 0x1012ccc: sra   a1, v1, 16
	...
	shr
	stloc.2
// 0x01012cd0: 0x1012cd0: lw    v0, 31468(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01012dd0: 0x1012dd0: addiu sp, sp, -112
	...
	add
	stloc.0
// 0x01012dd4: 0x1012dd4: lw    v0, 31392(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01012dfc: 0x1012dfc: andi  v1, v1, 32767
	...
	and
	stloc 7
// 0x01012e00: 0x1012e00: lw    t0, 31468(t0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01012eac: 0x1012eac: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01012eb0: 0x1012eb0: lw    a0, 31480(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01012f80: 0x1012f80: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01012f84: 0x1012f84: lw    v0, 31392(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01012f90: 0x1012f90: lhu   v0, 2(s5)
	...
	call int32 [WazeWP7]CRunTime::memoryReadShortUnsigned(int32)
	stloc 6
// 0x01012f94: 0x1012f94: lw    v1, 31468(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01013048: 0x1013048: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101304c: 0x101304c: lw    v0, -30384(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013094: 0x1013094: lui   a1, 0x30000
	ldc.i4 196608
	stloc.2
// 0x01013098: 0x1013098: jal   0x1013d0c addiu a1, a1, -28812
	ldloc.2
	ldc.i4 -28812
	add
	stloc.2
...
// --- basic block ---
L_10130b4:
// 0x010130b4: 0x10130b4: lw    v0, -28812(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013158: 0x1013158: lui   v1, 0x20000
	...
	stloc 7
L_101315c:
// 0x0101315c: 0x101315c: lw    v0, 31388(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010131c8: 0x10131c8: bne   v0, zero, 0x1013298 lui   a0, 0x20000
	...
	brtrue L_1013298
// --- basic block ---
// 0x010131d0: 0x10131d0: lw    v0, 31392(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010131e4: 0x10131e4: beq   a3, v0, 0x1013234 lui   v0, 0x20000
	...
	beq  L_1013234
// --- basic block ---
// 0x010131ec: 0x10131ec: lw    a0, 31480(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
