...
// 0x01011ba0: 0x1011ba0: lui   v0, 0x10000
	ldc.i4 65536
	stloc 6
// 0x01011ba4: 0x1011ba4: j	 0x1011c54 addiu v0, v0, 18084
	ldloc 6
	ldc.i4 18084
	add
	stloc 6
...
// 0x01011bc0: 0x1011bc0: bne   v1, v0, 0x1011bd0 lui   s0, 0x10000
	...
	bne.un L_1011bd0
// --- basic block ---
// 0x01011bc8: 0x1011bc8: j	 0x1011bdc addiu s0, s0, 18084
	ldloc 10
	ldc.i4 18084
	add
	stloc 10
...
// 0x01011be4: 0x1011be4: bne   v0, zero, 0x1011bf4 lui   s2, 0x10000
	...
	brtrue L_1011bf4
// --- basic block ---
// 0x01011bec: 0x1011bec: j	 0x1011bfc addiu s2, s2, 18084
	ldloc 9
	ldc.i4 18084
	add
	stloc 9
...
// 0x01011bf4: 0x1011bf4: lui   s2, 0x20000
	ldc.i4 131072
	stloc 9
// 0x01011bf8: 0x1011bf8: addiu s2, s2, -336
	ldloc 9
	ldc.i4 -336
	add
	stloc 9
...
// 0x01011c0c: 0x1011c0c: bne   v1, zero, 0x1011c1c lui   v1, 0x10000
	...
	brtrue L_1011c1c
// --- basic block ---
// 0x01011c14: 0x1011c14: j	 0x1011c24 addiu v1, v1, 18084
	ldloc 7
	ldc.i4 18084
	add
	stloc 7
...
// 0x01011c30: 0x1011c30: addu  a3, s3, zero
	ldloc 11
	stloc 4
// 0x01011c34: 0x1011c34: addiu a0, s1, -30216
	ldloc 8
	ldc.i4 -30216
	add
	stloc.1
...
// 0x01011c48: 0x1011c48: jal   0x1000f9c sw    s0, 28(sp)
	...
	stloc 6
// --- basic block ---
// 0x01011c50: 0x1011c50: addiu v0, s1, -30216
	ldloc 8
	ldc.i4 -30216
	add
	stloc 6
...
// 0x01011c70: 0x1011c70: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01011c74: 0x1011c74: lw    v0, -31244(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01011cd4: 0x1011cd4: jal   0x100177c addu  s2, v0, zero
	...
	stloc 7
// --- basic block ---
// 0x01011cdc: 0x1011cdc: lw    v0, -31244(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01011cec: 0x1011cec: addu  a1, s0, zero
	ldloc 8
	stloc.2
// 0x01011cf0: 0x1011cf0: jal   0x1042620 addu  a0, s2, zero
	ldloc 10
	stloc.1
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl49::roadmap_range_get_address_1042620(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 5
	stloc 7
// --- basic block ---
// 0x01011cf8: 0x1011cf8: jal   0x1042548 addu  a0, s2, zero
	ldloc 10
	stloc.1
	ldloc.1
...
// 0x01011d04: 0x1011d04: beq   v0, a0, 0x1011d5c addiu v1, zero, -1
	...
	beq  L_1011d5c
// --- basic block ---
// 0x01011d0c: 0x1011d0c: lw    a0, -31244(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01011f8c: 0x1011f8c: addiu sp, sp, -80
	...
	add
	stloc.0
// 0x01011f90: 0x1011f90: lw    v0, 30528(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01011fa4: 0x1011fa4: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01011fa8: 0x1011fa8: lw    a0, 30608(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01012030: 0x1012030: beq   s4, v0, 0x1012148 lui   v0, 0x20000
	...
	beq  L_1012148
// --- basic block ---
// 0x01012038: 0x1012038: lw    a2, 30620(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101209c: 0x101209c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x010120a0: 0x10120a0: lw    a0, 30620(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10121d4:
// 0x010121d4: 0x10121d4: lw    v0, 30528(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010121e0: 0x10121e0: lhu   v0, 2(s1)
	...
	call int32 [WazeWP7]CRunTime::memoryReadShortUnsigned(int32)
	stloc 6
// 0x010121e4: 0x10121e4: lw    v1, 30608(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01012434: 0x1012434: sw    a2, 112(sp)
	...
	ldloc.3
	stelem.i4
// 0x01012438: 0x1012438: jal   0x1041ee0 sw    a3, 116(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01012450: 0x1012450: addu  a1, s0, zero
	ldloc 10
	stloc.2
// 0x01012454: 0x1012454: jal   0x10418e8 addu  a0, v0, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010124b0: 0x10124b0: addu  a0, s5, zero
	ldloc 11
	stloc.1
// 0x010124b4: 0x10124b4: beq   s5, zero, 0x101251c addiu a1, a1, -31240
	ldloc 11
	ldloc.2
	ldc.i4 -31240
	add
...
// 0x010124d0: 0x10124d0: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x010124d4: 0x10124d4: lw    v0, -31244(a0)
	ldloc 5
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0101251c: 0x101251c: addiu s2, s2, 1
	...
	stloc 8
L_1012520:
// 0x01012520: 0x1012520: lw    v0, -31244(s3)
	ldloc 5
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x01012530: 0x1012530: slt   v0, s2, v0
	...
	clt
	stloc 6
// 0x01012534: 0x1012534: addiu a1, a1, -31240
	ldloc.2
	ldc.i4 -31240
	add
	stloc.2
...
// 0x01012684: 0x1012684: addiu a2, a1, 24
	...
	add
	stloc.3
// 0x01012688: 0x1012688: jal   0x1042620 addiu a1, a1, 16
	ldloc.2
	ldc.i4.s 16
	add
	stloc.2
...
// 0x010126a8: 0x10126a8: lw    a0, 24(sp)
	...
	ldelem.i4
	stloc.1
// 0x010126ac: 0x10126ac: lw    v0, -31244(s3)
	ldloc 5
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x010126e4: 0x10126e4: addu  a0, s4, zero
	...
	stloc.1
L_10126e8:
// 0x010126e8: 0x10126e8: jal   0x10417ec addiu a1, sp, 16
	ldloc.0
	ldc.i4.s 16
	add
	stloc.2
...
// 0x01012778: 0x1012778: beq   a2, zero, 0x1012798 lui   v1, 0x20000
	...
	brfalse L_1012798
// --- basic block ---
// 0x01012780: 0x1012780: lw    a1, 30528(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01012784: 0x1012784: lw    v1, 30608(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1012798:
// 0x01012798: 0x1012798: lw    a1, 30528(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x0101279c: 0x101279c: lw    v1, 30608(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01012858: 0x1012858: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0101285c: 0x101285c: lw    v1, 30528(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01012864: 0x1012864: addu  v0, v1, v0
	...
	add
	stloc 5
// 0x01012868: 0x1012868: lw    a0, 30608(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01012878: 0x1012878: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0101287c: 0x101287c: lw    v1, 30528(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01012884: 0x1012884: addu  v0, v1, v0
	...
	add
	stloc 5
// 0x01012888: 0x1012888: lw    a0, 30608(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01012d14: 0x1012d14: lw    v0, 36(sp)
	...
	ldelem.i4
	stloc 5
// 0x01012d18: 0x1012d18: lw    v1, 30528(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01012d28: 0x1012d28: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01012d2c: 0x1012d2c: lw    v1, 30608(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
