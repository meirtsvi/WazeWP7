...
// 0x010122a0: 0x10122a0: sw    a2, 112(sp)
	...
	ldloc.3
	stelem.i4
// 0x010122a4: 0x10122a4: jal   0x1041328 sw    a3, 116(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010122bc: 0x10122bc: addu  a1, s0, zero
	ldloc 10
	stloc.2
// 0x010122c0: 0x10122c0: jal   0x1040d30 addu  a0, v0, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101231c: 0x101231c: addu  a0, s5, zero
	ldloc 11
	stloc.1
// 0x01012320: 0x1012320: beq   s5, zero, 0x1012388 addiu a1, a1, -30312
	ldloc 11
	ldloc.2
	ldc.i4 -30312
	add
...
// 0x0101233c: 0x101233c: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x01012340: 0x1012340: lw    v0, -30316(a0)
	ldloc 5
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01012388: 0x1012388: addiu s2, s2, 1
	...
	stloc 8
L_101238c:
// 0x0101238c: 0x101238c: lw    v0, -30316(s3)
	ldloc 5
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x0101239c: 0x101239c: slt   v0, s2, v0
	...
	clt
	stloc 6
// 0x010123a0: 0x10123a0: addiu a1, a1, -30312
	ldloc.2
	ldc.i4 -30312
	add
	stloc.2
...
// 0x010124f0: 0x10124f0: addiu a2, a1, 24
	...
	add
	stloc.3
// 0x010124f4: 0x10124f4: jal   0x1041a68 addiu a1, a1, 16
	ldloc.2
	ldc.i4.s 16
	add
	stloc.2
...
// 0x01012514: 0x1012514: lw    a0, 24(sp)
	...
	ldelem.i4
	stloc.1
// 0x01012518: 0x1012518: lw    v0, -30316(s3)
	ldloc 5
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x01012550: 0x1012550: addu  a0, s4, zero
	...
	stloc.1
L_1012554:
// 0x01012554: 0x1012554: jal   0x1040c34 addiu a1, sp, 16
	ldloc.0
	ldc.i4.s 16
	add
	stloc.2
...
// 0x010125e4: 0x10125e4: beq   a2, zero, 0x1012604 lui   v1, 0x20000
	...
	brfalse L_1012604
// --- basic block ---
// 0x010125ec: 0x10125ec: lw    a1, 31456(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x010125f0: 0x10125f0: lw    v1, 31536(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1012604:
// 0x01012604: 0x1012604: lw    a1, 31456(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01012608: 0x1012608: lw    v1, 31536(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010126c4: 0x10126c4: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x010126c8: 0x10126c8: lw    v1, 31456(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010126d0: 0x10126d0: addu  v0, v1, v0
	...
	add
	stloc 5
// 0x010126d4: 0x10126d4: lw    a0, 31536(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x010126e4: 0x10126e4: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x010126e8: 0x10126e8: lw    v1, 31456(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010126f0: 0x10126f0: addu  v0, v1, v0
	...
	add
	stloc 5
// 0x010126f4: 0x10126f4: lw    a0, 31536(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01012804: 0x1012804: lui   a3, 0x0
	ldc.i4.s 0
	stloc 4
// 0x01012808: 0x1012808: addiu a1, a1, 27712
	ldloc.2
	ldc.i4 27712
	add
	stloc.2
// 0x0101280c: 0x101280c: addiu a3, a3, 27916
	ldloc 4
	ldc.i4 27916
	add
	stloc 4
...
// 0x01012b80: 0x1012b80: lw    v0, 36(sp)
	...
	ldelem.i4
	stloc 5
// 0x01012b84: 0x1012b84: lw    v1, 31456(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01012b94: 0x1012b94: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01012b98: 0x1012b98: lw    v1, 31536(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01012d50: 0x1012d50: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01012d54: 0x1012d54: lw    v1, 31456(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01012d74: 0x1012d74: sra   a1, v1, 16
	...
	shr
	stloc.2
// 0x01012d78: 0x1012d78: lw    v0, 31536(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01012e78: 0x1012e78: addiu sp, sp, -112
	...
	add
	stloc.0
// 0x01012e7c: 0x1012e7c: lw    v0, 31456(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01012ea4: 0x1012ea4: andi  v1, v1, 32767
	...
	and
	stloc 7
// 0x01012ea8: 0x1012ea8: lw    t0, 31536(t0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01012f54: 0x1012f54: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01012f58: 0x1012f58: lw    a0, 31548(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01013028: 0x1013028: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0101302c: 0x101302c: lw    v0, 31456(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01013038: 0x1013038: lhu   v0, 2(s5)
	...
	call int32 [WazeWP7]CRunTime::memoryReadShortUnsigned(int32)
	stloc 6
// 0x0101303c: 0x101303c: lw    v1, 31536(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010130f0: 0x10130f0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010130f4: 0x10130f4: lw    v0, -30316(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101313c: 0x101313c: lui   a1, 0x30000
	ldc.i4 196608
	stloc.2
// 0x01013140: 0x1013140: jal   0x1013db4 addiu a1, a1, -28744
	ldloc.2
	ldc.i4 -28744
	add
	stloc.2
...
// --- basic block ---
L_101315c:
// 0x0101315c: 0x101315c: lw    v0, -28744(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01013200: 0x1013200: lui   v1, 0x20000
	...
	stloc 7
L_1013204:
// 0x01013204: 0x1013204: lw    v0, 31452(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01013270: 0x1013270: bne   v0, zero, 0x1013340 lui   a0, 0x20000
	...
	brtrue L_1013340
// --- basic block ---
// 0x01013278: 0x1013278: lw    v0, 31456(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0101328c: 0x101328c: beq   a3, v0, 0x10132dc lui   v0, 0x20000
	...
	beq  L_10132dc
// --- basic block ---
// 0x01013294: 0x1013294: lw    a0, 31548(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
