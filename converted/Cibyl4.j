...
// 0x010054b0: 0x10054b0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010054b4: 0x10054b4: lw    v0, 31556(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01005540: 0x1005540: mflo  lo
	ldloc 13
	stloc.1
// 0x01005544: 0x1005544: jal   0x10c0e60 sll   zero, zero, 0
	ldloc.0
	ldloc.1
...
// 0x0100554c: 0x100554c: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01005550: 0x1005550: lw    a3, 24060(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01005554: 0x1005554: lw    a2, 24056(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01005558: 0x1005558: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x0100555c: 0x100555c: jal   0x10c0c38 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01005568: 0x1005568: addu  s3, v1, zero
	ldloc 6
	stloc 11
// 0x0100556c: 0x100556c: jal   0x10c0e60 addu  s2, v0, zero
	ldloc 5
	stloc 10
	ldloc.0
	ldloc.1
...
// 0x0100557c: 0x100557c: addu  a0, s2, zero
	ldloc 10
	stloc.1
// 0x01005580: 0x1005580: jal   0x10c0c90 addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01005588: 0x1005588: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x0100558c: 0x100558c: jal   0x10c0de8 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010055c0: 0x10055c0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010055c4: 0x10055c4: lw    v0, 31556(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010057dc: 0x10057dc: lui   v0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x010057e0: 0x10057e0: jr    ra sw    a0, 31560(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01005948: 0x1005948: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100594c: 0x100594c: lw    v1, 31560(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01005960: 0x1005960: bne   a0, v1, 0x1005994 addu  s0, a0, zero
	...
	bne.un L_1005994
// --- basic block ---
// 0x01005968: 0x1005968: j	 0x1005994 sw    zero, 31560(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01005e40: 0x1005e40: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01005e44: 0x1005e44: addiu a2, a2, 2948
	ldloc.3
	ldc.i4 2948
	add
	stloc.3
...
// 0x01005e64: 0x1005e64: addu  a0, s0, zero
	ldloc 6
	stloc.1
// 0x01005e68: 0x1005e68: addiu a2, a2, 13764
	ldloc.3
	ldc.i4 13764
	add
	stloc.3
...
// 0x01005e94: 0x1005e94: addu  a0, s0, zero
	ldloc 6
	stloc.1
// 0x01005e98: 0x1005e98: addiu a2, a2, -10944
	ldloc.3
	ldc.i4 -10944
	add
	stloc.3
...
// 0x01006bb4: 0x1006bb4: lw    s0, 31560(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01006c24: 0x1006c24: slti  a3, v0, 46
	...
	clt
	stloc.3
// 0x01006c28: 0x1006c28: beq   a3, zero, 0x1006c48 addiu v1, v1, 24744
	ldloc.3
	ldloc 5
	ldc.i4 24744
	add
...
// 0x01006cc8: 0x1006cc8: lui   t0, 0xe0000
	ldc.i4 917504
	stloc 7
// 0x01006ccc: 0x1006ccc: addiu t0, t0, 29764
	ldloc 7
	ldc.i4 29764
	add
	stloc 7
...
// 0x01006df4: 0x1006df4: lui   a3, 0xe0000
	ldc.i4 917504
	stloc.3
// 0x01006df8: 0x1006df8: addiu a3, a3, 29764
	ldloc.3
	ldc.i4 29764
	add
	stloc.3
...
// 0x01006e84: 0x1006e84: lui   a1, 0xe0000
	ldc.i4 917504
	stloc.1
// 0x01006e88: 0x1006e88: addiu a1, a1, 29764
	ldloc.1
	ldc.i4 29764
	add
	stloc.1
...
// 0x01006f24: 0x1006f24: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x01006f28: 0x1006f28: addiu v1, v1, 29764
	ldloc 5
	ldc.i4 29764
	add
	stloc 5
...
// 0x01006fc4: 0x1006fc4: addiu sp, sp, -56
	...
	add
	stloc.0
// 0x01006fc8: 0x1006fc8: addiu v0, v0, 29764
	ldloc 5
	ldc.i4 29764
	add
	stloc 5
...
// 0x01007004: 0x1007004: lui   s2, 0xe0000
	ldc.i4 917504
	stloc 8
// 0x01007008: 0x1007008: addiu s2, s2, 29764
	ldloc 8
	ldc.i4 29764
	add
	stloc 8
...
// 0x01007030: 0x1007030: lw    a0, 20(sp)
	...
	ldelem.i4
	stloc.1
// 0x01007034: 0x1007034: jal   0x10c0e60 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	call int32 Cibyl143::__floatsidf_10c0e60(int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
...
// 0x0100703c: 0x100703c: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01007040: 0x1007040: lw    a3, 24068(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01007044: 0x1007044: lw    a2, 24064(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01007048: 0x1007048: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x0100704c: 0x100704c: jal   0x10c0c38 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01007058: 0x1007058: addu  s5, v1, zero
	ldloc 6
	stloc 13
// 0x0100705c: 0x100705c: jal   0x10c0e60 addu  s4, v0, zero
	ldloc 5
	stloc 12
	ldloc.0
	ldloc.1
...
// 0x0100706c: 0x100706c: addu  a0, s4, zero
	ldloc 12
	stloc.1
// 0x01007070: 0x1007070: jal   0x10c0c38 addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x01007078: 0x1007078: lw    a3, 24076(s1)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x0100707c: 0x100707c: lw    a2, 24072(s1)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01007080: 0x1007080: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x01007084: 0x1007084: jal   0x10c0b88 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0100708c: 0x100708c: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01007090: 0x1007090: jal   0x10c0d70 addu  a1, v1, zero
	ldloc 6
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01007098: 0x1007098: beq   s3, zero, 0x10070f8 addu  s0, v0, zero
	...
	brfalse L_10070f8
// --- basic block ---
// 0x010070a0: 0x10070a0: jal   0x10c0e4c addu  a0, s3, zero
	ldloc 11
	stloc.1
	ldloc.1
	conv.r4
...
// 0x010070b0: 0x10070b0: lw    a1, 4(v1)
	...
	ldelem.i4
	stloc.2
// 0x010070b4: 0x10070b4: jal   0x10c0c20 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x010070bc: 0x10070bc: addu  a0, s0, zero
	ldloc 9
	stloc.1
// 0x010070c0: 0x10070c0: jal   0x10c0e4c addu  s2, v0, zero
	ldloc 5
	stloc 8
	ldloc.1
	conv.r4
...
// 0x010070c8: 0x10070c8: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x010070cc: 0x10070cc: jal   0x10c0c20 addu  a0, s2, zero
	ldloc 8
	stloc.1
	ldloc.1
	ldloc.2
	...
	stloc 5
// --- basic block ---
// 0x010070d4: 0x10070d4: jal   0x10c0d14 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x010070dc: 0x10070dc: lw    a3, 24076(s1)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x010070e0: 0x10070e0: lw    a2, 24072(s1)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010070e4: 0x10070e4: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x010070e8: 0x10070e8: jal   0x10c0b88 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_10070f8:
// 0x010070f8: 0x10070f8: jal   0x10c0e60 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01007100: 0x1007100: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01007104: 0x1007104: lw    a3, 24084(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01007108: 0x1007108: lw    a2, 24080(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0100710c: 0x100710c: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x01007110: 0x1007110: jal   0x10c0c38 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01007118: 0x1007118: addu  a1, v1, zero
	...
	stloc.2
L_100711c:
// 0x0100711c: 0x100711c: jal   0x10c0d70 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010072a4: 0x10072a4: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 6
// 0x010072a8: 0x10072a8: addiu v0, v0, 29764
	ldloc 6
	ldc.i4 29764
	add
	stloc 6
...
// 0x01007398: 0x1007398: addu  s2, a0, zero
	ldloc.1
	stloc 11
// 0x0100739c: 0x100739c: addiu s0, s0, 29764
	ldloc 7
	ldc.i4 29764
	add
	stloc 7
