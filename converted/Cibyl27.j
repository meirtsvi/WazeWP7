...
// 0x010246e4: 0x10246e4: bne   v0, zero, 0x10246f8 lui   v0, 0x50000
	...
	brtrue L_10246f8
// --- basic block ---
// 0x010246ec: 0x10246ec: jal   0x10c002c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl143::roadmap_label_start_10c002c(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x01024c18: 0x1024c18: sw    s6, 16(sp)
	...
	ldloc 14
	stelem.i4
// 0x01024c1c: 0x1024c1c: jal   0x10bfc00 sw    v0, 20(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
	...
	ldloc 5
	stelem.i4
	call int32 Cibyl142::roadmap_label_add_place_10bfc00()
	stloc 5
// --- basic block ---
L_1024c24:
...
// 0x01024cf4: 0x1024cf4: lw    a0, 28608(v0)
	...
	ldelem.i4
	stloc.1
// 0x01024cf8: 0x1024cf8: jal   0x10c0188 sltiu a0, a0, 1
	ldloc.1
	ldc.i4.1
	clt.un
	stloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl143::roadmap_label_draw_cache_10c0188(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
