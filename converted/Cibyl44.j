...
// 0x0103b970: 0x103b970: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x0103b974: 0x103b974: jal   0x1097d78 sw    v0, -13288(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_103b9c0:
// 0x0103b9c0: 0x103b9c0: jal   0x10ac4e4 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103ba94: 0x103ba94: addu  a0, s3, zero
	ldloc 11
	stloc.1
// 0x0103ba98: 0x103ba98: jal   0x109b47c addiu a1, a1, -9292
	ldloc.2
	ldc.i4 -9292
	add
	stloc.2
...
// 0x0103bb98: 0x103bb98: jal   0x104c078 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x0103bba0: 0x103bba0: jal   0x10ac4e4 addu  a0, s0, zero
	ldloc 10
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103bc7c: 0x103bc7c: lui   a1, 0x10000
	ldc.i4 65536
	stloc.2
// 0x0103bc80: 0x103bc80: jal   0x109b47c addiu a1, a1, -9356
	ldloc.2
	ldc.i4 -9356
	add
	stloc.2
...
// 0x0103bc90: 0x103bc90: lw    a0, 144(sp)
	...
	ldelem.i4
	stloc.1
// 0x0103bc94: 0x103bc94: jal   0x109e088 addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0103bd24: 0x103bd24: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x0103bd28: 0x103bd28: jal   0x109b47c addiu a1, a1, -9292
	ldloc.2
	ldc.i4 -9292
	add
	stloc.2
...
// 0x0103be10: 0x103be10: sw    s1, 40(sp)
	...
	ldloc 9
	stelem.i4
// 0x0103be14: 0x103be14: jal   0x109a59c sw    s0, 36(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103be34: 0x103be34: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0103be38: 0x103be38: jal   0x109c67c addiu a0, s0, 12768
	ldloc 8
	ldc.i4 12768
	add
	stloc.1
...
// 0x0103be50: 0x103be50: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0103be54: 0x103be54: jal   0x109c67c addiu a0, s0, 12768
	ldloc 8
	ldc.i4 12768
	add
	stloc.1
...
// 0x0103be6c: 0x103be6c: addiu a1, zero, 2
	ldc.i4.2
	stloc.2
// 0x0103be70: 0x103be70: jal   0x109c67c addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x0103be80: 0x103be80: addiu a2, zero, 1
	ldc.i4.1
	stloc.3
// 0x0103be84: 0x103be84: jal   0x109c67c addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x0103beb4: 0x103beb4: sw    zero, 16(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x0103beb8: 0x103beb8: jal   0x109c968 sw    zero, 24(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103bf5c: 0x103bf5c: lw    a0, 16(v0)
	...
	ldelem.i4
	stloc.1
// 0x0103bf60: 0x103bf60: jal   0x10c0908 addu  s0, v0, zero
	ldloc 5
	stloc 8
	ldloc.0
	ldloc.1
...
// 0x0103bf68: 0x103bf68: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x0103bf6c: 0x103bf6c: jal   0x10c0a40 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103bf80: 0x103bf80: lw    a0, 8(s0)
	...
	ldelem.i4
	stloc.1
// 0x0103bf84: 0x103bf84: jal   0x10c0908 sw    v0, 36(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103bf8c: 0x103bf8c: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x0103bf90: 0x103bf90: jal   0x10c0a40 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103c32c: 0x103c32c: beq   v0, zero, 0x103c394 lui   a2, 0x10000
	...
	brfalse L_103c394
// --- basic block ---
// 0x0103c334: 0x103c334: jal   0x109a59c addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103c3cc: 0x103c3cc: beq   v0, zero, 0x103c424 lui   a2, 0x10000
	...
	brfalse L_103c424
// --- basic block ---
// 0x0103c3d4: 0x103c3d4: jal   0x109a59c addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103c444: 0x103c444: beq   v0, zero, 0x103c49c lui   a2, 0x10000
	...
	brfalse L_103c49c
// --- basic block ---
// 0x0103c44c: 0x103c44c: jal   0x109a59c addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103c4cc: 0x103c4cc: beq   v0, zero, 0x103c528 lui   a2, 0x10000
	...
	brfalse L_103c528
// --- basic block ---
// 0x0103c4d4: 0x103c4d4: jal   0x109a59c addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103c8d0: 0x103c8d0: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x0103c8d4: 0x103c8d4: jal   0x1099158 addu  s0, v0, zero
	ldloc 5
	stloc 8
	ldloc.1
	ldloc.2
...
// 0x0103c910: 0x103c910: addu  a0, s0, zero
	ldloc 8
	stloc.1
// 0x0103c914: 0x103c914: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0103ca78: 0x103ca78: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x0103ca7c: 0x103ca7c: jal   0x1097d78 addu  s0, v0, zero
	ldloc 5
	stloc 7
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_103caac:
// 0x0103caac: 0x103caac: jal   0x1097d78 addu  a0, s0, zero
	ldloc 7
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_103cadc:
// 0x0103cadc: 0x103cadc: jal   0x1097d78 addu  a0, s0, zero
	ldloc 7
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103caf4: 0x103caf4: bne   v0, zero, 0x103cb0c sll   zero, zero, 0
	...
	brtrue L_103cb0c
// --- basic block ---
// 0x0103cafc: 0x103cafc: jal   0x10aaec0 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_103cb0c:
// 0x0103cb0c: 0x103cb0c: jal   0x1097d78 addu  a0, s0, zero
	ldloc 7
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103cb24: 0x103cb24: bne   v0, zero, 0x103cb3c sll   zero, zero, 0
	...
	brtrue L_103cb3c
// --- basic block ---
// 0x0103cb2c: 0x103cb2c: jal   0x10aae50 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_103cb3c:
// 0x0103cb3c: 0x103cb3c: jal   0x1097d78 addu  a0, s0, zero
	ldloc 7
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103cb54: 0x103cb54: bne   v0, zero, 0x103cb6c sll   zero, zero, 0
	...
	brtrue L_103cb6c
// --- basic block ---
// 0x0103cb5c: 0x103cb5c: jal   0x10aad90 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_103cb6c:
// 0x0103cb6c: 0x103cb6c: jal   0x1097d78 addu  a0, s0, zero
	ldloc 7
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103cb84: 0x103cb84: bne   v0, zero, 0x103cb9c sll   zero, zero, 0
	...
	brtrue L_103cb9c
// --- basic block ---
// 0x0103cb8c: 0x103cb8c: jal   0x10aadf0 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_103cb9c:
// 0x0103cb9c: 0x103cb9c: jal   0x1097d78 addu  a0, s0, zero
	ldloc 7
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_103cbdc:
// 0x0103cbdc: 0x103cbdc: jal   0x1097d78 addu  a0, s0, zero
	ldloc 7
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_103cc1c:
// 0x0103cc1c: 0x103cc1c: jal   0x1097d78 addu  a0, s0, zero
	ldloc 7
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0103cc70: 0x103cc70: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0103cc74: 0x103cc74: jal   0x1097d78 sw    v1, -11992(v0)
	ldloc 9
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_103ccc0:
// 0x0103ccc0: 0x103ccc0: jal   0x10ac4e4 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
