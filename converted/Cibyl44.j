...
// 0x0103bddc: 0x103bddc: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0103bde0: 0x103bde0: jal   0x109c40c addiu a0, s0, 12756
	ldloc 8
	ldc.i4 12756
	add
	stloc.1
...
// 0x0103bdf8: 0x103bdf8: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0103bdfc: 0x103bdfc: jal   0x109c40c addiu a0, s0, 12756
	ldloc 8
	ldc.i4 12756
	add
	stloc.1
...
// 0x0103be0c: 0x103be0c: sltiu a2, v0, 1
	...
	clt.un
	stloc.3
// 0x0103be10: 0x103be10: addiu a0, s0, 12756
	ldloc 8
	ldc.i4 12756
	add
	stloc.1
...
// 0x0103be18: 0x103be18: jal   0x109c40c addu  a3, zero, zero
	...
	stloc 5
// --- basic block ---
// 0x0103be20: 0x103be20: addiu a0, s0, 12756
	ldloc 8
	ldc.i4 12756
	add
	stloc.1
...
// 0x0103be44: 0x103be44: addu  a0, s1, zero
	ldloc 9
	stloc.1
// 0x0103be48: 0x103be48: addiu a2, s0, 12756
	ldloc 8
	ldc.i4 12756
	add
	stloc.3
...
// 0x0103c074: 0x103c074: addiu a1, a1, -8452
	...
	add
	stloc.2
// 0x0103c078: 0x103c078: addiu a2, a2, 12884
	ldloc.3
	ldc.i4 12884
	add
	stloc.3
...
// 0x0103c128: 0x103c128: addu  a0, v0, zero
	ldloc 6
	stloc.1
// 0x0103c12c: 0x103c12c: addiu a1, a1, 12884
	ldloc.2
	ldc.i4 12884
	add
	stloc.2
...
// 0x0103c1ec: 0x103c1ec: addiu a0, a0, 12676
	...
	add
	stloc.1
// 0x0103c1f0: 0x103c1f0: addiu a1, a1, 12900
	ldloc.2
	ldc.i4 12900
	add
	stloc.2
...
// 0x0103c208: 0x103c208: lui   s1, 0x0
	...
	stloc 9
L_103c20c:
// 0x0103c20c: 0x103c20c: jal   0x100e368 addiu a0, s1, 12900
	ldloc 9
	ldc.i4 12900
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x0103c214: 0x103c214: addiu a0, s1, 12900
	ldloc 9
	ldc.i4 12900
	add
	stloc.1
