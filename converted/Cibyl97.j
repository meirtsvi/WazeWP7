...
// 0x010810dc: 0x10810dc: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010810e0: 0x10810e0: addiu a0, a0, 16644
	ldloc.1
	ldc.i4 16644
	add
	stloc.1
...
// 0x01081108: 0x1081108: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0108110c: 0x108110c: addiu a0, a0, 16644
	ldloc.1
	ldc.i4 16644
	add
	stloc.1
...
// 0x01081130: 0x1081130: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01081134: 0x1081134: addiu a0, a0, 16644
	ldloc.1
	ldc.i4 16644
	add
	stloc.1
...
// 0x01081160: 0x1081160: lui   s5, 0x0
	...
	stloc 12
L_1081164:
// 0x01081164: 0x1081164: addiu a0, s5, 16644
	ldloc 12
	ldc.i4 16644
	add
	stloc.1
...
// 0x01081178: 0x1081178: subu  a2, zero, a2
	...
	neg
	stloc.3
// 0x0108117c: 0x108117c: addiu a0, s5, 16644
	ldloc 12
	ldc.i4 16644
	add
	stloc.1
...
// 0x010811a8: 0x10811a8: lui   s3, 0x80000
	ldc.i4 524288
	stloc 11
// 0x010811ac: 0x10811ac: addiu a0, s2, 16644
	ldloc 9
	ldc.i4 16644
	add
	stloc.1
...
// 0x010811d0: 0x10811d0: and   a2, v0, a2
	...
	and
	stloc.3
// 0x010811d4: 0x10811d4: addiu a0, s2, 16644
	ldloc 9
	ldc.i4 16644
	add
	stloc.1
...
// 0x010811f8: 0x10811f8: lui   s3, 0x80000
	ldc.i4 524288
	stloc 11
// 0x010811fc: 0x10811fc: addiu a0, s2, 16644
	ldloc 9
	ldc.i4 16644
	add
	stloc.1
...
// 0x0108120c: 0x108120c: lw    a2, -13628(s3)
	...
	ldelem.i4
	stloc.3
// 0x01081210: 0x1081210: addiu a0, s2, 16644
	ldloc 9
	ldc.i4 16644
	add
	stloc.1
...
// 0x01081238: 0x1081238: and   a2, v0, a2
	...
	and
	stloc.3
// 0x0108123c: 0x108123c: addiu a0, s2, 16644
	ldloc 9
	ldc.i4 16644
	add
	stloc.1
...
// 0x01081260: 0x1081260: and   a2, v0, a2
	...
	and
	stloc.3
// 0x01081264: 0x1081264: addiu a0, s2, 16644
	ldloc 9
	ldc.i4 16644
	add
	stloc.1
...
// 0x01081288: 0x1081288: lui   s0, 0x0
	ldc.i4.s 0
	stloc 8
// 0x0108128c: 0x108128c: addiu a0, s0, 16644
	ldloc 8
	ldc.i4 16644
	add
	stloc.1
...
// 0x010812a4: 0x10812a4: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x010812a8: 0x10812a8: jal   0x109c40c addiu a0, s0, 16644
	ldloc 8
	ldc.i4 16644
	add
	stloc.1
...
// 0x010812c8: 0x10812c8: sw    v0, 20(sp)
	...
	ldloc 5
	stelem.i4
// 0x010812cc: 0x10812cc: addiu a2, s0, 16644
	ldloc 8
	ldc.i4 16644
	add
	stloc.3
