...
// 0x01081170: 0x1081170: jal   0x1080f88 sw    zero, -13644(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010811b4: 0x10811b4: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010811b8: 0x10811b8: lw    v0, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010811c8: 0x10811c8: lui   v1, 0x80000
	ldc.i4 524288
	stloc 6
// 0x010811cc: 0x10811cc: lw    s0, -10792(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10811d8:
// 0x010811d8: 0x10811d8: lw    s0, -7988(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010811e4: 0x10811e4: lui   s2, 0x80000
	ldc.i4 524288
	stloc 9
// 0x010811e8: 0x10811e8: lw    v1, -13628(s2)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010811f8: 0x10811f8: jal   0x1094ca4 addiu a0, zero, 1
	...
	stloc 5
// --- basic block ---
// 0x01081200: 0x1081200: j	 0x10814c4 sw    zero, -13628(s2)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01081208: 0x1081208: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x0108120c: 0x108120c: addiu v1, v1, -13616
	ldloc 6
	ldc.i4 -13616
	add
	stloc 6
...
// 0x01081384: 0x1081384: jal   0x109c658 addu  a3, zero, zero
	...
	stloc 5
// --- basic block ---
// 0x0108138c: 0x108138c: lw    a2, -13640(s3)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010813ac: 0x10813ac: jal   0x109c658 addu  a3, zero, zero
	...
	stloc 5
// --- basic block ---
// 0x010813b4: 0x10813b4: lw    a2, -13640(s3)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010813d4: 0x10813d4: jal   0x109c658 addu  a3, zero, zero
	...
	stloc 5
// --- basic block ---
// 0x010813dc: 0x10813dc: lw    a2, -13644(s3)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010813ec: 0x10813ec: jal   0x109c658 addu  a3, zero, zero
	...
	stloc 5
// --- basic block ---
// 0x010813f4: 0x10813f4: lw    a2, -13644(s3)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01081414: 0x1081414: jal   0x109c658 addu  a3, zero, zero
	...
	stloc 5
// --- basic block ---
// 0x0108141c: 0x108141c: lw    a2, -13644(s3)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010814bc: 0x10814bc: lui   v1, 0x80000
	ldc.i4 524288
	stloc 6
// 0x010814c0: 0x10814c0: sw    v0, -13628(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010814f0: 0x10814f0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010814f4: 0x10814f4: lw    v1, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010814fc: 0x10814fc: sll   v1, v1, 2
	...
	shl
	stloc 6
// 0x01081500: 0x1081500: addiu v0, v0, -13616
	ldloc 5
	ldc.i4 -13616
	add
	stloc 5
...
// 0x0108161c: 0x108161c: addu  s2, a1, zero
	ldloc.2
	stloc 8
// 0x01081620: 0x1081620: addiu s4, s4, -11592
	ldloc 9
	ldc.i4 -11592
	add
	stloc 9
// 0x01081624: 0x1081624: addiu s1, s1, -13592
	ldloc 12
	ldc.i4 -13592
	add
	stloc 12
// 0x01081628: 0x1081628: addiu s5, s5, -10788
	ldloc 13
	ldc.i4 -10788
	add
	stloc 13
...
// 0x01081754: 0x1081754: sll   v0, s0, 2
	...
	shl
	stloc 5
// 0x01081758: 0x1081758: addiu s2, s2, -13616
	ldloc 8
	ldc.i4 -13616
	add
	stloc 8
...
// 0x01081760: 0x1081760: lui   a2, 0x80000
	ldc.i4 524288
	stloc.3
// 0x01081764: 0x1081764: addiu a2, a2, -10788
	ldloc.3
	ldc.i4 -10788
	add
	stloc.3
...
// 0x01081778: 0x1081778: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0108177c: 0x108177c: addiu v0, v0, -10388
	ldloc 5
	ldc.i4 -10388
	add
	stloc 5
...
// 0x01081788: 0x1081788: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0108178c: 0x108178c: addiu v0, v0, -9588
	ldloc 5
	ldc.i4 -9588
	add
	stloc 5
...
// 0x010817b0: 0x10817b0: addu  a1, s3, zero
	ldloc 10
	stloc.2
// 0x010817b4: 0x10817b4: addiu a3, a3, -9188
	ldloc 4
	ldc.i4 -9188
	add
	stloc 4
...
// 0x010817d4: 0x10817d4: bne   v0, zero, 0x108183c lui   v0, 0x80000
	...
	brtrue L_108183c
// --- basic block ---
// 0x010817dc: 0x10817dc: lw    v0, -13644(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081854: 0x1081854: bne   v0, zero, 0x10818d8 lui   v0, 0x80000
	...
	brtrue L_10818d8
// --- basic block ---
// 0x0108185c: 0x108185c: lw    v1, -13644(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010818c0: 0x10818c0: sll   s0, s0, 2
	...
	shl
	stloc 11
// 0x010818c4: 0x10818c4: addiu v0, v0, -13616
	ldloc 5
	ldc.i4 -13616
	add
	stloc 5
...
// 0x01081970: 0x1081970: sll   v1, a0, 2
	...
	shl
	stloc 7
// 0x01081974: 0x1081974: addiu v0, v0, 29544
	ldloc 5
	ldc.i4 29544
	add
	stloc 5
...
// 0x01081a24: 0x1081a24: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01081a28: 0x1081a28: sw    s0, -13632(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081a4c: 0x1081a4c: sw    s0, 40(sp)
	...
	ldloc 8
	stelem.i4
// 0x01081a50: 0x1081a50: beq   a0, zero, 0x1081d68 sw    zero, -13628(v0)
	ldloc.1
	ldloc 7
	ldloc 5
	ldc.i4.2
...
// 0x01081a6c: 0x1081a6c: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x01081a70: 0x1081a70: addiu v1, v1, 29568
	ldloc 6
	ldc.i4 29568
	add
	stloc 6
...
// 0x01081a88: 0x1081a88: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01081a8c: 0x1081a8c: lw    v1, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081a94: 0x1081a94: sll   v1, v1, 2
	...
	shl
	stloc 6
// 0x01081a98: 0x1081a98: addiu v0, v0, -13616
	ldloc 5
	ldc.i4 -13616
	add
	stloc 5
...
// 0x01081adc: 0x1081adc: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01081ae0: 0x1081ae0: lw    v1, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081ae8: 0x1081ae8: sll   v1, v1, 2
	...
	shl
	stloc 6
// 0x01081aec: 0x1081aec: addiu v0, v0, -13616
	ldloc 5
	ldc.i4 -13616
	add
	stloc 5
...
// 0x01081b30: 0x1081b30: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01081b34: 0x1081b34: lw    v1, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081b3c: 0x1081b3c: sll   v1, v1, 2
	...
	shl
	stloc 6
// 0x01081b40: 0x1081b40: addiu v0, v0, -13616
	ldloc 5
	ldc.i4 -13616
	add
	stloc 5
...
// 0x01081b90: 0x1081b90: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01081b94: 0x1081b94: lw    v1, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081b9c: 0x1081b9c: sll   v1, v1, 2
	...
	shl
	stloc 6
// 0x01081ba0: 0x1081ba0: addiu v0, v0, -13616
	ldloc 5
	ldc.i4 -13616
	add
	stloc 5
...
// 0x01081bd8: 0x1081bd8: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x01081bdc: 0x1081bdc: j	 0x1081bf4 sw    zero, -13640(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081bec: 0x1081bec: addiu a0, zero, 1
	ldc.i4.1
	stloc.1
// 0x01081bf0: 0x1081bf0: sw    v1, -13640(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081c04: 0x1081c04: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01081c08: 0x1081c08: lw    a0, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081c2c: 0x1081c2c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01081c30: 0x1081c30: lw    v1, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081c38: 0x1081c38: sll   v1, v1, 2
	...
	shl
	stloc 6
// 0x01081c3c: 0x1081c3c: addiu v0, v0, -13616
	ldloc 5
	ldc.i4 -13616
	add
	stloc 5
...
// 0x01081cc0: 0x1081cc0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01081cc4: 0x1081cc4: j	 0x1081ce8 sw    zero, -13644(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081cd0: 0x1081cd0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01081cd4: 0x1081cd4: j	 0x1081bfc sw    v1, -13644(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081ce0: 0x1081ce0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01081ce4: 0x1081ce4: sw    v1, -13644(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081cf0: 0x1081cf0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01081cf4: 0x1081cf4: lw    a0, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081d08: 0x1081d08: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01081d0c: 0x1081d0c: lw    v1, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081d14: 0x1081d14: sll   v1, v1, 2
	...
	shl
	stloc 6
// 0x01081d18: 0x1081d18: addiu v0, v0, -13616
	ldloc 5
	ldc.i4 -13616
	add
	stloc 5
...
// 0x01081d5c: 0x1081d5c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01081d60: 0x1081d60: jal   0x102148c sw    zero, -13628(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01081d94: 0x1081d94: sw    s0, 24(sp)
	...
	ldloc 9
	stelem.i4
// 0x01081d98: 0x1081d98: addiu t0, t0, -11592
	ldloc 8
	ldc.i4 -11592
	add
	stloc 8
// 0x01081d9c: 0x1081d9c: addiu t4, t4, -13592
	ldloc 11
	ldc.i4 -13592
	add
	stloc 11
...
// 0x01081e10: 0x1081e10: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01081e14: 0x1081e14: addiu a0, s0, -13624
	ldloc 9
	ldc.i4 -13624
	add
	stloc.1
...
// 0x01081e28: 0x1081e28: addiu v0, s0, -13624
	ldloc 9
	ldc.i4 -13624
	add
	stloc 7
...
// 0x0108218c: 0x108218c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01082190: 0x1082190: lw    v0, -10792(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010821a8: 0x10821a8: lui   v0, 0x80000
	...
	stloc 5
L_10821ac:
// 0x010821ac: 0x10821ac: lw    v0, -10792(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010821b4: 0x10821b4: bne   v0, zero, 0x1082208 lui   v0, 0x80000
	...
	brtrue L_1082208
// --- basic block ---
// 0x010821bc: 0x10821bc: lw    v1, -13644(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01082220: 0x1082220: bne   v0, zero, 0x1082264 lui   v0, 0x80000
	...
	brtrue L_1082264
// --- basic block ---
// 0x01082228: 0x1082228: lw    v1, -13644(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01082330: 0x1082330: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01082334: 0x1082334: lw    a2, -13596(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01082348: 0x1082348: sw    a2, 32(sp)
	...
	ldloc.3
	stelem.i4
// 0x0108234c: 0x108234c: jal   0x101cd80 sw    v1, -13632(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01082398: 0x1082398: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0108239c: 0x108239c: lw    a2, -13600(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010823b0: 0x10823b0: sw    a2, 16(sp)
	...
	ldloc.3
	stelem.i4
// 0x010823b4: 0x10823b4: jal   0x101cd80 sw    v1, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
