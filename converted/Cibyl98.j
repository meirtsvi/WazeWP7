...
// 0x01082400: 0x1082400: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01082404: 0x1082404: lw    a2, -13604(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01082418: 0x1082418: sw    a2, 16(sp)
	...
	ldloc.3
	stelem.i4
// 0x0108241c: 0x108241c: jal   0x101cd80 sw    v1, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0108246c: 0x108246c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01082470: 0x1082470: lw    a2, -13608(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01082484: 0x1082484: sw    a2, 16(sp)
	...
	ldloc.3
	stelem.i4
// 0x01082488: 0x1082488: jal   0x101cd80 sw    v1, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010824d4: 0x10824d4: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010824d8: 0x10824d8: lw    a2, -13612(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010824ec: 0x10824ec: sw    a2, 16(sp)
	...
	ldloc.3
	stelem.i4
// 0x010824f0: 0x10824f0: jal   0x101cd80 sw    v1, -13632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01082534: 0x1082534: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01082538: 0x1082538: lw    a2, -13616(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01082548: 0x1082548: sw    a2, 16(sp)
	...
	ldloc.3
	stelem.i4
// 0x0108254c: 0x108254c: jal   0x101cd80 sw    zero, -13632(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01082588: 0x1082588: jal   0x1080f88 sw    v1, -13644(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010825c0: 0x10825c0: jal   0x1094bd4 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01082778: 0x1082778: addiu a0, s0, -19244
	...
	add
	stloc.1
// 0x0108277c: 0x108277c: jal   0x10970cc addiu a1, a1, -22708
	ldloc.2
	ldc.i4 -22708
	add
	stloc.2
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl112::ssd_menu_set_right_text_10970cc(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x0108279c: 0x108279c: addiu a0, s0, -19244
	...
	add
	stloc.1
// 0x010827a0: 0x10827a0: jal   0x10970cc addiu a1, a1, -22728
	ldloc.2
	ldc.i4 -22728
	add
	stloc.2
...
// 0x010827c4: 0x10827c4: addiu a0, s0, -19244
	...
	add
	stloc.1
// 0x010827c8: 0x10827c8: jal   0x10970cc addiu a1, a1, -22748
	ldloc.2
	ldc.i4 -22748
	add
	stloc.2
...
// 0x010827e8: 0x10827e8: addiu a0, s0, -19244
	...
	add
	stloc.1
// 0x010827ec: 0x10827ec: jal   0x10970cc addiu a1, a1, -22772
	ldloc.2
	ldc.i4 -22772
	add
	stloc.2
...
// 0x0108280c: 0x108280c: addiu a0, s0, -19244
	...
	add
	stloc.1
// 0x01082810: 0x1082810: jal   0x10970cc addiu a1, a1, -22796
	ldloc.2
	ldc.i4 -22796
	add
	stloc.2
...
// 0x0108284c: 0x108284c: addiu a1, a1, -22816
	...
	add
	stloc.2
// 0x01082850: 0x1082850: jal   0x10970cc addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01082a04: 0x1082a04: lui   v0, 0x80000
	ldc.i4 524288
	stloc.0
// 0x01082a08: 0x1082a08: lw    v0, -5972(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01082a14: 0x1082a14: lui   v0, 0x80000
	ldc.i4 524288
	stloc.0
// 0x01082a18: 0x1082a18: lw    v0, -5972(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01082a24: 0x1082a24: lui   v0, 0x80000
	ldc.i4 524288
	stloc 4
// 0x01082a28: 0x1082a28: addiu v0, v0, -7972
	ldloc 4
	ldc.i4 -7972
	add
	stloc 4
...
// 0x01082ab8: 0x1082ab8: lui   v0, 0x80000
	ldc.i4 524288
	stloc.1
// 0x01082abc: 0x1082abc: addiu v0, v0, -7972
	ldloc.1
	ldc.i4 -7972
	add
	stloc.1
...
// 0x01082ad4: 0x1082ad4: lui   v0, 0x80000
	ldc.i4 524288
	stloc.0
// 0x01082ad8: 0x1082ad8: lw    v0, -1968(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01082af0: 0x1082af0: lui   v0, 0x80000
	ldc.i4 524288
	stloc.1
// 0x01082af4: 0x1082af4: addiu v0, v0, -5968
	ldloc.1
	ldc.i4 -5968
	add
	stloc.1
...
// 0x01082b0c: 0x1082b0c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 4
// 0x01082b10: 0x1082b10: addiu v0, v0, -5968
	ldloc 4
	ldc.i4 -5968
	add
	stloc 4
...
// 0x01082b9c: 0x1082b9c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 4
// 0x01082ba0: 0x1082ba0: addiu v0, v0, -5968
	ldloc 4
	ldc.i4 -5968
	add
	stloc 4
...
// 0x01082c20: 0x1082c20: lui   v0, 0x80000
	ldc.i4 524288
	stloc 4
// 0x01082c24: 0x1082c24: addiu v0, v0, -5968
	ldloc 4
	ldc.i4 -5968
	add
	stloc 4
...
// 0x01082ce8: 0x1082ce8: sll   a0, a0, 2
	...
	shl
	stloc.1
// 0x01082cec: 0x1082cec: addiu v0, v0, -5968
	ldloc 6
	ldc.i4 -5968
	add
	stloc 6
...
// 0x01082d84: 0x1082d84: lui   v1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x01082d88: 0x1082d88: lw    v1, 31360(v1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1082dac:
// 0x01082dac: 0x1082dac: lw    a1, 31448(a0)
	ldloc 5
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01082de0: 0x1082de0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01082de4: 0x1082de4: lw    v1, 31436(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01082eb8: 0x1082eb8: sw    v0, 552(s5)
	...
	stelem.i4
L_1082ebc:
// 0x01082ebc: 0x1082ebc: lw    v1, 31448(s7)
	ldloc 5
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x01082fb8: 0x1082fb8: lui   s0, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01082fbc: 0x1082fbc: addiu s0, s0, -5968
	ldloc 7
	ldc.i4 -5968
	add
	stloc 7
...
// 0x010830c8: 0x10830c8: mflo  lo
	ldloc 13
	stloc.1
// 0x010830cc: 0x10830cc: jal   0x10c0da0 sll   zero, zero, 0
	ldloc.0
	ldloc.1
...
// 0x010830d4: 0x10830d4: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x010830d8: 0x10830d8: lw    a3, 23908(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x010830dc: 0x10830dc: lw    a2, 23904(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010830e0: 0x10830e0: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x010830e4: 0x10830e4: jal   0x10c0b78 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010830f0: 0x10830f0: addu  s3, v1, zero
	ldloc 6
	stloc 11
// 0x010830f4: 0x10830f4: jal   0x10c0da0 addu  s2, v0, zero
	ldloc 5
	stloc 10
	ldloc.0
	ldloc.1
...
// 0x01083104: 0x1083104: addu  a0, s2, zero
	ldloc 10
	stloc.1
// 0x01083108: 0x1083108: jal   0x10c0bd0 addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01083110: 0x1083110: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x01083114: 0x1083114: jal   0x10c0cb0 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01083350: 0x1083350: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01083354: 0x1083354: addiu v0, v0, -7972
	ldloc 5
	ldc.i4 -7972
	add
	stloc 5
...
// 0x01083394: 0x1083394: lui   a3, 0x80000
	ldc.i4 524288
	stloc 4
// 0x01083398: 0x1083398: addiu a3, a3, -7972
	ldloc 4
	ldc.i4 -7972
	add
	stloc 4
...
// 0x010833ac: 0x10833ac: addu  v0, v0, a3
	...
	add
	stloc 5
// 0x010833b0: 0x10833b0: addiu a2, a2, -5968
	ldloc.3
	ldc.i4 -5968
	add
	stloc.3
...
// 0x0108346c: 0x108346c: lui   s0, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01083470: 0x1083470: addiu s0, s0, -7972
	ldloc 7
	ldc.i4 -7972
	add
	stloc 7
...
// 0x01083488: 0x1083488: sw    s2, 24(sp)
	...
	ldloc 10
	stelem.i4
// 0x0108348c: 0x108348c: lw    s4, 23844(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010834a4: 0x10834a4: lw    a0, 4(s2)
	...
	ldelem.i4
	stloc.1
// 0x010834a8: 0x10834a8: jal   0x10c0d8c addiu s0, s0, 4
	ldloc 7
	ldc.i4.4
	add
	stloc 7
...
// 0x010834b8: 0x10834b8: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x010834bc: 0x10834bc: jal   0x10c0ab0 addu  a1, s4, zero
	ldloc 12
	stloc.2
	ldloc.1
	ldloc.2
	...
	stloc 5
// --- basic block ---
// 0x010834c4: 0x10834c4: jal   0x10c0c9c addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
...
// 0x010834e4: 0x10834e4: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010834e8: 0x10834e8: lw    v0, -7976(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01083524: 0x1083524: addiu sp, sp, -72
	...
	add
	stloc.0
// 0x01083528: 0x1083528: addiu v1, v1, -7972
	ldloc 8
	ldc.i4 -7972
	add
	stloc 8
...
// 0x010835b0: 0x10835b0: sll   s2, s2, 2
	...
	shl
	stloc 9
// 0x010835b4: 0x10835b4: addiu s1, s1, -7972
	ldloc 6
	ldc.i4 -7972
	add
	stloc 6
...
// 0x01083634: 0x1083634: lui   s1, 0x80000
	...
	stloc 6
L_1083638:
// 0x01083638: 0x1083638: addiu s1, s1, -7972
	ldloc 6
	ldc.i4 -7972
	add
	stloc 6
...
// 0x0108367c: 0x108367c: sw    v1, 0(s2)
	...
	ldloc 8
	stelem.i4
// 0x01083680: 0x1083680: jal   0x10c0d8c sw    v0, 2696(s2)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01083690: 0x1083690: lui   v1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x01083694: 0x1083694: lw    a1, 23844(v1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01083698: 0x1083698: jal   0x10c0ab0 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	ldloc.2
	...
	stloc 5
// --- basic block ---
// 0x010836a0: 0x10836a0: jal   0x10c0c9c addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	call float32 [WazeWP7]CRunTime::intBitsToFloat(int32)
...
// 0x010836bc: 0x10836bc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010836c0: 0x10836c0: addiu v0, v0, 29624
	ldloc 5
	ldc.i4 29624
	add
	stloc 5
...
// 0x01083748: 0x1083748: lui   s1, 0x80000
	ldc.i4 524288
	stloc 6
// 0x0108374c: 0x108374c: addiu s1, s1, -7972
	ldloc 6
	ldc.i4 -7972
	add
	stloc 6
...
// 0x01083840: 0x1083840: jal   0x1001b14 lui   s2, 0x80000
	...
	stloc 5
// --- basic block ---
// 0x01083848: 0x1083848: addiu s2, s2, -7972
	ldloc 9
	ldc.i4 -7972
	add
	stloc 9
...
// 0x010838c8: 0x10838c8: lui   v0, 0x80000
	...
	stloc 5
L_10838cc:
// 0x010838cc: 0x10838cc: addiu v0, v0, -7972
	ldloc 5
	ldc.i4 -7972
	add
	stloc 5
...
// 0x01083910: 0x1083910: beq   v0, zero, 0x1083988 lui   s0, 0x80000
	...
	brfalse L_1083988
// --- basic block ---
// 0x01083918: 0x1083918: lw    v0, -7984(s0)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01083920: 0x1083920: bne   v0, zero, 0x1083988 sll   zero, zero, 0
	...
	brtrue L_1083988
// --- basic block ---
// 0x01083928: 0x1083928: jal   0x10aceb8 addu  a0, s1, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01083934: 0x1083934: addiu a2, zero, 5
	ldc.i4.5
	stloc.3
// 0x01083938: 0x1083938: jal   0x10acc5c addu  a0, s1, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0108397c: 0x108397c: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x01083980: 0x1083980: j	 0x108398c sw    v0, -7984(s0)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010839e0: 0x10839e0: jal   0x106c404 addiu a1, zero, 100
	...
	stloc 5
// --- basic block ---
// 0x010839e8: 0x10839e8: jal   0x10aceb8 addu  a0, s2, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010839f4: 0x10839f4: addiu a1, zero, 5
	ldc.i4.5
	stloc.2
// 0x010839f8: 0x10839f8: jal   0x10acc5c addiu a2, zero, 2
	ldc.i4.2
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01083a10: 0x1083a10: jal   0x106c404 addu  a0, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x01083a18: 0x1083a18: jal   0x10aceb8 addu  a0, s2, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01083a24: 0x1083a24: addiu a1, zero, 5
	ldc.i4.5
	stloc.2
// 0x01083a28: 0x1083a28: jal   0x10acc5c addiu a2, zero, 2
	ldc.i4.2
	stloc.3
	ldloc.0
	ldloc.1
