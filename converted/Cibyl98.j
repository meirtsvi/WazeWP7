...
// 0x01082778: 0x1082778: addiu a0, s0, -19244
	...
	add
	stloc.1
// 0x0108277c: 0x108277c: jal   0x10970f0 addiu a1, a1, -22708
	ldloc.2
	ldc.i4 -22708
	add
	stloc.2
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl112::ssd_menu_set_right_text_10970f0(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x0108279c: 0x108279c: addiu a0, s0, -19244
	...
	add
	stloc.1
// 0x010827a0: 0x10827a0: jal   0x10970f0 addiu a1, a1, -22728
	ldloc.2
	ldc.i4 -22728
	add
	stloc.2
...
// 0x010827c4: 0x10827c4: addiu a0, s0, -19244
	...
	add
	stloc.1
// 0x010827c8: 0x10827c8: jal   0x10970f0 addiu a1, a1, -22748
	ldloc.2
	ldc.i4 -22748
	add
	stloc.2
...
// 0x010827e8: 0x10827e8: addiu a0, s0, -19244
	...
	add
	stloc.1
// 0x010827ec: 0x10827ec: jal   0x10970f0 addiu a1, a1, -22772
	ldloc.2
	ldc.i4 -22772
	add
	stloc.2
...
// 0x0108280c: 0x108280c: addiu a0, s0, -19244
	...
	add
	stloc.1
// 0x01082810: 0x1082810: jal   0x10970f0 addiu a1, a1, -22796
	ldloc.2
	ldc.i4 -22796
	add
	stloc.2
...
// 0x0108284c: 0x108284c: addiu a1, a1, -22816
	...
	add
	stloc.2
// 0x01082850: 0x1082850: jal   0x10970f0 addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x010830c8: 0x10830c8: mflo  lo
	ldloc 13
	stloc.1
// 0x010830cc: 0x10830cc: jal   0x10c0b30 sll   zero, zero, 0
	ldloc.0
	ldloc.1
...
// 0x010830e0: 0x10830e0: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x010830e4: 0x10830e4: jal   0x10c0908 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010830f0: 0x10830f0: addu  s3, v1, zero
	ldloc 6
	stloc 11
// 0x010830f4: 0x10830f4: jal   0x10c0b30 addu  s2, v0, zero
	ldloc 5
	stloc 10
	ldloc.0
	ldloc.1
...
// 0x01083104: 0x1083104: addu  a0, s2, zero
	ldloc 10
	stloc.1
// 0x01083108: 0x1083108: jal   0x10c0960 addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01083110: 0x1083110: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x01083114: 0x1083114: jal   0x10c0a40 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010834a4: 0x10834a4: lw    a0, 4(s2)
	...
	ldelem.i4
	stloc.1
// 0x010834a8: 0x10834a8: jal   0x10c0b1c addiu s0, s0, 4
	ldloc 7
	ldc.i4.4
	add
	stloc 7
...
// 0x010834b8: 0x10834b8: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x010834bc: 0x10834bc: jal   0x10c0840 addu  a1, s4, zero
	ldloc 12
	stloc.2
	ldloc.1
	ldloc.2
	...
	stloc 5
// --- basic block ---
// 0x010834c4: 0x10834c4: jal   0x10c0a2c addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
...
// 0x0108367c: 0x108367c: sw    v1, 0(s2)
	...
	ldloc 8
	stelem.i4
// 0x01083680: 0x1083680: jal   0x10c0b1c sw    v0, 2696(s2)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01083694: 0x1083694: lw    a1, 23796(v1)
	...
	ldelem.i4
	stloc.2
// 0x01083698: 0x1083698: jal   0x10c0840 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	ldloc.2
	...
	stloc 5
// --- basic block ---
// 0x010836a0: 0x10836a0: jal   0x10c0a2c addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	call float32 [WazeWP7]CRunTime::intBitsToFloat(int32)
...
// 0x01083920: 0x1083920: bne   v0, zero, 0x1083988 sll   zero, zero, 0
	...
	brtrue L_1083988
// --- basic block ---
// 0x01083928: 0x1083928: jal   0x10acc48 addu  a0, s1, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01083934: 0x1083934: addiu a2, zero, 5
	ldc.i4.5
	stloc.3
// 0x01083938: 0x1083938: jal   0x10ac9ec addu  a0, s1, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010839e0: 0x10839e0: jal   0x106c404 addiu a1, zero, 100
	...
	stloc 5
// --- basic block ---
// 0x010839e8: 0x10839e8: jal   0x10acc48 addu  a0, s2, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010839f4: 0x10839f4: addiu a1, zero, 5
	ldc.i4.5
	stloc.2
// 0x010839f8: 0x10839f8: jal   0x10ac9ec addiu a2, zero, 2
	ldc.i4.2
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01083a10: 0x1083a10: jal   0x106c404 addu  a0, s1, zero
	...
	stloc 5
// --- basic block ---
// 0x01083a18: 0x1083a18: jal   0x10acc48 addu  a0, s2, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01083a24: 0x1083a24: addiu a1, zero, 5
	ldc.i4.5
	stloc.2
// 0x01083a28: 0x1083a28: jal   0x10ac9ec addiu a2, zero, 2
	ldc.i4.2
	stloc.3
	ldloc.0
	ldloc.1
