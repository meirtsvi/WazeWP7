...
// 0x01030548: 0x1030548: sw    v1, 36(sp)
	...
	ldloc 7
	stelem.i4
// 0x0103054c: 0x103054c: jal   0x10a1aa4 sw    a3, 32(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0103072c: 0x103072c: addiu a0, zero, 1
	ldc.i4.1
	stloc.1
// 0x01030730: 0x1030730: jal   0x10a1aa4 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01030b04: 0x1030b04: sw    v1, 24(sp)
	...
	ldloc 7
	stelem.i4
// 0x01030b08: 0x1030b08: jal   0x10a1aa4 sw    v0, 28(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01031124: 0x1031124: addu  v1, v0, zero
	ldloc 6
	stloc 7
// 0x01031128: 0x1031128: jal   0x10c36d8 addiu s2, zero, 48
	ldc.i4.s 48
	stloc 9
	ldloc.0
	ldloc.1
...
// 0x01031420: 0x1031420: lw    a2, 24016(v0)
	...
	ldelem.i4
	stloc.3
// 0x01031424: 0x1031424: jal   0x10c192c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
