...
// 0x0102d3f0: 0x102d3f0: addiu a0, a0, -25052
	...
	add
	stloc.1
// 0x0102d3f4: 0x102d3f4: addiu a1, a1, 12052
	ldloc.2
	ldc.i4 12052
	add
	stloc.2
...
// 0x0102d428: 0x102d428: addiu a0, a0, -25040
	...
	add
	stloc.1
// 0x0102d42c: 0x102d42c: addiu a1, a1, 12068
	ldloc.2
	ldc.i4 12068
	add
	stloc.2
...
// 0x0102d870: 0x102d870: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0102d874: 0x102d874: jal   0x100e368 addiu a0, a0, 11844
	ldloc.1
	ldc.i4 11844
	add
	stloc.1
...
// 0x0102d8cc: 0x102d8cc: addiu a0, zero, 4
	ldc.i4.4
	stloc.1
// 0x0102d8d0: 0x102d8d0: addiu a2, zero, 2531
	ldc.i4 2531
	stloc.3
...
// 0x0102d98c: 0x102d98c: addiu a0, zero, 4
	ldc.i4.4
	stloc.1
// 0x0102d990: 0x102d990: jal   0x100449c addiu a2, zero, 3153
	ldc.i4 3153
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0102da00: 0x102da00: addiu a2, a2, 11680
	...
	add
	stloc.3
// 0x0102da04: 0x102da04: addiu a3, a3, 11768
	ldloc 4
	ldc.i4 11768
	add
	stloc 4
...
// 0x0102db74: 0x102db74: jal   0x1004258 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x0102db7c: 0x102db7c: lw    v0, 12048(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0102db94: 0x102db94: jal   0x1015cc8 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x0102db9c: 0x102db9c: sw    v0, 12048(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0102dbe8: 0x102dbe8: sw    s1, 24(sp)
	...
	ldloc 7
	stelem.i4
// 0x0102dbec: 0x102dbec: addiu a1, a1, 11908
	ldloc.2
	ldc.i4 11908
	add
	stloc.2
...
// 0x0102dc44: 0x102dc44: addiu a0, zero, 4
	ldc.i4.4
	stloc.1
// 0x0102dc48: 0x102dc48: jal   0x100449c addiu a2, zero, 2636
	ldc.i4 2636
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0102dc6c: 0x102dc6c: jal   0x100e7a8 addiu a0, a0, 11892
	ldloc.1
	ldc.i4 11892
	add
	stloc.1
...
// 0x0102dcdc: 0x102dcdc: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x0102dce0: 0x102dce0: addiu a1, a1, 11844
	ldloc.2
	ldc.i4 11844
	add
	stloc.2
...
// 0x0102dd10: 0x102dd10: addiu a3, s2, 20820
	...
	add
	stloc 4
// 0x0102dd14: 0x102dd14: addiu a1, a1, 11860
	ldloc.2
	ldc.i4 11860
	add
	stloc.2
...
// 0x0102dd30: 0x102dd30: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x0102dd34: 0x102dd34: addiu a1, a1, 11876
	ldloc.2
	ldc.i4 11876
	add
	stloc.2
...
// 0x0102dd68: 0x102dd68: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x0102dd6c: 0x102dd6c: addiu a1, a1, 11892
	ldloc.2
	ldc.i4 11892
	add
	stloc.2
...
// 0x0102de20: 0x102de20: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0102de24: 0x102de24: jal   0x100e630 addiu a0, a0, 11892
	ldloc.1
	ldc.i4 11892
	add
	stloc.1
...
// 0x0102dffc: 0x102dffc: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0102e000: 0x102e000: addiu a1, a1, 11908
	ldloc.2
	ldc.i4 11908
	add
	stloc.2
...
// 0x0102e654: 0x102e654: addiu a0, a0, -25228
	...
	add
	stloc.1
// 0x0102e658: 0x102e658: jal   0x1004a38 addiu a1, zero, 2141
	ldc.i4 2141
	stloc.2
	ldloc.0
	ldloc.1
