...
// 0x0108b194: 0x108b194: lw    a1, 28720(s0)
	...
	ldelem.i4
	stloc.2
// 0x0108b198: 0x108b198: jal   0x10acc78 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl129::editor_points_set_old_points_10acc78(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x0108b994: 0x108b994: addiu a1, zero, 1
	ldc.i4.1
	stloc.2
// 0x0108b998: 0x108b998: jal   0x10a1a90 addu  a2, s2, zero
	ldloc 8
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0108b9c0: 0x108b9c0: sw    zero, 24(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x0108b9c4: 0x108b9c4: jal   0x10a2dd0 sw    zero, 28(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108c1dc: 0x108c1dc: addiu a0, a0, -6916
	...
	add
	stloc.1
// 0x0108c1e0: 0x108c1e0: jal   0x109e2b4 addiu a2, zero, 512
	ldc.i4 512
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0108c1f0: 0x108c1f0: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x0108c1f4: 0x108c1f4: jal   0x10994c8 addu  s4, v0, zero
	ldloc 5
	stloc 16
	ldloc.0
	ldloc.1
...
// 0x0108c240: 0x108c240: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x0108c244: 0x108c244: jal   0x1099158 addu  s2, v0, zero
	ldloc 5
	stloc 13
	ldloc.1
	ldloc.2
...
// 0x0108c2b0: 0x108c2b0: jal   0x1098e88 lui   s7, 0x0
	ldc.i4.s 0
	stloc 8
	ldloc.0
	ldloc.1
...
// 0x0108c2c0: 0x108c2c0: addiu a1, s7, 23000
	...
	add
	stloc.2
// 0x0108c2c4: 0x108c2c4: jal   0x1099158 sw    v0, 1360(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108c2d0: 0x108c2d0: addu  a0, s2, zero
	ldloc 13
	stloc.1
// 0x0108c2d4: 0x108c2d4: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108c310: 0x108c310: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x0108c314: 0x108c314: jal   0x109e2b4 addiu a2, zero, 8
	ldc.i4.8
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0108c31c: 0x108c31c: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x0108c320: 0x108c320: jal   0x109903c addu  a0, s2, zero
	ldloc 13
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x0108c364: 0x108c364: addiu a2, zero, 18
	ldc.i4.s 18
	stloc.3
// 0x0108c368: 0x108c368: jal   0x1098e88 addiu a3, zero, 8
	ldc.i4.8
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x0108c378: 0x108c378: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x0108c37c: 0x108c37c: jal   0x1099158 sw    v0, 1360(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108c388: 0x108c388: addu  a0, s2, zero
	ldloc 13
	stloc.1
// 0x0108c38c: 0x108c38c: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108c3d8: 0x108c3d8: addiu a3, zero, 8
	ldc.i4.8
	stloc 4
// 0x0108c3dc: 0x108c3dc: jal   0x1098e88 sb    zero, 447(sp)
	ldloc.0
	ldc.i4 447
	add
	ldc.i4.s 0
...
// 0x0108c3f0: 0x108c3f0: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x0108c3f4: 0x108c3f4: jal   0x1099158 sw    v0, 1360(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108c400: 0x108c400: addu  a0, s2, zero
	ldloc 13
	stloc.1
// 0x0108c404: 0x108c404: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108c4d0: 0x108c4d0: addiu a2, zero, 14
	ldc.i4.s 14
	stloc.3
// 0x0108c4d4: 0x108c4d4: jal   0x1098e88 ori   a3, zero, 32776
	ldc.i4.s 0
	ldc.i4 32776
	or
	stloc 4
...
// 0x0108c4e8: 0x108c4e8: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x0108c4ec: 0x108c4ec: jal   0x1099158 sw    v0, 1360(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108c4f8: 0x108c4f8: addu  a0, s2, zero
	ldloc 13
	stloc.1
// 0x0108c4fc: 0x108c4fc: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108c538: 0x108c538: lw    v0, 240(v0)
	...
	ldelem.i4
	stloc 5
// 0x0108c53c: 0x108c53c: jal   0x10c36c8 sw    v0, 1356(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108c560: 0x108c560: lw    s8, 192(sp)
	...
	ldelem.i4
	stloc 14
// 0x0108c564: 0x108c564: jal   0x10c36c8 addu  a0, s0, a0
	ldloc 10
	ldloc.1
	add
	stloc.1
...
// 0x0108c6cc: 0x108c6cc: sw    a2, 1360(sp)
	...
	ldloc.3
	stelem.i4
// 0x0108c6d0: 0x108c6d0: jal   0x10c0b30 subu  a0, v1, v0
	ldloc 6
	ldloc 5
	sub
	stloc.1
...
// 0x0108c6d8: 0x108c6d8: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x0108c6dc: 0x108c6dc: jal   0x10c0a40 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0108c71c: 0x108c71c: addiu a1, sp, 948
	...
	add
	stloc.2
// 0x0108c720: 0x108c720: jal   0x1098e88 addiu a2, zero, 14
	ldc.i4.s 14
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0108c734: 0x108c734: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x0108c738: 0x108c738: jal   0x1099158 sw    v0, 1360(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108c744: 0x108c744: addu  a0, s2, zero
	ldloc 13
	stloc.1
// 0x0108c748: 0x108c748: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108c780: 0x108c780: lw    a1, 148(s7)
	...
	ldelem.i4
	stloc.2
// 0x0108c784: 0x108c784: jal   0x10c0a40 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	call int32 Cibyl143::__fixdfsi_10c0a40(int32,int32,int32)
...
// 0x0108c868: 0x108c868: addiu a1, sp, 448
	...
	add
	stloc.2
// 0x0108c86c: 0x108c86c: jal   0x1098e88 addiu a2, zero, 14
	ldc.i4.s 14
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0108c880: 0x108c880: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x0108c884: 0x108c884: jal   0x1099158 sw    v0, 1360(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108c890: 0x108c890: addu  a0, s2, zero
	ldloc 13
	stloc.1
// 0x0108c894: 0x108c894: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108c928: 0x108c928: addiu a1, sp, 1148
	...
	add
	stloc.2
// 0x0108c92c: 0x108c92c: jal   0x1098e88 addiu a2, zero, 12
	ldc.i4.s 12
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0108c940: 0x108c940: addiu a1, a1, 23000
	...
	add
	stloc.2
// 0x0108c944: 0x108c944: jal   0x1099158 sw    v0, 1360(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108c950: 0x108c950: addu  a0, s2, zero
	ldloc 13
	stloc.1
// 0x0108c954: 0x108c954: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108c984: 0x108c984: lui   v0, 0x10800000
	ldc.i4 276824064
	stloc 5
// 0x0108c988: 0x108c988: jal   0x109e668 sw    v0, 24(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108c9d0: 0x108c9d0: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x0108c9d4: 0x108c9d4: jal   0x1099158 addu  s3, v0, zero
	ldloc 5
	stloc 9
	ldloc.1
	ldloc.2
...
// 0x0108ca4c: 0x108ca4c: addu  a2, a1, zero
	ldloc.2
	stloc.3
// 0x0108ca50: 0x108ca50: jal   0x1099158 addu  s7, v0, zero
	ldloc 5
	stloc 8
	ldloc.1
	ldloc.2
...
// 0x0108ca64: 0x108ca64: addiu a0, a0, -25112
	...
	add
	stloc.1
// 0x0108ca68: 0x108ca68: jal   0x109e2b4 addiu a1, a1, -25076
	ldloc.2
	ldc.i4 -25076
	add
	stloc.2
...
// 0x0108ca74: 0x108ca74: addu  a0, s7, zero
	ldloc 8
	stloc.1
// 0x0108ca78: 0x108ca78: jal   0x109903c addu  s8, v0, zero
	ldloc 5
	stloc 14
	ldloc.1
	ldloc.2
...
// 0x0108ca84: 0x108ca84: addiu a1, zero, -20
	ldc.i4.s -20
	stloc.2
// 0x0108ca88: 0x108ca88: jal   0x10990fc addiu a2, zero, 12
	ldc.i4.s 12
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0108cab8: 0x108cab8: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x0108cabc: 0x108cabc: jal   0x1099158 sw    v0, 1360(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108cac4: 0x108cac4: addu  a0, s3, zero
	ldloc 9
	stloc.1
// 0x0108cac8: 0x108cac8: jal   0x109903c addu  a1, s7, zero
	ldloc 8
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108cad4: 0x108cad4: addu  a0, s3, zero
	ldloc 9
	stloc.1
// 0x0108cad8: 0x108cad8: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108cae0: 0x108cae0: addu  a0, s7, zero
	ldloc 8
	stloc.1
// 0x0108cae4: 0x108cae4: jal   0x109903c addu  a1, s4, zero
	ldloc 16
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108cb38: 0x108cb38: addu  a1, s4, zero
	ldloc 16
	stloc.2
// 0x0108cb3c: 0x108cb3c: jal   0x109903c addu  a0, s3, zero
	ldloc 9
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x0108ccb0: 0x108ccb0: addiu a1, sp, 448
	...
	add
	stloc.2
// 0x0108ccb4: 0x108ccb4: jal   0x1098e88 addiu a2, zero, 14
	ldc.i4.s 14
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0108ccc8: 0x108ccc8: addiu a1, a1, 23008
	...
	add
	stloc.2
// 0x0108cccc: 0x108cccc: jal   0x1099158 sw    v0, 1360(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108ccdc: 0x108ccdc: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x0108cce0: 0x108cce0: jal   0x109903c addu  a0, s3, zero
	ldloc 9
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x0108cce8: 0x108cce8: lw    a0, -1964(s0)
	...
	ldelem.i4
	stloc.1
// 0x0108ccec: 0x108ccec: jal   0x109903c addu  a1, s3, zero
	ldloc 9
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108ccf4: 0x108ccf4: lw    a0, -1964(s0)
	...
	ldelem.i4
	stloc.1
// 0x0108ccf8: 0x108ccf8: jal   0x109903c addu  a1, s2, zero
	ldloc 13
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108cd2c: 0x108cd2c: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x0108cd30: 0x108cd30: jal   0x1099158 sw    v0, 1360(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108cd3c: 0x108cd3c: lw    a0, -1964(s0)
	...
	ldelem.i4
	stloc.1
// 0x0108cd40: 0x108cd40: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108cd74: 0x108cd74: lw    a0, -1964(s0)
	...
	ldelem.i4
	stloc.1
// 0x0108cd78: 0x108cd78: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0108cd84: 0x108cd84: addiu a0, a0, -7084
	...
	add
	stloc.1
// 0x0108cd88: 0x108cd88: jal   0x1096064 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
