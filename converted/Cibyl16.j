...
// 0x01015c78: 0x1015c78: lui   v0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x01015c7c: 0x1015c7c: lw    v0, -28240(v0)
	ldloc 4
	ldloc.1
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1015c88:
// 0x01015c88: 0x1015c88: lw    v0, -28244(v0)
	ldloc 4
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01015ca4: 0x1015ca4: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x01015ca8: 0x1015ca8: lw    v0, -28248(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01015cd4: 0x1015cd4: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x01015cd8: 0x1015cd8: lw    v0, -28252(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01015ce8: 0x1015ce8: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x01015cec: 0x1015cec: jr    ra sw    v1, -28240(v0)
	ldloc 3
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01015cf8: 0x1015cf8: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x01015cfc: 0x1015cfc: jr    ra sw    v1, -28244(v0)
	ldloc 3
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01015d2c: 0x1015d2c: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x01015d30: 0x1015d30: jr    ra sw    v1, -28252(v0)
	ldloc 3
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01015d60: 0x1015d60: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x01015d64: 0x1015d64: addiu s1, s1, 9628
	ldloc 6
	ldc.i4 9628
	add
	stloc 6
...
// 0x01015e08: 0x1015e08: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01015e0c: 0x1015e0c: lw    v0, -28256(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01015e70: 0x1015e70: sw    s6, 56(sp)
	...
	ldloc 8
	stelem.i4
// 0x01015e74: 0x1015e74: sw    a2, -28260(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01015f74: 0x1015f74: lw    s0, 32(sp)
	...
	ldelem.i4
	stloc 10
// 0x01015f78: 0x1015f78: sw    zero, -28260(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1016014:
// 0x01016014: 0x1016014: lw    v0, -28260(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010160a0: 0x10160a0: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x010160a4: 0x10160a4: bgtz  v0, 0x10160cc sw    v0, -28256(v1)
	ldloc 6
	ldloc 5
	ldloc 7
	ldc.i4.2
...
// 0x01016100: 0x1016100: jal   0x100e5e0 addiu a1, a1, 9628
	ldloc.2
	ldc.i4 9628
	add
	stloc.2
...
// 0x0101612c: 0x101612c: jal   0x100e5e0 addiu a1, a1, 9628
	ldloc.2
	ldc.i4 9628
	add
	stloc.2
...
// 0x010161ac: 0x10161ac: jal   0x100e5e0 addiu a1, a1, 7036
	ldloc.2
	ldc.i4 7036
	add
	stloc.2
...
// 0x010161ec: 0x10161ec: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010161f0: 0x10161f0: lw    v0, -28248(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01016220: 0x1016220: lw    s0, 16(sp)
	...
	ldelem.i4
	stloc 8
// 0x01016224: 0x1016224: sw    v0, -28248(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010163f0: 0x10163f0: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x010163f4: 0x10163f4: lw    v0, -28220(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01016410: 0x1016410: bltz  v0, 0x1016424 lui   v1, 0x30000
	...
	blt L_1016424
// --- basic block ---
// 0x01016418: 0x1016418: lw    v1, -28232(v1)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0101642c: 0x101642c: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x01016430: 0x1016430: lw    v0, -28220(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101643c: 0x101643c: lui   v0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x01016440: 0x1016440: jr    ra sw    a0, -28228(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01016458: 0x1016458: lui   v0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x0101645c: 0x101645c: jr    ra sw    a0, -28236(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01016480: 0x1016480: jal   0x101afd8 sw    zero, -28224(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010164a4: 0x10164a4: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010164a8: 0x10164a8: sw    zero, -28228(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010164ac: 0x10164ac: lui   v0, 0x30000
	...
	stloc 5
L_10164b0:
// 0x010164b0: 0x10164b0: lw    v0, -28236(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010164e0: 0x10164e0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010164e4: 0x10164e4: jal   0x102148c sw    v1, -28236(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101651c: 0x101651c: jal   0x102148c sw    v1, -28224(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01016550: 0x1016550: jal   0x102148c sw    zero, -28236(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01016598: 0x1016598: sw    s0, 24(sp)
	...
	ldloc 8
	stelem.i4
// 0x0101659c: 0x101659c: jal   0x101fa48 sw    zero, -28212(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010165b0: 0x10165b0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010165b4: 0x10165b4: sw    v1, -28232(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010165d0: 0x10165d0: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x010165d4: 0x10165d4: addiu v0, v0, 9628
	ldloc 5
	ldc.i4 9628
	add
	stloc 5
...
// 0x010165ec: 0x10165ec: addiu a1, zero, 1
	ldc.i4.1
	stloc.2
// 0x010165f0: 0x10165f0: jal   0x10a1a64 addiu a2, s0, 29728
	ldloc 8
	ldc.i4 29728
	add
	stloc.3
...
// 0x0101664c: 0x101664c: jal   0x104241c sw    v0, 4(s1)
	...
	stloc 5
// --- basic block ---
// 0x01016654: 0x1016654: lw    v1, -28232(s2)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0101665c: 0x101665c: addu  v0, v0, v1
	...
	add
	stloc 5
// 0x01016660: 0x1016660: addiu s0, s0, -28208
	ldloc 8
	ldc.i4 -28208
	add
	stloc 8
// 0x01016664: 0x1016664: jal   0x104241c sw    v0, 4(s0)
	...
	stloc 5
// --- basic block ---
// 0x0101666c: 0x101666c: lw    a0, -28232(s2)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01016698: 0x1016698: addiu a0, a0, 29824
	...
	add
	stloc.1
// 0x0101669c: 0x101669c: jal   0x104ee2c sw    v0, -28216(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010166a8: 0x10166a8: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010166ac: 0x10166ac: sw    v1, -28212(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01016738: 0x1016738: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101673c: 0x101673c: lw    v0, -28212(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01016740: 0x1016740: lui   v1, 0xf0000
	ldc.i4 983040
	stloc 6
// 0x01016744: 0x1016744: lw    s0, -30052(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01016760: 0x1016760: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01016764: 0x1016764: lw    v0, -28236(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1016774:
// 0x01016774: 0x1016774: lw    v0, -28224(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101679c: 0x101679c: bne   v0, zero, 0x10167f0 lui   v0, 0x30000
	...
	brtrue L_10167f0
// --- basic block ---
// 0x010167a4: 0x10167a4: lw    v0, -28236(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010167e4: 0x10167e4: lui   v0, 0x30000
	...
	stloc 5
L_10167e8:
// 0x010167e8: 0x10167e8: j	 0x1016c9c sw    zero, -28220(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010167f4: 0x10167f4: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010167f8: 0x10167f8: sw    v1, -28220(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101681c: 0x101681c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01016820: 0x1016820: lw    a0, -28216(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01016838: 0x1016838: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0101683c: 0x101683c: lw    s7, -30052(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 16
// 0x01016840: 0x1016840: jal   0x10a1a64 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01016860: 0x1016860: jal   0x104241c sw    s2, 36(sp)
	...
	stloc 5
// --- basic block ---
// 0x01016868: 0x1016868: lw    v1, -28232(s6)
	ldloc 7
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x010168a0: 0x10168a0: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x010168a4: 0x10168a4: jal   0x109a570 sw    zero, 36(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010168b4: 0x10168b4: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x010168b8: 0x10168b8: lw    v0, -30052(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010168dc: 0x10168dc: jal   0x104241c sw    a1, 352(sp)
	...
	stloc 5
// --- basic block ---
// 0x010168e4: 0x10168e4: lw    v1, -28232(s2)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01016918: 0x1016918: jal   0x104241c sw    v0, 44(sp)
	...
	stloc 5
// --- basic block ---
// 0x01016920: 0x1016920: lw    a0, -28232(s2)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01016924: 0x1016924: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x01016928: 0x1016928: lw    v1, -28228(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01016944: 0x1016944: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01016948: 0x1016948: addiu v0, v0, 25016
	ldloc 5
	ldc.i4 25016
	add
	stloc 5
...
// 0x010169d8: 0x10169d8: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x010169dc: 0x10169dc: jal   0x10a1a64 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01016a88: 0x1016a88: jal   0x104241c sw    s5, 44(sp)
	...
	stloc 5
// --- basic block ---
// 0x01016a90: 0x1016a90: lw    v1, -28232(s3)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01016ac0: 0x1016ac0: jal   0x104241c sw    s5, 44(sp)
	...
	stloc 5
// --- basic block ---
// 0x01016ac8: 0x1016ac8: lw    v1, -28232(s3)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01016ad8: 0x1016ad8: addu  v0, v1, v0
	...
	add
	stloc 5
// 0x01016adc: 0x1016adc: jal   0x10acc00 sw    v0, 48(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01016b70: 0x1016b70: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x01016b74: 0x1016b74: lw    v1, -28232(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01016be8: 0x1016be8: jal   0x104241c sw    s0, 44(sp)
	...
	stloc 5
// --- basic block ---
// 0x01016bf0: 0x1016bf0: lw    v1, -28232(s3)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01016c34: 0x1016c34: jal   0x104241c sw    v0, 44(sp)
	...
	stloc 5
// --- basic block ---
// 0x01016c3c: 0x1016c3c: lw    v1, -28232(s3)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01016c6c: 0x1016c6c: jal   0x104241c sw    s4, 44(sp)
	...
	stloc 5
// --- basic block ---
// 0x01016c74: 0x1016c74: lw    v1, -28232(s3)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01016d18: 0x1016d18: lui   t1, 0x0
	ldc.i4.s 0
	stloc 6
// 0x01016d1c: 0x1016d1c: lw    v1, -28184(v0)
	ldloc 9
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 10
// 0x01016d20: 0x1016d20: addiu a0, a0, -27780
	ldloc.1
	ldc.i4 -27780
	add
	stloc.1
// 0x01016d24: 0x1016d24: addiu a1, a1, -27980
	ldloc.2
	ldc.i4 -27980
	add
	stloc.2
// 0x01016d28: 0x1016d28: addiu a2, a2, -28180
	ldloc.3
	ldc.i4 -28180
	add
	stloc.3
// 0x01016d2c: 0x1016d2c: addiu t2, t2, -27572
	ldloc 11
	ldc.i4 -27572
	add
	stloc 11
...
// 0x01016ec0: 0x1016ec0: jal   0x1094c9c addiu a0, zero, 1
	ldc.i4.1
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01016ee0: 0x1016ee0: jal   0x1094bcc addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01016fd4: 0x1016fd4: beq   s6, zero, 0x1017008 lui   v0, 0x20000
	...
	brfalse L_1017008
// --- basic block ---
// 0x01016fdc: 0x1016fdc: lw    v1, 24012(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x01016fe0: 0x1016fe0: lw    v0, 24008(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101701c: 0x101701c: jal   0x100449c addiu a0, zero, 1
	...
	stloc 5
// --- basic block ---
// 0x01017024: 0x1017024: jal   0x1094bcc addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_1017438:
// 0x01017438: 0x1017438: lw    v0, -28184(s5)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10174b4:
// 0x010174b4: 0x10174b4: lw    s7, -28184(s5)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x010174c0: 0x10174c0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x010174c4: 0x10174c4: addiu v0, v0, -27572
	ldloc 5
	ldc.i4 -27572
	add
	stloc 5
...
// 0x010174d8: 0x10174d8: jal   0x1001800 addu  a0, v0, a0
	...
	stloc 5
// --- basic block ---
// 0x010174e0: 0x10174e0: sw    s7, -28184(s5)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
