...
// 0x010bbdc8: 0x10bbdc8: lui   v0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010bbdcc: 0x10bbdcc: sw    a1, 19480(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010bbe8c: 0x10bbe8c: lw    s2, 0(s1)
	...
	ldelem.i4
	stloc 8
// 0x010bbe90: 0x10bbe90: lw    v0, 18800(s6)
	ldloc 6
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x010bbf90: 0x10bbf90: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010bbf94: 0x10bbf94: lw    v0, 18800(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010bc0e0: 0x10bc0e0: lw    v1, -4(s0)
	...
	ldelem.i4
	stloc 7
// 0x010bc0e4: 0x10bc0e4: lw    v0, 18800(s6)
	ldloc 6
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x010bc27c: 0x10bc27c: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010bc280: 0x10bc280: lw    v0, 18800(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010bc528: 0x10bc528: lw    s0, 576(sp)
	...
	ldelem.i4
	stloc 9
// 0x010bc52c: 0x10bc52c: sw    v0, 19480(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010bc598: 0x10bc598: lui   s1, 0x0
	ldc.i4.s 0
	stloc 8
// 0x010bc59c: 0x10bc59c: addiu s1, s1, 19480
	ldloc 8
	ldc.i4 19480
	add
	stloc 8
...
// 0x010bca48: 0x10bca48: lui   v1, 0x0
	ldc.i4.s 0
	stloc 6
// 0x010bca4c: 0x10bca4c: addiu v1, v1, 19480
	ldloc 6
	ldc.i4 19480
	add
	stloc 6
...
// --- basic block ---
L_10bcb0c:
// 0x010bcb0c: 0x10bcb0c: lw    a0, 18800(s7)
	ldloc 7
	ldloc 15
	ldc.i4.2
	shr.un
