...
// 0x01057770: 0x1057770: mflo  lo
	ldloc 8
	stloc 5
// 0x01057774: 0x1057774: jal   0x10a4a6c sw    a3, 52(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010581ac: 0x10581ac: sw    v0, 24(sp)
	...
	ldloc 5
	stelem.i4
// 0x010581b0: 0x10581b0: jal   0x109e668 sw    s2, 20(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010581cc: 0x10581cc: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x010581d0: 0x10581d0: jal   0x1099348 sw    v0, 16(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010581fc: 0x10581fc: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x01058200: 0x1058200: jal   0x1099158 addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
	ldloc.1
	ldloc.2
...
// 0x01058228: 0x1058228: addiu a0, a0, 9328
	...
	add
	stloc.1
// 0x0105822c: 0x105822c: jal   0x1098e88 addiu a2, zero, -1
	ldc.i4.m1
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0105824c: 0x105824c: addiu a1, a1, 23008
	...
	add
	stloc.2
// 0x01058250: 0x1058250: jal   0x1099158 sw    v0, 32(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0105825c: 0x105825c: addu  a0, s1, zero
	ldloc 9
	stloc.1
// 0x01058260: 0x1058260: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x010582e4: 0x10582e4: addiu a0, a0, -29832
	...
	add
	stloc.1
// 0x010582e8: 0x10582e8: jal   0x1096064 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01058758: 0x1058758: jal   0x101f990 addiu a0, a0, -29708
	...
	stloc 5
// --- basic block ---
// 0x01058760: 0x1058760: j	 0x1058bc4 sw    v0, 10512(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0105881c: 0x105881c: bne   v0, zero, 0x105882c lui   s6, 0x70000
	...
	brtrue L_105882c
// --- basic block ---
// 0x01058824: 0x1058824: j	 0x1058834 addiu s6, s6, 10796
	ldloc 11
	ldc.i4 10796
	add
	stloc 11
...
// 0x0105882c: 0x105882c: lui   s6, 0x70000
	ldc.i4 458752
	stloc 11
// 0x01058830: 0x1058830: addiu s6, s6, 10828
	ldloc 11
	ldc.i4 10828
	add
	stloc 11
...
// 0x010588f8: 0x10588f8: addu  s1, zero, zero
	ldc.i4.s 0
	stloc 9
// 0x010588fc: 0x10588fc: addiu s3, s8, 29764
	ldloc 18
	ldc.i4 29764
	add
	stloc 14
...
// 0x01058a20: 0x1058a20: mult  v0, a0
	...
	mul
	stloc 12
// 0x01058a24: 0x1058a24: lw    a0, 29888(s7)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01058a40: 0x1058a40: lw    a0, 16(a0)
	...
	ldelem.i4
	stloc.1
// 0x01058a44: 0x1058a44: lw    a1, 29764(s8)
	ldloc 6
	ldloc 18
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1058a74:
// 0x01058a74: 0x1058a74: lw    v0, 29888(s7)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
