...
// 0x01058d44: 0x1058d44: addiu a2, sp, 32
	...
	add
	stloc.3
// 0x01058d48: 0x1058d48: jal   0x10a1a90 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010594e8: 0x10594e8: addiu a0, a0, 9812
	...
	add
	stloc.1
// 0x010594ec: 0x10594ec: jal   0x109e338 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl118::ssd_bitmap_splash_109e338(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 9
	stloc 7
// --- basic block ---
...
// 0x01059508: 0x1059508: addiu a0, a0, 9832
	...
	add
	stloc.1
// 0x0105950c: 0x105950c: jal   0x109e338 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_1059830:
// 0x01059830: 0x1059830: jal   0x10c0b30 addu  s1, zero, zero
	ldc.i4.s 0
	stloc 11
	ldloc.0
	ldloc.1
...
// 0x01059840: 0x1059840: sw    a2, 208(sp)
	...
	ldloc.3
	stelem.i4
// 0x01059844: 0x1059844: jal   0x10c0b30 sw    v1, 212(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0105985c: 0x105985c: addu  a2, v0, zero
	ldloc 5
	stloc.3
// 0x01059860: 0x1059860: jal   0x10c0908 addu  a3, v1, zero
	ldloc 6
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x01059870: 0x1059870: sw    a2, 208(sp)
	...
	ldloc.3
	stelem.i4
// 0x01059874: 0x1059874: jal   0x10c0b30 sw    v1, 212(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0105988c: 0x105988c: addu  a2, v0, zero
	ldloc 5
	stloc.3
// 0x01059890: 0x1059890: jal   0x10c0960 addu  a3, v1, zero
	ldloc 6
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x01059898: 0x1059898: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x0105989c: 0x105989c: jal   0x10c0a40 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
