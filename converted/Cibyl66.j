...
// 0x01058d3c: 0x1058d3c: lui   v1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x01058d40: 0x1058d40: addiu v0, v1, 14356
	ldloc 7
	ldc.i4 14356
	add
	stloc 6
// 0x01058d44: 0x1058d44: lw    s2, 14356(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01058d98: 0x1058d98: lui   v1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x01058d9c: 0x1058d9c: addiu v1, v1, 14356
	ldloc 7
	ldc.i4 14356
	add
	stloc 7
...
// 0x01058fb4: 0x1058fb4: lui   v0, 0x0
	ldc.i4.s 0
	stloc 6
// 0x01058fb8: 0x1058fb8: addiu v0, v0, 14356
	ldloc 6
	ldc.i4 14356
	add
	stloc 6
...
// 0x01058fc8: 0x1058fc8: addiu v0, zero, -1
	ldc.i4.m1
	stloc 6
// 0x01058fcc: 0x1058fcc: bne   a3, v0, 0x1058fe0 addiu v1, v1, 14356
	ldloc 4
	ldloc 6
	ldloc 8
	ldc.i4 14356
...
// 0x01059024: 0x1059024: jal   0x104f08c sw    s0, 20(sp)
	...
	stloc 5
// --- basic block ---
// 0x0105902c: 0x105902c: addiu a0, s1, 14372
	ldloc 10
	ldc.i4 14372
	add
	stloc.1
...
// 0x01059058: 0x1059058: jal   0x104f08c sw    s2, 10860(s0)
	...
	stloc 5
// --- basic block ---
// 0x01059060: 0x1059060: addiu a0, s1, 14372
	ldloc 10
	ldc.i4 14372
	add
	stloc.1
...
// 0x01059090: 0x1059090: jal   0x104f08c addiu a0, a0, 9588
	...
	stloc 5
// --- basic block ---
// 0x01059098: 0x1059098: addiu a0, s1, 14388
	ldloc 10
	ldc.i4 14388
	add
	stloc.1
...
// 0x010590c4: 0x10590c4: jal   0x104f08c sw    s2, 10892(s0)
	...
	stloc 5
// --- basic block ---
// 0x010590cc: 0x10590cc: addiu a0, s1, 14388
	ldloc 10
	ldc.i4 14388
	add
	stloc.1
...
// 0x010590fc: 0x10590fc: jal   0x104f08c addiu a0, a0, 9620
	...
	stloc 5
// --- basic block ---
// 0x01059104: 0x1059104: addiu a0, s1, 14404
	ldloc 10
	ldc.i4 14404
	add
	stloc.1
...
// 0x01059130: 0x1059130: jal   0x104f08c sw    s2, 10868(s0)
	...
	stloc 5
// --- basic block ---
// 0x01059138: 0x1059138: addiu a0, s1, 14404
	ldloc 10
	ldc.i4 14404
	add
	stloc.1
...
// 0x01059168: 0x1059168: jal   0x104f08c addiu a0, a0, 9660
	...
	stloc 5
// --- basic block ---
// 0x01059170: 0x1059170: addiu a0, s1, 14420
	ldloc 10
	ldc.i4 14420
	add
	stloc.1
...
// 0x01059198: 0x1059198: jal   0x104f08c addiu a0, a0, 9680
	...
	stloc 5
// --- basic block ---
// 0x010591a0: 0x10591a0: addiu a0, s1, 14420
	ldloc 10
	ldc.i4 14420
	add
	stloc.1
...
// 0x010591cc: 0x10591cc: jal   0x104f08c sw    s3, 12(s0)
	...
	stloc 5
// --- basic block ---
// 0x010591d4: 0x10591d4: addiu a0, s1, 14436
	ldloc 10
	ldc.i4 14436
	add
	stloc.1
...
// 0x010591f8: 0x10591f8: jal   0x104f08c sw    s3, 16(s0)
	...
	stloc 5
// --- basic block ---
// 0x01059200: 0x1059200: addiu a0, s1, 14436
	ldloc 10
	ldc.i4 14436
	add
	stloc.1
...
// 0x01059250: 0x1059250: addiu a0, s0, 26260
	...
	add
	stloc.1
// 0x01059254: 0x1059254: addiu a1, a1, 14372
	ldloc.2
	ldc.i4 14372
	add
	stloc.2
...
// 0x0105927c: 0x105927c: addiu a0, s0, 26260
	...
	add
	stloc.1
// 0x01059280: 0x1059280: addiu a1, a1, 14388
	ldloc.2
	ldc.i4 14388
	add
	stloc.2
...
// 0x01059298: 0x1059298: addiu a0, s0, 26260
	...
	add
	stloc.1
// 0x0105929c: 0x105929c: addiu a1, a1, 14404
	ldloc.2
	ldc.i4 14404
	add
	stloc.2
...
// 0x010592b4: 0x10592b4: addiu a0, s0, 26260
	...
	add
	stloc.1
// 0x010592b8: 0x10592b8: addiu a1, a1, 14420
	ldloc.2
	ldc.i4 14420
	add
	stloc.2
...
// 0x010592d0: 0x10592d0: addiu a0, s0, 26260
	...
	add
	stloc.1
// 0x010592d4: 0x10592d4: addiu a1, a1, 14436
	ldloc.2
	ldc.i4 14436
	add
	stloc.2
...
// 0x010592fc: 0x10592fc: addiu a3, s1, 20820
	...
	add
	stloc 4
// 0x01059300: 0x1059300: addiu a1, a1, 14096
	ldloc.2
	ldc.i4 14096
	add
	stloc.2
...
// 0x0105931c: 0x105931c: addiu a3, s1, 20820
	...
	add
	stloc 4
// 0x01059320: 0x1059320: addiu a1, a1, 14112
	ldloc.2
	ldc.i4 14112
	add
	stloc.2
...
// 0x0105933c: 0x105933c: addiu a3, s1, 20820
	...
	add
	stloc 4
// 0x01059340: 0x1059340: addiu a1, a1, 14128
	ldloc.2
	ldc.i4 14128
	add
	stloc.2
...
// 0x0105935c: 0x105935c: addiu a3, s1, 20820
	...
	add
	stloc 4
// 0x01059360: 0x1059360: addiu a1, a1, 14144
	ldloc.2
	ldc.i4 14144
	add
	stloc.2
...
// 0x0105937c: 0x105937c: addiu s1, s1, 20820
	...
	add
	stloc 9
// 0x01059380: 0x1059380: addiu a1, a1, 14452
	ldloc.2
	ldc.i4 14452
	add
	stloc.2
...
// 0x010593a4: 0x10593a4: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x010593a8: 0x10593a8: addiu a1, a1, 14160
	ldloc.2
	ldc.i4 14160
	add
	stloc.2
...
// 0x010593c0: 0x10593c0: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x010593c4: 0x10593c4: addiu a1, a1, 14176
	ldloc.2
	ldc.i4 14176
	add
	stloc.2
...
// 0x010593e0: 0x10593e0: addiu a0, s3, 18364
	...
	add
	stloc.1
// 0x010593e4: 0x10593e4: addiu a1, a1, 14192
	ldloc.2
	ldc.i4 14192
	add
	stloc.2
...
// 0x010593f8: 0x10593f8: addiu a0, s2, 12676
	...
	add
	stloc.1
// 0x010593fc: 0x10593fc: addiu a1, a1, 14468
	ldloc.2
	ldc.i4 14468
	add
	stloc.2
...
// 0x0105942c: 0x105942c: lui   v1, 0x0
	ldc.i4.s 0
	stloc 5
// 0x01059430: 0x1059430: jal   0x1060670 sw    v0, 14208(v1)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01059470: 0x1059470: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01059474: 0x1059474: jal   0x100e7a8 addiu a0, a0, 14176
	ldloc.1
	ldc.i4 14176
	add
	stloc.1
...
// 0x01059484: 0x1059484: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01059488: 0x1059488: jal   0x100e7a8 addiu a0, a0, 14192
	ldloc.1
	ldc.i4 14192
	add
	stloc.1
...
// 0x010594c4: 0x10594c4: addu  a1, s0, zero
	ldloc 8
	stloc.2
// 0x010594c8: 0x10594c8: jal   0x100e67c addiu a0, a0, 14160
	ldloc.1
	ldc.i4 14160
	add
	stloc.1
...
// 0x01059510: 0x1059510: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01059514: 0x1059514: addiu a0, a0, 14176
	ldloc.1
	ldc.i4 14176
	add
	stloc.1
...
// 0x01059530: 0x1059530: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01059534: 0x1059534: addiu a0, a0, 14192
	ldloc.1
	ldc.i4 14192
	add
	stloc.1
...
// 0x0105956c: 0x105956c: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01059570: 0x1059570: addiu a0, a0, 14112
	ldloc.1
	ldc.i4 14112
	add
	stloc.1
...
// 0x010595a0: 0x10595a0: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x010595a4: 0x10595a4: addiu a0, a0, 14112
	ldloc.1
	ldc.i4 14112
	add
	stloc.1
...
// 0x010595dc: 0x10595dc: lui   s0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010595e0: 0x10595e0: addiu a0, s0, 14112
	ldloc 5
	ldc.i4 14112
	add
	stloc.1
...
// 0x01059604: 0x1059604: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01059608: 0x1059608: addiu a0, s0, 14112
	ldloc 5
	ldc.i4 14112
	add
	stloc.1
...
// 0x0105961c: 0x105961c: jal   0x109e0c8 addiu a1, zero, 1
	...
	stloc 7
// --- basic block ---
// 0x01059624: 0x1059624: addiu a0, s0, 14112
	ldloc 5
	ldc.i4 14112
	add
	stloc.1
...
// 0x01059650: 0x1059650: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01059654: 0x1059654: addiu a0, a0, 14176
	ldloc.1
	ldc.i4 14176
	add
	stloc.1
...
// 0x010596b4: 0x10596b4: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010596b8: 0x10596b8: addiu a0, a0, 14176
	ldloc.1
	ldc.i4 14176
	add
	stloc.1
...
// 0x010596d8: 0x10596d8: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010596dc: 0x10596dc: jal   0x100e630 addiu a0, a0, 14192
	ldloc.1
	ldc.i4 14192
	add
	stloc.1
...
// 0x01059744: 0x1059744: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01059748: 0x1059748: addiu a0, a0, 14176
	ldloc.1
	ldc.i4 14176
	add
	stloc.1
...
// 0x01059b58: 0x1059b58: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x01059b5c: 0x1059b5c: addiu a0, a0, 14096
	ldloc.1
	ldc.i4 14096
	add
	stloc.1
...
// 0x01059d70: 0x1059d70: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x01059d74: 0x1059d74: addiu a0, a0, 14112
	ldloc.1
	ldc.i4 14112
	add
	stloc.1
...
// 0x01059d94: 0x1059d94: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x01059d98: 0x1059d98: addiu a0, a0, 14096
	ldloc.1
	ldc.i4 14096
	add
	stloc.1
...
// 0x01059e00: 0x1059e00: beq   v0, zero, 0x1059e18 lui   v0, 0x0
	...
	brfalse L_1059e18
// --- basic block ---
// 0x01059e08: 0x1059e08: lw    a0, 14320(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01059fd4: 0x1059fd4: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01059fd8: 0x1059fd8: addiu a0, a0, 14112
	ldloc.1
	ldc.i4 14112
	add
	stloc.1
