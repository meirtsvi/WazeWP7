...
// 0x0105e77c: 0x105e77c: mflo  lo
	ldloc 9
	stloc 5
// 0x0105e780: 0x105e780: jal   0x10a1a6c addu  a2, a2, v0
	ldloc.3
	ldloc 5
	add
	stloc.3
...
// 0x0105edb4: 0x105edb4: jal   0x104ee2c lui   s3, 0x70000
	...
	stloc 5
// --- basic block ---
// 0x0105edbc: 0x105edbc: jal   0x109a578 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0105f02c: 0x105f02c: sw    v1, 36(sp)
	...
	ldloc 6
	stelem.i4
// 0x0105f030: 0x105f030: jal   0x109a578 sw    v0, 32(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0105f0d8: 0x105f0d8: sw    v1, 36(sp)
	...
	ldloc 6
	stelem.i4
// 0x0105f0dc: 0x105f0dc: jal   0x109a578 sw    v0, 32(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0105f34c: 0x105f34c: sw    s8, 4(s6)
	...
	ldloc 15
	stelem.i4
// 0x0105f350: 0x105f350: jal   0x10a1a6c addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0105f5f4: 0x105f5f4: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0105f5f8: 0x105f5f8: jal   0x10a1a6c sw    v1, 12436(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0105f610: 0x105f610: addiu a1, zero, 3
	ldc.i4.3
	stloc.2
// 0x0105f614: 0x105f614: jal   0x10a1a6c sw    v0, 12408(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0105f62c: 0x105f62c: addiu a1, zero, 3
	ldc.i4.3
	stloc.2
// 0x0105f630: 0x105f630: jal   0x10a1a6c sw    v0, 12412(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0105f648: 0x105f648: lui   v1, 0x70000
	ldc.i4 458752
	stloc 6
// 0x0105f64c: 0x105f64c: jal   0x10a1a6c sw    v0, 12416(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
