...
// 0x0105e524: 0x105e524: lui   v0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0105e528: 0x105e528: jr    ra sw    a0, 14504(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0105e530: 0x105e530: lui   v0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0105e534: 0x105e534: jr    ra sw    a0, 14484(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0105e53c: 0x105e53c: lui   v0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0105e540: 0x105e540: jr    ra sw    a0, 14500(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0105e548: 0x105e548: lui   v0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0105e54c: 0x105e54c: jr    ra sw    a0, 14496(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0105e554: 0x105e554: lui   v0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0105e558: 0x105e558: jr    ra sw    a0, 14492(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0105e560: 0x105e560: lui   v0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0105e564: 0x105e564: jr    ra sw    a0, 14488(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0105e638: 0x105e638: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0105e63c: 0x105e63c: lw    a0, 14484(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0105ebcc: 0x105ebcc: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0105ebd0: 0x105ebd0: jal   0x100e7a8 addiu a0, a0, 14524
	ldloc.1
	ldc.i4 14524
	add
	stloc.1
...
// 0x0105ece8: 0x105ece8: jal   0x104ebec sw    v0, 32(sp)
	...
	stloc 5
// --- basic block ---
// 0x0105ecf0: 0x105ecf0: lw    v1, 14572(s2)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0105ed08: 0x105ed08: addu  a1, s3, zero
	ldloc 10
	stloc.2
// 0x0105ed0c: 0x105ed0c: addiu a2, s2, 14572
	ldloc 9
	ldc.i4 14572
	add
	stloc.3
...
// 0x0105ed18: 0x105ed18: jal   0x104eaf4 sw    zero, 20(sp)
	...
	stloc 5
// --- basic block ---
// 0x0105ed20: 0x105ed20: lw    s0, 14572(s2)
	ldloc 7
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0105ed3c: 0x105ed3c: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0105ed40: 0x105ed40: sw    s0, 14572(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0105ed48: 0x105ed48: lw    v1, 32(sp)
	...
	ldelem.i4
	stloc 6
// 0x0105ed4c: 0x105ed4c: lw    v0, 14572(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0105ed8c: 0x105ed8c: addiu sp, sp, -432
	...
	add
	stloc.0
// 0x0105ed90: 0x105ed90: addiu a0, a0, 14508
	ldloc.1
	ldc.i4 14508
	add
	stloc.1
...
// 0x0105f018: 0x105f018: addiu sp, sp, -824
	...
	add
	stloc.0
// 0x0105f01c: 0x105f01c: addiu a0, a0, 14524
	ldloc.1
	ldc.i4 14524
	add
	stloc.1
...
// 0x0105f14c: 0x105f14c: lui   s1, 0x0
	ldc.i4.s 0
	stloc 8
// 0x0105f150: 0x105f150: lw    v1, 14576(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0105f168: 0x105f168: addiu a1, s0, -7
	...
	add
	stloc.2
// 0x0105f16c: 0x105f16c: addiu a2, s1, 14576
	ldloc 8
	ldc.i4 14576
	add
	stloc.3
...
// 0x0105f178: 0x105f178: jal   0x104eaf4 sw    zero, 20(sp)
	...
	stloc 5
// --- basic block ---
// 0x0105f180: 0x105f180: lw    v0, 14576(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0105f188: 0x105f188: addiu v0, v0, 3
	...
	add
	stloc 5
// 0x0105f18c: 0x105f18c: sw    v0, 14576(s1)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0105f194: 0x105f194: lw    v1, 32(sp)
	...
	ldelem.i4
	stloc 6
// 0x0105f198: 0x105f198: lw    v0, 14576(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0105f204: 0x105f204: addu  a1, s0, zero
	ldloc 9
	stloc.2
// 0x0105f208: 0x105f208: addiu a2, s2, 14576
	ldloc 10
	ldc.i4 14576
	add
	stloc.3
...
// 0x0105f214: 0x105f214: jal   0x104eaf4 sw    zero, 20(sp)
	...
	stloc 5
// --- basic block ---
// 0x0105f21c: 0x105f21c: lw    s1, 14576(s2)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0105f240: 0x105f240: lui   v1, 0x0
	ldc.i4.s 0
	stloc 6
// 0x0105f244: 0x105f244: sw    s1, 14576(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0105f35c: 0x105f35c: addiu sp, sp, -56
	...
	add
	stloc.0
// 0x0105f360: 0x105f360: addiu v1, v1, 14580
	ldloc 7
	ldc.i4 14580
	add
	stloc 7
...
// 0x0105f6ac: 0x105f6ac: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x0105f6b0: 0x105f6b0: addiu a1, a1, 14508
	ldloc.2
	ldc.i4 14508
	add
	stloc.2
...
// 0x0105f6c4: 0x105f6c4: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x0105f6c8: 0x105f6c8: addiu a1, a1, 14524
	ldloc.2
	ldc.i4 14524
	add
	stloc.2
...
// 0x0105f6e0: 0x105f6e0: lui   a2, 0x0
	ldc.i4.s 0
	stloc.3
// 0x0105f6e4: 0x105f6e4: addiu a1, a1, 14540
	ldloc.2
	ldc.i4 14540
	add
	stloc.2
...
// 0x0105f704: 0x105f704: addiu a0, s1, 12676
	...
	add
	stloc.1
// 0x0105f708: 0x105f708: addiu a1, a1, 14556
	ldloc.2
	ldc.i4 14556
	add
	stloc.2
