...
// 0x0104d0c8: 0x104d0c8: addiu a0, a0, -26772
	...
	add
	stloc.1
// 0x0104d0cc: 0x104d0cc: jal   0x104cf64 addiu a1, a1, 13700
	ldloc.2
	ldc.i4 13700
	add
	stloc.2
...
// 0x0104d0e4: 0x104d0e4: addiu a0, a0, 26252
	...
	add
	stloc.1
// 0x0104d0e8: 0x104d0e8: jal   0x104cf64 addiu a1, a1, 13708
	ldloc.2
	ldc.i4 13708
	add
	stloc.2
...
// 0x0104d100: 0x104d100: addiu a0, a0, 26268
	...
	add
	stloc.1
// 0x0104d104: 0x104d104: jal   0x104cf64 addiu a1, a1, 13732
	ldloc.2
	ldc.i4 13732
	add
	stloc.2
...
// 0x0104d11c: 0x104d11c: addiu a0, a0, 21376
	...
	add
	stloc.1
// 0x0104d120: 0x104d120: jal   0x104cf64 addiu a1, a1, 13748
	ldloc.2
	ldc.i4 13748
	add
	stloc.2
...
// 0x0104d138: 0x104d138: addiu a0, a0, 3272
	...
	add
	stloc.1
// 0x0104d13c: 0x104d13c: jal   0x104cf64 addiu a1, a1, 13756
	ldloc.2
	ldc.i4 13756
	add
	stloc.2
...
// 0x0104dfd4: 0x104dfd4: lui   v0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0104dfd8: 0x104dfd8: jr    ra sw    a0, 13780(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0104dfe0: 0x104dfe0: lui   v0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0104dfe4: 0x104dfe4: jr    ra sw    a0, 13784(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0104dfec: 0x104dfec: lui   v0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0104dff0: 0x104dff0: jr    ra sw    a0, 13788(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0104dff8: 0x104dff8: lui   v0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0104dffc: 0x104dffc: jr    ra sw    a0, 13792(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0104e198: 0x104e198: sra   a1, a1, 16
	...
	shr
	stloc.2
// 0x0104e19c: 0x104e19c: lw    v0, 13784(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0104e1d8: 0x104e1d8: sra   a1, a1, 16
	...
	shr
	stloc.2
// 0x0104e1dc: 0x104e1dc: lw    v0, 13788(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0104e324: 0x104e324: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0104e328: 0x104e328: lw    v0, 13780(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
