...
// 0x01003fd0: 0x1003fd0: lui   s1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x01003fd4: 0x1003fd4: lw    v0, 31424(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01003ff4: 0x1003ff4: jal   0x100a048 sw    a1, 16(sp)
	...
	stloc 6
// --- basic block ---
// 0x01003ffc: 0x1003ffc: lw    v1, 31424(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01004060: 0x1004060: addiu sp, sp, -80
	...
	add
	stloc.0
// 0x01004064: 0x1004064: lw    v0, 31424(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01004078: 0x1004078: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0100407c: 0x100407c: lw    a0, 31500(a0)
	ldloc 5
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010040cc: 0x10040cc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x010040d0: 0x10040d0: lw    a2, 31512(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01004140: 0x1004140: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01004144: 0x1004144: lw    a0, 31512(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010041dc: 0x10041dc: lui   v0, 0x20000
	...
	stloc 6
L_10041e0:
// 0x010041e0: 0x10041e0: lw    v0, 31424(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010041ec: 0x10041ec: lhu   v0, 2(s3)
	...
	call int32 [WazeWP7]CRunTime::memoryReadShortUnsigned(int32)
	stloc 6
// 0x010041f0: 0x10041f0: lw    v1, 31500(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01004258: 0x1004258: lui   v0, 0x20000
	ldc.i4 131072
	stloc.0
// 0x0100425c: 0x100425c: jr    ra sw    zero, 31448(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010042a8: 0x10042a8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010042ac: 0x10042ac: lw    a0, 31428(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004310: 0x1004310: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004314: 0x1004314: lw    v0, 31428(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004504: 0x1004504: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004508: 0x1004508: lw    v0, 31436(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1004524:
// 0x01004524: 0x1004524: lw    s5, 31444(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1004548:
// 0x01004548: 0x1004548: sw    v1, 31444(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010045d4: 0x10045d4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010045d8: 0x10045d8: lw    v0, 31428(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010045e8: 0x10045e8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010045ec: 0x10045ec: lw    v0, 31440(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010045f4: 0x10045f4: beq   v0, zero, 0x100460c lui   v0, 0x20000
	...
	brfalse L_100460c
// --- basic block ---
// 0x010045fc: 0x10045fc: lw    v0, 31432(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004610: 0x1004610: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004614: 0x1004614: sw    v1, 31440(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004618: 0x1004618: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100461c: 0x100461c: jal   0x104c694 sw    zero, 31432(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004630: 0x1004630: addiu a1, a1, 22444
	...
	add
	stloc.2
// 0x01004634: 0x1004634: jal   0x104dc58 addiu a2, a2, 14308
	ldloc.3
	ldc.i4 14308
	add
	stloc.3
...
// 0x01004640: 0x1004640: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01004644: 0x1004644: beq   v0, zero, 0x1004708 sw    v0, 31428(s1)
	ldloc 5
	ldloc 6
	ldloc 8
	ldc.i4.2
...
// 0x01004688: 0x1004688: beq   v0, zero, 0x10046c0 lui   v0, 0x20000
	...
	brfalse L_10046c0
// --- basic block ---
// 0x01004690: 0x1004690: lw    a0, 31428(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010046bc: 0x10046bc: lui   v0, 0x20000
	...
	stloc 5
L_10046c0:
// 0x010046c0: 0x10046c0: lw    a0, 31428(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004708: 0x1004708: lui   v0, 0x20000
	...
	stloc 5
L_100470c:
// 0x0100470c: 0x100470c: lw    s7, 31428(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100474c: 0x100474c: addiu a0, sp, 72
	...
	add
	stloc.1
// 0x01004750: 0x1004750: addiu a1, s1, -14024
	ldloc 8
	ldc.i4 -14024
	add
	stloc.2
...
// 0x01004768: 0x1004768: slti  v0, a2, 9
	...
	clt
	stloc 5
// 0x0100476c: 0x100476c: addiu a1, s1, -14024
	ldloc 8
	ldc.i4 -14024
	add
	stloc.2
...
// 0x0100478c: 0x100478c: addu  a0, a0, v0
	...
	add
	stloc.1
// 0x01004790: 0x1004790: addiu a1, s1, -14024
	ldloc 8
	ldc.i4 -14024
	add
	stloc.2
...
// 0x01004868: 0x1004868: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100486c: 0x100486c: lw    s5, 31452(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010048e4: 0x10048e4: lui   v0, 0x20000
	...
	stloc 5
L_10048e8:
// 0x010048e8: 0x10048e8: lw    a0, 31428(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004910: 0x1004910: beq   a1, v0, 0x1004928 lui   v0, 0x20000
	...
	beq  L_1004928
// --- basic block ---
// 0x01004918: 0x1004918: lw    v0, 31428(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004928: 0x1004928: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100492c: 0x100492c: lw    a2, 31428(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004978: 0x1004978: addiu v1, zero, 1
	ldc.i4.1
	stloc 7
// 0x0100497c: 0x100497c: sw    v1, 31436(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004980: 0x1004980: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004984: 0x1004984: j	 0x10049a4 sw    zero, 31444(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004994: 0x1004994: beq   v0, zero, 0x10049a4 sw    zero, 31444(v1)
	ldloc 5
	ldloc 6
	ldloc 7
	ldc.i4.2
...
// 0x010049f8: 0x10049f8: jal   0x100449c lui   s0, 0x20000
	...
	stloc 7
// --- basic block ---
// 0x01004a00: 0x1004a00: lw    a0, 31428(s0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01004a1c: 0x1004a1c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01004a20: 0x1004a20: sw    v1, 31432(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldloc 8
	stelem.i4
// 0x01004a24: 0x1004a24: sw    zero, 31428(s0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01004a70: 0x1004a70: lui   v0, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01004a74: 0x1004a74: lw    v0, 31456(v0)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01004ae4: 0x1004ae4: lui   v0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01004ae8: 0x1004ae8: lw    v0, 31456(v0)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01004bf4: 0x1004bf4: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x01004bf8: 0x1004bf8: lw    v0, 24304(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004c24: 0x1004c24: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004c28: 0x1004c28: sw    s0, 31456(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004c38: 0x1004c38: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01004c3c: 0x1004c3c: lw    v1, 31456(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01004ca0: 0x1004ca0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01004ca4: 0x1004ca4: lw    v0, 31456(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01004ce0: 0x1004ce0: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x01004ce4: 0x1004ce4: lw    v0, 24304(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004d78: 0x1004d78: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01004d7c: 0x1004d7c: lw    v1, 24304(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01004e48: 0x1004e48: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x01004e4c: 0x1004e4c: lw    v0, 24308(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004e78: 0x1004e78: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004e7c: 0x1004e7c: sw    s0, 31460(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004e8c: 0x1004e8c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004e90: 0x1004e90: lw    a2, 31460(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004f48: 0x1004f48: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004f4c: 0x1004f4c: lw    v0, 31460(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004fc8: 0x1004fc8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004fcc: 0x1004fcc: lw    a1, 31460(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01005078: 0x1005078: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100507c: 0x100507c: lw    v0, 31460(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010050f0: 0x10050f0: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x010050f4: 0x10050f4: lw    v0, 24308(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100519c:
// 0x0100519c: 0x100519c: lw    v1, 24308(v1)
	ldloc 8
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010052c8: 0x10052c8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010052cc: 0x10052cc: lw    v1, 31460(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01005374: 0x1005374: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01005378: 0x1005378: lw    a3, 23628(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x0100537c: 0x100537c: lw    a2, 23624(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010053cc: 0x10053cc: lui   v0, 0x20000
	...
	stloc 5
L_10053d0:
// 0x010053d0: 0x10053d0: lw    v1, 31460(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01005440: 0x1005440: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01005444: 0x1005444: lw    a3, 23628(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01005448: 0x1005448: lw    a2, 23624(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
