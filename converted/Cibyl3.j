...
// 0x01003fd0: 0x1003fd0: lui   s1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x01003fd4: 0x1003fd4: lw    v0, 31360(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01003ff4: 0x1003ff4: jal   0x100a048 sw    a1, 16(sp)
	...
	stloc 6
// --- basic block ---
// 0x01003ffc: 0x1003ffc: lw    v1, 31360(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01004060: 0x1004060: addiu sp, sp, -80
	...
	add
	stloc.0
// 0x01004064: 0x1004064: lw    v0, 31360(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01004078: 0x1004078: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0100407c: 0x100407c: lw    a0, 31436(a0)
	ldloc 5
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010040cc: 0x10040cc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x010040d0: 0x10040d0: lw    a2, 31448(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01004140: 0x1004140: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01004144: 0x1004144: lw    a0, 31448(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010041dc: 0x10041dc: lui   v0, 0x20000
	...
	stloc 6
L_10041e0:
// 0x010041e0: 0x10041e0: lw    v0, 31360(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010041ec: 0x10041ec: lhu   v0, 2(s3)
	...
	call int32 [WazeWP7]CRunTime::memoryReadShortUnsigned(int32)
	stloc 6
// 0x010041f0: 0x10041f0: lw    v1, 31436(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01004258: 0x1004258: lui   v0, 0x20000
	ldc.i4 131072
	stloc.0
// 0x0100425c: 0x100425c: jr    ra sw    zero, 31384(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010042a8: 0x10042a8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010042ac: 0x10042ac: lw    a0, 31364(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004310: 0x1004310: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004314: 0x1004314: lw    v0, 31364(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010044f8: 0x10044f8: sw    zero, 44(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x010044fc: 0x10044fc: jal   0x10c0e50 sw    v0, 48(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01004504: 0x1004504: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004508: 0x1004508: lw    v0, 31372(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1004524:
// 0x01004524: 0x1004524: lw    s5, 31380(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1004548:
// 0x01004548: 0x1004548: sw    v1, 31380(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010045d4: 0x10045d4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010045d8: 0x10045d8: lw    v0, 31364(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010045e8: 0x10045e8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010045ec: 0x10045ec: lw    v0, 31376(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010045f4: 0x10045f4: beq   v0, zero, 0x100460c lui   v0, 0x20000
	...
	brfalse L_100460c
// --- basic block ---
// 0x010045fc: 0x10045fc: lw    v0, 31368(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004610: 0x1004610: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004614: 0x1004614: sw    v1, 31376(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004618: 0x1004618: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100461c: 0x100461c: jal   0x104c524 sw    zero, 31368(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004630: 0x1004630: addiu a1, a1, 22444
	...
	add
	stloc.2
// 0x01004634: 0x1004634: jal   0x104dae8 addiu a2, a2, 14588
	ldloc.3
	ldc.i4 14588
	add
	stloc.3
...
// 0x01004640: 0x1004640: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01004644: 0x1004644: beq   v0, zero, 0x1004708 sw    v0, 31364(s1)
	ldloc 5
	ldloc 6
	ldloc 8
	ldc.i4.2
...
// 0x01004688: 0x1004688: beq   v0, zero, 0x10046c0 lui   v0, 0x20000
	...
	brfalse L_10046c0
// --- basic block ---
// 0x01004690: 0x1004690: lw    a0, 31364(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01004694: 0x1004694: jal   0x101d4a4 sw    a0, 1348(sp)
	...
	stloc 5
// --- basic block ---
// 0x0100469c: 0x100469c: jal   0x10aaad4 sw    v0, 1344(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010046bc: 0x10046bc: lui   v0, 0x20000
	...
	stloc 5
L_10046c0:
// 0x010046c0: 0x10046c0: lw    a0, 31364(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004708: 0x1004708: lui   v0, 0x20000
	...
	stloc 5
L_100470c:
// 0x0100470c: 0x100470c: lw    s7, 31364(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100472c: 0x100472c: addu  v1, v0, zero
	ldloc 5
	stloc 7
// 0x01004730: 0x1004730: jal   0x10c3938 addiu s8, zero, 48
	ldc.i4.s 48
	stloc 11
	ldloc.0
	ldloc.1
...
// 0x01004800: 0x1004800: addu  a0, s5, v0
	...
	add
	stloc.1
// 0x01004804: 0x1004804: jal   0x10c0e50 addu  s1, v0, zero
	ldloc 5
	stloc 8
	ldloc.0
	ldloc.1
...
// 0x01004868: 0x1004868: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100486c: 0x100486c: lw    s5, 31388(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004898: 0x1004898: addu  a3, s4, zero
	ldloc 13
	stloc 4
// 0x0100489c: 0x100489c: jal   0x10c0e50 addu  a0, s1, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010048e4: 0x10048e4: lui   v0, 0x20000
	...
	stloc 5
L_10048e8:
// 0x010048e8: 0x10048e8: lw    a0, 31364(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004910: 0x1004910: beq   a1, v0, 0x1004928 lui   v0, 0x20000
	...
	beq  L_1004928
// --- basic block ---
// 0x01004918: 0x1004918: lw    v0, 31364(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004928: 0x1004928: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100492c: 0x100492c: lw    a2, 31364(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004978: 0x1004978: addiu v1, zero, 1
	ldc.i4.1
	stloc 7
// 0x0100497c: 0x100497c: sw    v1, 31372(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004980: 0x1004980: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004984: 0x1004984: j	 0x10049a4 sw    zero, 31380(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004994: 0x1004994: beq   v0, zero, 0x10049a4 sw    zero, 31380(v1)
	ldloc 5
	ldloc 6
	ldloc 7
	ldc.i4.2
...
// 0x010049f8: 0x10049f8: jal   0x100449c lui   s0, 0x20000
	...
	stloc 7
// --- basic block ---
// 0x01004a00: 0x1004a00: lw    a0, 31364(s0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01004a1c: 0x1004a1c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01004a20: 0x1004a20: sw    v1, 31368(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldloc 8
	stelem.i4
// 0x01004a24: 0x1004a24: sw    zero, 31364(s0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01004a70: 0x1004a70: lui   v0, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01004a74: 0x1004a74: lw    v0, 31392(v0)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01004ae4: 0x1004ae4: lui   v0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01004ae8: 0x1004ae8: lw    v0, 31392(v0)
	ldloc 2
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01004bf4: 0x1004bf4: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x01004bf8: 0x1004bf8: lw    v0, 24576(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004c24: 0x1004c24: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004c28: 0x1004c28: sw    s0, 31392(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004c38: 0x1004c38: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01004c3c: 0x1004c3c: lw    v1, 31392(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01004ca0: 0x1004ca0: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01004ca4: 0x1004ca4: lw    v0, 31392(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01004ce0: 0x1004ce0: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x01004ce4: 0x1004ce4: lw    v0, 24576(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004d78: 0x1004d78: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01004d7c: 0x1004d7c: lw    v1, 24576(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01004e48: 0x1004e48: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 8
// 0x01004e4c: 0x1004e4c: lw    v0, 24580(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004e78: 0x1004e78: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004e7c: 0x1004e7c: sw    s0, 31396(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004e8c: 0x1004e8c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004e90: 0x1004e90: lw    a2, 31396(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004f48: 0x1004f48: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004f4c: 0x1004f4c: lw    v0, 31396(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01004fc8: 0x1004fc8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01004fcc: 0x1004fcc: lw    a1, 31396(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01005078: 0x1005078: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100507c: 0x100507c: lw    v0, 31396(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010050f0: 0x10050f0: lw    v1, 0(a0)
	...
	ldelem.i4
	stloc 7
// 0x010050f4: 0x10050f4: lw    v0, 24580(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100519c:
// 0x0100519c: 0x100519c: lw    v1, 24580(v1)
	ldloc 8
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010052c8: 0x10052c8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010052cc: 0x10052cc: lw    v1, 31396(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01005368: 0x1005368: mflo  lo
	ldloc 14
	stloc.1
// 0x0100536c: 0x100536c: jal   0x10c0da0 sll   zero, zero, 0
	ldloc.0
	ldloc.1
...
// 0x01005374: 0x1005374: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01005378: 0x1005378: lw    a3, 23908(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x0100537c: 0x100537c: lw    a2, 23904(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01005380: 0x1005380: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x01005384: 0x1005384: jal   0x10c0b78 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01005390: 0x1005390: addu  s5, v1, zero
	ldloc 6
	stloc 13
// 0x01005394: 0x1005394: jal   0x10c0da0 addu  s4, v0, zero
	ldloc 5
	stloc 12
	ldloc.0
	ldloc.1
...
// 0x010053a4: 0x10053a4: addu  a0, s4, zero
	ldloc 12
	stloc.1
// 0x010053a8: 0x10053a8: jal   0x10c0bd0 addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x010053b0: 0x10053b0: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x010053b4: 0x10053b4: jal   0x10c0d28 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010053cc: 0x10053cc: lui   v0, 0x20000
	...
	stloc 5
L_10053d0:
// 0x010053d0: 0x10053d0: lw    v1, 31396(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01005434: 0x1005434: mflo  lo
	ldloc 14
	stloc.1
// 0x01005438: 0x1005438: jal   0x10c0da0 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	call int32 Cibyl143::__floatsidf_10c0da0(int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
...
// 0x01005440: 0x1005440: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01005444: 0x1005444: lw    a3, 23908(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01005448: 0x1005448: lw    a2, 23904(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0100544c: 0x100544c: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x01005450: 0x1005450: jal   0x10c0b78 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0100545c: 0x100545c: addu  s3, v1, zero
	ldloc 6
	stloc 11
// 0x01005460: 0x1005460: jal   0x10c0da0 addu  s2, v0, zero
	ldloc 5
	stloc 10
	ldloc.0
	ldloc.1
...
// 0x01005470: 0x1005470: addu  a0, s2, zero
	ldloc 10
	stloc.1
// 0x01005474: 0x1005474: jal   0x10c0bd0 addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0100547c: 0x100547c: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x01005480: 0x1005480: jal   0x10c0cb0 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
