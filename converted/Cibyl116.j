...
// 0x0109be38: 0x109be38: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109be3c: 0x109be3c: lw    a0, 10036(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109c074: 0x109c074: lui   v1, 0x80000
	ldc.i4 524288
	stloc 7
// 0x0109c078: 0x109c078: addiu v0, v1, 10056
	ldloc 7
	ldc.i4 10056
	add
	stloc 6
// 0x0109c07c: 0x109c07c: sw    t1, 10056(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0109c08c: 0x109c08c: sw    v1, 4(v0)
	...
	ldloc 7
	stelem.i4
// 0x0109c090: 0x109c090: lw    t0, 10036(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109c100: 0x109c100: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x0109c104: 0x109c104: sw    v0, 10036(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109c10c: 0x109c10c: jal   0x1092890 sw    zero, 20(sp)
	...
	stloc 6
// --- basic block ---
// 0x0109c114: 0x109c114: lw    a0, 10036(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109c120: 0x109c120: lui   s0, 0x80000
	...
	stloc 8
L_109c124:
// 0x0109c124: 0x109c124: lw    a0, 10036(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109c12c: 0x109c12c: jal   0x109b458 addiu a1, a1, -7480
	...
	stloc 6
// --- basic block ---
// 0x0109c134: 0x109c134: lw    a0, 10036(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109c148: 0x109c148: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x0109c14c: 0x109c14c: lw    s6, 10036(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109c15c: 0x109c15c: jal   0x109b588 addu  a0, s6, zero
	...
	stloc 6
// --- basic block ---
// 0x0109c164: 0x109c164: lw    a0, 10036(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109c168: 0x109c168: jal   0x10992c8 addu  a1, zero, zero
	...
	call void Cibyl114::ssd_widget_set_left_softkey_callback_10992c8(int32,int32)
// --- basic block ---
// 0x0109c170: 0x109c170: lw    v0, 10036(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109c184: 0x109c184: jalr  v0 addu  a1, s4, zero
	...
	stloc 6
// --- basic block ---
// 0x0109c18c: 0x109c18c: lw    a0, 10036(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109c190: 0x109c190: lui   a1, 0x80000
	ldc.i4 524288
	stloc.2
// 0x0109c194: 0x109c194: jal   0x109912c addiu a1, a1, 10056
	ldloc.2
	ldc.i4 10056
	add
	stloc.2
...
// 0x0109c1a0: 0x109c1a0: jal   0x109914c sll   zero, zero, 0
	...
	stloc 6
// --- basic block ---
// 0x0109c1a8: 0x109c1a8: lw    a0, 10036(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109c374: 0x109c374: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0109c378: 0x109c378: addiu v0, v0, 29832
	ldloc 5
	ldc.i4 29832
	add
	stloc 5
...
// 0x0109c3a4: 0x109c3a4: sll   v1, v1, 2
	...
	shl
	stloc 8
// 0x0109c3a8: 0x109c3a8: addiu v0, v0, 29844
	ldloc 5
	ldc.i4 29844
	add
	stloc 5
...
// 0x0109c540: 0x109c540: sll   v1, v1, 2
	...
	shl
	stloc 7
// 0x0109c544: 0x109c544: j	 0x109c56c addiu v0, v0, 29832
	ldloc 5
	ldc.i4 29832
	add
	stloc 5
...
// 0x0109c564: 0x109c564: sll   v1, v1, 2
	...
	shl
	stloc 7
// 0x0109c568: 0x109c568: addiu v0, v0, 29844
	ldloc 5
	ldc.i4 29844
	add
	stloc 5
...
// 0x0109c8bc: 0x109c8bc: lui   a0, 0x80000
	ldc.i4 524288
	stloc.1
// 0x0109c8c0: 0x109c8c0: addiu a0, a0, 10072
	ldloc.1
	ldc.i4 10072
	add
	stloc.1
