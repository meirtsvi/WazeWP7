...
// 0x01046808: 0x1046808: lw    a0, 8(s2)
	...
	ldelem.i4
	stloc.1
// 0x0104680c: 0x104680c: jal   0x10c0b40 sll   zero, zero, 0
	ldloc.0
	ldloc.1
...
// 0x01046824: 0x1046824: lw    a2, 0(v0)
	...
	ldelem.i4
	stloc.3
// 0x01046828: 0x1046828: jal   0x10c0918 addu  a1, v1, zero
	ldloc 7
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01046830: 0x1046830: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x01046834: 0x1046834: jal   0x10c0a50 addu  a0, v0, zero
	ldloc 6
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010469a0: 0x10469a0: addiu a1, zero, 1
	ldc.i4.1
	stloc.2
// 0x010469a4: 0x10469a4: jal   0x10949fc sw    zero, 20448(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01046ac4: 0x1046ac4: jal   0x10641ec sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x01046acc: 0x1046acc: jal   0x1094c0c addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01046c24: 0x1046c24: lui   a1, 0x10000
	ldc.i4 65536
	stloc.2
// 0x01046c28: 0x1046c28: jal   0x109b490 addiu a1, a1, 228
	ldloc.2
	ldc.i4 228
	add
	stloc.2
...
// 0x01046c8c: 0x1046c8c: jal   0x1000f9c addiu a1, zero, 20
	...
	stloc 5
// --- basic block ---
// 0x01046c94: 0x1046c94: jal   0x1094138 sll   zero, zero, 0
...
// --- basic block ---
L_1046cb8:
// 0x01046cb8: 0x1046cb8: jal   0x1096308 addu  a0, s0, zero
	ldloc 9
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01046d6c: 0x1046d6c: addiu v0, zero, 136
	ldc.i4 136
	stloc 5
// 0x01046d70: 0x1046d70: jal   0x1093b9c sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01046d80: 0x1046d80: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x01046d84: 0x1046d84: jal   0x109916c sw    v0, 24(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01046da4: 0x1046da4: jal   0x1094cdc addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01046de4: 0x1046de4: sw    s1, 44(sp)
	...
	ldloc 14
	stelem.i4
// 0x01046de8: 0x1046de8: jal   0x1094118 sw    s0, 40(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01046e00: 0x1046e00: addiu a1, a1, 244
	...
	add
	stloc.2
// 0x01046e04: 0x1046e04: jal   0x109b490 addu  s7, v0, zero
	ldloc 5
	stloc 16
	ldloc.0
	ldloc.1
...
// 0x01046e10: 0x1046e10: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01046e14: 0x1046e14: jal   0x109b490 addiu a1, a1, 248
	ldloc.2
	ldc.i4 248
	add
	stloc.2
...
// 0x01046e3c: 0x1046e3c: addiu a2, a2, 23008
	...
	stloc.3
L_1046e40:
// 0x01046e40: 0x1046e40: jal   0x109916c sll   zero, zero, 0
	ldloc.1
	ldloc.2
	ldloc.3
	call void Cibyl114::ssd_widget_set_color_109916c(int32,int32,int32)
...
// 0x01046e88: 0x1046e88: addu  a0, s2, zero
	ldloc 11
	stloc.1
// 0x01046e8c: 0x1046e8c: jal   0x109b490 addu  a1, s4, zero
	ldloc 15
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01046eb0: 0x1046eb0: sw    v0, 196(s1)
	...
	stelem.i4
L_1046eb4:
// 0x01046eb4: 0x1046eb4: jal   0x109b490 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01046ec4: 0x1046ec4: beq   v0, zero, 0x1046ed4 addu  a1, s6, zero
	...
	brfalse L_1046ed4
// --- basic block ---
// 0x01046ecc: 0x1046ecc: jal   0x109916c sll   zero, zero, 0
	ldloc.1
	ldloc.2
	ldloc.3
	call void Cibyl114::ssd_widget_set_color_109916c(int32,int32,int32)
...
// 0x01046ed4: 0x1046ed4: addu  a0, s1, zero
	ldloc 14
	stloc.1
// 0x01046ed8: 0x1046ed8: jal   0x109b490 addu  a1, s8, zero
	ldloc 13
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01046ee8: 0x1046ee8: beq   v0, zero, 0x1046ef8 addu  a2, s5, zero
	...
	brfalse L_1046ef8
// --- basic block ---
// 0x01046ef0: 0x1046ef0: jal   0x109916c sll   zero, zero, 0
	ldloc.1
	ldloc.2
	ldloc.3
	call void Cibyl114::ssd_widget_set_color_109916c(int32,int32,int32)
...
// 0x01046f34: 0x1046f34: addu  a1, s0, zero
	ldloc 8
	stloc.2
// 0x01046f38: 0x1046f38: jal   0x109b490 addu  a0, s2, zero
	ldloc 11
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01046f58: 0x1046f58: addiu a1, a1, 268
	...
	add
	stloc.2
// 0x01046f5c: 0x1046f5c: jal   0x109b490 addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01046f70: 0x1046f70: addiu a1, a1, 23008
	...
	add
	stloc.2
// 0x01046f74: 0x1046f74: jal   0x109916c addu  a2, a1, zero
	ldloc.2
	stloc.3
	ldloc.1
	ldloc.2
...
// 0x01046f80: 0x1046f80: addu  a0, s0, zero
	ldloc 8
	stloc.1
// 0x01046f84: 0x1046f84: jal   0x109b490 addiu a1, a1, 280
	ldloc.2
	ldc.i4 280
	add
	stloc.2
...
// 0x01046f98: 0x1046f98: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01046f9c: 0x1046f9c: jal   0x109916c addu  a2, a1, zero
	ldloc.2
	stloc.3
	ldloc.1
	ldloc.2
...
// 0x0104707c: 0x104707c: addiu a0, a0, 352
	...
	add
	stloc.1
// 0x01047080: 0x1047080: jal   0x1095a3c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl111::ssd_dialog_change_text_1095a3c(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x0104717c: 0x104717c: addu  a1, s1, zero
	ldloc 9
	stloc.2
// 0x01047180: 0x1047180: jal   0x1095a3c addiu a0, a0, 352
	ldloc.1
	ldc.i4 352
	add
	stloc.1
...
// 0x010471c4: 0x10471c4: sw    s4, 68(sp)
	...
	ldloc 10
	stelem.i4
// 0x010471c8: 0x10471c8: jal   0x1094118 sw    s3, 64(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010472cc: 0x10472cc: addiu a0, a0, 352
	...
	add
	stloc.1
// 0x010472d0: 0x10472d0: jal   0x1095a3c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01047330: 0x1047330: addu  a1, s5, zero
	ldloc 13
	stloc.2
// 0x01047334: 0x1047334: jal   0x1095a3c addiu a0, a0, 352
	ldloc.1
	ldc.i4 352
	add
	stloc.1
...
// 0x01047358: 0x1047358: sw    s0, 0(v0)
	...
	ldloc 8
	stelem.i4
// 0x0104735c: 0x104735c: jal   0x1099300 sw    s2, 4(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01047370: 0x1047370: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01047374: 0x1047374: jal   0x109b5c0 addu  a0, s1, zero
	ldloc 11
	stloc.1
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x0104737c: 0x104737c: jal   0x1095198 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01047384: 0x1047384: lw    a1, 16(s1)
	...
	ldelem.i4
	stloc.2
// 0x01047388: 0x1047388: jal   0x109c778 addiu a0, s3, 30216
	ldloc 12
	ldc.i4 30216
	add
	stloc.1
...
// 0x01047674: 0x1047674: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01047678: 0x1047678: jal   0x109a5b0 sw    zero, 20448(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0104768c: 0x104768c: addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
// 0x01047690: 0x1047690: jal   0x109c690 sltu  s4, zero, v0
	ldc.i4.s 0
	ldloc 5
	clt.un
	stloc 11
...
// 0x010476a0: 0x10476a0: addu  a2, s1, zero
	ldloc 9
	stloc.3
// 0x010476a4: 0x10476a4: jal   0x109c690 addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x010476b8: 0x10476b8: addiu a1, zero, 7
	ldc.i4.7
	stloc.2
// 0x010476bc: 0x10476bc: jal   0x109c690 addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x010476d4: 0x10476d4: addiu a1, zero, 2
	ldc.i4.2
	stloc.2
// 0x010476d8: 0x10476d8: jal   0x109c690 addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x010476e8: 0x10476e8: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x010476ec: 0x10476ec: jal   0x109c690 addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x0104771c: 0x104771c: sw    v0, 28(sp)
	...
	ldloc 5
	stelem.i4
// 0x01047720: 0x1047720: jal   0x109c97c sw    zero, 24(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
