...
// 0x0104779c: 0x104779c: jal   0x109a32c sw    zero, 20512(v0)
	...
	stloc 5
// --- basic block ---
// 0x010477a4: 0x10477a4: addiu a0, s0, 13452
	ldloc 8
	ldc.i4 13452
	add
	stloc.1
...
// 0x010477b4: 0x10477b4: jal   0x109c40c sltu  s4, zero, v0
	...
	stloc 5
// --- basic block ---
// 0x010477bc: 0x10477bc: addiu a0, s0, 13452
	ldloc 8
	ldc.i4 13452
	add
	stloc.1
...
// 0x010477d4: 0x10477d4: xori  a2, a2, 1
	...
	xor
	stloc.3
// 0x010477d8: 0x10477d8: addiu a0, s0, 13452
	ldloc 8
	ldc.i4 13452
	add
	stloc.1
...
// 0x010477f0: 0x10477f0: and   a2, s3, a2
	...
	and
	stloc.3
// 0x010477f4: 0x10477f4: addiu a0, s0, 13452
	ldloc 8
	ldc.i4 13452
	add
	stloc.1
...
// 0x01047804: 0x1047804: addu  a2, s3, zero
	ldloc 10
	stloc.3
// 0x01047808: 0x1047808: addiu a0, s0, 13452
	ldloc 8
	ldc.i4 13452
	add
	stloc.1
...
// 0x0104782c: 0x104782c: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x01047830: 0x1047830: addiu a2, s0, 13452
	ldloc 8
	ldc.i4 13452
	add
	stloc.3
