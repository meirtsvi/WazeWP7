...
// 0x0106e0d0: 0x106e0d0: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0106e0d4: 0x106e0d4: lw    v0, 15052(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106e154: 0x106e154: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0106e158: 0x106e158: sw    zero, 15052(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106e180: 0x106e180: lui   s0, 0x0
	ldc.i4.s 0
	stloc 8
// 0x0106e184: 0x106e184: lw    v0, 15040(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0106e1ac: 0x106e1ac: jal   0x1030d4c addiu a0, a0, -7672
	...
	stloc 6
// --- basic block ---
// 0x0106e1b4: 0x106e1b4: sw    zero, 15040(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0106e1e0: 0x106e1e0: beq   v0, zero, 0x106e1f0 addu  v1, zero, zero
	...
	brfalse L_106e1f0
// --- basic block ---
// 0x0106e1e8: 0x106e1e8: sw    zero, 15040(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0106e234: 0x106e234: beq   v0, zero, 0x106e244 lui   v1, 0x0
	...
	brfalse L_106e244
// --- basic block ---
// 0x0106e23c: 0x106e23c: j	 0x106e24c sw    zero, 15040(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0106e244: 0x106e244: addiu v0, zero, 1
	ldc.i4.1
	stloc 6
// 0x0106e248: 0x106e248: sw    v0, 15040(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0106e270: 0x106e270: lui   s0, 0x0
	ldc.i4.s 0
	stloc 8
// 0x0106e274: 0x106e274: lw    v0, 15036(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0106e2b8: 0x106e2b8: beq   v0, zero, 0x106e2c8 addu  v1, zero, zero
	...
	brfalse L_106e2c8
// --- basic block ---
// 0x0106e2c0: 0x106e2c0: sw    zero, 15036(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0106e2f0: 0x106e2f0: jal   0x106e268 sw    v1, 15036(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106e308: 0x106e308: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0106e30c: 0x106e30c: lw    v0, 15032(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106e364: 0x106e364: jal   0x106aeec addu  s2, v0, zero
	...
	stloc 5
// --- basic block ---
// 0x0106e36c: 0x106e36c: addiu a0, s5, 14916
	ldloc 8
	ldc.i4 14916
	add
	stloc.1
...
// 0x0106e390: 0x106e390: addiu a1, a1, 20428
	...
	add
	stloc.2
// 0x0106e394: 0x106e394: jal   0x100e5e0 addiu a0, s5, 14916
	ldloc 8
	ldc.i4 14916
	add
	stloc.1
...
// 0x0106e3bc: 0x106e3bc: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0106e3c0: 0x106e3c0: jal   0x100e368 addiu a0, a0, 14932
	ldloc.1
	ldc.i4 14932
	add
	stloc.1
...
// 0x0106e500: 0x106e500: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0106e504: 0x106e504: sw    zero, 15032(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106e54c: 0x106e54c: jal   0x106e308 sw    v1, 15032(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_106e650:
// 0x0106e650: 0x106e650: lw    a0, 15056(t0)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0106e680: 0x106e680: addiu a3, zero, -1
	ldc.i4.m1
	stloc 4
// 0x0106e684: 0x106e684: sw    zero, 15056(t0)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_106e6e0:
// 0x0106e6e0: 0x106e6e0: sw    zero, 15056(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_106f19c:
// 0x0106f19c: 0x106f19c: lw    v0, 15048(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
