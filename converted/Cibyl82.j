...
// 0x0106dfcc: 0x106dfcc: lw    s1, 17880(v0)
	...
	ldelem.i4
	stloc 9
// 0x0106dfd0: 0x106dfd0: jal   0x10ac998 sll   zero, zero, 0
...
// --- basic block ---
L_106dff0:
// 0x0106dff0: 0x106dff0: jal   0x10ac998 sll   zero, zero, 0
	call int32 Cibyl129::editor_points_get_total_points_10ac998()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
...
// 0x0106e014: 0x106e014: beq   v0, zero, 0x106e038 addu  v1, zero, zero
	...
	brfalse L_106e038
// --- basic block ---
// 0x0106e01c: 0x106e01c: jal   0x10ac998 sll   zero, zero, 0
	call int32 Cibyl129::editor_points_get_total_points_10ac998()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
...
// --- basic block ---
L_106e224:
// 0x0106e224: 0x106e224: jal   0x10a88d8 lui   s5, 0x0
	ldc.i4.s 0
	stloc 8
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl126::roadmap_download_settings_isDownloadWazers_10a88d8(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
// 0x0106e22c: 0x106e22c: jal   0x10a8b44 addu  s4, v0, zero
	ldloc 5
	stloc 14
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl126::roadmap_download_settings_isDownloadReports_10a8b44(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
// 0x0106e234: 0x106e234: jal   0x10a8a98 addu  s3, v0, zero
	ldloc 5
	stloc 13
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl126::roadmap_download_settings_isDownloadTraffic_10a8a98(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x0106e390: 0x106e390: ori   s5, s5, 32
	...
	stloc 8
L_106e394:
// 0x0106e394: 0x106e394: jal   0x10a4a48 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0106e474: 0x106e474: addiu a2, sp, 36
	...
	add
	stloc.3
// 0x0106e478: 0x106e478: jal   0x10b3140 addiu a3, sp, 40
	ldloc.0
	ldc.i4.s 40
	add
	stloc 4
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl133::editor_track_report_get_current_position_10b3140(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x0106eff4: 0x106eff4: beq   a0, zero, 0x106f028 lui   v0, 0x80000
	...
	brfalse L_106f028
// --- basic block ---
// 0x0106effc: 0x106effc: jal   0x10ac4e4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0106f04c: 0x106f04c: bne   a0, v0, 0x106f0c4 sll   zero, zero, 0
	...
	bne.un L_106f0c4
// --- basic block ---
// 0x0106f054: 0x106f054: jal   0x10ac4e4 addiu a0, zero, 27
	ldc.i4.s 27
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0106f07c: 0x106f07c: beq   v0, zero, 0x106f094 sll   zero, zero, 0
	...
	brfalse L_106f094
// --- basic block ---
// 0x0106f084: 0x106f084: jal   0x10a065c sll   zero, zero, 0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
...
// --- basic block ---
L_106f094:
// 0x0106f094: 0x106f094: jal   0x10a073c sll   zero, zero, 0
	call int32 Cibyl120::roadmap_login_is_login_active_10a073c()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x0106f0ac: 0x106f0ac: jal   0x104c168 addiu a1, a1, 24340
	...
	stloc 5
// --- basic block ---
// 0x0106f0b4: 0x106f0b4: jal   0x10a1438 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0106f104: 0x106f104: beq   a0, v0, 0x106f124 sll   zero, zero, 0
	...
	beq  L_106f124
// --- basic block ---
// 0x0106f10c: 0x106f10c: jal   0x10ac4e4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0106f128: 0x106f128: lw    s0, 17752(v0)
	...
	ldelem.i4
	stloc 8
// 0x0106f12c: 0x106f12c: jal   0x10ac4e4 sltiu s0, s0, 1
	ldloc 8
	ldc.i4.1
	clt.un
	stloc 8
...
// 0x0106f16c: 0x106f16c: beq   a0, zero, 0x106f188 addu  v1, zero, zero
	...
	brfalse L_106f188
// --- basic block ---
// 0x0106f174: 0x106f174: jal   0x10ac4e4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
