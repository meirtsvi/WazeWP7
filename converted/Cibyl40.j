...
// 0x010366e0: 0x10366e0: addiu a0, zero, 51
	ldc.i4.s 51
	stloc.1
// 0x010366e4: 0x10366e4: bne   v0, a0, 0x1036718 addiu v1, v1, -16928
	ldloc 5
	ldloc.1
	ldloc 7
	ldc.i4 -16928
...
// 0x010366f4: 0x10366f4: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010366f8: 0x10366f8: j	 0x1036720 sw    zero, -16916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01036704: 0x1036704: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01036708: 0x1036708: j	 0x1036720 sw    v1, -16916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01036720: 0x1036720: lui   s2, 0x60000
	ldc.i4 393216
	stloc 10
// 0x01036724: 0x1036724: addiu s1, s2, -16928
	ldloc 10
	ldc.i4 -16928
	add
	stloc 9
...
// 0x0103673c: 0x103673c: lui   a1, 0x60000
	ldc.i4 393216
	stloc.2
// 0x01036740: 0x1036740: jal   0x10364a0 addiu a1, a1, -16672
	ldloc.2
	ldc.i4 -16672
	add
	stloc.2
	...
	stloc 5
// --- basic block ---
// 0x01036748: 0x1036748: bltz  v0, 0x10367d4 sw    v0, -16928(s2)
	ldloc 5
	ldloc 6
	ldloc 10
	ldc.i4.2
...
// 0x010367bc: 0x10367bc: lui   a0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x010367c0: 0x10367c0: addiu a0, a0, -16900
	ldloc.1
	ldc.i4 -16900
	add
	stloc.1
...
// 0x0103681c: 0x103681c: lb    v1, 0(v0)
	...
	call int32 [WazeWP7]CRunTime::memoryReadByte(int32)
	stloc 8
// 0x01036820: 0x1036820: addiu s1, s2, -16928
	ldloc 11
	ldc.i4 -16928
	add
	stloc 9
...
// 0x0103683c: 0x103683c: jal   0x10364a0 lui   s3, 0x60000
	...
	stloc 6
// --- basic block ---
// 0x01036844: 0x1036844: sw    v0, -16928(s2)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01036848: 0x1036848: lw    a1, 36(s0)
	...
	ldelem.i4
	stloc.2
// 0x0103684c: 0x103684c: addiu a0, s3, -16672
	ldloc 10
	ldc.i4 -16672
	add
	stloc.1
// 0x01036850: 0x1036850: jal   0x1001af8 addiu a2, zero, 16
	...
	stloc 6
// --- basic block ---
// 0x01036858: 0x1036858: lw    v0, -16928(s2)
	ldloc 5
	ldloc 11
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 6
// 0x0103685c: 0x103685c: addiu s3, s3, -16672
	ldloc 10
	ldc.i4 -16672
	add
	stloc 10
...
// 0x01036978: 0x1036978: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0103697c: 0x103697c: addiu v0, v0, 26172
	ldloc 5
	ldc.i4 26172
	add
	stloc 5
...
// 0x010369a8: 0x10369a8: addu  a0, s0, zero
	ldloc 10
	stloc.1
// 0x010369ac: 0x10369ac: jalr  v0 addiu a1, a1, -16928
	ldloc 5
	ldloc.2
	ldc.i4 -16928
	add
...
// 0x010369b4: 0x10369b4: lui   a0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x010369b8: 0x10369b8: jal   0x101c99c addiu a0, a0, -16656
	ldloc.1
	ldc.i4 -16656
	add
	stloc.1
...
// 0x01036b2c: 0x1036b2c: addiu v0, zero, 80
	ldc.i4.s 80
	stloc 6
// 0x01036b30: 0x1036b30: beq   v1, v0, 0x1036b44 addiu s1, s1, 26172
	ldloc 10
	ldloc 6
	ldloc 7
	ldc.i4 26172
...
// 0x01036c88: 0x1036c88: addu  s3, a0, zero
	ldloc.1
	stloc 11
// 0x01036c8c: 0x1036c8c: addiu v0, v0, 26180
	ldloc 5
	ldc.i4 26180
	add
	stloc 5
...
// 0x01036d24: 0x1036d24: lui   v0, 0x60000
	ldc.i4 393216
	stloc.1
// 0x01036d28: 0x1036d28: jr    ra sw    a0, -16584(v0)
	ldloc 3
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01036d34: 0x1036d34: addiu sp, sp, -40
	...
	add
	stloc.0
// 0x01036d38: 0x1036d38: addiu v0, v0, -16580
	ldloc 5
	ldc.i4 -16580
	add
	stloc 5
...
// 0x01036d50: 0x1036d50: ori   a2, a2, 32768
	...
	or
	stloc.3
// 0x01036d54: 0x1036d54: lw    v0, -16584(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01036d88: 0x1036d88: lui   v0, 0x60000
	ldc.i4 393216
	stloc.2
// 0x01036d8c: 0x1036d8c: addiu v0, v0, -16580
	ldloc.2
	ldc.i4 -16580
	add
	stloc.2
...
// 0x01036dc4: 0x1036dc4: lw    a2, 8(a2)
	...
	ldelem.i4
	stloc.3
// 0x01036dc8: 0x1036dc8: lw    v1, -16584(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01037298: 0x1037298: lw    a0, 8(a0)
	...
	ldelem.i4
	stloc.1
// 0x0103729c: 0x103729c: jal   0x104d46c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010372ac: 0x10372ac: lw    a0, 8(a0)
	...
	ldelem.i4
	stloc.1
// 0x010372b0: 0x10372b0: jal   0x1051c70 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010372c0: 0x10372c0: lw    a0, 8(a0)
	...
	ldelem.i4
	stloc.1
// 0x010372c4: 0x10372c4: jal   0x104fb3c sll   zero, zero, 0
	call int32 Cibyl59::roadmap_serial_close_104fb3c()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 5
	stloc 7
// --- basic block ---
...
// 0x010372d4: 0x10372d4: lw    a0, 8(a0)
	...
	ldelem.i4
	stloc.1
// 0x010372d8: 0x10372d8: jal   0x10ac65c sll   zero, zero, 0
	call void Cibyl129::roadmap_spawn_close_pipe_10ac65c()
// --- basic block ---
L_10372e0:
...
// 0x01037314: 0x1037314: sll   v1, v1, 2
	...
	shl
	stloc 5
// 0x01037318: 0x1037318: addiu a2, a2, 26388
	ldloc.3
	ldc.i4 26388
	add
	stloc.3
...
// 0x01037338: 0x1037338: lw    a0, 8(a0)
	...
	ldelem.i4
	stloc.1
// 0x0103733c: 0x103733c: jal   0x104d48c addu  a2, v0, zero
	ldloc 6
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0103734c: 0x103734c: lw    a0, 8(a0)
	...
	ldelem.i4
	stloc.1
// 0x01037350: 0x1037350: jal   0x1052198 addu  a2, v0, zero
	ldloc 6
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01037360: 0x1037360: lw    a0, 8(a0)
	...
	ldelem.i4
	stloc.1
// 0x01037364: 0x1037364: jal   0x104fb34 addu  a2, v0, zero
	ldloc 6
	stloc.3
	call int32 Cibyl59::roadmap_serial_write_104fb34()
	stloc 6
// --- basic block ---
...
// 0x01037374: 0x1037374: lw    a0, 8(a0)
	...
	ldelem.i4
	stloc.1
// 0x01037378: 0x1037378: jal   0x10ac64c addu  a2, v0, zero
	ldloc 6
	stloc.3
	call int32 Cibyl129::roadmap_spawn_write_pipe_10ac64c()
	stloc 6
// --- basic block ---
L_1037380:
...
// 0x010373ac: 0x10373ac: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010373b0: 0x10373b0: addiu v0, v0, 26408
	ldloc 5
	ldc.i4 26408
	add
	stloc 5
...
// 0x010373d4: 0x10373d4: lw    a0, 8(a0)
	...
	ldelem.i4
	stloc.1
// 0x010373d8: 0x10373d8: jal   0x104d4b4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010373e8: 0x10373e8: lw    a0, 8(a0)
	...
	ldelem.i4
	stloc.1
// 0x010373ec: 0x10373ec: jal   0x1051fe4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010373fc: 0x10373fc: lw    a0, 8(a0)
	...
	ldelem.i4
	stloc.1
// 0x01037400: 0x1037400: jal   0x104fb04 sll   zero, zero, 0
	ldloc.1
	ldloc.2
	ldloc.3
	call int32 Cibyl59::roadmap_serial_read_104fb04(int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x01037410: 0x1037410: lw    a0, 8(a0)
	...
	ldelem.i4
	stloc.1
// 0x01037414: 0x1037414: jal   0x10ac654 sll   zero, zero, 0
	call int32 Cibyl129::roadmap_spawn_read_pipe_10ac654()
	stloc 5
// --- basic block ---
L_103741c:
...
// 0x010374a0: 0x10374a0: sw    s4, 8264(sp)
	...
	ldloc 10
	stelem.i4
// 0x010374a4: 0x10374a4: sw    v0, -16544(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
	...
	ldloc 5
	stelem.i4
// 0x010374a8: 0x10374a8: sw    zero, -16548(s0)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010374f8: 0x10374f8: jal   0x101cd80 addiu a0, a0, -12568
	...
	stloc 5
// --- basic block ---
// 0x01037500: 0x1037500: sw    v0, -16544(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01037510: 0x1037510: jal   0x101cd80 addiu a0, a0, -12528
	...
	stloc 5
// --- basic block ---
// 0x01037518: 0x1037518: sw    v0, -16544(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0103751c: 0x103751c: addiu v0, zero, 5
	...
	stloc 5
L_1037520:
// 0x01037520: 0x1037520: j	 0x10375a0 sw    v0, -16548(s0)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01037528: 0x1037528: jal   0x101cd80 addiu a0, a0, -12488
	...
	stloc 5
// --- basic block ---
// 0x01037530: 0x1037530: sw    v0, -16544(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01037558: 0x1037558: jal   0x101cd80 addiu a0, a0, -12456
	...
	stloc 5
// --- basic block ---
// 0x01037560: 0x1037560: sw    v0, -16544(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0103756c: 0x103756c: jal   0x101cd80 addiu a0, a0, -12428
	...
	stloc 5
// --- basic block ---
// 0x01037574: 0x1037574: sw    v0, -16544(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01037578: 0x1037578: addiu v0, zero, 6
	ldc.i4.6
	stloc 5
// 0x0103757c: 0x103757c: sw    v0, -16548(s0)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0103758c: 0x103758c: lui   v1, 0x60000
	ldc.i4 393216
	stloc 7
// 0x01037590: 0x1037590: sw    v0, -16544(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01037598: 0x1037598: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x0103759c: 0x103759c: sw    v1, -16548(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010375cc: 0x10375cc: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x010375d0: 0x10375d0: sw    v0, -16548(s0)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010376e4: 0x10376e4: jal   0x101cd80 addiu a0, a0, -12312
	...
	stloc 5
// --- basic block ---
// 0x010376ec: 0x10376ec: sw    v0, -16544(s2)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x010376fc: 0x10376fc: jal   0x101cd80 addiu a0, a0, -12200
	...
	stloc 5
// --- basic block ---
// 0x01037704: 0x1037704: sw    v0, -16544(s2)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01037708: 0x1037708: addiu v0, zero, 6
	...
	stloc 5
L_103770c:
// 0x0103770c: 0x103770c: j	 0x1037718 sw    v0, -16548(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0103774c: 0x103774c: lui   v0, 0x60000
	ldc.i4 393216
	stloc.2
// 0x01037750: 0x1037750: lw    v0, -16540(v0)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x010377c0: 0x10377c0: lui   v1, 0x60000
	ldc.i4 393216
	stloc.3
// 0x010377c4: 0x10377c4: lw    a1, -16540(v1)
	ldloc 5
	ldloc.3
	ldc.i4.2
	shr.un
...
// 0x010378b4: 0x10378b4: lui   s0, 0x60000
	ldc.i4 393216
	stloc 7
// 0x010378b8: 0x10378b8: lw    v0, -16540(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010378c8: 0x10378c8: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x010378cc: 0x10378cc: lw    v0, -16536(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010378d4: 0x10378d4: beq   v0, zero, 0x1037928 sll   zero, zero, 0
	...
	brfalse L_1037928
// --- basic block ---
// 0x010378dc: 0x10378dc: jal   0x104c584 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010378e4: 0x10378e4: lui   a1, 0x10000
	ldc.i4 65536
	stloc.2
// 0x010378e8: 0x10378e8: lui   a2, 0x0
	ldc.i4.s 0
	stloc.3
...
// 0x010378f0: 0x10378f0: addiu a1, a1, -12164
	...
	add
	stloc.2
// 0x010378f4: 0x10378f4: jal   0x104dae8 addiu a2, a2, 28964
	ldloc.3
	ldc.i4 28964
	add
	stloc.3
...
// 0x010378fc: 0x10378fc: beq   v0, zero, 0x1037920 sll   zero, zero, 0
	...
	brfalse L_1037920
// --- basic block ---
// 0x01037904: 0x1037904: lw    a1, -16540(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01037920: 0x1037920: lui   v0, 0x60000
	ldc.i4 393216
	stloc 5
// 0x01037924: 0x1037924: sw    zero, -16536(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
