...
// 0x0100b468: 0x100b468: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b46c: 0x100b46c: lw    v1, 30680(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b4c4: 0x100b4c4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b4c8: 0x100b4c8: lw    v0, 30688(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b500: 0x100b500: lui   v0, 0x20000
	...
	stloc 5
L_100b504:
// 0x0100b504: 0x100b504: lw    v1, 30688(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b54c: 0x100b54c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b550: 0x100b550: lw    v1, 30688(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100b58c:
// 0x0100b58c: 0x100b58c: lw    v1, 30688(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b5d4: 0x100b5d4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b5d8: 0x100b5d8: lw    v1, 30688(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100b614:
// 0x0100b614: 0x100b614: lw    v1, 30688(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b664: 0x100b664: lui   s0, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100b668: 0x100b668: lw    v0, 30688(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100b690: 0x100b690: bltz  v0, 0x100b6bc sll   v0, v0, 2
	...
	blt L_100b6bc
// --- basic block ---
// 0x0100b698: 0x100b698: lw    v1, 30688(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100b870: 0x100b870: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b874: 0x100b874: lw    v1, 30688(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b89c: 0x100b89c: lui   v1, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100b8a0: 0x100b8a0: lw    a0, 30692(v1)
	ldloc 8
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100b93c: 0x100b93c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100b940: 0x100b940: lw    s0, 30692(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100b950: 0x100b950: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100b954: 0x100b954: lw    a0, 30692(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100b988: 0x100b988: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0100b98c: 0x100b98c: addiu v1, v1, -22796
	ldloc 5
	ldc.i4 -22796
	add
	stloc 5
...
// 0x0100b9f8: 0x100b9f8: lui   v0, 0xe0000
	...
	stloc 6
L_100b9fc:
// 0x0100b9fc: 0x100b9fc: addiu v0, v0, -22796
	ldloc 6
	ldc.i4 -22796
	add
	stloc 6
...
// 0x0100ba70: 0x100ba70: lui   v1, 0xe0000
	...
	stloc 5
L_100ba74:
// 0x0100ba74: 0x100ba74: addiu v1, v1, -22796
	ldloc 5
	ldc.i4 -22796
	add
	stloc 5
...
// 0x0100bae0: 0x100bae0: lui   v0, 0xe0000
	...
	stloc 6
L_100bae4:
// 0x0100bae4: 0x100bae4: addiu v0, v0, -22796
	ldloc 6
	ldc.i4 -22796
	add
	stloc 6
...
// 0x0100bb58: 0x100bb58: lui   a0, 0xe0000
	...
	stloc.1
L_100bb5c:
// 0x0100bb5c: 0x100bb5c: addiu a0, a0, -22796
	ldloc.1
	ldc.i4 -22796
	add
	stloc.1
...
// 0x0100bbcc: 0x100bbcc: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0100bbd0: 0x100bbd0: addiu v1, v1, -22796
	ldloc 5
	ldc.i4 -22796
	add
	stloc 5
...
// 0x0100bc48: 0x100bc48: lui   v1, 0xe0000
	...
	stloc 5
L_100bc4c:
// 0x0100bc4c: 0x100bc4c: addiu v1, v1, -22796
	ldloc 5
	ldc.i4 -22796
	add
	stloc 5
...
// 0x0100bcc0: 0x100bcc0: lui   v1, 0xe0000
	...
	stloc 5
L_100bcc4:
// 0x0100bcc4: 0x100bcc4: addiu v1, v1, -22796
	ldloc 5
	ldc.i4 -22796
	add
	stloc 5
...
// 0x0100bd94: 0x100bd94: bne   v0, v1, 0x100ba60 lui   v1, 0xe0000
	...
	bne.un L_100ba60
// --- basic block ---
// 0x0100bd9c: 0x100bd9c: j	 0x100ba78 addiu v1, v1, -22796
	ldloc 5
	ldc.i4 -22796
	add
	stloc 5
...
// 0x0100be04: 0x100be04: bne   v0, v1, 0x100bbbc lui   v1, 0xe0000
	...
	bne.un L_100bbbc
// --- basic block ---
// 0x0100be0c: 0x100be0c: j	 0x100bbd4 addiu v1, v1, -22796
	ldloc 5
	ldc.i4 -22796
	add
	stloc 5
...
// 0x0100be28: 0x100be28: bne   v0, v1, 0x100bc38 lui   v1, 0xe0000
	...
	bne.un L_100bc38
// --- basic block ---
// 0x0100be30: 0x100be30: j	 0x100bc50 addiu v1, v1, -22796
	ldloc 5
	ldc.i4 -22796
	add
	stloc 5
...
// 0x0100be4c: 0x100be4c: bne   v0, v1, 0x100bcb0 lui   v1, 0xe0000
	...
	bne.un L_100bcb0
// --- basic block ---
// 0x0100be54: 0x100be54: j	 0x100bcc8 addiu v1, v1, -22796
	ldloc 5
	ldc.i4 -22796
	add
	stloc 5
...
// 0x0100be7c: 0x100be7c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100be80: 0x100be80: lw    v0, 30688(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100becc: 0x100becc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100bed0: 0x100bed0: lw    a0, 30692(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100bf08: 0x100bf08: lui   v0, 0x20000
	...
	stloc 5
L_100bf0c:
// 0x0100bf0c: 0x100bf0c: lw    a0, 30692(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100bf38: 0x100bf38: lw    a1, 24(sp)
	...
	ldelem.i4
	stloc.2
// 0x0100bf3c: 0x100bf3c: addiu s3, s3, -22796
	ldloc 11
	ldc.i4 -22796
	add
	stloc 11
...
// --- basic block ---
L_100bf98:
// 0x0100bf98: 0x100bf98: lw    a0, 30692(a3)
	ldloc 6
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0100c104: 0x100c104: lui   a0, 0xe0000
	ldc.i4 917504
	stloc.1
// 0x0100c108: 0x100c108: lw    v1, -16932(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100c1a4:
// 0x0100c1a4: 0x100c1a4: lw    v0, 30696(a3)
	ldloc 6
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0100c218: 0x100c218: addiu a0, zero, 4
	ldc.i4.4
	stloc.1
// 0x0100c21c: 0x100c21c: addiu a1, a1, 24920
	ldloc.2
	ldc.i4 24920
	add
	stloc.2
// 0x0100c220: 0x100c220: addiu a2, zero, 893
	ldc.i4 893
	stloc.3
// 0x0100c224: 0x100c224: addiu a3, a3, 25164
	ldloc 4
	ldc.i4 25164
	add
	stloc 4
...
// 0x0100c29c: 0x100c29c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100c2a0: 0x100c2a0: lw    s0, 30692(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100c3c4: 0x100c3c4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100c3c8: 0x100c3c8: sw    zero, 30696(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100c424: 0x100c424: lui   s1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100c428: 0x100c428: lw    v0, 30688(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100c434: 0x100c434: jal   0x10158a0 sll   s0, s0, 2
	...
	stloc 6
// --- basic block ---
// 0x0100c43c: 0x100c43c: lw    v0, 30688(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100c544: 0x100c544: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100c548: 0x100c548: lw    v0, 30688(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100c720: 0x100c720: lui   v1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x0100c724: 0x100c724: lw    v1, 30700(v1)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0100c74c: 0x100c74c: lui   v1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x0100c750: 0x100c750: lw    v1, 30700(v1)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0100c770: 0x100c770: lui   v1, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100c774: 0x100c774: lw    a0, 30700(v1)
	ldloc 8
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100c828: 0x100c828: lui   v1, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100c82c: 0x100c82c: lw    v1, 30700(v1)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
