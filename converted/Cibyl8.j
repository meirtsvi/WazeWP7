...
// 0x0100b468: 0x100b468: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b46c: 0x100b46c: lw    v1, 31544(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b4c4: 0x100b4c4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b4c8: 0x100b4c8: lw    v0, 31552(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b500: 0x100b500: lui   v0, 0x20000
	...
	stloc 5
L_100b504:
// 0x0100b504: 0x100b504: lw    v1, 31552(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b54c: 0x100b54c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b550: 0x100b550: lw    v1, 31552(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100b58c:
// 0x0100b58c: 0x100b58c: lw    v1, 31552(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b5d4: 0x100b5d4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b5d8: 0x100b5d8: lw    v1, 31552(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100b614:
// 0x0100b614: 0x100b614: lw    v1, 31552(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b664: 0x100b664: lui   s0, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100b668: 0x100b668: lw    v0, 31552(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100b690: 0x100b690: bltz  v0, 0x100b6bc sll   v0, v0, 2
	...
	blt L_100b6bc
// --- basic block ---
// 0x0100b698: 0x100b698: lw    v1, 31552(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100b870: 0x100b870: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b874: 0x100b874: lw    v1, 31552(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b89c: 0x100b89c: lui   v1, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100b8a0: 0x100b8a0: lw    a0, 31556(v1)
	ldloc 8
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100b93c: 0x100b93c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100b940: 0x100b940: lw    s0, 31556(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100b950: 0x100b950: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100b954: 0x100b954: lw    a0, 31556(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100b988: 0x100b988: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0100b98c: 0x100b98c: addiu v1, v1, 29700
	ldloc 5
	ldc.i4 29700
	add
	stloc 5
...
// 0x0100b9f8: 0x100b9f8: lui   v0, 0xe0000
	...
	stloc 6
L_100b9fc:
// 0x0100b9fc: 0x100b9fc: addiu v0, v0, 29700
	ldloc 6
	ldc.i4 29700
	add
	stloc 6
...
// 0x0100ba70: 0x100ba70: lui   v1, 0xe0000
	...
	stloc 5
L_100ba74:
// 0x0100ba74: 0x100ba74: addiu v1, v1, 29700
	ldloc 5
	ldc.i4 29700
	add
	stloc 5
...
// 0x0100bae0: 0x100bae0: lui   v0, 0xe0000
	...
	stloc 6
L_100bae4:
// 0x0100bae4: 0x100bae4: addiu v0, v0, 29700
	ldloc 6
	ldc.i4 29700
	add
	stloc 6
...
// 0x0100bb58: 0x100bb58: lui   a0, 0xe0000
	...
	stloc.1
L_100bb5c:
// 0x0100bb5c: 0x100bb5c: addiu a0, a0, 29700
	ldloc.1
	ldc.i4 29700
	add
	stloc.1
...
// 0x0100bbcc: 0x100bbcc: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0100bbd0: 0x100bbd0: addiu v1, v1, 29700
	ldloc 5
	ldc.i4 29700
	add
	stloc 5
...
// 0x0100bc48: 0x100bc48: lui   v1, 0xe0000
	...
	stloc 5
L_100bc4c:
// 0x0100bc4c: 0x100bc4c: addiu v1, v1, 29700
	ldloc 5
	ldc.i4 29700
	add
	stloc 5
...
// 0x0100bcc0: 0x100bcc0: lui   v1, 0xe0000
	...
	stloc 5
L_100bcc4:
// 0x0100bcc4: 0x100bcc4: addiu v1, v1, 29700
	ldloc 5
	ldc.i4 29700
	add
	stloc 5
...
// 0x0100bd94: 0x100bd94: bne   v0, v1, 0x100ba60 lui   v1, 0xe0000
	...
	bne.un L_100ba60
// --- basic block ---
// 0x0100bd9c: 0x100bd9c: j	 0x100ba78 addiu v1, v1, 29700
	ldloc 5
	ldc.i4 29700
	add
	stloc 5
...
// 0x0100be04: 0x100be04: bne   v0, v1, 0x100bbbc lui   v1, 0xe0000
	...
	bne.un L_100bbbc
// --- basic block ---
// 0x0100be0c: 0x100be0c: j	 0x100bbd4 addiu v1, v1, 29700
	ldloc 5
	ldc.i4 29700
	add
	stloc 5
...
// 0x0100be28: 0x100be28: bne   v0, v1, 0x100bc38 lui   v1, 0xe0000
	...
	bne.un L_100bc38
// --- basic block ---
// 0x0100be30: 0x100be30: j	 0x100bc50 addiu v1, v1, 29700
	ldloc 5
	ldc.i4 29700
	add
	stloc 5
...
// 0x0100be4c: 0x100be4c: bne   v0, v1, 0x100bcb0 lui   v1, 0xe0000
	...
	bne.un L_100bcb0
// --- basic block ---
// 0x0100be54: 0x100be54: j	 0x100bcc8 addiu v1, v1, 29700
	ldloc 5
	ldc.i4 29700
	add
	stloc 5
...
// 0x0100be7c: 0x100be7c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100be80: 0x100be80: lw    v0, 31552(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100becc: 0x100becc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100bed0: 0x100bed0: lw    a0, 31556(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100bf08: 0x100bf08: lui   v0, 0x20000
	...
	stloc 6
L_100bf0c:
// 0x0100bf0c: 0x100bf0c: lw    a0, 31556(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100bf24: 0x100bf24: sw    v0, 32(sp)
	...
	ldloc 6
	stelem.i4
// 0x0100bf28: 0x100bf28: addiu s3, s3, 29700
	ldloc 11
	ldc.i4 29700
	add
	stloc 11
// 0x0100bf2c: 0x100bf2c: addiu s8, s8, 24696
	ldloc 15
	ldc.i4 24696
	add
	stloc 15
...
// --- basic block ---
L_100bf58:
// 0x0100bf58: 0x100bf58: lw    a0, 31556(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100c0c4:
// 0x0100c0c4: 0x100c0c4: lui   a0, 0xf0000
	ldc.i4 983040
	stloc.1
// 0x0100c0c8: 0x100c0c8: lw    v1, -29972(a0)
	ldloc 5
	ldloc.1
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100c15c:
// 0x0100c15c: 0x100c15c: lw    v0, 31560(s7)
	ldloc 5
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x0100c1d4: 0x100c1d4: addiu a2, zero, 893
	ldc.i4 893
	stloc.3
// 0x0100c1d8: 0x100c1d8: addiu a3, a3, 24940
	ldloc 4
	ldc.i4 24940
	add
	stloc 4
...
// 0x0100c248: 0x100c248: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100c24c: 0x100c24c: sw    zero, 31560(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100c2a8: 0x100c2a8: lui   s1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100c2ac: 0x100c2ac: lw    v0, 31552(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100c2b8: 0x100c2b8: jal   0x1015724 sll   s0, s0, 2
	...
	stloc 6
// --- basic block ---
// 0x0100c2c0: 0x100c2c0: lw    v0, 31552(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100c3c8: 0x100c3c8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100c3cc: 0x100c3cc: lw    v0, 31552(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100c5a4: 0x100c5a4: lui   v1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x0100c5a8: 0x100c5a8: lw    v1, 31564(v1)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0100c5d0: 0x100c5d0: lui   v1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x0100c5d4: 0x100c5d4: lw    v1, 31564(v1)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0100c5f4: 0x100c5f4: lui   v1, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100c5f8: 0x100c5f8: lw    a0, 31564(v1)
	ldloc 8
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100c6ac: 0x100c6ac: lui   v1, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100c6b0: 0x100c6b0: lw    v1, 31564(v1)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100c728: 0x100c728: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100c72c: 0x100c72c: lw    v0, 31564(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100c800: 0x100c800: lui   s1, 0x20000
	ldc.i4 131072
	stloc 11
// 0x0100c804: 0x100c804: lw    v0, 31564(s1)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0100c82c: 0x100c82c: lui   a3, 0x15750000
	ldc.i4 359989248
	stloc 4
// 0x0100c830: 0x100c830: sw    v0, 31564(s1)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x0100c8dc: 0x100c8dc: lui   v1, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100c8e0: 0x100c8e0: lw    a1, 31564(v1)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
