...
// 0x0100b480: 0x100b480: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b484: 0x100b484: lw    v1, 30632(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b4dc: 0x100b4dc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b4e0: 0x100b4e0: lw    v0, 30640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b518: 0x100b518: lui   v0, 0x20000
	...
	stloc 5
L_100b51c:
// 0x0100b51c: 0x100b51c: lw    v1, 30640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b564: 0x100b564: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b568: 0x100b568: lw    v1, 30640(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100b5a4:
// 0x0100b5a4: 0x100b5a4: lw    v1, 30640(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b5ec: 0x100b5ec: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b5f0: 0x100b5f0: lw    v1, 30640(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100b62c:
// 0x0100b62c: 0x100b62c: lw    v1, 30640(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b67c: 0x100b67c: lui   s0, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100b680: 0x100b680: lw    v0, 30640(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100b6a8: 0x100b6a8: bltz  v0, 0x100b6d4 sll   v0, v0, 2
	...
	blt L_100b6d4
// --- basic block ---
// 0x0100b6b0: 0x100b6b0: lw    v1, 30640(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100b888: 0x100b888: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100b88c: 0x100b88c: lw    v1, 30640(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100b8b4: 0x100b8b4: lui   v1, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100b8b8: 0x100b8b8: lw    a0, 30644(v1)
	ldloc 8
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100b954: 0x100b954: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100b958: 0x100b958: lw    s0, 30644(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100b968: 0x100b968: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100b96c: 0x100b96c: lw    a0, 30644(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100b9a0: 0x100b9a0: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0100b9a4: 0x100b9a4: addiu v1, v1, -28524
	ldloc 5
	ldc.i4 -28524
	add
	stloc 5
...
// 0x0100ba10: 0x100ba10: lui   v0, 0xe0000
	...
	stloc 6
L_100ba14:
// 0x0100ba14: 0x100ba14: addiu v0, v0, -28524
	ldloc 6
	ldc.i4 -28524
	add
	stloc 6
...
// 0x0100ba88: 0x100ba88: lui   v1, 0xe0000
	...
	stloc 5
L_100ba8c:
// 0x0100ba8c: 0x100ba8c: addiu v1, v1, -28524
	ldloc 5
	ldc.i4 -28524
	add
	stloc 5
...
// 0x0100baf8: 0x100baf8: lui   v0, 0xe0000
	...
	stloc 6
L_100bafc:
// 0x0100bafc: 0x100bafc: addiu v0, v0, -28524
	ldloc 6
	ldc.i4 -28524
	add
	stloc 6
...
// 0x0100bb70: 0x100bb70: lui   a0, 0xe0000
	...
	stloc.1
L_100bb74:
// 0x0100bb74: 0x100bb74: addiu a0, a0, -28524
	ldloc.1
	ldc.i4 -28524
	add
	stloc.1
...
// 0x0100bbe4: 0x100bbe4: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0100bbe8: 0x100bbe8: addiu v1, v1, -28524
	ldloc 5
	ldc.i4 -28524
	add
	stloc 5
...
// 0x0100bc60: 0x100bc60: lui   v1, 0xe0000
	...
	stloc 5
L_100bc64:
// 0x0100bc64: 0x100bc64: addiu v1, v1, -28524
	ldloc 5
	ldc.i4 -28524
	add
	stloc 5
...
// 0x0100bcd8: 0x100bcd8: lui   v1, 0xe0000
	...
	stloc 5
L_100bcdc:
// 0x0100bcdc: 0x100bcdc: addiu v1, v1, -28524
	ldloc 5
	ldc.i4 -28524
	add
	stloc 5
...
// 0x0100bdac: 0x100bdac: bne   v0, v1, 0x100ba78 lui   v1, 0xe0000
	...
	bne.un L_100ba78
// --- basic block ---
// 0x0100bdb4: 0x100bdb4: j	 0x100ba90 addiu v1, v1, -28524
	ldloc 5
	ldc.i4 -28524
	add
	stloc 5
...
// 0x0100be1c: 0x100be1c: bne   v0, v1, 0x100bbd4 lui   v1, 0xe0000
	...
	bne.un L_100bbd4
// --- basic block ---
// 0x0100be24: 0x100be24: j	 0x100bbec addiu v1, v1, -28524
	ldloc 5
	ldc.i4 -28524
	add
	stloc 5
...
// 0x0100be40: 0x100be40: bne   v0, v1, 0x100bc50 lui   v1, 0xe0000
	...
	bne.un L_100bc50
// --- basic block ---
// 0x0100be48: 0x100be48: j	 0x100bc68 addiu v1, v1, -28524
	ldloc 5
	ldc.i4 -28524
	add
	stloc 5
...
// 0x0100be64: 0x100be64: bne   v0, v1, 0x100bcc8 lui   v1, 0xe0000
	...
	bne.un L_100bcc8
// --- basic block ---
// 0x0100be6c: 0x100be6c: j	 0x100bce0 addiu v1, v1, -28524
	ldloc 5
	ldc.i4 -28524
	add
	stloc 5
...
// 0x0100be94: 0x100be94: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100be98: 0x100be98: lw    v0, 30640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100bee4: 0x100bee4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100bee8: 0x100bee8: lw    a0, 30644(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100bf20: 0x100bf20: lui   v0, 0x20000
	...
	stloc 5
L_100bf24:
// 0x0100bf24: 0x100bf24: lw    a0, 30644(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100bf50: 0x100bf50: lw    a1, 24(sp)
	...
	ldelem.i4
	stloc.2
// 0x0100bf54: 0x100bf54: addiu s3, s3, -28524
	ldloc 11
	ldc.i4 -28524
	add
	stloc 11
...
// --- basic block ---
L_100bfb0:
// 0x0100bfb0: 0x100bfb0: lw    a0, 30644(a3)
	ldloc 6
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0100c11c: 0x100c11c: lui   a0, 0xe0000
	ldc.i4 917504
	stloc.1
// 0x0100c120: 0x100c120: lw    v1, -22660(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_100c1bc:
// 0x0100c1bc: 0x100c1bc: lw    v0, 30648(a3)
	ldloc 6
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x0100c2b4: 0x100c2b4: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100c2b8: 0x100c2b8: lw    s0, 30644(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100c3dc: 0x100c3dc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100c3e0: 0x100c3e0: sw    zero, 30648(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100c43c: 0x100c43c: lui   s1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x0100c440: 0x100c440: lw    v0, 30640(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100c44c: 0x100c44c: jal   0x10158b8 sll   s0, s0, 2
	...
	stloc 6
// --- basic block ---
// 0x0100c454: 0x100c454: lw    v0, 30640(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100c55c: 0x100c55c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100c560: 0x100c560: lw    v0, 30640(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100c738: 0x100c738: lui   v1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x0100c73c: 0x100c73c: lw    v1, 30652(v1)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0100c764: 0x100c764: lui   v1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x0100c768: 0x100c768: lw    v1, 30652(v1)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0100c788: 0x100c788: lui   v1, 0x20000
	ldc.i4 131072
	stloc 6
// 0x0100c78c: 0x100c78c: lw    a0, 30652(v1)
	ldloc 8
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100c840: 0x100c840: lui   v1, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100c844: 0x100c844: lw    v1, 30652(v1)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
