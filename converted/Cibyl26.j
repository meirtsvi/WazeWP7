...
// 0x01022ec4: 0x1022ec4: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x01022ec8: 0x1022ec8: addiu v1, v1, -30440
	ldloc 7
	ldc.i4 -30440
	add
	stloc 7
// 0x01022ecc: 0x1022ecc: addiu a3, a3, 28804
	ldloc 4
	ldc.i4 28804
	add
	stloc 4
...
// 0x01022f24: 0x1022f24: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01022f28: 0x1022f28: lw    v0, 28452(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01022f30: 0x1022f30: bne   v0, zero, 0x1022ff4 lui   v0, 0x30000
	...
	brtrue L_1022ff4
// --- basic block ---
// 0x01022f38: 0x1022f38: lw    v0, 28676(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01022f40: 0x1022f40: beq   v0, zero, 0x1022ff4 lui   v0, 0x30000
	...
	brfalse L_1022ff4
// --- basic block ---
// 0x01022f48: 0x1022f48: lw    v0, 28480(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1022f70:
// 0x01022f70: 0x1022f70: lw    v0, 28672(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01022f88: 0x1022f88: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x01022f8c: 0x1022f8c: lw    v0, -30056(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01022f98: 0x1022f98: lui   v1, 0xf0000
	ldc.i4 983040
	stloc 7
// 0x01022f9c: 0x1022f9c: lw    a1, -30052(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01023018: 0x1023018: sw    s2, 152(sp)
	...
	ldloc 12
	stelem.i4
// 0x0102301c: 0x102301c: addiu s0, a0, 29620
	ldloc.1
	ldc.i4 29620
	add
	stloc 9
...
// --- basic block ---
L_1023040:
// 0x01023040: 0x1023040: lw    v1, 31376(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01023064: 0x1023064: sra   v0, v0, 16
	...
	shr
	stloc 5
// 0x01023068: 0x1023068: lw    a1, 31464(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0102308c: 0x102308c: sra   a0, v0, 16
	...
	shr
	stloc.1
// 0x01023090: 0x1023090: lw    v1, 31452(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x010230cc: 0x10230cc: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x010230d0: 0x10230d0: lw    s5, 31472(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01023100: 0x1023100: beq   v0, zero, 0x10237ac sll   zero, zero, 0
	...
	brfalse L_10237ac
// --- basic block ---
// 0x01023108: 0x1023108: jal   0x10bdabc sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01023140: 0x1023140: addiu v0, v0, 3
	...
	add
	stloc 5
// 0x01023144: 0x1023144: lw    v1, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x0102314c: 0x102314c: addu  v0, v1, v0
	...
	add
	stloc 5
// 0x01023150: 0x1023150: addiu a0, a0, -20376
	ldloc.1
	ldc.i4 -20376
	add
	stloc.1
...
// 0x010231a4: 0x10231a4: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x010231a8: 0x10231a8: lw    v0, 31464(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01023244: 0x1023244: beq   t0, zero, 0x10233dc addu  v0, a3, zero
	...
	brfalse L_10233dc
// --- basic block ---
// 0x0102324c: 0x102324c: lw    v0, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023260: 0x1023260: bne   a2, zero, 0x1023284 sra   a1, a1, 3
	...
	brtrue L_1023284
// --- basic block ---
// 0x01023268: 0x1023268: lw    v0, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023274: 0x1023274: sw    a1, 0(v0)
	...
	ldloc.2
	stelem.i4
// 0x01023278: 0x1023278: sw    a0, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldloc.1
	stelem.i4
// 0x0102327c: 0x102327c: j	 0x1023288 sw    a2, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023404: 0x1023404: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 7
// 0x01023408: 0x1023408: addiu v1, v1, 29620
	ldloc 7
	ldc.i4 29620
	add
	stloc 7
...
// 0x01023480: 0x1023480: beq   t0, zero, 0x102377c addiu a0, sp, 48
	...
	brfalse L_102377c
// --- basic block ---
// 0x01023488: 0x1023488: lw    v0, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x0102349c: 0x102349c: bne   a1, zero, 0x10234c0 sra   a0, a0, 3
	...
	brtrue L_10234c0
// --- basic block ---
// 0x010234a4: 0x10234a4: lw    v0, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x010234b0: 0x10234b0: sw    a0, 0(v0)
	...
	ldloc.1
	stelem.i4
// 0x010234b4: 0x10234b4: sw    v1, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldloc 7
	stelem.i4
// 0x010234b8: 0x10234b8: j	 0x1023778 sw    a1, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023518: 0x1023518: lw    t0, 6204(s2)
	...
	ldelem.i4
	stloc 13
// 0x0102351c: 0x102351c: lw    a0, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023520: 0x1023520: addiu a1, t0, 8
	...
	add
	stloc.2
// 0x01023524: 0x1023524: lw    v0, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023528: 0x1023528: subu  a0, a1, a0
	...
	sub
	stloc.1
// 0x0102352c: 0x102352c: sw    a1, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023534: 0x1023534: addiu a2, v0, 4
	...
	add
	stloc.3
// 0x01023538: 0x1023538: sw    a2, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10235fc:
// 0x010235fc: 0x10235fc: lw    v0, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023600: 0x1023600: lui   v1, 0x40000
	ldc.i4 262144
	stloc 7
// 0x01023604: 0x1023604: addiu v1, v1, -20376
	ldloc 7
	ldc.i4 -20376
	add
	stloc 7
...
// 0x01023754: 0x1023754: lw    v0, 6204(s2)
	...
	ldelem.i4
	stloc 5
// 0x01023758: 0x1023758: lw    a1, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x0102375c: 0x102375c: lw    v1, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x0102376c: 0x102376c: sw    a1, 0(v1)
	...
	ldloc.2
	stelem.i4
// 0x01023770: 0x1023770: sw    v0, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldloc 5
	stelem.i4
// 0x01023774: 0x1023774: sw    a0, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x010237c0: 0x10237c0: lw    a0, 140(sp)
	...
	ldelem.i4
	stloc.1
// 0x010237c4: 0x10237c4: lw    v1, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x010237d4: 0x10237d4: addu  v0, v1, v0
	...
	add
	stloc 5
// 0x010237d8: 0x10237d8: addiu a1, a1, -20376
	ldloc.2
	ldc.i4 -20376
	add
	stloc.2
...
// --- basic block ---
L_1023824:
// 0x01023824: 0x1023824: lw    v0, 31464(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010238c0: 0x10238c0: beq   t0, zero, 0x1023a50 addu  v0, a3, zero
	...
	brfalse L_1023a50
// --- basic block ---
// 0x010238c8: 0x10238c8: lw    v0, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x010238dc: 0x10238dc: bne   a1, zero, 0x1023900 sra   a0, a0, 3
	...
	brtrue L_1023900
// --- basic block ---
// 0x010238e4: 0x10238e4: lw    v0, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x010238f0: 0x10238f0: sw    a0, 0(v0)
	...
	ldloc.1
	stelem.i4
// 0x010238f4: 0x10238f4: sw    v1, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldloc 7
	stelem.i4
// 0x010238f8: 0x10238f8: j	 0x1023904 sw    a1, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023a78: 0x1023a78: lui   a0, 0xe0000
	ldc.i4 917504
	stloc.1
// 0x01023a7c: 0x1023a7c: addiu a0, a0, 29620
	ldloc.1
	ldc.i4 29620
	add
	stloc.1
...
// 0x01023af4: 0x1023af4: beq   t0, zero, 0x1023de4 sll   zero, zero, 0
	...
	brfalse L_1023de4
// --- basic block ---
// 0x01023afc: 0x1023afc: lw    v0, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023b10: 0x1023b10: bne   a1, zero, 0x1023b34 sra   a0, a0, 3
	...
	brtrue L_1023b34
// --- basic block ---
// 0x01023b18: 0x1023b18: lw    v0, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023b24: 0x1023b24: sw    a0, 0(v0)
	...
	ldloc.1
	stelem.i4
// 0x01023b28: 0x1023b28: sw    v1, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldloc 7
	stelem.i4
// 0x01023b2c: 0x1023b2c: j	 0x1023de4 sw    a1, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023b8c: 0x1023b8c: lw    t0, 6204(s2)
	...
	ldelem.i4
	stloc 13
// 0x01023b90: 0x1023b90: lw    a0, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023b94: 0x1023b94: addiu a1, t0, 8
	...
	add
	stloc.2
// 0x01023b98: 0x1023b98: lw    v0, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023b9c: 0x1023b9c: subu  a0, a1, a0
	...
	sub
	stloc.1
// 0x01023ba0: 0x1023ba0: sw    a1, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023ba8: 0x1023ba8: addiu a2, v0, 4
	...
	add
	stloc.3
// 0x01023bac: 0x1023bac: sw    a2, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1023c68:
// 0x01023c68: 0x1023c68: lw    v0, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023c6c: 0x1023c6c: lui   v1, 0x40000
	ldc.i4 262144
	stloc 7
// 0x01023c70: 0x1023c70: addiu v1, v1, -20376
	ldloc 7
	ldc.i4 -20376
	add
	stloc 7
...
// 0x01023dc0: 0x1023dc0: lw    v0, 6204(s2)
	...
	ldelem.i4
	stloc 5
// 0x01023dc4: 0x1023dc4: lw    a1, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01023dc8: 0x1023dc8: lw    v1, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023dd8: 0x1023dd8: sw    a1, 0(v1)
	...
	ldloc.2
	stelem.i4
// 0x01023ddc: 0x1023ddc: sw    v0, -20388(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldloc 5
	stelem.i4
// 0x01023de0: 0x1023de0: sw    a0, 28756(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023e5c: 0x1023e5c: lui   a0, 0xe0000
	ldc.i4 917504
	stloc.1
// 0x01023e60: 0x1023e60: lw    v0, 29744(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01023e78: 0x1023e78: beq   v1, zero, 0x1023f94 lui   v1, 0xe0000
	...
	brfalse L_1023f94
// --- basic block ---
// 0x01023e80: 0x1023e80: lw    a0, 29620(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01023ea0: 0x1023ea0: bne   a0, v1, 0x1023eb8 lui   v1, 0x30000
	...
	bne.un L_1023eb8
// --- basic block ---
// 0x01023ea8: 0x1023ea8: lw    v1, 28452(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01023ed8: 0x1023ed8: lw    v1, 156(sp)
	...
	ldelem.i4
	stloc 7
// 0x01023edc: 0x1023edc: lw    v0, 29744(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01023ef0: 0x1023ef0: beq   v1, zero, 0x1023f94 lui   a1, 0xe0000
	...
	brfalse L_1023f94
// --- basic block ---
// 0x01023ef8: 0x1023ef8: lw    a0, 29620(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01023f3c: 0x1023f3c: bne   v0, zero, 0x1023f94 lui   v1, 0xe0000
	...
	brtrue L_1023f94
// --- basic block ---
// 0x01023f44: 0x1023f44: lw    v0, 29744(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01023f64: 0x1023f64: lw    v0, 28(v0)
	...
	ldelem.i4
	stloc 5
// 0x01023f68: 0x1023f68: lw    v1, 29620(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01023f84: 0x1023f84: beq   v1, v0, 0x1023f94 addiu a0, sp, 64
	...
	beq  L_1023f94
// --- basic block ---
// 0x01023f8c: 0x1023f8c: jal   0x10bff74 addu  a1, s1, zero
	ldloc 10
	stloc.2
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl142::roadmap_label_add_10bff74(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
