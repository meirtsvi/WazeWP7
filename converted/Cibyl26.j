...
// 0x01023100: 0x1023100: beq   v0, zero, 0x10237ac sll   zero, zero, 0
	...
	brfalse L_10237ac
// --- basic block ---
// 0x01023108: 0x1023108: jal   0x10bd868 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01023f84: 0x1023f84: beq   v1, v0, 0x1023f94 addiu a0, sp, 64
	...
	beq  L_1023f94
// --- basic block ---
// 0x01023f8c: 0x1023f8c: jal   0x10bfd20 addu  a1, s1, zero
	ldloc 10
	stloc.2
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl142::roadmap_label_add_10bfd20(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
