...
// 0x01022f14: 0x1022f14: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x01022f18: 0x1022f18: addiu v1, v1, -30852
	ldloc 7
	ldc.i4 -30852
	add
	stloc 7
// 0x01022f1c: 0x1022f1c: addiu a3, a3, 28392
	ldloc 4
	ldc.i4 28392
	add
	stloc 4
...
// 0x01022f74: 0x1022f74: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01022f78: 0x1022f78: lw    v0, 28040(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01022f80: 0x1022f80: bne   v0, zero, 0x1023044 lui   v0, 0x30000
	...
	brtrue L_1023044
// --- basic block ---
// 0x01022f88: 0x1022f88: lw    v0, 28264(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01022f90: 0x1022f90: beq   v0, zero, 0x1023044 lui   v0, 0x30000
	...
	brfalse L_1023044
// --- basic block ---
// 0x01022f98: 0x1022f98: lw    v0, 28068(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1022fc0:
// 0x01022fc0: 0x1022fc0: lw    v0, 28260(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1022fd8:
// 0x01022fd8: 0x1022fd8: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x01022fdc: 0x1022fdc: lw    v0, -8904(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01022fe4: 0x1022fe4: div   v0, a2
	...
	div
	stloc 8
// 0x01022fe8: 0x1022fe8: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 7
// 0x01022fec: 0x1022fec: lw    a1, -8900(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01023068: 0x1023068: sw    s2, 152(sp)
	...
	ldloc 12
	stelem.i4
// 0x0102306c: 0x102306c: addiu s0, a0, -14764
	ldloc.1
	ldc.i4 -14764
	add
	stloc 9
...
// --- basic block ---
L_1023090:
// 0x01023090: 0x1023090: lw    v1, 30960(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010230b4: 0x10230b4: sra   v0, v0, 16
	...
	shr
	stloc 5
// 0x010230b8: 0x10230b8: lw    a1, 31052(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010230dc: 0x10230dc: sra   a0, v0, 16
	...
	shr
	stloc.1
// 0x010230e0: 0x10230e0: lw    v1, 31040(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0102311c: 0x102311c: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01023120: 0x1023120: lw    s5, 31060(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01023150: 0x1023150: beq   v0, zero, 0x10237fc sll   zero, zero, 0
	...
	brfalse L_10237fc
// --- basic block ---
// 0x01023158: 0x1023158: jal   0x10bd2b8 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01023190: 0x1023190: addiu v0, v0, 3
	...
	add
	stloc 5
// 0x01023194: 0x1023194: lw    v1, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x0102319c: 0x102319c: addu  v0, v1, v0
	...
	add
	stloc 5
// 0x010231a0: 0x10231a0: addiu a0, a0, -20788
	ldloc.1
	ldc.i4 -20788
	add
	stloc.1
...
// 0x010231f4: 0x10231f4: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x010231f8: 0x10231f8: lw    v0, 31052(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01023294: 0x1023294: beq   t0, zero, 0x102342c addu  v0, a3, zero
	...
	brfalse L_102342c
// --- basic block ---
// 0x0102329c: 0x102329c: lw    v0, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x010232b0: 0x10232b0: bne   a2, zero, 0x10232d4 sra   a1, a1, 3
	...
	brtrue L_10232d4
// --- basic block ---
// 0x010232b8: 0x10232b8: lw    v0, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x010232c4: 0x10232c4: sw    a1, 0(v0)
	...
	ldloc.2
	stelem.i4
// 0x010232c8: 0x10232c8: sw    a0, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldloc.1
	stelem.i4
// 0x010232cc: 0x10232cc: j	 0x10232d8 sw    a2, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023454: 0x1023454: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 7
// 0x01023458: 0x1023458: addiu v1, v1, -14764
	ldloc 7
	ldc.i4 -14764
	add
	stloc 7
...
// 0x010234d0: 0x10234d0: beq   t0, zero, 0x10237cc addiu a0, sp, 48
	...
	brfalse L_10237cc
// --- basic block ---
// 0x010234d8: 0x10234d8: lw    v0, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x010234ec: 0x10234ec: bne   a1, zero, 0x1023510 sra   a0, a0, 3
	...
	brtrue L_1023510
// --- basic block ---
// 0x010234f4: 0x10234f4: lw    v0, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023500: 0x1023500: sw    a0, 0(v0)
	...
	ldloc.1
	stelem.i4
// 0x01023504: 0x1023504: sw    v1, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldloc 7
	stelem.i4
// 0x01023508: 0x1023508: j	 0x10237c8 sw    a1, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023568: 0x1023568: lw    t0, 6204(s2)
	...
	ldelem.i4
	stloc 13
// 0x0102356c: 0x102356c: lw    a0, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023570: 0x1023570: addiu a1, t0, 8
	...
	add
	stloc.2
// 0x01023574: 0x1023574: lw    v0, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023578: 0x1023578: subu  a0, a1, a0
	...
	sub
	stloc.1
// 0x0102357c: 0x102357c: sw    a1, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023584: 0x1023584: addiu a2, v0, 4
	...
	add
	stloc.3
// 0x01023588: 0x1023588: sw    a2, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_102364c:
// 0x0102364c: 0x102364c: lw    v0, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023650: 0x1023650: lui   v1, 0x40000
	ldc.i4 262144
	stloc 7
// 0x01023654: 0x1023654: addiu v1, v1, -20788
	ldloc 7
	ldc.i4 -20788
	add
	stloc 7
...
// 0x010237a4: 0x10237a4: lw    v0, 6204(s2)
	...
	ldelem.i4
	stloc 5
// 0x010237a8: 0x10237a8: lw    a1, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x010237ac: 0x10237ac: lw    v1, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x010237bc: 0x10237bc: sw    a1, 0(v1)
	...
	ldloc.2
	stelem.i4
// 0x010237c0: 0x10237c0: sw    v0, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldloc 5
	stelem.i4
// 0x010237c4: 0x10237c4: sw    a0, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x010237d0: 0x10237d0: lui   v1, 0x10000
	ldc.i4 65536
	stloc 7
// 0x010237d4: 0x10237d4: addiu v1, v1, -29260
	ldloc 7
	ldc.i4 -29260
	add
	stloc 7
...
// 0x01023810: 0x1023810: lw    a0, 140(sp)
	...
	ldelem.i4
	stloc.1
// 0x01023814: 0x1023814: lw    v1, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023824: 0x1023824: addu  v0, v1, v0
	...
	add
	stloc 5
// 0x01023828: 0x1023828: addiu a1, a1, -20788
	ldloc.2
	ldc.i4 -20788
	add
	stloc.2
...
// --- basic block ---
L_1023874:
// 0x01023874: 0x1023874: lw    v0, 31052(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01023910: 0x1023910: beq   t0, zero, 0x1023aa0 addu  v0, a3, zero
	...
	brfalse L_1023aa0
// --- basic block ---
// 0x01023918: 0x1023918: lw    v0, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x0102392c: 0x102392c: bne   a1, zero, 0x1023950 sra   a0, a0, 3
	...
	brtrue L_1023950
// --- basic block ---
// 0x01023934: 0x1023934: lw    v0, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023940: 0x1023940: sw    a0, 0(v0)
	...
	ldloc.1
	stelem.i4
// 0x01023944: 0x1023944: sw    v1, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldloc 7
	stelem.i4
// 0x01023948: 0x1023948: j	 0x1023954 sw    a1, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023ac8: 0x1023ac8: lui   a0, 0xe0000
	ldc.i4 917504
	stloc.1
// 0x01023acc: 0x1023acc: addiu a0, a0, -14764
	ldloc.1
	ldc.i4 -14764
	add
	stloc.1
...
// 0x01023b44: 0x1023b44: beq   t0, zero, 0x1023e34 sll   zero, zero, 0
	...
	brfalse L_1023e34
// --- basic block ---
// 0x01023b4c: 0x1023b4c: lw    v0, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023b60: 0x1023b60: bne   a1, zero, 0x1023b84 sra   a0, a0, 3
	...
	brtrue L_1023b84
// --- basic block ---
// 0x01023b68: 0x1023b68: lw    v0, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023b74: 0x1023b74: sw    a0, 0(v0)
	...
	ldloc.1
	stelem.i4
// 0x01023b78: 0x1023b78: sw    v1, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldloc 7
	stelem.i4
// 0x01023b7c: 0x1023b7c: j	 0x1023e34 sw    a1, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023bdc: 0x1023bdc: lw    t0, 6204(s2)
	...
	ldelem.i4
	stloc 13
// 0x01023be0: 0x1023be0: lw    a0, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023be4: 0x1023be4: addiu a1, t0, 8
	...
	add
	stloc.2
// 0x01023be8: 0x1023be8: lw    v0, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023bec: 0x1023bec: subu  a0, a1, a0
	...
	sub
	stloc.1
// 0x01023bf0: 0x1023bf0: sw    a1, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023bf8: 0x1023bf8: addiu a2, v0, 4
	...
	add
	stloc.3
// 0x01023bfc: 0x1023bfc: sw    a2, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1023cb8:
// 0x01023cb8: 0x1023cb8: lw    v0, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01023cbc: 0x1023cbc: lui   v1, 0x40000
	ldc.i4 262144
	stloc 7
// 0x01023cc0: 0x1023cc0: addiu v1, v1, -20788
	ldloc 7
	ldc.i4 -20788
	add
	stloc 7
...
// 0x01023e10: 0x1023e10: lw    v0, 6204(s2)
	...
	ldelem.i4
	stloc 5
// 0x01023e14: 0x1023e14: lw    a1, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01023e18: 0x1023e18: lw    v1, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023e28: 0x1023e28: sw    a1, 0(v1)
	...
	ldloc.2
	stelem.i4
// 0x01023e2c: 0x1023e2c: sw    v0, -20800(s3)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
	...
	ldloc 5
	stelem.i4
// 0x01023e30: 0x1023e30: sw    a0, 28344(s4)
	ldloc 6
	ldloc 19
	ldc.i4.2
	shr.un
...
// 0x01023eac: 0x1023eac: lui   a0, 0xe0000
	ldc.i4 917504
	stloc.1
// 0x01023eb0: 0x1023eb0: lw    v0, -14640(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01023ec8: 0x1023ec8: beq   v1, zero, 0x1023fe4 lui   v1, 0xe0000
	...
	brfalse L_1023fe4
// --- basic block ---
// 0x01023ed0: 0x1023ed0: lw    a0, -14764(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01023ef0: 0x1023ef0: bne   a0, v1, 0x1023f08 lui   v1, 0x30000
	...
	bne.un L_1023f08
// --- basic block ---
// 0x01023ef8: 0x1023ef8: lw    v1, 28040(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01023f28: 0x1023f28: lw    v1, 156(sp)
	...
	ldelem.i4
	stloc 7
// 0x01023f2c: 0x1023f2c: lw    v0, -14640(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01023f40: 0x1023f40: beq   v1, zero, 0x1023fe4 lui   a1, 0xe0000
	...
	brfalse L_1023fe4
// --- basic block ---
// 0x01023f48: 0x1023f48: lw    a0, -14764(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01023f78: 0x1023f78: beq   a0, zero, 0x1023fe4 sll   zero, zero, 0
	...
	brfalse L_1023fe4
// --- basic block ---
// 0x01023f80: 0x1023f80: jal   0x104df84 sll   zero, zero, 0
	ldloc.1
...
// 0x01023f8c: 0x1023f8c: bne   v0, zero, 0x1023fe4 lui   v1, 0xe0000
	...
	brtrue L_1023fe4
// --- basic block ---
// 0x01023f94: 0x1023f94: lw    v0, -14640(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01023fb4: 0x1023fb4: lw    v0, 28(v0)
	...
	ldelem.i4
	stloc 5
// 0x01023fb8: 0x1023fb8: lw    v1, -14764(a1)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x01023fd4: 0x1023fd4: beq   v1, v0, 0x1023fe4 addiu a0, sp, 64
	...
	beq  L_1023fe4
// --- basic block ---
// 0x01023fdc: 0x1023fdc: jal   0x10bfef0 addu  a1, s1, zero
	ldloc 10
	stloc.2
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl143::roadmap_label_add_10bfef0(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
