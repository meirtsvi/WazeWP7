...
// 0x010a2dac: 0x10a2dac: lui   v0, 0x80000
	ldc.i4 524288
	stloc 6
// 0x010a2db0: 0x10a2db0: lw    v0, 27608(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a2e08: 0x10a2e08: lui   v0, 0x80000
	ldc.i4 524288
	stloc 6
// 0x010a2e0c: 0x10a2e0c: lw    v0, 27616(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a2fa8: 0x10a2fa8: addiu s6, sp, 24
	...
	add
	stloc 14
// 0x010a2fac: 0x10a2fac: addiu a1, a1, 29852
	ldloc.2
	ldc.i4 29852
	add
	stloc.2
...
// 0x010a3850: 0x10a3850: jal   0x10947cc lui   s0, 0x80000
	...
	stloc 5
// --- basic block ---
// 0x010a3858: 0x10a3858: lw    v0, 30820(s0)
	ldloc 8
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010a3868: 0x10a3868: jalr  v0 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x010a3870: 0x10a3870: sw    zero, 30820(s0)
	ldloc 8
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010a38d0: 0x10a38d0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010a38d4: 0x10a38d4: lw    v0, 30828(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10a3b6c:
// 0x010a3b6c: 0x10a3b6c: jal   0x10a392c sw    s0, 30828(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a3cb8: 0x10a3cb8: sw    s7, 112(sp)
	...
	ldloc 12
	stelem.i4
// 0x010a3cbc: 0x10a3cbc: lw    s0, -29908(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a3f4c: 0x10a3f4c: sw    s6, 64(sp)
	...
	ldloc 12
	stelem.i4
// 0x010a3f50: 0x10a3f50: lw    s6, -29908(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
