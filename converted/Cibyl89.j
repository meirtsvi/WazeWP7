...
// 0x01076c9c: 0x1076c9c: sw    s1, 40(sp)
	...
	ldloc 10
	stelem.i4
// 0x01076ca0: 0x1076ca0: jal   0x10a7048 addu  s0, a0, zero
	ldloc.1
	stloc 9
	ldloc.0
	ldloc.1
...
// 0x01076f70: 0x1076f70: lw    a2, 28(v0)
	...
	ldelem.i4
	stloc.3
// 0x01076f74: 0x1076f74: jal   0x10a1a90 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01076fdc: 0x1076fdc: sw    zero, 20(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01076fe0: 0x1076fe0: jal   0x10a2dd0 sw    zero, 28(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01077054: 0x1077054: lw    a0, 16(s0)
	...
	ldelem.i4
	stloc.1
// 0x01077058: 0x1077058: jal   0x10acc48 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01077148: 0x1077148: lw    v1, 24(sp)
	...
	ldelem.i4
	stloc 7
// 0x0107714c: 0x107714c: jal   0x10a7048 sw    v1, 20(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01077190: 0x1077190: addiu a0, zero, 1
	ldc.i4.1
	stloc.1
// 0x01077194: 0x1077194: jal   0x10a1a90 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
