...
// 0x0105c7d4: 0x105c7d4: addiu a0, s2, 11008
	...
	add
	stloc.1
// 0x0105c7d8: 0x105c7d8: jal   0x1096064 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0105c838: 0x105c838: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x0105c83c: 0x105c83c: jal   0x1099158 addu  s0, v0, zero
	ldloc 5
	stloc 8
	ldloc.1
	ldloc.2
...
// 0x0105c85c: 0x105c85c: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x0105c860: 0x105c860: jal   0x1098e88 addiu a0, s4, 9172
	ldloc 13
	ldc.i4 9172
	add
	stloc.1
...
// 0x0105c870: 0x105c870: addiu a1, s3, 23008
	...
	add
	stloc.2
// 0x0105c874: 0x105c874: jal   0x1097c70 sw    v0, 112(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0105c880: 0x105c880: addu  a0, s0, zero
	ldloc 8
	stloc.1
// 0x0105c884: 0x105c884: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0105c898: 0x105c898: addiu a1, a1, 22896
	...
	add
	stloc.2
// 0x0105c89c: 0x105c89c: jal   0x1098e88 addiu a0, s4, 9172
	ldloc 13
	ldc.i4 9172
	add
	stloc.1
...
// 0x0105c8a8: 0x105c8a8: addiu a1, s3, 23008
	...
	add
	stloc.2
// 0x0105c8ac: 0x105c8ac: jal   0x1097c70 sw    v0, 112(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0105c8b8: 0x105c8b8: addu  a0, s0, zero
	ldloc 8
	stloc.1
// 0x0105c8bc: 0x105c8bc: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0105c8d4: 0x105c8d4: addiu a1, a1, 18656
	...
	add
	stloc.2
// 0x0105c8d8: 0x105c8d8: jal   0x1098e88 addiu a0, a0, 11380
	ldloc.1
	ldc.i4 11380
	add
	stloc.1
...
// 0x0105c8e4: 0x105c8e4: addiu a1, s3, 23008
	...
	add
	stloc.2
// 0x0105c8e8: 0x105c8e8: jal   0x1097c70 sw    v0, 112(sp)
	ldloc 7
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0105c8f4: 0x105c8f4: addu  a0, s0, zero
	ldloc 8
	stloc.1
// 0x0105c8f8: 0x105c8f8: jal   0x109903c addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0105c900: 0x105c900: addu  a0, s1, zero
	ldloc 9
	stloc.1
// 0x0105c904: 0x105c904: jal   0x109903c addu  a1, s0, zero
	ldloc 8
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x0105c90c: 0x105c90c: addiu a0, s2, 11008
	...
	add
	stloc.1
// 0x0105c910: 0x105c910: jal   0x1096064 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0105c92c: 0x105c92c: addiu a1, a1, 11380
	...
	add
	stloc.2
// 0x0105c930: 0x105c930: jal   0x109b558 addiu a2, a2, -24
	ldloc.3
	ldc.i4.s -24
	add
	stloc.3
