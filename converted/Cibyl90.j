...
// 0x01077ec8: 0x1077ec8: lui   v0, 0x80000
	ldc.i4 524288
	stloc.0
// 0x01077ecc: 0x1077ecc: sw    v1, -16088(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01077ee0: 0x1077ee0: lui   v0, 0x80000
	ldc.i4 524288
	stloc.0
// 0x01077ee4: 0x1077ee4: lw    v1, -13864(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01077f70: 0x1077f70: beq   v0, v1, 0x1077fbc lui   v0, 0x80000
	...
	beq  L_1077fbc
// --- basic block ---
// 0x01077f78: 0x1077f78: addiu v0, v0, -15868
	ldloc 5
	ldc.i4 -15868
	add
	stloc 5
...
// 0x01077fe0: 0x1077fe0: bne   v0, zero, 0x1078000 lui   a1, 0x20000
	...
	brtrue L_1078000
// --- basic block ---
// 0x01077fe8: 0x1077fe8: jal   0x109b47c addiu a1, a1, -26912
	ldloc.2
	ldc.i4 -26912
	add
	stloc.2
	...
	stloc 5
// --- basic block ---
// 0x01077ff0: 0x1077ff0: jal   0x1099210 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
...
// --- basic block ---
L_1078000:
// 0x01078000: 0x1078000: jal   0x109b47c addiu a1, a1, -26912
	ldloc.2
	ldc.i4 -26912
	add
	stloc.2
	...
	stloc 5
// --- basic block ---
// 0x01078008: 0x1078008: jal   0x1099224 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
...
// 0x010781bc: 0x10781bc: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010781c0: 0x10781c0: addiu v0, v0, -15868
	ldloc 5
	ldc.i4 -15868
	add
	stloc 5
...
// 0x010781d8: 0x10781d8: lui   s0, 0x80000
	ldc.i4 524288
	stloc 7
// 0x010781dc: 0x10781dc: addiu a0, s0, -15916
	ldloc 7
	ldc.i4 -15916
	add
	stloc.1
...
// 0x010781f8: 0x10781f8: addiu v0, s0, -15916
	ldloc 7
	ldc.i4 -15916
	add
	stloc 5
...
// 0x01078208: 0x1078208: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0107820c: 0x107820c: addiu v0, v0, -15868
	ldloc 5
	ldc.i4 -15868
	add
	stloc 5
...
// 0x01078224: 0x1078224: lui   s0, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01078228: 0x1078228: addiu a0, s0, -15896
	ldloc 7
	ldc.i4 -15896
	add
	stloc.1
...
// 0x01078244: 0x1078244: addiu v0, s0, -15896
	ldloc 7
	ldc.i4 -15896
	add
	stloc 5
...
// 0x01078284: 0x1078284: addu  s6, a0, zero
	ldloc.1
	stloc 14
// 0x01078288: 0x1078288: addiu s2, s2, -13752
	ldloc 8
	ldc.i4 -13752
	add
	stloc 8
...
// 0x010782e8: 0x10782e8: addiu s2, s2, 4
	...
	stloc 8
L_10782ec:
// 0x010782ec: 0x10782ec: lw    v0, -16084(s3)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x01078554: 0x1078554: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x01078558: 0x1078558: addiu v1, v1, 29472
	ldloc 6
	ldc.i4 29472
	add
	stloc 6
...
// 0x01078568: 0x1078568: addiu a0, a0, -26676
	...
	add
	stloc.1
// 0x0107856c: 0x107856c: jal   0x109e2b4 addiu a2, zero, 8
	ldc.i4.8
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0107857c: 0x107857c: addiu a1, zero, 5
	ldc.i4.5
	stloc.2
// 0x01078580: 0x1078580: jal   0x10944c4 addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0107858c: 0x107858c: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x01078590: 0x1078590: jal   0x10990fc addiu a2, zero, 5
	ldc.i4.5
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01078598: 0x1078598: addu  a0, s0, zero
	ldloc 9
	stloc.1
// 0x0107859c: 0x107859c: jal   0x109903c addu  a1, s1, zero
	ldloc 8
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x010785e4: 0x10785e4: jal   0x109b47c addu  s2, a0, zero
	ldloc.1
	stloc 10
	ldloc.0
	ldloc.1
...
// 0x010785fc: 0x10785fc: addiu a0, s3, -26664
	...
	add
	stloc.1
// 0x01078600: 0x1078600: jal   0x109e2b4 addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01078610: 0x1078610: addiu a1, zero, 5
	ldc.i4.5
	stloc.2
// 0x01078614: 0x1078614: jal   0x10944c4 addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01078620: 0x1078620: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x01078624: 0x1078624: jal   0x10990fc addiu a2, zero, 5
	ldc.i4.5
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0107862c: 0x107862c: addu  a0, s2, zero
	ldloc 10
	stloc.1
// 0x01078630: 0x1078630: jal   0x109903c addu  a1, s0, zero
	ldloc 8
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x01078684: 0x1078684: sll   v0, v0, 2
	...
	shl
	stloc 5
// 0x01078688: 0x1078688: addiu v1, v1, 29472
	ldloc 6
	ldc.i4 29472
	add
	stloc 6
...
// 0x01078690: 0x1078690: lw    a1, 0(v0)
	...
	stloc.2
L_1078694:
// 0x01078694: 0x1078694: jal   0x109e088 addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x0107869c: 0x107869c: jal   0x1099224 addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.1
	call int32 Cibyl114::ssd_widget_show_1099224(int32)
...
// --- basic block ---
L_10786ac:
// 0x010786ac: 0x10786ac: jal   0x1099210 addu  a0, s0, zero
	ldloc 8
	stloc.1
	ldloc.1
	call int32 Cibyl114::ssd_widget_hide_1099210(int32)
...
// 0x010787c8: 0x10787c8: addiu v0, zero, 136
	ldc.i4 136
	stloc 5
// 0x010787cc: 0x10787cc: jal   0x1093b9c sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010787dc: 0x10787dc: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x010787e0: 0x10787e0: jal   0x1099158 sw    v0, 24(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01078828: 0x1078828: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x0107882c: 0x107882c: jal   0x109b47c addu  a0, s1, zero
	ldloc 9
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01078840: 0x1078840: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01078844: 0x1078844: jal   0x109b7ac addu  a0, s1, zero
	ldloc 9
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01078864: 0x1078864: addu  s0, v0, zero
	ldloc 5
	stloc 11
// 0x01078868: 0x1078868: addiu s3, s3, -13752
	ldloc 10
	ldc.i4 -13752
	add
	stloc 10
...
// 0x01078884: 0x1078884: lw    a0, 16(v0)
	...
	ldelem.i4
	stloc.1
// 0x01078888: 0x1078888: jal   0x1094924 addiu s3, s3, 4
	ldloc 10
	ldc.i4.4
	add
	stloc 10
...
// 0x010788ac: 0x10788ac: sll   s2, s2, 2
	...
	shl
	stloc 7
// 0x010788b0: 0x10788b0: addiu v0, v0, -13812
	ldloc 5
	ldc.i4 -13812
	add
	stloc 5
...
// --- basic block ---
L_10788dc:
// 0x010788dc: 0x10788dc: lw    v0, -16084(s4)
	ldloc 6
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x010788f4: 0x10788f4: jal   0x106c98c addiu a0, sp, 16
	...
	stloc 5
// --- basic block ---
// 0x010788fc: 0x10788fc: jal   0x1094c0c addiu a0, zero, 1
	ldc.i4.1
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010789a8: 0x10789a8: jal   0x1096064 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
	...
	stloc 6
// --- basic block ---
// 0x010789b0: 0x10789b0: jal   0x10949b4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010789d4: 0x10789d4: sw    s0, 20(sp)
	...
	ldloc 7
	stelem.i4
// 0x010789d8: 0x10789d8: addiu s0, s1, -16080
	ldloc 8
	ldc.i4 -16080
	add
	stloc 7
...
// 0x010789e8: 0x10789e8: bne   v0, zero, 0x10789fc sw    a1, 36(sp)
	...
	brtrue L_10789fc
// --- basic block ---
// 0x010789f0: 0x10789f0: sw    a0, -16080(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01078a1c: 0x1078a1c: sw    v0, -16080(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01078a7c: 0x1078a7c: addiu s0, s0, -15868
	ldloc 8
	ldc.i4 -15868
	add
	stloc 8
...
// 0x01078b6c: 0x1078b6c: lui   v1, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01078b70: 0x1078b70: addiu v1, v1, -15868
	ldloc 7
	ldc.i4 -15868
	add
	stloc 7
...
// 0x01078bdc: 0x1078bdc: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01078be0: 0x1078be0: addiu v0, v0, -15868
	ldloc 5
	ldc.i4 -15868
	add
	stloc 5
...
// 0x01078be8: 0x1078be8: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01078bec: 0x1078bec: lw    a2, -13844(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1078c48:
// 0x01078c48: 0x1078c48: jal   0x1094108 sll   zero, zero, 0
...
// 0x01078c70: 0x1078c70: jal   0x1094108 sll   zero, zero, 0
	call int32 Cibyl110::ssd_dialog_is_currently_active_1094108()
	stloc 5
// --- basic block ---
// 0x01078c78: 0x1078c78: beq   v0, zero, 0x1078c9c addu  v1, zero, zero
	...
	brfalse L_1078c9c
// --- basic block ---
// 0x01078c80: 0x1078c80: jal   0x1094138 sll   zero, zero, 0
...
// 0x01078cb4: 0x1078cb4: jal   0x1094108 sll   zero, zero, 0
	call int32 Cibyl110::ssd_dialog_is_currently_active_1094108()
	stloc 5
// --- basic block ---
// 0x01078cbc: 0x1078cbc: beq   v0, zero, 0x1078ce8 addiu v1, zero, -1
	...
	brfalse L_1078ce8
// --- basic block ---
// 0x01078cc4: 0x1078cc4: jal   0x1094138 sll   zero, zero, 0
	call int32 Cibyl110::ssd_dialog_currently_active_name_1094138()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
...
// 0x01078cf8: 0x1078cf8: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01078cfc: 0x1078cfc: lw    a0, -13844(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01078e54: 0x1078e54: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01078e58: 0x1078e58: addiu v0, v0, -15868
	ldloc 5
	ldc.i4 -15868
	add
	stloc 5
...
// 0x01078f0c: 0x1078f0c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01078f10: 0x1078f10: lw    a0, -13844(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01078f3c: 0x1078f3c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01078f40: 0x1078f40: lw    a0, -13844(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01078f74: 0x1078f74: jal   0x1094108 sll   zero, zero, 0
	call int32 Cibyl110::ssd_dialog_is_currently_active_1094108()
	stloc 5
// --- basic block ---
// 0x01078f7c: 0x1078f7c: beq   v0, zero, 0x1078fac sll   zero, zero, 0
	...
	brfalse L_1078fac
// --- basic block ---
// 0x01078f84: 0x1078f84: jal   0x1094138 sll   zero, zero, 0
	call int32 Cibyl110::ssd_dialog_currently_active_name_1094138()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
...
// 0x01078f9c: 0x1078f9c: bne   v0, zero, 0x1078fac sll   zero, zero, 0
	...
	brtrue L_1078fac
// --- basic block ---
// 0x01078fa4: 0x1078fa4: jal   0x1094cdc addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_1078fac:
// 0x01078fac: 0x1078fac: jal   0x1094108 sll   zero, zero, 0
	call int32 Cibyl110::ssd_dialog_is_currently_active_1094108()
	stloc 5
// --- basic block ---
// 0x01078fb4: 0x1078fb4: beq   v0, zero, 0x1078fe4 sll   zero, zero, 0
	...
	brfalse L_1078fe4
// --- basic block ---
// 0x01078fbc: 0x1078fbc: jal   0x1094138 sll   zero, zero, 0
	call int32 Cibyl110::ssd_dialog_currently_active_name_1094138()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
...
// 0x01078fd4: 0x1078fd4: bne   v0, zero, 0x1078fe4 sll   zero, zero, 0
	...
	brtrue L_1078fe4
// --- basic block ---
// 0x01078fdc: 0x1078fdc: jal   0x1094cdc addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01079200: 0x1079200: lui   s1, 0x80000
	ldc.i4 524288
	stloc 9
// 0x01079204: 0x1079204: lw    v0, -13836(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01079224: 0x1079224: jal   0x1000930 addu  a0, v0, zero
	...
	stloc 6
// --- basic block ---
// 0x0107922c: 0x107922c: jal   0x1053080 sw    zero, -13836(s1)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010792b0: 0x10792b0: beq   v0, zero, 0x10792c8 sll   zero, zero, 0
	...
	brfalse L_10792c8
// --- basic block ---
// 0x010792b8: 0x10792b8: jal   0x1094c0c addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01079424: 0x1079424: addu  a0, s2, zero
	ldloc 8
	stloc.1
// 0x01079428: 0x1079428: jal   0x10791f8 sw    zero, -13836(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
