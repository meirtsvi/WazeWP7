...
// 0x0108849c: 0x108849c: lw    a0, 28(sp)
	...
	ldelem.i4
	stloc.1
// 0x010884a0: 0x10884a0: jal   0x10c0b30 sll   zero, zero, 0
	ldloc.0
	ldloc.1
...
// 0x010884b4: 0x10884b4: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x010884b8: 0x10884b8: jal   0x10c0908 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010884c0: 0x10884c0: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x010884c4: 0x10884c4: jal   0x10c0a40 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01089104: 0x1089104: lw    a1, 32(sp)
	...
	ldelem.i4
	stloc.2
// 0x01089108: 0x1089108: jal   0x10aa178 addu  a2, s1, zero
	ldloc 9
	stloc.3
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl127::roadmap_tripserver_response_10aa178(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 8
	stloc 5
// --- basic block ---
