...
// 0x010b0a70: 0x10b0a70: lui   v0, 0x0
	ldc.i4.s 0
	stloc.0
// 0x010b0a74: 0x10b0a74: lw    v0, 19036(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010b0b64: 0x10b0b64: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b0b68: 0x10b0b68: lw    v0, 18900(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b0b7c: 0x10b0b7c: lui   s0, 0x0
	ldc.i4.s 0
	stloc 8
// 0x010b0b80: 0x10b0b80: addiu s0, s0, 18976
	ldloc 8
	ldc.i4 18976
	add
	stloc 8
...
// 0x010b0bf0: 0x10b0bf0: lw    v1, 20(sp)
	...
	ldelem.i4
	stloc 7
// 0x010b0bf4: 0x10b0bf4: lw    a0, 18976(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b0c04: 0x10b0c04: bne   v1, zero, 0x10b0c28 sll   zero, zero, 0
	...
	brtrue L_10b0c28
// --- basic block ---
// 0x010b0c0c: 0x10b0c0c: addiu v0, v0, 18976
	ldloc 5
	ldc.i4 18976
	add
	stloc 5
...
// 0x010b0c24: 0x10b0c24: lui   v0, 0x0
	...
	stloc 5
L_10b0c28:
// 0x010b0c28: 0x10b0c28: addiu v0, v0, 18976
	ldloc 5
	ldc.i4 18976
	add
	stloc 5
...
// 0x010b0f20: 0x10b0f20: jal   0x10b0e74 sw    zero, 18900(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b0f34: 0x10b0f34: sw    v1, 19028(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b0f3c: 0x10b0f3c: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b0f40: 0x10b0f40: sw    v1, 19036(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b1038: 0x10b1038: addiu a0, s1, 12676
	...
	add
	stloc.1
// 0x010b103c: 0x10b103c: addiu a1, s0, 19120
	ldloc 10
	ldc.i4 19120
	add
	stloc.2
...
// 0x010b1060: 0x10b1060: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010b1064: 0x10b1064: addiu a1, a1, 19104
	ldloc.2
	ldc.i4 19104
	add
	stloc.2
...
// 0x010b1090: 0x10b1090: addiu a0, s1, 12676
	...
	add
	stloc.1
// 0x010b1094: 0x10b1094: addiu a1, a1, 19088
	ldloc.2
	ldc.i4 19088
	add
	stloc.2
...
// 0x010b10b0: 0x10b10b0: addu  a1, s3, zero
	ldloc 9
	stloc.2
// 0x010b10b4: 0x10b10b4: jal   0x100e814 addiu a0, s0, 19120
	ldloc 10
	ldc.i4 19120
	add
	stloc.1
...
// 0x010b10bc: 0x10b10bc: bne   v0, zero, 0x10b1100 addiu v1, zero, 1
	...
	brtrue L_10b1100
// --- basic block ---
// 0x010b10c4: 0x10b10c4: addiu a0, s0, 19120
	ldloc 10
	ldc.i4 19120
	add
	stloc.1
...
// 0x010b1140: 0x10b1140: lui   s0, 0x0
	ldc.i4.s 0
	stloc 7
// 0x010b1144: 0x10b1144: lw    v1, 19140(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010b115c: 0x10b115c: jal   0x1008ce8 addu  a1, zero, zero
	...
	stloc 5
// --- basic block ---
// 0x010b1164: 0x10b1164: sw    v0, 19140(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010b116c: 0x10b116c: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b1170: 0x10b1170: lw    v0, 19140(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b12c4: 0x10b12c4: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x010b12c8: 0x10b12c8: addiu a0, a0, 19120
	ldloc.1
	ldc.i4 19120
	add
	stloc.1
...
// 0x010b1490: 0x10b1490: bne   a2, v1, 0x10b14ec lui   a0, 0x0
	...
	bne.un L_10b14ec
// --- basic block ---
// 0x010b1498: 0x10b1498: addiu a0, a0, 19024
	ldloc.1
	ldc.i4 19024
	add
	stloc.1
...
// 0x010b1538: 0x10b1538: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b153c: 0x10b153c: lw    t0, 18808(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b1544: 0x10b1544: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b1548: 0x10b1548: addiu v0, v0, 19024
	ldloc 5
	ldc.i4 19024
	add
	stloc 5
// 0x010b154c: 0x10b154c: lw    v1, 19036(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010b156c: 0x10b156c: jal   0x10af37c sw    s0, 4(v0)
	...
	stloc 5
// --- basic block ---
// 0x010b1574: 0x10b1574: j	 0x10b1580 sw    zero, 19036(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x010b15fc: 0x10b15fc: addiu s7, s7, -11536
	...
	add
	stloc 11
// 0x010b1600: 0x10b1600: addiu s2, s2, 19024
	ldloc 10
	ldc.i4 19024
	add
	stloc 10
...
// 0x010b16ac: 0x10b16ac: jal   0x10aeecc addu  a0, s2, zero
	...
	stloc 6
// --- basic block ---
// 0x010b16b4: 0x10b16b4: lw    v1, 18808(s6)
	ldloc 5
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x010b16e8: 0x10b16e8: jal   0x10aeecc addu  a0, s2, zero
	...
	stloc 6
// --- basic block ---
// 0x010b16f0: 0x10b16f0: lw    v1, 18808(s6)
	ldloc 5
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x010b1720: 0x10b1720: bne   s4, v1, 0x10b1794 lui   a0, 0x0
	...
	bne.un L_10b1794
// --- basic block ---
// 0x010b1728: 0x10b1728: lw    v0, 18900(a0)
	ldloc 5
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010b1730: 0x10b1730: beq   v0, zero, 0x10b17a8 addiu a3, zero, -1
	...
	brfalse L_10b17a8
// --- basic block ---
// 0x010b1738: 0x10b1738: addiu v0, a0, 18900
	ldloc.1
	ldc.i4 18900
	add
	stloc 6
...
// 0x010b1750: 0x10b1750: addu  a1, s7, a1
	...
	add
	stloc.2
// 0x010b1754: 0x10b1754: addiu a0, a0, 18976
	ldloc.1
	ldc.i4 18976
	add
	stloc.1
...
// 0x010b1774: 0x10b1774: jal   0x10aeecc addiu a0, sp, 32
	...
	stloc 6
// --- basic block ---
// 0x010b177c: 0x10b177c: lw    v1, 18808(s6)
	ldloc 5
	ldloc 15
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10b18a0:
// 0x010b18a0: 0x10b18a0: lw    v0, 18900(a3)
	ldloc 6
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x010b18b0: 0x10b18b0: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b18b4: 0x10b18b4: lw    v0, 19036(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b18b8: 0x10b18b8: lui   a2, 0x0
	ldc.i4.s 0
	stloc.3
// 0x010b18bc: 0x10b18bc: addiu a0, a0, 19040
	ldloc.1
	ldc.i4 19040
	add
	stloc.1
// 0x010b18c0: 0x10b18c0: addiu a1, a1, -1
	...
	add
	stloc.2
// 0x010b18c4: 0x10b18c4: addiu a2, a2, 18976
	ldloc.3
	ldc.i4 18976
	add
	stloc.3
// 0x010b18c8: 0x10b18c8: addiu a3, a3, 18900
	ldloc 4
	ldc.i4 18900
	add
	stloc 4
...
// 0x010b18d8: 0x10b18d8: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x010b18dc: 0x10b18dc: addiu a0, a0, 19040
	ldloc.1
	ldc.i4 19040
	add
	stloc.1
// 0x010b18e0: 0x10b18e0: addiu a1, a1, 18976
	ldloc.2
	ldc.i4 18976
	add
	stloc.2
...
// 0x010b18ec: 0x10b18ec: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b18f0: 0x10b18f0: jal   0x10ad388 sw    zero, 18900(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b1914: 0x10b1914: lw    s0, 32(sp)
	...
	ldelem.i4
	stloc 8
// 0x010b1918: 0x10b1918: sw    v1, 19028(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b193c: 0x10b193c: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b1940: 0x10b1940: sw    v1, 19036(v0)
	ldloc 8
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010b1990: 0x10b1990: lui   s5, 0x0
	ldc.i4.s 0
	stloc 14
// 0x010b1994: 0x10b1994: addiu s0, v0, 18976
	ldloc 5
	ldc.i4 18976
	add
	stloc 8
// 0x010b1998: 0x10b1998: addiu s2, s5, 18900
	ldloc 14
	ldc.i4 18900
	add
	stloc 11
...
// 0x010b19a0: 0x10b19a0: lui   s7, 0x0
	...
	stloc 16
L_10b19a4:
// 0x010b19a4: 0x10b19a4: lw    v0, 18900(s5)
	ldloc 7
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x010b1a20: 0x10b1a20: lui   v1, 0x0
	ldc.i4.s 0
	stloc 6
// 0x010b1a24: 0x10b1a24: addiu v1, v1, 19024
	ldloc 6
	ldc.i4 19024
	add
	stloc 6
...
// 0x010b1a2c: 0x10b1a2c: sw    s1, 4(v1)
	...
	ldloc 10
	stelem.i4
// 0x010b1a30: 0x10b1a30: j	 0x10b1fc4 sw    v0, 19036(s7)
	ldloc 7
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x010b1a38: 0x10b1a38: lw    a0, -11560(a0)
	...
	ldelem.i4
	stloc.1
// 0x010b1a3c: 0x10b1a3c: lw    v0, 18900(s5)
	ldloc 7
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x010b1b00: 0x10b1b00: beq   v0, zero, 0x10b1c90 sll   zero, zero, 0
	...
	brfalse L_10b1c90
// --- basic block ---
// 0x010b1b08: 0x10b1b08: lw    v0, 18900(s5)
	ldloc 7
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x010b1b18: 0x10b1b18: lui   v1, 0x0
	ldc.i4.s 0
	stloc 6
// 0x010b1b1c: 0x10b1b1c: lw    v0, 18976(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10b1c90:
// 0x010b1c90: 0x10b1c90: lw    v0, 18900(s5)
	ldloc 7
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x010b1cb0: 0x10b1cb0: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b1cb4: 0x10b1cb4: addiu v0, v0, 19024
	ldloc 5
	ldc.i4 19024
	add
	stloc 5
...
// --- basic block ---
L_10b1cdc:
// 0x010b1cdc: 0x10b1cdc: lw    v0, 19036(s7)
	ldloc 7
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x010b1ce0: 0x10b1ce0: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010b1ce4: 0x10b1ce4: addiu a0, a0, 19040
	ldloc.1
	ldc.i4 19040
	add
	stloc.1
...
// 0x010b1cfc: 0x10b1cfc: beq   v0, zero, 0x10b1d18 lui   a0, 0x0
	...
	brfalse L_10b1d18
// --- basic block ---
// 0x010b1d04: 0x10b1d04: addiu a0, a0, 19040
	ldloc.1
	ldc.i4 19040
	add
	stloc.1
...
// 0x010b1d0c: 0x10b1d0c: addiu a2, zero, 48
	ldc.i4.s 48
	stloc.3
// 0x010b1d10: 0x10b1d10: jal   0x1001800 sw    zero, 19036(s7)
	ldloc 7
	ldloc 16
	ldc.i4.2
	shr.un
...
// 0x010b1e70: 0x10b1e70: beq   s3, v0, 0x10b1fc8 lui   v0, 0x90000
	...
	beq  L_10b1fc8
// --- basic block ---
// 0x010b1e78: 0x10b1e78: lw    v0, 18900(s5)
	ldloc 7
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x010b1e88: 0x10b1e88: lui   v1, 0x0
	ldc.i4.s 0
	stloc 6
// 0x010b1e8c: 0x10b1e8c: lw    v0, 18976(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010b2014: 0x10b2014: addiu v0, zero, 10
	ldc.i4.s 10
	stloc 5
// 0x010b2018: 0x10b2018: addiu a3, a3, 18976
	ldloc 4
	ldc.i4 18976
	add
	stloc 4
// 0x010b201c: 0x10b201c: addiu a2, s1, 18900
	ldloc 10
	ldc.i4 18900
	add
	stloc.3
...
// 0x010b2034: 0x10b2034: bne   s8, zero, 0x10b2054 addu  a1, v0, zero
	...
	brtrue L_10b2054
// --- basic block ---
// 0x010b203c: 0x10b203c: lw    v1, 18900(s1)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010b205c: 0x10b205c: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010b2060: 0x10b2060: lw    v0, 18900(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
