...
// 0x0100f078: 0x100f078: addu  a0, s2, zero
	ldloc 9
	stloc.1
// 0x0100f07c: 0x100f07c: jal   0x104dc58 addiu a2, a2, 26152
	ldloc.3
	ldc.i4 26152
	add
	stloc.3
...
// 0x0100f1d0: 0x100f1d0: sw    zero, 12(s1)
	...
	ldc.i4.s 0
	stelem.i4
// 0x0100f1d4: 0x100f1d4: sw    v1, -30628(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100f260: 0x100f260: addiu v0, v0, 1
	...
	add
	stloc 5
// 0x0100f264: 0x100f264: jal   0x104d394 sw    v0, 24(s1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100f284: 0x100f284: lw    a0, 4(s1)
	...
	ldelem.i4
	stloc.1
// 0x0100f288: 0x100f288: jal   0x104d31c sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// --- basic block ---
L_100f320:
// 0x0100f320: 0x100f320: jal   0x104c724 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100f394: 0x100f394: addiu s0, s0, -30624
	ldloc 5
	ldc.i4 -30624
	add
	stloc 5
// 0x0100f398: 0x100f398: addiu s1, s1, -30604
	ldloc 7
	ldc.i4 -30604
	add
	stloc 7
...
// 0x0100f3d0: 0x100f3d0: lui   v0, 0x30000
	ldc.i4 196608
	stloc.2
// 0x0100f3d4: 0x100f3d4: lw    v1, -30624(v0)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0100f3dc: 0x100f3dc: beq   v1, zero, 0x100f42c addu  a1, zero, zero
	...
	brfalse L_100f42c
// --- basic block ---
// 0x0100f3e4: 0x100f3e4: addiu v0, v0, -30624
	ldloc.2
	ldc.i4 -30624
	add
	stloc.2
...
// 0x0100f42c: 0x100f42c: sll   a1, a1, 2
	...
	shl
	stloc.1
// 0x0100f430: 0x100f430: addiu v0, v0, -30624
	ldloc.2
	ldc.i4 -30624
	add
	stloc.2
...
// 0x0100f458: 0x100f458: lw    s0, -30604(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100f4f0: 0x100f4f0: lui   v1, 0x30000
	ldc.i4 196608
	stloc 8
// 0x0100f4f4: 0x100f4f4: lw    a0, -30604(v1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100f4fc: 0x100f4fc: sw    s1, 4(s0)
	...
	ldloc 9
	stelem.i4
// 0x0100f500: 0x100f500: sw    s0, -30604(v1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100f578: 0x100f578: addiu s0, s0, -30600
	ldloc 5
	ldc.i4 -30600
	add
	stloc 5
// 0x0100f57c: 0x100f57c: addiu s2, s2, -30400
	ldloc 9
	ldc.i4 -30400
	add
	stloc 9
...
// 0x0100f58c: 0x100f58c: beq   v0, zero, 0x100f5cc addu  a1, v0, zero
	...
	brfalse L_100f5cc
// --- basic block ---
// 0x0100f594: 0x100f594: jal   0x104d820 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100f5a4: 0x100f5a4: lw    a1, 0(s0)
	...
	ldelem.i4
	stloc.2
// 0x0100f5a8: 0x100f5a8: jal   0x104db94 addu  a0, s1, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0100f798: 0x100f798: jal   0x10c0c50 sw    v0, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100f880: 0x100f880: addiu a1, zero, 500
	ldc.i4 500
	stloc.2
// 0x0100f884: 0x100f884: jal   0x10c0c50 sw    v0, 24(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100f940: 0x100f940: lw    a0, 8(s0)
	...
	ldelem.i4
	stloc.1
// 0x0100f944: 0x100f944: jal   0x104c800 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100f9ac: 0x100f9ac: lw    a0, 8(s0)
	...
	ldelem.i4
	stloc.1
// 0x0100f9b0: 0x100f9b0: jal   0x104c800 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100fd14: 0x100fd14: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0100fd18: 0x100fd18: lw    v1, -30396(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100fd20: 0x100fd20: sll   v1, v1, 2
	...
	shl
	stloc 6
// 0x0100fd24: 0x100fd24: addiu v0, v0, -30600
	ldloc 5
	ldc.i4 -30600
	add
	stloc 5
...
// 0x0100fd50: 0x100fd50: addiu a0, s1, 18616
	...
	add
	stloc.1
// 0x0100fd54: 0x100fd54: jal   0x104d820 addu  a1, s0, zero
	ldloc 8
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0100fd5c: 0x100fd5c: beq   v0, zero, 0x100fd6c addiu a0, s1, 18616
	...
	brfalse L_100fd6c
// --- basic block ---
// 0x0100fd64: 0x100fd64: jal   0x104db94 addu  a1, s0, zero
	ldloc 8
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0100fd74: 0x100fd74: lui   s0, 0x30000
	ldc.i4 196608
	stloc 8
// 0x0100fd78: 0x100fd78: lw    s1, -30396(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100fd7c: 0x100fd7c: jal   0x1001ba8 addu  a0, s2, zero
	...
	stloc 5
// --- basic block ---
// 0x0100fd84: 0x100fd84: lw    v1, -30396(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100fd98: 0x100fd98: sll   s1, s1, 2
	...
	shl
	stloc 9
// 0x0100fd9c: 0x100fd9c: addiu a0, a0, -30600
	ldloc.1
	ldc.i4 -30600
	add
	stloc.1
...
// 0x0100fdb4: 0x100fdb4: mfhi  hi
	ldloc 12
	stloc 6
// 0x0100fdb8: 0x100fdb8: sw    v1, -30396(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100fe14: 0x100fe14: addu  a0, s1, zero
	ldloc 9
	stloc.1
// 0x0100fe18: 0x100fe18: jal   0x104deb0 addiu a1, a1, 15592
	ldloc.2
	ldc.i4 15592
	add
	stloc.2
...
// 0x0100fe48: 0x100fe48: lw    a2, 8(s0)
	...
	ldelem.i4
	stloc.3
// 0x0100fe4c: 0x100fe4c: jal   0x104d5fc addu  a0, s2, zero
	ldloc 10
	stloc.1
	ldloc.0
	ldloc.1
	...
	stloc 6
// --- basic block ---
// 0x0100fe54: 0x100fe54: jal   0x104d5dc addu  a0, s2, zero
	ldloc 10
	stloc.1
	ldloc.0
	ldloc.1
	...
	stloc 6
// --- basic block ---
// 0x0100fe5c: 0x100fe5c: jal   0x104c580 sll   zero, zero, 0
...
// 0x0100fe8c: 0x100fe8c: lw    a0, 0(s0)
	...
	ldelem.i4
	stloc.1
// 0x0100fe90: 0x100fe90: jal   0x104c800 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0100ff38: 0x100ff38: jal   0x1001ac4 addiu a1, a1, 27152
	...
	stloc 5
// --- basic block ---
// 0x0100ff40: 0x100ff40: jal   0x104cd08 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl56::roadmap_path_images_104cd08(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
// 0x0100ff48: 0x100ff48: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x0100ff4c: 0x100ff4c: jal   0x104ccc0 addu  a1, s2, zero
	ldloc 11
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0100ff58: 0x100ff58: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0100ff5c: 0x100ff5c: jal   0x104d820 addu  s6, v0, zero
	ldloc 5
	stloc 10
	ldloc.0
	ldloc.1
...
// 0x0100ff7c: 0x100ff7c: jalr  s3 addu  a2, s6, zero
	...
	stloc 5
// --- basic block ---
// 0x0100ff84: 0x100ff84: jal   0x104c800 addu  a0, s6, zero
	ldloc 10
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01010010: 0x1010010: jal   0x101cd74 sw    v0, 24(sp)
	...
	stloc 5
// --- basic block ---
// 0x01010018: 0x1010018: jal   0x104c560 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
...
// 0x0101002c: 0x101002c: addu  a2, s0, zero
	ldloc 8
	stloc.3
// 0x01010030: 0x1010030: jal   0x1045f60 addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x01010078: 0x1010078: lui   v0, 0x20000
	ldc.i4 131072
	stloc 4
// 0x0101007c: 0x101007c: lw    v0, 24680(v0)
	ldloc 6
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x010100d8: 0x10100d8: addiu v1, a2, 12
	...
	add
	stloc 13
// 0x010100dc: 0x10100dc: lw    t8, 29760(t0)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01010134: 0x1010134: beq   s0, zero, 0x10101f0 sll   zero, zero, 0
	...
	brfalse L_10101f0
// --- basic block ---
// 0x0101013c: 0x101013c: lw    s1, 29636(t5)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01010254: 0x1010254: lui   v0, 0x20000
	ldc.i4 131072
	stloc 4
// 0x01010258: 0x1010258: lw    v1, 24680(v0)
	ldloc 6
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x01010270: 0x1010270: lui   a2, 0xe0000
	ldc.i4 917504
	stloc.2
// 0x01010274: 0x1010274: lw    t2, 29760(a2)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x010102ac: 0x10102ac: lw    t4, 16(t4)
	...
	ldelem.i4
	stloc 5
// 0x010102b0: 0x10102b0: lw    t5, 29636(t0)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010103b0: 0x10103b0: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x010103b4: 0x10103b4: lw    v0, 29760(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010103d4: 0x10103d4: addu  s1, v0, zero
	ldloc 5
	stloc 12
// 0x010103d8: 0x10103d8: lw    v0, -30388(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010104ac: 0x10104ac: lui   v1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x010104b0: 0x10104b0: lw    v0, -30388(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010104ec: 0x10104ec: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x010104f0: 0x10104f0: lw    v1, -30388(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01010584: 0x1010584: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x01010588: 0x1010588: lw    v0, -30388(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010105f8: 0x10105f8: jal   0x100e368 addu  a0, s7, zero
	...
	stloc 5
// --- basic block ---
// 0x01010600: 0x1010600: jal   0x10bd8c4 sw    v0, 64(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101065c: 0x101065c: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x01010660: 0x1010660: lw    v1, -30388(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0101069c: 0x101069c: bne   s2, v0, 0x10106b4 sll   zero, zero, 0
	...
	bne.un L_10106b4
// --- basic block ---
// 0x010106a4: 0x10106a4: jal   0x10bd8c4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010106fc: 0x10106fc: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x01010700: 0x1010700: lw    v1, -30388(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010107dc: 0x10107dc: lw    a1, 1792(v0)
	...
	ldelem.i4
	stloc.2
// 0x010107e0: 0x10107e0: jal   0x104f0d8 addu  a0, s1, zero
	ldloc 12
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010107ec: 0x10107ec: sw    v0, 48(s6)
	...
	ldloc 5
	stelem.i4
// 0x010107f0: 0x10107f0: jal   0x104defc addiu s2, s2, 1
	ldloc 8
	ldc.i4.1
	add
	stloc 8
...
// 0x0101080c: 0x101080c: bne   v0, zero, 0x1010820 sll   zero, zero, 0
	...
	brtrue L_1010820
// --- basic block ---
// 0x01010814: 0x1010814: jal   0x104ef88 addu  a0, s7, zero
	ldloc 11
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01010840: 0x1010840: lw    a1, 1792(v0)
	...
	ldelem.i4
	stloc.2
// 0x01010844: 0x1010844: jal   0x104f0d8 addu  a0, s1, zero
	ldloc 12
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01010878: 0x1010878: lw    a0, 0(v0)
	...
	ldelem.i4
	stloc.1
// 0x0101087c: 0x101087c: jal   0x104ef88 addiu s7, s7, 4
	ldloc 11
	ldc.i4.4
	add
	stloc 11
...
// 0x0101088c: 0x101088c: blez  v1, 0x101089c addu  a0, v1, zero
	...
	ble L_101089c
// --- basic block ---
// 0x01010894: 0x1010894: jal   0x104defc sll   zero, zero, 0
	ldloc.1
	call int32 Cibyl57::roadmap_canvas_set_thickness_104defc(int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
...
// 0x01010920: 0x1010920: lw    a1, 1792(v0)
	...
	ldelem.i4
	stloc.2
// 0x01010924: 0x1010924: jal   0x104f0d8 addu  a0, s1, zero
	ldloc 12
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01010944: 0x1010944: lw    a0, 68(sp)
	...
	stloc.1
L_1010948:
// 0x01010948: 0x1010948: jal   0x104ef88 addiu s5, s5, 1
	ldloc 15
	ldc.i4.1
	add
	stloc 15
...
// 0x0101095c: 0x101095c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01010960: 0x1010960: lw    v0, -30392(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010978: 0x1010978: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x0101097c: 0x101097c: sw    v0, -30388(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
