...
// 0x0100f1d0: 0x100f1d0: sw    zero, 12(s1)
	...
	ldc.i4.s 0
	stelem.i4
// 0x0100f1d4: 0x100f1d4: sw    v1, -30596(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0100f394: 0x100f394: addiu s0, s0, -30592
	ldloc 5
	ldc.i4 -30592
	add
	stloc 5
// 0x0100f398: 0x100f398: addiu s1, s1, -30572
	ldloc 7
	ldc.i4 -30572
	add
	stloc 7
...
// 0x0100f3d0: 0x100f3d0: lui   v0, 0x30000
	ldc.i4 196608
	stloc.2
// 0x0100f3d4: 0x100f3d4: lw    v1, -30592(v0)
	ldloc 4
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x0100f3dc: 0x100f3dc: beq   v1, zero, 0x100f42c addu  a1, zero, zero
	...
	brfalse L_100f42c
// --- basic block ---
// 0x0100f3e4: 0x100f3e4: addiu v0, v0, -30592
	ldloc.2
	ldc.i4 -30592
	add
	stloc.2
...
// 0x0100f42c: 0x100f42c: sll   a1, a1, 2
	...
	shl
	stloc.1
// 0x0100f430: 0x100f430: addiu v0, v0, -30592
	ldloc.2
	ldc.i4 -30592
	add
	stloc.2
...
// 0x0100f458: 0x100f458: lw    s0, -30572(v0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100f4f0: 0x100f4f0: lui   v1, 0x30000
	ldc.i4 196608
	stloc 8
// 0x0100f4f4: 0x100f4f4: lw    a0, -30572(v1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100f4fc: 0x100f4fc: sw    s1, 4(s0)
	...
	ldloc 9
	stelem.i4
// 0x0100f500: 0x100f500: sw    s0, -30572(v1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100f578: 0x100f578: addiu s0, s0, -30568
	ldloc 5
	ldc.i4 -30568
	add
	stloc 5
// 0x0100f57c: 0x100f57c: addiu s2, s2, -30368
	ldloc 9
	ldc.i4 -30368
	add
	stloc 9
...
// 0x0100fd14: 0x100fd14: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0100fd18: 0x100fd18: lw    v1, -30364(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100fd20: 0x100fd20: sll   v1, v1, 2
	...
	shl
	stloc 6
// 0x0100fd24: 0x100fd24: addiu v0, v0, -30568
	ldloc 5
	ldc.i4 -30568
	add
	stloc 5
...
// 0x0100fd74: 0x100fd74: lui   s0, 0x30000
	ldc.i4 196608
	stloc 8
// 0x0100fd78: 0x100fd78: lw    s1, -30364(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100fd7c: 0x100fd7c: jal   0x1001ba8 addu  a0, s2, zero
	...
	stloc 5
// --- basic block ---
// 0x0100fd84: 0x100fd84: lw    v1, -30364(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100fd98: 0x100fd98: sll   s1, s1, 2
	...
	shl
	stloc 9
// 0x0100fd9c: 0x100fd9c: addiu a0, a0, -30568
	ldloc.1
	ldc.i4 -30568
	add
	stloc.1
...
// 0x0100fdb4: 0x100fdb4: mfhi  hi
	ldloc 12
	stloc 6
// 0x0100fdb8: 0x100fdb8: sw    v1, -30364(s0)
	ldloc 7
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0100fe14: 0x100fe14: addu  a0, s1, zero
	ldloc 9
	stloc.1
// 0x0100fe18: 0x100fe18: jal   0x104deb0 addiu a1, a1, 15620
	ldloc.2
	ldc.i4 15620
	add
	stloc.2
...
// 0x01010078: 0x1010078: lui   v0, 0x20000
	ldc.i4 131072
	stloc 4
// 0x0101007c: 0x101007c: lw    v0, 24712(v0)
	ldloc 6
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x010100d8: 0x10100d8: addiu v1, a2, 12
	...
	add
	stloc 13
// 0x010100dc: 0x10100dc: lw    t8, 29792(t0)
	ldloc 6
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01010134: 0x1010134: beq   s0, zero, 0x10101f0 sll   zero, zero, 0
	...
	brfalse L_10101f0
// --- basic block ---
// 0x0101013c: 0x101013c: lw    s1, 29668(t5)
	ldloc 6
	ldloc 17
	ldc.i4.2
	shr.un
...
// 0x01010254: 0x1010254: lui   v0, 0x20000
	ldc.i4 131072
	stloc 4
// 0x01010258: 0x1010258: lw    v1, 24712(v0)
	ldloc 6
	ldloc 4
	ldc.i4.2
	shr.un
...
// 0x01010270: 0x1010270: lui   a2, 0xe0000
	ldc.i4 917504
	stloc.2
// 0x01010274: 0x1010274: lw    t2, 29792(a2)
	ldloc 6
	ldloc.2
	ldc.i4.2
	shr.un
...
// 0x010102ac: 0x10102ac: lw    t4, 16(t4)
	...
	ldelem.i4
	stloc 5
// 0x010102b0: 0x10102b0: lw    t5, 29668(t0)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010103b0: 0x10103b0: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x010103b4: 0x10103b4: lw    v0, 29792(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010103d4: 0x10103d4: addu  s1, v0, zero
	ldloc 5
	stloc 12
// 0x010103d8: 0x10103d8: lw    v0, -30356(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010104ac: 0x10104ac: lui   v1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x010104b0: 0x10104b0: lw    v0, -30356(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010104ec: 0x10104ec: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x010104f0: 0x10104f0: lw    v1, -30356(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01010584: 0x1010584: lui   a0, 0x10000
	ldc.i4 65536
	stloc.1
// 0x01010588: 0x1010588: lw    v0, -30356(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101065c: 0x101065c: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x01010660: 0x1010660: lw    v1, -30356(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010106fc: 0x10106fc: lui   a0, 0x30000
	ldc.i4 196608
	stloc.1
// 0x01010700: 0x1010700: lw    v1, -30356(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0101095c: 0x101095c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x01010960: 0x1010960: lw    v0, -30360(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01010978: 0x1010978: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x0101097c: 0x101097c: sw    v0, -30356(s2)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
