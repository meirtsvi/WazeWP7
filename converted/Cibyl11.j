...
// 0x0100f798: 0x100f798: jal   0x10c0bb0 sw    v0, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100f880: 0x100f880: addiu a1, zero, 500
	ldc.i4 500
	stloc.2
// 0x0100f884: 0x100f884: jal   0x10c0bb0 sw    v0, 24(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010105f8: 0x10105f8: jal   0x100e368 addu  a0, s7, zero
	...
	stloc 5
// --- basic block ---
// 0x01010600: 0x1010600: jal   0x10bd824 sw    v0, 64(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101069c: 0x101069c: bne   s2, v0, 0x10106b4 sll   zero, zero, 0
	...
	bne.un L_10106b4
// --- basic block ---
// 0x010106a4: 0x10106a4: jal   0x10bd824 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
