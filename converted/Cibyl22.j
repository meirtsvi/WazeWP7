...
// 0x0101de50: 0x101de50: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101de54: 0x101de54: lw    v1, 28388(v0)
	ldloc 3
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101de64: 0x101de64: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101de68: 0x101de68: addiu v0, v0, 28424
	ldloc.0
	ldc.i4 28424
	add
	stloc.0
...
// 0x0101de90: 0x101de90: addu  s2, a0, zero
	ldloc.1
	stloc 10
// 0x0101de94: 0x101de94: lw    v1, 28416(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x0101de98: 0x101de98: j	 0x101deb4 addiu s1, v0, 28416
	ldloc 6
	ldc.i4 28416
	add
	stloc 9
...
// 0x0101dfa8: 0x101dfa8: lui   s0, 0x0
	ldc.i4.s 0
	stloc 8
// 0x0101dfac: 0x101dfac: addiu v0, v1, 28416
	ldloc 7
	ldc.i4 28416
	add
	stloc 6
...
// 0x0101dfe8: 0x101dfe8: sw    v0, 28416(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101e074: 0x101e074: bne   v0, zero, 0x101e080 sll   zero, zero, 0
	...
	brtrue L_101e080
// --- basic block ---
// 0x0101e07c: 0x101e07c: sw    s0, 28384(s4)
	ldloc 5
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x0101e0d0: 0x101e0d0: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x0101e0d4: 0x101e0d4: addiu v0, v0, 9620
	ldloc 6
	ldc.i4 9620
	add
	stloc 6
...
// 0x0101e158: 0x101e158: addiu a1, a1, -8956
	...
	add
	stloc.2
// 0x0101e15c: 0x101e15c: jal   0x100f4ac sw    v0, 28412(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101e19c: 0x101e19c: sw    s0, 40(sp)
	...
	ldloc 9
	stelem.i4
// 0x0101e1a0: 0x101e1a0: lw    s0, 28388(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101e1a4: 0x101e1a4: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101e1a8: 0x101e1a8: lw    v0, 28384(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101e1c4: 0x101e1c4: lui   s1, 0x30000
	ldc.i4 196608
	stloc 8
// 0x0101e1c8: 0x101e1c8: lw    v0, 28392(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101e204: 0x101e204: jal   0x101aee4 addiu a0, zero, 84
	...
	stloc 5
// --- basic block ---
// 0x0101e20c: 0x101e20c: lw    a1, 28392(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101e280: 0x101e280: addu  a3, v0, zero
	ldloc 5
	stloc 4
// 0x0101e284: 0x101e284: addiu a1, s4, 22900
	ldloc 12
	ldc.i4 22900
	add
	stloc.2
...
// 0x0101e290: 0x101e290: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101e294: 0x101e294: lw    a0, 28392(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101e29c: 0x101e29c: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101e2a0: 0x101e2a0: lw    t0, 28400(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 15
// 0x0101e2a4: 0x101e2a4: addiu a3, v0, 28416
	ldloc 5
	ldc.i4 28416
	add
	stloc 4
// 0x0101e2a8: 0x101e2a8: lw    v1, 28416(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101e308: 0x101e308: lui   s4, 0x30000
	ldc.i4 196608
	stloc 12
// 0x0101e30c: 0x101e30c: beq   a1, a0, 0x101e390 sw    a1, 28396(s4)
	ldloc.2
	ldloc.1
	ldloc 6
	ldloc 12
...
// 0x0101e320: 0x101e320: addu  s1, v0, zero
	ldloc 5
	stloc 8
// 0x0101e324: 0x101e324: lw    v0, 28396(s4)
	ldloc 6
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x0101e374: 0x101e374: lw    a2, 32(sp)
	...
	ldelem.i4
	stloc.3
// 0x0101e378: 0x101e378: addiu a1, a1, 22900
	ldloc.2
	ldc.i4 22900
	add
	stloc.2
...
// 0x0101e3d8: 0x101e3d8: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x0101e3dc: 0x101e3dc: addiu a1, a1, 22900
	ldloc.2
	ldc.i4 22900
	add
	stloc.2
...
// 0x0101e3f4: 0x101e3f4: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x0101e3f8: 0x101e3f8: jal   0x10bfe1c addu  a0, s1, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl142::roadmap_sunset_10bfe1c(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x0101e43c: 0x101e43c: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x0101e440: 0x101e440: jal   0x10bfe58 addu  a0, s1, zero
	ldloc 8
	stloc.1
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl142::roadmap_sunrise_10bfe58(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
// --- basic block ---
...
// 0x0101e46c: 0x101e46c: addiu a0, zero, 68
	ldc.i4.s 68
	stloc.1
// 0x0101e470: 0x101e470: jal   0x101ae74 sw    zero, 28396(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101e4a0: 0x101e4a0: lui   v0, 0x30000
	...
	stloc 5
L_101e4a4:
// 0x0101e4a4: 0x101e4a4: lw    v0, 28412(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101e50c: 0x101e50c: addiu a1, v0, 28416
	ldloc 6
	ldc.i4 28416
	add
	stloc.2
// 0x0101e510: 0x101e510: addiu s1, s1, 29604
	ldloc 9
	ldc.i4 29604
	add
	stloc 9
// 0x0101e514: 0x101e514: lw    s0, 28416(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e524: 0x101e524: lui   s8, 0x0
	ldc.i4.s 0
	stloc 16
// 0x0101e528: 0x101e528: addiu s7, s2, 28424
	ldloc 10
	ldc.i4 28424
	add
	stloc 15
...
// 0x0101e540: 0x101e540: bne   v0, zero, 0x101e618 sll   zero, zero, 0
	...
	brtrue L_101e618
// --- basic block ---
// 0x0101e548: 0x101e548: lw    v0, 28388(s4)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x0101e558: 0x101e558: lw    v0, 24(s0)
	...
	ldelem.i4
	stloc 6
// 0x0101e55c: 0x101e55c: sw    zero, 28388(s4)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
	...
	ldc.i4.s 0
	stelem.i4
// 0x0101e560: 0x101e560: sw    v0, 28424(s2)
	ldloc 5
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0101e564: 0x101e564: lw    v0, 28(s0)
	...
	ldelem.i4
	stloc 6
// 0x0101e568: 0x101e568: sw    zero, 28400(s6)
	ldloc 5
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x0101e56c: 0x101e56c: sw    v0, 4(s7)
	...
	ldloc 6
	stelem.i4
// 0x0101e570: 0x101e570: sw    zero, 28392(s5)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x0101e604: 0x101e604: lw    a1, 20(sp)
	...
	ldelem.i4
	stloc.2
// 0x0101e608: 0x101e608: sw    s3, 28404(v1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101e624: 0x101e624: bne   s0, a1, 0x101e538 lui   v0, 0x30000
	...
	bne.un L_101e538
// --- basic block ---
// 0x0101e62c: 0x101e62c: lw    v0, 28404(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e68c: 0x101e68c: lw    s0, 32(sp)
	...
	ldelem.i4
	stloc 7
// 0x0101e690: 0x101e690: sw    v1, 28404(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e6c8: 0x101e6c8: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101e6cc: 0x101e6cc: lw    v0, 28388(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e6fc: 0x101e6fc: sw    s0, 56(sp)
	...
	ldloc 9
	stelem.i4
// 0x0101e700: 0x101e700: lw    s4, 28384(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101e710: 0x101e710: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101e714: 0x101e714: lw    v0, 28416(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e724: 0x101e724: lui   s8, 0x0
	ldc.i4.s 0
	stloc 16
// 0x0101e728: 0x101e728: addiu s0, s0, 29604
	ldloc 9
	ldc.i4 29604
	add
	stloc 9
// 0x0101e72c: 0x101e72c: addiu s5, s5, 6948
	ldloc 11
	ldc.i4 6948
	add
	stloc 11
...
// 0x0101e878: 0x101e878: beq   v0, zero, 0x101e94c sll   zero, zero, 0
	...
	brfalse L_101e94c
// --- basic block ---
// 0x0101e880: 0x101e880: jal   0x10bdaf0 sw    a1, 48(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl141::editor_screen_overide_car_10bdaf0(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 6
// --- basic block ---
...
// 0x0101e8a4: 0x101e8a4: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0101e8a8: 0x101e8a8: jal   0x10a1a6c sw    v0, 44(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101e8cc: 0x101e8cc: addiu a1, zero, 1
	ldc.i4.1
	stloc.2
// 0x0101e8d0: 0x101e8d0: jal   0x10a1a6c addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0101e9c0: 0x101e9c0: addu  a0, zero, zero
	...
	stloc.1
L_101e9c4:
// 0x0101e9c4: 0x101e9c4: jal   0x10a1a6c addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0101eaac: 0x101eaac: lw    v0, 32(sp)
	...
	ldelem.i4
	stloc 6
// 0x0101eab0: 0x101eab0: addiu v1, v1, 28416
	ldloc 7
	ldc.i4 28416
	add
	stloc 7
...
// 0x0101eabc: 0x101eabc: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101eac0: 0x101eac0: lw    a1, 28396(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101ead8: 0x101ead8: lui   a0, 0xe0000
	ldc.i4 917504
	stloc.1
// 0x0101eadc: 0x101eadc: addiu a0, a0, 29604
	ldloc.1
	ldc.i4 29604
	add
	stloc.1
...
// 0x0101ebe4: 0x101ebe4: jal   0x1021920 sw    zero, 28392(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101ec88: 0x101ec88: lui   s1, 0x30000
	ldc.i4 196608
	stloc 9
// 0x0101ec8c: 0x101ec8c: lw    v0, 28388(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101ecb8: 0x101ecb8: lui   v1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x0101ecbc: 0x101ecbc: sw    s0, 28388(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101ecc8: 0x101ecc8: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101eccc: 0x101eccc: lw    v0, 28384(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101ecd4: 0x101ecd4: beq   s0, v0, 0x101ecf4 lui   v0, 0x30000
	...
	beq  L_101ecf4
// --- basic block ---
// 0x0101ecdc: 0x101ecdc: lw    v0, 28392(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101ed68: 0x101ed68: sw    s0, 32(sp)
	...
	ldloc 8
	stelem.i4
// 0x0101ed6c: 0x101ed6c: lw    s0, 28392(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101eda0: 0x101eda0: lui   s3, 0x10000
	ldc.i4 65536
	stloc 9
// 0x0101eda4: 0x101eda4: addiu s5, v0, 28416
	ldloc 6
	ldc.i4 28416
	add
	stloc 14
...
// 0x0101edac: 0x101edac: addiu s3, s3, -29784
	...
	add
	stloc 9
// 0x0101edb0: 0x101edb0: lw    s8, 28416(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101ee6c: 0x101ee6c: jal   0x101de74 lui   s0, 0x30000
	...
	stloc 5
// --- basic block ---
// 0x0101ee74: 0x101ee74: beq   v0, zero, 0x101eea8 sw    v0, 28392(s0)
	ldloc 5
	ldloc 6
	ldloc 8
	ldc.i4.2
...
// 0x0101ee88: 0x101ee88: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101ee8c: 0x101ee8c: beq   v0, zero, 0x101eea4 sw    v0, 28400(v1)
	ldloc 5
	ldloc 6
	ldloc 7
	ldc.i4.2
...
// --- basic block ---
L_101eea4:
// 0x0101eea4: 0x101eea4: sw    zero, 28392(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101eecc: 0x101eecc: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101eed0: 0x101eed0: beq   v0, zero, 0x101eef8 sw    v0, 28400(v1)
	ldloc 5
	ldloc 7
	ldloc 6
	ldc.i4.2
...
// 0x0101eee4: 0x101eee4: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101eee8: 0x101eee8: beq   v0, zero, 0x101eef8 sw    v0, 28392(v1)
	ldloc 5
	ldloc 7
	ldloc 6
	ldc.i4.2
...
// 0x0101ef40: 0x101ef40: addiu s1, s1, 4892
	...
	add
	stloc 9
// 0x0101ef44: 0x101ef44: addiu s6, s6, 28416
	ldloc 13
	ldc.i4 28416
	add
	stloc 13
...
// 0x0101f004: 0x101f004: lui   s0, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101f008: 0x101f008: jal   0x100e368 sw    v0, 28384(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101f018: 0x101f018: bne   v0, zero, 0x101f024 sll   zero, zero, 0
	...
	brtrue L_101f024
// --- basic block ---
// 0x0101f020: 0x101f020: lw    v0, 28384(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
