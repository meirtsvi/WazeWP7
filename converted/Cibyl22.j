...
// 0x0101de44: 0x101de44: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101de48: 0x101de48: lw    v1, 28420(v0)
	ldloc 3
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0101de58: 0x101de58: lui   v0, 0x30000
	ldc.i4 196608
	stloc.0
// 0x0101de5c: 0x101de5c: addiu v0, v0, 28456
	ldloc.0
	ldc.i4 28456
	add
	stloc.0
...
// 0x0101de84: 0x101de84: addu  s2, a0, zero
	ldloc.1
	stloc 10
// 0x0101de88: 0x101de88: lw    v1, 28448(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 7
// 0x0101de8c: 0x101de8c: j	 0x101dea8 addiu s1, v0, 28448
	ldloc 6
	ldc.i4 28448
	add
	stloc 9
...
// 0x0101df9c: 0x101df9c: lui   s0, 0x0
	ldc.i4.s 0
	stloc 8
// 0x0101dfa0: 0x101dfa0: addiu v0, v1, 28448
	ldloc 7
	ldc.i4 28448
	add
	stloc 6
...
// 0x0101dfdc: 0x101dfdc: sw    v0, 28448(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101e068: 0x101e068: bne   v0, zero, 0x101e074 sll   zero, zero, 0
	...
	brtrue L_101e074
// --- basic block ---
// 0x0101e070: 0x101e070: sw    s0, 28416(s4)
	ldloc 5
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x0101e14c: 0x101e14c: addiu a1, a1, -8968
	...
	add
	stloc.2
// 0x0101e150: 0x101e150: jal   0x100f4ac sw    v0, 28444(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101e190: 0x101e190: sw    s0, 40(sp)
	...
	ldloc 9
	stelem.i4
// 0x0101e194: 0x101e194: lw    s0, 28420(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101e198: 0x101e198: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101e19c: 0x101e19c: lw    v0, 28416(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101e1b8: 0x101e1b8: lui   s1, 0x30000
	ldc.i4 196608
	stloc 8
// 0x0101e1bc: 0x101e1bc: lw    v0, 28424(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101e1f8: 0x101e1f8: jal   0x101aed8 addiu a0, zero, 84
	...
	stloc 5
// --- basic block ---
// 0x0101e200: 0x101e200: lw    a1, 28424(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101e284: 0x101e284: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101e288: 0x101e288: lw    a0, 28424(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101e290: 0x101e290: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101e294: 0x101e294: lw    t0, 28432(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 15
// 0x0101e298: 0x101e298: addiu a3, v0, 28448
	ldloc 5
	ldc.i4 28448
	add
	stloc 4
// 0x0101e29c: 0x101e29c: lw    v1, 28448(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101e2fc: 0x101e2fc: lui   s4, 0x30000
	ldc.i4 196608
	stloc 12
// 0x0101e300: 0x101e300: beq   a1, a0, 0x101e384 sw    a1, 28428(s4)
	ldloc.2
	ldloc.1
	ldloc 6
	ldloc 12
...
// 0x0101e314: 0x101e314: addu  s1, v0, zero
	ldloc 5
	stloc 8
// 0x0101e318: 0x101e318: lw    v0, 28428(s4)
	ldloc 6
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x0101e460: 0x101e460: addiu a0, zero, 68
	ldc.i4.s 68
	stloc.1
// 0x0101e464: 0x101e464: jal   0x101ae68 sw    zero, 28428(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101e494: 0x101e494: lui   v0, 0x30000
	...
	stloc 5
L_101e498:
// 0x0101e498: 0x101e498: lw    v0, 28444(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101e500: 0x101e500: addiu a1, v0, 28448
	ldloc 6
	ldc.i4 28448
	add
	stloc.2
// 0x0101e504: 0x101e504: addiu s1, s1, 29636
	ldloc 9
	ldc.i4 29636
	add
	stloc 9
// 0x0101e508: 0x101e508: lw    s0, 28448(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e518: 0x101e518: lui   s8, 0x0
	ldc.i4.s 0
	stloc 16
// 0x0101e51c: 0x101e51c: addiu s7, s2, 28456
	ldloc 10
	ldc.i4 28456
	add
	stloc 15
...
// 0x0101e534: 0x101e534: bne   v0, zero, 0x101e60c sll   zero, zero, 0
	...
	brtrue L_101e60c
// --- basic block ---
// 0x0101e53c: 0x101e53c: lw    v0, 28420(s4)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x0101e54c: 0x101e54c: lw    v0, 24(s0)
	...
	ldelem.i4
	stloc 6
// 0x0101e550: 0x101e550: sw    zero, 28420(s4)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
	...
	ldc.i4.s 0
	stelem.i4
// 0x0101e554: 0x101e554: sw    v0, 28456(s2)
	ldloc 5
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0101e558: 0x101e558: lw    v0, 28(s0)
	...
	ldelem.i4
	stloc 6
// 0x0101e55c: 0x101e55c: sw    zero, 28432(s6)
	ldloc 5
	ldloc 14
	ldc.i4.2
	shr.un
...
// 0x0101e560: 0x101e560: sw    v0, 4(s7)
	...
	ldloc 6
	stelem.i4
// 0x0101e564: 0x101e564: sw    zero, 28424(s5)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// 0x0101e5f8: 0x101e5f8: lw    a1, 20(sp)
	...
	ldelem.i4
	stloc.2
// 0x0101e5fc: 0x101e5fc: sw    s3, 28436(v1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101e618: 0x101e618: bne   s0, a1, 0x101e52c lui   v0, 0x30000
	...
	bne.un L_101e52c
// --- basic block ---
// 0x0101e620: 0x101e620: lw    v0, 28436(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e680: 0x101e680: lw    s0, 32(sp)
	...
	ldelem.i4
	stloc 7
// 0x0101e684: 0x101e684: sw    v1, 28436(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e6bc: 0x101e6bc: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101e6c0: 0x101e6c0: lw    v0, 28420(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e6f0: 0x101e6f0: sw    s0, 56(sp)
	...
	ldloc 9
	stelem.i4
// 0x0101e6f4: 0x101e6f4: lw    s4, 28416(v1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101e704: 0x101e704: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101e708: 0x101e708: lw    v0, 28448(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101e718: 0x101e718: lui   s8, 0x0
	ldc.i4.s 0
	stloc 16
// 0x0101e71c: 0x101e71c: addiu s0, s0, 29636
	ldloc 9
	ldc.i4 29636
	add
	stloc 9
...
// 0x0101eaa0: 0x101eaa0: lw    v0, 32(sp)
	...
	ldelem.i4
	stloc 6
// 0x0101eaa4: 0x101eaa4: addiu v1, v1, 28448
	ldloc 7
	ldc.i4 28448
	add
	stloc 7
...
// 0x0101eab0: 0x101eab0: lui   v0, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101eab4: 0x101eab4: lw    a1, 28428(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101eacc: 0x101eacc: lui   a0, 0xe0000
	ldc.i4 917504
	stloc.1
// 0x0101ead0: 0x101ead0: addiu a0, a0, 29636
	ldloc.1
	ldc.i4 29636
	add
	stloc.1
...
// 0x0101ebd8: 0x101ebd8: jal   0x1021914 sw    zero, 28424(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101ec7c: 0x101ec7c: lui   s1, 0x30000
	ldc.i4 196608
	stloc 9
// 0x0101ec80: 0x101ec80: lw    v0, 28420(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101ecac: 0x101ecac: lui   v1, 0x0
	ldc.i4.s 0
	stloc 7
// 0x0101ecb0: 0x101ecb0: sw    s0, 28420(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0101ecbc: 0x101ecbc: lui   v0, 0x30000
	ldc.i4 196608
	stloc 5
// 0x0101ecc0: 0x101ecc0: lw    v0, 28416(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101ecc8: 0x101ecc8: beq   s0, v0, 0x101ece8 lui   v0, 0x30000
	...
	beq  L_101ece8
// --- basic block ---
// 0x0101ecd0: 0x101ecd0: lw    v0, 28424(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0101ed5c: 0x101ed5c: sw    s0, 32(sp)
	...
	ldloc 8
	stelem.i4
// 0x0101ed60: 0x101ed60: lw    s0, 28424(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101ed94: 0x101ed94: lui   s3, 0x10000
	ldc.i4 65536
	stloc 9
// 0x0101ed98: 0x101ed98: addiu s5, v0, 28448
	ldloc 6
	ldc.i4 28448
	add
	stloc 14
...
// 0x0101eda0: 0x101eda0: addiu s3, s3, -29784
	...
	add
	stloc 9
// 0x0101eda4: 0x101eda4: lw    s8, 28448(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0101ee60: 0x101ee60: jal   0x101de68 lui   s0, 0x30000
	...
	stloc 5
// --- basic block ---
// 0x0101ee68: 0x101ee68: beq   v0, zero, 0x101ee9c sw    v0, 28424(s0)
	ldloc 5
	ldloc 6
	ldloc 8
	ldc.i4.2
...
// 0x0101ee7c: 0x101ee7c: lui   v1, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101ee80: 0x101ee80: beq   v0, zero, 0x101ee98 sw    v0, 28432(v1)
	ldloc 5
	ldloc 6
	ldloc 7
	ldc.i4.2
...
// --- basic block ---
L_101ee98:
// 0x0101ee98: 0x101ee98: sw    zero, 28424(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0101eec0: 0x101eec0: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101eec4: 0x101eec4: beq   v0, zero, 0x101eeec sw    v0, 28432(v1)
	ldloc 5
	ldloc 7
	ldloc 6
	ldc.i4.2
...
// 0x0101eed8: 0x101eed8: lui   v1, 0x30000
	ldc.i4 196608
	stloc 6
// 0x0101eedc: 0x101eedc: beq   v0, zero, 0x101eeec sw    v0, 28424(v1)
	ldloc 5
	ldloc 7
	ldloc 6
	ldc.i4.2
...
// 0x0101ef34: 0x101ef34: addiu s1, s1, 4892
	...
	add
	stloc 9
// 0x0101ef38: 0x101ef38: addiu s6, s6, 28448
	ldloc 13
	ldc.i4 28448
	add
	stloc 13
...
// 0x0101eff8: 0x101eff8: lui   s0, 0x30000
	ldc.i4 196608
	stloc 7
// 0x0101effc: 0x101effc: jal   0x100e368 sw    v0, 28416(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0101f00c: 0x101f00c: bne   v0, zero, 0x101f018 sll   zero, zero, 0
	...
	brtrue L_101f018
// --- basic block ---
// 0x0101f014: 0x101f014: lw    v0, 28416(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
