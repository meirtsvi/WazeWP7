...
// 0x0108f944: 0x108f944: lui   a1, 0xf0000
	ldc.i4 983040
	stloc.2
// 0x0108f948: 0x108f948: addiu v1, v1, -29760
	ldloc 5
	ldc.i4 -29760
	add
	stloc 5
// 0x0108f94c: 0x108f94c: addiu a1, a1, -27760
	ldloc.2
	ldc.i4 -27760
	add
	stloc.2
...
// 0x0108f9c0: 0x108f9c0: sw    s1, 24(sp)
	...
	ldloc 7
	stelem.i4
// 0x0108f9c4: 0x108f9c4: addiu s0, s0, -27756
	ldloc 5
	ldc.i4 -27756
	add
	stloc 5
...
// 0x0108f9d0: 0x108f9d0: sw    zero, 400(s0)
	...
	ldc.i4.s 0
	stelem.i4
// 0x0108f9d4: 0x108f9d4: addiu s1, s1, -27356
	ldloc 7
	ldc.i4 -27356
	add
	stloc 7
...
// 0x0108fa20: 0x108fa20: sw    s1, 24(sp)
	...
	ldloc 7
	stelem.i4
// 0x0108fa24: 0x108fa24: addiu s0, s0, -29760
	ldloc 5
	ldc.i4 -29760
	add
	stloc 5
...
// 0x0108fa30: 0x108fa30: sw    zero, 2000(s0)
	...
	ldc.i4.s 0
	stelem.i4
// 0x0108fa34: 0x108fa34: addiu s1, s1, -27760
	ldloc 7
	ldc.i4 -27760
	add
	stloc 7
...
// 0x0108fa74: 0x108fa74: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x0108fa78: 0x108fa78: lw    v0, -25352(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0108fa90: 0x108fa90: lui   v1, 0x80000
	ldc.i4 524288
	stloc 7
// 0x0108fa94: 0x108fa94: addiu v0, v1, 8744
	ldloc 7
	ldc.i4 8744
	add
	stloc 5
...
// 0x0108fab8: 0x108fab8: bne   a1, a0, 0x108fae8 lui   a0, 0x80000
	...
	bne.un L_108fae8
// --- basic block ---
// 0x0108fac0: 0x108fac0: lw    a0, 8744(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_108fae8:
// 0x0108fae8: 0x108fae8: addiu a0, a0, 8744
	ldloc.1
	ldc.i4 8744
	add
	stloc.1
...
// 0x0108fb00: 0x108fb00: lui   v0, 0x80000
	...
	stloc 5
L_108fb04:
// 0x0108fb04: 0x108fb04: lw    v0, 8740(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0108fb9c: 0x108fb9c: beq   v0, zero, 0x108fbc4 lui   v0, 0xf0000
	...
	brfalse L_108fbc4
// --- basic block ---
// 0x0108fba4: 0x108fba4: addiu v0, v0, -27352
	ldloc 5
	ldc.i4 -27352
	add
	stloc 5
...
// 0x0108fc08: 0x108fc08: beq   v0, zero, 0x108fd78 lui   s2, 0xf0000
	...
	brfalse L_108fd78
// --- basic block ---
// 0x0108fc10: 0x108fc10: addiu s2, s2, -27352
	ldloc 8
	ldc.i4 -27352
	add
	stloc 8
...
// 0x0108fcd0: 0x108fcd0: lui   s6, 0xf0000
	ldc.i4 983040
	stloc 12
// 0x0108fcd4: 0x108fcd4: addiu s7, s7, -29760
	ldloc 14
	ldc.i4 -29760
	add
	stloc 14
// 0x0108fcd8: 0x108fcd8: addiu s6, s6, -27760
	ldloc 12
	ldc.i4 -27760
	add
	stloc 12
...
// 0x0108fd6c: 0x108fd6c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0108fd70: 0x108fd70: jal   0x102148c sw    zero, 8736(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0108fde0: 0x108fde0: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x0108fde4: 0x108fde4: addiu v0, v0, -29760
	ldloc 5
	ldc.i4 -29760
	add
	stloc 5
// 0x0108fde8: 0x108fde8: lui   a1, 0xf0000
	ldc.i4 983040
	stloc.2
// 0x0108fdec: 0x108fdec: addiu a1, a1, -27760
	ldloc.2
	ldc.i4 -27760
	add
	stloc.2
...
// 0x0108fe5c: 0x108fe5c: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x0108fe60: 0x108fe60: addiu v0, v0, -29760
	ldloc 5
	ldc.i4 -29760
	add
	stloc 5
...
// --- basic block ---
L_108fe88:
// 0x0108fe88: 0x108fe88: addiu s0, s0, -29760
	ldloc 8
	ldc.i4 -29760
	add
	stloc 8
...
// 0x0108ff28: 0x108ff28: lui   a0, 0xf0000
	ldc.i4 983040
	stloc.1
// 0x0108ff2c: 0x108ff2c: addiu a0, a0, -27352
	ldloc.1
	ldc.i4 -27352
	add
	stloc.1
...
// 0x0108ffec: 0x108ffec: lui   a0, 0xf0000
	ldc.i4 983040
	stloc.1
// 0x0108fff0: 0x108fff0: addiu a0, a0, -27352
	ldloc.1
	ldc.i4 -27352
	add
	stloc.1
...
// 0x01090068: 0x1090068: lui   v1, 0x80000
	ldc.i4 524288
	stloc 6
// 0x0109006c: 0x109006c: sw    v0, 8740(v1)
	ldloc 8
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01090134: 0x1090134: addiu a2, zero, 250
	ldc.i4 250
	stloc.3
// 0x01090138: 0x1090138: addiu s2, s2, -27756
	ldloc 10
	ldc.i4 -27756
	add
	stloc 10
...
// 0x010901d4: 0x10901d4: addiu a1, zero, 1
	ldc.i4.1
	stloc.2
// 0x010901d8: 0x10901d8: jal   0x10a1a6c addu  a2, s0, zero
	ldloc 9
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01090200: 0x1090200: sw    zero, 24(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01090204: 0x1090204: jal   0x10a2dac sw    zero, 28(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01090224: 0x1090224: addiu a1, zero, 1
	ldc.i4.1
	stloc.2
// 0x01090228: 0x1090228: jal   0x10a1a6c addu  a2, s1, zero
	ldloc 8
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01090254: 0x1090254: sw    zero, 24(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01090258: 0x1090258: jal   0x10a2dac sw    zero, 28(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01090260: 0x1090260: lui   v0, 0xf0000
	...
	stloc 5
L_1090264:
// 0x01090264: 0x1090264: addiu v0, v0, -27756
	ldloc 5
	ldc.i4 -27756
	add
	stloc 5
...
// 0x01090318: 0x1090318: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 6
// 0x0109031c: 0x109031c: lw    v0, -27760(v0)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01090348: 0x1090348: lw    v0, 4(s0)
	...
	ldelem.i4
	stloc 6
// 0x0109034c: 0x109034c: addiu v1, v1, -27756
	ldloc 5
	ldc.i4 -27756
	add
	stloc 5
// 0x01090350: 0x1090350: addiu a0, a0, -27356
	ldloc.1
	ldc.i4 -27356
	add
	stloc.1
...
// 0x0109039c: 0x109039c: lui   v1, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x010903a0: 0x10903a0: addiu v1, v1, -29760
	ldloc 5
	ldc.i4 -29760
	add
	stloc 5
...
// 0x010903d0: 0x10903d0: lui   v1, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x010903d4: 0x10903d4: addiu v1, v1, -29760
	ldloc 5
	ldc.i4 -29760
	add
	stloc 5
...
// 0x01090490: 0x1090490: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01090494: 0x1090494: lw    v0, 8760(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109049c: 0x109049c: beq   v0, zero, 0x10904f8 lui   a3, 0x10810000
	...
	brfalse L_10904f8
// --- basic block ---
// 0x010904a4: 0x10904a4: jal   0x1094100 sll   zero, zero, 0
...
// 0x010904ac: 0x10904ac: beq   v0, zero, 0x10904e0 lui   a0, 0x20000
	...
	brfalse L_10904e0
// --- basic block ---
// 0x010904b4: 0x10904b4: jal   0x1094100 sll   zero, zero, 0
	call int32 Cibyl110::ssd_dialog_currently_active_name_1094100()
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 7
	stloc 5
...
// 0x010904cc: 0x10904cc: bne   v0, zero, 0x10904e0 lui   a0, 0x20000
	...
	brtrue L_10904e0
// --- basic block ---
// 0x010904d4: 0x10904d4: jal   0x1094ca4 addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010904e0: 0x10904e0: addiu a0, a0, -4160
	...
	add
	stloc.1
// 0x010904e4: 0x10904e4: jal   0x1094358 addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x010904ec: 0x10904ec: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010904f0: 0x10904f0: sw    zero, 8760(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109050c: 0x109050c: addiu a1, a1, 18656
	...
	add
	stloc.2
// 0x01090510: 0x1090510: jal   0x1095b48 addiu a2, a2, 1752
	ldloc.3
	ldc.i4 1752
	add
	stloc.3
...
// 0x01090524: 0x1090524: addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
// 0x01090528: 0x1090528: jal   0x1094428 sw    v0, 8760(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01090568: 0x1090568: addiu v0, zero, 17
	ldc.i4.s 17
	stloc 5
// 0x0109056c: 0x109056c: jal   0x1093b64 sw    v0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01090590: 0x1090590: lui   s3, 0x80000
	ldc.i4 524288
	stloc 8
// 0x01090594: 0x1090594: jal   0x1099134 sw    s0, 116(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// --- basic block ---
// 0x0109059c: 0x109059c: lw    a0, 8760(s3)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x010905a0: 0x10905a0: jal   0x1099018 addu  a1, s2, zero
	ldloc 10
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x010905a8: 0x10905a8: lw    v0, 20(s0)
	...
	ldelem.i4
	stloc 5
// 0x010905ac: 0x10905ac: lw    s3, 8760(s3)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010905c4: 0x10905c4: addiu a1, a1, 1624
	...
	add
	stloc.2
// 0x010905c8: 0x10905c8: jal   0x10992c8 addu  a0, s3, zero
	ldloc 8
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x010905e8: 0x10905e8: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x010905ec: 0x10905ec: jal   0x10992c8 addu  a0, s3, zero
	ldloc 8
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x010905f8: 0x10905f8: addiu a1, s1, 18656
	...
	stloc.2
L_10905fc:
// 0x010905fc: 0x10905fc: jal   0x109b588 lui   s0, 0x20000
	ldc.i4 131072
	stloc 9
	ldloc.0
	ldloc.1
...
// 0x01090604: 0x1090604: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x01090608: 0x1090608: jal   0x1096040 addiu a0, s0, -4160
	ldloc 9
	ldc.i4 -4160
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x01090610: 0x1090610: jal   0x1095918 addiu a0, s0, -4160
	ldloc 9
	ldc.i4 -4160
	add
	stloc.1
...
// 0x01090618: 0x1090618: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109061c: 0x109061c: lw    a0, 8760(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01090620: 0x1090620: addiu a1, sp, 24
	...
	add
	stloc.2
// 0x01090624: 0x1090624: jal   0x10994a4 addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01090630: 0x1090630: addiu a1, sp, 32
	...
	add
	stloc.2
// 0x01090634: 0x1090634: jal   0x10994a4 addu  a2, zero, zero
	ldc.i4.s 0
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x0109068c: 0x109068c: sw    v0, 24(sp)
	...
	ldloc 5
	stelem.i4
// 0x01090690: 0x1090690: jal   0x10949c4 sw    a2, 48(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01090884: 0x1090884: addiu a2, a2, -4096
	...
	add
	stloc.3
// 0x01090888: 0x1090888: addiu a0, s2, 8764
	ldloc 8
	ldc.i4 8764
	add
	stloc.1
...
// 0x010908c4: 0x10908c4: addiu a0, sp, 72
	...
	add
	stloc.1
// 0x010908c8: 0x10908c8: addiu a1, s2, 8764
	ldloc 8
	ldc.i4 8764
	add
	stloc.2
...
// 0x01090918: 0x1090918: lui   v0, 0xf0000
	ldc.i4 983040
	stloc.0
// 0x0109091c: 0x109091c: lw    v0, -23348(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01090928: 0x1090928: lui   v0, 0xf0000
	ldc.i4 983040
	stloc.1
// 0x0109092c: 0x109092c: addiu v0, v0, -25348
	ldloc.1
	ldc.i4 -25348
	add
	stloc.1
...
// 0x01090944: 0x1090944: lui   v0, 0xf0000
	ldc.i4 983040
	stloc.0
// 0x01090948: 0x1090948: lw    v0, -23348(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x010909e4: 0x10909e4: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x010909e8: 0x10909e8: addiu v0, v0, -25348
	ldloc 5
	ldc.i4 -25348
	add
	stloc 5
...
// 0x01090a70: 0x1090a70: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01090a74: 0x1090a74: addiu a0, a0, -25348
	ldloc.1
	ldc.i4 -25348
	add
	stloc.1
...
// 0x01090b24: 0x1090b24: lui   a1, 0x10000
	ldc.i4 65536
	stloc.2
// 0x01090b28: 0x1090b28: jal   0x109b458 addiu a1, a1, -32492
	ldloc.2
	ldc.i4 -32492
	add
	stloc.2
...
// 0x01090b3c: 0x1090b3c: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01090b40: 0x1090b40: jal   0x1099134 addu  a2, a1, zero
	ldloc.2
	stloc.3
	ldloc.1
	ldloc.2
...
// 0x01090b78: 0x1090b78: lui   a1, 0x10000
	ldc.i4 65536
	stloc.2
// 0x01090b7c: 0x1090b7c: jal   0x109b458 addiu a1, a1, -32492
	ldloc.2
	ldc.i4 -32492
	add
	stloc.2
...
// 0x01090b90: 0x1090b90: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01090b94: 0x1090b94: jal   0x1099134 addu  a2, a1, zero
	ldloc.2
	stloc.3
	ldloc.1
	ldloc.2
...
// --- basic block ---
L_1090c38:
// 0x01090c38: 0x1090c38: jal   0x10a1a6c sw    a3, 16(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
