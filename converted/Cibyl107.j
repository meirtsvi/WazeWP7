...
// 0x0108f8f8: 0x108f8f8: jal   0x100e368 addiu a0, a0, 17452
	ldloc.1
	ldc.i4 17452
	add
	stloc.1
...
// 0x0108f91c: 0x108f91c: jal   0x100e368 addiu a0, a0, 17436
	ldloc.1
	ldc.i4 17436
	add
	stloc.1
...
// 0x0108fd64: 0x108fd64: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0108fd68: 0x108fd68: addiu a1, a1, 17436
	ldloc.2
	ldc.i4 17436
	add
	stloc.2
...
// 0x0108fdcc: 0x108fdcc: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x0108fdd0: 0x108fdd0: addiu a1, a1, 17420
	ldloc.2
	ldc.i4 17420
	add
	stloc.2
...
// 0x0108fde8: 0x108fde8: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x0108fdec: 0x108fdec: addiu a1, a1, 17404
	ldloc.2
	ldc.i4 17404
	add
	stloc.2
...
// 0x0108fe08: 0x108fe08: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x0108fe0c: 0x108fe0c: addiu a1, a1, 17452
	ldloc.2
	ldc.i4 17452
	add
	stloc.2
...
// 0x010904a0: 0x10904a0: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x010904a4: 0x10904a4: addiu v1, a0, 17468
	ldloc.1
	ldc.i4 17468
	add
	stloc 7
// 0x010904a8: 0x10904a8: sw    ra, 20(sp)
// 0x010904ac: 0x10904ac: sw    v0, 17468(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x0109050c: 0x109050c: beq   s0, zero, 0x10906a8 lui   v0, 0x0
	...
	brfalse L_10906a8
// --- basic block ---
// 0x01090514: 0x1090514: lw    v1, 17468(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01090520: 0x1090520: bne   v1, a0, 0x1090564 addiu v0, v0, 17468
	ldloc 7
	ldloc.1
	ldloc 6
	ldc.i4 17468
...
// 0x01090568: 0x1090568: beq   v1, v0, 0x10905ac lui   v1, 0x0
	...
	beq  L_10905ac
// --- basic block ---
// 0x01090570: 0x1090570: addiu v1, v1, 17468
	ldloc 7
	ldc.i4 17468
	add
	stloc 7
...
// 0x010905b0: 0x10905b0: addu  a1, s2, zero
	...
	stloc.2
L_10905b4:
// 0x010905b4: 0x10905b4: addiu a0, a0, 17468
	ldloc.1
	ldc.i4 17468
	add
	stloc.1
