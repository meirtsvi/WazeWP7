...
// 0x01001990: 0x1001990: jal   0x10018cc addiu a2, a2, 30432
	ldloc.3
	ldc.i4 30432
	add
	stloc.3
...
// 0x01002090: 0x1002090: addu  s0, zero, zero
	ldc.i4.s 0
	stloc 8
// 0x01002094: 0x1002094: j	 0x10020e8 addiu s2, s5, 30708
	ldloc 12
	ldc.i4 30708
	add
	stloc 10
...
// 0x0100209c: 0x100209c: lw    a0, 4(s2)
	...
	ldelem.i4
	stloc.1
// 0x010020a0: 0x10020a0: lw    v1, 30708(s5)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x01002578: 0x1002578: addu  s2, zero, zero
	ldc.i4.s 0
	stloc 10
// 0x0100257c: 0x100257c: j	 0x10025c8 addiu s4, s5, 30692
	ldloc 13
	ldc.i4 30692
	add
	stloc 12
...
// 0x01002584: 0x1002584: lw    a0, 4(s4)
	...
	ldelem.i4
	stloc.1
// 0x01002588: 0x1002588: lw    v1, 30692(s5)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10025ec:
// 0x010025ec: 0x10025ec: lw    s0, 30700(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010027ac: 0x10027ac: addu  a3, a2, zero
	ldloc.3
	stloc 4
// 0x010027b0: 0x10027b0: addiu a0, a0, 30708
	ldloc.1
	ldc.i4 30708
	add
	stloc.1
...
// 0x010027e4: 0x10027e4: addu  a3, a2, zero
	ldloc.3
	stloc 4
// 0x010027e8: 0x10027e8: addiu a0, a0, 30692
	ldloc.1
	ldc.i4 30692
	add
	stloc.1
...
// 0x01002918: 0x1002918: lw    s0, 24(sp)
	...
	ldelem.i4
	stloc 8
// 0x0100291c: 0x100291c: sw    v1, 30724(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01002928: 0x1002928: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100292c: 0x100292c: lw    v0, 30724(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01002984: 0x1002984: jal   0x106b36c addu  a0, v0, zero
	...
	stloc 5
// --- basic block ---
// 0x0100298c: 0x100298c: lw    v0, 30728(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100299c: 0x100299c: jalr  v0 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x010029a4: 0x10029a4: sw    zero, 30728(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010029c0: 0x10029c0: sw    s2, 44(sp)
	...
	ldloc 8
	stelem.i4
// 0x010029c4: 0x10029c4: lw    s2, -30068(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010029cc: 0x10029cc: sw    s1, 40(sp)
	...
	ldloc 9
	stelem.i4
// 0x010029d0: 0x10029d0: lw    s1, -30072(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01002a00: 0x1002a00: beq   v0, zero, 0x1002a20 lui   v1, 0x20000
	...
	brfalse L_1002a20
// --- basic block ---
// 0x01002a08: 0x1002a08: beq   a0, zero, 0x1002a24 addiu v1, v1, 24376
	ldloc.1
	ldloc 6
	ldc.i4 24376
	add
...
// 0x01002a1c: 0x1002a1c: lui   v1, 0x20000
	...
	stloc 6
L_1002a20:
// 0x01002a20: 0x1002a20: addiu v1, v1, 24376
	ldloc 6
	ldc.i4 24376
	add
	stloc 6
...
// 0x01002a74: 0x1002a74: sll   v0, v0, 4
	...
	shl
	stloc 5
// 0x01002a78: 0x1002a78: addiu v1, v1, 24364
	ldloc 6
	ldc.i4 24364
	add
	stloc 6
...
// 0x01002ae4: 0x1002ae4: addu  a3, s1, zero
	ldloc 9
	stloc 4
// 0x01002ae8: 0x1002ae8: jal   0x1000f64 addiu a0, s0, 30732
	ldloc 10
	ldc.i4 30732
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x01002af0: 0x1002af0: j	 0x1002b14 addiu v0, s0, 30732
	ldloc 10
	ldc.i4 30732
	add
	stloc 5
...
// 0x01002b04: 0x1002b04: addu  a3, s1, zero
	ldloc 9
	stloc 4
// 0x01002b08: 0x1002b08: jal   0x1000f64 addiu a0, s0, 30784
	ldloc 10
	ldc.i4 30784
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x01002b10: 0x1002b10: addiu v0, s0, 30784
	ldloc 10
	ldc.i4 30784
	add
	stloc 5
...
// 0x01002c38: 0x1002c38: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01002c3c: 0x1002c3c: lw    v0, 30724(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
