...
// 0x01001990: 0x1001990: jal   0x10018cc addiu a2, a2, 30528
	ldloc.3
	ldc.i4 30528
	add
	stloc.3
...
// 0x01002090: 0x1002090: addu  s0, zero, zero
	ldc.i4.s 0
	stloc 8
// 0x01002094: 0x1002094: j	 0x10020e8 addiu s2, s5, 30804
	ldloc 12
	ldc.i4 30804
	add
	stloc 10
...
// 0x0100209c: 0x100209c: lw    a0, 4(s2)
	...
	ldelem.i4
	stloc.1
// 0x010020a0: 0x10020a0: lw    v1, 30804(s5)
	ldloc 5
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x01002318: 0x1002318: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0100231c: 0x100231c: jal   0x10001a0 addiu a0, a0, 20732
	ldloc.1
	ldc.i4 20732
	add
	stloc.1
...
// 0x0100250c: 0x100250c: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01002510: 0x1002510: jal   0x10001a0 addiu a0, a0, 20752
	ldloc.1
	ldc.i4 20752
	add
	stloc.1
...
// 0x01002578: 0x1002578: addu  s2, zero, zero
	ldc.i4.s 0
	stloc 10
// 0x0100257c: 0x100257c: j	 0x10025c8 addiu s4, s5, 30788
	ldloc 13
	ldc.i4 30788
	add
	stloc 12
...
// 0x01002584: 0x1002584: lw    a0, 4(s4)
	...
	ldelem.i4
	stloc.1
// 0x01002588: 0x1002588: lw    v1, 30788(s5)
	ldloc 5
	ldloc 13
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10025ec:
// 0x010025ec: 0x10025ec: lw    s0, 30796(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01002714: 0x1002714: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x01002718: 0x1002718: jal   0x10001f8 addiu a1, a1, 20780
	ldloc.2
	ldc.i4 20780
	add
	stloc.2
...
// 0x010027ac: 0x10027ac: addu  a3, a2, zero
	ldloc.3
	stloc 4
// 0x010027b0: 0x10027b0: addiu a0, a0, 30804
	ldloc.1
	ldc.i4 30804
	add
	stloc.1
...
// 0x010027e4: 0x10027e4: addu  a3, a2, zero
	ldloc.3
	stloc 4
// 0x010027e8: 0x10027e8: addiu a0, a0, 30788
	ldloc.1
	ldc.i4 30788
	add
	stloc.1
...
// 0x0100280c: 0x100280c: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x01002810: 0x1002810: lw    v1, -29976(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01002814: 0x1002814: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x01002818: 0x1002818: lw    v0, -29972(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0100282c: 0x100282c: lui   a2, 0x0
	ldc.i4.s 0
	stloc.3
// 0x01002830: 0x1002830: j	 0x1002840 addiu a2, a2, 20840
	ldloc.3
	ldc.i4 20840
	add
	stloc.3
...
// 0x01002838: 0x1002838: lui   a2, 0x0
	ldc.i4.s 0
	stloc.3
// 0x0100283c: 0x100283c: addiu a2, a2, 20848
	ldloc.3
	ldc.i4 20848
	add
	stloc.3
...
// 0x01002840: 0x1002840: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x01002844: 0x1002844: jal   0x10a18c8 addiu a1, zero, 19
	ldc.i4.s 19
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01002864: 0x1002864: sw    zero, 16(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x01002868: 0x1002868: jal   0x104f78c sw    zero, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01002870: 0x1002870: lw    v0, 24(sp)
	...
	ldelem.i4
	stloc 5
// 0x01002874: 0x1002874: jal   0x104eea4 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x0100287c: 0x100287c: jal   0x104e550 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x010028a4: 0x10028a4: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x010028a8: 0x10028a8: addiu a0, s0, 18432
	ldloc 8
	ldc.i4 18432
	add
	stloc.1
// 0x010028ac: 0x10028ac: addiu a1, a1, 144
	...
	add
	stloc.2
// 0x010028b0: 0x10028b0: addiu a2, a2, 18684
	ldloc.3
	ldc.i4 18684
	add
	stloc.3
// 0x010028b4: 0x10028b4: sw    ra, 28(sp)
// 0x010028b8: 0x10028b8: jal   0x100ee78 addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x010028c4: 0x10028c4: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x010028c8: 0x10028c8: addiu a0, s0, 18432
	ldloc 8
	ldc.i4 18432
	add
	stloc.1
// 0x010028cc: 0x10028cc: addiu a1, a1, 160
	...
	add
	stloc.2
// 0x010028d0: 0x10028d0: addiu a2, a2, 9724
	ldloc.3
	ldc.i4 9724
	add
	stloc.3
// 0x010028d4: 0x10028d4: jal   0x100ee78 addu  a3, zero, zero
	ldc.i4.s 0
	stloc 4
	ldloc.0
	ldloc.1
...
// 0x010028e8: 0x10028e8: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010028ec: 0x10028ec: addiu v0, v0, 20864
	ldloc 5
	ldc.i4 20864
	add
	stloc 5
// 0x010028f0: 0x10028f0: addiu a0, a0, 12744
	ldloc.1
	ldc.i4 12744
	add
	stloc.1
// 0x010028f4: 0x10028f4: addiu a1, a1, 176
	...
	add
	stloc.2
// 0x010028f8: 0x10028f8: addiu a3, a3, 9368
	ldloc 4
	ldc.i4 9368
	add
	stloc 4
...
// 0x01002900: 0x1002900: sw    v0, 16(sp)
	...
	ldloc 5
	stelem.i4
// 0x01002904: 0x1002904: jal   0x100eec0 sw    zero, 20(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01002918: 0x1002918: lw    s0, 24(sp)
	...
	ldelem.i4
	stloc 8
// 0x0100291c: 0x100291c: sw    v1, 30820(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01002928: 0x1002928: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100292c: 0x100292c: lw    v0, 30820(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01002944: 0x1002944: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01002948: 0x1002948: jal   0x100e410 addiu a0, a0, 144
	ldloc.1
	ldc.i4 144
	add
	stloc.1
...
// 0x01002974: 0x1002974: jal   0x105017c sw    s0, 16(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0100297c: 0x100297c: jal   0x1002928 lui   s0, 0x20000
	...
	stloc 5
// --- basic block ---
// 0x01002984: 0x1002984: jal   0x106b53c addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
	...
	ldloc.3
	ldloc 4
	call int32 Cibyl79::Realtime_NotifySplashUpdateTime_106b53c(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 8
	stloc 5
// --- basic block ---
// 0x0100298c: 0x100298c: lw    v0, 30824(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0100299c: 0x100299c: jalr  v0 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x010029a4: 0x10029a4: sw    zero, 30824(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010029c0: 0x10029c0: sw    s2, 44(sp)
	...
	ldloc 8
	stelem.i4
// 0x010029c4: 0x10029c4: lw    s2, -29972(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010029cc: 0x10029cc: sw    s1, 40(sp)
	...
	ldloc 9
	stelem.i4
// 0x010029d0: 0x10029d0: lw    s1, -29976(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01002a00: 0x1002a00: beq   v0, zero, 0x1002a20 lui   v1, 0x20000
	...
	brfalse L_1002a20
// --- basic block ---
// 0x01002a08: 0x1002a08: beq   a0, zero, 0x1002a24 addiu v1, v1, 24136
	ldloc.1
	ldloc 6
	ldc.i4 24136
	add
...
// 0x01002a1c: 0x1002a1c: lui   v1, 0x20000
	...
	stloc 6
L_1002a20:
// 0x01002a20: 0x1002a20: addiu v1, v1, 24136
	ldloc 6
	ldc.i4 24136
	add
	stloc 6
...
// 0x01002a74: 0x1002a74: sll   v0, v0, 4
	...
	shl
	stloc 5
// 0x01002a78: 0x1002a78: addiu v1, v1, 24124
	ldloc 6
	ldc.i4 24124
	add
	stloc 6
...
// 0x01002aa8: 0x1002aa8: lui   a3, 0x0
	...
	stloc 4
L_1002aac:
// 0x01002aac: 0x1002aac: addiu a1, a1, 20868
	ldloc.2
	ldc.i4 20868
	add
	stloc.2
// 0x01002ab0: 0x1002ab0: addiu a3, a3, 20896
	ldloc 4
	ldc.i4 20896
	add
	stloc 4
...
// 0x01002ad8: 0x1002ad8: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x01002adc: 0x1002adc: addiu a1, a1, 20964
	ldloc.2
	ldc.i4 20964
	add
	stloc.2
...
// 0x01002ae4: 0x1002ae4: addu  a3, s1, zero
	ldloc 9
	stloc 4
// 0x01002ae8: 0x1002ae8: jal   0x1000f64 addiu a0, s0, 30828
	ldloc 10
	ldc.i4 30828
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x01002af0: 0x1002af0: j	 0x1002b14 addiu v0, s0, 30828
	ldloc 10
	ldc.i4 30828
	add
	stloc 5
...
// 0x01002af8: 0x1002af8: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x01002afc: 0x1002afc: addiu a1, a1, 20984
	ldloc.2
	ldc.i4 20984
	add
	stloc.2
...
// 0x01002b04: 0x1002b04: addu  a3, s1, zero
	ldloc 9
	stloc 4
// 0x01002b08: 0x1002b08: jal   0x1000f64 addiu a0, s0, 30880
	ldloc 10
	ldc.i4 30880
	add
	stloc.1
	...
	stloc 5
// --- basic block ---
// 0x01002b10: 0x1002b10: addiu v0, s0, 30880
	ldloc 10
	ldc.i4 30880
	add
	stloc 5
...
// 0x01002b54: 0x1002b54: lui   a3, 0x0
	ldc.i4.s 0
	stloc 4
// 0x01002b58: 0x1002b58: addiu a1, a1, 20868
	ldloc.2
	ldc.i4 20868
	add
	stloc.2
// 0x01002b5c: 0x1002b5c: addiu a3, a3, 21000
	ldloc 4
	ldc.i4 21000
	add
	stloc 4
...
// 0x01002b84: 0x1002b84: beq   v1, zero, 0x1002b94 addu  v0, zero, zero
	...
	brfalse L_1002b94
// --- basic block ---
// 0x01002b8c: 0x1002b8c: jal   0x106a8d4 addu  a0, s1, zero
	ldloc 9
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01002bac: 0x1002bac: addu  a1, s0, zero
	ldloc 8
	stloc.2
// 0x01002bb0: 0x1002bb0: addiu a2, a2, 20840
	ldloc.3
	ldc.i4 20840
	add
	stloc.3
// 0x01002bb4: 0x1002bb4: addiu a3, a3, 18684
	ldloc 4
	ldc.i4 18684
	add
	stloc 4
...
// 0x01002bc0: 0x1002bc0: sw    v0, 24(sp)
	...
	ldloc 5
	stelem.i4
// 0x01002bc4: 0x1002bc4: jal   0x10a2c08 sw    zero, 28(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01002bcc: 0x1002bcc: lui   a0, 0x1000000
	...
	stloc.1
L_1002bd0:
// 0x01002bd0: 0x1002bd0: jal   0x104ffe4 addiu a0, a0, 11056
	ldloc.1
	ldc.i4 11056
	add
	stloc.1
...
// 0x01002c20: 0x1002c20: jal   0x100e850 addiu a0, a0, 160
	ldloc.1
	ldc.i4 160
	add
	stloc.1
...
// 0x01002c38: 0x1002c38: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01002c3c: 0x1002c3c: lw    v0, 30820(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01002c5c: 0x1002c5c: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01002c60: 0x1002c60: jal   0x100e688 addiu a0, a0, 144
	ldloc.1
	ldc.i4 144
	add
	stloc.1
