...
// 0x0108e5a0: 0x108e5a0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 6
// 0x0108e5a4: 0x108e5a4: lw    a0, -648(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0108e5c0: 0x108e5c0: lui   s0, 0x80000
	ldc.i4 524288
	stloc 7
// 0x0108e5c4: 0x108e5c4: lw    a0, -644(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0108e5c8: 0x108e5c8: lui   v0, 0x80000
	ldc.i4 524288
	stloc 6
// 0x0108e5cc: 0x108e5cc: beq   a0, zero, 0x108e5e0 sw    zero, -648(v0)
	ldloc.1
	ldloc 5
	ldloc 6
	ldc.i4.2
...
// 0x0108e5d4: 0x108e5d4: jal   0x104c690 sll   zero, zero, 0
	...
	stloc 6
// --- basic block ---
// 0x0108e5dc: 0x108e5dc: sw    zero, -644(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0108e638: 0x108e638: sw    v0, -644(s0)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0108e648: 0x108e648: lui   v0, 0x80000
	ldc.i4 524288
	stloc.0
// 0x0108e64c: 0x108e64c: lw    v0, 8684(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108e658: 0x108e658: lui   v0, 0x80000
	ldc.i4 524288
	stloc.0
// 0x0108e65c: 0x108e65c: jr    ra sw    zero, 8684(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108e6b0: 0x108e6b0: lui   v0, 0x80000
	ldc.i4 524288
	stloc.1
// 0x0108e6b4: 0x108e6b4: addiu v0, v0, -636
	ldloc.1
	ldc.i4 -636
	add
	stloc.1
...
// 0x0108e6cc: 0x108e6cc: lui   v0, 0x80000
	ldc.i4 524288
	stloc.1
// 0x0108e6d0: 0x108e6d0: addiu v0, v0, 164
	ldloc.1
	ldc.i4 164
	add
	stloc.1
...
// 0x0108e6e0: 0x108e6e0: lui   v0, 0x80000
	ldc.i4 524288
	stloc.0
// 0x0108e6e4: 0x108e6e4: lw    v0, 152(v0)
	ldloc 2
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108e6f4: 0x108e6f4: lui   v0, 0x80000
	ldc.i4 524288
	stloc.0
// 0x0108e6f8: 0x108e6f8: jr    ra sw    v1, -640(v0)
	ldloc 3
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108e8e4: 0x108e8e4: beq   v0, zero, 0x108e920 sll   zero, zero, 0
	...
	brfalse L_108e920
// --- basic block ---
// 0x0108e8ec: 0x108e8ec: jal   0x1094c0c addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0108e94c: 0x108e94c: sw    s4, 128(sp)
	...
	ldloc 9
	stelem.i4
// 0x0108e950: 0x108e950: sw    zero, -640(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0108ea6c: 0x108ea6c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 6
// 0x0108ea70: 0x108ea70: lw    v0, -640(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0108eb6c: 0x108eb6c: addiu a2, zero, 160
	ldc.i4 160
	stloc.3
// 0x0108eb70: 0x108eb70: addiu s2, s2, -636
	ldloc 7
	ldc.i4 -636
	add
	stloc 7
...
// 0x0108ebc0: 0x108ebc0: addiu a0, a0, -29724
	...
	add
	stloc.1
// 0x0108ebc4: 0x108ebc4: addiu a1, a1, 144
	ldloc.2
	ldc.i4 144
	add
	stloc.2
...
// 0x0108ebdc: 0x108ebdc: addiu a0, a0, -29736
	...
	add
	stloc.1
// 0x0108ebe0: 0x108ebe0: jal   0x101f78c addiu a1, a1, 136
	ldloc.2
	ldc.i4 136
	add
	stloc.2
...
// 0x0108ec98: 0x108ec98: addiu a2, zero, 135
	ldc.i4 135
	stloc.3
// 0x0108ec9c: 0x108ec9c: addiu s2, s2, -636
	ldloc 6
	ldc.i4 -636
	add
	stloc 6
...
// 0x0108ed20: 0x108ed20: lui   s0, 0x80000
	ldc.i4 524288
	stloc 6
// 0x0108ed24: 0x108ed24: addiu s0, s0, -636
	ldloc 6
	ldc.i4 -636
	add
	stloc 6
...
// 0x0108f00c: 0x108f00c: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 4
// 0x0108f010: 0x108f010: addiu v0, v0, -29600
	ldloc 4
	ldc.i4 -29600
	add
	stloc 4
...
// 0x0108f01c: 0x108f01c: lw    a3, 0(a1)
	...
	ldelem.i4
	stloc.3
// 0x0108f020: 0x108f020: addiu a2, a2, -27600
	ldloc.2
	ldc.i4 -27600
	add
	stloc.2
...
// 0x0108f1c8: 0x108f1c8: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x0108f1cc: 0x108f1cc: addiu v1, v1, 29764
	ldloc 5
	ldc.i4 29764
	add
	stloc 5
...
// 0x0108f35c: 0x108f35c: lui   s0, 0xf0000
	ldc.i4 983040
	stloc 7
// 0x0108f360: 0x108f360: addiu s0, s0, -29600
	ldloc 7
	ldc.i4 -29600
	add
	stloc 7
...
// 0x0108f3b4: 0x108f3b4: bne   v0, zero, 0x108f37c lui   a0, 0xf0000
	...
	brtrue L_108f37c
// --- basic block ---
// 0x0108f3bc: 0x108f3bc: addiu a0, a0, -27192
	ldloc.1
	ldc.i4 -27192
	add
	stloc.1
...
// 0x0108f3e0: 0x108f3e0: lw    s0, 16(sp)
	...
	ldelem.i4
	stloc 7
// 0x0108f3e4: 0x108f3e4: sw    v1, 8688(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0108f3f0: 0x108f3f0: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x0108f3f4: 0x108f3f4: lw    v0, -29908(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0108f408: 0x108f408: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x0108f40c: 0x108f40c: lw    v0, -29912(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0108f53c: 0x108f53c: sw    v1, 48(sp)
	...
	ldloc 7
	stelem.i4
// 0x0108f540: 0x108f540: jal   0x10a1aa4 sw    v0, 40(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108f640: 0x108f640: addu  a0, zero, zero
	ldc.i4.s 0
	stloc.1
// 0x0108f644: 0x108f644: jal   0x10a1aa4 addiu a1, zero, 1
	ldc.i4.1
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x0108f780: 0x108f780: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0108f784: 0x108f784: lw    v0, 8688(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0108f78c: 0x108f78c: bne   v0, zero, 0x108f8fc lui   s1, 0xf0000
	...
	brtrue L_108f8fc
// --- basic block ---
// 0x0108f794: 0x108f794: addiu s1, s1, -27192
	ldloc 9
	ldc.i4 -27192
	add
	stloc 9
...
// 0x0108f79c: 0x108f79c: lui   s7, 0xf0000
	ldc.i4 983040
	stloc 11
// 0x0108f7a0: 0x108f7a0: addiu s8, s8, -29600
	ldloc 15
	ldc.i4 -29600
	add
	stloc 15
// 0x0108f7a4: 0x108f7a4: addiu s7, s7, -27600
	ldloc 11
	ldc.i4 -27600
	add
	stloc 11
...
// 0x0108f854: 0x108f854: lui   s4, 0xf0000
	ldc.i4 983040
	stloc 10
// 0x0108f858: 0x108f858: addiu s7, s7, -27192
	ldloc 11
	ldc.i4 -27192
	add
	stloc 11
// 0x0108f85c: 0x108f85c: addiu s6, s6, -29600
	ldloc 14
	ldc.i4 -29600
	add
	stloc 14
// 0x0108f860: 0x108f860: addiu s4, s4, -27600
	ldloc 10
	ldc.i4 -27600
	add
	stloc 10
