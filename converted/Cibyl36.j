...
// 0x01031be8: 0x1031be8: lw    a0, 20(s2)
	...
	ldelem.i4
	stloc.1
// 0x01031bec: 0x1031bec: jal   0x10c09c4 addiu s0, s0, -17992
	ldloc 7
	ldc.i4 -17992
	add
	stloc 7
...
// 0x01031c00: 0x1031c00: lw    a0, 24(s2)
	...
	ldelem.i4
	stloc.1
// 0x01031c04: 0x1031c04: jal   0x10c09c4 addu  s5, v1, zero
	ldloc 8
	stloc 12
	ldloc.0
	ldloc.1
...
// 0x01031c14: 0x1031c14: lw    a0, 28(s2)
	...
	ldelem.i4
	stloc.1
// 0x01031c18: 0x1031c18: jal   0x10c09c4 lui   s1, 0x10000
	ldc.i4 65536
	stloc 10
	ldloc.0
	ldloc.1
...
// 0x010327a4: 0x10327a4: lw    a0, 20(a1)
	...
	ldelem.i4
	stloc.1
// 0x010327a8: 0x10327a8: jal   0x10c0b10 addu  s0, a1, zero
	ldloc.2
	stloc 8
	ldloc.0
	ldloc.1
...
// 0x010327bc: 0x10327bc: addu  a1, v1, zero
	ldloc 7
	stloc.2
// 0x010327c0: 0x10327c0: jal   0x10c08e8 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
