...
// 0x01031748: 0x1031748: lui   v1, 0x0
	ldc.i4.s 0
	stloc 6
// 0x0103174c: 0x103174c: addiu v1, v1, 12188
	ldloc 6
	ldc.i4 12188
	add
	stloc 6
...
// 0x010317ec: 0x10317ec: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x010317f0: 0x10317f0: lw    v0, 12204(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01031808: 0x1031808: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0103180c: 0x103180c: lw    v0, 12208(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01031858: 0x1031858: jal   0x100e7a8 addiu a0, a0, 12212
	ldloc.1
	ldc.i4 12212
	add
	stloc.1
...
// 0x010318f8: 0x10318f8: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x010318fc: 0x10318fc: jal   0x100e368 addiu a0, a0, 12228
	ldloc.1
	ldc.i4 12228
	add
	stloc.1
...
// 0x0103191c: 0x103191c: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01031920: 0x1031920: jal   0x100e368 addiu a0, a0, 12244
	ldloc.1
	ldc.i4 12244
	add
	stloc.1
...
// --- basic block ---
L_1031e60:
// 0x01031e60: 0x1031e60: jal   0x100e7a8 addiu a0, a0, 12292
	ldloc.1
	ldc.i4 12292
	add
	stloc.1
...
// 0x01031f08: 0x1031f08: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01031f0c: 0x1031f0c: addiu a0, a0, 12324
	ldloc.1
	ldc.i4 12324
	add
	stloc.1
...
// 0x01031f84: 0x1031f84: addiu a2, a2, 9300
	...
	add
	stloc.3
// 0x01031f88: 0x1031f88: addiu a1, s0, 12124
	ldloc 9
	ldc.i4 12124
	add
	stloc.2
...
// 0x01031f94: 0x1031f94: lui   a1, 0x0
	ldc.i4.s 0
	stloc.2
// 0x01031f98: 0x1031f98: addiu a0, s0, 12124
	ldloc 9
	ldc.i4 12124
	add
	stloc.1
...
// 0x01031fc0: 0x1031fc0: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x01031fc4: 0x1031fc4: addiu a1, a1, 12140
	ldloc.2
	ldc.i4 12140
	add
	stloc.2
...
// 0x01031fdc: 0x1031fdc: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x01031fe0: 0x1031fe0: addiu a1, a1, 12156
	ldloc.2
	ldc.i4 12156
	add
	stloc.2
...
// 0x01031ff8: 0x1031ff8: lui   a2, 0x20000
	ldc.i4 131072
	stloc.3
// 0x01031ffc: 0x1031ffc: addiu a1, a1, 12212
	ldloc.2
	ldc.i4 12212
	add
	stloc.2
...
// 0x01032014: 0x1032014: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x01032018: 0x1032018: addiu a1, a1, 12292
	ldloc.2
	ldc.i4 12292
	add
	stloc.2
...
// 0x01032038: 0x1032038: addiu a0, s3, 12676
	...
	add
	stloc.1
// 0x0103203c: 0x103203c: addiu a1, s0, 12244
	ldloc 9
	ldc.i4 12244
	add
	stloc.2
...
// 0x01032050: 0x1032050: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01032054: 0x1032054: addiu a1, s2, 12228
	ldloc 11
	ldc.i4 12228
	add
	stloc.2
...
// 0x0103206c: 0x103206c: jal   0x100ee18 sw    zero, 20(sp)
	...
	stloc 5
// --- basic block ---
// 0x01032074: 0x1032074: jal   0x100e368 addiu a0, s2, 12228
	ldloc 11
	ldc.i4 12228
	add
	stloc.1
...
// 0x01032088: 0x1032088: bne   v0, zero, 0x10320a8 sll   zero, zero, 0
	...
	brtrue L_10320a8
// --- basic block ---
// 0x01032090: 0x1032090: jal   0x100e368 addiu a0, s0, 12244
	ldloc 9
	ldc.i4 12244
	add
	stloc.1
...
// 0x010320b0: 0x10320b0: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x010320b4: 0x10320b4: addiu a1, a1, 12268
	ldloc.2
	ldc.i4 12268
	add
	stloc.2
...
// 0x010320cc: 0x10320cc: lui   a2, 0x10000
	ldc.i4 65536
	stloc.3
// 0x010320d0: 0x10320d0: addiu a1, a1, 12172
	ldloc.2
	ldc.i4 12172
	add
	stloc.2
...
// 0x010320f8: 0x10320f8: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x010320fc: 0x10320fc: addiu a1, s2, 12308
	ldloc 11
	ldc.i4 12308
	add
	stloc.2
...
// 0x01032114: 0x1032114: addiu a0, s0, 12676
	...
	add
	stloc.1
// 0x01032118: 0x1032118: addiu a1, a1, 12324
	ldloc.2
	ldc.i4 12324
	add
	stloc.2
...
// 0x0103212c: 0x103212c: jal   0x100ee18 sw    zero, 20(sp)
	...
	stloc 5
// --- basic block ---
// 0x01032134: 0x1032134: addiu a0, s2, 12308
	ldloc 11
	ldc.i4 12308
	add
	stloc.1
...
// 0x010321ac: 0x10321ac: bne   v0, zero, 0x10321f4 lui   v0, 0x0
	...
	brtrue L_10321f4
// --- basic block ---
// 0x010321b4: 0x10321b4: lw    v0, 12340(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01032220: 0x1032220: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x01032224: 0x1032224: sw    zero, 12340(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010322ac: 0x10322ac: jal   0x100e5e0 addiu a0, a0, 12324
	ldloc.1
	ldc.i4 12324
	add
	stloc.1
...
// 0x010323b8: 0x10323b8: lw    t1, -18108(a1)
	...
	ldelem.i4
	stloc 17
// 0x010323bc: 0x10323bc: lb    a3, 12288(v0)
	ldloc 5
	ldc.i4 12288
	add
	call int32 [WazeWP7]CRunTime::memoryReadByte(int32)
