...
// 0x010a6004: 0x10a6004: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010a6008: 0x10a6008: lw    v1, 31264(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a6020: 0x10a6020: lui   s1, 0x0
	ldc.i4.s 0
	stloc 12
// 0x010a6024: 0x10a6024: sw    v1, 31264(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a6030: 0x10a6030: addiu a0, s1, 32144
	...
	add
	stloc.1
// 0x010a6034: 0x10a6034: jal   0x101cd80 sw    v0, 31268(s3)
	ldloc 7
	ldloc 15
	ldc.i4.2
	shr.un
...
// 0x010a603c: 0x10a603c: lui   v1, 0x80000
	ldc.i4 524288
	stloc 6
// 0x010a6040: 0x10a6040: addiu s3, s3, 31268
	ldloc 15
	ldc.i4 31268
	add
	stloc 15
// 0x010a6044: 0x10a6044: addiu s2, s2, 32140
	...
	add
	stloc 10
// 0x010a6048: 0x10a6048: addiu a0, v1, 31276
	ldloc 6
	ldc.i4 31276
	add
	stloc.1
...
// 0x010a6054: 0x10a6054: sw    s1, 4(a0)
	...
	ldloc 12
	stelem.i4
// 0x010a6058: 0x10a6058: sw    s2, 31276(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a605c: 0x10a605c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010a6060: 0x10a6060: lw    s3, 29916(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a6138: 0x10a6138: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x010a613c: 0x10a613c: lw    a2, -30068(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a6270: 0x10a6270: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x010a6274: 0x10a6274: lw    a2, -30068(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a67c4: 0x10a67c4: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x010a67c8: 0x10a67c8: lw    a2, -30068(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a68f0: 0x10a68f0: lui   v0, 0xf0000
	ldc.i4 983040
	stloc 5
// 0x010a68f4: 0x10a68f4: lw    a2, -30068(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a69ec: 0x10a69ec: addiu a1, a1, 9696
	...
	add
	stloc.2
// 0x010a69f0: 0x10a69f0: addiu s4, s4, 31240
	ldloc 11
	ldc.i4 31240
	add
	stloc 11
// 0x010a69f4: 0x10a69f4: beq   v0, zero, 0x10a6a78 addiu v1, a0, 31216
	ldloc 5
	ldloc.1
	ldc.i4 31216
	add
...
// 0x010a6a00: 0x10a6a00: addiu v0, v0, -6748
	...
	add
	stloc 5
// 0x010a6a04: 0x10a6a04: sw    v0, 31216(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010a6a7c: 0x10a6a7c: addiu v0, v0, 20620
	...
	add
	stloc 5
// 0x010a6a80: 0x10a6a80: sw    v0, 31216(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010a6af8: 0x10a6af8: lui   a3, 0x80000
	ldc.i4 524288
	stloc 4
// 0x010a6afc: 0x10a6afc: addiu a3, a3, 31240
	ldloc 4
	ldc.i4 31240
	add
	stloc 4
...
// 0x010a6b1c: 0x10a6b1c: lw    a3, 648(sp)
	...
	ldelem.i4
	stloc 4
// 0x010a6b20: 0x10a6b20: addiu v0, v0, 31216
	ldloc 5
	ldc.i4 31216
	add
	stloc 5
...
// 0x010a6bc4: 0x10a6bc4: lui   v0, 0x80000
	...
	stloc 5
L_10a6bc8:
// 0x010a6bc8: 0x10a6bc8: lw    v0, 31212(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a6bec: 0x10a6bec: beq   v0, zero, 0x10a6c00 lui   v1, 0x80000
	...
	brfalse L_10a6c00
// --- basic block ---
// 0x010a6bf4: 0x10a6bf4: lw    a1, 31276(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10a6c00:
// 0x010a6c00: 0x10a6c00: addiu v1, v1, 31276
	ldloc 6
	ldc.i4 31276
	add
	stloc 6
...
// 0x010a6c28: 0x10a6c28: beq   v0, zero, 0x10a6c3c lui   v1, 0x80000
	...
	brfalse L_10a6c3c
// --- basic block ---
// 0x010a6c30: 0x10a6c30: lw    a1, 31276(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10a6c3c:
// 0x010a6c3c: 0x10a6c3c: addiu v1, v1, 31276
	ldloc 6
	ldc.i4 31276
	add
	stloc 6
...
// 0x010a6c64: 0x10a6c64: beq   v0, zero, 0x10a6c78 lui   v1, 0x80000
	...
	brfalse L_10a6c78
// --- basic block ---
// 0x010a6c6c: 0x10a6c6c: lw    a1, 31276(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10a6c78:
// 0x010a6c78: 0x10a6c78: addiu v1, v1, 31276
	ldloc 6
	ldc.i4 31276
	add
	stloc 6
...
// 0x010a6ca0: 0x10a6ca0: beq   v0, zero, 0x10a6cb4 lui   v1, 0x80000
	...
	brfalse L_10a6cb4
// --- basic block ---
// 0x010a6ca8: 0x10a6ca8: lw    a1, 31276(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10a6cb4:
// 0x010a6cb4: 0x10a6cb4: addiu v1, v1, 31276
	ldloc 6
	ldc.i4 31276
	add
	stloc 6
...
// 0x010a6ce0: 0x10a6ce0: beq   v0, zero, 0x10a6cf4 lui   v1, 0x80000
	...
	brfalse L_10a6cf4
// --- basic block ---
// 0x010a6ce8: 0x10a6ce8: lw    a1, 31276(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10a6cf4:
// 0x010a6cf4: 0x10a6cf4: addiu v1, v1, 31276
	ldloc 6
	ldc.i4 31276
	add
	stloc 6
...
// 0x010a6d1c: 0x10a6d1c: beq   v0, zero, 0x10a6d30 lui   v1, 0x80000
	...
	brfalse L_10a6d30
// --- basic block ---
// 0x010a6d24: 0x10a6d24: lw    a1, 31276(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10a6d30:
// 0x010a6d30: 0x10a6d30: addiu v1, v1, 31276
	ldloc 6
	ldc.i4 31276
	add
	stloc 6
...
// 0x010a6d84: 0x10a6d84: lui   s3, 0x0
	ldc.i4.s 0
	stloc 15
// 0x010a6d88: 0x10a6d88: addiu s1, s1, 31216
	ldloc 12
	ldc.i4 31216
	add
	stloc 12
...
// 0x010a6dc4: 0x10a6dc4: lui   v0, 0x80000
	...
	stloc 5
L_10a6dc8:
// 0x010a6dc8: 0x10a6dc8: addiu v0, v0, 31216
	ldloc 5
	ldc.i4 31216
	add
	stloc 5
...
// 0x010a6de8: 0x10a6de8: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010a6dec: 0x10a6dec: jal   0x109497c sw    v1, 31212(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010a7274: 0x10a7274: lui   v1, 0x90000
	ldc.i4 589824
	stloc 6
// 0x010a7278: 0x10a7278: lw    a1, -32696(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a73a0: 0x10a73a0: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x010a73a4: 0x10a73a4: addiu s0, s0, 29956
	ldloc 8
	ldc.i4 29956
	add
	stloc 8
// 0x010a73a8: 0x10a73a8: addiu s8, s8, 8192
	...
	add
	stloc 15
// 0x010a73ac: 0x10a73ac: addiu s7, s7, 29920
	ldloc 14
	ldc.i4 29920
	add
	stloc 14
...
// 0x010a7430: 0x10a7430: lui   v1, 0x90000
	ldc.i4 589824
	stloc 6
// 0x010a7434: 0x10a7434: lw    a1, -32696(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010a7490: 0x10a7490: addiu s0, s0, 4
	...
	stloc 8
L_10a7494:
// 0x010a7494: 0x10a7494: addiu v1, v1, 29980
	ldloc 6
	ldc.i4 29980
	add
	stloc 6
...
// 0x010a74c4: 0x10a74c4: lui   v0, 0x90000
	ldc.i4 589824
	stloc 5
// 0x010a74c8: 0x10a74c8: sw    zero, -32708(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
