...
// 0x010636d4: 0x10636d4: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x010636d8: 0x10636d8: lw    a0, 31408(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010636dc: 0x10636dc: sw    s4, 112(sp)
	...
	ldloc 14
	stelem.i4
// 0x010636e0: 0x10636e0: lw    v1, 12976(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01063754: 0x1063754: addiu a0, zero, 1
	ldc.i4.1
	stloc.1
// 0x01063758: 0x1063758: sw    a0, 12976(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01063780: 0x1063780: lui   v1, 0x70000
	ldc.i4 458752
	stloc 7
// 0x01063784: 0x1063784: sw    v0, 12984(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01063788: 0x1063788: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0106378c: 0x106378c: sw    zero, 12980(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106393c: 0x106393c: lui   s1, 0x70000
	ldc.i4 458752
	stloc 8
// 0x01063940: 0x1063940: addiu s1, s1, 15956
	ldloc 8
	ldc.i4 15956
	add
	stloc 8
...
// 0x01063ba4: 0x1063ba4: jal   0x100b040 lui   s1, 0x70000
	...
	stloc 5
// --- basic block ---
// 0x01063bac: 0x1063bac: lw    a0, 12984(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01063bbc: 0x1063bbc: jal   0x1015ab0 sll   zero, zero, 0
	...
	stloc 5
// --- basic block ---
// 0x01063bc4: 0x1063bc4: sw    zero, 12984(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01063bc8: 0x1063bc8: lui   v0, 0x70000
	...
	stloc 5
L_1063bcc:
// 0x01063bcc: 0x1063bcc: lw    s1, 12980(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01063be8: 0x1063be8: lui   s2, 0x70000
	ldc.i4 458752
	stloc 9
// 0x01063bec: 0x1063bec: addiu s2, s2, 12996
	ldloc 9
	ldc.i4 12996
	add
	stloc 9
...
// 0x01063c10: 0x1063c10: bgez  s1, 0x1063c00 lui   v0, 0x70000
	...
	bge L_1063c00
// --- basic block ---
// 0x01063c18: 0x1063c18: sw    zero, 12980(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01063c1c: 0x1063c1c: lui   v0, 0x70000
	...
	stloc 5
L_1063c20:
// 0x01063c20: 0x1063c20: sw    zero, 12976(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01063cc4: 0x1063cc4: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01063cc8: 0x1063cc8: lw    t0, 15968(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01063e6c: 0x1063e6c: lui   s2, 0x70000
	ldc.i4 458752
	stloc 8
// 0x01063e70: 0x1063e70: lw    v0, 15968(s2)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01063e9c: 0x1063e9c: addiu a2, zero, 1603
	ldc.i4 1603
	stloc.3
// 0x01063ea0: 0x1063ea0: addiu s2, s2, 15968
	ldloc 8
	ldc.i4 15968
	add
	stloc 8
...
// 0x01063f68: 0x1063f68: lui   a0, 0x70000
	ldc.i4 458752
	stloc.1
// 0x01063f6c: 0x1063f6c: lw    a1, 15980(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.2
// 0x01063f70: 0x1063f70: addiu a0, a0, 16020
	ldloc.1
	ldc.i4 16020
	add
	stloc.1
...
// 0x0106403c: 0x106403c: lui   s1, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01064040: 0x1064040: addiu s1, s1, 15968
	ldloc 5
	ldc.i4 15968
	add
	stloc 5
...
// 0x0106407c: 0x106407c: lui   s1, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01064080: 0x1064080: addiu s1, s1, 15968
	ldloc 5
	ldc.i4 15968
	add
	stloc 5
...
// 0x010640b0: 0x10640b0: lui   v0, 0x70000
	ldc.i4 458752
	stloc 6
// 0x010640b4: 0x10640b4: addiu v0, v0, 15968
	ldloc 6
	ldc.i4 15968
	add
	stloc 6
...
// 0x010640e4: 0x10640e4: lui   s0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x010640e8: 0x10640e8: addiu s0, s0, 15968
	ldloc 5
	ldc.i4 15968
	add
	stloc 5
...
// 0x01064138: 0x1064138: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0106413c: 0x106413c: lw    v0, 15956(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01064158: 0x1064158: lui   s0, 0x70000
	ldc.i4 458752
	stloc 8
// 0x0106415c: 0x106415c: addiu a0, s0, 15968
	ldloc 8
	ldc.i4 15968
	add
	stloc.1
...
// 0x0106416c: 0x106416c: lui   v1, 0x70000
	ldc.i4 458752
	stloc 7
// 0x01064170: 0x1064170: lw    v0, 15956(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0106418c: 0x106418c: addiu a2, zero, 146
	ldc.i4 146
	stloc.3
// 0x01064190: 0x1064190: sw    v0, 15968(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01064194: 0x1064194: sw    v0, 16(sp)
	...
	ldloc 5
	stelem.i4
// 0x01064198: 0x1064198: jal   0x100449c sw    v0, 15956(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010641f0: 0x10641f0: addiu sp, sp, -48
	...
	add
	stloc.0
// 0x010641f4: 0x10641f4: lw    v1, 15980(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01064210: 0x1064210: addu  s0, a0, zero
	ldloc.1
	stloc 10
// 0x01064214: 0x1064214: addiu v0, v0, 16020
	ldloc 5
	ldc.i4 16020
	add
	stloc 5
...
// 0x010642d4: 0x10642d4: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x010642d8: 0x10642d8: addiu v0, v0, 15968
	ldloc 5
	ldc.i4 15968
	add
	stloc 5
...
// 0x01064304: 0x1064304: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01064308: 0x1064308: lw    a0, 15968(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106434c: 0x106434c: lui   v1, 0x70000
	ldc.i4 458752
	stloc 6
// 0x01064350: 0x1064350: addiu v1, v1, 15968
	ldloc 6
	ldc.i4 15968
	add
	stloc 6
...
// 0x010643ec: 0x10643ec: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x010643f0: 0x10643f0: lw    v0, 15968(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01064408: 0x1064408: lui   s8, 0x70000
	ldc.i4 458752
	stloc 12
// 0x0106440c: 0x106440c: addiu a0, s8, 15968
	ldloc 12
	ldc.i4 15968
	add
	stloc.1
...
// 0x0106441c: 0x106441c: lw    v0, 264(sp)
	...
	ldelem.i4
	stloc 5
// 0x01064420: 0x1064420: j	 0x106444c sw    v0, 15968(s8)
	ldloc 6
	ldloc 12
	ldc.i4.2
	shr.un
...
// 0x01064450: 0x1064450: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x01064454: 0x1064454: addiu v0, v0, 15968
	ldloc 5
	ldc.i4 15968
	add
	stloc 5
...
// 0x01064764: 0x1064764: lui   a0, 0x70000
	ldc.i4 458752
	stloc.1
// 0x01064768: 0x1064768: addiu v0, a0, 15968
	ldloc.1
	ldc.i4 15968
	add
	stloc 5
...
// 0x01064770: 0x1064770: sw    s5, 24(v0)
	...
	ldloc 15
	stelem.i4
// 0x01064774: 0x1064774: lw    a0, 15968(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01064838: 0x1064838: bne   v0, zero, 0x106485c lui   v0, 0x70000
	...
	brtrue L_106485c
// --- basic block ---
// 0x01064840: 0x1064840: addiu v0, v0, 15968
	ldloc 5
	ldc.i4 15968
	add
	stloc 5
