...
// 0x01094d4c: 0x1094d4c: lui   s2, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01094d50: 0x1094d50: lw    v0, 10044(s2)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01094d68: 0x1094d68: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01094d6c: 0x1094d6c: lw    v0, 9916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01094d88: 0x1094d88: lw    v1, 0(s1)
	...
	ldelem.i4
	stloc 9
// 0x01094d8c: 0x1094d8c: addiu v0, s2, 10044
	ldloc 7
	ldc.i4 10044
	add
	stloc 5
// 0x01094d90: 0x1094d90: sw    v1, 10044(s2)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01094da0: 0x1094da0: lui   s2, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01094da4: 0x1094da4: lw    v0, 9916(s2)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01094dac: 0x1094dac: lw    a0, 20(v0)
	...
	ldelem.i4
	stloc.1
// 0x01094db0: 0x1094db0: jal   0x1099924 addiu a1, s1, 10044
	ldloc 8
	ldc.i4 10044
	add
	stloc.2
...
// 0x01094db8: 0x1094db8: bne   v0, zero, 0x1094e30 addu  s0, v0, zero
	...
	brtrue L_1094e30
// --- basic block ---
// 0x01094dc0: 0x1094dc0: lw    v0, 9916(s2)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01094dd0: 0x1094dd0: beq   a0, zero, 0x1094df0 lui   s2, 0x80000
	...
	brfalse L_1094df0
// --- basic block ---
// 0x01094dd8: 0x1094dd8: jal   0x1099924 addiu a1, s1, 10044
	ldloc 8
	ldc.i4 10044
	add
	stloc.2
...
// --- basic block ---
L_1094df0:
// 0x01094df0: 0x1094df0: lw    v0, 9916(s2)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01094df8: 0x1094df8: lw    a0, 20(v0)
	...
	ldelem.i4
	stloc.1
// 0x01094dfc: 0x1094dfc: addiu a1, s1, 10044
	ldloc 8
	ldc.i4 10044
	add
	stloc.2
// 0x01094e00: 0x1094e00: jal   0x1099b10 addiu a2, zero, 1
	...
	stloc 5
// --- basic block ---
// 0x01094e08: 0x1094e08: bne   v0, zero, 0x1094e2c addiu a1, s1, 10044
	ldloc 5
	ldloc 8
	ldc.i4 10044
	add
	...
	brtrue L_1094e2c
// --- basic block ---
// 0x01094e10: 0x1094e10: lw    v0, 9916(s2)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01094e54: 0x1094e54: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01094e58: 0x1094e58: lw    v0, 9916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01094e74: 0x1094e74: jal   0x10999c0 sw    v1, 10044(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01094ec8: 0x1094ec8: beq   a1, zero, 0x1094ed8 lui   a0, 0x80000
	...
	brfalse L_1094ed8
// --- basic block ---
// 0x01094ed0: 0x1094ed0: j	 0x1094ee4 addiu a0, a0, 9988
	ldloc.1
	ldc.i4 9988
	add
	stloc.1
...
// 0x01094ed8: 0x1094ed8: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01094edc: 0x1094edc: addiu a0, a0, 9988
	ldloc.1
	ldc.i4 9988
	add
	stloc.1
// 0x01094ee0: 0x1094ee0: addiu a1, a1, -3352
	ldloc.2
	ldc.i4 -3352
	add
	stloc.2
...
// 0x01094ef0: 0x1094ef0: lui   v1, 0x1090000
	ldc.i4 17367040
	stloc 7
// 0x01094ef4: 0x1094ef4: addiu v0, v0, 9988
	ldloc 5
	ldc.i4 9988
	add
	stloc 5
...
// 0x01094f14: 0x1094f14: beq   a1, zero, 0x1094f24 lui   a0, 0x80000
	...
	brfalse L_1094f24
// --- basic block ---
// 0x01094f1c: 0x1094f1c: j	 0x1094f30 addiu a0, a0, 9932
	ldloc.1
	ldc.i4 9932
	add
	stloc.1
...
// 0x01094f24: 0x1094f24: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01094f28: 0x1094f28: addiu a0, a0, 9932
	ldloc.1
	ldc.i4 9932
	add
	stloc.1
// 0x01094f2c: 0x1094f2c: addiu a1, a1, -3340
	ldloc.2
	ldc.i4 -3340
	add
	stloc.2
...
// 0x01094f3c: 0x1094f3c: lui   v1, 0x1090000
	ldc.i4 17367040
	stloc 7
// 0x01094f40: 0x1094f40: addiu v0, v0, 9932
	ldloc 5
	ldc.i4 9932
	add
	stloc 5
...
// 0x01094f78: 0x1094f78: sw    s0, 20(sp)
	...
	ldloc 6
	stelem.i4
// 0x01094f7c: 0x1094f7c: lw    s0, 9916(s1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01094f9c: 0x1094f9c: jal   0x103fe18 sll   zero, zero, 0
	...
	stloc 8
// --- basic block ---
// 0x01094fa4: 0x1094fa4: lw    a0, 9916(s1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01094fd0: 0x1094fd0: sw    s0, 32(sp)
	...
	ldloc 8
	stelem.i4
// 0x01094fd4: 0x1094fd4: lw    s0, 9916(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01095010: 0x1095010: beq   v0, zero, 0x109502c lui   v0, 0x80000
	...
	brfalse L_109502c
// --- basic block ---
// 0x01095018: 0x1095018: lw    v0, 10044(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109507c: 0x109507c: beq   v0, zero, 0x10951a4 addiu v0, zero, 1
	...
	brfalse L_10951a4
// --- basic block ---
// 0x01095084: 0x1095084: lw    v0, 9916(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x0109508c: 0x109508c: lw    a0, 20(v0)
	...
	ldelem.i4
	stloc.1
// 0x01095090: 0x1095090: addiu a1, a1, 7188
	ldloc.2
	ldc.i4 7188
	add
	stloc.2
...
// 0x010950a0: 0x10950a0: jal   0x109b258 lui   s1, 0xf0000
	...
	stloc 5
// --- basic block ---
// 0x010950a8: 0x10950a8: lw    v1, -30008(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010950cc: 0x10950cc: jal   0x10992a4 addu  a2, zero, zero
	...
	stloc 5
// --- basic block ---
// 0x010950d4: 0x10950d4: lw    v0, -30008(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01095160: 0x1095160: addu  v1, v0, v1
	...
	add
	stloc 7
// 0x01095164: 0x1095164: lw    a0, -30008(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010951cc: 0x10951cc: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010951d0: 0x10951d0: lw    v0, 9916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109529c: 0x109529c: sw    s0, 16(sp)
	...
	ldloc 7
	stelem.i4
// 0x010952a0: 0x10952a0: lw    s0, 9916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010952c8: 0x10952c8: beq   v0, zero, 0x10952e4 lui   v0, 0x80000
	...
	brfalse L_10952e4
// --- basic block ---
// 0x010952d0: 0x10952d0: lw    v0, 10044(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095378: 0x1095378: lui   s2, 0x80000
	ldc.i4 524288
	stloc 10
// 0x0109537c: 0x109537c: lw    v0, 9916(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010953ac: 0x10953ac: lw    v0, 0(s0)
	...
	ldelem.i4
	stloc 5
// 0x010953b0: 0x10953b0: addiu a0, v1, 10044
	ldloc 7
	ldc.i4 10044
	add
	stloc.1
// 0x010953b4: 0x10953b4: sw    v0, 10044(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010953bc: 0x10953bc: lw    a1, 4(s0)
	...
	ldelem.i4
	stloc.2
// 0x010953c0: 0x10953c0: lw    v0, 9928(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010953d8: 0x10953d8: addiu v0, zero, -1
	ldc.i4.m1
	stloc 5
// 0x010953dc: 0x10953dc: addiu a1, a1, -3320
	ldloc.2
	ldc.i4 -3320
	add
	stloc.2
// 0x010953e0: 0x10953e0: jal   0x1000420 sw    v0, 10044(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10953f0:
// 0x010953f0: 0x10953f0: lw    v0, 9916(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01095420: 0x1095420: lui   v0, 0x80000
	...
	stloc 5
L_1095424:
// 0x01095424: 0x1095424: lw    v0, 9916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010954cc: 0x10954cc: lui   s0, 0x80000
	ldc.i4 524288
	stloc 8
// 0x010954d0: 0x10954d0: lw    a0, 9916(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01095500: 0x1095500: jal   0x1095468 sll   zero, zero, 0
	...
	stloc 6
// --- basic block ---
// 0x01095508: 0x1095508: lw    v0, 9916(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01095518: 0x1095518: jal   0x109f5f0 sll   zero, zero, 0
	...
	stloc 6
// --- basic block ---
// 0x01095520: 0x1095520: lw    v1, 9916(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010955a8: 0x10955a8: lui   v1, 0xf0000
	ldc.i4 983040
	stloc 7
// 0x010955ac: 0x10955ac: lw    v0, -30004(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 5
// 0x010955b0: 0x10955b0: lw    s1, -30008(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01095610: 0x1095610: bgez  v0, 0x10956a0 lui   a1, 0x10000
	...
	bge L_10956a0
// --- basic block ---
// 0x01095618: 0x1095618: jal   0x109b258 addiu a1, a1, 7188
	ldloc.2
	ldc.i4 7188
	add
	stloc.2
...
// 0x01095744: 0x1095744: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01095748: 0x1095748: lw    s0, 9916(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095774: 0x1095774: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01095778: 0x1095778: lw    v0, 9916(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010957c0: 0x10957c0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010957c4: 0x10957c4: lw    a0, 9916(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010957e8: 0x10957e8: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010957ec: 0x10957ec: lw    a0, 9916(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095810: 0x1095810: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01095814: 0x1095814: lw    v1, 9916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095858: 0x1095858: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109585c: 0x109585c: lw    v1, 9916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010959a0: 0x10959a0: addiu a1, zero, 545
	ldc.i4 545
	stloc.2
// 0x010959a4: 0x10959a4: addiu a0, a0, -3272
	ldloc.1
	ldc.i4 -3272
	add
	stloc.1
...
// 0x01095a60: 0x1095a60: lui   v1, 0x80000
	ldc.i4 524288
	stloc 8
// 0x01095a64: 0x1095a64: lw    v1, 9920(v1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01095ac0: 0x1095ac0: lw    s2, 20(s0)
	...
	ldelem.i4
	stloc 10
// 0x01095ac4: 0x1095ac4: addiu a0, a0, -3352
	ldloc.1
	ldc.i4 -3352
	add
	stloc.1
// 0x01095ac8: 0x1095ac8: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01095acc: 0x1095acc: jal   0x101cd74 sw    s0, 9920(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095ae4: 0x1095ae4: lw    s2, 20(s0)
	...
	ldelem.i4
	stloc 10
// 0x01095ae8: 0x1095ae8: jal   0x101cd74 addiu a0, a0, -3340
	ldloc.1
	ldc.i4 -3340
	add
	stloc.1
...
// 0x01095b34: 0x1095b34: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01095b38: 0x1095b38: lw    v0, 9916(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095b44: 0x1095b44: addiu sp, sp, -56
	...
	add
	stloc.0
// 0x01095b48: 0x1095b48: addiu a1, a1, 7188
	ldloc.2
	ldc.i4 7188
	add
	stloc.2
...
// 0x01095b9c: 0x1095b9c: lui   v0, 0x80000
	...
	stloc 5
L_1095ba0:
// 0x01095ba0: 0x1095ba0: lw    v0, 9916(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095bd0: 0x1095bd0: lui   v0, 0xf0000
	...
	stloc 5
L_1095bd4:
// 0x01095bd4: 0x1095bd4: lw    s1, -30008(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095be0: 0x1095be0: lui   v1, 0x80000
	ldc.i4 524288
	stloc 6
// 0x01095be4: 0x1095be4: lw    v1, 9916(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1095c7c:
// 0x01095c7c: 0x1095c7c: lw    a0, 9916(s3)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01095d60: 0x1095d60: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01095d64: 0x1095d64: addiu a1, a1, -3060
	ldloc.2
	ldc.i4 -3060
	add
	stloc.2
...
// 0x01095e6c: 0x1095e6c: addu  s4, a1, zero
	ldloc.2
	stloc 12
// 0x01095e70: 0x1095e70: lw    s1, 9916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095ecc: 0x1095ecc: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01095ed0: 0x1095ed0: lw    v0, 9916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095eec: 0x1095eec: lw    a0, 4(s1)
	...
	ldelem.i4
	stloc.1
// 0x01095ef0: 0x1095ef0: lw    v1, 9916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095ef8: 0x1095ef8: sw    v1, 4(s1)
	...
	ldloc 7
	stelem.i4
// 0x01095efc: 0x1095efc: sw    s1, 9916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095f38: 0x1095f38: lui   v0, 0x80000
	...
	stloc 5
L_1095f3c:
// 0x01095f3c: 0x1095f3c: lw    v0, 9916(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095fcc: 0x1095fcc: addu  a0, s0, zero
	ldloc 9
	stloc.1
// 0x01095fd0: 0x1095fd0: jal   0x1094e9c sw    s0, 9916(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x01095fd8: 0x1095fd8: lw    v0, 9916(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01096030: 0x1096030: jal   0x1095d30 lui   s1, 0x80000
	...
	stloc 5
// --- basic block ---
// 0x01096038: 0x1096038: lw    v0, 9924(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109606c: 0x109606c: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x01096070: 0x1096070: sw    v0, 9924(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01096074: 0x1096074: lui   v0, 0x80000
	...
	stloc 5
L_1096078:
// 0x01096078: 0x1096078: lw    v0, 9924(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109609c: 0x109609c: addiu a0, zero, 350
	ldc.i4 350
	stloc.1
// 0x010960a0: 0x10960a0: jal   0x1050120 sw    zero, 9928(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
