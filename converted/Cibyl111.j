...
// 0x01094f40: 0x1094f40: lui   s2, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01094f44: 0x1094f44: lw    v0, 9932(s2)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01094f5c: 0x1094f5c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01094f60: 0x1094f60: lw    v0, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01094f7c: 0x1094f7c: lw    v1, 0(s1)
	...
	ldelem.i4
	stloc 9
// 0x01094f80: 0x1094f80: addiu v0, s2, 9932
	ldloc 7
	ldc.i4 9932
	add
	stloc 5
// 0x01094f84: 0x1094f84: sw    v1, 9932(s2)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01094f94: 0x1094f94: lui   s2, 0x80000
	ldc.i4 524288
	stloc 7
// 0x01094f98: 0x1094f98: lw    v0, 9804(s2)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01094fa0: 0x1094fa0: lw    a0, 20(v0)
	...
	ldelem.i4
	stloc.1
// 0x01094fa4: 0x1094fa4: jal   0x1099b24 addiu a1, s1, 9932
	ldloc 8
	ldc.i4 9932
	add
	stloc.2
...
// 0x01094fac: 0x1094fac: bne   v0, zero, 0x1095024 addu  s0, v0, zero
	...
	brtrue L_1095024
// --- basic block ---
// 0x01094fb4: 0x1094fb4: lw    v0, 9804(s2)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01094fc4: 0x1094fc4: beq   a0, zero, 0x1094fe4 lui   s2, 0x80000
	...
	brfalse L_1094fe4
// --- basic block ---
// 0x01094fcc: 0x1094fcc: jal   0x1099b24 addiu a1, s1, 9932
	ldloc 8
	ldc.i4 9932
	add
	stloc.2
...
// --- basic block ---
L_1094fe4:
// 0x01094fe4: 0x1094fe4: lw    v0, 9804(s2)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01094fec: 0x1094fec: lw    a0, 20(v0)
	...
	ldelem.i4
	stloc.1
// 0x01094ff0: 0x1094ff0: addiu a1, s1, 9932
	ldloc 8
	ldc.i4 9932
	add
	stloc.2
// 0x01094ff4: 0x1094ff4: jal   0x1099d10 addiu a2, zero, 1
	...
	stloc 5
// --- basic block ---
// 0x01094ffc: 0x1094ffc: bne   v0, zero, 0x1095020 addiu a1, s1, 9932
	ldloc 5
	ldloc 8
	ldc.i4 9932
	add
	...
	brtrue L_1095020
// --- basic block ---
// 0x01095004: 0x1095004: lw    v0, 9804(s2)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01095048: 0x1095048: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109504c: 0x109504c: lw    v0, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095068: 0x1095068: jal   0x1099bc0 sw    v1, 9932(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010950bc: 0x10950bc: beq   a1, zero, 0x10950cc lui   a0, 0x80000
	...
	brfalse L_10950cc
// --- basic block ---
// 0x010950c4: 0x10950c4: j	 0x10950d8 addiu a0, a0, 9876
	ldloc.1
	ldc.i4 9876
	add
	stloc.1
...
// 0x010950cc: 0x10950cc: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x010950d0: 0x10950d0: addiu a0, a0, 9876
	ldloc.1
	ldc.i4 9876
	add
	stloc.1
...
// 0x010950e4: 0x10950e4: lui   v1, 0x1090000
	ldc.i4 17367040
	stloc 7
// 0x010950e8: 0x10950e8: addiu v0, v0, 9876
	ldloc 5
	ldc.i4 9876
	add
	stloc 5
...
// 0x01095108: 0x1095108: beq   a1, zero, 0x1095118 lui   a0, 0x80000
	...
	brfalse L_1095118
// --- basic block ---
// 0x01095110: 0x1095110: j	 0x1095124 addiu a0, a0, 9820
	ldloc.1
	ldc.i4 9820
	add
	stloc.1
...
// 0x01095118: 0x1095118: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x0109511c: 0x109511c: addiu a0, a0, 9820
	ldloc.1
	ldc.i4 9820
	add
	stloc.1
...
// 0x01095130: 0x1095130: lui   v1, 0x1090000
	ldc.i4 17367040
	stloc 7
// 0x01095134: 0x1095134: addiu v0, v0, 9820
	ldloc 5
	ldc.i4 9820
	add
	stloc 5
...
// 0x0109516c: 0x109516c: sw    s0, 20(sp)
	...
	ldloc 6
	stelem.i4
// 0x01095170: 0x1095170: lw    s0, 9804(s1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01095190: 0x1095190: jal   0x103fe24 sll   zero, zero, 0
	...
	stloc 8
// --- basic block ---
// 0x01095198: 0x1095198: lw    a0, 9804(s1)
	ldloc 5
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010951c4: 0x10951c4: sw    s0, 32(sp)
	...
	ldloc 8
	stelem.i4
// 0x010951c8: 0x10951c8: lw    s0, 9804(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01095204: 0x1095204: beq   v0, zero, 0x1095220 lui   v0, 0x80000
	...
	brfalse L_1095220
// --- basic block ---
// 0x0109520c: 0x109520c: lw    v0, 9932(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095270: 0x1095270: beq   v0, zero, 0x1095398 addiu v0, zero, 1
	...
	brfalse L_1095398
// --- basic block ---
// 0x01095278: 0x1095278: lw    v0, 9804(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01095294: 0x1095294: jal   0x109b458 lui   s1, 0xf0000
	...
	stloc 5
// --- basic block ---
// 0x0109529c: 0x109529c: lw    v1, -29912(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010952c0: 0x10952c0: jal   0x10994a4 addu  a2, zero, zero
	...
	stloc 5
// --- basic block ---
// 0x010952c8: 0x10952c8: lw    v0, -29912(s1)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01095354: 0x1095354: addu  v1, v0, v1
	...
	add
	stloc 7
// 0x01095358: 0x1095358: lw    a0, -29912(a0)
	ldloc 6
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010953c0: 0x10953c0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010953c4: 0x10953c4: lw    v0, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095490: 0x1095490: sw    s0, 16(sp)
	...
	ldloc 7
	stelem.i4
// 0x01095494: 0x1095494: lw    s0, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010954bc: 0x10954bc: beq   v0, zero, 0x10954d8 lui   v0, 0x80000
	...
	brfalse L_10954d8
// --- basic block ---
// 0x010954c4: 0x10954c4: lw    v0, 9932(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109556c: 0x109556c: lui   s2, 0x80000
	ldc.i4 524288
	stloc 10
// 0x01095570: 0x1095570: lw    v0, 9804(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010955a0: 0x10955a0: lw    v0, 0(s0)
	...
	ldelem.i4
	stloc 5
// 0x010955a4: 0x10955a4: addiu a0, v1, 9932
	ldloc 7
	ldc.i4 9932
	add
	stloc.1
// 0x010955a8: 0x10955a8: sw    v0, 9932(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x010955b0: 0x10955b0: lw    a1, 4(s0)
	...
	ldelem.i4
	stloc.2
// 0x010955b4: 0x10955b4: lw    v0, 9816(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010955d0: 0x10955d0: addiu a1, a1, -3040
	...
	add
	stloc.2
// 0x010955d4: 0x10955d4: jal   0x1000420 sw    v0, 9932(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_10955e4:
// 0x010955e4: 0x10955e4: lw    v0, 9804(s2)
	ldloc 6
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01095614: 0x1095614: lui   v0, 0x80000
	...
	stloc 5
L_1095618:
// 0x01095618: 0x1095618: lw    v0, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010956c0: 0x10956c0: lui   s0, 0x80000
	ldc.i4 524288
	stloc 8
// 0x010956c4: 0x10956c4: lw    a0, 9804(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x010956f4: 0x10956f4: jal   0x109565c sll   zero, zero, 0
	...
	stloc 6
// --- basic block ---
// 0x010956fc: 0x10956fc: lw    v0, 9804(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109570c: 0x109570c: jal   0x109f7f0 sll   zero, zero, 0
	...
	stloc 6
// --- basic block ---
// 0x01095714: 0x1095714: lw    v1, 9804(s0)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x0109579c: 0x109579c: lui   v1, 0xf0000
	ldc.i4 983040
	stloc 7
// 0x010957a0: 0x10957a0: lw    v0, -29908(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 5
// 0x010957a4: 0x10957a4: lw    s1, -29912(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01095938: 0x1095938: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109593c: 0x109593c: lw    s0, 9804(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095968: 0x1095968: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x0109596c: 0x109596c: lw    v0, 9804(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010959b4: 0x10959b4: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010959b8: 0x10959b8: lw    a0, 9804(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010959dc: 0x10959dc: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010959e0: 0x10959e0: lw    a0, 9804(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095a04: 0x1095a04: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01095a08: 0x1095a08: lw    v1, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095a4c: 0x1095a4c: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01095a50: 0x1095a50: lw    v1, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095c54: 0x1095c54: lui   v1, 0x80000
	ldc.i4 524288
	stloc 8
// 0x01095c58: 0x1095c58: lw    v1, 9808(v1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01095cbc: 0x1095cbc: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01095cc0: 0x1095cc0: jal   0x101cd80 sw    s0, 9808(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095d28: 0x1095d28: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x01095d2c: 0x1095d2c: lw    v0, 9804(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095d90: 0x1095d90: lui   v0, 0x80000
	...
	stloc 5
L_1095d94:
// 0x01095d94: 0x1095d94: lw    v0, 9804(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095dc4: 0x1095dc4: lui   v0, 0xf0000
	...
	stloc 5
L_1095dc8:
// 0x01095dc8: 0x1095dc8: lw    s1, -29912(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01095dd4: 0x1095dd4: lui   v1, 0x80000
	ldc.i4 524288
	stloc 6
// 0x01095dd8: 0x1095dd8: lw    v1, 9804(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// --- basic block ---
L_1095e70:
// 0x01095e70: 0x1095e70: lw    a0, 9804(s3)
	ldloc 7
	ldloc 11
	ldc.i4.2
	shr.un
...
// 0x01096060: 0x1096060: addu  s4, a1, zero
	ldloc.2
	stloc 12
// 0x01096064: 0x1096064: lw    s1, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010960c0: 0x10960c0: lui   v0, 0x80000
	ldc.i4 524288
	stloc 5
// 0x010960c4: 0x10960c4: lw    v0, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010960e0: 0x10960e0: lw    a0, 4(s1)
	...
	ldelem.i4
	stloc.1
// 0x010960e4: 0x10960e4: lw    v1, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010960ec: 0x10960ec: sw    v1, 4(s1)
	...
	ldloc 7
	stelem.i4
// 0x010960f0: 0x10960f0: sw    s1, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0109612c: 0x109612c: lui   v0, 0x80000
	...
	stloc 5
L_1096130:
// 0x01096130: 0x1096130: lw    v0, 9804(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010961c0: 0x10961c0: addu  a0, s0, zero
	ldloc 9
	stloc.1
// 0x010961c4: 0x10961c4: jal   0x1095090 sw    s0, 9804(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
	...
	stloc 5
// --- basic block ---
// 0x010961cc: 0x10961cc: lw    v0, 9804(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01096224: 0x1096224: jal   0x1095f24 lui   s1, 0x80000
	...
	stloc 5
// --- basic block ---
// 0x0109622c: 0x109622c: lw    v0, 9812(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01096260: 0x1096260: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x01096264: 0x1096264: sw    v0, 9812(s1)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01096268: 0x1096268: lui   v0, 0x80000
	...
	stloc 5
L_109626c:
// 0x0109626c: 0x109626c: lw    v0, 9812(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01096290: 0x1096290: addiu a0, zero, 350
	ldc.i4 350
	stloc.1
// 0x01096294: 0x1096294: jal   0x104ffc4 sw    zero, 9816(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
