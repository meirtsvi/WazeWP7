...
// 0x01008afc: 0x1008afc: lui   t2, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01008b00: 0x1008b00: addiu t2, t2, 24312
	ldloc 7
	ldc.i4 24312
	add
	stloc 7
...
// 0x01008b10: 0x1008b10: lui   t2, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01008b14: 0x1008b14: addiu t2, t2, 24312
	ldloc 7
	ldc.i4 24312
	add
	stloc 7
...
// 0x01008c5c: 0x1008c5c: lui   s1, 0x20000
	ldc.i4 131072
	stloc 9
// 0x01008c60: 0x1008c60: lw    v0, 31480(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01008c78: 0x1008c78: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 7
// 0x01008c7c: 0x1008c7c: lw    v1, 29784(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01008c98: 0x1008c98: lui   v1, 0x20000
	ldc.i4 131072
	stloc 7
// 0x01008c9c: 0x1008c9c: sw    v0, 31476(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
	...
	ldloc 5
	stelem.i4
// 0x01008ca0: 0x1008ca0: sw    s0, 31480(s1)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01008ca4: 0x1008ca4: lui   v0, 0x20000
	...
	stloc 5
L_1008ca8:
// 0x01008ca8: 0x1008ca8: lw    s0, 31476(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01008cf0: 0x1008cf0: sw    s5, 56(sp)
	...
	ldloc 11
	stelem.i4
// 0x01008cf4: 0x1008cf4: lw    s5, 29784(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01008ee8: 0x1008ee8: sw    s0, 20(sp)
	...
	ldloc 8
	stelem.i4
// 0x01008eec: 0x1008eec: lw    s0, 29784(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01008f9c: 0x1008f9c: addiu sp, sp, -112
	...
	add
	stloc.0
// 0x01008fa0: 0x1008fa0: addiu v0, v0, 29668
	ldloc 5
	ldc.i4 29668
	add
	stloc 5
...
// 0x01009040: 0x1009040: bne   v1, zero, 0x1009090 lui   v0, 0xe0000
	...
	brtrue L_1009090
// --- basic block ---
// 0x01009048: 0x1009048: addiu v0, v0, 29668
	ldloc 5
	ldc.i4 29668
	add
	stloc 5
...
// 0x010091dc: 0x10091dc: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010091e0: 0x10091e0: lw    a3, 23684(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x010091e4: 0x10091e4: lw    a2, 23680(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01009204: 0x1009204: blez  v0, 0x1009278 lui   v0, 0x20000
	...
	ble L_1009278
// --- basic block ---
// 0x0100920c: 0x100920c: lw    a3, 23692(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01009210: 0x1009210: lw    a2, 23688(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01009228: 0x1009228: lui   s7, 0xe0000
	ldc.i4 917504
	stloc 9
// 0x0100922c: 0x100922c: addiu s7, s7, 29668
	ldloc 9
	ldc.i4 29668
	add
	stloc 9
...
// 0x0100928c: 0x100928c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x01009290: 0x1009290: lw    a3, 23684(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01009294: 0x1009294: lw    a2, 23680(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010092b4: 0x10092b4: blez  v0, 0x100932c lui   v0, 0x20000
	...
	ble L_100932c
// --- basic block ---
// 0x010092bc: 0x10092bc: lw    a3, 23692(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x010092c0: 0x10092c0: lw    a2, 23688(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x010092d8: 0x10092d8: lui   s7, 0xe0000
	ldc.i4 917504
	stloc 9
// 0x010092dc: 0x10092dc: addiu s7, s7, 29668
	ldloc 9
	ldc.i4 29668
	add
	stloc 9
...
// 0x0100932c: 0x100932c: lui   s3, 0xe0000
	ldc.i4 917504
	stloc 10
// 0x01009330: 0x1009330: addiu s3, s3, 29668
	ldloc 10
	ldc.i4 29668
	add
	stloc 10
...
// --- basic block ---
L_1009568:
// 0x01009568: 0x1009568: addiu v0, v0, 29668
	ldloc 5
	ldc.i4 29668
	add
	stloc 5
...
// --- basic block ---
L_1009594:
// 0x01009594: 0x1009594: addiu v0, v0, 29668
	ldloc 5
	ldc.i4 29668
	add
	stloc 5
...
// 0x010095d8: 0x10095d8: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 7
// 0x010095dc: 0x10095dc: beq   v0, zero, 0x100962c addiu v1, v1, 29668
	ldloc 5
	ldloc 7
	ldc.i4 29668
	add
...
// 0x0100985c: 0x100985c: sw    s0, 16(sp)
	...
	ldloc 8
	stelem.i4
// 0x01009860: 0x1009860: lw    s0, 29784(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01009908: 0x1009908: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0100990c: 0x100990c: lw    a3, 23700(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01009910: 0x1009910: lw    a2, 23696(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01009924: 0x1009924: bgtz  v0, 0x1009948 lui   v0, 0x20000
	...
	bgt L_1009948
// --- basic block ---
// 0x0100992c: 0x100992c: lw    a3, 23708(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01009930: 0x1009930: lw    a2, 23704(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01009954: 0x1009954: lui   v1, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01009958: 0x1009958: lw    a1, 23560(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x010099cc: 0x10099cc: jal   0x100e7a8 lui   s0, 0xe0000
	...
	stloc 5
// --- basic block ---
// 0x010099d4: 0x10099d4: bne   v0, zero, 0x10099f8 sw    v0, 29668(s0)
	ldloc 5
	ldloc 6
	ldloc 7
	ldc.i4.2
...
// 0x010099e0: 0x10099e0: jal   0x100e7a8 addiu a0, a0, 476
	...
	stloc 5
// --- basic block ---
// 0x010099e8: 0x10099e8: bne   v0, zero, 0x10099f8 sw    v0, 29668(s0)
	ldloc 5
	ldloc 6
	ldloc 7
	ldc.i4.2
...
// 0x010099f0: 0x10099f0: addiu v0, zero, 20
	ldc.i4.s 20
	stloc 5
// 0x010099f4: 0x10099f4: sw    v0, 29668(s0)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x01009a1c: 0x1009a1c: sw    s0, 16(sp)
	...
	ldloc 7
	stelem.i4
// 0x01009a20: 0x1009a20: lw    s0, 29668(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01009a68: 0x1009a68: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x01009a6c: 0x1009a6c: jal   0x100e630 sw    v0, 29668(v1)
	ldloc 8
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01009a8c: 0x1009a8c: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 6
// 0x01009a90: 0x1009a90: lw    a1, 29668(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01009aa4: 0x1009aa4: slti  v0, a0, 6
	...
	clt
	stloc 5
// 0x01009aa8: 0x1009aa8: beq   v0, zero, 0x1009ab8 sw    a0, 29668(v1)
	ldloc 5
	ldloc 7
	ldloc 6
	ldc.i4.2
...
// 0x01009acc: 0x1009acc: ori   v0, zero, 65535
	...
	stloc 5
L_1009ad0:
// 0x01009ad0: 0x1009ad0: sw    v0, 29668(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01009ae0: 0x1009ae0: beq   v0, v1, 0x1009b00 lui   v1, 0xe0000
	...
	beq  L_1009b00
// --- basic block ---
// 0x01009ae8: 0x1009ae8: lw    a0, 29668(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01009af4: 0x1009af4: beq   a0, zero, 0x1009b00 sll   zero, zero, 0
	...
	brfalse L_1009b00
// --- basic block ---
// 0x01009afc: 0x1009afc: sw    v0, 29668(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01009b00: 0x1009b00: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x01009b04: 0x1009b04: lw    a1, 29668(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01009b64: 0x1009b64: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 6
// 0x01009b68: 0x1009b68: lw    v1, 29784(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01009b90: 0x1009b90: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01009b94: 0x1009b94: lw    a3, 23644(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01009b98: 0x1009b98: lw    a2, 23640(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01009bb8: 0x1009bb8: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01009bbc: 0x1009bbc: lw    a3, 23716(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01009bc0: 0x1009bc0: lw    a2, 23712(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01009d40: 0x1009d40: lui   s0, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x01009d44: 0x1009d44: addiu s0, s0, 29668
	ldloc 5
	ldc.i4 29668
	add
	stloc 5
...
// 0x01009eb8: 0x1009eb8: lui   a1, 0x20000
	ldc.i4 131072
	stloc.2
// 0x01009ebc: 0x1009ebc: lw    a0, 31512(a1)
	ldloc 5
	ldloc.2
	ldc.i4.2
	shr.un
