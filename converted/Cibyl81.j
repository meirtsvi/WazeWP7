...
// 0x0106d288: 0x106d288: sw    zero, 24(sp)
	...
	ldc.i4.s 0
	stelem.i4
// 0x0106d28c: 0x106d28c: jal   0x10c0a40 addiu s4, sp, 16
	ldloc.0
	ldc.i4.s 16
	add
	stloc 10
...
// 0x0106d57c: 0x106d57c: sw    v0, 44(sp)
	...
	ldloc 5
	stelem.i4
// 0x0106d580: 0x106d580: jal   0x10c0a40 sw    zero, 48(sp)
	ldloc 6
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0106db68: 0x106db68: beq   a1, zero, 0x106dba0 addu  a0, a1, zero
	...
	brfalse L_106dba0
// --- basic block ---
// 0x0106db70: 0x106db70: jal   0x10ac4e4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0106db90: 0x106db90: jal   0x100449c sw    v0, 16(sp)
	...
	stloc 5
// --- basic block ---
// 0x0106db98: 0x106db98: jal   0x10ac3a4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl129::roadmap_geo_config_transaction_failed_10ac3a4(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
