...
// 0x0106cacc: 0x106cacc: beq   s0, v1, 0x106cad8 lui   v1, 0x70000
	...
	beq  L_106cad8
// --- basic block ---
// 0x0106cad4: 0x106cad4: sw    s0, 18196(v1)
	ldloc 7
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0106cae8: 0x106cae8: beq   v1, zero, 0x106cb08 lui   a0, 0x70000
	...
	brfalse L_106cb08
// --- basic block ---
// 0x0106caf0: 0x106caf0: addiu a0, a0, 18128
	ldloc.1
	ldc.i4 18128
	add
	stloc.1
...
// 0x0106cb00: 0x106cb00: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0106cb04: 0x106cb04: sb    zero, 18191(v0)
	ldloc 5
	ldc.i4 18191
	add
	ldc.i4.s 0
...
// 0x0106cbb8: 0x106cbb8: addu  a3, v0, zero
	ldloc 7
	stloc 4
// 0x0106cbbc: 0x106cbbc: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106cc38: 0x106cc38: addiu v0, v0, -1032
	...
	add
	stloc 5
// 0x0106cc3c: 0x106cc3c: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106cc94: 0x106cc94: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x0106cc98: 0x106cc98: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106ccc4: 0x106ccc4: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x0106ccc8: 0x106ccc8: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106ccf0: 0x106ccf0: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x0106ccf4: 0x106ccf4: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106cd1c: 0x106cd1c: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x0106cd20: 0x106cd20: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106cd60: 0x106cd60: addiu v0, v0, -1196
	...
	add
	stloc 5
// 0x0106cd64: 0x106cd64: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106cde8: 0x106cde8: addu  a2, a1, zero
	ldloc.2
	stloc.3
// 0x0106cdec: 0x106cdec: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106ce1c: 0x106ce1c: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x0106ce20: 0x106ce20: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106ce5c: 0x106ce5c: addiu v0, v0, -888
	...
	add
	stloc 5
// 0x0106ce60: 0x106ce60: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106cea8: 0x106cea8: addiu v0, v0, -828
	...
	add
	stloc 5
// 0x0106ceac: 0x106ceac: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106cedc: 0x106cedc: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x0106cee0: 0x106cee0: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106cf84: 0x106cf84: lw    v0, 84(sp)
	...
	ldelem.i4
	stloc 5
// 0x0106cf88: 0x106cf88: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106d018: 0x106d018: addu  a2, a1, zero
	ldloc.2
	stloc.3
// 0x0106d01c: 0x106d01c: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106d05c: 0x106d05c: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0106d060: 0x106d060: lw    a0, 28940(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106d064: 0x106d064: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x0106d068: 0x106d068: lw    a1, 28944(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106d370: 0x106d370: lui   v0, 0xe0000
	...
	stloc 5
L_106d374:
// 0x0106d374: 0x106d374: addiu v0, v0, 29604
	ldloc 5
	ldc.i4 29604
	add
	stloc 5
...
// 0x0106d47c: 0x106d47c: addu  s1, v0, zero
	ldloc 5
	stloc 10
// 0x0106d480: 0x106d480: lw    v0, 17836(s4)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0106d498: 0x106d498: lui   v1, 0x70000
	ldc.i4 458752
	stloc 7
// 0x0106d49c: 0x106d49c: sw    v0, 17832(v1)
	ldloc 6
	ldloc 7
	ldc.i4.2
	shr.un
...
// 0x0106d4a0: 0x106d4a0: addiu v0, zero, 1
	ldc.i4.1
	stloc 5
// 0x0106d4a4: 0x106d4a4: sw    v0, 17836(s4)
	ldloc 6
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x0106d8c8: 0x106d8c8: lui   a0, 0x70000
	ldc.i4 458752
	stloc.1
// 0x0106d8cc: 0x106d8cc: addiu a0, a0, 18216
	ldloc.1
	ldc.i4 18216
	add
	stloc.1
...
// 0x0106d8ec: 0x106d8ec: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0106d8f0: 0x106d8f0: lw    v0, 17840(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106d90c: 0x106d90c: lui   s0, 0x70000
	ldc.i4 458752
	stloc 7
// 0x0106d910: 0x106d910: jal   0x108b4f0 addiu a0, s0, 18216
	ldloc 7
	ldc.i4 18216
	add
	stloc.1
...
// 0x0106d918: 0x106d918: addiu a1, v0, 68
	...
	add
	stloc.2
// 0x0106d91c: 0x106d91c: addiu a0, s0, 18216
	ldloc 7
	ldc.i4 18216
	add
	stloc.1
...
// 0x0106d938: 0x106d938: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0106d93c: 0x106d93c: lw    v0, 17840(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106d960: 0x106d960: lui   a0, 0x70000
	ldc.i4 458752
	stloc.1
// 0x0106d964: 0x106d964: jal   0x108b4f0 addiu a0, a0, 18216
	ldloc.1
	ldc.i4 18216
	add
	stloc.1
...
// 0x0106d96c: 0x106d96c: beq   v0, zero, 0x106da5c lui   v1, 0xe0000
	...
	brfalse L_106da5c
// --- basic block ---
// 0x0106d974: 0x106d974: addiu v1, v1, 29604
	ldloc 6
	ldc.i4 29604
	add
	stloc 6
...
// 0x0106da40: 0x106da40: beq   v0, zero, 0x106da5c sw    a0, 17840(v1)
	ldloc 5
	ldloc 7
	ldloc 6
	ldc.i4.2
...
// 0x0106da48: 0x106da48: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0106da4c: 0x106da4c: lw    v1, 17840(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106da54: 0x106da54: addiu v1, v1, 4
	...
	add
	stloc 6
// 0x0106da58: 0x106da58: sw    v1, 17840(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106da5c: 0x106da5c: lui   v0, 0x70000
	...
	stloc 5
L_106da60:
// 0x0106da60: 0x106da60: lw    v0, 17832(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106dab8: 0x106dab8: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0106dabc: 0x106dabc: lw    a0, 17908(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106dac0: 0x106dac0: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0106dac4: 0x106dac4: lw    v0, 17912(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106dad8: 0x106dad8: lui   a1, 0x1070000
	ldc.i4 17235968
	stloc.2
// 0x0106dadc: 0x106dadc: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106db00: 0x106db00: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x0106db04: 0x106db04: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106db38: 0x106db38: jal   0x1085d08 addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
...
// 0x0106db68: 0x106db68: beq   a1, zero, 0x106dba0 addu  a0, a1, zero
	...
	brfalse L_106dba0
// --- basic block ---
// 0x0106db70: 0x106db70: jal   0x10ac754 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x0106db90: 0x106db90: jal   0x100449c sw    v0, 16(sp)
	...
	stloc 5
// --- basic block ---
// 0x0106db98: 0x106db98: jal   0x10ac614 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
	ldloc 4
	call int32 Cibyl129::roadmap_geo_config_transaction_failed_10ac614(int32,int32,int32,int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
	stloc 6
	stloc 5
// --- basic block ---
...
// 0x0106dbd0: 0x106dbd0: lw    s0, 17784(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0106dbdc: 0x106dbdc: addu  s1, a1, zero
	ldloc.2
	stloc 9
// 0x0106dbe0: 0x106dbe0: sw    zero, 17784(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0106dbec: 0x106dbec: lui   s4, 0x70000
	ldc.i4 458752
	stloc 11
// 0x0106dbf0: 0x106dbf0: addiu a0, s4, 17936
	ldloc 11
	ldc.i4 17936
	add
	stloc.1
// 0x0106dbf4: 0x106dbf4: jal   0x106b058 lui   s3, 0x70000
	...
	stloc 6
// --- basic block ---
// 0x0106dbfc: 0x106dbfc: jal   0x106b030 addiu a0, s3, 18000
	ldloc 10
	ldc.i4 18000
	add
	stloc.1
...
// 0x0106dc04: 0x106dc04: lui   a0, 0x70000
	ldc.i4 458752
	stloc.1
// 0x0106dc08: 0x106dc08: jal   0x106b008 addiu a0, a0, 18064
	ldloc.1
	ldc.i4 18064
	add
	stloc.1
...
// 0x0106dc18: 0x106dc18: addiu a0, zero, 1
	ldc.i4.1
	stloc.1
// 0x0106dc1c: 0x106dc1c: jal   0x106b18c sw    v1, 17780(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x0106dc24: 0x106dc24: lui   a3, 0x10000
	ldc.i4 65536
	stloc 4
// 0x0106dc28: 0x106dc28: addiu s4, s4, 17936
	ldloc 11
	ldc.i4 17936
	add
	stloc 11
// 0x0106dc2c: 0x106dc2c: addiu s3, s3, 18000
	ldloc 10
	ldc.i4 18000
	add
	stloc 10
...
// 0x0106dc9c: 0x106dc9c: lui   s0, 0x70000
	ldc.i4 458752
	stloc 8
// 0x0106dca0: 0x106dca0: addiu s0, s0, 17936
	ldloc 8
	ldc.i4 17936
	add
	stloc 8
...
// 0x0106dcf4: 0x106dcf4: lui   v0, 0x70000
	ldc.i4 458752
	stloc 5
// 0x0106dcf8: 0x106dcf8: lw    v0, 17772(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106dd4c: 0x106dd4c: lui   a3, 0x1070000
	ldc.i4 17235968
	stloc 4
// 0x0106dd50: 0x106dd50: addiu a0, a0, 17936
	ldloc.1
	ldc.i4 17936
	add
	stloc.1
