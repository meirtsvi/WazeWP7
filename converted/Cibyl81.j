...
// 0x0106cbcc: 0x106cbcc: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x0106cbd0: 0x106cbd0: addiu a0, a0, 15000
	ldloc.1
	ldc.i4 15000
	add
	stloc.1
...
// 0x0106cbe0: 0x106cbe0: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x0106cbe4: 0x106cbe4: addiu a0, a0, 15016
	ldloc.1
	ldc.i4 15016
	add
	stloc.1
...
// 0x0106cc54: 0x106cc54: bne   v0, zero, 0x106cc8c lui   v0, 0x0
	...
	brtrue L_106cc8c
// --- basic block ---
// 0x0106cc5c: 0x106cc5c: lw    v0, 15204(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106d2f0: 0x106d2f0: lw    v1, 0(s0)
	...
	ldelem.i4
	stloc 7
// 0x0106d2f4: 0x106d2f4: lw    v0, 15044(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106da2c: 0x106da2c: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0106da30: 0x106da30: lw    a1, 15044(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x0106da74: 0x106da74: lui   v0, 0x0
	ldc.i4.s 0
	stloc 5
// 0x0106da78: 0x106da78: lw    a1, 15044(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
