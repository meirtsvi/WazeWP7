...
// 0x01087600: 0x1087600: lw    a0, 24(sp)
	...
	ldelem.i4
	stloc.1
// 0x01087604: 0x1087604: jal   0x10aceb8 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01087778: 0x1087778: blez  a0, 0x108779c sll   zero, zero, 0
	...
	ble L_108779c
// --- basic block ---
// 0x01087780: 0x1087780: jal   0x10aceb8 sw    v0, 608(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x0108778c: 0x108778c: addiu a1, zero, 5
	ldc.i4.5
	stloc.2
// 0x01087790: 0x1087790: jal   0x10acc5c addiu a2, zero, 4
	ldc.i4.4
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01087914: 0x1087914: blez  a0, 0x1087938 sll   zero, zero, 0
	...
	ble L_1087938
// --- basic block ---
// 0x0108791c: 0x108791c: jal   0x10aceb8 sw    v0, 608(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
...
// 0x01087928: 0x1087928: addiu a1, zero, 5
	ldc.i4.5
	stloc.2
// 0x0108792c: 0x108792c: jal   0x10acc5c addiu a2, zero, 1
	ldc.i4.1
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01087d80: 0x1087d80: addu  a1, zero, zero
	ldc.i4.s 0
	stloc.2
// 0x01087d84: 0x1087d84: jal   0x10b9c9c sw    v0, 32(sp)
	ldloc 5
	ldloc.0
	ldc.i4.2
	shr.un
