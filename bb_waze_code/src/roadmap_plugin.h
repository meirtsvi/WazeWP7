...
#if defined(FORCE_INLINE) || defined(DECLARE_ROADMAP_PLUGIN)
#if !defined(INLINE_DEC)
#define INLINE_DEC
#endif

INLINE_DEC int roadmap_plugin_same_line (const PluginLine *line1,
...
INLINE_DEC int roadmap_plugin_same_street (const PluginStreet *street1,
...
INLINE_DEC int roadmap_plugin_get_id (const PluginLine *line) {
   return line->plugin_id;
}


INLINE_DEC int roadmap_plugin_get_square (const PluginLine *line) {
   return line->square;
}


INLINE_DEC int roadmap_plugin_get_fips (const PluginLine *line) {
   return line->fips;
}


INLINE_DEC int roadmap_plugin_get_line_id (const PluginLine *line) {
...
INLINE_DEC int roadmap_plugin_get_line_cfcc (const PluginLine *line) {
   return line->cfcc;
}


INLINE_DEC int roadmap_plugin_get_street_id (const PluginStreet *street) {

   return street->street_id;
}


INLINE_DEC void roadmap_plugin_set_line (PluginLine *line,
                              int plugin_id,
                              int line_id,
                              int cfcc,
                              int square,
...
INLINE_DEC void roadmap_plugin_set_street (PluginStreet *street,
                                int plugin_id,
                                int square,
                                int street_id) {
