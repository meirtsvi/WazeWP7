...
RoadMapShape *RoadMapShapeActiveShape = NULL;

int shape_cache_square = -1;
int shape_cache_scale_factor = -1;
int shape_cache_scale_shift = -1;
...
static void roadmap_shape_activate (void *context) {
   ...
   if (shape_context) RoadMapShapeActiveShape = shape_context->Shape;
}
...
void roadmap_shape_set_square (void) {
   shape_cache_scale_shift = roadmap_square_current_scale_shift ();
}
