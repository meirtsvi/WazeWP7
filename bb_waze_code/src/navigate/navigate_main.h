...
#define LOG_NAVIGATION_STATE FALSE // TRUE iff we want to print periodic prints to log about navigation state
#define LOG_NAVIGATION_TIMEOUT 10000
#ifdef J2ME
...
timeStruct navigate_main_get_current_time(void);
