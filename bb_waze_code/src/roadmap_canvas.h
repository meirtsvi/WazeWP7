 ...
 * If is_new == TRUE, then a new pen is created, to save time searching for old pens.
 */
...
#ifdef J2ME
extern inline int roadmap_canvas_width (void) {
	return CanvasWidth;
}


extern inline int roadmap_canvas_height (void) {
	return CanvasHeight;
}
