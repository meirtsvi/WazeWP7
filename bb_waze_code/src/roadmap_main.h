...
#else
#define roadmap_main_context_menu_set(x,y,z)
#define roadmap_main_context_menu_reset(x)
#endif
...
#ifdef RIMAPI
typedef int (*RoadMapMainIntCallback) (int addr);
...
void roadmap_main_context_menu_reset(BOOL keep_softKeys);
void roadmap_main_reset_none_softkey_menu_items();
