                                 ...
                                 roadmap_result       rc)
{
   ...
   if( succeeded != rc)
   {
	  ...
	  if( is_network_error( rc)){
		 snprintf(buff, sizeof(buff),"%s\r\n%s", roadmap_lang_get("Search requires internet connection."),
		  			  roadmap_lang_get("Please make sure you are connected."));
         roadmap_messagebox_cb ( roadmap_lang_get( "Search location"),buff, on_search_error_message);
	  }
      ...
      else
      {
    	 ...
    	 snprintf(buff, sizeof(buff),"%s\r\n%s", roadmap_lang_get("Search failed"),
    		  			  roadmap_lang_get("Please try again later"));
