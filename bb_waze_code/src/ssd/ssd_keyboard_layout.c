...
static void init()
{
   ...
   background_pen = roadmap_canvas_create_pen( "keyboard_layout_pen_background", FALSE);
   roadmap_canvas_set_foreground( background_color);

   buttons_pen = roadmap_canvas_create_pen( "keyboard_layout_pen_buttons", FALSE);
   roadmap_canvas_set_foreground( buttons_color);

   black_pen = roadmap_canvas_create_pen( "keyboard_layout_pen_black", FALSE);
   roadmap_canvas_set_foreground( black);
   roadmap_canvas_set_thickness (3);

   font_pen = roadmap_canvas_create_pen( "keyboard_layout_pen_font", FALSE);
   roadmap_canvas_set_foreground( font_color);
   roadmap_canvas_set_thickness (2);

   selected_font_pen = roadmap_canvas_create_pen( "keyboard_layout_selected_pen_font", FALSE);
