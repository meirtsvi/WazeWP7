...
#define SSD_WIDGET_RESIZE       0x80000000
...
/* Dialogs */
#define SSD_DIALOG_TRY_RESIZE     0x8000 // If widget does not fit, build again with width = screen_width
