...
static const char * get_current_street(void);
static const char * get_time_to_destination(void);
static const char * get_dist_to_destination(void);
static const char * get_current_num_comments(void);
...
static int roadmap_bar_short_click (RoadMapGuiPoint *point)
{
...
static int roadmap_bar_long_click (RoadMapGuiPoint *point) {
...
static void roadmap_bar_set_mode (int flags) {
   int x_offset;
   int y_offset;
