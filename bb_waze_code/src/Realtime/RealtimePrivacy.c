...
static void set_softkeys( SsdWidget dialog)
{
   ...
   ssd_widget_set_left_softkey_callback ( dialog, on_ok);
}
#endif
...
static void create_dialog (void) {
   ...
   ssd_widget_add (box, ssd_text_new ("privacy_heading_label",
            roadmap_lang_get ("Display my location on waze mobile and web maps as follows:"), font_size,
   ...
   ssd_widget_add (box, ssd_text_new ("driving_heading_label",
            roadmap_lang_get ("When driving"), font_size, SSD_TEXT_LABEL
   ...
   ssd_widget_add (box, ssd_text_new ("Nickname", roadmap_lang_get (
            "Nickname"), font_size, SSD_ALIGN_VCENTER | SSD_WIDGET_SPACE));
   ...
   ssd_widget_add (box, ssd_text_new ("Anonymous text", roadmap_lang_get (
            "Anonymous"), font_size, SSD_ALIGN_VCENTER | SSD_WIDGET_SPACE));
   ...
   ssd_widget_add (box, ssd_text_new ("Invisible Text", roadmap_lang_get (
            "Don't show me"), font_size, SSD_ALIGN_VCENTER | SSD_WIDGET_SPACE
            | SSD_END_ROW));
...
/*
   ...
   ssd_widget_add (box, ssd_text_new ("reporting_heading_label",
            roadmap_lang_get ("When reporting"), font_size, SSD_TEXT_LABEL
                     | SSD_ALIGN_VCENTER | SSD_WIDGET_SPACE | SSD_END_ROW));
   ...
   space = ssd_container_new ("spacer1", NULL, 10, font_size, 0);
   ssd_widget_set_color (space, NULL, NULL);
