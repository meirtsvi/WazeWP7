...
void RealtimeTrafficInfoPluginInit () {
   ...
   pens[LIGHT_TRAFFIC] = roadmap_canvas_create_pen ("RealtimeTrafficInfoPenGood", FALSE);
   ...
   pens[MODERATE_TRAFFIC] = roadmap_canvas_create_pen ("RealtimeTrafficInfoPenMild", FALSE);
   roadmap_canvas_set_foreground
      (roadmap_config_get (&RouteInfoConfigRouteColorMild));
   roadmap_canvas_set_thickness (TRAFFIC_PEN_WIDTH);

   pens[HEAVY_TRAFFIC] = roadmap_canvas_create_pen ("RealtimeTrafficInfoPenBad", FALSE);
   roadmap_canvas_set_foreground
      (roadmap_config_get (&RouteInfoConfigRouteColorBad));
   roadmap_canvas_set_thickness (TRAFFIC_PEN_WIDTH);

   pens[STAND_STILL_TRAFFIC] = roadmap_canvas_create_pen ("RealtimeTrafficInfoPenStandStill", FALSE);
   roadmap_canvas_set_foreground
      (roadmap_config_get (&RouteInfoConfigRouteColorStandStill));
   roadmap_canvas_set_thickness (TRAFFIC_PEN_WIDTH);

   speed_text_pen = 	roadmap_canvas_create_pen("SpeedText", FALSE);
