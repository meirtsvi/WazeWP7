...
static RoadMapPen roadmap_display_new_pen
    ...
    if (strcasecmp (color, "#000000") != 0) {
        ...
        pen = roadmap_canvas_create_pen (pen_name, TRUE);
...
static void roadmap_display_create_pens (void) {
    ...
    RoadMapMessageContour = roadmap_canvas_create_pen ("message.contour", FALSE);
...
static void roadmap_display_console_box
    ...
    if(roadmap_screen_is_hd_screen())
    	warning_font_size = warning_font_size * 0.8;
#endif
    int offset = 62;
