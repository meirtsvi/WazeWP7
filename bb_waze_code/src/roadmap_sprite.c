...
static RoadMapPen RoadMapCanvasBlackPen;
...
static void roadmap_sprite_decode_plane
   ...
   sprite->last->pen = roadmap_canvas_create_pen (pen, TRUE);
...
static RoadMapSprite roadmap_sprite_new
   ...
   sprite->first.pen = RoadMapCanvasBlackPen;
...
void roadmap_sprite_initialize (void) {
   ...
   RoadMapCanvasBlackPen = roadmap_canvas_create_pen ("Black", FALSE);
