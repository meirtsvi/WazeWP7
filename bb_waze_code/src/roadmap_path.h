...
#ifdef J2ME
/*
 * This path signals that we want a resource which was supposed to be found in some subdirectory of the resources.
 * ( Made to accomdodate the different skins ). If a file was supposed to be under path1/path2/, then it's filename
 * will simply be path1_path2_filename. For example, what should have been skins/default/day/2/schema,
 * will be a file named skins_default_day_2_schema. ( should be found in the pre-installed resources ).
 */
#define ROADMAP_PATH_VAR_PATH "var_resource:/"
