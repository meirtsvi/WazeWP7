...
// EditBoxScreenOS5
//
#define __NR_NOPH_EditBoxScreenOS5_showEditBox 175 /* rimapi_os5 */
...
#define __NR_NOPH_EditBoxScreenOS5_isTouchScreenSupported 176 /* rimapi_os5 */
static inline _syscall0(int,NOPH_EditBoxScreenOS5_isTouchScreenSupported) 
//
// EditBoxCameraScreen
//
#define __NR_NOPH_EditBoxCameraScreen_showEditBox 177 /* rimapi_os5 */
...
#define __NR_NOPH_EditBoxCameraScreen_getLastImageId 178 /* rimapi_os5 */
static inline _syscall0(int,NOPH_EditBoxCameraScreen_getLastImageId) 
#define __NR_NOPH_EditBoxCameraScreen_registerAddrs 179 /* rimapi_os5 */
static inline _syscall2(void,NOPH_EditBoxCameraScreen_registerAddrs, int, box_text_addr, int, image_path_addr) 

//EmbeddedBrowser
#define __NR_NOPH_EmbeddedBrowser_EmbeddedBrowserHide 180 /* rimapi_os5 */
static inline _syscall0(void,NOPH_EmbeddedBrowser_EmbeddedBrowserHide) 
#define __NR_NOPH_EmbeddedBrowser_EmbeddedBrowserShow 181 /* rimapi_os5 */
