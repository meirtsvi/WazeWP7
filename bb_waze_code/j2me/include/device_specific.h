...
#define __NR_NOPH_DeviceSpecific_init 418 /* rim_device */
static inline _syscall2(void,NOPH_DeviceSpecific_init, int, timeout, int, isRefreshThread) 
#define __NR_NOPH_DeviceSpecific_getPlatform 419 /* rim_device */
static inline _syscall2(void,NOPH_DeviceSpecific_getPlatform, int, addr, int, size) 
#define __NR_NOPH_DeviceSpecific_setBacklightOn 420 /* rim_device */
