...
#define __NR_NOPH_FormCommandMgr_new 215 /* command_mgr */
static inline _syscall1(NOPH_FormCommandMgr_t,NOPH_FormCommandMgr_new, NOPH_Form_t, form) 
#define __NR_NOPH_FormCommandMgr_addCommand 216 /* command_mgr */
...
#define __NR_NOPH_FormCommandMgr_getCallBackNotif 217 /* command_mgr */
static inline _syscall3(int,NOPH_FormCommandMgr_getCallBackNotif, int*, callback_addr, void*, callback_name, void*, callback_context) 
#define __NR_NOPH_FormCommandMgr_addCallback 218 /* command_mgr */
