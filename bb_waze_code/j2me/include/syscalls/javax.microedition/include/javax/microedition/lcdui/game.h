...
#define __NR_NOPH_GameCanvas_flushGraphics 387 /* javax.microedition */
static inline _syscall1(void,NOPH_GameCanvas_flushGraphics, NOPH_GameCanvas_t, canvas) 
#define __NR_NOPH_GameCanvas_flushGraphics_rect 388 /* javax.microedition */
