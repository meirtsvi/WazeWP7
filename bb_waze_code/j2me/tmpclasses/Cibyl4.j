...
// 0x010054c8: 0x10054c8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010054cc: 0x10054cc: lw    v0, 30564(v0)
	ldloc 7
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01005558: 0x1005558: mflo  lo
	ldloc 13
	stloc.1
// 0x0100555c: 0x100555c: jal   0x10c32a0 sll   zero, zero, 0
	ldloc.0
	ldloc.1
...
// 0x01005564: 0x1005564: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01005568: 0x1005568: lw    a3, 22732(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x0100556c: 0x100556c: lw    a2, 22728(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01005570: 0x1005570: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x01005574: 0x1005574: jal   0x10c3078 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01005580: 0x1005580: addu  s3, v1, zero
	ldloc 6
	stloc 11
// 0x01005584: 0x1005584: jal   0x10c32a0 addu  s2, v0, zero
	ldloc 5
	stloc 10
	ldloc.0
	ldloc.1
...
// 0x01005594: 0x1005594: addu  a0, s2, zero
	ldloc 10
	stloc.1
// 0x01005598: 0x1005598: jal   0x10c30d0 addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x010055a0: 0x10055a0: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x010055a4: 0x10055a4: jal   0x10c3228 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010055d8: 0x10055d8: lui   v0, 0x20000
	ldc.i4 131072
	stloc 5
// 0x010055dc: 0x10055dc: lw    v0, 30564(v0)
	ldloc 6
	ldloc 5
	ldc.i4.2
	shr.un
...
// 0x01005954: 0x1005954: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01005958: 0x1005958: lw    v1, 30568(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01005974: 0x1005974: lui   s1, 0x20000
	ldc.i4 131072
	stloc 8
// 0x01005978: 0x1005978: lw    a0, 30572(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x0100597c: 0x100597c: jal   0x1015b64 sw    zero, 30568(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
	...
	stloc 6
// --- basic block ---
// 0x01005984: 0x1005984: j	 0x10059b0 sw    zero, 30572(s1)
	ldloc 5
	ldloc 8
	ldc.i4.2
	shr.un
...
// 0x01005a24: 0x1005a24: sw    s0, 20(sp)
	...
	ldloc 7
	stelem.i4
// 0x01005a28: 0x1005a28: sw    a0, 30568(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01005a44: 0x1005a44: lui   a0, 0x0
	ldc.i4.s 0
	stloc.1
// 0x01005a48: 0x1005a48: jal   0x1015990 addiu a0, a0, 24072
	ldloc.1
	ldc.i4 24072
	add
	stloc.1
...
// 0x01005a50: 0x1005a50: lui   s2, 0x20000
	ldc.i4 131072
	stloc 9
// 0x01005a54: 0x1005a54: sw    v0, 30572(s2)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01005a58: 0x1005a58: lui   v0, 0x20000
	ldc.i4 131072
	stloc 6
// 0x01005a5c: 0x1005a5c: lw    s0, 30568(v0)
	ldloc 5
	ldloc 6
	ldc.i4.2
	shr.un
...
// 0x01005a68: 0x1005a68: lw    a0, 0(s0)
	...
	ldelem.i4
	stloc.1
// 0x01005a6c: 0x1005a6c: jal   0x1015680 sll   zero, zero, 0
	ldloc.1
	ldloc.2
	...
	stloc 6
// --- basic block ---
// 0x01005a74: 0x1005a74: lw    a0, 30572(s2)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01005a78: 0x1005a78: addu  a1, v0, zero
	ldloc 6
	stloc.2
// 0x01005a7c: 0x1005a7c: jal   0x10158a0 addu  a2, s1, zero
	ldloc 8
	stloc.3
	ldloc.0
	ldloc.1
	...
	stloc 6
// --- basic block ---
// 0x01005a84: 0x1005a84: lw    a0, 30572(s2)
	ldloc 5
	ldloc 9
	ldc.i4.2
	shr.un
...
// 0x01005a88: 0x1005a88: addu  a1, s1, zero
	ldloc 8
	stloc.2
// 0x01005a8c: 0x1005a8c: jal   0x1015a80 addu  a2, s0, zero
	ldloc 7
	stloc.3
	ldloc.0
	ldloc.1
...
// 0x01005f10: 0x1005f10: addiu sp, sp, -24
	...
	add
	stloc.0
// 0x01005f14: 0x1005f14: addiu a2, a2, 2456
	ldloc.3
	ldc.i4 2456
	add
	stloc.3
...
// 0x01005f34: 0x1005f34: addu  a0, s0, zero
	ldloc 6
	stloc.1
// 0x01005f38: 0x1005f38: addiu a2, a2, 13188
	ldloc.3
	ldc.i4 13188
	add
	stloc.3
...
// 0x01005f64: 0x1005f64: addu  a0, s0, zero
	ldloc 6
	stloc.1
// 0x01005f68: 0x1005f68: addiu a2, a2, -11928
	ldloc.3
	ldc.i4 -11928
	add
	stloc.3
...
// 0x01006c7c: 0x1006c7c: jal   0x1015680 lui   s0, 0x20000
	ldc.i4 131072
	stloc 8
	ldloc.1
	ldloc.2
	...
	stloc 5
// --- basic block ---
// 0x01006c84: 0x1006c84: lw    a0, 30572(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x01006c88: 0x1006c88: jal   0x10155ec addu  a1, v0, zero
	ldloc 5
	stloc.2
	ldloc.1
	ldloc.2
...
// 0x01006c98: 0x1006c98: beq   a1, v1, 0x1006cac addu  v0, zero, zero
	...
	beq  L_1006cac
// --- basic block ---
// 0x01006ca0: 0x1006ca0: lw    a0, 30572(s0)
	ldloc 6
	ldloc 8
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc.1
// 0x01006ca4: 0x1006ca4: jal   0x10156b4 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	ldloc.2
	ldloc.3
...
// 0x01006ce4: 0x1006ce4: slti  a3, v0, 46
	...
	clt
	stloc.3
// 0x01006ce8: 0x1006ce8: beq   a3, zero, 0x1006d08 addiu v1, v1, 23400
	ldloc.3
	ldloc 5
	ldc.i4 23400
	add
...
// 0x01006d88: 0x1006d88: lui   t0, 0xe0000
	ldc.i4 917504
	stloc 7
// 0x01006d8c: 0x1006d8c: addiu t0, t0, -28540
	ldloc 7
	ldc.i4 -28540
	add
	stloc 7
...
// 0x01006eb4: 0x1006eb4: lui   a3, 0xe0000
	ldc.i4 917504
	stloc.3
// 0x01006eb8: 0x1006eb8: addiu a3, a3, -28540
	ldloc.3
	ldc.i4 -28540
	add
	stloc.3
...
// 0x01006f44: 0x1006f44: lui   a1, 0xe0000
	ldc.i4 917504
	stloc.1
// 0x01006f48: 0x1006f48: addiu a1, a1, -28540
	ldloc.1
	ldc.i4 -28540
	add
	stloc.1
...
// 0x01006fe4: 0x1006fe4: lui   v1, 0xe0000
	ldc.i4 917504
	stloc 5
// 0x01006fe8: 0x1006fe8: addiu v1, v1, -28540
	ldloc 5
	ldc.i4 -28540
	add
	stloc 5
...
// 0x01007084: 0x1007084: addiu sp, sp, -56
	...
	add
	stloc.0
// 0x01007088: 0x1007088: addiu v0, v0, -28540
	ldloc 5
	ldc.i4 -28540
	add
	stloc 5
...
// 0x010070c4: 0x10070c4: lui   s2, 0xe0000
	ldc.i4 917504
	stloc 8
// 0x010070c8: 0x10070c8: addiu s2, s2, -28540
	ldloc 8
	ldc.i4 -28540
	add
	stloc 8
...
// 0x010070f0: 0x10070f0: lw    a0, 20(sp)
	...
	ldelem.i4
	stloc.1
// 0x010070f4: 0x10070f4: jal   0x10c32a0 sll   zero, zero, 0
	ldloc.0
	ldloc.1
	call int32 Cibyl146::__floatsidf_10c32a0(int32,int32)
	ldsfld int32 [WazeWP7]CRunTime::saved_v1
...
// 0x010070fc: 0x10070fc: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x01007100: 0x1007100: lw    a3, 22740(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x01007104: 0x1007104: lw    a2, 22736(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x01007108: 0x1007108: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x0100710c: 0x100710c: jal   0x10c3078 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01007118: 0x1007118: addu  s5, v1, zero
	ldloc 6
	stloc 13
// 0x0100711c: 0x100711c: jal   0x10c32a0 addu  s4, v0, zero
	ldloc 5
	stloc 12
	ldloc.0
	ldloc.1
...
// 0x0100712c: 0x100712c: addu  a0, s4, zero
	ldloc 12
	stloc.1
// 0x01007130: 0x1007130: jal   0x10c3078 addu  a2, v0, zero
	ldloc 5
	stloc.3
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x01007138: 0x1007138: lw    a3, 22748(s1)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x0100713c: 0x100713c: lw    a2, 22744(s1)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x01007140: 0x1007140: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x01007144: 0x1007144: jal   0x10c2fc8 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x0100714c: 0x100714c: addu  a0, v0, zero
	ldloc 5
	stloc.1
// 0x01007150: 0x1007150: jal   0x10c31b0 addu  a1, v1, zero
	ldloc 6
	stloc.2
	ldloc.0
	ldloc.1
...
// 0x01007158: 0x1007158: beq   s3, zero, 0x10071b8 addu  s0, v0, zero
	...
	brfalse L_10071b8
// --- basic block ---
// 0x01007160: 0x1007160: jal   0x10c328c addu  a0, s3, zero
	ldloc 11
	stloc.1
	ldloc.1
	conv.r4
...
// 0x01007170: 0x1007170: lw    a1, 4(v1)
	...
	ldelem.i4
	stloc.2
// 0x01007174: 0x1007174: jal   0x10c3060 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.1
	ldloc.2
...
// 0x0100717c: 0x100717c: addu  a0, s0, zero
	ldloc 9
	stloc.1
// 0x01007180: 0x1007180: jal   0x10c328c addu  s2, v0, zero
	ldloc 5
	stloc 8
	ldloc.1
	conv.r4
...
// 0x01007188: 0x1007188: addu  a1, v0, zero
	ldloc 5
	stloc.2
// 0x0100718c: 0x100718c: jal   0x10c3060 addu  a0, s2, zero
	ldloc 8
	stloc.1
	ldloc.1
	ldloc.2
	...
	stloc 5
// --- basic block ---
// 0x01007194: 0x1007194: jal   0x10c3154 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
	...
	stloc 5
// --- basic block ---
// 0x0100719c: 0x100719c: lw    a3, 22748(s1)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x010071a0: 0x10071a0: lw    a2, 22744(s1)
	ldloc 7
	ldloc 10
	ldc.i4.2
	shr.un
...
// 0x010071a4: 0x10071a4: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x010071a8: 0x10071a8: jal   0x10c2fc8 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// --- basic block ---
L_10071b8:
// 0x010071b8: 0x10071b8: jal   0x10c32a0 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010071c0: 0x10071c0: lui   a0, 0x20000
	ldc.i4 131072
	stloc.1
// 0x010071c4: 0x10071c4: lw    a3, 22756(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
	...
	ldelem.i4
	stloc 4
// 0x010071c8: 0x10071c8: lw    a2, 22752(a0)
	ldloc 7
	ldloc.1
	ldc.i4.2
	shr.un
...
// 0x010071cc: 0x10071cc: addu  a1, v1, zero
	ldloc 6
	stloc.2
// 0x010071d0: 0x10071d0: jal   0x10c3078 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x010071d8: 0x10071d8: addu  a1, v1, zero
	...
	stloc.2
L_10071dc:
// 0x010071dc: 0x10071dc: jal   0x10c31b0 addu  a0, v0, zero
	ldloc 5
	stloc.1
	ldloc.0
	ldloc.1
...
// 0x01007364: 0x1007364: lui   v0, 0xe0000
	ldc.i4 917504
	stloc 6
// 0x01007368: 0x1007368: addiu v0, v0, -28540
	ldloc 6
	ldc.i4 -28540
	add
	stloc 6
...
// 0x01007458: 0x1007458: addu  s2, a0, zero
	ldloc.1
	stloc 11
// 0x0100745c: 0x100745c: addiu s0, s0, -28540
	ldloc 7
	ldc.i4 -28540
	add
	stloc 7
